...
function Initialize-Activatecampaignoptions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Activatecampaignoptions' | Write-Debug
...
Activatecampaignoptions<PSCustomObject>
#>
function ConvertFrom-JsonToActivatecampaignoptions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Activatecampaignoptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Activatecampaignoptions

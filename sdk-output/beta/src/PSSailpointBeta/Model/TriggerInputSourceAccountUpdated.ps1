...
TriggerInputSourceAccountUpdated<PSCustomObject>
#>

function Initialize-BetaTriggerInputSourceAccountUpdated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceAccountUpdated' | Write-Debug
...
Convert from JSON to TriggerInputSourceAccountUpdated<PSCustomObject>
...
TriggerInputSourceAccountUpdated<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputSourceAccountUpdated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceAccountUpdated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputSourceAccountUpdated

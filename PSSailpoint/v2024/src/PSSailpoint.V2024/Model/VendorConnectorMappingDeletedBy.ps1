...
function Initialize-V2024VendorConnectorMappingDeletedBy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024VendorConnectorMappingDeletedBy' | Write-Debug
...
function ConvertFrom-V2024JsonToVendorConnectorMappingDeletedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024VendorConnectorMappingDeletedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024VendorConnectorMappingDeletedBy

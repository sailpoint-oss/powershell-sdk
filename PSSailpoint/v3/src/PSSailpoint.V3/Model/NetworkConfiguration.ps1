...
function Initialize-NetworkConfiguration {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NetworkConfiguration' | Write-Debug
...
function ConvertFrom-JsonToNetworkConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NetworkConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Entitlementref {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DimensionsV1 => Entitlementref' | Write-Debug
...
function ConvertFrom-JsonToEntitlementref {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DimensionsV1 => Entitlementref' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-DataAccessImpactScore {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => DataAccessImpactScore' | Write-Debug
...
function ConvertFrom-JsonToDataAccessImpactScore {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => DataAccessImpactScore' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026SubscriptionPutRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SubscriptionPutRequest' | Write-Debug
...
SubscriptionPutRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSubscriptionPutRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SubscriptionPutRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SubscriptionPutRequest

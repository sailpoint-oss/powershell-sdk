...
function Initialize-BetaFormElementValidationsSet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormElementValidationsSet' | Write-Debug
...
FormElementValidationsSet<PSCustomObject>
#>
function ConvertFrom-BetaJsonToFormElementValidationsSet {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormElementValidationsSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaFormElementValidationsSet

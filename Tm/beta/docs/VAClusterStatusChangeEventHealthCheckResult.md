...
```powershell
$VAClusterStatusChangeEventHealthCheckResult = Initialize-Tm.BetaVAClusterStatusChangeEventHealthCheckResult  -Message Test Connection failed with exception. Error message - java.lang Exception `

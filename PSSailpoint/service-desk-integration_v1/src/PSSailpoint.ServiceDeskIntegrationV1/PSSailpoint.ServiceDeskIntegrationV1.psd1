#
# Module manifest for module 'PSSailpoint.ServiceDeskIntegrationV1'
#
...
RootModule = 'PSSailpoint.ServiceDeskIntegrationV1.psm1'
...
GUID = 'fc49bde5-b0f3-8950-89fc-5585b0c9cbb7'
...
Description = 'PSSailpoint.ServiceDeskIntegrationV1 - the PowerShell module for Identity Security Cloud API - Service Desk Integration'
...
FunctionsToExport = 'New-ServiceDeskIntegrationV1', 'Remove-ServiceDeskIntegrationV1', 
               'Get-ServiceDeskIntegrationTemplateV1', 
               'Get-ServiceDeskIntegrationTypesV1', 'Get-ServiceDeskIntegrationV1', 
               'Get-ServiceDeskIntegrationsV1', 'Get-StatusCheckDetailsV1', 
               'Update-ServiceDeskIntegrationV1', 'Send-ServiceDeskIntegrationV1', 
               'Update-StatusCheckDetailsV1', 'Get-Configuration', 

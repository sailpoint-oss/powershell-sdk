...
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "PSSailpointBeta"; ModuleVersion = "1.2.1"}
```
...
## Documentation for Models
 ...
 - [PSSailpointBeta/Model.SpConfigExportJobAllOf](docs/SpConfigExportJobAllOf.md)
 - [PSSailpointBeta/Model.SpConfigExportJobStatus](docs/SpConfigExportJobStatus.md)
 - [PSSailpointBeta/Model.SpConfigExportJobStatusAllOf](docs/SpConfigExportJobStatusAllOf.md)
 ...
 - [PSSailpointBeta/Model.SpConfigImportJobStatusAllOf](docs/SpConfigImportJobStatusAllOf.md)

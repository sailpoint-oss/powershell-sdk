...
function Initialize-V2026UpdateStreamConfigResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026UpdateStreamConfigResponse' | Write-Debug
...
UpdateStreamConfigResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToUpdateStreamConfigResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026UpdateStreamConfigResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026UpdateStreamConfigResponse

...
function Initialize-Entitlementprivilegelevel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.EntitlementsV1 => Entitlementprivilegelevel' | Write-Debug
...
Entitlementprivilegelevel<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementprivilegelevel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.EntitlementsV1 => Entitlementprivilegelevel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Entitlementprivilegelevel

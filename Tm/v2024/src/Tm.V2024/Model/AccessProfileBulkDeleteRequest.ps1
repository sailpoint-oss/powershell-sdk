...
function Initialize-V2024AccessProfileBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccessProfileBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccessProfileBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

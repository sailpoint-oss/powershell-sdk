...
function Initialize-V2026AssignmentContextDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AssignmentContextDto' | Write-Debug
...
AssignmentContextDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAssignmentContextDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AssignmentContextDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AssignmentContextDto

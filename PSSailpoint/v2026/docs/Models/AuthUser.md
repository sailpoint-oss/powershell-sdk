...
keywords: ['powershell', 'PowerShell', 'sdk', 'AuthUser', 'V2026AuthUser'] 
slug: /tools/sdk/powershell/v2026/models/auth-user
...
```powershell
$AuthUser = Initialize-V2026AuthUser  -Tenant test-tenant `

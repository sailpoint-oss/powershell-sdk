...
function Initialize-V2024RequestOnBehalfOfConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RequestOnBehalfOfConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestOnBehalfOfConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RequestOnBehalfOfConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
BusinessApplicationOwner<PSCustomObject>
#>

function Initialize-BusinessApplicationOwner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.BusinessApplications => BusinessApplicationOwner' | Write-Debug
...
Convert from JSON to BusinessApplicationOwner<PSCustomObject>
...
BusinessApplicationOwner<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessApplicationOwner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.BusinessApplications => BusinessApplicationOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessApplicationOwner

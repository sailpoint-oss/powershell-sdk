...
keywords: ['powershell', 'PowerShell', 'sdk', 'DataAccess', 'V2026DataAccess'] 
slug: /tools/sdk/powershell/v2026/models/data-access
...
```powershell
$DataAccess = Initialize-V2026DataAccess  -Policies null `
 -Categories null `
 -ImpactScore null
```

...
function Initialize-V2024SpConfigExportResults {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SpConfigExportResults' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigExportResults {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SpConfigExportResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

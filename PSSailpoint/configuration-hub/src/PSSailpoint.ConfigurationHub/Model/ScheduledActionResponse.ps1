...
function Initialize-ScheduledActionResponse {
    [CmdletBinding()]
    Param (
...
ScheduledActionResponse<PSCustomObject>
#>
function ConvertFrom-JsonToScheduledActionResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ScheduledActionResponse

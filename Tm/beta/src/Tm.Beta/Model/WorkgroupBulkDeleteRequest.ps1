...
function Initialize-BetaWorkgroupBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaWorkgroupBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkgroupBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaWorkgroupBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

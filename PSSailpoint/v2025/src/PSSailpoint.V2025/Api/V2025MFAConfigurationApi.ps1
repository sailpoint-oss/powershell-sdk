...
MfaDuoConfig
#>
function Get-V2025MFADuoConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2025MFADuoConfig' | Write-Debug
...
KbaQuestion[]
#>
function Get-V2025MFAKbaConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2025MFAKbaConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MfaOktaConfig
#>
function Get-V2025MFAOktaConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2025MFAOktaConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MfaDuoConfig
#>
function Set-V2025MFADuoConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Set-V2025MFADuoConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Set-V2025MFAKBAConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Set-V2025MFAKBAConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MfaOktaConfig
#>
function Set-V2025MFAOktaConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Set-V2025MFAOktaConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Test-V2025MFAConfig {
    ...
    Process {
        'Calling method: Test-V2025MFAConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

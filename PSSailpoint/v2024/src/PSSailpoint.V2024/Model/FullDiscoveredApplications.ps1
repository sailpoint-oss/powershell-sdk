...
function Initialize-V2024FullDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024FullDiscoveredApplications' | Write-Debug
...
function ConvertFrom-V2024JsonToFullDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024FullDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024FullDiscoveredApplications
        $AllProperties = ("id", "name", "discoverySource", "discoveredVendor", "description", "recommendedConnectors", "discoveredAt", "createdAt", "status", "associatedSources", "riskScore", "isBusiness", "totalSigninsCount", "riskLevel")

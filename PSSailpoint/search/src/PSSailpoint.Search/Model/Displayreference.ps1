...
function Initialize-Displayreference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Search => Displayreference' | Write-Debug
...
function ConvertFrom-JsonToDisplayreference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Search => Displayreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

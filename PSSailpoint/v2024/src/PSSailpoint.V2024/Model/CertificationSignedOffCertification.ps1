...
function Initialize-V2024CertificationSignedOffCertification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CertificationSignedOffCertification' | Write-Debug
...
CertificationSignedOffCertification<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCertificationSignedOffCertification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CertificationSignedOffCertification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024CertificationSignedOffCertification

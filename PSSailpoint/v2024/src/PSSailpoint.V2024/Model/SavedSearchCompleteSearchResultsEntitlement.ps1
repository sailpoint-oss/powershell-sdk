...
function Initialize-V2024SavedSearchCompleteSearchResultsEntitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SavedSearchCompleteSearchResultsEntitlement' | Write-Debug
...
SavedSearchCompleteSearchResultsEntitlement<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSavedSearchCompleteSearchResultsEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SavedSearchCompleteSearchResultsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SavedSearchCompleteSearchResultsEntitlement

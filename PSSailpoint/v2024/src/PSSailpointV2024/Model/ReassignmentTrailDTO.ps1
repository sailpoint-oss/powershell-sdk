...
function Initialize-V2024ReassignmentTrailDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ReassignmentTrailDTO' | Write-Debug
...
function ConvertFrom-V2024JsonToReassignmentTrailDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ReassignmentTrailDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

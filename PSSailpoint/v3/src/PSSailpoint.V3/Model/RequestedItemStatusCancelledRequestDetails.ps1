...
function Initialize-RequestedItemStatusCancelledRequestDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RequestedItemStatusCancelledRequestDetails' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemStatusCancelledRequestDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RequestedItemStatusCancelledRequestDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

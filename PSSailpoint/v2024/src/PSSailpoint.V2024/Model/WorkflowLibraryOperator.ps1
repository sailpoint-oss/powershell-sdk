...
function Initialize-V2024WorkflowLibraryOperator {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024WorkflowLibraryOperator' | Write-Debug
...
WorkflowLibraryOperator<PSCustomObject>
#>
function ConvertFrom-V2024JsonToWorkflowLibraryOperator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024WorkflowLibraryOperator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024WorkflowLibraryOperator

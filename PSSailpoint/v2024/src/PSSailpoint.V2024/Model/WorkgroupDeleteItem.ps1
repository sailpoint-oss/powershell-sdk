...
function Initialize-V2024WorkgroupDeleteItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024WorkgroupDeleteItem' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkgroupDeleteItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024WorkgroupDeleteItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'RequestOnBehalfOfConfig', 'V2026RequestOnBehalfOfConfig'] 
slug: /tools/sdk/powershell/v2026/models/request-on-behalf-of-config
...
```powershell
$RequestOnBehalfOfConfig = Initialize-V2026RequestOnBehalfOfConfig  -AllowRequestOnBehalfOfAnyoneByAnyone true `

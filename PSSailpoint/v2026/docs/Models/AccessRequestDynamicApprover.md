...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessRequestDynamicApprover', 'V2026AccessRequestDynamicApprover'] 
slug: /tools/sdk/powershell/v2026/models/access-request-dynamic-approver
...
```powershell
$AccessRequestDynamicApprover = Initialize-V2026AccessRequestDynamicApprover  -AccessRequestId 4b4d982dddff4267ab12f0f1e72b5a6d `
 -RequestedFor null `
 -RequestedItems null `
 -RequestedBy null
```

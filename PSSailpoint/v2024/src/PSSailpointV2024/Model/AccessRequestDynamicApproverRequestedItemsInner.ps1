...
function Initialize-V2024AccessRequestDynamicApproverRequestedItemsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestDynamicApproverRequestedItemsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

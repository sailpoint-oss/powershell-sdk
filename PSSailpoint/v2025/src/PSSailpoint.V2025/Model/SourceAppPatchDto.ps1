...
function Initialize-V2025SourceAppPatchDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SourceAppPatchDto' | Write-Debug
...
Convert from JSON to SourceAppPatchDto<PSCustomObject>
...
SourceAppPatchDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSourceAppPatchDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SourceAppPatchDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SourceAppPatchDto
        $AllProperties = ("id", "cloudAppId", "name", "created", "modified", "enabled", "provisionRequestEnabled", "description", "matchAllAccounts", "appCenterEnabled", "accessProfiles", "accountSource", "owner")

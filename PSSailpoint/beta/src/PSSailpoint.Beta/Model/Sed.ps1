...
function Initialize-BetaSed {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSed' | Write-Debug
...
Sed<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSed {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSed' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSed

...
function Initialize-V2026IdentityCertDecisionSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IdentityCertDecisionSummary' | Write-Debug
...
IdentityCertDecisionSummary<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIdentityCertDecisionSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IdentityCertDecisionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IdentityCertDecisionSummary

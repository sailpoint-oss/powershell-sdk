...
function Initialize-ServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ServiceDeskIntegrationTemplateType' | Write-Debug
...
function ConvertFrom-JsonToServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ServiceDeskIntegrationTemplateType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

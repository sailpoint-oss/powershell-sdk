...
function Initialize-V2024IdentitySummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentitySummary' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentitySummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentitySummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

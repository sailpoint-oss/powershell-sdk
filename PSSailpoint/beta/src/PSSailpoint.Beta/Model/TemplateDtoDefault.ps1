...
function Initialize-BetaTemplateDtoDefault {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTemplateDtoDefault' | Write-Debug
...
function ConvertFrom-BetaJsonToTemplateDtoDefault {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTemplateDtoDefault' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

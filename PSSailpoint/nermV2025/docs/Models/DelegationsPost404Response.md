...
keywords: ['powershell', 'PowerShell', 'sdk', 'DelegationsPost404Response', 'NERMV2025DelegationsPost404Response'] 
slug: /tools/sdk/powershell/nermv2025/models/delegations-post404-response
...
```powershell
$DelegationsPost404Response = Initialize-NERMV2025DelegationsPost404Response  -VarError The requested Profile was not found
```

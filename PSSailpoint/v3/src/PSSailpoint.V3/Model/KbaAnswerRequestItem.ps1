...
function Initialize-KbaAnswerRequestItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => KbaAnswerRequestItem' | Write-Debug
...
function ConvertFrom-JsonToKbaAnswerRequestItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => KbaAnswerRequestItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

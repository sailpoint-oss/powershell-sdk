...
function Initialize-V2024MailFromAttributesDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024MailFromAttributesDto' | Write-Debug
...
MailFromAttributesDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToMailFromAttributesDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024MailFromAttributesDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024MailFromAttributesDto

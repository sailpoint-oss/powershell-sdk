...
function Initialize-SearchFilters {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => SearchFilters' | Write-Debug
...
Convert from JSON to SearchFilters<PSCustomObject>
...
SearchFilters<PSCustomObject>
#>
function ConvertFrom-JsonToSearchFilters {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => SearchFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SearchFilters

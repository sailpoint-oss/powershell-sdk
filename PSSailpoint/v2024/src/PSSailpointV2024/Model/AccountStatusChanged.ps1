...
function Initialize-V2024AccountStatusChanged {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountStatusChanged' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountStatusChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountStatusChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

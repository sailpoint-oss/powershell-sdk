...
function Initialize-Publicidentityconfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PublicIdentitiesConfigV1 => Publicidentityconfig' | Write-Debug
...
function ConvertFrom-JsonToPublicidentityconfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PublicIdentitiesConfigV1 => Publicidentityconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

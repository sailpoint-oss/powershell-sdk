...
function Initialize-BetaSodExemptCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSodExemptCriteria' | Write-Debug
...
function ConvertFrom-BetaJsonToSodExemptCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSodExemptCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

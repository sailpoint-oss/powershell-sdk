...
function Initialize-BetaBulkIdentitiesAccountsResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaBulkIdentitiesAccountsResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToBulkIdentitiesAccountsResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaBulkIdentitiesAccountsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

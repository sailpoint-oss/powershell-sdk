...
function Initialize-Entitlementattributebulkupdatequeryrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Entitlementattributebulkupdatequeryrequest' | Write-Debug
...
Entitlementattributebulkupdatequeryrequest<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementattributebulkupdatequeryrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Entitlementattributebulkupdatequeryrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Entitlementattributebulkupdatequeryrequest

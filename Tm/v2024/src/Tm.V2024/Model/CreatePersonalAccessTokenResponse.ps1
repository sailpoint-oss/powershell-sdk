...
function Initialize-V2024CreatePersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CreatePersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToCreatePersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CreatePersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner' | Write-Debug
...
AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner

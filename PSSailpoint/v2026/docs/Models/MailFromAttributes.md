...
keywords: ['powershell', 'PowerShell', 'sdk', 'MailFromAttributes', 'V2026MailFromAttributes'] 
slug: /tools/sdk/powershell/v2026/models/mail-from-attributes
...
```powershell
$MailFromAttributes = Initialize-V2026MailFromAttributes  -Identity bob.smith@sailpoint.com `

...
function Initialize-V2024NonEmployeeApprovalItemDetail {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeApprovalItemDetail' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeApprovalItemDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeApprovalItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

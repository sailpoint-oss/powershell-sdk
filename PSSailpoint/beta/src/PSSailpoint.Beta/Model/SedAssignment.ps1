...
function Initialize-BetaSedAssignment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSedAssignment' | Write-Debug
...
function ConvertFrom-BetaJsonToSedAssignment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSedAssignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

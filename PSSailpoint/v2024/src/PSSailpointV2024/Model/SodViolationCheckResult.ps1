...
function Initialize-V2024SodViolationCheckResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SodViolationCheckResult' | Write-Debug
...
function ConvertFrom-V2024JsonToSodViolationCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SodViolationCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Get-AuthUserV1 {
    ...
    Process {
        'Calling method: Get-AuthUserV1' | Write-Debug
        ...
        $LocalVarUri = '/auth-users/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getAuthUserV1."
        }
...
function Update-AuthUserV1 {
    ...
    Process {
        'Calling method: Update-AuthUserV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/auth-users/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling patchAuthUserV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

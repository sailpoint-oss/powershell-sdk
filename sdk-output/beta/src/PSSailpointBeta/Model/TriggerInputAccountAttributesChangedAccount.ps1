...
TriggerInputAccountAttributesChangedAccount<PSCustomObject>
#>

function Initialize-BetaTriggerInputAccountAttributesChangedAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountAttributesChangedAccount' | Write-Debug
...
Convert from JSON to TriggerInputAccountAttributesChangedAccount<PSCustomObject>
...
TriggerInputAccountAttributesChangedAccount<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputAccountAttributesChangedAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountAttributesChangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputAccountAttributesChangedAccount

...
function Initialize-IdentityAttributeTransform {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityAttributeTransform' | Write-Debug
...
function ConvertFrom-JsonToIdentityAttributeTransform {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityAttributeTransform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026DataAccessCategoriesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026DataAccessCategoriesInner' | Write-Debug
...
DataAccessCategoriesInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToDataAccessCategoriesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026DataAccessCategoriesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026DataAccessCategoriesInner

...
function Initialize-Validatefilterinputdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Validatefilterinputdto' | Write-Debug
...
Validatefilterinputdto<PSCustomObject>
#>
function ConvertFrom-JsonToValidatefilterinputdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Validatefilterinputdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Validatefilterinputdto

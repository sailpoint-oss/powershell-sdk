...
function Initialize-V2026MachineIdentityCreatedMachineIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityCreatedMachineIdentity' | Write-Debug
...
MachineIdentityCreatedMachineIdentity<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMachineIdentityCreatedMachineIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityCreatedMachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MachineIdentityCreatedMachineIdentity

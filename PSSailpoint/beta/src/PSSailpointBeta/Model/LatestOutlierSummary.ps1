...
function Initialize-BetaLatestOutlierSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaLatestOutlierSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToLatestOutlierSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaLatestOutlierSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

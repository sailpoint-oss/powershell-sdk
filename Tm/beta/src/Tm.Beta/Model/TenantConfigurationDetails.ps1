...
function Initialize-BetaTenantConfigurationDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaTenantConfigurationDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToTenantConfigurationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaTenantConfigurationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

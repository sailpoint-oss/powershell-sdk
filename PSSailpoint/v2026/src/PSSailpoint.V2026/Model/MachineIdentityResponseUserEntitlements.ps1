...
function Initialize-V2026MachineIdentityResponseUserEntitlements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityResponseUserEntitlements' | Write-Debug
...
MachineIdentityResponseUserEntitlements<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMachineIdentityResponseUserEntitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityResponseUserEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MachineIdentityResponseUserEntitlements

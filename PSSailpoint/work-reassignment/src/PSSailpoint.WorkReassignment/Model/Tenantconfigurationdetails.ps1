...
function Initialize-Tenantconfigurationdetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.WorkReassignmentV1 => Tenantconfigurationdetails' | Write-Debug
...
Tenantconfigurationdetails<PSCustomObject>
#>
function ConvertFrom-JsonToTenantconfigurationdetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.WorkReassignmentV1 => Tenantconfigurationdetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Tenantconfigurationdetails

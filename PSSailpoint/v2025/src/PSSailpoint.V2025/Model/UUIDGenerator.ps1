...
function Initialize-V2025UUIDGenerator {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025UUIDGenerator' | Write-Debug
...
UUIDGenerator<PSCustomObject>
#>
function ConvertFrom-V2025JsonToUUIDGenerator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025UUIDGenerator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025UUIDGenerator

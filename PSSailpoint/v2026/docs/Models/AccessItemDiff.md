...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessItemDiff', 'V2026AccessItemDiff'] 
slug: /tools/sdk/powershell/v2026/models/access-item-diff
...
```powershell
$AccessItemDiff = Initialize-V2026AccessItemDiff  -Id null `
 -EventType null `
 -DisplayName null `
 -SourceName null
```

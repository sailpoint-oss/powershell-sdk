...
Accessrequestpreapproval2<PSCustomObject>
#>

function Initialize-Accessrequestpreapproval2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Accessrequestpreapproval2' | Write-Debug
...
Convert from JSON to Accessrequestpreapproval2<PSCustomObject>
...
Accessrequestpreapproval2<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestpreapproval2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Accessrequestpreapproval2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessrequestpreapproval2

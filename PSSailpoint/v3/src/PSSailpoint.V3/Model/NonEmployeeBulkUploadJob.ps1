...
function Initialize-NonEmployeeBulkUploadJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeBulkUploadJob' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeBulkUploadJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeBulkUploadJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

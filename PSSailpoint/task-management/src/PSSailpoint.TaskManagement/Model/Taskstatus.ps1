...
function Initialize-Taskstatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TaskManagementV1 => Taskstatus' | Write-Debug
...
function ConvertFrom-JsonToTaskstatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TaskManagementV1 => Taskstatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

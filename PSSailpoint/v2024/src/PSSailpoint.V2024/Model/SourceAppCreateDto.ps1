...
function Initialize-V2024SourceAppCreateDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SourceAppCreateDto' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceAppCreateDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SourceAppCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024VendorConnectorMappingDeletedBy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024VendorConnectorMappingDeletedBy' | Write-Debug
...
function ConvertFrom-V2024JsonToVendorConnectorMappingDeletedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024VendorConnectorMappingDeletedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

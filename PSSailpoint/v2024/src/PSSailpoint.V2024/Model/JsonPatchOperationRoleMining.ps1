...
function Initialize-V2024JsonPatchOperationRoleMining {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024JsonPatchOperationRoleMining' | Write-Debug
...
JsonPatchOperationRoleMining<PSCustomObject>
#>
function ConvertFrom-V2024JsonToJsonPatchOperationRoleMining {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024JsonPatchOperationRoleMining' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024JsonPatchOperationRoleMining

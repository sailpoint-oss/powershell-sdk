...
function Initialize-V2024SavedSearchCompleteSearchResultsAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SavedSearchCompleteSearchResultsAccount' | Write-Debug
...
function ConvertFrom-V2024JsonToSavedSearchCompleteSearchResultsAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SavedSearchCompleteSearchResultsAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026PasswordInfoAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026PasswordInfoAccount' | Write-Debug
...
PasswordInfoAccount<PSCustomObject>
#>
function ConvertFrom-V2026JsonToPasswordInfoAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026PasswordInfoAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026PasswordInfoAccount

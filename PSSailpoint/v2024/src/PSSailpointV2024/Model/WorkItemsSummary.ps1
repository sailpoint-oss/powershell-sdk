...
function Initialize-V2024WorkItemsSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkItemsSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkItemsSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkItemsSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-CampaignsDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CampaignsDeleteRequest' | Write-Debug
...
function ConvertFrom-JsonToCampaignsDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CampaignsDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024AccessRequestPreApproval {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequestPreApproval' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestPreApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequestPreApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

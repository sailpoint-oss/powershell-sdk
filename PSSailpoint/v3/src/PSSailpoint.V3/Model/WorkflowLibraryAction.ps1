...
function Initialize-WorkflowLibraryAction {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => WorkflowLibraryAction' | Write-Debug
...
function ConvertFrom-JsonToWorkflowLibraryAction {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => WorkflowLibraryAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

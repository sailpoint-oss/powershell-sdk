...
keywords: ['powershell', 'PowerShell', 'sdk', 'SpConfigExportJobStatus', 'V2026SpConfigExportJobStatus'] 
slug: /tools/sdk/powershell/v2026/models/sp-config-export-job-status
...
```powershell
$SpConfigExportJobStatus = Initialize-V2026SpConfigExportJobStatus  -JobId 3469b87d-48ca-439a-868f-2160001da8c1 `
 -Status COMPLETE `
 -Type IMPORT `

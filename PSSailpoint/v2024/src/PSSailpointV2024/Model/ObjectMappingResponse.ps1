...
function Initialize-V2024ObjectMappingResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ObjectMappingResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToObjectMappingResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ObjectMappingResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

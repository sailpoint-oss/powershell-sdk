...
function Initialize-TenantUiMetadataItemResponse {
    [CmdletBinding()]
    Param (
...
TenantUiMetadataItemResponse<PSCustomObject>
#>
function ConvertFrom-JsonToTenantUiMetadataItemResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in TenantUiMetadataItemResponse

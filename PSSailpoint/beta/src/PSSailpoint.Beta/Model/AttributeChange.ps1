...
function Initialize-BetaAttributeChange {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAttributeChange' | Write-Debug
...
function ConvertFrom-BetaJsonToAttributeChange {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAttributeChange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

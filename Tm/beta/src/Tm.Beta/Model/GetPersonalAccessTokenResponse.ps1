...
function Initialize-BetaGetPersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaGetPersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToGetPersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaGetPersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

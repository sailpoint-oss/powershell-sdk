...
function Initialize-AccesscriteriaCriteriaListInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SodPoliciesV1 => AccesscriteriaCriteriaListInner' | Write-Debug
...
function ConvertFrom-JsonToAccesscriteriaCriteriaListInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SodPoliciesV1 => AccesscriteriaCriteriaListInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

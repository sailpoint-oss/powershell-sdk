...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMembershipSelector', 'V2026RoleMembershipSelector'] 
slug: /tools/sdk/powershell/v2026/models/role-membership-selector
...
```powershell
$RoleMembershipSelector = Initialize-V2026RoleMembershipSelector  -Type null `
 -Criteria null `
 -Identities null
```

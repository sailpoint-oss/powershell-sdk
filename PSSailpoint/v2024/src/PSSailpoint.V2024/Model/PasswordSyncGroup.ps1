...
function Initialize-V2024PasswordSyncGroup {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024PasswordSyncGroup' | Write-Debug
...
function ConvertFrom-V2024JsonToPasswordSyncGroup {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024PasswordSyncGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

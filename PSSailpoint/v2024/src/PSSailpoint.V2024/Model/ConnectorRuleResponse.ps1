...
function Initialize-V2024ConnectorRuleResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConnectorRuleResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToConnectorRuleResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConnectorRuleResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaExportFormDefinitionsByTenant200ResponseInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaExportFormDefinitionsByTenant200ResponseInner' | Write-Debug
...
function ConvertFrom-BetaJsonToExportFormDefinitionsByTenant200ResponseInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaExportFormDefinitionsByTenant200ResponseInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

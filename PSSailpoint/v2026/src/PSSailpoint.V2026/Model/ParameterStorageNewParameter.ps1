...
function Initialize-V2026ParameterStorageNewParameter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageNewParameter' | Write-Debug
...
ParameterStorageNewParameter<PSCustomObject>
#>
function ConvertFrom-V2026JsonToParameterStorageNewParameter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageNewParameter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ParameterStorageNewParameter

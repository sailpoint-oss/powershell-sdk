...
keywords: ['powershell', 'PowerShell', 'sdk', 'ScheduledSearch', 'V2026ScheduledSearch'] 
slug: /tools/sdk/powershell/v2026/methods/scheduled-search
...
------------- | ------------- | -------------
[**New-V2026ScheduledSearch**](#create-scheduled-search) | **POST** `/scheduled-searches` | Create a new scheduled search
[**Remove-V2026ScheduledSearch**](#delete-scheduled-search) | **DELETE** `/scheduled-searches/{id}` | Delete a scheduled search
[**Get-V2026ScheduledSearch**](#get-scheduled-search) | **GET** `/scheduled-searches/{id}` | Get a scheduled search
[**Get-V2026ScheduledSearch**](#list-scheduled-search) | **GET** `/scheduled-searches` | List scheduled searches
[**Invoke-V2026UnsubscribeScheduledSearch**](#unsubscribe-scheduled-search) | **POST** `/scheduled-searches/{id}/unsubscribe` | Unsubscribe a recipient from scheduled search
[**Update-V2026ScheduledSearch**](#update-scheduled-search) | **PUT** `/scheduled-searches/{id}` | Update an existing scheduled search
...
try {
    $Result = ConvertFrom-V2026JsonToCreateScheduledSearchRequest -Json $CreateScheduledSearchRequest
    New-V2026ScheduledSearch -CreateScheduledSearchRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026ScheduledSearch -CreateScheduledSearchRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026ScheduledSearch"
...
try {
    Remove-V2026ScheduledSearch -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026ScheduledSearch -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026ScheduledSearch"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ScheduledSearch -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ScheduledSearch -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ScheduledSearch"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026ScheduledSearch -Offset $Offset -Limit $Limit -Count $Count -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ScheduledSearch"
    Write-Host $_.ErrorDetails
}
...
try {
    $Result = ConvertFrom-V2026JsonToTypedReference -Json $TypedReference
    Invoke-V2026UnsubscribeScheduledSearch -Id $Id -TypedReference $Result 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026UnsubscribeScheduledSearch -Id $Id -TypedReference $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026UnsubscribeScheduledSearch"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToScheduledSearch -Json $ScheduledSearch
    Update-V2026ScheduledSearch -Id $Id -ScheduledSearch $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ScheduledSearch -Id $Id -ScheduledSearch $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ScheduledSearch"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-VendorConnectorMapping {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => VendorConnectorMapping' | Write-Debug
...
function ConvertFrom-JsonToVendorConnectorMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => VendorConnectorMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

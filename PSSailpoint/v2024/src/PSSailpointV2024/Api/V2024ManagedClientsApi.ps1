...
ManagedClient
#>
function New-V2024ManagedClient {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2024ManagedClient' | Write-Debug
...
None
#>
function Remove-V2024ManagedClient {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2024ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClient
#>
function Get-V2024ManagedClient {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClientStatus
#>
function Get-V2024ManagedClientStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024ManagedClientStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClient[]
#>
function Get-V2024ManagedClients {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2024ManagedClients' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClient
#>
function Update-V2024ManagedClient {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2024ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ConnectorRuleCreateRequestSignature {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ConnectorRuleCreateRequestSignature' | Write-Debug
...
function ConvertFrom-V2024JsonToConnectorRuleCreateRequestSignature {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ConnectorRuleCreateRequestSignature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024MailFromAttributesDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024MailFromAttributesDto' | Write-Debug
...
function ConvertFrom-V2024JsonToMailFromAttributesDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024MailFromAttributesDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

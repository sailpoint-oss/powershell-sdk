...
function Initialize-DataAccessCategoriesInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => DataAccessCategoriesInner' | Write-Debug
...
function ConvertFrom-JsonToDataAccessCategoriesInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => DataAccessCategoriesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

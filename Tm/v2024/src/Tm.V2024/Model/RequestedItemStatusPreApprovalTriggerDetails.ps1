...
function Initialize-V2024RequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

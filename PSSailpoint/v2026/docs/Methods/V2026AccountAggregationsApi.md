...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountAggregations', 'V2026AccountAggregations'] 
slug: /tools/sdk/powershell/v2026/methods/account-aggregations
...
------------- | ------------- | -------------
[**Get-V2026AccountAggregationStatus**](#get-account-aggregation-status) | **GET** `/account-aggregations/{id}/status` | In-progress account aggregation status
...
try {
    Get-V2026AccountAggregationStatus -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AccountAggregationStatus -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccountAggregationStatus"

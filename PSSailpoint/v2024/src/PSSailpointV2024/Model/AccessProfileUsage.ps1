...
function Initialize-V2024AccessProfileUsage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileUsage' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileUsage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

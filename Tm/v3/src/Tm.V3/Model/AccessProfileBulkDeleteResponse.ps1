...
function Initialize-AccessProfileBulkDeleteResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => AccessProfileBulkDeleteResponse' | Write-Debug
...
function ConvertFrom-JsonToAccessProfileBulkDeleteResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => AccessProfileBulkDeleteResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

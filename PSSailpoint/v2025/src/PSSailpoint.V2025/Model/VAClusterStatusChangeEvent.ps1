...
function Initialize-V2025VAClusterStatusChangeEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025VAClusterStatusChangeEvent' | Write-Debug
...
VAClusterStatusChangeEvent<PSCustomObject>
#>
function ConvertFrom-V2025JsonToVAClusterStatusChangeEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025VAClusterStatusChangeEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025VAClusterStatusChangeEvent

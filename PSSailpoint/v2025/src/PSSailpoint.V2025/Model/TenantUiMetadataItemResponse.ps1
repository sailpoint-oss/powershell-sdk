...
function Initialize-V2025TenantUiMetadataItemResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025TenantUiMetadataItemResponse' | Write-Debug
...
TenantUiMetadataItemResponse<PSCustomObject>
#>
function ConvertFrom-V2025JsonToTenantUiMetadataItemResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025TenantUiMetadataItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025TenantUiMetadataItemResponse

...
function Initialize-BetaJsonPatchOperations {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaJsonPatchOperations' | Write-Debug
...
function ConvertFrom-BetaJsonToJsonPatchOperations {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaJsonPatchOperations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

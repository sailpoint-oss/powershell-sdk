...
function Initialize-BetaRoleMiningSessionStatus {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningSessionStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningSessionStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningSessionStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024NonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
...
NonEmployeeSourceLiteWithSchemaAttributes<PSCustomObject>
#>
function ConvertFrom-V2024JsonToNonEmployeeSourceLiteWithSchemaAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024NonEmployeeSourceLiteWithSchemaAttributes

...
#>
function New-V2026FormDefinition {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026FormDefinition' | Write-Debug
...
#>
function New-V2026FormDefinitionDynamicSchema {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: New-V2026FormDefinitionDynamicSchema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function New-V2026FormDefinitionFileRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: New-V2026FormDefinitionFileRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function New-V2026FormInstance {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: New-V2026FormInstance' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Remove-V2026FormDefinition {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026FormDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Export-V2026FormDefinitionsByTenant {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Export-V2026FormDefinitionsByTenant' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026FileFromS3 {
    ...
    Process {
        'Calling method: Get-V2026FileFromS3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
FormDefinitionResponse
#>
function Get-V2026FormDefinitionByKey {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026FormDefinitionByKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
FormInstanceResponse
#>
function Get-V2026FormInstanceByKey {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026FormInstanceByKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
System.IO.FileInfo
#>
function Get-V2026FormInstanceFile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026FormInstanceFile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Import-V2026FormDefinitions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Import-V2026FormDefinitions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
FormDefinitionResponse
#>
function Update-V2026FormDefinition {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026FormDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
FormInstanceResponse
#>
function Update-V2026FormInstance {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026FormInstance' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Search-V2026FormDefinitionsByTenant {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int64]]
    ...
    Process {
        'Calling method: Search-V2026FormDefinitionsByTenant' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Search-V2026FormElementDataByElementID {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Search-V2026FormElementDataByElementID' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Search-V2026FormInstancesByTenant {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Search-V2026FormInstancesByTenant' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Search-V2026PreDefinedSelectOptions {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Search-V2026PreDefinedSelectOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Show-V2026PreviewDataSource {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Show-V2026PreviewDataSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

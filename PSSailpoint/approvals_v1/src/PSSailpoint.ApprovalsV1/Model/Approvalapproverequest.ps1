...
function Initialize-Approvalapproverequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApprovalsV1 => Approvalapproverequest' | Write-Debug
...
Approvalapproverequest<PSCustomObject>
#>
function ConvertFrom-JsonToApprovalapproverequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApprovalsV1 => Approvalapproverequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

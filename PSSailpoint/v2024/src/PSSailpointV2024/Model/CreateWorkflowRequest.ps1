...
function Initialize-V2024CreateWorkflowRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CreateWorkflowRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateWorkflowRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CreateWorkflowRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026SourceAppAccountSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SourceAppAccountSource' | Write-Debug
...
SourceAppAccountSource<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSourceAppAccountSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SourceAppAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SourceAppAccountSource

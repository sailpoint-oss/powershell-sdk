...
function Initialize-IdentityAssociationDetailsAssociationDetailsInner {
    [CmdletBinding()]
    Param (
...
IdentityAssociationDetailsAssociationDetailsInner<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityAssociationDetailsAssociationDetailsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in IdentityAssociationDetailsAssociationDetailsInner

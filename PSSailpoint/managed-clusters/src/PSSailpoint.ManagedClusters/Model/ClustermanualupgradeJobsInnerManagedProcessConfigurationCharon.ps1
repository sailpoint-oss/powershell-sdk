...
function Initialize-ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClusters => ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
...
function ConvertFrom-JsonToClustermanualupgradeJobsInnerManagedProcessConfigurationCharon {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClusters => ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

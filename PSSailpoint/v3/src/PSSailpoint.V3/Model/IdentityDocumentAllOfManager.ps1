...
function Initialize-IdentityDocumentAllOfManager {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityDocumentAllOfManager' | Write-Debug
...
function ConvertFrom-JsonToIdentityDocumentAllOfManager {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityDocumentAllOfManager' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-MachineClassificationConfig {
    [CmdletBinding()]
    Param (
...
MachineClassificationConfig<PSCustomObject>
#>
function ConvertFrom-JsonToMachineClassificationConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in MachineClassificationConfig

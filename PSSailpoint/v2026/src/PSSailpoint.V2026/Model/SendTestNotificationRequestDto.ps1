...
function Initialize-V2026SendTestNotificationRequestDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SendTestNotificationRequestDto' | Write-Debug
...
SendTestNotificationRequestDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSendTestNotificationRequestDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SendTestNotificationRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SendTestNotificationRequestDto

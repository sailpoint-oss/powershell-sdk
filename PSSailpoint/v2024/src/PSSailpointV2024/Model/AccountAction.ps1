...
function Initialize-V2024AccountAction {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountAction' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAction {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Entitlementaccessrequestconfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.EntitlementsV1 => Entitlementaccessrequestconfig' | Write-Debug
...
function ConvertFrom-JsonToEntitlementaccessrequestconfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.EntitlementsV1 => Entitlementaccessrequestconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

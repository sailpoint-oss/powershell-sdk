...
function Initialize-V2024VAClusterStatusChangeEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024VAClusterStatusChangeEvent' | Write-Debug
...
VAClusterStatusChangeEvent<PSCustomObject>
#>
function ConvertFrom-V2024JsonToVAClusterStatusChangeEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024VAClusterStatusChangeEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024VAClusterStatusChangeEvent

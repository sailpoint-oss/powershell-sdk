...
function Initialize-V2026AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner' | Write-Debug
...
AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner

...
PasswordSyncGroup
#>
function New-V2026PasswordSyncGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026PasswordSyncGroup' | Write-Debug
...
None
#>
function Remove-V2026PasswordSyncGroup {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026PasswordSyncGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordSyncGroup
#>
function Get-V2026PasswordSyncGroup {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026PasswordSyncGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordSyncGroup[]
#>
function Get-V2026PasswordSyncGroups {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026PasswordSyncGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordSyncGroup
#>
function Update-V2026PasswordSyncGroup {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026PasswordSyncGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

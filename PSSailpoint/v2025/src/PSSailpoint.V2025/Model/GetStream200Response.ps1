...
#>
function ConvertFrom-V2025JsonToGetStream200Response {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            $matchInstance = ConvertFrom-V2025JsonToStreamConfigResponse $Json
            ...
            Write-Debug "Failed to match 'StreamConfigResponse' defined in oneOf (V2025GetStream200Response). Proceeding to the next one if any."
        }

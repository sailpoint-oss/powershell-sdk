...
keywords: ['powershell', 'PowerShell', 'sdk', 'MultiHostIntegrationsConnectorAttributes', 'V2026MultiHostIntegrationsConnectorAttributes'] 
slug: /tools/sdk/powershell/v2026/models/multi-host-integrations-connector-attributes
...
```powershell
$MultiHostIntegrationsConnectorAttributes = Initialize-V2026MultiHostIntegrationsConnectorAttributes  -MaxAllowedSources 250 `

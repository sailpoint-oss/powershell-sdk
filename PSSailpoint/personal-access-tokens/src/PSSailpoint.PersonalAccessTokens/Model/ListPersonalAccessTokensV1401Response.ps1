...
ListPersonalAccessTokensV1401Response<PSCustomObject>
#>

function Initialize-ListPersonalAccessTokensV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListPersonalAccessTokensV1401Response<PSCustomObject>
...
ListPersonalAccessTokensV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToListPersonalAccessTokensV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListPersonalAccessTokensV1401Response
        $AllProperties = ("error")

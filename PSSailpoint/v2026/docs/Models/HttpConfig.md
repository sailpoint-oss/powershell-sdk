...
keywords: ['powershell', 'PowerShell', 'sdk', 'HttpConfig', 'V2026HttpConfig'] 
slug: /tools/sdk/powershell/v2026/models/http-config
...
```powershell
$HttpConfig = Initialize-V2026HttpConfig  -Url https://www.example.com `

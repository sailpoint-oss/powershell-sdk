...
function Initialize-BetaCreateWorkflowRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaCreateWorkflowRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateWorkflowRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaCreateWorkflowRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025AccessRequestDynamicApprover {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccessRequestDynamicApprover' | Write-Debug
...
AccessRequestDynamicApprover<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccessRequestDynamicApprover {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccessRequestDynamicApprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccessRequestDynamicApprover

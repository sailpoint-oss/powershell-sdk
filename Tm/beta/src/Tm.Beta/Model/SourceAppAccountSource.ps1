...
function Initialize-BetaSourceAppAccountSource {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSourceAppAccountSource' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceAppAccountSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSourceAppAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaProcessIdentitiesRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaProcessIdentitiesRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToProcessIdentitiesRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaProcessIdentitiesRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

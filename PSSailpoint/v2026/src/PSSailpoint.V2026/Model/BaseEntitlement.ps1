...
function Initialize-V2026BaseEntitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026BaseEntitlement' | Write-Debug
...
BaseEntitlement<PSCustomObject>
#>
function ConvertFrom-V2026JsonToBaseEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026BaseEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026BaseEntitlement

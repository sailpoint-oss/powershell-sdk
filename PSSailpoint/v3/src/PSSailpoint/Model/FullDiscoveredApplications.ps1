...
function Initialize-FullDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => FullDiscoveredApplications' | Write-Debug
...
function ConvertFrom-JsonToFullDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => FullDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaNonEmployeeBulkUploadJob {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeBulkUploadJob' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeBulkUploadJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeBulkUploadJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'DependantConnectionsMissingDto', 'V2026DependantConnectionsMissingDto'] 
slug: /tools/sdk/powershell/v2026/models/dependant-connections-missing-dto
...
```powershell
$DependantConnectionsMissingDto = Initialize-V2026DependantConnectionsMissingDto  -DependencyType dependantApps `

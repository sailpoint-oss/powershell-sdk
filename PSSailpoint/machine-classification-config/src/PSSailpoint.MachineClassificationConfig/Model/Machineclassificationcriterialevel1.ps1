...
function Initialize-Machineclassificationcriterialevel1 {
    [CmdletBinding()]
    Param (
...
Machineclassificationcriterialevel1<PSCustomObject>
#>
function ConvertFrom-JsonToMachineclassificationcriterialevel1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Machineclassificationcriterialevel1

...
function Initialize-TaskResultDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Sources => TaskResultDetails' | Write-Debug
...
TaskResultDetails<PSCustomObject>
#>
function ConvertFrom-JsonToTaskResultDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Sources => TaskResultDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TaskResultDetails
        $AllProperties = ("id", "type", "name", "description", "launcher", "created", "launched", "completed", "completionStatus", "parentName", "progress")

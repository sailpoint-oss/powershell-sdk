...
```powershell
$TriggerInputAccessRequestPreApprovalRequestedItemsInner = Initialize-PSSailpointBetaTriggerInputAccessRequestPreApprovalRequestedItemsInner  -Id 2c91808b6ef1d43e016efba0ce470904 `
...
```powershell
$TriggerInputAccessRequestPreApprovalRequestedItemsInner | ConvertTo-JSON
```

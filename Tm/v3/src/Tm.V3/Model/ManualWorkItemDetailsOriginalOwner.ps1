...
function Initialize-ManualWorkItemDetailsOriginalOwner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ManualWorkItemDetailsOriginalOwner' | Write-Debug
...
function ConvertFrom-JsonToManualWorkItemDetailsOriginalOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ManualWorkItemDetailsOriginalOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

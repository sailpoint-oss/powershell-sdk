...
function Initialize-SessionConfiguration {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SessionConfiguration' | Write-Debug
...
function ConvertFrom-JsonToSessionConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SessionConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

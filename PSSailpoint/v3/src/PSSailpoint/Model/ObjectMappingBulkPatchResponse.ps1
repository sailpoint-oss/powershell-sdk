...
function Initialize-ObjectMappingBulkPatchResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ObjectMappingBulkPatchResponse' | Write-Debug
...
function ConvertFrom-JsonToObjectMappingBulkPatchResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ObjectMappingBulkPatchResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

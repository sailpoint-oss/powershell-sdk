...
keywords: ['powershell', 'PowerShell', 'sdk', 'TemplateDtoSlackTemplate', 'BetaTemplateDtoSlackTemplate'] 
slug: /tools/sdk/powershell/beta/models/template-dto-slack-template
...
```powershell
$TemplateDtoSlackTemplate = Initialize-BetaTemplateDtoSlackTemplate  -Key null `

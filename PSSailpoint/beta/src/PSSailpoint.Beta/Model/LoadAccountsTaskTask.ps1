...
function Initialize-BetaLoadAccountsTaskTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaLoadAccountsTaskTask' | Write-Debug
...
LoadAccountsTaskTask<PSCustomObject>
#>
function ConvertFrom-BetaJsonToLoadAccountsTaskTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaLoadAccountsTaskTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaLoadAccountsTaskTask

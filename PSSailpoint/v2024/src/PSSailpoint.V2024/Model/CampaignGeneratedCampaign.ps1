...
function Initialize-V2024CampaignGeneratedCampaign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CampaignGeneratedCampaign' | Write-Debug
...
CampaignGeneratedCampaign<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCampaignGeneratedCampaign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CampaignGeneratedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024CampaignGeneratedCampaign

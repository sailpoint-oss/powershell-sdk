...
function Initialize-V2025CommonAccessIDStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CommonAccessIDStatus' | Write-Debug
...
CommonAccessIDStatus<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCommonAccessIDStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CommonAccessIDStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CommonAccessIDStatus

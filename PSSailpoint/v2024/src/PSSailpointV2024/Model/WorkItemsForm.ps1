...
function Initialize-V2024WorkItemsForm {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkItemsForm' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkItemsForm {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkItemsForm' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

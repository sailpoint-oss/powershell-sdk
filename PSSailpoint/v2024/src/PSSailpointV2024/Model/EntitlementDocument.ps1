...
function Initialize-V2024EntitlementDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024EntitlementDocument' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlementDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024EntitlementDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
**FederationProtocolDetails** | [**ServiceProviderConfigurationFederationProtocolDetailsInner[]**](ServiceProviderConfigurationFederationProtocolDetailsInner.md) | A list of the abstract implementations of the Federation Protocol details. Typically, this will include on SpDetails object and one IdpDetails object used in tandem to define a SAML integration between a customer&#39;s identity provider and a customer&#39;s SailPoint instance (i.e., the service provider). | [optional] 

## Examples

- Prepare the resource
```powershell
$ServiceProviderConfiguration = Initialize-PSSailpointServiceProviderConfiguration  -Enabled true `
 -BypassIdp true `

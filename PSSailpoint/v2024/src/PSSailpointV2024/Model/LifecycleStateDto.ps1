...
function Initialize-V2024LifecycleStateDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024LifecycleStateDto' | Write-Debug
...
function ConvertFrom-V2024JsonToLifecycleStateDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024LifecycleStateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026BulkIdentitiesAccountsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026BulkIdentitiesAccountsResponse' | Write-Debug
...
BulkIdentitiesAccountsResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToBulkIdentitiesAccountsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026BulkIdentitiesAccountsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026BulkIdentitiesAccountsResponse

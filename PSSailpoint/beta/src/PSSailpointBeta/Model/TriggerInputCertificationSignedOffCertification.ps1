...
TriggerInputCertificationSignedOffCertification<PSCustomObject>
#>

function Initialize-BetaTriggerInputCertificationSignedOffCertification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputCertificationSignedOffCertification' | Write-Debug
...
Convert from JSON to TriggerInputCertificationSignedOffCertification<PSCustomObject>
...
TriggerInputCertificationSignedOffCertification<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputCertificationSignedOffCertification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputCertificationSignedOffCertification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputCertificationSignedOffCertification

...
function Initialize-BetaAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInnerApprover {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInnerApprover' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInnerApprover {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInnerApprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

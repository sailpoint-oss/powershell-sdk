...
function Initialize-V2026Owns {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026Owns' | Write-Debug
...
Owns<PSCustomObject>
#>
function ConvertFrom-V2026JsonToOwns {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026Owns' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026Owns

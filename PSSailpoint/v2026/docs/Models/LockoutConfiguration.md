...
keywords: ['powershell', 'PowerShell', 'sdk', 'LockoutConfiguration', 'V2026LockoutConfiguration'] 
slug: /tools/sdk/powershell/v2026/models/lockout-configuration
...
```powershell
$LockoutConfiguration = Initialize-V2026LockoutConfiguration  -MaximumAttempts 5 `
 -LockoutDuration 15 `
 -LockoutWindow 5
```

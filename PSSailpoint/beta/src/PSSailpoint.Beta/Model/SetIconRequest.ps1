...
function Initialize-BetaSetIconRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSetIconRequest' | Write-Debug
...
SetIconRequest<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSetIconRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSetIconRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSetIconRequest
        $AllProperties = ("image")

...
function Initialize-BetaSavedSearchCompleteSearchResultsIdentity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSavedSearchCompleteSearchResultsIdentity' | Write-Debug
...
function ConvertFrom-BetaJsonToSavedSearchCompleteSearchResultsIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSavedSearchCompleteSearchResultsIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ScheduledActionPayload', 'V2026ScheduledActionPayload'] 
slug: /tools/sdk/powershell/v2026/models/scheduled-action-payload
...
```powershell
$ScheduledActionPayload = Initialize-V2026ScheduledActionPayload  -JobType BACKUP `

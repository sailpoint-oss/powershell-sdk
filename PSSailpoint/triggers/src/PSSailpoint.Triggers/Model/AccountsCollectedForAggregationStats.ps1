...
function Initialize-AccountsCollectedForAggregationStats {
    [CmdletBinding()]
    Param (
...
AccountsCollectedForAggregationStats<PSCustomObject>
#>
function ConvertFrom-JsonToAccountsCollectedForAggregationStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccountsCollectedForAggregationStats

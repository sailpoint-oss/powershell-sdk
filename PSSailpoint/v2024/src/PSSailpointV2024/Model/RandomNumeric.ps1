...
function Initialize-V2024RandomNumeric {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RandomNumeric' | Write-Debug
...
function ConvertFrom-V2024JsonToRandomNumeric {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RandomNumeric' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

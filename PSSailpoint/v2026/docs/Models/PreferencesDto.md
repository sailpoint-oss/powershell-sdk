...
keywords: ['powershell', 'PowerShell', 'sdk', 'PreferencesDto', 'V2026PreferencesDto'] 
slug: /tools/sdk/powershell/v2026/models/preferences-dto
...
```powershell
$PreferencesDto = Initialize-V2026PreferencesDto  -Key cloud_manual_work_item_summary `
 -Mediums [EMAIL] `

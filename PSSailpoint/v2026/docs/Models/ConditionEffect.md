...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConditionEffect', 'V2026ConditionEffect'] 
slug: /tools/sdk/powershell/v2026/models/condition-effect
...
```powershell
$ConditionEffect = Initialize-V2026ConditionEffect  -EffectType HIDE `
 -Config null
```

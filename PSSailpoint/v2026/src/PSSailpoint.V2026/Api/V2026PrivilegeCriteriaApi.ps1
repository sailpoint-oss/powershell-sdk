...
#>
function New-V2026CustomPrivilegeCriteria {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026CustomPrivilegeCriteria' | Write-Debug
...
None
#>
function Remove-V2026CustomPrivilegeCriteria {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026CustomPrivilegeCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PrivilegeCriteriaDTO
#>
function Get-V2026PrivilegeCriteria {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026PrivilegeCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PrivilegeCriteriaDTO
#>
function Send-V2026CustomPrivilegeCriteriaValue {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2026CustomPrivilegeCriteriaValue' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

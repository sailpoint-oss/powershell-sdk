...
function Get-StatusBySourceIdV1 {
    ...
    Process {
        'Calling method: Get-StatusBySourceIdV1' | Write-Debug
        ...
        $LocalVarUri = '/source-usages/v1/{sourceId}/status'
        if (!$SourceId) {
            throw "Error! The required parameter `SourceId` missing when calling getStatusBySourceIdV1."
        }
...
function Get-UsagesBySourceIdV1 {
    ...
    Process {
        'Calling method: Get-UsagesBySourceIdV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/source-usages/v1/{sourceId}/summaries'
        if (!$SourceId) {
            throw "Error! The required parameter `SourceId` missing when calling getUsagesBySourceIdV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{sourceId}', [System.Web.HTTPUtility]::UrlEncode($SourceId))

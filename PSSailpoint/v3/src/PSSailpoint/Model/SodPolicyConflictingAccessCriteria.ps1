...
function Initialize-SodPolicyConflictingAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => SodPolicyConflictingAccessCriteria' | Write-Debug
...
function ConvertFrom-JsonToSodPolicyConflictingAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => SodPolicyConflictingAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026RecommenderCalculations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RecommenderCalculations' | Write-Debug
...
RecommenderCalculations<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRecommenderCalculations {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RecommenderCalculations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RecommenderCalculations

...
function Remove-AccountRequestV1 {
    ...
    Process {
        'Calling method: Remove-AccountRequestV1' | Write-Debug
        ...
        $LocalVarUri = '/account-requests/v1/account/{accountId}/delete'
        if (!$AccountId) {
            throw "Error! The required parameter `AccountId` missing when calling deleteAccountRequestV1."
        }
...
function Get-AccountDeletionRequestsV1 {
    ...
    Process {
        'Calling method: Get-AccountDeletionRequestsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/account-requests/v1/deletion'

...
function Initialize-BetaTemplateSlackAutoApprovalData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTemplateSlackAutoApprovalData' | Write-Debug
...
TemplateSlackAutoApprovalData<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTemplateSlackAutoApprovalData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTemplateSlackAutoApprovalData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTemplateSlackAutoApprovalData

...
function Initialize-V2026ApprovalApprovalCriteriaApproval {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApprovalApprovalCriteriaApproval' | Write-Debug
...
ApprovalApprovalCriteriaApproval<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApprovalApprovalCriteriaApproval {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApprovalApprovalCriteriaApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApprovalApprovalCriteriaApproval

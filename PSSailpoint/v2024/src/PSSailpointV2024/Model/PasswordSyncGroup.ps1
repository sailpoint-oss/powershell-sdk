...
function Initialize-V2024PasswordSyncGroup {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PasswordSyncGroup' | Write-Debug
...
function ConvertFrom-V2024JsonToPasswordSyncGroup {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PasswordSyncGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

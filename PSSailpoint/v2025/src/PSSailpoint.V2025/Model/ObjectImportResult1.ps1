...
ObjectImportResult1<PSCustomObject>
#>

function Initialize-V2025ObjectImportResult1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ObjectImportResult1' | Write-Debug
...
Convert from JSON to ObjectImportResult1<PSCustomObject>
...
ObjectImportResult1<PSCustomObject>
#>
function ConvertFrom-V2025JsonToObjectImportResult1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ObjectImportResult1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ObjectImportResult1

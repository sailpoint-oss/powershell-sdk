...
function Initialize-BetaMultiHostIntegrationsConnectorAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaMultiHostIntegrationsConnectorAttributes' | Write-Debug
...
MultiHostIntegrationsConnectorAttributes<PSCustomObject>
#>
function ConvertFrom-BetaJsonToMultiHostIntegrationsConnectorAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaMultiHostIntegrationsConnectorAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $BetaMultiHostIntegrationsConnectorAttributesAdditionalProperties = @{}

        # check if Json contains properties not defined in BetaMultiHostIntegrationsConnectorAttributes
        ...
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            ...
            if (!($AllProperties.Contains($name))) {
                $BetaMultiHostIntegrationsConnectorAttributesAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "showEntitlementSchema" = ${ShowEntitlementSchema}
            "multiHostAttributes" = ${MultiHostAttributes}
            "AdditionalProperties" = $BetaMultiHostIntegrationsConnectorAttributesAdditionalProperties
        }

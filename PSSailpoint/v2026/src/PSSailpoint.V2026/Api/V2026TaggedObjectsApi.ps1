...
None
#>
function Remove-V2026TaggedObject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Remove-V2026TaggedObject' | Write-Debug
...
None
#>
function Remove-V2026TagsToManyObject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Remove-V2026TagsToManyObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject
#>
function Get-V2026TaggedObject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [ValidateSet("ACCESS_PROFILE", "APPLICATION", "CAMPAIGN", "ENTITLEMENT", "IDENTITY", "ROLE", "SOD_POLICY", "SOURCE")]
    ...
    Process {
        'Calling method: Get-V2026TaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject[]
#>
function Get-V2026TaggedObjects {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026TaggedObjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject[]
#>
function Get-V2026TaggedObjectsByType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [ValidateSet("ACCESS_PROFILE", "APPLICATION", "CAMPAIGN", "ENTITLEMENT", "IDENTITY", "ROLE", "SOD_POLICY", "SOURCE")]
    ...
    Process {
        'Calling method: Get-V2026TaggedObjectsByType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject
#>
function Send-V2026TaggedObject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [ValidateSet("ACCESS_PROFILE", "APPLICATION", "CAMPAIGN", "ENTITLEMENT", "IDENTITY", "ROLE", "SOD_POLICY", "SOURCE")]
    ...
    Process {
        'Calling method: Send-V2026TaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Set-V2026TagToObject {
    ...
    Process {
        'Calling method: Set-V2026TagToObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Set-V2026TagsToManyObjects {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Set-V2026TagsToManyObjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
LauncherRequest<PSCustomObject>
#>

function Initialize-V2025LauncherRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025LauncherRequest' | Write-Debug
...
Convert from JSON to LauncherRequest<PSCustomObject>
...
LauncherRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToLauncherRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025LauncherRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025LauncherRequest
        $AllProperties = ("name", "description", "type", "disabled", "reference", "config")

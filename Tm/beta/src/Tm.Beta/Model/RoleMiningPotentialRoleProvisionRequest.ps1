...
function Initialize-BetaRoleMiningPotentialRoleProvisionRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleProvisionRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleProvisionRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleProvisionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

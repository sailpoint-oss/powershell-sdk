...
function Initialize-V2024AccountAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountAttribute' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

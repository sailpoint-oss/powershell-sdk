...
function Initialize-BetaIdentityCompareResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityCompareResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityCompareResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityCompareResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

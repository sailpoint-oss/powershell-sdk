...
function Initialize-Taskinfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DataAccessSecurityV1 => Taskinfo' | Write-Debug
...
Taskinfo<PSCustomObject>
#>
function ConvertFrom-JsonToTaskinfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DataAccessSecurityV1 => Taskinfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Taskinfo

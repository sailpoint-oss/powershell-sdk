...
function Initialize-V2025VendorConnectorMappingDeletedBy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025VendorConnectorMappingDeletedBy' | Write-Debug
...
VendorConnectorMappingDeletedBy<PSCustomObject>
#>
function ConvertFrom-V2025JsonToVendorConnectorMappingDeletedBy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025VendorConnectorMappingDeletedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025VendorConnectorMappingDeletedBy

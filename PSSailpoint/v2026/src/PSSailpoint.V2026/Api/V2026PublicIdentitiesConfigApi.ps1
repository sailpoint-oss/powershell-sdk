...
#>
function Get-V2026PublicIdentityConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2026PublicIdentityConfig' | Write-Debug
...
PublicIdentityConfig
#>
function Update-V2026PublicIdentityConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Update-V2026PublicIdentityConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

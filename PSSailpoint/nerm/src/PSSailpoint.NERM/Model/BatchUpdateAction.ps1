...
BatchUpdateAction<PSCustomObject>
#>

function Initialize-NERMBatchUpdateAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMBatchUpdateAction' | Write-Debug
...
Convert from JSON to BatchUpdateAction<PSCustomObject>
...
BatchUpdateAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToBatchUpdateAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMBatchUpdateAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMBatchUpdateAction

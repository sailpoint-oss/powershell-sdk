...
function Initialize-ViolationOwnerAssignmentConfigOwnerRef {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ViolationOwnerAssignmentConfigOwnerRef' | Write-Debug
...
function ConvertFrom-JsonToViolationOwnerAssignmentConfigOwnerRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ViolationOwnerAssignmentConfigOwnerRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

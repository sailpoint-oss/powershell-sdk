...
function Initialize-V2026WorkflowLibraryOperator {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026WorkflowLibraryOperator' | Write-Debug
...
WorkflowLibraryOperator<PSCustomObject>
#>
function ConvertFrom-V2026JsonToWorkflowLibraryOperator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026WorkflowLibraryOperator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026WorkflowLibraryOperator

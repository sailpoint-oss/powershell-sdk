...
String
#>
function Get-PasswordDictionaryV1 {
    [CmdletBinding()]
    Param (
        [String]
    ...
    Process {
        'Calling method: Get-PasswordDictionaryV1' | Write-Debug
        ...
        $LocalVarUri = '/password-dictionary/v1'
...
None
#>
function Send-PasswordDictionaryV1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Send-PasswordDictionaryV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

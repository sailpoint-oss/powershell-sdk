...
function Initialize-V2024ServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ServiceDeskIntegrationTemplateType' | Write-Debug
...
function ConvertFrom-V2024JsonToServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ServiceDeskIntegrationTemplateType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

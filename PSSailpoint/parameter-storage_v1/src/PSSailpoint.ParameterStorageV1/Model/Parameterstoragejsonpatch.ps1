...
function Initialize-Parameterstoragejsonpatch {
    [CmdletBinding()]
    Param (
...
Parameterstoragejsonpatch<PSCustomObject>
#>
function ConvertFrom-JsonToParameterstoragejsonpatch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Parameterstoragejsonpatch

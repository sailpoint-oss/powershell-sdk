...
#>
function ConvertFrom-V2026JsonToAttributeRequestValue {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'String' defined in oneOf (V2026AttributeRequestValue). Proceeding to the next one if any."
        }

...
function Initialize-CreateOAuthClientRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CreateOAuthClientRequest' | Write-Debug
...
function ConvertFrom-JsonToCreateOAuthClientRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CreateOAuthClientRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024RemediationItemDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RemediationItemDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToRemediationItemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RemediationItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

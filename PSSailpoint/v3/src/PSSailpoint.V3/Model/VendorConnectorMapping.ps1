...
function Initialize-VendorConnectorMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => VendorConnectorMapping' | Write-Debug
...
VendorConnectorMapping<PSCustomObject>
#>
function ConvertFrom-JsonToVendorConnectorMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => VendorConnectorMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VendorConnectorMapping

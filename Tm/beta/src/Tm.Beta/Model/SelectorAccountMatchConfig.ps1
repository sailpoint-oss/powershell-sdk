...
function Initialize-BetaSelectorAccountMatchConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSelectorAccountMatchConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToSelectorAccountMatchConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSelectorAccountMatchConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

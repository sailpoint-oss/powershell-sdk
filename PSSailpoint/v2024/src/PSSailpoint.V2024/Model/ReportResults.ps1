...
function Initialize-V2024ReportResults {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ReportResults' | Write-Debug
...
function ConvertFrom-V2024JsonToReportResults {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ReportResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

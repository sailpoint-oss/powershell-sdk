...
function Initialize-V2026MachineIdentityResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityResponse' | Write-Debug
...
MachineIdentityResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMachineIdentityResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MachineIdentityResponse

...
function Initialize-V2026ExpressionChildrenInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ExpressionChildrenInner' | Write-Debug
...
ExpressionChildrenInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToExpressionChildrenInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ExpressionChildrenInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ExpressionChildrenInner

...
keywords: ['powershell', 'PowerShell', 'sdk', 'SlimDiscoveredApplications', 'V2026SlimDiscoveredApplications'] 
slug: /tools/sdk/powershell/v2026/models/slim-discovered-applications
...
```powershell
$SlimDiscoveredApplications = Initialize-V2026SlimDiscoveredApplications  -Id null `
 -Name ExampleApp `
 -DiscoverySource csv `

...
function Initialize-BetaCompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCompletedApprovalPreApprovalTriggerResult' | Write-Debug
...
function ConvertFrom-BetaJsonToCompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCompletedApprovalPreApprovalTriggerResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

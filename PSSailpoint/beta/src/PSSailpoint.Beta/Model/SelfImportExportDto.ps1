...
function Initialize-BetaSelfImportExportDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSelfImportExportDto' | Write-Debug
...
function ConvertFrom-BetaJsonToSelfImportExportDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSelfImportExportDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

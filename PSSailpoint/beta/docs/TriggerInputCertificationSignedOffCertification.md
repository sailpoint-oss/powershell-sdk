...
```powershell
$TriggerInputCertificationSignedOffCertification = Initialize-PSSailpointBetaTriggerInputCertificationSignedOffCertification  -Id 2c91808576f886190176f88caf0d0067 `
...
```powershell
$TriggerInputCertificationSignedOffCertification | ConvertTo-JSON
```

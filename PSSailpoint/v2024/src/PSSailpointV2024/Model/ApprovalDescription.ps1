...
function Initialize-V2024ApprovalDescription {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalDescription' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalDescription {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

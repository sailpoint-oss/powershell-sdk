...
function Initialize-NonEmployeeSourceLiteWithSchemaAttributesAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeSourceLiteWithSchemaAttributesAllOf' | Write-Debug
...
NonEmployeeSourceLiteWithSchemaAttributesAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToNonEmployeeSourceLiteWithSchemaAttributesAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeSourceLiteWithSchemaAttributesAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NonEmployeeSourceLiteWithSchemaAttributesAllOf

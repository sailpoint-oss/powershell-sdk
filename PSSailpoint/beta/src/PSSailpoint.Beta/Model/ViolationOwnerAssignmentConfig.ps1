...
function Initialize-BetaViolationOwnerAssignmentConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaViolationOwnerAssignmentConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToViolationOwnerAssignmentConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaViolationOwnerAssignmentConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

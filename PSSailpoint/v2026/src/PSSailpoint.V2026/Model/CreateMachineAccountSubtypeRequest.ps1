...
function Initialize-V2026CreateMachineAccountSubtypeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CreateMachineAccountSubtypeRequest' | Write-Debug
...
CreateMachineAccountSubtypeRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCreateMachineAccountSubtypeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CreateMachineAccountSubtypeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CreateMachineAccountSubtypeRequest

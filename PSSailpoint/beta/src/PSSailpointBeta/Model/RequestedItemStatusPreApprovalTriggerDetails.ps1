...
function Initialize-BetaRequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

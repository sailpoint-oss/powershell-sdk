...
function Initialize-V2024ConfigObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ConfigObject' | Write-Debug
...
function ConvertFrom-V2024JsonToConfigObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ConfigObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaIdentityLifecycleState {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaIdentityLifecycleState' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityLifecycleState {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaIdentityLifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

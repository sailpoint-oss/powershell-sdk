...
function Initialize-BetaGetReferenceIdentityAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaGetReferenceIdentityAttribute' | Write-Debug
...
function ConvertFrom-BetaJsonToGetReferenceIdentityAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaGetReferenceIdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

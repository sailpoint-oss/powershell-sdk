...
function Initialize-BetaTenantConfigurationResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaTenantConfigurationResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToTenantConfigurationResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaTenantConfigurationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaConflictingAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaConflictingAccessCriteria' | Write-Debug
...
function ConvertFrom-BetaJsonToConflictingAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaConflictingAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

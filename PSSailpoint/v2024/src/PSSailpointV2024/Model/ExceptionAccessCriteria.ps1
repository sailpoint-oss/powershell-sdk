...
function Initialize-V2024ExceptionAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ExceptionAccessCriteria' | Write-Debug
...
function ConvertFrom-V2024JsonToExceptionAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ExceptionAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

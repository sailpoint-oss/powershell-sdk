...
function Initialize-BetaIdentityAttributeNames {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributeNames' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributeNames {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributeNames' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

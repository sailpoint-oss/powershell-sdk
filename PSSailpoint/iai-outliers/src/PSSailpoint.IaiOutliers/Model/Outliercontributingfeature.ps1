...
function Initialize-Outliercontributingfeature {
    [CmdletBinding()]
    Param (
...
Outliercontributingfeature<PSCustomObject>
#>
function ConvertFrom-JsonToOutliercontributingfeature {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Outliercontributingfeature

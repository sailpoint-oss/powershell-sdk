...
function Initialize-EntitlementDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => EntitlementDocument' | Write-Debug
...
function ConvertFrom-JsonToEntitlementDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => EntitlementDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

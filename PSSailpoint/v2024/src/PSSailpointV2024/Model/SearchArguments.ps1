...
function Initialize-V2024SearchArguments {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SearchArguments' | Write-Debug
...
function ConvertFrom-V2024JsonToSearchArguments {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SearchArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

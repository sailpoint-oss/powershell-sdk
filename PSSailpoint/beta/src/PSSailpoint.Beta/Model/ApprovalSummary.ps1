...
function Initialize-BetaApprovalSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

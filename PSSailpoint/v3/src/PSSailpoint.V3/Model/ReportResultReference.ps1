...
function Initialize-ReportResultReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ReportResultReference' | Write-Debug
...
function ConvertFrom-JsonToReportResultReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ReportResultReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

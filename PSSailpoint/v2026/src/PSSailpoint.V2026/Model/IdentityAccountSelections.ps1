...
function Initialize-V2026IdentityAccountSelections {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IdentityAccountSelections' | Write-Debug
...
IdentityAccountSelections<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIdentityAccountSelections {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IdentityAccountSelections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IdentityAccountSelections

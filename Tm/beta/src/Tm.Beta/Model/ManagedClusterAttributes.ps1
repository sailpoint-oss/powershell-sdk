...
function Initialize-BetaManagedClusterAttributes {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaManagedClusterAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToManagedClusterAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaManagedClusterAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

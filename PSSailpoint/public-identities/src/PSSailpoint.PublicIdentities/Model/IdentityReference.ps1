...
function Initialize-IdentityReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PublicIdentities => IdentityReference' | Write-Debug
...
function ConvertFrom-JsonToIdentityReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PublicIdentities => IdentityReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'LoadAccountsTaskTaskMessagesInner', 'V2026LoadAccountsTaskTaskMessagesInner'] 
slug: /tools/sdk/powershell/v2026/models/load-accounts-task-task-messages-inner
...
```powershell
$LoadAccountsTaskTaskMessagesInner = Initialize-V2026LoadAccountsTaskTaskMessagesInner  -Type WARN `
 -VarError false `
 -Warning true `

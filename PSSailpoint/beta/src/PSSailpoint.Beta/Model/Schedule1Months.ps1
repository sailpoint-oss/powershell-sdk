...
function Initialize-BetaSchedule1Months {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSchedule1Months' | Write-Debug
...
function ConvertFrom-BetaJsonToSchedule1Months {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSchedule1Months' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'RecommendationResponse', 'V2026RecommendationResponse'] 
slug: /tools/sdk/powershell/v2026/models/recommendation-response
...
```powershell
$RecommendationResponse = Initialize-V2026RecommendationResponse  -Request null `
 -Recommendation true `

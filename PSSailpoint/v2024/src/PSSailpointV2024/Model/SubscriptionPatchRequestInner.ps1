...
function Initialize-V2024SubscriptionPatchRequestInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SubscriptionPatchRequestInner' | Write-Debug
...
function ConvertFrom-V2024JsonToSubscriptionPatchRequestInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SubscriptionPatchRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ErrorResponseDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ErrorResponseDto' | Write-Debug
...
function ConvertFrom-V2024JsonToErrorResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ErrorResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

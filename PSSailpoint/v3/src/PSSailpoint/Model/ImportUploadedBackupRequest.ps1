...
function Initialize-ImportUploadedBackupRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ImportUploadedBackupRequest' | Write-Debug
...
function ConvertFrom-JsonToImportUploadedBackupRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ImportUploadedBackupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

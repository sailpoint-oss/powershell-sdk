...
function Initialize-Spconfigexportresults {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigexportresults' | Write-Debug
...
Spconfigexportresults<PSCustomObject>
#>
function ConvertFrom-JsonToSpconfigexportresults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigexportresults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Spconfigexportresults

...
function Initialize-ObjectMappingBulkPatchResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ObjectMappingBulkPatchResponse' | Write-Debug
...
function ConvertFrom-JsonToObjectMappingBulkPatchResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ObjectMappingBulkPatchResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

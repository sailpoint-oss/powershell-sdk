...
keywords: ['powershell', 'PowerShell', 'sdk', 'ParameterStorage', 'V2026ParameterStorage'] 
slug: /tools/sdk/powershell/v2026/methods/parameter-storage
...
------------- | ------------- | -------------
[**New-V2026Parameter**](#create-parameter) | **POST** `/parameter-storage/parameters` | Add a new parameter.
[**Remove-V2026Parameter**](#delete-parameter) | **DELETE** `/parameter-storage/parameters/{id}` | Delete a parameter.
[**Get-V2026AttestationDocument**](#get-attestation-document) | **GET** `/parameter-storage/attestation` | Get an attestation document.
[**Get-V2026Parameter**](#get-parameter) | **GET** `/parameter-storage/parameters/{id}` | Get a specific parameter.
[**Get-V2026ParameterReferences**](#get-parameter-references) | **GET** `/parameter-storage/parameters/{id}/references` | Get parameter references.
[**Get-V2026ParameterStorageSpecification**](#get-parameter-storage-specification) | **GET** `/parameter-storage/specification` | Get specifications for parameter types.
[**Search-V2026Parameters**](#search-parameters) | **GET** `/parameter-storage/parameters` | Query stored parameters.
[**Update-V2026Parameter**](#update-parameter) | **PATCH** `/parameter-storage/parameters/{id}` | Update a parameter.
...
try {
    ...
    # New-V2026Parameter -ParameterStorageNewParameter $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Parameter"
...
try {
    Remove-V2026Parameter -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Parameter -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Parameter"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026AttestationDocument -Key $Key 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AttestationDocument -Key $Key  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AttestationDocument"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Parameter -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Parameter -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Parameter"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ParameterReferences -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ParameterReferences -Id $Id -Sorters $Sorters -Limit $Limit -Offset $Offset  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ParameterReferences"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ParameterStorageSpecification 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ParameterStorageSpecification -AcceptLanguage $AcceptLanguage  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ParameterStorageSpecification"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Search-V2026Parameters 
    
    # Below is a request that includes all optional parameters
    # Search-V2026Parameters -Filters $Filters -Sorters $Sorters -Offset $Offset -Limit $Limit  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Search-V2026Parameters"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Update-V2026Parameter -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Update-V2026Parameter -Id $Id -ParameterStorageUpdateParameter $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026Parameter"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
TriggerInputAccountsCollectedForAggregationStats<PSCustomObject>
#>

function Initialize-BetaTriggerInputAccountsCollectedForAggregationStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountsCollectedForAggregationStats' | Write-Debug
...
Convert from JSON to TriggerInputAccountsCollectedForAggregationStats<PSCustomObject>
...
TriggerInputAccountsCollectedForAggregationStats<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputAccountsCollectedForAggregationStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountsCollectedForAggregationStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputAccountsCollectedForAggregationStats

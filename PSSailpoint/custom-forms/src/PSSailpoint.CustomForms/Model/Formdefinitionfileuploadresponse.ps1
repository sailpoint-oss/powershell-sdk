...
function Initialize-Formdefinitionfileuploadresponse {
    [CmdletBinding()]
    Param (
...
Formdefinitionfileuploadresponse<PSCustomObject>
#>
function ConvertFrom-JsonToFormdefinitionfileuploadresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Formdefinitionfileuploadresponse

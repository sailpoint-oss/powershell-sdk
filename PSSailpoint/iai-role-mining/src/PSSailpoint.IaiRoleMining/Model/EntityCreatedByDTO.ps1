...
function Initialize-EntityCreatedByDTO {
    [CmdletBinding()]
    Param (
...
EntityCreatedByDTO<PSCustomObject>
#>
function ConvertFrom-JsonToEntityCreatedByDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in EntityCreatedByDTO

...
function Initialize-V2026AuthUserSlimResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AuthUserSlimResponse' | Write-Debug
...
AuthUserSlimResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAuthUserSlimResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AuthUserSlimResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AuthUserSlimResponse

...
function Initialize-V2026AuthUser {
    [CmdletBinding()]
    Param (
...
AuthUser<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAuthUser {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AuthUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AuthUser

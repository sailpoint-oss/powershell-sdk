...
function Initialize-BetaAppAccountDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAppAccountDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToAppAccountDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAppAccountDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
RunWorkflowAction<PSCustomObject>
#>

function Initialize-NERMRunWorkflowAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMRunWorkflowAction' | Write-Debug
...
Convert from JSON to RunWorkflowAction<PSCustomObject>
...
RunWorkflowAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToRunWorkflowAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMRunWorkflowAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMRunWorkflowAction
        $AllProperties = ("workflow_id", "description", "archived", "configuration_attributes")

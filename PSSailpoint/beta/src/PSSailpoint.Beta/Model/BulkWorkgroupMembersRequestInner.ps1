...
function Initialize-BetaBulkWorkgroupMembersRequestInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaBulkWorkgroupMembersRequestInner' | Write-Debug
...
function ConvertFrom-BetaJsonToBulkWorkgroupMembersRequestInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaBulkWorkgroupMembersRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

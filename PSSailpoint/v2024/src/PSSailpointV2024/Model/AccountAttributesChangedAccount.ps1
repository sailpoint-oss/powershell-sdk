...
function Initialize-V2024AccountAttributesChangedAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountAttributesChangedAccount' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAttributesChangedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountAttributesChangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

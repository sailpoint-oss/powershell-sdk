...
function Initialize-BetaPatchServiceDeskIntegrationRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaPatchServiceDeskIntegrationRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToPatchServiceDeskIntegrationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaPatchServiceDeskIntegrationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ApprovalReminderAndEscalationConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ApprovalReminderAndEscalationConfig' | Write-Debug
...
function ConvertFrom-JsonToApprovalReminderAndEscalationConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ApprovalReminderAndEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

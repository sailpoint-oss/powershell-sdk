...
function Initialize-Attrsyncsourceconfig {
    [CmdletBinding()]
    Param (
...
Attrsyncsourceconfig<PSCustomObject>
#>
function ConvertFrom-JsonToAttrsyncsourceconfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Attrsyncsourceconfig

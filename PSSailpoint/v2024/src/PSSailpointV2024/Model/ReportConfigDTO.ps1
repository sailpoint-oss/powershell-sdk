...
function Initialize-V2024ReportConfigDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ReportConfigDTO' | Write-Debug
...
function ConvertFrom-V2024JsonToReportConfigDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ReportConfigDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

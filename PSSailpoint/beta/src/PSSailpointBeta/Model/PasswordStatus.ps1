...
function Initialize-BetaPasswordStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaPasswordStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToPasswordStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaPasswordStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

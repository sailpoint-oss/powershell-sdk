...
function Initialize-V2024RoleMiningSessionResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleMiningSessionResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningSessionResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleMiningSessionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024RoleInsightsResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RoleInsightsResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleInsightsResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RoleInsightsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Errormessagedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PersonalAccessTokens => Errormessagedto' | Write-Debug
...
function ConvertFrom-JsonToErrormessagedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PersonalAccessTokens => Errormessagedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

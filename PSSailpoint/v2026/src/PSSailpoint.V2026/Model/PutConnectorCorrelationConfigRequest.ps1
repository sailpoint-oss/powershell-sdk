...
function Initialize-V2026PutConnectorCorrelationConfigRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026PutConnectorCorrelationConfigRequest' | Write-Debug
...
PutConnectorCorrelationConfigRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToPutConnectorCorrelationConfigRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026PutConnectorCorrelationConfigRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026PutConnectorCorrelationConfigRequest
        $AllProperties = ("file")

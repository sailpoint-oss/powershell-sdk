...
function Initialize-V2026TaskDefinitionSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TaskDefinitionSummary' | Write-Debug
...
TaskDefinitionSummary<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTaskDefinitionSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TaskDefinitionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TaskDefinitionSummary

...
function Initialize-V2024AccessSummaryAccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessSummaryAccess' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessSummaryAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessSummaryAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Jsonpatchoperationrolemining {
    [CmdletBinding()]
    Param (
...
Jsonpatchoperationrolemining<PSCustomObject>
#>
function ConvertFrom-JsonToJsonpatchoperationrolemining {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Jsonpatchoperationrolemining

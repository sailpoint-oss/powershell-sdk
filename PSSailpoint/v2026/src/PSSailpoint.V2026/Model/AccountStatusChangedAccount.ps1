...
function Initialize-V2026AccountStatusChangedAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccountStatusChangedAccount' | Write-Debug
...
AccountStatusChangedAccount<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccountStatusChangedAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccountStatusChangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccountStatusChangedAccount

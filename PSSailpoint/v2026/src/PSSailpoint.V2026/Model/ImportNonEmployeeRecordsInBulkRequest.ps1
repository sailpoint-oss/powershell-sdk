...
function Initialize-V2026ImportNonEmployeeRecordsInBulkRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ImportNonEmployeeRecordsInBulkRequest' | Write-Debug
...
ImportNonEmployeeRecordsInBulkRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToImportNonEmployeeRecordsInBulkRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ImportNonEmployeeRecordsInBulkRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ImportNonEmployeeRecordsInBulkRequest
        $AllProperties = ("data")

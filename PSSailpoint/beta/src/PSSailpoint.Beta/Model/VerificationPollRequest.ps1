...
function Initialize-BetaVerificationPollRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaVerificationPollRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToVerificationPollRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaVerificationPollRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

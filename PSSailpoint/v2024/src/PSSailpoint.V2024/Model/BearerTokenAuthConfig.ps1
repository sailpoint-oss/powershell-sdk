...
function Initialize-V2024BearerTokenAuthConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024BearerTokenAuthConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToBearerTokenAuthConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024BearerTokenAuthConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

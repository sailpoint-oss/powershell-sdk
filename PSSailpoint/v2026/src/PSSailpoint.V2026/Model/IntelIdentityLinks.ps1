...
function Initialize-V2026IntelIdentityLinks {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IntelIdentityLinks' | Write-Debug
...
IntelIdentityLinks<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIntelIdentityLinks {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IntelIdentityLinks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

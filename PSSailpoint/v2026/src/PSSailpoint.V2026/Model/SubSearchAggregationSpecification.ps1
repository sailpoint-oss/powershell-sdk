...
function Initialize-V2026SubSearchAggregationSpecification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SubSearchAggregationSpecification' | Write-Debug
...
SubSearchAggregationSpecification<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSubSearchAggregationSpecification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SubSearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SubSearchAggregationSpecification

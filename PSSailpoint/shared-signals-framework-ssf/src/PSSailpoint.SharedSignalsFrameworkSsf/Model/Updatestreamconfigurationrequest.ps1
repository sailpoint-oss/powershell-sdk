...
function Initialize-Updatestreamconfigurationrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SharedSignalsFrameworkSsfV1 => Updatestreamconfigurationrequest' | Write-Debug
...
Updatestreamconfigurationrequest<PSCustomObject>
#>
function ConvertFrom-JsonToUpdatestreamconfigurationrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SharedSignalsFrameworkSsfV1 => Updatestreamconfigurationrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Updatestreamconfigurationrequest

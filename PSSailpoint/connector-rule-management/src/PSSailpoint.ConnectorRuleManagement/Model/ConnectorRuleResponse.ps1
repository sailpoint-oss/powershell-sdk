...
function Initialize-ConnectorRuleResponse {
    [CmdletBinding()]
    Param (
...
ConnectorRuleResponse<PSCustomObject>
#>
function ConvertFrom-JsonToConnectorRuleResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ConnectorRuleResponse

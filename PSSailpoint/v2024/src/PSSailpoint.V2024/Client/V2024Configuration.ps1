...
Get the configuration object 'V2024Configuration'.
...
#>
function Get-V2024Configuration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://sailpoint.api.identitynow.com/v2024";
    }
...
System.Collections.Hashtable
#>
function Set-V2024Configuration {
...
None
#>
function Set-V2024ConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-V2024ConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-V2024ConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
String
#>
function Get-V2024UrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-V2024ConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-V2024KeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'V2024ConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-V2024ConfigurationHttpSigning{

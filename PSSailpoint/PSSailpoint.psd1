...
FunctionsToExport = 'New-AccessProfile', 'Remove-AccessProfile', 
               ...
               'Update-AuthOrgSessionConfig', 'Remove-IdentityProfile', 
               'Remove-IdentityProfiles', 'Export-IdentityProfiles', 
               'Get-DefaultIdentityAttributeConfig', 'Get-IdentityProfile', 
               'Import-IdentityProfiles', 'Get-IdentityProfiles', 
               'Sync-IdentityProfile', 'New-LifecycleState', 'Remove-LifecycleState', 
               'Get-LifecycleState', 'Get-LifecycleStates', 'Set-LifecycleState', 
               'Update-LifecycleStates', 'New-ManagedClient', 'Remove-ManagedClient', 
               'Get-ManagedClient', 'Get-ManagedClientStatus', 'Get-ManagedClients', 
               ...
               'Initialize-DiscoveredApplicationsInner', 
               'ConvertFrom-JsonToDiscoveredApplicationsInner', 

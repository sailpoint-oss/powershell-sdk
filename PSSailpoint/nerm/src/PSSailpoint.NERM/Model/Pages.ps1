...
function Initialize-NERMPages {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMPages' | Write-Debug
...
Convert from JSON to Pages<PSCustomObject>
...
Pages<PSCustomObject>
#>
function ConvertFrom-NERMJsonToPages {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMPages' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMPages

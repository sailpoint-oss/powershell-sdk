...
function Initialize-BetaSelectorAccountMatchConfigMatchExpression {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSelectorAccountMatchConfigMatchExpression' | Write-Debug
...
function ConvertFrom-BetaJsonToSelectorAccountMatchConfigMatchExpression {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSelectorAccountMatchConfigMatchExpression' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

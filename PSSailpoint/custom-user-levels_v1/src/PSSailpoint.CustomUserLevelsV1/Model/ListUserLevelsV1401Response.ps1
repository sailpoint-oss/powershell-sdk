...
ListUserLevelsV1401Response<PSCustomObject>
#>

function Initialize-ListUserLevelsV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListUserLevelsV1401Response<PSCustomObject>
...
ListUserLevelsV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToListUserLevelsV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListUserLevelsV1401Response
        $AllProperties = ("error")

...
function Initialize-BetaFormCondition {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormCondition' | Write-Debug
...
function ConvertFrom-BetaJsonToFormCondition {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormCondition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

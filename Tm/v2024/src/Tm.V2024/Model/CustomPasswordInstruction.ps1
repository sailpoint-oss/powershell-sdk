...
function Initialize-V2024CustomPasswordInstruction {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CustomPasswordInstruction' | Write-Debug
...
function ConvertFrom-V2024JsonToCustomPasswordInstruction {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CustomPasswordInstruction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

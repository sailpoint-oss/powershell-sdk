...
function Initialize-BetaGenerateRandomString {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaGenerateRandomString' | Write-Debug
...
function ConvertFrom-BetaJsonToGenerateRandomString {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaGenerateRandomString' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

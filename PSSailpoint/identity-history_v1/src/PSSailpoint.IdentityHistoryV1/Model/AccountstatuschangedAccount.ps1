...
function Initialize-AccountstatuschangedAccount {
    [CmdletBinding()]
    Param (
...
AccountstatuschangedAccount<PSCustomObject>
#>
function ConvertFrom-JsonToAccountstatuschangedAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccountstatuschangedAccount

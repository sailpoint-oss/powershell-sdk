...
function Initialize-BetaMessageCatalogDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaMessageCatalogDto' | Write-Debug
...
function ConvertFrom-BetaJsonToMessageCatalogDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaMessageCatalogDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

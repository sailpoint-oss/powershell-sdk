...
function Initialize-V2025TypeAheadQuery {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025TypeAheadQuery' | Write-Debug
...
TypeAheadQuery<PSCustomObject>
#>
function ConvertFrom-V2025JsonToTypeAheadQuery {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025TypeAheadQuery' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025TypeAheadQuery

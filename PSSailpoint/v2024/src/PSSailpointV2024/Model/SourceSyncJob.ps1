...
function Initialize-V2024SourceSyncJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SourceSyncJob' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceSyncJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SourceSyncJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

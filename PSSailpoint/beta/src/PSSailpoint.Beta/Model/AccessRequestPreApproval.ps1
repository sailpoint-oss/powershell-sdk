...
function Initialize-BetaAccessRequestPreApproval {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequestPreApproval' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPreApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequestPreApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

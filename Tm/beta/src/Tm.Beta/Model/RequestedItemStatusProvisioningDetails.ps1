...
function Initialize-BetaRequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRequestedItemStatusProvisioningDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRequestedItemStatusProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026ApprovalConfigCronTimezone {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigCronTimezone' | Write-Debug
...
ApprovalConfigCronTimezone<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApprovalConfigCronTimezone {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigCronTimezone' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApprovalConfigCronTimezone

...
IdentityProfile1AllOf<PSCustomObject>
#>

function Initialize-BetaIdentityProfile1AllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaIdentityProfile1AllOf' | Write-Debug
...
Convert from JSON to IdentityProfile1AllOf<PSCustomObject>
...
IdentityProfile1AllOf<PSCustomObject>
#>
function ConvertFrom-BetaJsonToIdentityProfile1AllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaIdentityProfile1AllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaIdentityProfile1AllOf

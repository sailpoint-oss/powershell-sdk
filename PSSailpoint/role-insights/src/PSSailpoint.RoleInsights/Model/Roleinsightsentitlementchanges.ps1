...
function Initialize-Roleinsightsentitlementchanges {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsightsentitlementchanges' | Write-Debug
...
Roleinsightsentitlementchanges<PSCustomObject>
#>
function ConvertFrom-JsonToRoleinsightsentitlementchanges {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsightsentitlementchanges' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleinsightsentitlementchanges

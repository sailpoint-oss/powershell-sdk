...
keywords: ['powershell', 'PowerShell', 'sdk', 'SessionConfiguration', 'V2026SessionConfiguration'] 
slug: /tools/sdk/powershell/v2026/models/session-configuration
...
```powershell
$SessionConfiguration = Initialize-V2026SessionConfiguration  -MaxIdleTime 15 `
 -RememberMe true `
 -MaxSessionTime 45
```

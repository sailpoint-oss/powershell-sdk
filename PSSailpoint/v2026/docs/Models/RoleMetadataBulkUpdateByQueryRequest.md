...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMetadataBulkUpdateByQueryRequest', 'V2026RoleMetadataBulkUpdateByQueryRequest'] 
slug: /tools/sdk/powershell/v2026/models/role-metadata-bulk-update-by-query-request
...
```powershell
$RoleMetadataBulkUpdateByQueryRequest = Initialize-V2026RoleMetadataBulkUpdateByQueryRequest  -Query {query"={indices=[roles], queryType=TEXT, textQuery={terms=[test123], fields=[id], matchAny=false, contains=true}, includeNested=false}} `
 -Operation REPLACE `
 -ReplaceScope ALL `
 -Values null
```

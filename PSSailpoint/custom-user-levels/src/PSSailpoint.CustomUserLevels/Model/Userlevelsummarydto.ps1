...
function Initialize-Userlevelsummarydto {
    [CmdletBinding()]
    Param (
...
Userlevelsummarydto<PSCustomObject>
#>
function ConvertFrom-JsonToUserlevelsummarydto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Userlevelsummarydto

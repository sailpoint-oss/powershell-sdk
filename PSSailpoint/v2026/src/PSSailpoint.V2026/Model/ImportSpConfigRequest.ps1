...
function Initialize-V2026ImportSpConfigRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ImportSpConfigRequest' | Write-Debug
...
ImportSpConfigRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToImportSpConfigRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ImportSpConfigRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ImportSpConfigRequest

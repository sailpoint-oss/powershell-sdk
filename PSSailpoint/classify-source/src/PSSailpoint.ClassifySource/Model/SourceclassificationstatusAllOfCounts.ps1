...
function Initialize-SourceclassificationstatusAllOfCounts {
    [CmdletBinding()]
    Param (
...
SourceclassificationstatusAllOfCounts<PSCustomObject>
#>
function ConvertFrom-JsonToSourceclassificationstatusAllOfCounts {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SourceclassificationstatusAllOfCounts

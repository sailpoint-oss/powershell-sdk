...
function Initialize-IdentityCertDecisionSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => IdentityCertDecisionSummary' | Write-Debug
...
function ConvertFrom-JsonToIdentityCertDecisionSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => IdentityCertDecisionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

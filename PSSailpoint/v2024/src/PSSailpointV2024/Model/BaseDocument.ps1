...
function Initialize-V2024BaseDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024BaseDocument' | Write-Debug
...
function ConvertFrom-V2024JsonToBaseDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024BaseDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

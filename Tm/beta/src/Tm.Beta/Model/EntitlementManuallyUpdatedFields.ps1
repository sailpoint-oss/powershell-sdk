...
function Initialize-BetaEntitlementManuallyUpdatedFields {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaEntitlementManuallyUpdatedFields' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementManuallyUpdatedFields {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaEntitlementManuallyUpdatedFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

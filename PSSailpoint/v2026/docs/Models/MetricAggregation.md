...
keywords: ['powershell', 'PowerShell', 'sdk', 'MetricAggregation', 'V2026MetricAggregation'] 
slug: /tools/sdk/powershell/v2026/models/metric-aggregation
...
```powershell
$MetricAggregation = Initialize-V2026MetricAggregation  -Name Access Name Count `
 -Type null `
 -Field @access.name
```

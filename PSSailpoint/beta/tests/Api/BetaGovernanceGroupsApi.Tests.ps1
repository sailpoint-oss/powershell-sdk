...
Describe -tag 'PSSailpoint.Beta' -name 'BetaBetaGovernanceGroupsApi' {
    ...
    Context 'Remove-BetaWorkgroupMembers' {
        It 'Test Remove-BetaWorkgroupMembers' {
            #$TestResult = Remove-BetaWorkgroupMembers -WorkgroupId "TEST_VALUE" -BulkWorkgroupMembersRequestInner "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Update-BetaWorkgroupMembers' {
        It 'Test Update-BetaWorkgroupMembers' {
            #$TestResult = Update-BetaWorkgroupMembers -WorkgroupId "TEST_VALUE" -BulkWorkgroupMembersRequestInner "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessRequestApprovals', 'V2026AccessRequestApprovals'] 
slug: /tools/sdk/powershell/v2026/methods/access-request-approvals
...
------------- | ------------- | -------------
[**Approve-V2026AccessRequest**](#approve-access-request) | **POST** `/access-request-approvals/{approvalId}/approve` | Approve access request approval
[**Invoke-V2026ForwardAccessRequest**](#forward-access-request) | **POST** `/access-request-approvals/{approvalId}/forward` | Forward access request approval
[**Get-V2026AccessRequestApprovalSummary**](#get-access-request-approval-summary) | **GET** `/access-request-approvals/approval-summary` | Get access requests approvals number
[**Get-V2026AccessRequestApprovers**](#list-access-request-approvers) | **GET** `/access-request-approvals/{accessRequestId}/approvers` | Access request approvers
[**Get-V2026CompletedApprovals**](#list-completed-approvals) | **GET** `/access-request-approvals/completed` | Completed access request approvals list
[**Get-V2026PendingApprovals**](#list-pending-approvals) | **GET** `/access-request-approvals/pending` | Pending access request approvals list
[**Deny-V2026AccessRequest**](#reject-access-request) | **POST** `/access-request-approvals/{approvalId}/reject` | Reject access request approval
...
try {
    Approve-V2026AccessRequest -ApprovalId $ApprovalId 
    
    # Below is a request that includes all optional parameters
    # Approve-V2026AccessRequest -ApprovalId $ApprovalId -CommentDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Approve-V2026AccessRequest"
...
try {
    $Result = ConvertFrom-V2026JsonToForwardApprovalDto -Json $ForwardApprovalDto
    Invoke-V2026ForwardAccessRequest -ApprovalId $ApprovalId -ForwardApprovalDto $Result 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026ForwardAccessRequest -ApprovalId $ApprovalId -ForwardApprovalDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026ForwardAccessRequest"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026AccessRequestApprovalSummary -OwnerId $OwnerId -FromDate $FromDate  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccessRequestApprovalSummary"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026AccessRequestApprovers -AccessRequestId $AccessRequestId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AccessRequestApprovers -AccessRequestId $AccessRequestId -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccessRequestApprovers"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026CompletedApprovals 
    
    # Below is a request that includes all optional parameters
    # Get-V2026CompletedApprovals -OwnerId $OwnerId -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026CompletedApprovals"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026PendingApprovals 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PendingApprovals -OwnerId $OwnerId -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026PendingApprovals"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToCommentDto -Json $CommentDto
    Deny-V2026AccessRequest -ApprovalId $ApprovalId -CommentDto $Result 
    
    # Below is a request that includes all optional parameters
    # Deny-V2026AccessRequest -ApprovalId $ApprovalId -CommentDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Deny-V2026AccessRequest"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

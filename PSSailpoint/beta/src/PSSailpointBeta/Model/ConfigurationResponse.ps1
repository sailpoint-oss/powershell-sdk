...
function Initialize-BetaConfigurationResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaConfigurationResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToConfigurationResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaConfigurationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

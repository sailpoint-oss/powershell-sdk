...
function Initialize-BetaMultiHostIntegrationsConnectorAttributesMultiHostAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaMultiHostIntegrationsConnectorAttributesMultiHostAttributes' | Write-Debug
...
MultiHostIntegrationsConnectorAttributesMultiHostAttributes<PSCustomObject>
#>
function ConvertFrom-BetaJsonToMultiHostIntegrationsConnectorAttributesMultiHostAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaMultiHostIntegrationsConnectorAttributesMultiHostAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaMultiHostIntegrationsConnectorAttributesMultiHostAttributes

...
function Initialize-V2024GetPersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024GetPersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToGetPersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024GetPersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

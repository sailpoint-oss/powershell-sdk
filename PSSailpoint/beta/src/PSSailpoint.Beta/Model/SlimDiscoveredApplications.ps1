...
function Initialize-BetaSlimDiscoveredApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSlimDiscoveredApplications' | Write-Debug
...
SlimDiscoveredApplications<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSlimDiscoveredApplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSlimDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

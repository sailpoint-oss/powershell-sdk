...
function Initialize-BetaAccessRequested {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequested' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequested {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequested' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAssignmentContextDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAssignmentContextDto' | Write-Debug
...
AssignmentContextDto<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAssignmentContextDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAssignmentContextDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaAssignmentContextDto

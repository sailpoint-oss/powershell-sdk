...
function Initialize-V2026AccessProfileUpdateItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessProfileUpdateItem' | Write-Debug
...
AccessProfileUpdateItem<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessProfileUpdateItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessProfileUpdateItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessProfileUpdateItem

...
keywords: ['powershell', 'PowerShell', 'sdk', 'TemplateSlack', 'V2026TemplateSlack'] 
slug: /tools/sdk/powershell/v2026/models/template-slack
...
```powershell
$TemplateSlack = Initialize-V2026TemplateSlack  -Key null `

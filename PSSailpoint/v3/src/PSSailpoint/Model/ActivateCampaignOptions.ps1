...
function Initialize-ActivateCampaignOptions {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ActivateCampaignOptions' | Write-Debug
...
function ConvertFrom-JsonToActivateCampaignOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ActivateCampaignOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

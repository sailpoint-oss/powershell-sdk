...
function Initialize-V2024BaseReferenceDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024BaseReferenceDto' | Write-Debug
...
function ConvertFrom-V2024JsonToBaseReferenceDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024BaseReferenceDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

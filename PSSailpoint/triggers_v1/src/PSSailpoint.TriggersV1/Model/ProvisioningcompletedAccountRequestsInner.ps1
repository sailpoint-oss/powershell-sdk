...
function Initialize-ProvisioningcompletedAccountRequestsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => ProvisioningcompletedAccountRequestsInner' | Write-Debug
...
ProvisioningcompletedAccountRequestsInner<PSCustomObject>
#>
function ConvertFrom-JsonToProvisioningcompletedAccountRequestsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => ProvisioningcompletedAccountRequestsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProvisioningcompletedAccountRequestsInner

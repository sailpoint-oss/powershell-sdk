...
function Initialize-ScheduledSearchAllOfOwner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ScheduledSearchAllOfOwner' | Write-Debug
...
function ConvertFrom-JsonToScheduledSearchAllOfOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ScheduledSearchAllOfOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

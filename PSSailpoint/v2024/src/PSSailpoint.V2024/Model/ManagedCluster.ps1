...
function Initialize-V2024ManagedCluster {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManagedCluster' | Write-Debug
...
ManagedCluster<PSCustomObject>
#>
function ConvertFrom-V2024JsonToManagedCluster {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManagedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

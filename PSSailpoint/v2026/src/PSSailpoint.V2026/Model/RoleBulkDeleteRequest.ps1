...
function Initialize-V2026RoleBulkDeleteRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleBulkDeleteRequest' | Write-Debug
...
RoleBulkDeleteRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleBulkDeleteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleBulkDeleteRequest

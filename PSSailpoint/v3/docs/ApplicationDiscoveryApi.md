# PSSailpoint.PSSailpoint\Api.ApplicationDiscoveryApi
...
> Array[] Get-DiscoveredApplications<br>
...
# Retrieve discovered applications for tenant
try {
    $Result = Get-DiscoveredApplications -Limit $Limit -Offset $Offset -Filter $Filter -Sorters $Sorters
} catch {

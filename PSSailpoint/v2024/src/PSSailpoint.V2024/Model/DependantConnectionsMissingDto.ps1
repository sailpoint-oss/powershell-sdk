...
function Initialize-V2024DependantConnectionsMissingDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024DependantConnectionsMissingDto' | Write-Debug
...
DependantConnectionsMissingDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToDependantConnectionsMissingDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024DependantConnectionsMissingDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024DependantConnectionsMissingDto

...
#>
function New-V2024ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2024ServiceDeskIntegration' | Write-Debug
...
None
#>
function Remove-V2024ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2024ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Get-V2024ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2024ServiceDeskIntegrationTemplate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024ServiceDeskIntegrationTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2024ServiceDeskIntegrationTypes {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2024ServiceDeskIntegrationTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto[]
#>
function Get-V2024ServiceDeskIntegrations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2024ServiceDeskIntegrations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2024StatusCheckDetails {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2024StatusCheckDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Update-V2024ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2024ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Send-V2024ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2024ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
QueuedCheckConfigDetails
#>
function Update-V2024StatusCheckDetails {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Update-V2024StatusCheckDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

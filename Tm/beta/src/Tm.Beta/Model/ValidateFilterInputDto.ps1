...
function Initialize-BetaValidateFilterInputDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaValidateFilterInputDto' | Write-Debug
...
function ConvertFrom-BetaJsonToValidateFilterInputDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaValidateFilterInputDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

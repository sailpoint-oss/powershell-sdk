...
function Initialize-V2024IdentityDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityDocument' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

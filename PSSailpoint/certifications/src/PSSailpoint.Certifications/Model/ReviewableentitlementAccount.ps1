...
function Initialize-ReviewableentitlementAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Certifications => ReviewableentitlementAccount' | Write-Debug
...
function ConvertFrom-JsonToReviewableentitlementAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Certifications => ReviewableentitlementAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026FormDefinitionInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026FormDefinitionInput' | Write-Debug
...
FormDefinitionInput<PSCustomObject>
#>
function ConvertFrom-V2026JsonToFormDefinitionInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026FormDefinitionInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026FormDefinitionInput

...
function Initialize-BetaMailFromAttributesDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaMailFromAttributesDto' | Write-Debug
...
function ConvertFrom-BetaJsonToMailFromAttributesDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaMailFromAttributesDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

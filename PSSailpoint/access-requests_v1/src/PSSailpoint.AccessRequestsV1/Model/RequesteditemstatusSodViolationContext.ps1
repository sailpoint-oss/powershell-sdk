...
function Initialize-RequesteditemstatusSodViolationContext {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestsV1 => RequesteditemstatusSodViolationContext' | Write-Debug
...
RequesteditemstatusSodViolationContext<PSCustomObject>
#>
function ConvertFrom-JsonToRequesteditemstatusSodViolationContext {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestsV1 => RequesteditemstatusSodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RequesteditemstatusSodViolationContext

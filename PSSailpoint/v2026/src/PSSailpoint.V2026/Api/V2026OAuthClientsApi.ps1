...
function New-V2026OauthClient {
    ...
    Process {
        'Calling method: New-V2026OauthClient' | Write-Debug
...
None
#>
function Remove-V2026OauthClient {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026OauthClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026OauthClient {
    ...
    Process {
        'Calling method: Get-V2026OauthClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
GetOAuthClientResponse[]
#>
function Get-V2026OauthClients {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026OauthClients' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
GetOAuthClientResponse
#>
function Update-V2026OauthClient {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026OauthClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

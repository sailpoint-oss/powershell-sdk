...
function Initialize-BetaSpConfigMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSpConfigMessage' | Write-Debug
...
function ConvertFrom-BetaJsonToSpConfigMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSpConfigMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

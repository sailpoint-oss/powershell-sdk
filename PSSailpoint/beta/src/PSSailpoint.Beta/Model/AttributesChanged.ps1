...
function Initialize-BetaAttributesChanged {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAttributesChanged' | Write-Debug
...
function ConvertFrom-BetaJsonToAttributesChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAttributesChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

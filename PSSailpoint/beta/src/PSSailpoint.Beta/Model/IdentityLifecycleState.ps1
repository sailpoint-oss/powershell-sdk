...
function Initialize-BetaIdentityLifecycleState {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityLifecycleState' | Write-Debug
...
IdentityLifecycleState<PSCustomObject>
#>
function ConvertFrom-BetaJsonToIdentityLifecycleState {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityLifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaIdentityLifecycleState

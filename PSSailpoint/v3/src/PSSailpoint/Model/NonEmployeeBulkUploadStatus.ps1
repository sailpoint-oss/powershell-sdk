...
function Initialize-NonEmployeeBulkUploadStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeBulkUploadStatus' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeBulkUploadStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeBulkUploadStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConnectorDetail', 'V2026ConnectorDetail'] 
slug: /tools/sdk/powershell/v2026/models/connector-detail
...
```powershell
$ConnectorDetail = Initialize-V2026ConnectorDetail  -Name name `
 -Type ServiceNow `

...
function Initialize-CampaignAllOfRoleCompositionCampaignInfoRemediatorRef {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => CampaignAllOfRoleCompositionCampaignInfoRemediatorRef' | Write-Debug
...
function ConvertFrom-JsonToCampaignAllOfRoleCompositionCampaignInfoRemediatorRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => CampaignAllOfRoleCompositionCampaignInfoRemediatorRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

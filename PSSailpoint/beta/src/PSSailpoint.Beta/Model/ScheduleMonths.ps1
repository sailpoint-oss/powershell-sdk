...
function Initialize-BetaScheduleMonths {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaScheduleMonths' | Write-Debug
...
function ConvertFrom-BetaJsonToScheduleMonths {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaScheduleMonths' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

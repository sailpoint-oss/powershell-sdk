...
function Initialize-V2026AccountUpdatedEntitlementChangesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccountUpdatedEntitlementChangesInner' | Write-Debug
...
AccountUpdatedEntitlementChangesInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccountUpdatedEntitlementChangesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccountUpdatedEntitlementChangesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccountUpdatedEntitlementChangesInner

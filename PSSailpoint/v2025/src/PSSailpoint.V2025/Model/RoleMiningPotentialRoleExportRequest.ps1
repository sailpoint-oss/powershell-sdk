...
function Initialize-V2025RoleMiningPotentialRoleExportRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningPotentialRoleExportRequest' | Write-Debug
...
RoleMiningPotentialRoleExportRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleMiningPotentialRoleExportRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningPotentialRoleExportRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleMiningPotentialRoleExportRequest

...
function Initialize-TaskResultDetailsReturnsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => TaskResultDetailsReturnsInner' | Write-Debug
...
function ConvertFrom-JsonToTaskResultDetailsReturnsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => TaskResultDetailsReturnsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

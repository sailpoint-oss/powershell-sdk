...
function Initialize-V2025WorkgroupDeleteItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025WorkgroupDeleteItem' | Write-Debug
...
WorkgroupDeleteItem<PSCustomObject>
#>
function ConvertFrom-V2025JsonToWorkgroupDeleteItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025WorkgroupDeleteItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025WorkgroupDeleteItem

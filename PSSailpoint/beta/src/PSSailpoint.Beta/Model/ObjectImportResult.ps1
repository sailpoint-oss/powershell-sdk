...
function Initialize-BetaObjectImportResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaObjectImportResult' | Write-Debug
...
function ConvertFrom-BetaJsonToObjectImportResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaObjectImportResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

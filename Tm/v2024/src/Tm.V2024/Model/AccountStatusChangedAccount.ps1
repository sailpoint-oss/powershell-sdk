...
function Initialize-V2024AccountStatusChangedAccount {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccountStatusChangedAccount' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountStatusChangedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccountStatusChangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

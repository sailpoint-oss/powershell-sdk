...
FunctionsToExport = 'Invoke-ApprovalSummary', 'Approve-Request', 'Invoke-ForwardRequest', 
               'Invoke-ListCompletedApprovals', 'Invoke-ListPendingApprovals', 
               'Deny-Request', 'Stop-AccessRequest', 'New-AccessRequest', 
               'Get-AccessRequestConfig', 'Invoke-ListAccessRequestStatus', 
               'Update-AccessRequestConfig', 'Get-AccountActivity', 
               'Invoke-ListAccountActivities', 'New-Account', 'Invoke-DeleteAccount', 
               'Disable-Account', 'Enable-Account', 'Get-Account', 
               'Get-AccountEntitlements', 'Invoke-ListAccounts', 'Send-Account', 
               'Invoke-ReloadAccount', 'Unlock-Account', 'Update-Account', 
               'Get-IdentityCertification', 'Invoke-ListIdentityAccessReviewItems', 
               'Invoke-ListIdentityCertifications', 'New-IdentityDecision', 
               ...
               'Invoke-ListIdentityProfiles', 'New-LifecycleState', 
               'Invoke-DeleteLifecycleState', 'Get-LifecycleState', 
               'Invoke-ListLifecycleStates', 'Set-LifecycleState', 
               'Update-LifecycleStates', 'New-SchemaAttribute', 
               'Invoke-DeleteSchemaAttribute', 'Invoke-DeleteSchemaAttributes', 
               'Get-SchemaAttribute', 'Get-SchemaAttributes', 
               'Invoke-NonEmployeeApprovalGet', 'Invoke-NonEmployeeApprovalList', 
               ...
               'Invoke-NonEmployeeRecordDelete', 'Invoke-NonEmployeeRecordGet', 
               'Invoke-NonEmployeeRecordList', 'Invoke-NonEmployeeRecordPatch', 
               ...
               'Invoke-NonEmployeeRequestDeletion', 'Invoke-NonEmployeeRequestGet', 
               'Invoke-NonEmployeeRequestList', 
               'Invoke-NonEmployeeRequestSummaryGet', 
               'Invoke-NonEmployeeSourceDelete', 'Invoke-NonEmployeeSourceGet', 
               'Invoke-NonEmployeeSourcePatch', 
               'Invoke-NonEmployeeSourcesCreation', 
               'Invoke-NonEmployeeSourcesList', 'Invoke-PatchSchemaAttribute', 
               'New-OauthClient', 'Invoke-DeleteOauthClient', 'Get-OauthClient', 
               'Invoke-ListOauthClients', 'Invoke-PatchOauthClient', 
               'Get-PasswordChangeStatus', 'Invoke-QueryPasswordInfo', 
               'Set-Password', 'New-PersonalAccessToken', 
               'Invoke-DeletePersonalAccessToken', 
               'Invoke-ListPersonalAccessTokens', 
               'Invoke-PatchPersonalAccessToken', 'Get-PublicIdentities', 
               'Get-PublicIdentityConfig', 'Update-PublicIdentityConfig', 
               'Invoke-ListRequestableObjects', 'Save-dSearchCreate', 
               'Save-dSearchDelete', 'Save-dSearchExecute', 'Save-dSearchGet', 
               'Save-dSearchList', 'Save-dSearchUpdate', 
               'Invoke-ScheduledSearchCreate', 'Invoke-ScheduledSearchDelete', 
               'Invoke-ScheduledSearchGet', 'Invoke-ScheduledSearchList', 
               'Invoke-ScheduledSearchUnsubscribe', 'Invoke-ScheduledSearchUpdate', 
               'Search-Aggregate', 'Search-Count', 'Search-Get', 'Search-Post', 
               'New-ServiceDeskIntegration', 'Invoke-DeleteServiceDeskIntegration', 
               'Get-ServiceDeskIntegration', 'Get-ServiceDeskIntegrationList', 
               'Get-ServiceDeskIntegrationTemplate', 
               'Get-ServiceDeskIntegrationTypes', 'Get-StatusCheckDetails', 
               'Invoke-PatchServiceDeskIntegration', 
               'Update-ServiceDeskIntegration', 'Update-StatusCheckDetails', 
               'Invoke-BulkUpdateProvisioningPolicies', 'New-ProvisioningPolicy', 
               'New-Schema', 'New-Source', 'Invoke-DeleteProvisioningPolicy', 
               'Invoke-DeleteSchema', 'Invoke-DeleteSource', 
               'Invoke-DownloadSourceAccountsSchema', 
               'Invoke-DownloadSourceEntitlementsSchema', 'Get-ProvisioningPolicy', 
               'Get-Schema', 'Get-Source', 'Get-SourceHealth', 
               'Invoke-ListProvisioningPolicies', 'Invoke-ListSchemas', 
               'Invoke-ListSources', 'Invoke-ReplaceProvisioningPolicy', 
               'Invoke-ReplaceSchema', 'Invoke-ReplaceSource', 
               'Update-ProvisioningPolicy', 'Update-Schema', 'Update-Source', 
               'Invoke-UploadConnectorFile', 'Invoke-UploadSourceAccountsSchema', 
               'Invoke-UploadSourceEntitlementsSchema', 'New-Transform', 
               'Invoke-DeleteTransform', 'Get-Transform', 'Get-TransformsList', 
               'Update-Transform', 'Approve-ApprovalItem', 
               'Invoke-BulkApproveApprovalItem', 'Invoke-BulkRejectApprovalItem', 
               'Complete-WorkItem', 'Complete-dWorkItems', 
               'Invoke-CountCompletedWorkItems', 'Invoke-CountWorkItems', 
               'Get-WorkItems', 'Invoke-ListWorkItems', 'Deny-ApprovalItem', 
               'Submit-AccountSelection', 'Invoke-SummaryWorkItems', 
               'Initialize-Access', 'ConvertFrom-JsonToAccess', 
               'ConvertFrom-JsonToAccess1', 'Initialize-AccessAllOf', 
               'ConvertFrom-JsonToAccessAllOf', 'Initialize-AccessProfile', 
               'ConvertFrom-JsonToAccessProfile', 'Initialize-AccessProfile1', 
               'ConvertFrom-JsonToAccessProfile1', 
               ...
               'ConvertFrom-JsonToAccount', 'Initialize-Account1', 
               'ConvertFrom-JsonToAccount1', 'Initialize-AccountAction', 
               'ConvertFrom-JsonToAccountAction', 'Initialize-AccountActivity', 
               'ConvertFrom-JsonToAccountActivity', 'Initialize-AccountActivity1', 
               'ConvertFrom-JsonToAccountActivity1', 
               ...
               'ConvertFrom-JsonToAggregation', 'Initialize-Aggregation1', 
               'ConvertFrom-JsonToAggregation1', 'Initialize-Aggregation1AllOf', 
               'ConvertFrom-JsonToAggregation1AllOf', 'Initialize-Aggregation2', 
               'ConvertFrom-JsonToAggregation2', 'Initialize-Aggregation2AllOf', 
               'ConvertFrom-JsonToAggregation2AllOf', 
               ...
               'ConvertFrom-JsonToApproval', 'Initialize-ApprovalForwardHistory', 
               ...
               'ConvertFrom-JsonToComment', 'Initialize-Comment1', 
               'ConvertFrom-JsonToComment1', 'Initialize-CommentDto', 
               ...
               'Initialize-CreateAccessRequest401Response', 
               'ConvertFrom-JsonToCreateAccessRequest401Response', 
               'Initialize-CreateAccessRequest429Response', 
               'ConvertFrom-JsonToCreateAccessRequest429Response', 
               ...
               'Initialize-Entitlement1', 'ConvertFrom-JsonToEntitlement1', 
               ...
               'Initialize-IdentityReference1', 
               'ConvertFrom-JsonToIdentityReference1', 
               'Initialize-IdentityReference1AllOf', 
               'ConvertFrom-JsonToIdentityReference1AllOf', 
               ...
               'ConvertFrom-JsonToLifecycleStateAllOf', 'Initialize-Lookup', 
               ...
               'ConvertFrom-JsonToModelFilter', 'Initialize-Name', 
               'ConvertFrom-JsonToName', 'Initialize-Name1', 
               'ConvertFrom-JsonToName1', 'Initialize-NameNormalizer', 
               ...
               'Initialize-NonEmployeeRecordBulkDeleteRequest', 
               'ConvertFrom-JsonToNonEmployeeRecordBulkDeleteRequest', 
               'Initialize-NonEmployeeRecordsBulkUploadRequest', 
               'ConvertFrom-JsonToNonEmployeeRecordsBulkUploadRequest', 
               ...
               'ConvertFrom-JsonToReviewRecommendation', 'Initialize-RightPad', 
               'ConvertFrom-JsonToRightPad', 'Initialize-Role', 
               'ConvertFrom-JsonToRole', 'Initialize-Role1', 
               'ConvertFrom-JsonToRole1', 'Initialize-RoleDocument', 
               'ConvertFrom-JsonToRoleDocument', 'Initialize-RoleDocumentAllOf', 
               'ConvertFrom-JsonToRoleDocumentAllOf', 'Initialize-RoleSummary', 
               'ConvertFrom-JsonToRoleSummary', 'Initialize-RoleSummaryAllOf', 
               'ConvertFrom-JsonToRoleSummaryAllOf', 'ConvertFrom-JsonToRule', 
               'Initialize-SavedSearch', 'ConvertFrom-JsonToSavedSearch', 
               'Initialize-SavedSearchAllOf', 'ConvertFrom-JsonToSavedSearchAllOf', 
               'Initialize-SavedSearchCreateRequest', 
               'ConvertFrom-JsonToSavedSearchCreateRequest', 'Initialize-Schedule', 
               'ConvertFrom-JsonToSchedule', 'Initialize-Schedule1', 
               'ConvertFrom-JsonToSchedule1', 'Initialize-ScheduledSearch', 
               'ConvertFrom-JsonToScheduledSearch', 
               'Initialize-ScheduledSearchAllOf', 
               'ConvertFrom-JsonToScheduledSearchAllOf', 
               'Initialize-ScheduledSearchCreateRequest', 
               'ConvertFrom-JsonToScheduledSearchCreateRequest', 
               'Initialize-Schema', 'ConvertFrom-JsonToSchema', 'Initialize-Search', 
               'ConvertFrom-JsonToSearch', 'Initialize-Search1', 
               'ConvertFrom-JsonToSearch1', 'Initialize-SearchArguments', 
               'ConvertFrom-JsonToSearchArguments', 
               'Initialize-SearchArgumentsOwner', 
               'ConvertFrom-JsonToSearchArgumentsOwner', 
               'ConvertFrom-JsonToSearchDocument', 'Initialize-SearchFilters', 
               'ConvertFrom-JsonToSearchFilters', 'Initialize-SectionDetails', 
               'ConvertFrom-JsonToSectionDetails', 
               ...
               'Initialize-Source', 'ConvertFrom-JsonToSource', 'Initialize-Source1', 
               'ConvertFrom-JsonToSource1', 'Initialize-Source1AllOf', 
               'ConvertFrom-JsonToSource1AllOf', 
               ...
               'Invoke-BetaBulkDeleteAccessProfiles', 'New-BetaAccessProfile', 
               'Invoke-BetaDeleteAccessProfile', 'Get-BetaAccessProfile', 
               'Invoke-BetaListAccessProfileEntitlements', 
               'Invoke-BetaListAccessProfiles', 'Invoke-BetaPatchAccessProfile', 
               'Invoke-BetaApprovalSummary', 'Approve-BetaRequest', 
               'Invoke-BetaForwardRequest', 'Invoke-BetaListCompletedApprovals', 
               'Invoke-BetaListPendingApprovals', 'Deny-BetaRequest', 
               'Stop-BetaAccessRequest', 'Close-BetaAccessRequest', 
               ...
               'Invoke-BetaDeleteAccount', 'Disable-BetaAccount', 
               'Enable-BetaAccount', 'Get-BetaAccount', 
               'Get-BetaAccountEntitlements', 'Invoke-BetaListAccounts', 
               'Send-BetaAccount', 'Invoke-BetaReloadAccount', 'Unlock-BetaAccount', 
               'Update-BetaAccount', 'Invoke-BetaActivateCampaign', 
               'Invoke-BetaAdminReassign', 'Complete-BetaCampaign', 
               'New-BetaCampaign', 'New-BetaCampaignTemplate', 
               'Invoke-BetaDeleteCampaignTemplate', 
               'Invoke-BetaDeleteCampaignTemplateSchedule', 
               'Invoke-BetaDeleteCampaigns', 'New-BetaCampaignTemplate', 
               ...
               'Invoke-BetaRunCampaignReport', 'Set-BetaCampaignReportsConfig', 
               'Set-BetaCampaignTemplateSchedule', 'Update-BetaCampaign', 
               ...
               'Invoke-BetaListReviewers', 'Invoke-BetaReassignIdentityCertsAsync', 
               'New-BetaConnectorRule', 'Invoke-BetaDeleteConnectorRule', 
               'Get-BetaConnectorRule', 'Get-BetaConnectorRuleList', 
               'Update-BetaConnectorRule', 'Confirm-BetaConnectorRule', 
               'Get-BetaConnectorList', 'New-BetaCustomPasswordInstructions', 
               'Invoke-BetaDeleteCustomPasswordInstructions', 
               'Get-BetaCustomPasswordInstructions', 
               'Invoke-BetaEntitlementsBulkUpdate', 'Get-BetaEntitlement', 
               'Invoke-BetaListEntitlementParents', 
               'Invoke-BetaListEntitlementchildren', 'Invoke-BetaListEntitlements', 
               ...
               'Invoke-BetaCommonAccessBulkUpdateStatus', 'New-BetaCommonAccess', 
               'Get-BetaCommonAccess', 'Export-BetaOutliersZip', 
               'Get-BetaLatestOutlierSnapshots', 'Get-BetaOutlierSnapshots', 
               'Get-BetaOutliers', 'Get-BetaOutliersContributingFeatures', 
               'Invoke-BetaIgnoreOutliers', 'Invoke-BetaUnIgnoreOutliers', 
               'Get-BetaOutliers', 'Get-BetaMessageCatalogs', 
               ...
               'Get-BetaPotentialRoleSummaries', 'Get-BetaPotentialRoleSummary', 
               'Get-BetaRoleMiningSession', 'Get-BetaRoleMiningSessionStatus', 
               'Get-BetaRoleMiningSessions', 'Invoke-BetaPatchRoleMiningSession', 
               'Invoke-BetaRoleMiningSessions', 
               'Sync-BetahronizeAttributesForIdentity', 
               'Compare-BetaIdentitySnapshots', 
               'Compare-BetaIdentitySnapshotsAccessType', 'Get-BetaEvents', 
               'Get-BetaIdentity', 'Get-BetaIdentitySnapshot', 
               'Get-BetaIdentitySnapshotSummary', 'Get-BetaStartDate', 
               'Invoke-BetaListIdentities', 'Invoke-BetaListIdentityAccessItems', 
               'Invoke-BetaListIdentitySnapshotAccessItems', 
               'Invoke-BetaListIdentitySnapshots', 'New-BetaIdentityProfile', 
               'Invoke-BetaDeleteIdentityProfile', 
               'Invoke-BetaDeleteIdentityProfiles', 'Export-BetaIdentityProfiles', 
               ...
               'Invoke-BetaRefreshIdentityProfile', 'Update-BetaIdentityProfile', 
               'Invoke-BetaListLifecycleStates', 'Update-BetaLifecycleStates', 
               'Get-BetaClientStatus', 'Update-BetaStatus', 
               'Get-BetaClientLogConfiguration', 'Get-BetaManagedCluster', 
               'Get-BetaManagedClusters', 'Update-BetaClientLogConfiguration', 
               'Get-BetaMFAConfig', 'Set-BetaMFAConfig', 'Test-BetaMFAConfig', 
               'New-BetaSchemaAttribute', 'Invoke-BetaDeleteSchemaAttribute', 
               'Invoke-BetaDeleteSchemaAttributes', 'Get-BetaSchemaAttribute', 
               'Get-BetaSchemaAttributes', 'Invoke-BetaNonEmployeeApprovalGet', 
               ...
               'Invoke-BetaDeleteVerifiedFromAddress', 'Get-BetaDkimAttributes', 
               ...
               'Test-BetaDomainDkim', 'New-BetaOauthClient', 
               'Invoke-BetaDeleteOauthClient', 'Get-BetaOauthClient', 
               'Invoke-BetaListOauthClients', 'Invoke-BetaPatchOauthClient', 
               'Get-BetaOrgConfig', 'Get-BetaValidTimeZones', 
               'Invoke-BetaPatchOrgConfig', 'New-BetaPasswordOrgConfig', 
               'Get-BetaPasswordOrgConfig', 'Update-BetaPasswordOrgConfig', 
               'Get-BetaPasswordDictionary', 
               'Get-BetaPasswordDictionaryFileStatus', 
               'Update-BetaPasswordDictionary', 'New-BetaDigitToken', 
               'Get-BetaPasswordChangeStatus', 'Invoke-BetaQueryPasswordInfo', 
               'Set-BetaPassword', 'New-BetaPasswordSyncGroup', 
               'Invoke-BetaDeletePasswordSyncGroup', 'Get-BetaPasswordSyncGroup', 
               ...
               'Invoke-BetaRoleInsightsRequests', 'New-BetaRole', 
               'Invoke-BetaDeleteRole', 'Get-BetaRole', 
               'Get-BetaRoleAssignedIdentities', 'Invoke-BetaListRoles', 
               'Invoke-BetaPatchRole', 'New-BetaSearchAttributeConfig', 
               'Invoke-BetaDeleteSearchAttributeConfig', 
               'Get-BetaSearchAttributeConfig', 
               'Get-BetaSingleSearchAttributeConfig', 
               'Invoke-BetaPatchSearchAttributeConfig', 'New-BetaSegment', 
               'Invoke-BetaDeleteSegmentById', 'Get-BetaSegmentById', 
               'Invoke-BetaListSegments', 'Invoke-BetaPatchSegment', 
               ...
               'Update-BetaStatusCheckDetails', 'New-BetaSodPolicy', 
               ...
               'Get-BetaSodAllReportRunStatus', 'Get-BetaSodPolicyById', 
               'Get-BetaSodPolicyScheduleById', 
               'Get-BetaSodViolationReportRunStatus', 
               'Get-BetaSodViolationReportStatus', 'Invoke-BetaListSodPolicies', 
               'Invoke-BetaPatchSodPolicy', 'Invoke-BetaRunAllPoliciesForOrg', 
               'Invoke-BetaRunSodPolicy', 'Update-BetaPolicyById', 
               'Update-BetaPolicyScheduleById', 'Invoke-BetaPredictViolations', 
               'Invoke-BetaBulkUpdateProvisioningPolicies', 
               'Invoke-BetaCheckConnection', 'New-BetaProvisioningPolicy', 
               'New-BetaSchema', 'New-BetaSource', 
               'Invoke-BetaDeleteProvisioningPolicy', 'Invoke-BetaDeleteSchema', 
               'Invoke-BetaDeleteSource', 
               'Invoke-BetaDownloadSourceAccountsSchema', 
               'Invoke-BetaDownloadSourceEntitlementsSchema', 
               'Get-BetaProvisioningPolicy', 'Get-BetaSchema', 'Get-BetaSource', 
               'Get-BetaSourceAttrSyncConfig', 'Get-BetaSourceConfig', 
               'Invoke-BetaListProvisioningPolicies', 'Invoke-BetaListSchemas', 
               'Invoke-BetaListSources', 'Receive-BetaResourceObjects', 
               'Ping-BetaCluster', 'Send-BetaSourceAttrSyncConfig', 
               'Invoke-BetaReplaceProvisioningPolicy', 'Invoke-BetaReplaceSchema', 
               'Invoke-BetaReplaceSource', 'Sync-BetahronizeAttributesForSource', 
               'Test-BetaConfiguration', 'Update-BetaProvisioningPolicy', 
               'Update-BetaSchema', 'Update-BetaSource', 
               'Invoke-BetaUploadConnectorFile', 
               'Invoke-BetaUploadSourceAccountsSchema', 
               'Invoke-BetaUploadSourceEntitlementsSchema', 
               'Invoke-BetaSpConfigExport', 'Invoke-BetaSpConfigExportDownload', 
               'Invoke-BetaSpConfigExportJobStatus', 'Invoke-BetaSpConfigImport', 
               'Invoke-BetaSpConfigImportDownload', 
               'Invoke-BetaSpConfigImportJobStatus', 'Invoke-BetaSpConfigObjects', 
               'Add-BetaTagToObject', 'Add-BetaTagsToManyObjects', 
               'Invoke-BetaDeleteTaggedObjectByTypeAndId', 
               'Get-BetaTaggedObjectByTypeAndId', 'Invoke-BetaListTaggedObjects', 
               'Invoke-BetaListTaggedObjectsByType', 'Remove-BetaTagsToManyObject', 
               'Update-BetaTaggedObjectByTypeAndId', 'New-BetaTransform', 
               'Invoke-BetaDeleteTransform', 'Get-BetaTransform', 
               'Get-BetaTransformsList', 'Update-BetaTransform', 
               'Complete-BetaInvocation', 'New-BetaSubscription', 
               'Invoke-BetaDeleteSubscription', 'Invoke-BetaListInvocationStatus', 
               'Invoke-BetaListSubscriptions', 'Invoke-BetaListTriggers', 
               'Invoke-BetaPatchSubscription', 'Start-BetaTestInvocation', 
               'Update-BetaSubscription', 'Confirm-BetaFilter', 
               'Stop-BetaWorkflowExecution', 'New-BetaWorkflow', 
               'Invoke-BetaDeleteWorkflow', 'Get-BetaWorkflow', 
               ...
               'Invoke-BetaListWorkflows', 'Invoke-BetaPatchWorkflow', 
               ...
               'Invoke-BetaBulkRejectApprovalItem', 'Complete-BetaWorkItem', 
               'Complete-BetadWorkItems', 'Invoke-BetaCountCompletedWorkItems', 
               'Invoke-BetaCountWorkItems', 'Get-BetaWorkItems', 
               'Invoke-BetaListWorkItems', 'Deny-BetaApprovalItem', 
               'Submit-BetaAccountSelection', 'Invoke-BetaSummaryWorkItems', 
               ...
               'Initialize-BetaApprovalScheme', 
               'ConvertFrom-BetaJsonToApprovalScheme', 
               ...
               'ConvertFrom-BetaJsonToGetEvents200ResponseInner', 
               ...
               'ConvertFrom-BetaJsonToImportOptions', 'Initialize-BetaInvocation', 
               'ConvertFrom-BetaJsonToInvocation', 
               ...
               'Initialize-BetaNonEmployeeRecordBulkDeleteRequest', 
               'ConvertFrom-BetaJsonToNonEmployeeRecordBulkDeleteRequest', 
               'Initialize-BetaNonEmployeeRecordsBulkUploadRequest', 
               'ConvertFrom-BetaJsonToNonEmployeeRecordsBulkUploadRequest', 
               ...
               'Initialize-BetaRoleMiningPotentialRoleSummaryDistribution', 
               'ConvertFrom-BetaJsonToRoleMiningPotentialRoleSummaryDistribution', 
               ...
               'Initialize-BetaSpConfigImportRequest', 
               'ConvertFrom-BetaJsonToSpConfigImportRequest', 
               ...
               'Get-BetaConfigurationHttpSigning', 'Invoke-BulkDeleteWorkGroups', 
               'New-Workgroup', 'Invoke-DeleteWorkgroup', 'Get-Workgroup', 
               'Invoke-ListWorkgroupConnections', 'Invoke-ListWorkgroupMembers', 
               'Invoke-ListWorkgroups', 'Edit-WorkgroupMembers', 'Update-Workgroup', 
               'Get-OrgSettings', 'Update-OrgSettings', 
               'Invoke-V2BulkDeleteWorkGroups', 'New-V2Workgroup', 
               'Invoke-V2DeleteWorkgroup', 'Get-V2Workgroup', 
               'Invoke-V2ListWorkgroupConnections', 
               'Invoke-V2ListWorkgroupMembers', 'Invoke-V2ListWorkgroups', 
               'Edit-V2WorkgroupMembers', 'Update-V2Workgroup', 'Get-V2OrgSettings', 
               ...
               'ConvertFrom-V2JsonToUpdateOrgSettingsRequest', 'Get-Configuration', 
               ...
               'Get-V2ConfigurationHttpSigning', 'Invoke-ListAccounts', 
               'Remove-Account', 'New-Application', 'Invoke-DeleteApplication', 
               'Get-Application', 'Get-ApplicationAccessProfiles', 
               'Invoke-ListApplications', 'Update-Application', 
               'Invoke-CCListAccounts', 'Remove-CCAccount', 'New-CCApplication', 
               'Invoke-CCDeleteApplication', 'Get-CCApplication', 
               'Get-CCApplicationAccessProfiles', 'Invoke-CCListApplications', 
               'Update-CCApplication', 'New-CCConnector', 'Invoke-CCDeleteConnector', 
               'Export-CCConnectorConfig', 'Import-CCConnectorConfig', 
               'Invoke-CCListConnectors', 'Export-CCAccountFeed', 
               'Invoke-CCLoadAccounts', 'Invoke-CCRefreshIdentities', 
               'Update-CCUserPermissions', 'New-Connector', 'Invoke-DeleteConnector', 
               'Export-ConnectorConfig', 'Import-ConnectorConfig', 
               'Invoke-ListConnectors', 'Export-AccountFeed', 'Invoke-LoadAccounts', 
               'Invoke-RefreshIdentities', 'Update-UserPermissions', 
               ...
               'Get-CCConfigurationHttpSigning', 'Get-Configuration', 
               'Set-Configuration', 'Set-ConfigurationApiKey', 
               'Set-ConfigurationApiKeyPrefix', 'Set-ConfigurationDefaultHeader', 
               'Get-HostSetting', 'Get-UrlFromHostSetting', 
               'Set-ConfigurationHttpSigning', 'Get-ConfigurationHttpSigning'

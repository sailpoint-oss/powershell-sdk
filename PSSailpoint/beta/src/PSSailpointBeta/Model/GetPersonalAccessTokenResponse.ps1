...
function Initialize-BetaGetPersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaGetPersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToGetPersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaGetPersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

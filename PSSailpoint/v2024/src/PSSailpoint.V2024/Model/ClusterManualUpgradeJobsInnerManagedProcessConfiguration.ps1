...
function Initialize-V2024ClusterManualUpgradeJobsInnerManagedProcessConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfiguration' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfiguration<PSCustomObject>
#>
function ConvertFrom-V2024JsonToClusterManualUpgradeJobsInnerManagedProcessConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ClusterManualUpgradeJobsInnerManagedProcessConfiguration

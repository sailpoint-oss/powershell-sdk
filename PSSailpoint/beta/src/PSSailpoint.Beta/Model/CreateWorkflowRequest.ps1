...
function Initialize-BetaCreateWorkflowRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCreateWorkflowRequest' | Write-Debug
...
CreateWorkflowRequest<PSCustomObject>
#>
function ConvertFrom-BetaJsonToCreateWorkflowRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCreateWorkflowRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaCreateWorkflowRequest

...
function Initialize-V2024SpConfigJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SpConfigJob' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SpConfigJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

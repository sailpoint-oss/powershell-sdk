...
keywords: ['powershell', 'PowerShell', 'sdk', 'PublicIdentitiesConfig', 'V2026PublicIdentitiesConfig'] 
slug: /tools/sdk/powershell/v2026/methods/public-identities-config
...
------------- | ------------- | -------------
[**Get-V2026PublicIdentityConfig**](#get-public-identity-config) | **GET** `/public-identities-config` | Get the public identities configuration
[**Update-V2026PublicIdentityConfig**](#update-public-identity-config) | **PUT** `/public-identities-config` | Update the public identities configuration
...
try {
    Get-V2026PublicIdentityConfig 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PublicIdentityConfig  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026PublicIdentityConfig"
...
try {
    $Result = ConvertFrom-V2026JsonToPublicIdentityConfig -Json $PublicIdentityConfig
    Update-V2026PublicIdentityConfig -PublicIdentityConfig $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026PublicIdentityConfig -PublicIdentityConfig $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026PublicIdentityConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

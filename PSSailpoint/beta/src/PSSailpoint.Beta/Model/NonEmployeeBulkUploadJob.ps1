...
function Initialize-BetaNonEmployeeBulkUploadJob {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeBulkUploadJob' | Write-Debug
...
NonEmployeeBulkUploadJob<PSCustomObject>
#>
function ConvertFrom-BetaJsonToNonEmployeeBulkUploadJob {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeBulkUploadJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaNonEmployeeBulkUploadJob

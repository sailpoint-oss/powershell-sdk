...
IdentityReference2<PSCustomObject>
#>

function Initialize-IdentityReference2 {
    [CmdletBinding()]
    Param (
...
Convert from JSON to IdentityReference2<PSCustomObject>
...
IdentityReference2<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityReference2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in IdentityReference2

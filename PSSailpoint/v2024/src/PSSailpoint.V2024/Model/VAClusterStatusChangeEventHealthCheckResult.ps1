...
function Initialize-V2024VAClusterStatusChangeEventHealthCheckResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024VAClusterStatusChangeEventHealthCheckResult' | Write-Debug
...
VAClusterStatusChangeEventHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-V2024JsonToVAClusterStatusChangeEventHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024VAClusterStatusChangeEventHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024VAClusterStatusChangeEventHealthCheckResult

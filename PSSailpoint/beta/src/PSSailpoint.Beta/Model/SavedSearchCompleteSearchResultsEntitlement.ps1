...
function Initialize-BetaSavedSearchCompleteSearchResultsEntitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSavedSearchCompleteSearchResultsEntitlement' | Write-Debug
...
function ConvertFrom-BetaJsonToSavedSearchCompleteSearchResultsEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSavedSearchCompleteSearchResultsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

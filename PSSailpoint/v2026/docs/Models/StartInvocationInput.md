...
keywords: ['powershell', 'PowerShell', 'sdk', 'StartInvocationInput', 'V2026StartInvocationInput'] 
slug: /tools/sdk/powershell/v2026/models/start-invocation-input
...
```powershell
$StartInvocationInput = Initialize-V2026StartInvocationInput  -TriggerId idn:access-requested `

...
function Initialize-BetaRequestedItemStatusSodViolationContext {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRequestedItemStatusSodViolationContext' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestedItemStatusSodViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRequestedItemStatusSodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

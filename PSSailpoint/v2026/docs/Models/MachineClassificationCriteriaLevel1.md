...
keywords: ['powershell', 'PowerShell', 'sdk', 'MachineClassificationCriteriaLevel1', 'V2026MachineClassificationCriteriaLevel1'] 
slug: /tools/sdk/powershell/v2026/models/machine-classification-criteria-level1
...
```powershell
$MachineClassificationCriteriaLevel1 = Initialize-V2026MachineClassificationCriteriaLevel1  -Operation null `
 -CaseSensitive false `
 -DataType null `

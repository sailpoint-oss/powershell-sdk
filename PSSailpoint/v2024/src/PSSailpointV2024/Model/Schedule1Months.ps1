...
function Initialize-V2024Schedule1Months {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Schedule1Months' | Write-Debug
...
function ConvertFrom-V2024JsonToSchedule1Months {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Schedule1Months' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeIdentityReferenceWithId {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => NonEmployeeIdentityReferenceWithId' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeIdentityReferenceWithId {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => NonEmployeeIdentityReferenceWithId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

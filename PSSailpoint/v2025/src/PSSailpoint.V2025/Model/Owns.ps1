...
function Initialize-V2025Owns {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025Owns' | Write-Debug
...
Owns<PSCustomObject>
#>
function ConvertFrom-V2025JsonToOwns {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025Owns' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025Owns

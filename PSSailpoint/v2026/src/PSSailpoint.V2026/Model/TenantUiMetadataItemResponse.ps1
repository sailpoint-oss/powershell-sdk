...
function Initialize-V2026TenantUiMetadataItemResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TenantUiMetadataItemResponse' | Write-Debug
...
TenantUiMetadataItemResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTenantUiMetadataItemResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TenantUiMetadataItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TenantUiMetadataItemResponse

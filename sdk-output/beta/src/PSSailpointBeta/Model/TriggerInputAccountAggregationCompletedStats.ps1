...
TriggerInputAccountAggregationCompletedStats<PSCustomObject>
#>

function Initialize-BetaTriggerInputAccountAggregationCompletedStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountAggregationCompletedStats' | Write-Debug
...
Convert from JSON to TriggerInputAccountAggregationCompletedStats<PSCustomObject>
...
TriggerInputAccountAggregationCompletedStats<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputAccountAggregationCompletedStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountAggregationCompletedStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputAccountAggregationCompletedStats

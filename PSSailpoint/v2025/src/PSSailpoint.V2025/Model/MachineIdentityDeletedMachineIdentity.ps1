...
MachineIdentityDeletedMachineIdentity<PSCustomObject>
#>

function Initialize-V2025MachineIdentityDeletedMachineIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025MachineIdentityDeletedMachineIdentity' | Write-Debug
...
Convert from JSON to MachineIdentityDeletedMachineIdentity<PSCustomObject>
...
MachineIdentityDeletedMachineIdentity<PSCustomObject>
#>
function ConvertFrom-V2025JsonToMachineIdentityDeletedMachineIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025MachineIdentityDeletedMachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025MachineIdentityDeletedMachineIdentity

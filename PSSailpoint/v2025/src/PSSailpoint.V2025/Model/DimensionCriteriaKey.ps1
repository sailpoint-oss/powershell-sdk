...
DimensionCriteriaKey<PSCustomObject>
#>

function Initialize-V2025DimensionCriteriaKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025DimensionCriteriaKey' | Write-Debug
...
Convert from JSON to DimensionCriteriaKey<PSCustomObject>
...
DimensionCriteriaKey<PSCustomObject>
#>
function ConvertFrom-V2025JsonToDimensionCriteriaKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025DimensionCriteriaKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025DimensionCriteriaKey

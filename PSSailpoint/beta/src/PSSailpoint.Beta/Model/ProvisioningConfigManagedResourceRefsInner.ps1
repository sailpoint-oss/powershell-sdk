...
function Initialize-BetaProvisioningConfigManagedResourceRefsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaProvisioningConfigManagedResourceRefsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningConfigManagedResourceRefsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaProvisioningConfigManagedResourceRefsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

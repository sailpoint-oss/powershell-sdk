...
function Initialize-BetaVendorConnectorMappingDeletedAt {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaVendorConnectorMappingDeletedAt' | Write-Debug
...
function ConvertFrom-BetaJsonToVendorConnectorMappingDeletedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaVendorConnectorMappingDeletedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025IdentityLifecycleState {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025IdentityLifecycleState' | Write-Debug
...
IdentityLifecycleState<PSCustomObject>
#>
function ConvertFrom-V2025JsonToIdentityLifecycleState {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025IdentityLifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025IdentityLifecycleState

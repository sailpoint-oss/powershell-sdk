...
keywords: ['powershell', 'PowerShell', 'sdk', 'RequestedItemStatusForm', 'RequestedItemStatusForm'] 
slug: /tools/sdk/powershell/accessrequests/models/requested-item-status-form
...
```powershell
$RequestedItemStatusForm = Initialize-RequestedItemStatusForm  -FormDefinitionId b2c1808f-77f5-4a3a-9f3a-1d2e3f4a5b6c `
...
```powershell
$RequestedItemStatusForm | ConvertTo-JSON
```

...
function Initialize-V2024FeatureValueDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024FeatureValueDto' | Write-Debug
...
FeatureValueDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToFeatureValueDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024FeatureValueDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024FeatureValueDto

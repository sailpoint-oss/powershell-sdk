...
function Initialize-V2024InvocationStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024InvocationStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToInvocationStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024InvocationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-RemediationItemDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => RemediationItemDetails' | Write-Debug
...
function ConvertFrom-JsonToRemediationItemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => RemediationItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

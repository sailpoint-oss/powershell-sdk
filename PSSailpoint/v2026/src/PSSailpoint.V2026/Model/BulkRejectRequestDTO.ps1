...
function Initialize-V2026BulkRejectRequestDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026BulkRejectRequestDTO' | Write-Debug
...
BulkRejectRequestDTO<PSCustomObject>
#>
function ConvertFrom-V2026JsonToBulkRejectRequestDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026BulkRejectRequestDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026BulkRejectRequestDTO

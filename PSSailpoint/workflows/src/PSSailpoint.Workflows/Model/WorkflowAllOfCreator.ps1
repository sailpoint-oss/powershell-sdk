...
function Initialize-WorkflowAllOfCreator {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Workflows => WorkflowAllOfCreator' | Write-Debug
...
function ConvertFrom-JsonToWorkflowAllOfCreator {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Workflows => WorkflowAllOfCreator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

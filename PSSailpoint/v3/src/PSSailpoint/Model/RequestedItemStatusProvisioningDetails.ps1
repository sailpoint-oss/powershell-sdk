...
function Initialize-RequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => RequestedItemStatusProvisioningDetails' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => RequestedItemStatusProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

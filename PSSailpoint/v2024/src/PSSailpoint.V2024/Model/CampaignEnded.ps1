...
function Initialize-V2024CampaignEnded {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CampaignEnded' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignEnded {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CampaignEnded' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

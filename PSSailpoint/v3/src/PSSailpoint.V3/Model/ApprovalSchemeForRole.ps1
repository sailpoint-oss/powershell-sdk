...
function Initialize-ApprovalSchemeForRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ApprovalSchemeForRole' | Write-Debug
...
function ConvertFrom-JsonToApprovalSchemeForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ApprovalSchemeForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaLifecycleStateDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaLifecycleStateDto' | Write-Debug
...
function ConvertFrom-BetaJsonToLifecycleStateDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaLifecycleStateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

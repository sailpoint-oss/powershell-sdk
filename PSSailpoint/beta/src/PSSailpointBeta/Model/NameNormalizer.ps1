...
function Initialize-BetaNameNormalizer {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaNameNormalizer' | Write-Debug
...
function ConvertFrom-BetaJsonToNameNormalizer {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaNameNormalizer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
# List access profiles for the specified source app
try {
    $Result = Get-BetaAccessProfilesForSourceApp -Id $Id -Limit $Limit -Offset $Offset -Filters $Filters
} catch {
...
# List all source apps
try {
    $Result = Get-BetaAllSourceApp -Limit $Limit -Count $Count -Offset $Offset -Sorters $Sorters -Filters $Filters
} catch {
...
# List all user apps
try {
    $Result = Get-BetaAllUserApps -Filters $Filters -Limit $Limit -Count $Count -Offset $Offset
} catch {
...
# List assigned source apps
try {
    $Result = Get-BetaAssignedSourceApp -Limit $Limit -Count $Count -Offset $Offset -Sorters $Sorters -Filters $Filters
} catch {
...
# List available accounts for user app
try {
    $Result = Get-BetaAvailableAccountsForUserApp -Id $Id -Limit $Limit -Count $Count -Offset $Offset
} catch {
...
# List available source apps
try {
    $Result = Get-BetaAvailableSourceApps -Limit $Limit -Count $Count -Offset $Offset -Sorters $Sorters -Filters $Filters
} catch {
...
# List owned user apps
try {
    $Result = Get-BetaOwnedUserApps -Limit $Limit -Count $Count -Offset $Offset -Filters $Filters
} catch {
...
$JsonPatchOperation = Initialize-JsonPatchOperation -Op "add" -Path "/description" -Value $UpdateMultiHostSourcesRequestInnerValue # JsonPatchOperation[] |  (optional)

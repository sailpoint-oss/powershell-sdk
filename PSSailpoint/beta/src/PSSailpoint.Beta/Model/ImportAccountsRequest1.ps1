...
function Initialize-BetaImportAccountsRequest1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaImportAccountsRequest1' | Write-Debug
...
function ConvertFrom-BetaJsonToImportAccountsRequest1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaImportAccountsRequest1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

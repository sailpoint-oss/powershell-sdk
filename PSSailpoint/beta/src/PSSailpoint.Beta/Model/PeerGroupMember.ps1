...
function Initialize-BetaPeerGroupMember {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaPeerGroupMember' | Write-Debug
...
function ConvertFrom-BetaJsonToPeerGroupMember {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaPeerGroupMember' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024AccessProfileEntitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileEntitlement' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

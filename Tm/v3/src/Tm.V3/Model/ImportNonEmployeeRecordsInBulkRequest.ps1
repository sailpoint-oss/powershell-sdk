...
function Initialize-ImportNonEmployeeRecordsInBulkRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ImportNonEmployeeRecordsInBulkRequest' | Write-Debug
...
function ConvertFrom-JsonToImportNonEmployeeRecordsInBulkRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ImportNonEmployeeRecordsInBulkRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

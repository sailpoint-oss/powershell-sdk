...
function Initialize-ListAccessProfiles401Response {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ListAccessProfiles401Response' | Write-Debug
...
function ConvertFrom-JsonToListAccessProfiles401Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ListAccessProfiles401Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

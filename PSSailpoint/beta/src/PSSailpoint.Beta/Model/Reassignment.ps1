...
function Initialize-BetaReassignment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaReassignment' | Write-Debug
...
Reassignment<PSCustomObject>
#>
function ConvertFrom-BetaJsonToReassignment {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaReassignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaReassignment

...
function Initialize-Accessrequestpreapproval {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Accessrequestpreapproval' | Write-Debug
...
Accessrequestpreapproval<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestpreapproval {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Accessrequestpreapproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessrequestpreapproval

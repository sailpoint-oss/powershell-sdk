...
FunctionsToExport = 'New-AccessProfile', 'Remove-AccessProfilesInBulk', 
               ...
               'Complete-Campaign', 'New-Campaign', 'Remove-Campaigns', 
               'Get-ActiveCampaigns', 'Get-Campaign', 'Get-CampaignReports', 
               'Get-CampaignReportsConfig', 'Move-', 'Set-CampaignReportsConfig', 
               'Start-Campaign', 'Start-CampaignRemediationScan', 
               'Start-CampaignReport', 'Update-Campaign', 'Get-CertificationTask', 

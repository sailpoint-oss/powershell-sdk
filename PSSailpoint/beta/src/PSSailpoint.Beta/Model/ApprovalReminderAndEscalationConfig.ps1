...
function Initialize-BetaApprovalReminderAndEscalationConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalReminderAndEscalationConfig' | Write-Debug
...
ApprovalReminderAndEscalationConfig<PSCustomObject>
#>
function ConvertFrom-BetaJsonToApprovalReminderAndEscalationConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalReminderAndEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaApprovalReminderAndEscalationConfig

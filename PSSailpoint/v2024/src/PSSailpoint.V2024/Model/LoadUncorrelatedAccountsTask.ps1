...
function Initialize-V2024LoadUncorrelatedAccountsTask {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024LoadUncorrelatedAccountsTask' | Write-Debug
...
function ConvertFrom-V2024JsonToLoadUncorrelatedAccountsTask {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024LoadUncorrelatedAccountsTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

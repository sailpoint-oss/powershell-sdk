...
LifecycleState
#>
function New-V2024LifecycleState {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2024LifecycleState' | Write-Debug
...
#>
function Remove-V2024LifecycleState {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2024LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LifecycleState
#>
function Get-V2024LifecycleState {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LifecycleState[]
#>
function Get-V2024LifecycleStates {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024LifecycleStates' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Set-V2024LifecycleState {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-V2024LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LifecycleState
#>
function Update-V2024LifecycleStates {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2024LifecycleStates' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

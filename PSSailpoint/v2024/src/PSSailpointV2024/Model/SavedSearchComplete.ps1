...
function Initialize-V2024SavedSearchComplete {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SavedSearchComplete' | Write-Debug
...
function ConvertFrom-V2024JsonToSavedSearchComplete {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SavedSearchComplete' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

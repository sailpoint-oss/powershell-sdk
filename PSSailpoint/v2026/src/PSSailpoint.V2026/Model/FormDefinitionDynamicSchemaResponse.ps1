...
function Initialize-V2026FormDefinitionDynamicSchemaResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026FormDefinitionDynamicSchemaResponse' | Write-Debug
...
FormDefinitionDynamicSchemaResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToFormDefinitionDynamicSchemaResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026FormDefinitionDynamicSchemaResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026FormDefinitionDynamicSchemaResponse

...
function Initialize-V2024WorkflowLibraryAction {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkflowLibraryAction' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowLibraryAction {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkflowLibraryAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

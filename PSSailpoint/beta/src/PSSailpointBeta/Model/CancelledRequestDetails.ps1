...
function Initialize-BetaCancelledRequestDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaCancelledRequestDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToCancelledRequestDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaCancelledRequestDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

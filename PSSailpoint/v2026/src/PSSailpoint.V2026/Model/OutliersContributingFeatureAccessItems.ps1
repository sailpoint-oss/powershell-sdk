...
function Initialize-V2026OutliersContributingFeatureAccessItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026OutliersContributingFeatureAccessItems' | Write-Debug
...
OutliersContributingFeatureAccessItems<PSCustomObject>
#>
function ConvertFrom-V2026JsonToOutliersContributingFeatureAccessItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026OutliersContributingFeatureAccessItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026OutliersContributingFeatureAccessItems

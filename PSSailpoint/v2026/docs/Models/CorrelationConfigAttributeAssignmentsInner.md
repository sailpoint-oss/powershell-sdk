...
keywords: ['powershell', 'PowerShell', 'sdk', 'CorrelationConfigAttributeAssignmentsInner', 'V2026CorrelationConfigAttributeAssignmentsInner'] 
slug: /tools/sdk/powershell/v2026/models/correlation-config-attribute-assignments-inner
...
```powershell
$CorrelationConfigAttributeAssignmentsInner = Initialize-V2026CorrelationConfigAttributeAssignmentsInner  -Property first_name `
 -Value firstName `
 -Operation EQ `
 -Complex false `
 -IgnoreCase false `

...
function Initialize-V2024CreateOAuthClientResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CreateOAuthClientResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateOAuthClientResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CreateOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ManagerCorrelationMapping {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ManagerCorrelationMapping' | Write-Debug
...
function ConvertFrom-JsonToManagerCorrelationMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccessRequestPostApproval {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestPostApproval' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPostApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestPostApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

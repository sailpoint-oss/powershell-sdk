...
function Initialize-V2026NonEmployeeApprovalItemDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeApprovalItemDetail' | Write-Debug
...
NonEmployeeApprovalItemDetail<PSCustomObject>
#>
function ConvertFrom-V2026JsonToNonEmployeeApprovalItemDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeApprovalItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026NonEmployeeApprovalItemDetail

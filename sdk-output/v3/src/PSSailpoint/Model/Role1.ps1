...
function Initialize-Role1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => Role1' | Write-Debug
...
Role1<PSCustomObject>
#>
function ConvertFrom-JsonToRole1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => Role1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Role1

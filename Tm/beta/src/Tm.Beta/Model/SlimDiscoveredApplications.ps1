...
function Initialize-BetaSlimDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSlimDiscoveredApplications' | Write-Debug
...
function ConvertFrom-BetaJsonToSlimDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSlimDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

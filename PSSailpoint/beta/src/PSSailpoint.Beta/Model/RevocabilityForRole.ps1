...
function Initialize-BetaRevocabilityForRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRevocabilityForRole' | Write-Debug
...
function ConvertFrom-BetaJsonToRevocabilityForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRevocabilityForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

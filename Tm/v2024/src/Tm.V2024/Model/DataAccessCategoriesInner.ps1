...
function Initialize-V2024DataAccessCategoriesInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024DataAccessCategoriesInner' | Write-Debug
...
function ConvertFrom-V2024JsonToDataAccessCategoriesInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024DataAccessCategoriesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Schedule1Days {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => Schedule1Days' | Write-Debug
...
Schedule1Days<PSCustomObject>
#>
function ConvertFrom-JsonToSchedule1Days {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => Schedule1Days' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Schedule1Days

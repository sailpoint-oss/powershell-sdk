...
function Initialize-V2024CertificationSignedOffCertification {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CertificationSignedOffCertification' | Write-Debug
...
function ConvertFrom-V2024JsonToCertificationSignedOffCertification {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CertificationSignedOffCertification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

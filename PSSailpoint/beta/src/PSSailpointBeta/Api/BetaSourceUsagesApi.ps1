...
SourceUsageStatus
#>
function Get-BetaStatusBySourceId {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-BetaStatusBySourceId' | Write-Debug
...
SourceUsage[]
#>
function Get-BetaUsagesBySourceId {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-BetaUsagesBySourceId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

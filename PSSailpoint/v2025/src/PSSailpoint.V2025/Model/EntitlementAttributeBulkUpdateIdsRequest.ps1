...
EntitlementAttributeBulkUpdateIdsRequest<PSCustomObject>
#>

function Initialize-V2025EntitlementAttributeBulkUpdateIdsRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025EntitlementAttributeBulkUpdateIdsRequest' | Write-Debug
...
Convert from JSON to EntitlementAttributeBulkUpdateIdsRequest<PSCustomObject>
...
EntitlementAttributeBulkUpdateIdsRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToEntitlementAttributeBulkUpdateIdsRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025EntitlementAttributeBulkUpdateIdsRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025EntitlementAttributeBulkUpdateIdsRequest

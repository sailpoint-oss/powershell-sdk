...
keywords: ['powershell', 'PowerShell', 'sdk', 'BackupResponse', 'V2026BackupResponse'] 
slug: /tools/sdk/powershell/v2026/models/backup-response
...
```powershell
$BackupResponse = Initialize-V2026BackupResponse  -JobId 3469b87d-48ca-439a-868f-2160001da8c1 `
 -Status COMPLETE `
 -Type BACKUP `
 -Tenant tenant-name `

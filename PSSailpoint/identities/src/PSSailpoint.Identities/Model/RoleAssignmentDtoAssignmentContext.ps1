...
function Initialize-RoleAssignmentDtoAssignmentContext {
    [CmdletBinding()]
    Param (
...
RoleAssignmentDtoAssignmentContext<PSCustomObject>
#>
function ConvertFrom-JsonToRoleAssignmentDtoAssignmentContext {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in RoleAssignmentDtoAssignmentContext

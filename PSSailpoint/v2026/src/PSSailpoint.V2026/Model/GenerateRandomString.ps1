...
function Initialize-V2026GenerateRandomString {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026GenerateRandomString' | Write-Debug
...
GenerateRandomString<PSCustomObject>
#>
function ConvertFrom-V2026JsonToGenerateRandomString {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026GenerateRandomString' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026GenerateRandomString

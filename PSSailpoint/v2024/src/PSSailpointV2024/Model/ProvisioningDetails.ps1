...
function Initialize-V2024ProvisioningDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ProvisioningDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

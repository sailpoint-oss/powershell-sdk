...
try {
    Get-V2026PendingTaskHeaders 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PendingTaskHeaders -Offset $Offset -Limit $Limit -Count $Count  
} catch {
...
try {
    Get-V2026PendingTasks 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PendingTasks -Offset $Offset -Limit $Limit -Count $Count  
} catch {
...
try {
    ...
    Update-V2026TaskStatus -Id $Id -JsonPatchOperation $Result 

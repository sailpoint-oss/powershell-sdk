...
function Initialize-BetaAttrSyncSourceAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAttrSyncSourceAttributeConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToAttrSyncSourceAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAttrSyncSourceAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

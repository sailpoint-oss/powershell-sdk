...
function Initialize-BetaConditionEffect {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConditionEffect' | Write-Debug
...
function ConvertFrom-BetaJsonToConditionEffect {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConditionEffect' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ApprovalName {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ApprovalName' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalName {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ApprovalName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

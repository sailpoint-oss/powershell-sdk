...
function Initialize-BetaWorkflowLibraryOperator {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaWorkflowLibraryOperator' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowLibraryOperator {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaWorkflowLibraryOperator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

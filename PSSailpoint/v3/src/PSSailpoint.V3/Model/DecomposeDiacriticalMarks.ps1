...
function Initialize-DecomposeDiacriticalMarks {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => DecomposeDiacriticalMarks' | Write-Debug
...
function ConvertFrom-JsonToDecomposeDiacriticalMarks {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => DecomposeDiacriticalMarks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaRoleInsightsEntitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleInsightsEntitlement' | Write-Debug
...
RoleInsightsEntitlement<PSCustomObject>
#>
function ConvertFrom-BetaJsonToRoleInsightsEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleInsightsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaRoleInsightsEntitlement

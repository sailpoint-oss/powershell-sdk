...
function Initialize-V2024DecomposeDiacriticalMarks {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024DecomposeDiacriticalMarks' | Write-Debug
...
function ConvertFrom-V2024JsonToDecomposeDiacriticalMarks {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024DecomposeDiacriticalMarks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

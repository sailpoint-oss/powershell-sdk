...
function Initialize-V2024ProcessIdentitiesRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ProcessIdentitiesRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToProcessIdentitiesRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ProcessIdentitiesRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

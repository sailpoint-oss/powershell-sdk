...
function Initialize-V2024ManagedClusterRedis {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManagedClusterRedis' | Write-Debug
...
ManagedClusterRedis<PSCustomObject>
#>
function ConvertFrom-V2024JsonToManagedClusterRedis {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManagedClusterRedis' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ManagedClusterRedis

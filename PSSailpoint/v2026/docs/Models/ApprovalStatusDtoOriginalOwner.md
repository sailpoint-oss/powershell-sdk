...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalStatusDtoOriginalOwner', 'V2026ApprovalStatusDtoOriginalOwner'] 
slug: /tools/sdk/powershell/v2026/models/approval-status-dto-original-owner
...
```powershell
$ApprovalStatusDtoOriginalOwner = Initialize-V2026ApprovalStatusDtoOriginalOwner  -Type IDENTITY `

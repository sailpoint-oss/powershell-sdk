...
function Initialize-Subscriptionputrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Subscriptionputrequest' | Write-Debug
...
Subscriptionputrequest<PSCustomObject>
#>
function ConvertFrom-JsonToSubscriptionputrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Subscriptionputrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Subscriptionputrequest

...
function Initialize-V2026KbaAnswerRequestItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026KbaAnswerRequestItem' | Write-Debug
...
KbaAnswerRequestItem<PSCustomObject>
#>
function ConvertFrom-V2026JsonToKbaAnswerRequestItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026KbaAnswerRequestItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026KbaAnswerRequestItem

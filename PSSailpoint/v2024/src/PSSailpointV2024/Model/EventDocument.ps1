...
function Initialize-V2024EventDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024EventDocument' | Write-Debug
...
function ConvertFrom-V2024JsonToEventDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024EventDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'IdentityAssociationDetails', 'V2026IdentityAssociationDetails'] 
slug: /tools/sdk/powershell/v2026/models/identity-association-details
...
```powershell
$IdentityAssociationDetails = Initialize-V2026IdentityAssociationDetails  -Message Identity cannot be deleted as it is owner of following resources `

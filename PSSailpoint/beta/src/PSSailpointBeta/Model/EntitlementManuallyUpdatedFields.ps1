...
function Initialize-BetaEntitlementManuallyUpdatedFields {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaEntitlementManuallyUpdatedFields' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementManuallyUpdatedFields {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaEntitlementManuallyUpdatedFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaNonEmployeeApprovalItem {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalItem' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeApprovalItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

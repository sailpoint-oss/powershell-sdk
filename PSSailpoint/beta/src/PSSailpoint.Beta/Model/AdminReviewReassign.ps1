...
function Initialize-BetaAdminReviewReassign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAdminReviewReassign' | Write-Debug
...
function ConvertFrom-BetaJsonToAdminReviewReassign {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAdminReviewReassign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

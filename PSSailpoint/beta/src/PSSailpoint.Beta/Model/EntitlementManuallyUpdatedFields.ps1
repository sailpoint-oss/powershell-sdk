...
EntitlementManuallyUpdatedFields<PSCustomObject>
#>
...
function Initialize-BetaEntitlementManuallyUpdatedFields {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaEntitlementManuallyUpdatedFields' | Write-Debug
...
Convert from JSON to EntitlementManuallyUpdatedFields<PSCustomObject>
...
EntitlementManuallyUpdatedFields<PSCustomObject>
#>
function ConvertFrom-BetaJsonToEntitlementManuallyUpdatedFields {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaEntitlementManuallyUpdatedFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaEntitlementManuallyUpdatedFields

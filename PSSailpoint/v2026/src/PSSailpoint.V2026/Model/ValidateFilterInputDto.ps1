...
function Initialize-V2026ValidateFilterInputDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ValidateFilterInputDto' | Write-Debug
...
ValidateFilterInputDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToValidateFilterInputDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ValidateFilterInputDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ValidateFilterInputDto

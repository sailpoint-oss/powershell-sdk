...
function Suspend-V2024Report {
    ...
    Process {
        'Calling method: Suspend-V2024Report' | Write-Debug
...
function Get-V2024Report {
    ...
    Process {
        'Calling method: Get-V2024Report' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ReportResults
#>
function Get-V2024ReportResult {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024ReportResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Start-V2024Report {
    ...
    Process {
        'Calling method: Start-V2024Report' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

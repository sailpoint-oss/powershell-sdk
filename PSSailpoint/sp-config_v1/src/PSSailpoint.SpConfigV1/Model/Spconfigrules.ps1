...
function Initialize-Spconfigrules {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigrules' | Write-Debug
...
Spconfigrules<PSCustomObject>
#>
function ConvertFrom-JsonToSpconfigrules {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigrules' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Spconfigrules

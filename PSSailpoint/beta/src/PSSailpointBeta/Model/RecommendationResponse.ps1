...
function Initialize-BetaRecommendationResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRecommendationResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommendationResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRecommendationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

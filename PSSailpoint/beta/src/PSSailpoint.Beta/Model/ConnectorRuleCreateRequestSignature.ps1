...
function Initialize-BetaConnectorRuleCreateRequestSignature {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleCreateRequestSignature' | Write-Debug
...
function ConvertFrom-BetaJsonToConnectorRuleCreateRequestSignature {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleCreateRequestSignature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

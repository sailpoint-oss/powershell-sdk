...
function Initialize-V2026ProcessIdentitiesRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ProcessIdentitiesRequest' | Write-Debug
...
ProcessIdentitiesRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToProcessIdentitiesRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ProcessIdentitiesRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ProcessIdentitiesRequest

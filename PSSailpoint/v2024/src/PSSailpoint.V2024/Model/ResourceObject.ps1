...
function Initialize-V2024ResourceObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ResourceObject' | Write-Debug
...
function ConvertFrom-V2024JsonToResourceObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ResourceObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

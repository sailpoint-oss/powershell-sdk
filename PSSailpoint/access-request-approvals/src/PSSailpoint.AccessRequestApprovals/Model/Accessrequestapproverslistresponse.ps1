...
function Initialize-Accessrequestapproverslistresponse {
    [CmdletBinding()]
    Param (
...
Accessrequestapproverslistresponse<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestapproverslistresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Accessrequestapproverslistresponse

...
function Initialize-BetaSodViolationContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSodViolationContext' | Write-Debug
...
function ConvertFrom-BetaJsonToSodViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

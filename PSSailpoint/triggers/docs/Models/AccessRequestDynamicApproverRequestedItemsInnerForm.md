...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessRequestDynamicApproverRequestedItemsInnerForm', 'AccessRequestDynamicApproverRequestedItemsInnerForm'] 
slug: /tools/sdk/powershell/triggers/models/access-request-dynamic-approver-requested-items-inner-form
...
```powershell
$AccessRequestDynamicApproverRequestedItemsInnerForm = Initialize-AccessRequestDynamicApproverRequestedItemsInnerForm  -FormDefinitionId b2c1808f-77f5-4a3a-9f3a-1d2e3f4a5b6c `
...
```powershell
$AccessRequestDynamicApproverRequestedItemsInnerForm | ConvertTo-JSON
```

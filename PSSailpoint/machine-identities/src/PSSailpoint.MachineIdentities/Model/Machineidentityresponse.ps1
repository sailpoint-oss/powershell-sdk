...
function Initialize-Machineidentityresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentitiesV1 => Machineidentityresponse' | Write-Debug
...
Machineidentityresponse<PSCustomObject>
#>
function ConvertFrom-JsonToMachineidentityresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentitiesV1 => Machineidentityresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Machineidentityresponse
        $AllProperties = ("id", "name", "created", "modified", "nativeIdentity", "description", "attributes", "subtype", "owners", "sourceId", "uuid", "manuallyEdited", "manuallyCreated", "source", "datasetId", "userEntitlements")

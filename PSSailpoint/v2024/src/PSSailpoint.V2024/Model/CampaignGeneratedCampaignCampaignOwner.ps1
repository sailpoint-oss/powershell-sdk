...
function Initialize-V2024CampaignGeneratedCampaignCampaignOwner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CampaignGeneratedCampaignCampaignOwner' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignGeneratedCampaignCampaignOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CampaignGeneratedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024CampaignGeneratedCampaignCampaignOwner

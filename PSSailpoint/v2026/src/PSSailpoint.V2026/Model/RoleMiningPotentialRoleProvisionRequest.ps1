...
function Initialize-V2026RoleMiningPotentialRoleProvisionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleProvisionRequest' | Write-Debug
...
RoleMiningPotentialRoleProvisionRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMiningPotentialRoleProvisionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleProvisionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMiningPotentialRoleProvisionRequest

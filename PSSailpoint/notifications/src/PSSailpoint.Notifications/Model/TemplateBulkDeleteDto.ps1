...
function Initialize-TemplateBulkDeleteDto {
    [CmdletBinding()]
    Param (
...
TemplateBulkDeleteDto<PSCustomObject>
#>
function ConvertFrom-JsonToTemplateBulkDeleteDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in TemplateBulkDeleteDto

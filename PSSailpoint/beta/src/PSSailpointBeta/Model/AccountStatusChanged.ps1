...
function Initialize-BetaAccountStatusChanged {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccountStatusChanged' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountStatusChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccountStatusChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

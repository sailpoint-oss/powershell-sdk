...
function Initialize-BetaOutliersContributingFeatureAccessItems {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaOutliersContributingFeatureAccessItems' | Write-Debug
...
function ConvertFrom-BetaJsonToOutliersContributingFeatureAccessItems {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaOutliersContributingFeatureAccessItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

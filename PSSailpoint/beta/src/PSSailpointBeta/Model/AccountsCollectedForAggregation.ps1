...
function Initialize-BetaAccountsCollectedForAggregation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccountsCollectedForAggregation' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountsCollectedForAggregation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccountsCollectedForAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

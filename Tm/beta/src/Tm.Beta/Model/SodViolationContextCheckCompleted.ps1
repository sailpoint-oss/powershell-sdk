...
function Initialize-BetaSodViolationContextCheckCompleted {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSodViolationContextCheckCompleted' | Write-Debug
...
function ConvertFrom-BetaJsonToSodViolationContextCheckCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSodViolationContextCheckCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

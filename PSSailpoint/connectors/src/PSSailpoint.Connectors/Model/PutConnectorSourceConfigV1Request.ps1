...
PutConnectorSourceConfigV1Request<PSCustomObject>
#>

function Initialize-PutConnectorSourceConfigV1Request {
    [CmdletBinding()]
    Param (
...
Convert from JSON to PutConnectorSourceConfigV1Request<PSCustomObject>
...
PutConnectorSourceConfigV1Request<PSCustomObject>
#>
function ConvertFrom-JsonToPutConnectorSourceConfigV1Request {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in PutConnectorSourceConfigV1Request
        $AllProperties = ("file")

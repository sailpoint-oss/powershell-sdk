...
function Initialize-BetaImportEntitlementsRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaImportEntitlementsRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToImportEntitlementsRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaImportEntitlementsRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

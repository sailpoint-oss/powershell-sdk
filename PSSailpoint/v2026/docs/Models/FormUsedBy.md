...
keywords: ['powershell', 'PowerShell', 'sdk', 'FormUsedBy', 'V2026FormUsedBy'] 
slug: /tools/sdk/powershell/v2026/models/form-used-by
...
```powershell
$FormUsedBy = Initialize-V2026FormUsedBy  -Type WORKFLOW `

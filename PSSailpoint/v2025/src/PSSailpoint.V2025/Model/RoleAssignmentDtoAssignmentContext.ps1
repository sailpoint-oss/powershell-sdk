...
function Initialize-V2025RoleAssignmentDtoAssignmentContext {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleAssignmentDtoAssignmentContext' | Write-Debug
...
RoleAssignmentDtoAssignmentContext<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleAssignmentDtoAssignmentContext {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleAssignmentDtoAssignmentContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleAssignmentDtoAssignmentContext

...
function Initialize-BetaSourceUsageStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceUsageStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceUsageStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceUsageStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

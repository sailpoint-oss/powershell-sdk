...
function Initialize-BetaFormElementDynamicDataSourceConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormElementDynamicDataSourceConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToFormElementDynamicDataSourceConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormElementDynamicDataSourceConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Loadentitlementtask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.EntitlementsV1 => Loadentitlementtask' | Write-Debug
...
Loadentitlementtask<PSCustomObject>
#>
function ConvertFrom-JsonToLoadentitlementtask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.EntitlementsV1 => Loadentitlementtask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Loadentitlementtask

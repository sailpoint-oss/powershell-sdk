...
function Initialize-V2024CompleteInvocation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CompleteInvocation' | Write-Debug
...
function ConvertFrom-V2024JsonToCompleteInvocation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CompleteInvocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

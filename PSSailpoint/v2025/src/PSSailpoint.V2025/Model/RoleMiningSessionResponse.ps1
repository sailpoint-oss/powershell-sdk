...
function Initialize-V2025RoleMiningSessionResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningSessionResponse' | Write-Debug
...
RoleMiningSessionResponse<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleMiningSessionResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningSessionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleMiningSessionResponse

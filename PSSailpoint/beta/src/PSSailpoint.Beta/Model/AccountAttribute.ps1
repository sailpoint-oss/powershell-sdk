...
function Initialize-BetaAccountAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAttribute' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
#>
function ConvertFrom-JsonToSubscriptionPatchRequestInnerValue {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                Write-Debug "Failed to match 'Int32' defined in anyOf (SubscriptionPatchRequestInnerValue). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'String' defined in anyOf (SubscriptionPatchRequestInnerValue). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-JsonToSubscriptionPatchRequestInnerValueAnyOfInner[] $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'SubscriptionPatchRequestInnerValueAnyOfInner[]' defined in anyOf (SubscriptionPatchRequestInnerValue). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'SystemCollectionsHashtable' defined in anyOf (SubscriptionPatchRequestInnerValue). Proceeding to the next one if any."
            }
        }

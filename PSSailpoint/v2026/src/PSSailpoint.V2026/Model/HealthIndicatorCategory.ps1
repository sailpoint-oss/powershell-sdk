...
function Initialize-V2026HealthIndicatorCategory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026HealthIndicatorCategory' | Write-Debug
...
HealthIndicatorCategory<PSCustomObject>
#>
function ConvertFrom-V2026JsonToHealthIndicatorCategory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026HealthIndicatorCategory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026HealthIndicatorCategory

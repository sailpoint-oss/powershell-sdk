...
```powershell
$TriggerInputAccountsCollectedForAggregationStats = Initialize-PSSailpointBetaTriggerInputAccountsCollectedForAggregationStats  -Scanned 200 `
 -Unchanged 190 `
 -Changed 6 `
 -Added 4 `
 -Removed 3
...
```powershell
$TriggerInputAccountsCollectedForAggregationStats | ConvertTo-JSON
```

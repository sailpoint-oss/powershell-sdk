...
function Initialize-Attrsyncsourceattributeconfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => Attrsyncsourceattributeconfig' | Write-Debug
...
Attrsyncsourceattributeconfig<PSCustomObject>
#>
function ConvertFrom-JsonToAttrsyncsourceattributeconfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => Attrsyncsourceattributeconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Attrsyncsourceattributeconfig

#
# Module manifest for module 'PSSailpoint.CertificationsV1'
#
...
RootModule = 'PSSailpoint.CertificationsV1.psm1'
...
Description = 'PSSailpoint.CertificationsV1 - the PowerShell module for Identity Security Cloud API - Certifications'

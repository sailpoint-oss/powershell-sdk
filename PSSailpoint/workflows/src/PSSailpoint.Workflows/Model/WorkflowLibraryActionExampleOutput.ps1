...
#>
function ConvertFrom-JsonToWorkflowLibraryActionExampleOutput {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'SystemCollectionsHashtable' defined in oneOf (WorkflowLibraryActionExampleOutput). Proceeding to the next one if any."
        }

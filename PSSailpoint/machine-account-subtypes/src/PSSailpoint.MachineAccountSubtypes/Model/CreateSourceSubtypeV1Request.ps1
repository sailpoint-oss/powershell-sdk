...
CreateSourceSubtypeV1Request<PSCustomObject>
#>

function Initialize-CreateSourceSubtypeV1Request {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountSubtypes => CreateSourceSubtypeV1Request' | Write-Debug
...
Convert from JSON to CreateSourceSubtypeV1Request<PSCustomObject>
...
CreateSourceSubtypeV1Request<PSCustomObject>
#>
function ConvertFrom-JsonToCreateSourceSubtypeV1Request {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountSubtypes => CreateSourceSubtypeV1Request' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateSourceSubtypeV1Request

...
keywords: ['powershell', 'PowerShell', 'sdk', 'CertificationSummaries', 'V2026CertificationSummaries'] 
slug: /tools/sdk/powershell/v2026/methods/certification-summaries
...
------------- | ------------- | -------------
[**Get-V2026IdentityAccessSummaries**](#get-identity-access-summaries) | **GET** `/certifications/{id}/access-summaries/{type}` | Access summaries
[**Get-V2026IdentityDecisionSummary**](#get-identity-decision-summary) | **GET** `/certifications/{id}/decision-summary` | Summary of certification decisions
[**Get-V2026IdentitySummaries**](#get-identity-summaries) | **GET** `/certifications/{id}/identity-summaries` | Identity summaries for campaign certification
[**Get-V2026IdentitySummary**](#get-identity-summary) | **GET** `/certifications/{id}/identity-summaries/{identitySummaryId}` | Summary for identity
...
try {
    Get-V2026IdentityAccessSummaries -Id $Id -Type $Type 
    
    # Below is a request that includes all optional parameters
    # Get-V2026IdentityAccessSummaries -Id $Id -Type $Type -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026IdentityAccessSummaries"
...
try {
    Get-V2026IdentityDecisionSummary -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026IdentityDecisionSummary -Id $Id -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026IdentityDecisionSummary"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026IdentitySummaries -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026IdentitySummaries -Id $Id -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026IdentitySummaries"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026IdentitySummary -Id $Id -IdentitySummaryId $IdentitySummaryId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026IdentitySummary -Id $Id -IdentitySummaryId $IdentitySummaryId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026IdentitySummary"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

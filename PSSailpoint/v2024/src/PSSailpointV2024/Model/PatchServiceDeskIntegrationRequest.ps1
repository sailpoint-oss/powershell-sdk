...
function Initialize-V2024PatchServiceDeskIntegrationRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PatchServiceDeskIntegrationRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToPatchServiceDeskIntegrationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PatchServiceDeskIntegrationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-RequestedItemDtoRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RequestedItemDtoRef' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemDtoRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RequestedItemDtoRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

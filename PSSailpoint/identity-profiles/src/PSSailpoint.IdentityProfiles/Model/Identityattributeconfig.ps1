...
function Initialize-Identityattributeconfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IdentityProfiles => Identityattributeconfig' | Write-Debug
...
function ConvertFrom-JsonToIdentityattributeconfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IdentityProfiles => Identityattributeconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

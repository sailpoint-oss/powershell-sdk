...
function Initialize-V2026ParameterStorageJsonPatch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageJsonPatch' | Write-Debug
...
ParameterStorageJsonPatch<PSCustomObject>
#>
function ConvertFrom-V2026JsonToParameterStorageJsonPatch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageJsonPatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ParameterStorageJsonPatch

...
function Initialize-BetaTenantConfigurationDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTenantConfigurationDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToTenantConfigurationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTenantConfigurationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

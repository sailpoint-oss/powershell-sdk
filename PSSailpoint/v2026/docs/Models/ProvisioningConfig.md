...
keywords: ['powershell', 'PowerShell', 'sdk', 'ProvisioningConfig', 'V2026ProvisioningConfig'] 
slug: /tools/sdk/powershell/v2026/models/provisioning-config
...
```powershell
$ProvisioningConfig = Initialize-V2026ProvisioningConfig  -UniversalManager true `

...
AccountActivity1<PSCustomObject>
#>

function Initialize-AccountActivity1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => AccountActivity1' | Write-Debug
...
Convert from JSON to AccountActivity1<PSCustomObject>
...
AccountActivity1<PSCustomObject>
#>
function ConvertFrom-JsonToAccountActivity1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => AccountActivity1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountActivity1

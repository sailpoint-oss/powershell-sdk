...
IdentityAttribute
#>
function New-V2026IdentityAttribute {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026IdentityAttribute' | Write-Debug
...
None
#>
function Remove-V2026IdentityAttribute {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026IdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-V2026IdentityAttributesInBulk {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Remove-V2026IdentityAttributesInBulk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityAttribute
#>
function Get-V2026IdentityAttribute {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityAttribute[]
#>
function Get-V2026IdentityAttributes {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026IdentityAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityAttribute
#>
function Send-V2026IdentityAttribute {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2026IdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026CreatePrivilegeCriteriaRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CreatePrivilegeCriteriaRequest' | Write-Debug
...
CreatePrivilegeCriteriaRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCreatePrivilegeCriteriaRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CreatePrivilegeCriteriaRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CreatePrivilegeCriteriaRequest

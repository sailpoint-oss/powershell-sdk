...
function Initialize-V2024CampaignCompleteOptions {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignCompleteOptions' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignCompleteOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignCompleteOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

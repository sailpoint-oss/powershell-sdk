...
function Initialize-BetaListWorkgroupMembers200ResponseInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaListWorkgroupMembers200ResponseInner' | Write-Debug
...
function ConvertFrom-BetaJsonToListWorkgroupMembers200ResponseInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaListWorkgroupMembers200ResponseInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SubscriptionPutRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SubscriptionPutRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToSubscriptionPutRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SubscriptionPutRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ParameterStorageJsonPatch', 'V2026ParameterStorageJsonPatch'] 
slug: /tools/sdk/powershell/v2026/models/parameter-storage-json-patch
...
```powershell
$ParameterStorageJsonPatch = Initialize-V2026ParameterStorageJsonPatch  -Op replace `
 -Path /name `

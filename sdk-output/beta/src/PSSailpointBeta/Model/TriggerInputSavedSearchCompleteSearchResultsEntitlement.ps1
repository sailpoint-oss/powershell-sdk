...
TriggerInputSavedSearchCompleteSearchResultsEntitlement<PSCustomObject>
#>

function Initialize-BetaTriggerInputSavedSearchCompleteSearchResultsEntitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputSavedSearchCompleteSearchResultsEntitlement' | Write-Debug
...
Convert from JSON to TriggerInputSavedSearchCompleteSearchResultsEntitlement<PSCustomObject>
...
TriggerInputSavedSearchCompleteSearchResultsEntitlement<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputSavedSearchCompleteSearchResultsEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputSavedSearchCompleteSearchResultsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputSavedSearchCompleteSearchResultsEntitlement

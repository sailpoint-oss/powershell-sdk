...
function Initialize-BetaAccessItemRoleResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessItemRoleResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessItemRoleResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessItemRoleResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

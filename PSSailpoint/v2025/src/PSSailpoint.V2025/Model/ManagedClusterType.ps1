...
function Initialize-V2025ManagedClusterType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ManagedClusterType' | Write-Debug
...
ManagedClusterType<PSCustomObject>
#>
function ConvertFrom-V2025JsonToManagedClusterType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ManagedClusterType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ManagedClusterType

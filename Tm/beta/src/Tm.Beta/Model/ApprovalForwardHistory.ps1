...
function Initialize-BetaApprovalForwardHistory {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaApprovalForwardHistory' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalForwardHistory {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaApprovalForwardHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

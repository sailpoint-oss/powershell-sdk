...
function Initialize-V2024SetLifecycleState200Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SetLifecycleState200Response' | Write-Debug
...
function ConvertFrom-V2024JsonToSetLifecycleState200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SetLifecycleState200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

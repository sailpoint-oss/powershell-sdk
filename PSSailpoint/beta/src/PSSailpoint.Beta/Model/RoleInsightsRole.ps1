...
function Initialize-BetaRoleInsightsRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleInsightsRole' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleInsightsRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleInsightsRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025ProvisioningPolicyDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ProvisioningPolicyDto' | Write-Debug
...
ProvisioningPolicyDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToProvisioningPolicyDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ProvisioningPolicyDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ProvisioningPolicyDto

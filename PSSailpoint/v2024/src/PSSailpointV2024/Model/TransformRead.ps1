...
function Initialize-V2024TransformRead {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TransformRead' | Write-Debug
...
function ConvertFrom-V2024JsonToTransformRead {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TransformRead' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

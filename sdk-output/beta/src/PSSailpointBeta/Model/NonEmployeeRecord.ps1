...
function Initialize-BetaNonEmployeeRecord {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaNonEmployeeRecord' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeRecord {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaNonEmployeeRecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

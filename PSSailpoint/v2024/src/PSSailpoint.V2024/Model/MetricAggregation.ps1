...
function Initialize-V2024MetricAggregation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024MetricAggregation' | Write-Debug
...
function ConvertFrom-V2024JsonToMetricAggregation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024MetricAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

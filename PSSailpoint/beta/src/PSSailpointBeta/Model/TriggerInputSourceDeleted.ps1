...
TriggerInputSourceDeleted<PSCustomObject>
#>

function Initialize-BetaTriggerInputSourceDeleted {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceDeleted' | Write-Debug
...
Convert from JSON to TriggerInputSourceDeleted<PSCustomObject>
...
TriggerInputSourceDeleted<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputSourceDeleted {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceDeleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputSourceDeleted

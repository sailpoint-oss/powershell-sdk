...
GetMFAOktaConfigV1401Response<PSCustomObject>
#>

function Initialize-GetMFAOktaConfigV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to GetMFAOktaConfigV1401Response<PSCustomObject>
...
GetMFAOktaConfigV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetMFAOktaConfigV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in GetMFAOktaConfigV1401Response
        $AllProperties = ("error")

...
ListWorkgroupMembersV1200ResponseInner<PSCustomObject>
#>

function Initialize-ListWorkgroupMembersV1200ResponseInner {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListWorkgroupMembersV1200ResponseInner<PSCustomObject>
...
ListWorkgroupMembersV1200ResponseInner<PSCustomObject>
#>
function ConvertFrom-JsonToListWorkgroupMembersV1200ResponseInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListWorkgroupMembersV1200ResponseInner

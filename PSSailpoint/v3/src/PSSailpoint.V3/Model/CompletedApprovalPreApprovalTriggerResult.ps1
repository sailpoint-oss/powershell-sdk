...
function Initialize-CompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CompletedApprovalPreApprovalTriggerResult' | Write-Debug
...
function ConvertFrom-JsonToCompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CompletedApprovalPreApprovalTriggerResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

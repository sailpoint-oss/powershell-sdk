...
keywords: ['powershell', 'PowerShell', 'sdk', 'CorrelatedGovernanceEvent', 'V2026CorrelatedGovernanceEvent'] 
slug: /tools/sdk/powershell/v2026/models/correlated-governance-event
...
```powershell
$CorrelatedGovernanceEvent = Initialize-V2026CorrelatedGovernanceEvent  -Name Manager Certification for Jon Snow `

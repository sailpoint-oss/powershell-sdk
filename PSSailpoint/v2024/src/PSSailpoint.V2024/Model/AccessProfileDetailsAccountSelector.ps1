...
function Initialize-V2024AccessProfileDetailsAccountSelector {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessProfileDetailsAccountSelector' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileDetailsAccountSelector {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessProfileDetailsAccountSelector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

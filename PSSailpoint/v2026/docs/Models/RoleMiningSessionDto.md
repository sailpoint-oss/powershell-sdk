...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMiningSessionDto', 'V2026RoleMiningSessionDto'] 
slug: /tools/sdk/powershell/v2026/models/role-mining-session-dto
...
```powershell
$RoleMiningSessionDto = Initialize-V2026RoleMiningSessionDto  -Scope null `
 -PruneThreshold 50 `

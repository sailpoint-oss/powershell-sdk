...
[**Set-MachineAccountMappingsV1**](#set-machine-account-mappings-v1) | **PUT** `/sources/v1/{sourceId}/machine-account-mappings` | Update source&#39;s machine account mappings

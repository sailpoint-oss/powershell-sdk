...
function Initialize-PublicIdentityAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => PublicIdentityAttributeConfig' | Write-Debug
...
function ConvertFrom-JsonToPublicIdentityAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => PublicIdentityAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

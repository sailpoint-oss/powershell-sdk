...
function Initialize-BetaFullcampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaFullcampaignAllOfSearchCampaignInfo' | Write-Debug
...
function ConvertFrom-BetaJsonToFullcampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaFullcampaignAllOfSearchCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaServiceDeskIntegrationTemplateDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaServiceDeskIntegrationTemplateDto' | Write-Debug
...
function ConvertFrom-BetaJsonToServiceDeskIntegrationTemplateDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaServiceDeskIntegrationTemplateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

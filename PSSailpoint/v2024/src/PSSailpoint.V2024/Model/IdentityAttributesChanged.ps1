...
function Initialize-V2024IdentityAttributesChanged {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityAttributesChanged' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityAttributesChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityAttributesChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

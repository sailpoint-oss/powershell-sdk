...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalRequestedTarget', 'V2026ApprovalRequestedTarget'] 
slug: /tools/sdk/powershell/v2026/models/approval-requested-target
...
```powershell
$ApprovalRequestedTarget = Initialize-V2026ApprovalRequestedTarget  -ForcedAuthSignature string `
 -Id string `
 -Name string `
 -ReauthRequired true `

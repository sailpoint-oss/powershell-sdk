...
function Initialize-BetaAccountToggleRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountToggleRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountToggleRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountToggleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

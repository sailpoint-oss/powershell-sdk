...
function Initialize-RoleDocumentAllOfEntitlements {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RoleDocumentAllOfEntitlements' | Write-Debug
...
function ConvertFrom-JsonToRoleDocumentAllOfEntitlements {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RoleDocumentAllOfEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

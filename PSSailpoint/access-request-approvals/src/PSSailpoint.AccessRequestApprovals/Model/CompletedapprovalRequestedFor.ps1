...
CompletedapprovalRequestedFor<PSCustomObject>
#>

function Initialize-CompletedapprovalRequestedFor {
    [CmdletBinding()]
    Param (
...
Convert from JSON to CompletedapprovalRequestedFor<PSCustomObject>
...
CompletedapprovalRequestedFor<PSCustomObject>
#>
function ConvertFrom-JsonToCompletedapprovalRequestedFor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in CompletedapprovalRequestedFor

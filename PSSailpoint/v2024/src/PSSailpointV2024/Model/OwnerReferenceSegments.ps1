...
function Initialize-V2024OwnerReferenceSegments {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024OwnerReferenceSegments' | Write-Debug
...
function ConvertFrom-V2024JsonToOwnerReferenceSegments {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024OwnerReferenceSegments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

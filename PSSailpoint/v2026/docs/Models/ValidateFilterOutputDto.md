...
keywords: ['powershell', 'PowerShell', 'sdk', 'ValidateFilterOutputDto', 'V2026ValidateFilterOutputDto'] 
slug: /tools/sdk/powershell/v2026/models/validate-filter-output-dto
...
```powershell
$ValidateFilterOutputDto = Initialize-V2026ValidateFilterOutputDto  -IsValid true `

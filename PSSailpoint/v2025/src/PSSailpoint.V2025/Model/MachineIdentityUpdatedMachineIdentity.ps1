...
MachineIdentityUpdatedMachineIdentity<PSCustomObject>
#>

function Initialize-V2025MachineIdentityUpdatedMachineIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025MachineIdentityUpdatedMachineIdentity' | Write-Debug
...
Convert from JSON to MachineIdentityUpdatedMachineIdentity<PSCustomObject>
...
MachineIdentityUpdatedMachineIdentity<PSCustomObject>
#>
function ConvertFrom-V2025JsonToMachineIdentityUpdatedMachineIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025MachineIdentityUpdatedMachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025MachineIdentityUpdatedMachineIdentity

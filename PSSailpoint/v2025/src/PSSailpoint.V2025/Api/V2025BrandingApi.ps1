...
BrandingItem
#>
function New-V2025BrandingItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025BrandingItem' | Write-Debug
...
function Remove-V2025Branding {
    ...
    Process {
        'Calling method: Remove-V2025Branding' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025Branding {
    ...
    Process {
        'Calling method: Get-V2025Branding' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
BrandingItem[]
#>
function Get-V2025BrandingList {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2025BrandingList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
BrandingItem
#>
function Set-V2025BrandingItem {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-V2025BrandingItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

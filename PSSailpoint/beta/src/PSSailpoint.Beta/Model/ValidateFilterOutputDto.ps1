...
function Initialize-BetaValidateFilterOutputDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaValidateFilterOutputDto' | Write-Debug
...
function ConvertFrom-BetaJsonToValidateFilterOutputDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaValidateFilterOutputDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024AccountCorrelatedAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccountCorrelatedAccount' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountCorrelatedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccountCorrelatedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

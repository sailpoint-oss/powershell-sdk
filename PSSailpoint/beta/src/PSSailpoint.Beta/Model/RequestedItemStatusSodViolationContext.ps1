...
function Initialize-BetaRequestedItemStatusSodViolationContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusSodViolationContext' | Write-Debug
...
RequestedItemStatusSodViolationContext<PSCustomObject>
#>
function ConvertFrom-BetaJsonToRequestedItemStatusSodViolationContext {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusSodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaRequestedItemStatusSodViolationContext

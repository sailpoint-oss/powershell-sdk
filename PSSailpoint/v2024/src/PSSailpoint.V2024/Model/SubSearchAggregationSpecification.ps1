...
function Initialize-V2024SubSearchAggregationSpecification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SubSearchAggregationSpecification' | Write-Debug
...
SubSearchAggregationSpecification<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSubSearchAggregationSpecification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SubSearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SubSearchAggregationSpecification

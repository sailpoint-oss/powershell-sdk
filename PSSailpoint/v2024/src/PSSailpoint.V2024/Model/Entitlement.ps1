...
function Initialize-V2024Entitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Entitlement' | Write-Debug
...
Entitlement<PSCustomObject>
#>
function ConvertFrom-V2024JsonToEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Entitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

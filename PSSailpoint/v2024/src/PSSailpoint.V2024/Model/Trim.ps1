...
function Initialize-V2024Trim {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Trim' | Write-Debug
...
Trim<PSCustomObject>
#>
function ConvertFrom-V2024JsonToTrim {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Trim' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024Trim

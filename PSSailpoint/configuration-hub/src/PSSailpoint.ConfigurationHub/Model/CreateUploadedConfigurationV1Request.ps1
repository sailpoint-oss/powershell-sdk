...
CreateUploadedConfigurationV1Request<PSCustomObject>
#>

function Initialize-CreateUploadedConfigurationV1Request {
    [CmdletBinding()]
    Param (
...
Convert from JSON to CreateUploadedConfigurationV1Request<PSCustomObject>
...
CreateUploadedConfigurationV1Request<PSCustomObject>
#>
function ConvertFrom-JsonToCreateUploadedConfigurationV1Request {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in CreateUploadedConfigurationV1Request

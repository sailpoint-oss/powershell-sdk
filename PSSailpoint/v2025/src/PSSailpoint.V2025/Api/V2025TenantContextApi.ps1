...
#>
function Get-V2025TenantContext {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2025TenantContext' | Write-Debug
...
None
#>
function Update-V2025TenantContext {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025TenantContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

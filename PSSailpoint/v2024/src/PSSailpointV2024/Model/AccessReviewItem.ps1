...
function Initialize-V2024AccessReviewItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessReviewItem' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessReviewItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessReviewItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

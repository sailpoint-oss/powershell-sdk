...
function Initialize-BetaWorkflowLibraryAction {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaWorkflowLibraryAction' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowLibraryAction {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaWorkflowLibraryAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

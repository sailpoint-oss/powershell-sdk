...
function Initialize-V2026IdentityProfileIdentityErrorReportArguments {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IdentityProfileIdentityErrorReportArguments' | Write-Debug
...
IdentityProfileIdentityErrorReportArguments<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIdentityProfileIdentityErrorReportArguments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IdentityProfileIdentityErrorReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IdentityProfileIdentityErrorReportArguments

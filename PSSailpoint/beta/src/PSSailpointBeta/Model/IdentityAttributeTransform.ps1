...
function Initialize-BetaIdentityAttributeTransform {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaIdentityAttributeTransform' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributeTransform {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaIdentityAttributeTransform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

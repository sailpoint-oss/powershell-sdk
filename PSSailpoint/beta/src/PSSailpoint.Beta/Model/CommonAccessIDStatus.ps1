...
function Initialize-BetaCommonAccessIDStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCommonAccessIDStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToCommonAccessIDStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCommonAccessIDStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SourceAccountUpdated {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024SourceAccountUpdated' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceAccountUpdated {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024SourceAccountUpdated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024RoleInsightsEntitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleInsightsEntitlement' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleInsightsEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleInsightsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaConfigurationItemRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaConfigurationItemRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToConfigurationItemRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaConfigurationItemRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-SourceAccountSelections {
    [CmdletBinding()]
    Param (
...
SourceAccountSelections<PSCustomObject>
#>
function ConvertFrom-JsonToSourceAccountSelections {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SourceAccountSelections

...
AccountV2<PSCustomObject>
#>

function Initialize-V2025AccountV2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccountV2' | Write-Debug
        ...
        if (!$Correlated) {
            throw "invalid value for 'Correlated', 'Correlated' cannot be null."
        }
...
Convert from JSON to AccountV2<PSCustomObject>
...
AccountV2<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccountV2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccountV2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccountV2
        $AllProperties = ("id", "name", "nativeIdentity", "uuid", "correlated", "isMachine", "origin", "attributes")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "correlated"))) {
            throw "Error! JSON cannot be serialized due to the required property 'correlated' missing."
        } else {
            $Correlated = $JsonParameters.PSobject.Properties["correlated"].value
        }

...
function Initialize-NonEmployeeApprovalSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeApprovalSummary' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeApprovalSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeApprovalSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ReviewableAccessProfile {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ReviewableAccessProfile' | Write-Debug
...
function ConvertFrom-V2024JsonToReviewableAccessProfile {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ReviewableAccessProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

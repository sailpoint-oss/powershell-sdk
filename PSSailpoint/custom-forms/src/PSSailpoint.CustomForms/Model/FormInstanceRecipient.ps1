...
function Initialize-FormInstanceRecipient {
    [CmdletBinding()]
    Param (
...
FormInstanceRecipient<PSCustomObject>
#>
function ConvertFrom-JsonToFormInstanceRecipient {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in FormInstanceRecipient

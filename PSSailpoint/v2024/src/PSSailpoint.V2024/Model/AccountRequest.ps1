...
function Initialize-V2024AccountRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccountRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccountRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

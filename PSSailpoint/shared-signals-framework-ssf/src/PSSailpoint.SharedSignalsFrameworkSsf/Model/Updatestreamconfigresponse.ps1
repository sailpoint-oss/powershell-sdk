...
function Initialize-Updatestreamconfigresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SharedSignalsFrameworkSsfV1 => Updatestreamconfigresponse' | Write-Debug
...
Updatestreamconfigresponse<PSCustomObject>
#>
function ConvertFrom-JsonToUpdatestreamconfigresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SharedSignalsFrameworkSsfV1 => Updatestreamconfigresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Updatestreamconfigresponse

...
function Initialize-BetaRemediationItemDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRemediationItemDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToRemediationItemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRemediationItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

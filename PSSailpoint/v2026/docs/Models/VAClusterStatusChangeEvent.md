...
keywords: ['powershell', 'PowerShell', 'sdk', 'VAClusterStatusChangeEvent', 'V2026VAClusterStatusChangeEvent'] 
slug: /tools/sdk/powershell/v2026/models/va-cluster-status-change-event
...
```powershell
$VAClusterStatusChangeEvent = Initialize-V2026VAClusterStatusChangeEvent  -Created 2020-06-29T22:01:50.474Z `
 -Type CLUSTER `
 -Application null `

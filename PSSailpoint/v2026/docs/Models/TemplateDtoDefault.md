...
keywords: ['powershell', 'PowerShell', 'sdk', 'TemplateDtoDefault', 'V2026TemplateDtoDefault'] 
slug: /tools/sdk/powershell/v2026/models/template-dto-default
...
```powershell
$TemplateDtoDefault = Initialize-V2026TemplateDtoDefault  -Key cloud_manual_work_item_summary `

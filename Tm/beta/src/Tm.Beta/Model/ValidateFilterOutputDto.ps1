...
function Initialize-BetaValidateFilterOutputDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaValidateFilterOutputDto' | Write-Debug
...
function ConvertFrom-BetaJsonToValidateFilterOutputDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaValidateFilterOutputDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024IdentityLifecycleState {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityLifecycleState' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityLifecycleState {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityLifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

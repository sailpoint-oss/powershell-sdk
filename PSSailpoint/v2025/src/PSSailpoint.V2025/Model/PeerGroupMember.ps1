...
function Initialize-V2025PeerGroupMember {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025PeerGroupMember' | Write-Debug
...
PeerGroupMember<PSCustomObject>
#>
function ConvertFrom-V2025JsonToPeerGroupMember {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025PeerGroupMember' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025PeerGroupMember

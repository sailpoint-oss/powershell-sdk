...
function Initialize-BetaSendTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSendTokenResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToSendTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSendTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024DimensionCriteriaLevel3 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024DimensionCriteriaLevel3' | Write-Debug
...
DimensionCriteriaLevel3<PSCustomObject>
#>
function ConvertFrom-V2024JsonToDimensionCriteriaLevel3 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024DimensionCriteriaLevel3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024DimensionCriteriaLevel3

...
function Initialize-Queryresultfilter {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Queryresultfilter' | Write-Debug
...
function ConvertFrom-JsonToQueryresultfilter {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Queryresultfilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

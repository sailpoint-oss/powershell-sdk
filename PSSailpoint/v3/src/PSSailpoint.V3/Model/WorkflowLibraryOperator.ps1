...
function Initialize-WorkflowLibraryOperator {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => WorkflowLibraryOperator' | Write-Debug
...
function ConvertFrom-JsonToWorkflowLibraryOperator {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => WorkflowLibraryOperator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

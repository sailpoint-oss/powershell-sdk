...
function Initialize-V2025CreateOAuthClientRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CreateOAuthClientRequest' | Write-Debug
...
CreateOAuthClientRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCreateOAuthClientRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CreateOAuthClientRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CreateOAuthClientRequest

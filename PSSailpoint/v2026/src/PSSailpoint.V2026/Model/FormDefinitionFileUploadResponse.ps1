...
function Initialize-V2026FormDefinitionFileUploadResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026FormDefinitionFileUploadResponse' | Write-Debug
...
FormDefinitionFileUploadResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToFormDefinitionFileUploadResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026FormDefinitionFileUploadResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026FormDefinitionFileUploadResponse

...
ListSegmentsV1401Response<PSCustomObject>
#>

function Initialize-ListSegmentsV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListSegmentsV1401Response<PSCustomObject>
...
ListSegmentsV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToListSegmentsV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListSegmentsV1401Response
        $AllProperties = ("error")

...
function Initialize-BetaStartInvocationInput {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaStartInvocationInput' | Write-Debug
...
function ConvertFrom-BetaJsonToStartInvocationInput {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaStartInvocationInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

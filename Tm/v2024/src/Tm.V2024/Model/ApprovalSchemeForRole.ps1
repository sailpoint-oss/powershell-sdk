...
function Initialize-V2024ApprovalSchemeForRole {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ApprovalSchemeForRole' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalSchemeForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ApprovalSchemeForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

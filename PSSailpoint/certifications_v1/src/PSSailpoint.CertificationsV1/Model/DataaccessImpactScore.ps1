...
function Initialize-DataaccessImpactScore {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationsV1 => DataaccessImpactScore' | Write-Debug
...
function ConvertFrom-JsonToDataaccessImpactScore {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationsV1 => DataaccessImpactScore' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

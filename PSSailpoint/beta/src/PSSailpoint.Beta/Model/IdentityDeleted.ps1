...
function Initialize-BetaIdentityDeleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityDeleted' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityDeleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityDeleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024CustomPasswordInstruction {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CustomPasswordInstruction' | Write-Debug
...
function ConvertFrom-V2024JsonToCustomPasswordInstruction {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CustomPasswordInstruction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccessItemAppResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccessItemAppResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessItemAppResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccessItemAppResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

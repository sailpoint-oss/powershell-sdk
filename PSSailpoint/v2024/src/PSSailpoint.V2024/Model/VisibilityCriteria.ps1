...
function Initialize-V2024VisibilityCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024VisibilityCriteria' | Write-Debug
...
function ConvertFrom-V2024JsonToVisibilityCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024VisibilityCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

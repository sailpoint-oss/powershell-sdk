...
function Initialize-BetaAttributeDTOList {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAttributeDTOList' | Write-Debug
...
function ConvertFrom-BetaJsonToAttributeDTOList {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAttributeDTOList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

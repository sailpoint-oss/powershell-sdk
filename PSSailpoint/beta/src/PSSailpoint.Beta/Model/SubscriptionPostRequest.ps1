...
function Initialize-BetaSubscriptionPostRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSubscriptionPostRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToSubscriptionPostRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSubscriptionPostRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

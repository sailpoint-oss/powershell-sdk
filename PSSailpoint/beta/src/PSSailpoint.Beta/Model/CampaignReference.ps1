...
function Initialize-BetaCampaignReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCampaignReference' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCampaignReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

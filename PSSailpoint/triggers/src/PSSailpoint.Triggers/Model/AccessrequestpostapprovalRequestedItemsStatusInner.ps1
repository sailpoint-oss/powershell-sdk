...
function Initialize-AccessrequestpostapprovalRequestedItemsStatusInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => AccessrequestpostapprovalRequestedItemsStatusInner' | Write-Debug
...
AccessrequestpostapprovalRequestedItemsStatusInner<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestpostapprovalRequestedItemsStatusInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => AccessrequestpostapprovalRequestedItemsStatusInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

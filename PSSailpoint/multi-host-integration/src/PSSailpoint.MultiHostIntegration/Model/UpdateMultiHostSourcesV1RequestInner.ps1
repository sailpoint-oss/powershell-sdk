...
UpdateMultiHostSourcesV1RequestInner<PSCustomObject>
#>

function Initialize-UpdateMultiHostSourcesV1RequestInner {
    [CmdletBinding()]
    Param (
...
Convert from JSON to UpdateMultiHostSourcesV1RequestInner<PSCustomObject>
...
UpdateMultiHostSourcesV1RequestInner<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateMultiHostSourcesV1RequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in UpdateMultiHostSourcesV1RequestInner

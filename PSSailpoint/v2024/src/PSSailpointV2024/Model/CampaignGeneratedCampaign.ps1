...
function Initialize-V2024CampaignGeneratedCampaign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignGeneratedCampaign' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignGeneratedCampaign {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignGeneratedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

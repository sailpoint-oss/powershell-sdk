...
keywords: ['powershell', 'PowerShell', 'sdk', 'WorkflowExecutionHistory', 'V2026WorkflowExecutionHistory'] 
slug: /tools/sdk/powershell/v2026/models/workflow-execution-history
...
```powershell
$WorkflowExecutionHistory = Initialize-V2026WorkflowExecutionHistory  -Definition null `
 -History null `
 -Trigger null
```

...
$AccessRequestRecommendationItemDetail = @"{  "IdentityId": "2c91808570313110017040b06f344ec9", "Access": null, "Ignored": true, "Requested": true, "Viewed": true, "Messages": null, "TranslationMessages": [{"key": "recommender-api.V2_WEIGHT_FEATURE_PRODUCT_INTERPRETATION_HIGH", "values":[75, "department"]}] }"@
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToAccessRequestRecommendationItemDetail -Json $AccessRequestRecommendationItemDetail
```

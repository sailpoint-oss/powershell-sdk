...
AccessRequestDynamicApproverRequestedItemsInnerForm<PSCustomObject>
#>

function Initialize-AccessRequestDynamicApproverRequestedItemsInnerForm {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Triggers => AccessRequestDynamicApproverRequestedItemsInnerForm' | Write-Debug
...
Convert from JSON to AccessRequestDynamicApproverRequestedItemsInnerForm<PSCustomObject>
...
AccessRequestDynamicApproverRequestedItemsInnerForm<PSCustomObject>
#>
function ConvertFrom-JsonToAccessRequestDynamicApproverRequestedItemsInnerForm {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Triggers => AccessRequestDynamicApproverRequestedItemsInnerForm' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccessRequestDynamicApproverRequestedItemsInnerForm

...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleCriteriaLevel2', 'V2026RoleCriteriaLevel2'] 
slug: /tools/sdk/powershell/v2026/models/role-criteria-level2
...
```powershell
$RoleCriteriaLevel2 = Initialize-V2026RoleCriteriaLevel2  -Operation null `
 -Key null `

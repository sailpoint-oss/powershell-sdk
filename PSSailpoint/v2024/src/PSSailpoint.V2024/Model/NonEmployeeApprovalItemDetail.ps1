...
function Initialize-V2024NonEmployeeApprovalItemDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeApprovalItemDetail' | Write-Debug
...
NonEmployeeApprovalItemDetail<PSCustomObject>
#>
function ConvertFrom-V2024JsonToNonEmployeeApprovalItemDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeApprovalItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024NonEmployeeApprovalItemDetail

...
function Initialize-V2025RequestedItemStatusPreApprovalTriggerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
...
RequestedItemStatusPreApprovalTriggerDetails<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRequestedItemStatusPreApprovalTriggerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RequestedItemStatusPreApprovalTriggerDetails

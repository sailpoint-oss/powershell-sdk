...
function Initialize-Configurationresponse {
    [CmdletBinding()]
    Param (
...
Configurationresponse<PSCustomObject>
#>
function ConvertFrom-JsonToConfigurationresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Configurationresponse

...
function Initialize-BetaRoleBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

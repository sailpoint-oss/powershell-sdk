...
function Initialize-V2024RoleMiningSessionParametersDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningSessionParametersDto' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningSessionParametersDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningSessionParametersDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

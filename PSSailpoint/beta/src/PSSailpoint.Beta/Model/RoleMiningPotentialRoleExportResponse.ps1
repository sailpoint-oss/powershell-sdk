...
function Initialize-BetaRoleMiningPotentialRoleExportResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRoleExportResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleExportResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRoleExportResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

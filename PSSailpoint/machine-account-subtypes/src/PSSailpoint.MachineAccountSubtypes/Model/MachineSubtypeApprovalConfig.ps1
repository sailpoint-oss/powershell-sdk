...
function Initialize-MachineSubtypeApprovalConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountSubtypes => MachineSubtypeApprovalConfig' | Write-Debug
...
function ConvertFrom-JsonToMachineSubtypeApprovalConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountSubtypes => MachineSubtypeApprovalConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

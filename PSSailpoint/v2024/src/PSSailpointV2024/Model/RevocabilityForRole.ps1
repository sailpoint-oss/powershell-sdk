...
function Initialize-V2024RevocabilityForRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RevocabilityForRole' | Write-Debug
...
function ConvertFrom-V2024JsonToRevocabilityForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RevocabilityForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

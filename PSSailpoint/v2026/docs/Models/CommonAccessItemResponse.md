...
keywords: ['powershell', 'PowerShell', 'sdk', 'CommonAccessItemResponse', 'V2026CommonAccessItemResponse'] 
slug: /tools/sdk/powershell/v2026/models/common-access-item-response
...
```powershell
$CommonAccessItemResponse = Initialize-V2026CommonAccessItemResponse  -Id null `
 -Access null `
 -Status null `
 -LastUpdated null `
 -ReviewedByUser null `

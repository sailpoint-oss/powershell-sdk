...
function Initialize-BetaSodExemptCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSodExemptCriteria' | Write-Debug
...
function ConvertFrom-BetaJsonToSodExemptCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSodExemptCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

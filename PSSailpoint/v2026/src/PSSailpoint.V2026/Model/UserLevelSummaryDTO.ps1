...
function Initialize-V2026UserLevelSummaryDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026UserLevelSummaryDTO' | Write-Debug
...
UserLevelSummaryDTO<PSCustomObject>
#>
function ConvertFrom-V2026JsonToUserLevelSummaryDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026UserLevelSummaryDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026UserLevelSummaryDTO

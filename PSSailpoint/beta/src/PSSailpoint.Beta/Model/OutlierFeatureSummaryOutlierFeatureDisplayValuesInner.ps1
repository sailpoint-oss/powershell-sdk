...
function Initialize-BetaOutlierFeatureSummaryOutlierFeatureDisplayValuesInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaOutlierFeatureSummaryOutlierFeatureDisplayValuesInner' | Write-Debug
...
function ConvertFrom-BetaJsonToOutlierFeatureSummaryOutlierFeatureDisplayValuesInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaOutlierFeatureSummaryOutlierFeatureDisplayValuesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

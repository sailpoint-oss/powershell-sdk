...
keywords: ['powershell', 'PowerShell', 'sdk', 'IAIPeerGroupStrategies', 'V2026IAIPeerGroupStrategies'] 
slug: /tools/sdk/powershell/v2026/methods/iai-peer-group-strategies
...
------------- | ------------- | -------------
[**Get-V2026PeerGroupOutliers**](#get-peer-group-outliers) | **GET** `/peer-group-strategies/{strategy}/identity-outliers` | Identity outliers list
...
try {
    Get-V2026PeerGroupOutliers -Strategy $Strategy -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PeerGroupOutliers -Strategy $Strategy -XSailPointExperimental $XSailPointExperimental -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026PeerGroupOutliers"

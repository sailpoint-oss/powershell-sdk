...
function Initialize-BetaServiceDeskIntegrationDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaServiceDeskIntegrationDto' | Write-Debug
...
function ConvertFrom-BetaJsonToServiceDeskIntegrationDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaServiceDeskIntegrationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-RequestedItemStatusSodViolationContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => RequestedItemStatusSodViolationContext' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemStatusSodViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => RequestedItemStatusSodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

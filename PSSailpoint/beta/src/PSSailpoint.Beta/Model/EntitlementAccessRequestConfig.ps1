...
function Initialize-BetaEntitlementAccessRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaEntitlementAccessRequestConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementAccessRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaEntitlementAccessRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

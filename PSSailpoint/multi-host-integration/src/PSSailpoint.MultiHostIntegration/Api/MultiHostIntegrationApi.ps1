...
function New-MultiHostIntegrationV1 {
    ...
    Process {
        'Calling method: New-MultiHostIntegrationV1' | Write-Debug
...
None
#>
function New-SourcesWithinMultiHostV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: New-SourcesWithinMultiHostV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multihostId}'
        if (!$MultihostId) {
            throw "Error! The required parameter `MultihostId` missing when calling createSourcesWithinMultiHostV1."
        }
...
None
#>
function Remove-MultiHostSourcesV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-MultiHostSourcesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multiHostId}/sources/bulk-delete'
        if (!$MultiHostId) {
            throw "Error! The required parameter `MultiHostId` missing when calling deleteMultiHostSourcesV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multiHostId}', [System.Web.HTTPUtility]::UrlEncode($MultiHostId))

        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling deleteMultiHostSourcesV1."
        }
...
function Remove-MultiHostV1 {
    ...
    Process {
        'Calling method: Remove-MultiHostV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multihostId}'
        if (!$MultihostId) {
            throw "Error! The required parameter `MultihostId` missing when calling deleteMultiHostV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multihostId}', [System.Web.HTTPUtility]::UrlEncode($MultihostId))
...
function Get-AcctAggregationGroupsV1 {
    ...
    Process {
        'Calling method: Get-AcctAggregationGroupsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multihostId}/acctAggregationGroups'
        if (!$MultihostId) {
            throw "Error! The required parameter `MultihostId` missing when calling getAcctAggregationGroupsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multihostId}', [System.Web.HTTPUtility]::UrlEncode($MultihostId))
...
function Get-EntitlementAggregationGroupsV1 {
    ...
    Process {
        'Calling method: Get-EntitlementAggregationGroupsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multiHostId}/entitlementAggregationGroups'
        if (!$MultiHostId) {
            throw "Error! The required parameter `MultiHostId` missing when calling getEntitlementAggregationGroupsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multiHostId}', [System.Web.HTTPUtility]::UrlEncode($MultiHostId))
...
function Get-MultiHostIntegrationsListV1 {
    ...
    Process {
        'Calling method: Get-MultiHostIntegrationsListV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-MultiHostIntegrationsV1 {
    ...
    Process {
        'Calling method: Get-MultiHostIntegrationsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multihostId}'
        if (!$MultihostId) {
            throw "Error! The required parameter `MultihostId` missing when calling getMultiHostIntegrationsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multihostId}', [System.Web.HTTPUtility]::UrlEncode($MultihostId))
...
function Get-MultiHostSourceCreationErrorsV1 {
    ...
    Process {
        'Calling method: Get-MultiHostSourceCreationErrorsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multiHostId}/sources/errors'
        if (!$MultiHostId) {
            throw "Error! The required parameter `MultiHostId` missing when calling getMultiHostSourceCreationErrorsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multiHostId}', [System.Web.HTTPUtility]::UrlEncode($MultiHostId))
...
function Get-MultihostIntegrationTypesV1 {
    ...
    Process {
        'Calling method: Get-MultihostIntegrationTypesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/types'
...
function Get-SourcesWithinMultiHostV1 {
    ...
    Process {
        'Calling method: Get-SourcesWithinMultiHostV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multihostId}/sources'
        if (!$MultihostId) {
            throw "Error! The required parameter `MultihostId` missing when calling getSourcesWithinMultiHostV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multihostId}', [System.Web.HTTPUtility]::UrlEncode($MultihostId))
...
None
#>
function Test-ConnectionMultiHostSourcesV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Test-ConnectionMultiHostSourcesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multihostId}/sources/testConnection'
        if (!$MultihostId) {
            throw "Error! The required parameter `MultihostId` missing when calling testConnectionMultiHostSourcesV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multihostId}', [System.Web.HTTPUtility]::UrlEncode($MultihostId))
...
#>
function Test-SourceConnectionMultihostV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Test-SourceConnectionMultihostV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multihostId}/sources/{sourceId}/testConnection'
        if (!$MultihostId) {
            throw "Error! The required parameter `MultihostId` missing when calling testSourceConnectionMultihostV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multihostId}', [System.Web.HTTPUtility]::UrlEncode($MultihostId))
        if (!$SourceId) {
            throw "Error! The required parameter `SourceId` missing when calling testSourceConnectionMultihostV1."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "TestSourceConnectionMultihostV1200Response" `
                                -IsBodyNullable $false
...
.PARAMETER UpdateMultiHostSourcesV1RequestInner
...
None
#>
function Update-MultiHostSourcesV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-MultiHostSourcesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/multihosts/v1/{multihostId}'
        if (!$MultihostId) {
            throw "Error! The required parameter `MultihostId` missing when calling updateMultiHostSourcesV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{multihostId}', [System.Web.HTTPUtility]::UrlEncode($MultihostId))

        if (!$UpdateMultiHostSourcesV1RequestInner) {
            throw "Error! The required parameter `UpdateMultiHostSourcesV1RequestInner` missing when calling updateMultiHostSourcesV1."
        }

        if ($LocalVarContentTypes.Contains('application/json-patch+json') -or ($UpdateMultiHostSourcesV1RequestInner -is [array])) {
            $LocalVarBodyParameter = $UpdateMultiHostSourcesV1RequestInner | ConvertTo-Json -AsArray -Depth 100
        } else {
            $LocalVarBodyParameter = $UpdateMultiHostSourcesV1RequestInner | ForEach-Object {
            # Get array of names of object properties that can be cast to boolean TRUE
            # PSObject.Properties - https://msdn.microsoft.com/en-us/library/system.management.automation.psobject.properties.aspx
            $NonEmptyProperties = $_.psobject.Properties | Where-Object {$null -ne $_.Value} | Select-Object -ExpandProperty Name

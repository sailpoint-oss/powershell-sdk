...
function Initialize-BetaLoadAccountsTaskTaskReturnsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaLoadAccountsTaskTaskReturnsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToLoadAccountsTaskTaskReturnsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaLoadAccountsTaskTaskReturnsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

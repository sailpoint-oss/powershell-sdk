...
function Initialize-TestWorkflowRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => TestWorkflowRequest' | Write-Debug
...
function ConvertFrom-JsonToTestWorkflowRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => TestWorkflowRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026CorrelationConfigAttributeAssignmentsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CorrelationConfigAttributeAssignmentsInner' | Write-Debug
...
CorrelationConfigAttributeAssignmentsInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCorrelationConfigAttributeAssignmentsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CorrelationConfigAttributeAssignmentsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CorrelationConfigAttributeAssignmentsInner

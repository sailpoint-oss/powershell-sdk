...
function Initialize-V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon<PSCustomObject>
#>
function ConvertFrom-V2026JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon

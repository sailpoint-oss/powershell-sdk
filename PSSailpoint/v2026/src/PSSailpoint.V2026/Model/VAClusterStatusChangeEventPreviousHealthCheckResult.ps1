...
function Initialize-V2026VAClusterStatusChangeEventPreviousHealthCheckResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
...
VAClusterStatusChangeEventPreviousHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-V2026JsonToVAClusterStatusChangeEventPreviousHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026VAClusterStatusChangeEventPreviousHealthCheckResult

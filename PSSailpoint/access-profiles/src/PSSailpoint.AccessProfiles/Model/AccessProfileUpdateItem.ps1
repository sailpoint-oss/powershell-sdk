...
function Initialize-AccessProfileUpdateItem {
    [CmdletBinding()]
    Param (
...
AccessProfileUpdateItem<PSCustomObject>
#>
function ConvertFrom-JsonToAccessProfileUpdateItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccessProfileUpdateItem

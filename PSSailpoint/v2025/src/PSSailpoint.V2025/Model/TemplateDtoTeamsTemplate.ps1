...
function Initialize-V2025TemplateDtoTeamsTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025TemplateDtoTeamsTemplate' | Write-Debug
...
TemplateDtoTeamsTemplate<PSCustomObject>
#>
function ConvertFrom-V2025JsonToTemplateDtoTeamsTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025TemplateDtoTeamsTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025TemplateDtoTeamsTemplate

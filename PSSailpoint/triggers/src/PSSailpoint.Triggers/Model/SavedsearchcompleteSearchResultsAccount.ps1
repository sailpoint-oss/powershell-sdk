...
function Initialize-SavedsearchcompleteSearchResultsAccount {
    [CmdletBinding()]
    Param (
...
SavedsearchcompleteSearchResultsAccount<PSCustomObject>
#>
function ConvertFrom-JsonToSavedsearchcompleteSearchResultsAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SavedsearchcompleteSearchResultsAccount

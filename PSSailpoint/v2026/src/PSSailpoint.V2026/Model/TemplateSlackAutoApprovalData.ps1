...
function Initialize-V2026TemplateSlackAutoApprovalData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TemplateSlackAutoApprovalData' | Write-Debug
...
TemplateSlackAutoApprovalData<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTemplateSlackAutoApprovalData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TemplateSlackAutoApprovalData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TemplateSlackAutoApprovalData

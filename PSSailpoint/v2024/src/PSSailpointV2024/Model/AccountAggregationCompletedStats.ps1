...
function Initialize-V2024AccountAggregationCompletedStats {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountAggregationCompletedStats' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAggregationCompletedStats {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountAggregationCompletedStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-CreatePersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => CreatePersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-JsonToCreatePersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => CreatePersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

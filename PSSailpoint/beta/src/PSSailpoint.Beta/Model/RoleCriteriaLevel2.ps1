...
function Initialize-BetaRoleCriteriaLevel2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleCriteriaLevel2' | Write-Debug
...
RoleCriteriaLevel2<PSCustomObject>
#>
function ConvertFrom-BetaJsonToRoleCriteriaLevel2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleCriteriaLevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaRoleCriteriaLevel2

...
function Initialize-V2026RoleDocumentAllOfDimensions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleDocumentAllOfDimensions' | Write-Debug
...
RoleDocumentAllOfDimensions<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleDocumentAllOfDimensions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleDocumentAllOfDimensions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleDocumentAllOfDimensions

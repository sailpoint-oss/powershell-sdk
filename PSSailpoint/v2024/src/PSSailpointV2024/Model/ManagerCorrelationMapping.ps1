...
function Initialize-V2024ManagerCorrelationMapping {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ManagerCorrelationMapping' | Write-Debug
...
function ConvertFrom-V2024JsonToManagerCorrelationMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
SoapApiAction<PSCustomObject>
#>

function Initialize-NERMSoapApiAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMSoapApiAction' | Write-Debug
...
Convert from JSON to SoapApiAction<PSCustomObject>
...
SoapApiAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToSoapApiAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMSoapApiAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMSoapApiAction

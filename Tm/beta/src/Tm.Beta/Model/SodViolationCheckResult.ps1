...
function Initialize-BetaSodViolationCheckResult {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSodViolationCheckResult' | Write-Debug
...
function ConvertFrom-BetaJsonToSodViolationCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSodViolationCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

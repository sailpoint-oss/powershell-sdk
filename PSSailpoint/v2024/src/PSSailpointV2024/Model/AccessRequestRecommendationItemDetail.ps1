...
function Initialize-V2024AccessRequestRecommendationItemDetail {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequestRecommendationItemDetail' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestRecommendationItemDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequestRecommendationItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
Objectimportresult2<PSCustomObject>
#>

function Initialize-Objectimportresult2 {
    [CmdletBinding()]
    Param (
...
Convert from JSON to Objectimportresult2<PSCustomObject>
...
Objectimportresult2<PSCustomObject>
#>
function ConvertFrom-JsonToObjectimportresult2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Objectimportresult2

...
function Initialize-V2024SpConfigExportJobStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SpConfigExportJobStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigExportJobStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SpConfigExportJobStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

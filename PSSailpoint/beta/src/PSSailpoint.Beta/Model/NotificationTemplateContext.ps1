...
function Initialize-BetaNotificationTemplateContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNotificationTemplateContext' | Write-Debug
...
function ConvertFrom-BetaJsonToNotificationTemplateContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNotificationTemplateContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

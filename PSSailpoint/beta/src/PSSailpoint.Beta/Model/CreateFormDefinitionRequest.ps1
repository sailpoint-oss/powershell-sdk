...
function Initialize-BetaCreateFormDefinitionRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCreateFormDefinitionRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateFormDefinitionRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCreateFormDefinitionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-AccountsExportReportArguments {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => AccountsExportReportArguments' | Write-Debug
...
function ConvertFrom-JsonToAccountsExportReportArguments {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => AccountsExportReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaTemplateSlackAutoApprovalData {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTemplateSlackAutoApprovalData' | Write-Debug
...
function ConvertFrom-BetaJsonToTemplateSlackAutoApprovalData {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTemplateSlackAutoApprovalData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'UserAppSource', 'V2026UserAppSource'] 
slug: /tools/sdk/powershell/v2026/models/user-app-source
...
```powershell
$UserAppSource = Initialize-V2026UserAppSource  -Id 9870808a7190d06e01719938fcd20792 `
 -Type SOURCE `
 -Name test-source
```

...
function New-AccessProfileV1 {
    ...
    Process {
        'Calling method: New-AccessProfileV1' | Write-Debug
...
None
#>
function Remove-AccessProfileV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-AccessProfileV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-profiles/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteAccessProfileV1."
        }
...
function Remove-AccessProfilesInBulkV1 {
    ...
    Process {
        'Calling method: Remove-AccessProfilesInBulkV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Entitlement[]
#>
function Get-AccessProfileEntitlementsV1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-AccessProfileEntitlementsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-profiles/v1/{id}/entitlements'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getAccessProfileEntitlementsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-AccessProfileV1 {
    ...
    Process {
        'Calling method: Get-AccessProfileV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-profiles/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getAccessProfileV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-AccessProfilesV1 {
    ...
    Process {
        'Calling method: Get-AccessProfilesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-AccessProfileV1 {
    ...
    Process {
        'Calling method: Update-AccessProfileV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-profiles/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling patchAccessProfileV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Update-AccessProfilesInBulkV1 {
    ...
    Process {
        'Calling method: Update-AccessProfilesInBulkV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

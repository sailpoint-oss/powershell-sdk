...
function Initialize-V2024IdentityWithNewAccess {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024IdentityWithNewAccess' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityWithNewAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024IdentityWithNewAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ForwardApprovalDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ForwardApprovalDto' | Write-Debug
...
function ConvertFrom-V2024JsonToForwardApprovalDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ForwardApprovalDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ApprovalconfigEscalationConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApprovalsV1 => ApprovalconfigEscalationConfig' | Write-Debug
...
ApprovalconfigEscalationConfig<PSCustomObject>
#>
function ConvertFrom-JsonToApprovalconfigEscalationConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApprovalsV1 => ApprovalconfigEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApprovalconfigEscalationConfig

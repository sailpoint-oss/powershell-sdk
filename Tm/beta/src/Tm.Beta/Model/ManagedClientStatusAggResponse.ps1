...
function Initialize-BetaManagedClientStatusAggResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaManagedClientStatusAggResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToManagedClientStatusAggResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaManagedClientStatusAggResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

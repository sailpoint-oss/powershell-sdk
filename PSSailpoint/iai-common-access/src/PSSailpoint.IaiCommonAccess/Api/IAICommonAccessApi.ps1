...
function New-CommonAccessV1 {
    ...
    Process {
        'Calling method: New-CommonAccessV1' | Write-Debug
        ...
        $LocalVarUri = '/common-access/v1'

        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling createCommonAccessV1."
        }
...
function Get-CommonAccessV1 {
    ...
    Process {
        'Calling method: Get-CommonAccessV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling getCommonAccessV1."
        }
        $LocalVarHeaderParameters['X-SailPoint-Experimental'] = $XSailPointExperimental
...
#>
function Update-CommonAccessStatusInBulkV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-CommonAccessStatusInBulkV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/common-access/v1/update-status'

        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling updateCommonAccessStatusInBulkV1."
        }
        $LocalVarHeaderParameters['X-SailPoint-Experimental'] = $XSailPointExperimental

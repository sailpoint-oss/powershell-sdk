...
function Initialize-V2026NonEmployeeSourceLiteWithSchemaAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
...
NonEmployeeSourceLiteWithSchemaAttributes<PSCustomObject>
#>
function ConvertFrom-V2026JsonToNonEmployeeSourceLiteWithSchemaAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026NonEmployeeSourceLiteWithSchemaAttributes

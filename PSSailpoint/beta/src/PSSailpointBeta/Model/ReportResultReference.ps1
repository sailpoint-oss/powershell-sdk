...
function Initialize-BetaReportResultReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaReportResultReference' | Write-Debug
...
function ConvertFrom-BetaJsonToReportResultReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaReportResultReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

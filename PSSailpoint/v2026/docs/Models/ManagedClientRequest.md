...
keywords: ['powershell', 'PowerShell', 'sdk', 'ManagedClientRequest', 'V2026ManagedClientRequest'] 
slug: /tools/sdk/powershell/v2026/models/managed-client-request
...
```powershell
$ManagedClientRequest = Initialize-V2026ManagedClientRequest  -ClusterId aClusterId `

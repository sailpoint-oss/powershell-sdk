...
function Initialize-V2024ValidateFilterOutputDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ValidateFilterOutputDto' | Write-Debug
...
function ConvertFrom-V2024JsonToValidateFilterOutputDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ValidateFilterOutputDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

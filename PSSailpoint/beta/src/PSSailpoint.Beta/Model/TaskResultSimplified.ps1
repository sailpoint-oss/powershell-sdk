...
function Initialize-BetaTaskResultSimplified {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTaskResultSimplified' | Write-Debug
...
function ConvertFrom-BetaJsonToTaskResultSimplified {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTaskResultSimplified' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

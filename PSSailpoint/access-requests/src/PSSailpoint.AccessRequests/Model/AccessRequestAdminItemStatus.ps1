...
function Initialize-AccessRequestAdminItemStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => AccessRequestAdminItemStatus' | Write-Debug
...
function ConvertFrom-JsonToAccessRequestAdminItemStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => AccessRequestAdminItemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024WorkgroupDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkgroupDto' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkgroupDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkgroupDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

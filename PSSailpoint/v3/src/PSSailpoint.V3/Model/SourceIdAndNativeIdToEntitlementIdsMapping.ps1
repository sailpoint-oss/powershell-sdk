...
function Initialize-SourceIdAndNativeIdToEntitlementIdsMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SourceIdAndNativeIdToEntitlementIdsMapping' | Write-Debug
...
SourceIdAndNativeIdToEntitlementIdsMapping<PSCustomObject>
#>
function ConvertFrom-JsonToSourceIdAndNativeIdToEntitlementIdsMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SourceIdAndNativeIdToEntitlementIdsMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SourceIdAndNativeIdToEntitlementIdsMapping

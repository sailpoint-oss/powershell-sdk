...
function Initialize-BetaExceptionCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaExceptionCriteria' | Write-Debug
...
function ConvertFrom-BetaJsonToExceptionCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaExceptionCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026CampaignAllOfRoleCompositionCampaignInfoRemediatorRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CampaignAllOfRoleCompositionCampaignInfoRemediatorRef' | Write-Debug
...
CampaignAllOfRoleCompositionCampaignInfoRemediatorRef<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCampaignAllOfRoleCompositionCampaignInfoRemediatorRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CampaignAllOfRoleCompositionCampaignInfoRemediatorRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CampaignAllOfRoleCompositionCampaignInfoRemediatorRef

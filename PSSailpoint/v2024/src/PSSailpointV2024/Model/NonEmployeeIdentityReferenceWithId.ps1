...
function Initialize-V2024NonEmployeeIdentityReferenceWithId {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeIdentityReferenceWithId' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeIdentityReferenceWithId {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeIdentityReferenceWithId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccountAggregationCompletedStats {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccountAggregationCompletedStats' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAggregationCompletedStats {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccountAggregationCompletedStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

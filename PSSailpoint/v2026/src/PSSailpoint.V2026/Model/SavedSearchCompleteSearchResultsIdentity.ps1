...
function Initialize-V2026SavedSearchCompleteSearchResultsIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SavedSearchCompleteSearchResultsIdentity' | Write-Debug
...
SavedSearchCompleteSearchResultsIdentity<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSavedSearchCompleteSearchResultsIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SavedSearchCompleteSearchResultsIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SavedSearchCompleteSearchResultsIdentity

...
function Initialize-V2026IntelOutlierAccessItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IntelOutlierAccessItem' | Write-Debug
...
IntelOutlierAccessItem<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIntelOutlierAccessItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IntelOutlierAccessItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IntelOutlierAccessItem

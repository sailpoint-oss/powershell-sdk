...
function Initialize-IdentityProfileAllOfOwner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityProfileAllOfOwner' | Write-Debug
...
function ConvertFrom-JsonToIdentityProfileAllOfOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityProfileAllOfOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

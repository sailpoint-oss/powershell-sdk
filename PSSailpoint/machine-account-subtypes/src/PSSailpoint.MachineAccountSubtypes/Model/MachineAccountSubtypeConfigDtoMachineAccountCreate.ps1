...
function Initialize-MachineAccountSubtypeConfigDtoMachineAccountCreate {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountSubtypes => MachineAccountSubtypeConfigDtoMachineAccountCreate' | Write-Debug
...
function ConvertFrom-JsonToMachineAccountSubtypeConfigDtoMachineAccountCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountSubtypes => MachineAccountSubtypeConfigDtoMachineAccountCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

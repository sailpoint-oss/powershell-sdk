...
function Initialize-Bulkcancelaccessrequest {
    [CmdletBinding()]
    Param (
...
Bulkcancelaccessrequest<PSCustomObject>
#>
function ConvertFrom-JsonToBulkcancelaccessrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Bulkcancelaccessrequest

...
function Initialize-Subscriptionpostrequest {
    [CmdletBinding()]
    Param (
...
Subscriptionpostrequest<PSCustomObject>
#>
function ConvertFrom-JsonToSubscriptionpostrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Subscriptionpostrequest

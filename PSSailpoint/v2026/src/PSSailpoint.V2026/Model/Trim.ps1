...
function Initialize-V2026Trim {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026Trim' | Write-Debug
...
Trim<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTrim {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026Trim' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026Trim

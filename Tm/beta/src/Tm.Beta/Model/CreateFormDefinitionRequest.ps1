...
function Initialize-BetaCreateFormDefinitionRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCreateFormDefinitionRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateFormDefinitionRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCreateFormDefinitionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

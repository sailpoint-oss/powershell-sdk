...
function Initialize-BetaStatic {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaStatic' | Write-Debug
...
Static<PSCustomObject>
#>
function ConvertFrom-BetaJsonToStatic {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaStatic' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaStatic

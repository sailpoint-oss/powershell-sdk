...
function Initialize-BetaTemplateSlack {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTemplateSlack' | Write-Debug
...
function ConvertFrom-BetaJsonToTemplateSlack {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTemplateSlack' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

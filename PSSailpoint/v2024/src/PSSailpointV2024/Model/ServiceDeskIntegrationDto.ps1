...
function Initialize-V2024ServiceDeskIntegrationDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ServiceDeskIntegrationDto' | Write-Debug
...
function ConvertFrom-V2024JsonToServiceDeskIntegrationDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ServiceDeskIntegrationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

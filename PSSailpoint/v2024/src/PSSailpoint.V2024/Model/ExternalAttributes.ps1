...
function Initialize-V2024ExternalAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ExternalAttributes' | Write-Debug
...
ExternalAttributes<PSCustomObject>
#>
function ConvertFrom-V2024JsonToExternalAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ExternalAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ExternalAttributes

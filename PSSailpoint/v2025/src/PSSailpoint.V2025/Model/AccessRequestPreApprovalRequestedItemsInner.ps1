...
function Initialize-V2025AccessRequestPreApprovalRequestedItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccessRequestPreApprovalRequestedItemsInner' | Write-Debug
...
AccessRequestPreApprovalRequestedItemsInner<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccessRequestPreApprovalRequestedItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccessRequestPreApprovalRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccessRequestPreApprovalRequestedItemsInner

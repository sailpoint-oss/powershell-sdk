...
function Initialize-PasswordChangeRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => PasswordChangeRequest' | Write-Debug
...
function ConvertFrom-JsonToPasswordChangeRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => PasswordChangeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025RoleMiningIdentityDistribution {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningIdentityDistribution' | Write-Debug
...
RoleMiningIdentityDistribution<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleMiningIdentityDistribution {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningIdentityDistribution' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleMiningIdentityDistribution

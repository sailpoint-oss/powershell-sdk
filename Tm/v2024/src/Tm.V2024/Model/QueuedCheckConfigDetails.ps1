...
function Initialize-V2024QueuedCheckConfigDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024QueuedCheckConfigDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToQueuedCheckConfigDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024QueuedCheckConfigDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SedApprovalStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SedApprovalStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToSedApprovalStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SedApprovalStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaSelectorAccountMatchConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSelectorAccountMatchConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToSelectorAccountMatchConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSelectorAccountMatchConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Accessprofilesummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Search => Accessprofilesummary' | Write-Debug
...
function ConvertFrom-JsonToAccessprofilesummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Search => Accessprofilesummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

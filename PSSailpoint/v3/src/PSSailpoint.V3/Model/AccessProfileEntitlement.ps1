...
function Initialize-AccessProfileEntitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessProfileEntitlement' | Write-Debug
...
function ConvertFrom-JsonToAccessProfileEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessProfileEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

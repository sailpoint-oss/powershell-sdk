...
function Initialize-BetaManagedClientStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaManagedClientStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToManagedClientStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaManagedClientStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

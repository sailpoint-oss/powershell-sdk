...
function Initialize-BetaFullcampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFullcampaignAllOfSearchCampaignInfo' | Write-Debug
...
function ConvertFrom-BetaJsonToFullcampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFullcampaignAllOfSearchCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

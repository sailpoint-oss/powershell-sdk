...
function Initialize-BetaAccessProfileDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccessProfileDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccessProfileDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

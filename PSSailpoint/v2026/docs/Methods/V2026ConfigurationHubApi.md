...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConfigurationHub', 'V2026ConfigurationHub'] 
slug: /tools/sdk/powershell/v2026/methods/configuration-hub
...
------------- | ------------- | -------------
[**New-V2026Deploy**](#create-deploy) | **POST** `/configuration-hub/deploys` | Create a deploy
[**New-V2026ObjectMapping**](#create-object-mapping) | **POST** `/configuration-hub/object-mappings/{sourceOrg}` | Creates an object mapping
[**New-V2026ObjectMappings**](#create-object-mappings) | **POST** `/configuration-hub/object-mappings/{sourceOrg}/bulk-create` | Bulk creates object mappings
[**New-V2026ScheduledAction**](#create-scheduled-action) | **POST** `/configuration-hub/scheduled-actions` | Create scheduled action
[**New-V2026UploadedConfiguration**](#create-uploaded-configuration) | **POST** `/configuration-hub/backups/uploads` | Upload a configuration
[**Remove-V2026Backup**](#delete-backup) | **DELETE** `/configuration-hub/backups/{id}` | Delete a backup
[**Remove-V2026Draft**](#delete-draft) | **DELETE** `/configuration-hub/drafts/{id}` | Delete a draft
[**Remove-V2026ObjectMapping**](#delete-object-mapping) | **DELETE** `/configuration-hub/object-mappings/{sourceOrg}/{objectMappingId}` | Deletes an object mapping
[**Remove-V2026ScheduledAction**](#delete-scheduled-action) | **DELETE** `/configuration-hub/scheduled-actions/{id}` | Delete scheduled action
[**Remove-V2026UploadedConfiguration**](#delete-uploaded-configuration) | **DELETE** `/configuration-hub/backups/uploads/{id}` | Delete an uploaded configuration
[**Get-V2026Deploy**](#get-deploy) | **GET** `/configuration-hub/deploys/{id}` | Get a deploy
[**Get-V2026ObjectMappings**](#get-object-mappings) | **GET** `/configuration-hub/object-mappings/{sourceOrg}` | Gets list of object mappings
[**Get-V2026UploadedConfiguration**](#get-uploaded-configuration) | **GET** `/configuration-hub/backups/uploads/{id}` | Get an uploaded configuration
[**Get-V2026Backups**](#list-backups) | **GET** `/configuration-hub/backups` | List backups
[**Get-V2026Deploys**](#list-deploys) | **GET** `/configuration-hub/deploys` | List deploys
[**Get-V2026Drafts**](#list-drafts) | **GET** `/configuration-hub/drafts` | List drafts
[**Get-V2026ScheduledActions**](#list-scheduled-actions) | **GET** `/configuration-hub/scheduled-actions` | List scheduled actions
[**Get-V2026UploadedConfigurations**](#list-uploaded-configurations) | **GET** `/configuration-hub/backups/uploads` | List uploaded configurations
[**Update-V2026ObjectMappings**](#update-object-mappings) | **POST** `/configuration-hub/object-mappings/{sourceOrg}/bulk-patch` | Bulk updates object mappings
[**Update-V2026ScheduledAction**](#update-scheduled-action) | **PATCH** `/configuration-hub/scheduled-actions/{id}` | Update scheduled action
...
try {
    $Result = ConvertFrom-V2026JsonToDeployRequest -Json $DeployRequest
    New-V2026Deploy -DeployRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Deploy -DeployRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Deploy"
...
try {
    $Result = ConvertFrom-V2026JsonToObjectMappingRequest -Json $ObjectMappingRequest
    New-V2026ObjectMapping -SourceOrg $SourceOrg -ObjectMappingRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026ObjectMapping -SourceOrg $SourceOrg -ObjectMappingRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026ObjectMapping"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToObjectMappingBulkCreateRequest -Json $ObjectMappingBulkCreateRequest
    New-V2026ObjectMappings -SourceOrg $SourceOrg -ObjectMappingBulkCreateRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026ObjectMappings -SourceOrg $SourceOrg -ObjectMappingBulkCreateRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026ObjectMappings"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToScheduledActionPayload -Json $ScheduledActionPayload
    New-V2026ScheduledAction -ScheduledActionPayload $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026ScheduledAction -ScheduledActionPayload $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026ScheduledAction"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    New-V2026UploadedConfiguration -Data $Data -Name $Name 
    
    # Below is a request that includes all optional parameters
    # New-V2026UploadedConfiguration -Data $Data -Name $Name  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026UploadedConfiguration"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026Backup -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Backup -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Backup"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026Draft -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Draft -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Draft"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026ObjectMapping -SourceOrg $SourceOrg -ObjectMappingId $ObjectMappingId 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026ObjectMapping -SourceOrg $SourceOrg -ObjectMappingId $ObjectMappingId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026ObjectMapping"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026ScheduledAction -ScheduledActionId $ScheduledActionId 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026ScheduledAction -ScheduledActionId $ScheduledActionId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026ScheduledAction"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026UploadedConfiguration -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026UploadedConfiguration -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026UploadedConfiguration"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Deploy -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Deploy -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Deploy"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ObjectMappings -SourceOrg $SourceOrg 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ObjectMappings -SourceOrg $SourceOrg  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ObjectMappings"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026UploadedConfiguration -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026UploadedConfiguration -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026UploadedConfiguration"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Backups -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Backups"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Deploys"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Drafts -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Drafts"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ScheduledActions 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ScheduledActions  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ScheduledActions"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026UploadedConfigurations 
    
    # Below is a request that includes all optional parameters
    # Get-V2026UploadedConfigurations -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026UploadedConfigurations"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToObjectMappingBulkPatchRequest -Json $ObjectMappingBulkPatchRequest
    Update-V2026ObjectMappings -SourceOrg $SourceOrg -ObjectMappingBulkPatchRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ObjectMappings -SourceOrg $SourceOrg -ObjectMappingBulkPatchRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ObjectMappings"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToJsonPatch -Json $JsonPatch
    Update-V2026ScheduledAction -ScheduledActionId $ScheduledActionId -JsonPatch $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ScheduledAction -ScheduledActionId $ScheduledActionId -JsonPatch $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ScheduledAction"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

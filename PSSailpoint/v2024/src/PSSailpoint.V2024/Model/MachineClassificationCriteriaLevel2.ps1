...
function Initialize-V2024MachineClassificationCriteriaLevel2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024MachineClassificationCriteriaLevel2' | Write-Debug
...
MachineClassificationCriteriaLevel2<PSCustomObject>
#>
function ConvertFrom-V2024JsonToMachineClassificationCriteriaLevel2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024MachineClassificationCriteriaLevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024MachineClassificationCriteriaLevel2

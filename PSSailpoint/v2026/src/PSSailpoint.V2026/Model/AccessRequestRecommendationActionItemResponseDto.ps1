...
function Initialize-V2026AccessRequestRecommendationActionItemResponseDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestRecommendationActionItemResponseDto' | Write-Debug
...
AccessRequestRecommendationActionItemResponseDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessRequestRecommendationActionItemResponseDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestRecommendationActionItemResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessRequestRecommendationActionItemResponseDto

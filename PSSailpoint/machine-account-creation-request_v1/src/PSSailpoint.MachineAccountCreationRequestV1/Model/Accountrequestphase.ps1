...
function Initialize-Accountrequestphase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountCreationRequestV1 => Accountrequestphase' | Write-Debug
...
Accountrequestphase<PSCustomObject>
#>
function ConvertFrom-JsonToAccountrequestphase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountCreationRequestV1 => Accountrequestphase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accountrequestphase

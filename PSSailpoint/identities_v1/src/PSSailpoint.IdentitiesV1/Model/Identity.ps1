...
function Initialize-Identity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IdentitiesV1 => Identity' | Write-Debug
...
Identity<PSCustomObject>
#>
function ConvertFrom-JsonToIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IdentitiesV1 => Identity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Identity

...
function Initialize-BulkworkgroupmembersrequestInner {
    [CmdletBinding()]
    Param (
...
BulkworkgroupmembersrequestInner<PSCustomObject>
#>
function ConvertFrom-JsonToBulkworkgroupmembersrequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in BulkworkgroupmembersrequestInner

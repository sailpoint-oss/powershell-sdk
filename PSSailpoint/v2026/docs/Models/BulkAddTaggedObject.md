...
keywords: ['powershell', 'PowerShell', 'sdk', 'BulkAddTaggedObject', 'V2026BulkAddTaggedObject'] 
slug: /tools/sdk/powershell/v2026/models/bulk-add-tagged-object
...
```powershell
$BulkAddTaggedObject = Initialize-V2026BulkAddTaggedObject  -ObjectRefs null `
 -Tags [BU_FINANCE, PCI] `
 -Operation MERGE
```

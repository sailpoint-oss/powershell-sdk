...
function Initialize-V2024IdentityAttribute1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityAttribute1' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityAttribute1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityAttribute1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeRequestSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeRequestSummary' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeRequestSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeRequestSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

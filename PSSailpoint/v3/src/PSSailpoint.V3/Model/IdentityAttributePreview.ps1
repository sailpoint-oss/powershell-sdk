...
function Initialize-IdentityAttributePreview {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityAttributePreview' | Write-Debug
...
function ConvertFrom-JsonToIdentityAttributePreview {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityAttributePreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Resourceobject {
    [CmdletBinding()]
    Param (
    )

    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => Resourceobject' | Write-Debug
...
Resourceobject<PSCustomObject>
#>
function ConvertFrom-JsonToResourceobject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => Resourceobject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Resourceobject

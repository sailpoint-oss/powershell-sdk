...
function Initialize-NonEmployeeSourceWithCloudExternalId {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeSourceWithCloudExternalId' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSourceWithCloudExternalId {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeSourceWithCloudExternalId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaSodViolationCheckResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSodViolationCheckResult' | Write-Debug
...
SodViolationCheckResult<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSodViolationCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSodViolationCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSodViolationCheckResult

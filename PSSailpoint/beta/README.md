...
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "PSSailpointBeta"; ModuleVersion = "1.1.2"}
```
...
## Documentation for Models
 ...
 - [PSSailpointBeta/Model.TransformAllOf](docs/TransformAllOf.md)
 ...
 - [PSSailpointBeta/Model.TransformUpdate](docs/TransformUpdate.md)
 - [PSSailpointBeta/Model.TransformUpdateAttributes](docs/TransformUpdateAttributes.md)

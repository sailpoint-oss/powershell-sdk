...
function Initialize-BetaRoleMembershipIdentity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMembershipIdentity' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMembershipIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMembershipIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

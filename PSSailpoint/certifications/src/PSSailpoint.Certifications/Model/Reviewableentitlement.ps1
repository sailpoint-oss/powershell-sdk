...
function Initialize-Reviewableentitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Certifications => Reviewableentitlement' | Write-Debug
...
function ConvertFrom-JsonToReviewableentitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Certifications => Reviewableentitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

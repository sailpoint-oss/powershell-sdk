...
function Initialize-BetaWorkflow {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaWorkflow' | Write-Debug
...
Workflow<PSCustomObject>
#>
function ConvertFrom-BetaJsonToWorkflow {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaWorkflow' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
ListSodPoliciesV1401Response<PSCustomObject>
#>

function Initialize-ListSodPoliciesV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListSodPoliciesV1401Response<PSCustomObject>
...
ListSodPoliciesV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToListSodPoliciesV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListSodPoliciesV1401Response
        $AllProperties = ("error")

...
function Initialize-BetaTaskResultResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTaskResultResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToTaskResultResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTaskResultResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

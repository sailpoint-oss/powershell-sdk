...
function Initialize-BetaTestWorkflow200Response {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaTestWorkflow200Response' | Write-Debug
...
function ConvertFrom-BetaJsonToTestWorkflow200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaTestWorkflow200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

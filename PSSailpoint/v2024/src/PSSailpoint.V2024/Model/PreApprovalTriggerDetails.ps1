...
function Initialize-V2024PreApprovalTriggerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024PreApprovalTriggerDetails' | Write-Debug
...
PreApprovalTriggerDetails<PSCustomObject>
#>
function ConvertFrom-V2024JsonToPreApprovalTriggerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024PreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024PreApprovalTriggerDetails

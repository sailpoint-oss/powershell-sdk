...
UsernamePasswordAction<PSCustomObject>
#>

function Initialize-NERMUsernamePasswordAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMUsernamePasswordAction' | Write-Debug
...
Convert from JSON to UsernamePasswordAction<PSCustomObject>
...
UsernamePasswordAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToUsernamePasswordAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMUsernamePasswordAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMUsernamePasswordAction
        $AllProperties = ("workflow_id", "description", "archived")

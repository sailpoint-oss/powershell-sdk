...
function Initialize-V2024NonEmployeeApprovalItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeApprovalItem' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeApprovalItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

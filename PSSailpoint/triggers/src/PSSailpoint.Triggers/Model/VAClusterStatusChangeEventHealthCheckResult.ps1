...
function Initialize-VAClusterStatusChangeEventHealthCheckResult {
    [CmdletBinding()]
    Param (
...
VAClusterStatusChangeEventHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-JsonToVAClusterStatusChangeEventHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in VAClusterStatusChangeEventHealthCheckResult

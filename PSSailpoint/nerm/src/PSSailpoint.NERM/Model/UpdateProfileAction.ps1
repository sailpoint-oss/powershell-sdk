...
UpdateProfileAction<PSCustomObject>
#>

function Initialize-NERMUpdateProfileAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMUpdateProfileAction' | Write-Debug
...
Convert from JSON to UpdateProfileAction<PSCustomObject>
...
UpdateProfileAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToUpdateProfileAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMUpdateProfileAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMUpdateProfileAction

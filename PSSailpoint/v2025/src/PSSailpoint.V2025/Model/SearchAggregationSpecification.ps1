...
function Initialize-V2025SearchAggregationSpecification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SearchAggregationSpecification' | Write-Debug
...
SearchAggregationSpecification<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSearchAggregationSpecification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SearchAggregationSpecification

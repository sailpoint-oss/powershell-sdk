...
function Initialize-ExceptionAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ExceptionAccessCriteria' | Write-Debug
...
ExceptionAccessCriteria<PSCustomObject>
#>
function ConvertFrom-JsonToExceptionAccessCriteria {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ExceptionAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExceptionAccessCriteria

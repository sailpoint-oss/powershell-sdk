...
function Initialize-SourceBeforeProvisioningRule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => SourceBeforeProvisioningRule' | Write-Debug
...
function ConvertFrom-JsonToSourceBeforeProvisioningRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => SourceBeforeProvisioningRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaResourceObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaResourceObject' | Write-Debug
...
function ConvertFrom-BetaJsonToResourceObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaResourceObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

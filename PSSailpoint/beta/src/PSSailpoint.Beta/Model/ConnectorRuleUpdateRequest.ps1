...
function Initialize-BetaConnectorRuleUpdateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleUpdateRequest' | Write-Debug
...
ConnectorRuleUpdateRequest<PSCustomObject>
#>
function ConvertFrom-BetaJsonToConnectorRuleUpdateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

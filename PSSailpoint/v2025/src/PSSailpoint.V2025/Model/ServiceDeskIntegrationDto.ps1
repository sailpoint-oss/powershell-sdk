...
function Initialize-V2025ServiceDeskIntegrationDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ServiceDeskIntegrationDto' | Write-Debug
...
ServiceDeskIntegrationDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToServiceDeskIntegrationDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ServiceDeskIntegrationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ServiceDeskIntegrationDto

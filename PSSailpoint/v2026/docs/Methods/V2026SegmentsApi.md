...
keywords: ['powershell', 'PowerShell', 'sdk', 'Segments', 'V2026Segments'] 
slug: /tools/sdk/powershell/v2026/methods/segments
...
------------- | ------------- | -------------
[**New-V2026Segment**](#create-segment) | **POST** `/segments` | Create segment
[**Remove-V2026Segment**](#delete-segment) | **DELETE** `/segments/{id}` | Delete segment by id
[**Get-V2026Segment**](#get-segment) | **GET** `/segments/{id}` | Get segment by id
[**Get-V2026Segments**](#list-segments) | **GET** `/segments` | List segments
[**Update-V2026Segment**](#patch-segment) | **PATCH** `/segments/{id}` | Update segment
...
try {
    $Result = ConvertFrom-V2026JsonToSegment -Json $Segment
    New-V2026Segment -Segment $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Segment -Segment $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Segment"
...
try {
    Remove-V2026Segment -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Segment -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Segment"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Segment -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Segment -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Segment"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Segments -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Segments"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026Segment -Id $Id -RequestBody $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026Segment -Id $Id -RequestBody $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026Segment"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

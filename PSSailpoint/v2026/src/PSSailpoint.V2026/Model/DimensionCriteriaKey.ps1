...
function Initialize-V2026DimensionCriteriaKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026DimensionCriteriaKey' | Write-Debug
...
DimensionCriteriaKey<PSCustomObject>
#>
function ConvertFrom-V2026JsonToDimensionCriteriaKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026DimensionCriteriaKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026DimensionCriteriaKey

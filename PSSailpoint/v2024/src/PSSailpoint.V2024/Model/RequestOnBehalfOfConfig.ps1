...
function Initialize-V2024RequestOnBehalfOfConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RequestOnBehalfOfConfig' | Write-Debug
...
RequestOnBehalfOfConfig<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRequestOnBehalfOfConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RequestOnBehalfOfConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RequestOnBehalfOfConfig

...
#>
function New-V2026SIMIntegration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026SIMIntegration' | Write-Debug
...
None
#>
function Remove-V2026SIMIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026SIMIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Get-V2026SIMIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026SIMIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto[]
#>
function Get-V2026SIMIntegrations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026SIMIntegrations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Update-V2026BeforeProvisioningRule {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026BeforeProvisioningRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Update-V2026SIMAttributes {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026SIMAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Send-V2026SIMIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2026SIMIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
EntitlementV2PrivilegeLevel<PSCustomObject>
#>

function Initialize-V2026EntitlementV2PrivilegeLevel {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026EntitlementV2PrivilegeLevel' | Write-Debug
...
Convert from JSON to EntitlementV2PrivilegeLevel<PSCustomObject>
...
EntitlementV2PrivilegeLevel<PSCustomObject>
#>
function ConvertFrom-V2026JsonToEntitlementV2PrivilegeLevel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026EntitlementV2PrivilegeLevel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026EntitlementV2PrivilegeLevel

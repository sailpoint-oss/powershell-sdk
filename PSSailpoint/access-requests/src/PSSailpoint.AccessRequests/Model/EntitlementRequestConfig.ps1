...
function Initialize-EntitlementRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => EntitlementRequestConfig' | Write-Debug
...
function ConvertFrom-JsonToEntitlementRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => EntitlementRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

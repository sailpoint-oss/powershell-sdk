...
keywords: ['powershell', 'PowerShell', 'sdk', 'SourceUsages', 'V2026SourceUsages'] 
slug: /tools/sdk/powershell/v2026/methods/source-usages
...
------------- | ------------- | -------------
[**Get-V2026StatusBySourceId**](#get-status-by-source-id) | **GET** `/source-usages/{sourceId}/status` | Finds status of source usage
[**Get-V2026UsagesBySourceId**](#get-usages-by-source-id) | **GET** `/source-usages/{sourceId}/summaries` | Returns source usage insights
...
try {
    Get-V2026StatusBySourceId -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026StatusBySourceId -SourceId $SourceId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026StatusBySourceId"
...
try {
    Get-V2026UsagesBySourceId -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026UsagesBySourceId -SourceId $SourceId -Limit $Limit -Offset $Offset -Count $Count -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026UsagesBySourceId"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

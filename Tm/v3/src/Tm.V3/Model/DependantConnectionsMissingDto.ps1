...
function Initialize-DependantConnectionsMissingDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => DependantConnectionsMissingDto' | Write-Debug
...
function ConvertFrom-JsonToDependantConnectionsMissingDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => DependantConnectionsMissingDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

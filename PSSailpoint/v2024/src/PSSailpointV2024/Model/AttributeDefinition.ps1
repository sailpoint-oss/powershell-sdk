...
function Initialize-V2024AttributeDefinition {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AttributeDefinition' | Write-Debug
...
function ConvertFrom-V2024JsonToAttributeDefinition {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AttributeDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaNonEmployeeApprovalSummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeApprovalSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

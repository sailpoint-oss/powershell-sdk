...
function Initialize-BetaApprovalComment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaApprovalComment' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaApprovalComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

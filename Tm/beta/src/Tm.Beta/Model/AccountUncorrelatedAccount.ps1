...
function Initialize-BetaAccountUncorrelatedAccount {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountUncorrelatedAccount' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountUncorrelatedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountUncorrelatedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

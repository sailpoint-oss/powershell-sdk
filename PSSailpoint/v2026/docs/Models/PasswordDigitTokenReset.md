...
keywords: ['powershell', 'PowerShell', 'sdk', 'PasswordDigitTokenReset', 'V2026PasswordDigitTokenReset'] 
slug: /tools/sdk/powershell/v2026/models/password-digit-token-reset
...
```powershell
$PasswordDigitTokenReset = Initialize-V2026PasswordDigitTokenReset  -UserId Abby.Smith `
 -Length 8 `
 -DurationMinutes 5
```

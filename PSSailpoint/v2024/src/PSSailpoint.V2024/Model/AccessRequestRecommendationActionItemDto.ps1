...
function Initialize-V2024AccessRequestRecommendationActionItemDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestRecommendationActionItemDto' | Write-Debug
...
AccessRequestRecommendationActionItemDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccessRequestRecommendationActionItemDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestRecommendationActionItemDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AccessRequestRecommendationActionItemDto

...
function Initialize-BetaEntitlementRequestConfig1 {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaEntitlementRequestConfig1' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementRequestConfig1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaEntitlementRequestConfig1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

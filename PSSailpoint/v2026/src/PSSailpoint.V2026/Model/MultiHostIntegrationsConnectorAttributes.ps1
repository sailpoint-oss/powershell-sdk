...
function Initialize-V2026MultiHostIntegrationsConnectorAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsConnectorAttributes' | Write-Debug
...
MultiHostIntegrationsConnectorAttributes<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMultiHostIntegrationsConnectorAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsConnectorAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $V2026MultiHostIntegrationsConnectorAttributesAdditionalProperties = @{}

        # check if Json contains properties not defined in V2026MultiHostIntegrationsConnectorAttributes
        ...
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            ...
            if (!($AllProperties.Contains($name))) {
                $V2026MultiHostIntegrationsConnectorAttributesAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "showEntitlementSchema" = ${ShowEntitlementSchema}
            "multiHostAttributes" = ${MultiHostAttributes}
            "AdditionalProperties" = $V2026MultiHostIntegrationsConnectorAttributesAdditionalProperties
        }

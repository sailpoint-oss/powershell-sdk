...
function Initialize-V2026ReviewRecommendation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ReviewRecommendation' | Write-Debug
...
ReviewRecommendation<PSCustomObject>
#>
function ConvertFrom-V2026JsonToReviewRecommendation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ReviewRecommendation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ReviewRecommendation

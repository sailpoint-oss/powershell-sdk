...
function Initialize-Recommendationrequestdto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiRecommendations => Recommendationrequestdto' | Write-Debug
...
function ConvertFrom-JsonToRecommendationrequestdto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiRecommendations => Recommendationrequestdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

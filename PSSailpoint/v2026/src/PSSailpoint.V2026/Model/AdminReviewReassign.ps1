...
function Initialize-V2026AdminReviewReassign {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AdminReviewReassign' | Write-Debug
...
AdminReviewReassign<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAdminReviewReassign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AdminReviewReassign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AdminReviewReassign

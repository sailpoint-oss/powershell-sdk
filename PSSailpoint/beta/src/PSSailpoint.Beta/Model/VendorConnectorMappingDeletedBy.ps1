...
function Initialize-BetaVendorConnectorMappingDeletedBy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaVendorConnectorMappingDeletedBy' | Write-Debug
...
function ConvertFrom-BetaJsonToVendorConnectorMappingDeletedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaVendorConnectorMappingDeletedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
#>
function ConvertFrom-V2024JsonToAttributeRequestValue {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'String' defined in oneOf (V2024AttributeRequestValue). Proceeding to the next one if any."
        }

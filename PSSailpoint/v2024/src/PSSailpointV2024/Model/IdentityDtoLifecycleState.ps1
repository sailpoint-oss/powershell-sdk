...
function Initialize-V2024IdentityDtoLifecycleState {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityDtoLifecycleState' | Write-Debug
...
IdentityDtoLifecycleState<PSCustomObject>
#>
function ConvertFrom-V2024JsonToIdentityDtoLifecycleState {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityDtoLifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024IdentityDtoLifecycleState

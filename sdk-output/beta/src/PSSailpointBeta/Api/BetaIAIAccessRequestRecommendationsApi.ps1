...
#>
function Invoke-BetaAccessRequestRecommendations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-BetaAccessRequestRecommendations' | Write-Debug
...
function Add-BetaAccessRequestRecommendationsIgnoredItem {
    ...
    Process {
        ...
        $LocalVarBodyParameter = $AccessRequestRecommendationActionItemDto | ConvertTo-Json -Depth 100

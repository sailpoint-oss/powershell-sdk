...
function Initialize-BetaAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

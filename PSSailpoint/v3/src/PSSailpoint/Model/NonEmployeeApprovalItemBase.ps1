...
function Initialize-NonEmployeeApprovalItemBase {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeApprovalItemBase' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeApprovalItemBase {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeApprovalItemBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

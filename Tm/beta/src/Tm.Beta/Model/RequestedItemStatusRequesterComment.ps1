...
function Initialize-BetaRequestedItemStatusRequesterComment {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRequestedItemStatusRequesterComment' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestedItemStatusRequesterComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRequestedItemStatusRequesterComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

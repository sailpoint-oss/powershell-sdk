...
Approval2<PSCustomObject>
#>

function Initialize-Approval2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApprovalsV1 => Approval2' | Write-Debug
...
Convert from JSON to Approval2<PSCustomObject>
...
Approval2<PSCustomObject>
#>
function ConvertFrom-JsonToApproval2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApprovalsV1 => Approval2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Approval2

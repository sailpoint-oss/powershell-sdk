...
function Initialize-NonEmployeeSourceRequestBody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeSourceRequestBody' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSourceRequestBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeSourceRequestBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

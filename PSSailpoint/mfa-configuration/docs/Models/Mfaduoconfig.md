...
slug: /tools/sdk/powershell/mfaconfigurationv1/models/mfaduoconfig
...
**ConfigProperties** | [**map[string]AnyType**](any-type) | A map with additional config properties for the given MFA method - duo-web. | [optional] 

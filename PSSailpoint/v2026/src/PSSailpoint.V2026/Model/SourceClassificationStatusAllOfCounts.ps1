...
function Initialize-V2026SourceClassificationStatusAllOfCounts {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SourceClassificationStatusAllOfCounts' | Write-Debug
...
SourceClassificationStatusAllOfCounts<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSourceClassificationStatusAllOfCounts {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SourceClassificationStatusAllOfCounts' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SourceClassificationStatusAllOfCounts

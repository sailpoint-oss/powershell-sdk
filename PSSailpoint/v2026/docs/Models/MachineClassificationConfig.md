...
slug: /tools/sdk/powershell/v2026/models/machine-classification-config
...
```powershell
$MachineClassificationConfig = Initialize-V2026MachineClassificationConfig  -Enabled true `

...
function Initialize-V2024ObjectMappingBulkCreateRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ObjectMappingBulkCreateRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToObjectMappingBulkCreateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ObjectMappingBulkCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

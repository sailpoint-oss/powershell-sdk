...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessRequestItemForm', 'AccessRequestItemForm'] 
slug: /tools/sdk/powershell/accessrequestapprovals/models/access-request-item-form
...
```powershell
$AccessRequestItemForm = Initialize-AccessRequestItemForm  -FormDefinitionId b2c1808f-77f5-4a3a-9f3a-1d2e3f4a5b6c `
...
```powershell
$AccessRequestItemForm | ConvertTo-JSON
```

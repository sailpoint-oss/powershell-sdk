...
function Initialize-EntitlementV2AccessModelMetadata {
    [CmdletBinding()]
    Param (
...
EntitlementV2AccessModelMetadata<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementV2AccessModelMetadata {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in EntitlementV2AccessModelMetadata

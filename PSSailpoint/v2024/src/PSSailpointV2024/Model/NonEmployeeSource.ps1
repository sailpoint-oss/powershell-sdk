...
function Initialize-V2024NonEmployeeSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeSource' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

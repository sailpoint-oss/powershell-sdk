...
function Initialize-V2026ClusterManualUpgradeJobsInnerManagedProcessConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfiguration' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfiguration<PSCustomObject>
#>
function ConvertFrom-V2026JsonToClusterManualUpgradeJobsInnerManagedProcessConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ClusterManualUpgradeJobsInnerManagedProcessConfiguration

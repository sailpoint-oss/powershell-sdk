...
function Initialize-BetaJsonPatchOperationRoleMining {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaJsonPatchOperationRoleMining' | Write-Debug
...
JsonPatchOperationRoleMining<PSCustomObject>
#>
function ConvertFrom-BetaJsonToJsonPatchOperationRoleMining {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaJsonPatchOperationRoleMining' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaJsonPatchOperationRoleMining

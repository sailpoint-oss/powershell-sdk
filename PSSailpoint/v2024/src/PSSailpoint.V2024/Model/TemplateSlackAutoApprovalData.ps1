...
function Initialize-V2024TemplateSlackAutoApprovalData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TemplateSlackAutoApprovalData' | Write-Debug
...
TemplateSlackAutoApprovalData<PSCustomObject>
#>
function ConvertFrom-V2024JsonToTemplateSlackAutoApprovalData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TemplateSlackAutoApprovalData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024TemplateSlackAutoApprovalData

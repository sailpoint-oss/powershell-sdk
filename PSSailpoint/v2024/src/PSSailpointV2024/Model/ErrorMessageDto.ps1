...
function Initialize-V2024ErrorMessageDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ErrorMessageDto' | Write-Debug
...
function ConvertFrom-V2024JsonToErrorMessageDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ErrorMessageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function ConvertFrom-V2024JsonToReportDetailsArguments {
    ...
    Process {
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'OrphanIdentitiesReportArguments' defined in oneOf (V2024ReportDetailsArguments). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'UncorrelatedAccountsReportArguments' defined in oneOf (V2024ReportDetailsArguments). Proceeding to the next one if any."
        }

...
function Initialize-ProvisioningCriteriaLevel2 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ProvisioningCriteriaLevel2' | Write-Debug
...
function ConvertFrom-JsonToProvisioningCriteriaLevel2 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ProvisioningCriteriaLevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

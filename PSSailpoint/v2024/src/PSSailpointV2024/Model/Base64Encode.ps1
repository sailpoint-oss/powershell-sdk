...
function Initialize-V2024Base64Encode {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Base64Encode' | Write-Debug
...
function ConvertFrom-V2024JsonToBase64Encode {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Base64Encode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

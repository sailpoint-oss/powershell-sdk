...
function Initialize-IdentityPreviewRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityPreviewRequest' | Write-Debug
...
function ConvertFrom-JsonToIdentityPreviewRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityPreviewRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaListWorkgroupMembers200ResponseInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaListWorkgroupMembers200ResponseInner' | Write-Debug
...
ListWorkgroupMembers200ResponseInner<PSCustomObject>
#>
function ConvertFrom-BetaJsonToListWorkgroupMembers200ResponseInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaListWorkgroupMembers200ResponseInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Workgroupmemberadditem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.GovernanceGroupsV1 => Workgroupmemberadditem' | Write-Debug
...
Workgroupmemberadditem<PSCustomObject>
#>
function ConvertFrom-JsonToWorkgroupmemberadditem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.GovernanceGroupsV1 => Workgroupmemberadditem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Workgroupmemberadditem

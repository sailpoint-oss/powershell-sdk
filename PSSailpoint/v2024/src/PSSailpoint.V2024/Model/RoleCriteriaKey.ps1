...
function Initialize-V2024RoleCriteriaKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleCriteriaKey' | Write-Debug
...
RoleCriteriaKey<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRoleCriteriaKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleCriteriaKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RoleCriteriaKey

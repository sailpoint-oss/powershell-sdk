...
function Initialize-SlimDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => SlimDiscoveredApplications' | Write-Debug
...
function ConvertFrom-JsonToSlimDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => SlimDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024BaseAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024BaseAccount' | Write-Debug
...
BaseAccount<PSCustomObject>
#>
function ConvertFrom-V2024JsonToBaseAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024BaseAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

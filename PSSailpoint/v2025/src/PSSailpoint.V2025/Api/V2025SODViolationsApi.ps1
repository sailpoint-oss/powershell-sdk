...
ViolationPrediction
#>
function Start-V2025PredictSodViolations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Start-V2025PredictSodViolations' | Write-Debug
...
SodViolationCheck
#>
function Start-V2025ViolationCheck {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Start-V2025ViolationCheck' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

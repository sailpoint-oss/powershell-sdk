...
function Initialize-ManagedClusterKeyPair {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ManagedClusterKeyPair' | Write-Debug
...
ManagedClusterKeyPair<PSCustomObject>
#>
function ConvertFrom-JsonToManagedClusterKeyPair {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ManagedClusterKeyPair' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ManagedClusterKeyPair

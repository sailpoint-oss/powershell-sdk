...
function Initialize-BetaSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSource' | Write-Debug
...
Source<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

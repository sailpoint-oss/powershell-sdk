...
function Initialize-BetaRoleCriteriaLevel1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleCriteriaLevel1' | Write-Debug
...
RoleCriteriaLevel1<PSCustomObject>
#>
function ConvertFrom-BetaJsonToRoleCriteriaLevel1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleCriteriaLevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaRoleCriteriaLevel1

...
Get the configuration object 'CCConfiguration'.
...
#>
function Get-CCConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://sailpoint.api.identitynow.com";
    }
...
None
#>
function Set-CCConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-CCConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-CCConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
String
#>
function Get-CCUrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-CCConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-CCKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'CCConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-CCConfigurationHttpSigning{

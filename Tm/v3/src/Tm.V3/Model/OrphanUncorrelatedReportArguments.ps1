...
function Initialize-OrphanUncorrelatedReportArguments {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => OrphanUncorrelatedReportArguments' | Write-Debug
...
function ConvertFrom-JsonToOrphanUncorrelatedReportArguments {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => OrphanUncorrelatedReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

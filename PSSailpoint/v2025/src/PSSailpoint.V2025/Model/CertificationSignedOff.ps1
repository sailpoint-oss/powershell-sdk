...
function Initialize-V2025CertificationSignedOff {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CertificationSignedOff' | Write-Debug
...
CertificationSignedOff<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCertificationSignedOff {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CertificationSignedOff' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CertificationSignedOff

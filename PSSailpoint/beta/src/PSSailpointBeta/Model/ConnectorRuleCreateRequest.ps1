...
function Initialize-BetaConnectorRuleCreateRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaConnectorRuleCreateRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToConnectorRuleCreateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaConnectorRuleCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

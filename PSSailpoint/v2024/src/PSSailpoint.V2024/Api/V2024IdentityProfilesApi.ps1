...
IdentityProfile
#>
function New-V2024IdentityProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2024IdentityProfile' | Write-Debug
...
#>
function Remove-V2024IdentityProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2024IdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaskResultSimplified
#>
function Remove-V2024IdentityProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String[]]
    ...
    Process {
        'Calling method: Remove-V2024IdentityProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Export-V2024IdentityProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Export-V2024IdentityProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2024DefaultIdentityAttributeConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024DefaultIdentityAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityProfile
#>
function Get-V2024IdentityProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024IdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ObjectImportResult
#>
function Import-V2024IdentityProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Import-V2024IdentityProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityProfile[]
#>
function Get-V2024IdentityProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int32]]
    ...
    Process {
        'Calling method: Get-V2024IdentityProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Show-V2024IdentityPreview {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Show-V2024IdentityPreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$IdentityPreviewRequest) {
            throw "Error! The required parameter `IdentityPreviewRequest` missing when calling showIdentityPreview."
        }
...
#>
function Sync-V2024IdentityProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Sync-V2024IdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityProfile
#>
function Update-V2024IdentityProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2024IdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

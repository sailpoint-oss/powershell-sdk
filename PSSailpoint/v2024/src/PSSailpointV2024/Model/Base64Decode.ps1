...
function Initialize-V2024Base64Decode {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Base64Decode' | Write-Debug
...
function ConvertFrom-V2024JsonToBase64Decode {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Base64Decode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'PendingApprovalOwner', 'V2026PendingApprovalOwner'] 
slug: /tools/sdk/powershell/v2026/models/pending-approval-owner
...
```powershell
$PendingApprovalOwner = Initialize-V2026PendingApprovalOwner  -Type IDENTITY `

...
function Initialize-BetaIdentityExceptionReportReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityExceptionReportReference' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityExceptionReportReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityExceptionReportReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024CommonAccessItemAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CommonAccessItemAccess' | Write-Debug
...
CommonAccessItemAccess<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCommonAccessItemAccess {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CommonAccessItemAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024CommonAccessItemAccess

...
function Initialize-Userlevelpublishsummary {
    [CmdletBinding()]
    Param (
...
Userlevelpublishsummary<PSCustomObject>
#>
function ConvertFrom-JsonToUserlevelpublishsummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Userlevelpublishsummary

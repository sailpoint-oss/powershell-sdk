...
function Initialize-SodViolationContextCheckCompleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SodViolationContextCheckCompleted' | Write-Debug
...
function ConvertFrom-JsonToSodViolationContextCheckCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SodViolationContextCheckCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

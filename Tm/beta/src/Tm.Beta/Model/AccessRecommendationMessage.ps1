...
function Initialize-BetaAccessRecommendationMessage {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRecommendationMessage' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRecommendationMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRecommendationMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

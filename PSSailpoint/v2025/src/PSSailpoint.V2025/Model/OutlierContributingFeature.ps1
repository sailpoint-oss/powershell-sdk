...
function Initialize-V2025OutlierContributingFeature {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025OutlierContributingFeature' | Write-Debug
...
OutlierContributingFeature<PSCustomObject>
#>
function ConvertFrom-V2025JsonToOutlierContributingFeature {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025OutlierContributingFeature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025OutlierContributingFeature

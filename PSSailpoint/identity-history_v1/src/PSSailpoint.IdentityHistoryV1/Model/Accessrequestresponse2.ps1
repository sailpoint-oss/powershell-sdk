...
Accessrequestresponse2<PSCustomObject>
#>

function Initialize-Accessrequestresponse2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IdentityHistoryV1 => Accessrequestresponse2' | Write-Debug
...
Convert from JSON to Accessrequestresponse2<PSCustomObject>
...
Accessrequestresponse2<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestresponse2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IdentityHistoryV1 => Accessrequestresponse2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessrequestresponse2

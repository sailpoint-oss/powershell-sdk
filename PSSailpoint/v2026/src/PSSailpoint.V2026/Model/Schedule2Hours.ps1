...
function Initialize-V2026Schedule2Hours {
    [CmdletBinding()]
    Param (
...
Schedule2Hours<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSchedule2Hours {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026Schedule2Hours' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

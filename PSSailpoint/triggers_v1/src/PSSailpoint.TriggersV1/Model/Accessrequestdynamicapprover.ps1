...
function Initialize-Accessrequestdynamicapprover {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Accessrequestdynamicapprover' | Write-Debug
...
Accessrequestdynamicapprover<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestdynamicapprover {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Accessrequestdynamicapprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessrequestdynamicapprover

...
function Initialize-V2024Schedule1Hours {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Schedule1Hours' | Write-Debug
...
function ConvertFrom-V2024JsonToSchedule1Hours {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Schedule1Hours' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'PasswordStatus', 'V2026PasswordStatus'] 
slug: /tools/sdk/powershell/v2026/models/password-status
...
```powershell
$PasswordStatus = Initialize-V2026PasswordStatus  -RequestId 089899f13a8f4da7824996191587bab9 `
 -State IN_PROGRESS `

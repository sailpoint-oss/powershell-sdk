...
keywords: ['powershell', 'PowerShell', 'sdk', 'IdentityProfile', 'V2026IdentityProfile'] 
slug: /tools/sdk/powershell/v2026/models/identity-profile
...
```powershell
$IdentityProfile = Initialize-V2026IdentityProfile  -Id id12345 `
 -Name aName `

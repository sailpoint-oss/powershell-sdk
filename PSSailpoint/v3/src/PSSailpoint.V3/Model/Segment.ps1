...
function Initialize-Segment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => Segment' | Write-Debug
...
Segment<PSCustomObject>
#>
function ConvertFrom-JsonToSegment {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => Segment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Segment

...
function Initialize-V2024TemplateTeams {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TemplateTeams' | Write-Debug
...
function ConvertFrom-V2024JsonToTemplateTeams {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TemplateTeams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

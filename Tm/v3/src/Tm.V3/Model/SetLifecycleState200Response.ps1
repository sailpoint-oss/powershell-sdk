...
function Initialize-SetLifecycleState200Response {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => SetLifecycleState200Response' | Write-Debug
...
function ConvertFrom-JsonToSetLifecycleState200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => SetLifecycleState200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

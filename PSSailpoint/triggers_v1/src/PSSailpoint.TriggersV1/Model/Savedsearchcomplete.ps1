...
function Initialize-Savedsearchcomplete {
    [CmdletBinding()]
    Param (
...
Savedsearchcomplete<PSCustomObject>
#>
function ConvertFrom-JsonToSavedsearchcomplete {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Savedsearchcomplete

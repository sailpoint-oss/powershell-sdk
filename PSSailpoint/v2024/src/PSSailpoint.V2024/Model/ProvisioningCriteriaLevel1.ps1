...
function Initialize-V2024ProvisioningCriteriaLevel1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ProvisioningCriteriaLevel1' | Write-Debug
...
ProvisioningCriteriaLevel1<PSCustomObject>
#>
function ConvertFrom-V2024JsonToProvisioningCriteriaLevel1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ProvisioningCriteriaLevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ProvisioningCriteriaLevel1

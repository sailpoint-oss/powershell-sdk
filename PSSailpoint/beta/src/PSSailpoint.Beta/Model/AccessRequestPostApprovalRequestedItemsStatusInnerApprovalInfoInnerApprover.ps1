...
function Initialize-BetaAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInnerApprover {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInnerApprover' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInnerApprover {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInnerApprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

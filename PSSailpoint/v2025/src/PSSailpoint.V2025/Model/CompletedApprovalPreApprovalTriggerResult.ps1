...
function Initialize-V2025CompletedApprovalPreApprovalTriggerResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CompletedApprovalPreApprovalTriggerResult' | Write-Debug
...
CompletedApprovalPreApprovalTriggerResult<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCompletedApprovalPreApprovalTriggerResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CompletedApprovalPreApprovalTriggerResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CompletedApprovalPreApprovalTriggerResult

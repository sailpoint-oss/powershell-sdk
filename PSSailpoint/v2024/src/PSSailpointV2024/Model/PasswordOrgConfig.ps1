...
function Initialize-V2024PasswordOrgConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PasswordOrgConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToPasswordOrgConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PasswordOrgConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

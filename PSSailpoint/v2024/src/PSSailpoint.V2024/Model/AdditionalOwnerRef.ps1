...
function Initialize-V2024AdditionalOwnerRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AdditionalOwnerRef' | Write-Debug
...
AdditionalOwnerRef<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAdditionalOwnerRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AdditionalOwnerRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AdditionalOwnerRef

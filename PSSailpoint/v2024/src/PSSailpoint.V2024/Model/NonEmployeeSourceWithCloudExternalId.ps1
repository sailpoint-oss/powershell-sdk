...
function Initialize-V2024NonEmployeeSourceWithCloudExternalId {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeSourceWithCloudExternalId' | Write-Debug
...
NonEmployeeSourceWithCloudExternalId<PSCustomObject>
#>
function ConvertFrom-V2024JsonToNonEmployeeSourceWithCloudExternalId {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeSourceWithCloudExternalId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024NonEmployeeSourceWithCloudExternalId

...
function Initialize-V2024ReviewDecision {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ReviewDecision' | Write-Debug
...
function ConvertFrom-V2024JsonToReviewDecision {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ReviewDecision' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

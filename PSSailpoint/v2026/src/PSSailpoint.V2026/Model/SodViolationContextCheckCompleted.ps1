...
function Initialize-V2026SodViolationContextCheckCompleted {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SodViolationContextCheckCompleted' | Write-Debug
...
SodViolationContextCheckCompleted<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSodViolationContextCheckCompleted {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SodViolationContextCheckCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SodViolationContextCheckCompleted

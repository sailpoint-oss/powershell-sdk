...
function Initialize-CreateWorkflowV1Request {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Workflows => CreateWorkflowV1Request' | Write-Debug
...
function ConvertFrom-JsonToCreateWorkflowV1Request {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Workflows => CreateWorkflowV1Request' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

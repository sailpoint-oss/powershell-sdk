...
keywords: ['powershell', 'PowerShell', 'sdk', 'NativeChangeDetectionConfig', 'V2026NativeChangeDetectionConfig'] 
slug: /tools/sdk/powershell/v2026/models/native-change-detection-config
...
```powershell
$NativeChangeDetectionConfig = Initialize-V2026NativeChangeDetectionConfig  -Enabled true `

...
function Initialize-Accountaction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.LifecycleStatesV1 => Accountaction' | Write-Debug
...
Accountaction<PSCustomObject>
#>
function ConvertFrom-JsonToAccountaction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.LifecycleStatesV1 => Accountaction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accountaction

...
function Initialize-BetaSubscriptionPutRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSubscriptionPutRequest' | Write-Debug
...
SubscriptionPutRequest<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSubscriptionPutRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSubscriptionPutRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSubscriptionPutRequest

...
WorkItems
#>
function Approve-V2025ApprovalItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Approve-V2025ApprovalItem' | Write-Debug
...
WorkItems
#>
function Approve-V2025ApprovalItemsInBulk {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Approve-V2025ApprovalItemsInBulk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
WorkItems
#>
function Complete-V2025WorkItem {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Complete-V2025WorkItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-V2025ForwardWorkItem {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2025ForwardWorkItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
WorkItems[]
#>
function Get-V2025CompletedWorkItems {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025CompletedWorkItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
WorkItemsCount
#>
function Get-V2025CountCompletedWorkItems {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025CountCompletedWorkItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
WorkItemsCount
#>
function Get-V2025CountWorkItems {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025CountWorkItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025WorkItem {
    ...
    Process {
        'Calling method: Get-V2025WorkItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
WorkItemsSummary
#>
function Get-V2025WorkItemsSummary {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025WorkItemsSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025WorkItems {
    ...
    Process {
        'Calling method: Get-V2025WorkItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
WorkItems
#>
function Deny-V2025ApprovalItem {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Deny-V2025ApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
WorkItems
#>
function Deny-V2025ApprovalItemsInBulk {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Deny-V2025ApprovalItemsInBulk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
WorkItems
#>
function Submit-V2025AccountSelection {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Submit-V2025AccountSelection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

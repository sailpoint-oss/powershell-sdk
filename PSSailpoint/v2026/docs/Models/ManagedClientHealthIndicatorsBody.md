...
keywords: ['powershell', 'PowerShell', 'sdk', 'ManagedClientHealthIndicatorsBody', 'V2026ManagedClientHealthIndicatorsBody'] 
slug: /tools/sdk/powershell/v2026/models/managed-client-health-indicators-body
...
```powershell
$ManagedClientHealthIndicatorsBody = Initialize-V2026ManagedClientHealthIndicatorsBody  -AlertKey  `

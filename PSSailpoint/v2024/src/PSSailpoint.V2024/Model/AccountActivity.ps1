...
function Initialize-V2024AccountActivity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccountActivity' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountActivity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccountActivity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountAction', 'V2026AccountAction'] 
slug: /tools/sdk/powershell/v2026/models/account-action
...
```powershell
$AccountAction = Initialize-V2026AccountAction  -Action ENABLE `

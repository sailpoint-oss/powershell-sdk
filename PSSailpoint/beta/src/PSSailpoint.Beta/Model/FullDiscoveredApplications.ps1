...
function Initialize-BetaFullDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFullDiscoveredApplications' | Write-Debug
...
function ConvertFrom-BetaJsonToFullDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFullDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

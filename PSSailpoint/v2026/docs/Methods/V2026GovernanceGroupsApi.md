...
keywords: ['powershell', 'PowerShell', 'sdk', 'GovernanceGroups', 'V2026GovernanceGroups'] 
slug: /tools/sdk/powershell/v2026/methods/governance-groups
...
------------- | ------------- | -------------
[**New-V2026Workgroup**](#create-workgroup) | **POST** `/workgroups` | Create a new governance group.
[**Remove-V2026Workgroup**](#delete-workgroup) | **DELETE** `/workgroups/{id}` | Delete a governance group
[**Remove-V2026WorkgroupMembers**](#delete-workgroup-members) | **POST** `/workgroups/{workgroupId}/members/bulk-delete` | Remove members from governance group
[**Remove-V2026WorkgroupsInBulk**](#delete-workgroups-in-bulk) | **POST** `/workgroups/bulk-delete` | Delete governance group(s)
[**Get-V2026Workgroup**](#get-workgroup) | **GET** `/workgroups/{id}` | Get governance group by id
[**Get-V2026Connections**](#list-connections) | **GET** `/workgroups/{workgroupId}/connections` | List connections for governance group
[**Get-V2026WorkgroupMembers**](#list-workgroup-members) | **GET** `/workgroups/{workgroupId}/members` | List governance group members
[**Get-V2026Workgroups**](#list-workgroups) | **GET** `/workgroups` | List governance groups
[**Update-V2026Workgroup**](#patch-workgroup) | **PATCH** `/workgroups/{id}` | Patch a governance group
[**Update-V2026WorkgroupMembers**](#update-workgroup-members) | **POST** `/workgroups/{workgroupId}/members/bulk-add` | Add members to governance group
...
try {
    $Result = ConvertFrom-V2026JsonToWorkgroupDto -Json $WorkgroupDto
    New-V2026Workgroup -WorkgroupDto $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Workgroup -WorkgroupDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Workgroup"
...
try {
    Remove-V2026Workgroup -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Workgroup -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Workgroup"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToIdentityPreviewResponseIdentity -Json $IdentityPreviewResponseIdentity
    Remove-V2026WorkgroupMembers -WorkgroupId $WorkgroupId -IdentityPreviewResponseIdentity $Result 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026WorkgroupMembers -WorkgroupId $WorkgroupId -IdentityPreviewResponseIdentity $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026WorkgroupMembers"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToWorkgroupBulkDeleteRequest -Json $WorkgroupBulkDeleteRequest
    Remove-V2026WorkgroupsInBulk -WorkgroupBulkDeleteRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026WorkgroupsInBulk -WorkgroupBulkDeleteRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026WorkgroupsInBulk"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Workgroup -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Workgroup -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Workgroup"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Connections -WorkgroupId $WorkgroupId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Connections -WorkgroupId $WorkgroupId -Offset $Offset -Limit $Limit -Count $Count -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Connections"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026WorkgroupMembers -WorkgroupId $WorkgroupId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026WorkgroupMembers -WorkgroupId $WorkgroupId -Offset $Offset -Limit $Limit -Count $Count -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026WorkgroupMembers"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Workgroups -Offset $Offset -Limit $Limit -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Workgroups"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Update-V2026Workgroup -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Update-V2026Workgroup -Id $Id -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026Workgroup"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToIdentityPreviewResponseIdentity -Json $IdentityPreviewResponseIdentity
    Update-V2026WorkgroupMembers -WorkgroupId $WorkgroupId -IdentityPreviewResponseIdentity $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026WorkgroupMembers -WorkgroupId $WorkgroupId -IdentityPreviewResponseIdentity $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026WorkgroupMembers"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

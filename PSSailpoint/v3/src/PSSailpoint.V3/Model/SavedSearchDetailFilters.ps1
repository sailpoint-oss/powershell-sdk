...
function Initialize-SavedSearchDetailFilters {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SavedSearchDetailFilters' | Write-Debug
...
function ConvertFrom-JsonToSavedSearchDetailFilters {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SavedSearchDetailFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

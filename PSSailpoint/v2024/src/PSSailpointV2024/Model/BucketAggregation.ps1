...
function Initialize-V2024BucketAggregation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024BucketAggregation' | Write-Debug
...
function ConvertFrom-V2024JsonToBucketAggregation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024BucketAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

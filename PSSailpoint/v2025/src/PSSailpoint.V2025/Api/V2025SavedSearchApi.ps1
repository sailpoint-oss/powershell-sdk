...
function New-V2025SavedSearch {
    ...
    Process {
        'Calling method: New-V2025SavedSearch' | Write-Debug
...
None
#>
function Remove-V2025SavedSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-V2025ExecuteSavedSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2025ExecuteSavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025SavedSearch {
    ...
    Process {
        'Calling method: Get-V2025SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SavedSearch[]
#>
function Get-V2025SavedSearches {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2025SavedSearches' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SavedSearch
#>
function Send-V2025SavedSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

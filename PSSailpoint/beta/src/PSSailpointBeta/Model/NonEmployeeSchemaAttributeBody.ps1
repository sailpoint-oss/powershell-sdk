...
function Initialize-BetaNonEmployeeSchemaAttributeBody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaNonEmployeeSchemaAttributeBody' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSchemaAttributeBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaNonEmployeeSchemaAttributeBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

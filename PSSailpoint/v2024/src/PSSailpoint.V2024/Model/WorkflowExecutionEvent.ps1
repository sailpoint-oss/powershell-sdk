...
function Initialize-V2024WorkflowExecutionEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024WorkflowExecutionEvent' | Write-Debug
...
WorkflowExecutionEvent<PSCustomObject>
#>
function ConvertFrom-V2024JsonToWorkflowExecutionEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024WorkflowExecutionEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024WorkflowExecutionEvent

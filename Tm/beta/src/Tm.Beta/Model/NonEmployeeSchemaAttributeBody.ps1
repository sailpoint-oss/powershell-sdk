...
function Initialize-BetaNonEmployeeSchemaAttributeBody {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeSchemaAttributeBody' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSchemaAttributeBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeSchemaAttributeBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

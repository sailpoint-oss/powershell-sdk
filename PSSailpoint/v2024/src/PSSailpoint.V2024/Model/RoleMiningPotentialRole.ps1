...
function Initialize-V2024RoleMiningPotentialRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningPotentialRole' | Write-Debug
...
RoleMiningPotentialRole<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRoleMiningPotentialRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningPotentialRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

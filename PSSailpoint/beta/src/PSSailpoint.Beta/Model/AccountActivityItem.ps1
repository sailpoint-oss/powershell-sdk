...
function Initialize-BetaAccountActivityItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountActivityItem' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountActivityItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountActivityItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

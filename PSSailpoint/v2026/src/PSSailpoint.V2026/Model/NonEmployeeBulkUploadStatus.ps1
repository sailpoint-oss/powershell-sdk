...
function Initialize-V2026NonEmployeeBulkUploadStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeBulkUploadStatus' | Write-Debug
...
NonEmployeeBulkUploadStatus<PSCustomObject>
#>
function ConvertFrom-V2026JsonToNonEmployeeBulkUploadStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeBulkUploadStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026NonEmployeeBulkUploadStatus

...
function Initialize-BetaCompletedApproval {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCompletedApproval' | Write-Debug
...
function ConvertFrom-BetaJsonToCompletedApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCompletedApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

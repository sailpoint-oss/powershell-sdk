...
function Initialize-ApprovalConfigEscalationConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Sources => ApprovalConfigEscalationConfig' | Write-Debug
...
function ConvertFrom-JsonToApprovalConfigEscalationConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Sources => ApprovalConfigEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

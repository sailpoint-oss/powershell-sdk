...
Reference2<PSCustomObject>
#>

function Initialize-Reference2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => Reference2' | Write-Debug
...
Convert from JSON to Reference2<PSCustomObject>
...
Reference2<PSCustomObject>
#>
function ConvertFrom-JsonToReference2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => Reference2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Reference2

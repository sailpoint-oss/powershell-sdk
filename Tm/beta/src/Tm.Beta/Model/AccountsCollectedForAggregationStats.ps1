...
function Initialize-BetaAccountsCollectedForAggregationStats {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountsCollectedForAggregationStats' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountsCollectedForAggregationStats {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountsCollectedForAggregationStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

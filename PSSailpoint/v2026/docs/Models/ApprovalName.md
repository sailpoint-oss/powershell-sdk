...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalName', 'V2026ApprovalName'] 
slug: /tools/sdk/powershell/v2026/models/approval-name
...
```powershell
$ApprovalName = Initialize-V2026ApprovalName  -Value Audit DB Access `
 -Locale en_US
```

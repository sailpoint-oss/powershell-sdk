...
function Initialize-V2024ManagedCluster {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ManagedCluster' | Write-Debug
...
function ConvertFrom-V2024JsonToManagedCluster {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ManagedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026TypeAheadQuery {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TypeAheadQuery' | Write-Debug
...
TypeAheadQuery<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTypeAheadQuery {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TypeAheadQuery' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TypeAheadQuery

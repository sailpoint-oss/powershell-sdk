...
function Initialize-SavedsearchcompleteSearchResultsEntitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => SavedsearchcompleteSearchResultsEntitlement' | Write-Debug
...
SavedsearchcompleteSearchResultsEntitlement<PSCustomObject>
#>
function ConvertFrom-JsonToSavedsearchcompleteSearchResultsEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => SavedsearchcompleteSearchResultsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SavedsearchcompleteSearchResultsEntitlement

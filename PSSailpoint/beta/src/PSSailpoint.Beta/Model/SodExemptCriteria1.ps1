...
function Initialize-BetaSodExemptCriteria1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSodExemptCriteria1' | Write-Debug
...
function ConvertFrom-BetaJsonToSodExemptCriteria1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSodExemptCriteria1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

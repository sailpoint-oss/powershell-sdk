...
function Initialize-V2024CreatePersonalAccessTokenRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CreatePersonalAccessTokenRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCreatePersonalAccessTokenRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CreatePersonalAccessTokenRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

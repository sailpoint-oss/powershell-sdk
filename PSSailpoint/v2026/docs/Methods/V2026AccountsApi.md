...
keywords: ['powershell', 'PowerShell', 'sdk', 'Accounts', 'V2026Accounts'] 
slug: /tools/sdk/powershell/v2026/methods/accounts
...
------------- | ------------- | -------------
[**New-V2026Account**](#create-account) | **POST** `/accounts` | Create account
[**Remove-V2026Account**](#delete-account) | **DELETE** `/accounts/{id}` | Delete account
[**Remove-V2026AccountAsync**](#delete-account-async) | **POST** `/accounts/{id}/remove` | Remove account
[**Disable-V2026Account**](#disable-account) | **POST** `/accounts/{id}/disable` | Disable account
[**Disable-V2026AccountForIdentity**](#disable-account-for-identity) | **POST** `/identities-accounts/{id}/disable` | Disable idn account for identity
[**Disable-V2026AccountsForIdentities**](#disable-accounts-for-identities) | **POST** `/identities-accounts/disable` | Disable idn accounts for identities
[**Enable-V2026Account**](#enable-account) | **POST** `/accounts/{id}/enable` | Enable account
[**Enable-V2026AccountForIdentity**](#enable-account-for-identity) | **POST** `/identities-accounts/{id}/enable` | Enable idn account for identity
[**Enable-V2026AccountsForIdentities**](#enable-accounts-for-identities) | **POST** `/identities-accounts/enable` | Enable idn accounts for identities
[**Get-V2026Account**](#get-account) | **GET** `/accounts/{id}` | Account details
[**Get-V2026AccountEntitlements**](#get-account-entitlements) | **GET** `/accounts/{id}/entitlements` | Account entitlements
[**Get-V2026Accounts**](#list-accounts) | **GET** `/accounts` | Accounts list
[**Send-V2026Account**](#put-account) | **PUT** `/accounts/{id}` | Update account
[**Submit-V2026ReloadAccount**](#submit-reload-account) | **POST** `/accounts/{id}/reload` | Reload account
[**Unlock-V2026Account**](#unlock-account) | **POST** `/accounts/{id}/unlock` | Unlock account
[**Update-V2026Account**](#update-account) | **PATCH** `/accounts/{id}` | Update account
...
try {
    $Result = ConvertFrom-V2026JsonToAccountAttributesCreate -Json $AccountAttributesCreate
    New-V2026Account -AccountAttributesCreate $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Account -AccountAttributesCreate $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Account"
...
try {
    Remove-V2026Account -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Account -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Account"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026AccountAsync -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026AccountAsync -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026AccountAsync"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAccountToggleRequest -Json $AccountToggleRequest
    Disable-V2026Account -Id $Id -AccountToggleRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Disable-V2026Account -Id $Id -AccountToggleRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Disable-V2026Account"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Disable-V2026AccountForIdentity -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Disable-V2026AccountForIdentity -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Disable-V2026AccountForIdentity"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToIdentitiesAccountsBulkRequest -Json $IdentitiesAccountsBulkRequest
    Disable-V2026AccountsForIdentities -IdentitiesAccountsBulkRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Disable-V2026AccountsForIdentities -IdentitiesAccountsBulkRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Disable-V2026AccountsForIdentities"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAccountToggleRequest -Json $AccountToggleRequest
    Enable-V2026Account -Id $Id -AccountToggleRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Enable-V2026Account -Id $Id -AccountToggleRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Enable-V2026Account"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Enable-V2026AccountForIdentity -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Enable-V2026AccountForIdentity -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Enable-V2026AccountForIdentity"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToIdentitiesAccountsBulkRequest -Json $IdentitiesAccountsBulkRequest
    Enable-V2026AccountsForIdentities -IdentitiesAccountsBulkRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Enable-V2026AccountsForIdentities -IdentitiesAccountsBulkRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Enable-V2026AccountsForIdentities"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Account -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Account -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Account"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026AccountEntitlements -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AccountEntitlements -Id $Id -Limit $Limit -Offset $Offset -Count $Count  
} catch {
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Accounts -Limit $Limit -Offset $Offset -Count $Count -DetailLevel $DetailLevel -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Accounts"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAccountAttributes -Json $AccountAttributes
    Send-V2026Account -Id $Id -AccountAttributes $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026Account -Id $Id -AccountAttributes $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026Account"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Submit-V2026ReloadAccount -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Submit-V2026ReloadAccount -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Submit-V2026ReloadAccount"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAccountUnlockRequest -Json $AccountUnlockRequest
    Unlock-V2026Account -Id $Id -AccountUnlockRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Unlock-V2026Account -Id $Id -AccountUnlockRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Unlock-V2026Account"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026Account -Id $Id -RequestBody $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026Account -Id $Id -RequestBody $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026Account"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-BetaPendingApproval {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaPendingApproval' | Write-Debug
...
function ConvertFrom-BetaJsonToPendingApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaPendingApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

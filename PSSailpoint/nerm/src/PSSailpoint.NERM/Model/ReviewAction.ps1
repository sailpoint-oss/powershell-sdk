...
ReviewAction<PSCustomObject>
#>

function Initialize-NERMReviewAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMReviewAction' | Write-Debug
...
Convert from JSON to ReviewAction<PSCustomObject>
...
ReviewAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToReviewAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMReviewAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMReviewAction

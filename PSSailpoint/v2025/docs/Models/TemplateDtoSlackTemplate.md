...
keywords: ['powershell', 'PowerShell', 'sdk', 'TemplateDtoSlackTemplate', 'V2025TemplateDtoSlackTemplate'] 
slug: /tools/sdk/powershell/v2025/models/template-dto-slack-template
...
```powershell
$TemplateDtoSlackTemplate = Initialize-V2025TemplateDtoSlackTemplate  -Key null `

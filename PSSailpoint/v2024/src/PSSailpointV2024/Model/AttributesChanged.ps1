...
function Initialize-V2024AttributesChanged {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AttributesChanged' | Write-Debug
...
function ConvertFrom-V2024JsonToAttributesChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AttributesChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

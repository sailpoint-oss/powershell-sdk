...
function Initialize-BetaTransformRead {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTransformRead' | Write-Debug
...
function ConvertFrom-BetaJsonToTransformRead {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTransformRead' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

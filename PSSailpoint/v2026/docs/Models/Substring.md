...
keywords: ['powershell', 'PowerShell', 'sdk', 'Substring', 'V2026Substring'] 
slug: /tools/sdk/powershell/v2026/models/substring
tags: ['SDK', 'Software Development Kit', 'Substring', 'V2026Substring']
---
...
```powershell
$Substring = Initialize-V2026Substring  -VarBegin 1 `
 -BeginOffset 3 `
 -VarEnd 6 `
 -EndOffset 1 `

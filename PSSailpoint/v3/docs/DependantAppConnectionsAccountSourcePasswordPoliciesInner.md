...
```powershell
$DependantAppConnectionsAccountSourcePasswordPoliciesInner = Initialize-PSSailpointDependantAppConnectionsAccountSourcePasswordPoliciesInner  -Type PASSWORD_POLICY `

...
function Initialize-Entitlementref {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfilesV1 => Entitlementref' | Write-Debug
...
function ConvertFrom-JsonToEntitlementref {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfilesV1 => Entitlementref' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

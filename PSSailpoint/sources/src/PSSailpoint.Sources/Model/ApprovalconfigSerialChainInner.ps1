...
function Initialize-ApprovalconfigSerialChainInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => ApprovalconfigSerialChainInner' | Write-Debug
...
ApprovalconfigSerialChainInner<PSCustomObject>
#>
function ConvertFrom-JsonToApprovalconfigSerialChainInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => ApprovalconfigSerialChainInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApprovalconfigSerialChainInner

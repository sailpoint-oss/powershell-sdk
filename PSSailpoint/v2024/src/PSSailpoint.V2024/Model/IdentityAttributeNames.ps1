...
function Initialize-V2024IdentityAttributeNames {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityAttributeNames' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityAttributeNames {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityAttributeNames' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

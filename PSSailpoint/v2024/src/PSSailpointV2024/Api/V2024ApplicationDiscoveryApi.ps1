...
function Get-V2024DiscoveredApplications {
    ...
    Process {
        'Calling method: Get-V2024DiscoveredApplications' | Write-Debug
...
#>
function Get-V2024ManualDiscoverApplicationsCsvTemplate {
    [CmdletBinding()]
    Param (
        [String]
    ...
    Process {
        'Calling method: Get-V2024ManualDiscoverApplicationsCsvTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Send-V2024ManualDiscoverApplicationsCsvTemplate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.IO.FileInfo]
    ...
    Process {
        'Calling method: Send-V2024ManualDiscoverApplicationsCsvTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

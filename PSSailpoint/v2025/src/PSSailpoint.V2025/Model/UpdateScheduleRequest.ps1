...
function Initialize-V2025UpdateScheduleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025UpdateScheduleRequest' | Write-Debug
...
UpdateScheduleRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToUpdateScheduleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025UpdateScheduleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025UpdateScheduleRequest

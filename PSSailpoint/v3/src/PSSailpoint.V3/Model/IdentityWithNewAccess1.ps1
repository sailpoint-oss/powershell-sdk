...
function Initialize-IdentityWithNewAccess1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityWithNewAccess1' | Write-Debug
...
IdentityWithNewAccess1<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityWithNewAccess1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityWithNewAccess1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IdentityWithNewAccess1

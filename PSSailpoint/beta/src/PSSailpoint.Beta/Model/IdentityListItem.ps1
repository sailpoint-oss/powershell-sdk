...
function Initialize-BetaIdentityListItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityListItem' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityListItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityListItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

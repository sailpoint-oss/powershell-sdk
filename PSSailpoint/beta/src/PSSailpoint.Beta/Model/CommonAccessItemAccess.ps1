...
function Initialize-BetaCommonAccessItemAccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCommonAccessItemAccess' | Write-Debug
...
function ConvertFrom-BetaJsonToCommonAccessItemAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCommonAccessItemAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026TemplateDtoDefault {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TemplateDtoDefault' | Write-Debug
...
TemplateDtoDefault<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTemplateDtoDefault {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TemplateDtoDefault' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TemplateDtoDefault

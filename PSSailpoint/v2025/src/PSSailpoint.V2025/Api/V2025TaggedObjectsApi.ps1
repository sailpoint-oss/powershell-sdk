...
None
#>
function Remove-V2025TaggedObject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Remove-V2025TaggedObject' | Write-Debug
...
None
#>
function Remove-V2025TagsToManyObject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Remove-V2025TagsToManyObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject
#>
function Get-V2025TaggedObject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [ValidateSet("ACCESS_PROFILE", "APPLICATION", "CAMPAIGN", "ENTITLEMENT", "IDENTITY", "ROLE", "SOD_POLICY", "SOURCE")]
    ...
    Process {
        'Calling method: Get-V2025TaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject[]
#>
function Get-V2025TaggedObjects {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2025TaggedObjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject[]
#>
function Get-V2025TaggedObjectsByType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [ValidateSet("ACCESS_PROFILE", "APPLICATION", "CAMPAIGN", "ENTITLEMENT", "IDENTITY", "ROLE", "SOD_POLICY", "SOURCE")]
    ...
    Process {
        'Calling method: Get-V2025TaggedObjectsByType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject
#>
function Send-V2025TaggedObject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [ValidateSet("ACCESS_PROFILE", "APPLICATION", "CAMPAIGN", "ENTITLEMENT", "IDENTITY", "ROLE", "SOD_POLICY", "SOURCE")]
    ...
    Process {
        'Calling method: Send-V2025TaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Set-V2025TagToObject {
    ...
    Process {
        'Calling method: Set-V2025TagToObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Set-V2025TagsToManyObjects {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Set-V2025TagsToManyObjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Healthevent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClientsV1 => Healthevent' | Write-Debug
...
Healthevent<PSCustomObject>
#>
function ConvertFrom-JsonToHealthevent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClientsV1 => Healthevent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Healthevent

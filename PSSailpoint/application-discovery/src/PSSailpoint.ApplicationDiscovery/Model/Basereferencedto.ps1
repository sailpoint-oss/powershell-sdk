...
function Initialize-Basereferencedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApplicationDiscovery => Basereferencedto' | Write-Debug
...
function ConvertFrom-JsonToBasereferencedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApplicationDiscovery => Basereferencedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026SodPolicyConflictingAccessCriteria {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SodPolicyConflictingAccessCriteria' | Write-Debug
...
SodPolicyConflictingAccessCriteria<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSodPolicyConflictingAccessCriteria {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SodPolicyConflictingAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SodPolicyConflictingAccessCriteria

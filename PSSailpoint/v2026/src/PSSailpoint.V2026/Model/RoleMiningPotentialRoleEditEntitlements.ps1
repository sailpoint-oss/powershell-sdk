...
function Initialize-V2026RoleMiningPotentialRoleEditEntitlements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleEditEntitlements' | Write-Debug
...
RoleMiningPotentialRoleEditEntitlements<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMiningPotentialRoleEditEntitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleEditEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMiningPotentialRoleEditEntitlements

...
function Initialize-BetaCustomPasswordInstruction {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCustomPasswordInstruction' | Write-Debug
...
function ConvertFrom-BetaJsonToCustomPasswordInstruction {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCustomPasswordInstruction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

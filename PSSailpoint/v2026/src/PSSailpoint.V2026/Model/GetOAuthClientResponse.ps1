...
function Initialize-V2026GetOAuthClientResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026GetOAuthClientResponse' | Write-Debug
...
GetOAuthClientResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToGetOAuthClientResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026GetOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026GetOAuthClientResponse

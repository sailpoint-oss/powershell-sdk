...
None
#>
function Complete-V2025TriggerInvocation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Complete-V2025TriggerInvocation' | Write-Debug
...
Subscription
#>
function New-V2025Subscription {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: New-V2025Subscription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-V2025Subscription {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025Subscription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Subscription[]
#>
function Get-V2025Subscriptions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025Subscriptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
InvocationStatus[]
#>
function Get-V2025TriggerInvocationStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025TriggerInvocationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025Triggers {
    ...
    Process {
        'Calling method: Get-V2025Triggers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Subscription
#>
function Update-V2025Subscription {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025Subscription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Invocation[]
#>
function Start-V2025TestTriggerInvocation {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Start-V2025TestTriggerInvocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Test-V2025SubscriptionFilter {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Test-V2025SubscriptionFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

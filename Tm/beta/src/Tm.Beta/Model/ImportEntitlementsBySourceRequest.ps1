...
function Initialize-BetaImportEntitlementsBySourceRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaImportEntitlementsBySourceRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToImportEntitlementsBySourceRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaImportEntitlementsBySourceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

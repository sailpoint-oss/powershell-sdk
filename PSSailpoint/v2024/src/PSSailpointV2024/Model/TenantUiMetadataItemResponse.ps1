...
function Initialize-V2024TenantUiMetadataItemResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TenantUiMetadataItemResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToTenantUiMetadataItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TenantUiMetadataItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

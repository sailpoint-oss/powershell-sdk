...
function Initialize-ExpressionChildrenInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ExpressionChildrenInner' | Write-Debug
...
function ConvertFrom-JsonToExpressionChildrenInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ExpressionChildrenInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024IdentityCertDecisionSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityCertDecisionSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityCertDecisionSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityCertDecisionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

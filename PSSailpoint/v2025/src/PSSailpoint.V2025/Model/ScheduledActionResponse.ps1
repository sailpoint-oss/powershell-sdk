...
function Initialize-V2025ScheduledActionResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ScheduledActionResponse' | Write-Debug
...
ScheduledActionResponse<PSCustomObject>
#>
function ConvertFrom-V2025JsonToScheduledActionResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ScheduledActionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ScheduledActionResponse

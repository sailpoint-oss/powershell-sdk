...
function Initialize-Recommendercalculations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiRecommendationsV1 => Recommendercalculations' | Write-Debug
...
Recommendercalculations<PSCustomObject>
#>
function ConvertFrom-JsonToRecommendercalculations {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiRecommendationsV1 => Recommendercalculations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Recommendercalculations

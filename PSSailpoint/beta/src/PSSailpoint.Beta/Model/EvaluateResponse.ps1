...
function Initialize-BetaEvaluateResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaEvaluateResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToEvaluateResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaEvaluateResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Approvalrequestedtarget {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Approvals => Approvalrequestedtarget' | Write-Debug
...
function ConvertFrom-JsonToApprovalrequestedtarget {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Approvals => Approvalrequestedtarget' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

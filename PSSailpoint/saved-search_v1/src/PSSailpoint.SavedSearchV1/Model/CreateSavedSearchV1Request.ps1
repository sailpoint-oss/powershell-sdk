...
CreateSavedSearchV1Request<PSCustomObject>
#>

function Initialize-CreateSavedSearchV1Request {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SavedSearchV1 => CreateSavedSearchV1Request' | Write-Debug
...
Convert from JSON to CreateSavedSearchV1Request<PSCustomObject>
...
CreateSavedSearchV1Request<PSCustomObject>
#>
function ConvertFrom-JsonToCreateSavedSearchV1Request {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SavedSearchV1 => CreateSavedSearchV1Request' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateSavedSearchV1Request

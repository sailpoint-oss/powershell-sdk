...
function Initialize-BetaDiscoveredApplicationsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaDiscoveredApplicationsInner' | Write-Debug
...
DiscoveredApplicationsInner<PSCustomObject>
#>
function ConvertFrom-BetaJsonToDiscoveredApplicationsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaDiscoveredApplicationsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaDiscoveredApplicationsInner

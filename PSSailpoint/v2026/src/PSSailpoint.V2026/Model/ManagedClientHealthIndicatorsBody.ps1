...
function Initialize-V2026ManagedClientHealthIndicatorsBody {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ManagedClientHealthIndicatorsBody' | Write-Debug
...
ManagedClientHealthIndicatorsBody<PSCustomObject>
#>
function ConvertFrom-V2026JsonToManagedClientHealthIndicatorsBody {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ManagedClientHealthIndicatorsBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ManagedClientHealthIndicatorsBody

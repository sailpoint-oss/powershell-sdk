...
function Initialize-BetaGetOAuthClientResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaGetOAuthClientResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToGetOAuthClientResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaGetOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

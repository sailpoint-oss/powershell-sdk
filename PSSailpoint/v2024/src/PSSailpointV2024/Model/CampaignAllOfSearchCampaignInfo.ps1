...
function Initialize-V2024CampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignAllOfSearchCampaignInfo' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignAllOfSearchCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

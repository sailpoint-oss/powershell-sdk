...
function Initialize-V2026WorkflowExecutionEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026WorkflowExecutionEvent' | Write-Debug
...
WorkflowExecutionEvent<PSCustomObject>
#>
function ConvertFrom-V2026JsonToWorkflowExecutionEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026WorkflowExecutionEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026WorkflowExecutionEvent

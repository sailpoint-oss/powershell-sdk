...
function Initialize-V2026ObjectImportResult1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ObjectImportResult1' | Write-Debug
...
ObjectImportResult1<PSCustomObject>
#>
function ConvertFrom-V2026JsonToObjectImportResult1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ObjectImportResult1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ObjectImportResult1

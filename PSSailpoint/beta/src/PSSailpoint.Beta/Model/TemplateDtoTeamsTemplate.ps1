...
function Initialize-BetaTemplateDtoTeamsTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTemplateDtoTeamsTemplate' | Write-Debug
...
TemplateDtoTeamsTemplate<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTemplateDtoTeamsTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTemplateDtoTeamsTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTemplateDtoTeamsTemplate

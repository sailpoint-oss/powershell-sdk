...
function Initialize-Accessmodelmetadata {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfiles => Accessmodelmetadata' | Write-Debug
...
function ConvertFrom-JsonToAccessmodelmetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfiles => Accessmodelmetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-DependantAppConnections {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => DependantAppConnections' | Write-Debug
...
function ConvertFrom-JsonToDependantAppConnections {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => DependantAppConnections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

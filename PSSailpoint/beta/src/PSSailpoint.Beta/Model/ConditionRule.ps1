...
function Initialize-BetaConditionRule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConditionRule' | Write-Debug
...
function ConvertFrom-BetaJsonToConditionRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConditionRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
[**Update-V2025PotentialRole**](#patch-potential-role) | **PATCH** `/role-mining-potential-roles/{potentialRoleId}` | Update a potential role
[**Update-V2025PotentialRoleSession**](#patch-potential-role-session) | **PATCH** `/role-mining-sessions/{sessionId}/potential-role-summaries/{potentialRoleId}` | Update a potential role session

...
function Initialize-V2024AccessProfileUpdateItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileUpdateItem' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileUpdateItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileUpdateItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

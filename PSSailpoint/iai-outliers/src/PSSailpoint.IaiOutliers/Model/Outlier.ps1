...
function Initialize-Outlier {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiOutliersV1 => Outlier' | Write-Debug
...
Outlier<PSCustomObject>
#>
function ConvertFrom-JsonToOutlier {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiOutliersV1 => Outlier' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Outlier

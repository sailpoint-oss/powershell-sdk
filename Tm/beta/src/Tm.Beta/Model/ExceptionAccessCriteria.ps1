...
function Initialize-BetaExceptionAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaExceptionAccessCriteria' | Write-Debug
...
function ConvertFrom-BetaJsonToExceptionAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaExceptionAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

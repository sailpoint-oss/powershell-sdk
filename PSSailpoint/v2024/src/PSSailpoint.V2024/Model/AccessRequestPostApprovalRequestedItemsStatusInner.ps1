...
function Initialize-V2024AccessRequestPostApprovalRequestedItemsStatusInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
...
AccessRequestPostApprovalRequestedItemsStatusInner<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccessRequestPostApprovalRequestedItemsStatusInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AccessRequestPostApprovalRequestedItemsStatusInner

...
function Initialize-V2024FilterAggregation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024FilterAggregation' | Write-Debug
...
function ConvertFrom-V2024JsonToFilterAggregation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024FilterAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024VendorConnectorMappingDeletedAt {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024VendorConnectorMappingDeletedAt' | Write-Debug
...
VendorConnectorMappingDeletedAt<PSCustomObject>
#>
function ConvertFrom-V2024JsonToVendorConnectorMappingDeletedAt {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024VendorConnectorMappingDeletedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024VendorConnectorMappingDeletedAt

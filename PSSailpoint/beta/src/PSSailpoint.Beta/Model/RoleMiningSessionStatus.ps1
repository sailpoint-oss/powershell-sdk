...
function Initialize-BetaRoleMiningSessionStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningSessionStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

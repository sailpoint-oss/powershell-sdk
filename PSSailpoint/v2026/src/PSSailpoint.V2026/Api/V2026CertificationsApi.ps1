...
CertificationTask
#>
function Get-V2026CertificationTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2026CertificationTask' | Write-Debug
...
#>
function Get-V2026IdentityCertification {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentityCertification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PermissionDto[]
#>
function Get-V2026IdentityCertificationItemPermissions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentityCertificationItemPermissions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CertificationTask[]
#>
function Get-V2026PendingCertificationTasks {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026PendingCertificationTasks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026CertificationReviewers {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026CertificationReviewers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessReviewItem[]
#>
function Get-V2026IdentityAccessReviewItems {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentityAccessReviewItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityCertificationDto[]
#>
function Get-V2026IdentityCertifications {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentityCertifications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityCertificationDto
#>
function Select-V2026IdentityDecision {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Select-V2026IdentityDecision' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityCertificationDto
#>
function Invoke-V2026ReassignIdentityCertifications {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2026ReassignIdentityCertifications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityCertificationDto
#>
function Invoke-V2026SignOffIdentityCertification {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2026SignOffIdentityCertification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CertificationTask
#>
function Submit-V2026ReassignCertsAsync {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Submit-V2026ReassignCertsAsync' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
AuthProfileRequest<PSCustomObject>
#>

function Initialize-BetaAuthProfileRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAuthProfileRequest' | Write-Debug
...
Convert from JSON to AuthProfileRequest<PSCustomObject>
...
AuthProfileRequest<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAuthProfileRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAuthProfileRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaAuthProfileRequest

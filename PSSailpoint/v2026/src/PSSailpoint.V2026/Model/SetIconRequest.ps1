...
function Initialize-V2026SetIconRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SetIconRequest' | Write-Debug
...
SetIconRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSetIconRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SetIconRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SetIconRequest
        $AllProperties = ("image")

...
function Initialize-MultiHostIntegrationsCreateSources {
    [CmdletBinding()]
    Param (
...
MultiHostIntegrationsCreateSources<PSCustomObject>
#>
function ConvertFrom-JsonToMultiHostIntegrationsCreateSources {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in MultiHostIntegrationsCreateSources

...
function Initialize-V2024TransformRule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TransformRule' | Write-Debug
...
function ConvertFrom-V2024JsonToTransformRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TransformRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-PasswordInfoQueryDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => PasswordInfoQueryDTO' | Write-Debug
...
function ConvertFrom-JsonToPasswordInfoQueryDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => PasswordInfoQueryDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

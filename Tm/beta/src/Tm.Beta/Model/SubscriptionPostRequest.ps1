...
function Initialize-BetaSubscriptionPostRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSubscriptionPostRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToSubscriptionPostRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSubscriptionPostRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

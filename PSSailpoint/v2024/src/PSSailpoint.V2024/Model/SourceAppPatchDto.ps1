...
function Initialize-V2024SourceAppPatchDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SourceAppPatchDto' | Write-Debug
...
SourceAppPatchDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSourceAppPatchDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SourceAppPatchDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SourceAppPatchDto

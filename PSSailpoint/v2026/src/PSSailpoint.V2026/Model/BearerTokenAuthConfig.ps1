...
function Initialize-V2026BearerTokenAuthConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026BearerTokenAuthConfig' | Write-Debug
...
BearerTokenAuthConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToBearerTokenAuthConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026BearerTokenAuthConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026BearerTokenAuthConfig

...
function Initialize-SetLifecycleStateV1200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.LifecycleStatesV1 => SetLifecycleStateV1200Response' | Write-Debug
...
Convert from JSON to SetLifecycleStateV1200Response<PSCustomObject>
...
SetLifecycleStateV1200Response<PSCustomObject>
#>
function ConvertFrom-JsonToSetLifecycleStateV1200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.LifecycleStatesV1 => SetLifecycleStateV1200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SetLifecycleStateV1200Response

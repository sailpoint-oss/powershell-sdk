...
$Lookup = @"{  "Table": {"USA": "Americas", "FRA": "EMEA", "AUS": "APAC", "default":"Unknown Region"}, "RequiresPeriodicRefresh": false, "VarInput": {"type": "accountAttribute", "attributes":{"attributeName": "first_name", "sourceName": "Source}}" }}}"@
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToLookup -Json $Lookup
```

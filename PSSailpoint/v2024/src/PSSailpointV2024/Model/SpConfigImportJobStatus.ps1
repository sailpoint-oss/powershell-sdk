...
function Initialize-V2024SpConfigImportJobStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SpConfigImportJobStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigImportJobStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SpConfigImportJobStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

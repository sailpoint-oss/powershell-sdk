...
function Initialize-V2024IdentityProfileExportedObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityProfileExportedObject' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityProfileExportedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityProfileExportedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaSourceAccountCreated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceAccountCreated' | Write-Debug
...
SourceAccountCreated<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSourceAccountCreated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceAccountCreated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSourceAccountCreated

...
function Initialize-V2026PrivilegeCriteriaDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026PrivilegeCriteriaDTO' | Write-Debug
...
PrivilegeCriteriaDTO<PSCustomObject>
#>
function ConvertFrom-V2026JsonToPrivilegeCriteriaDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026PrivilegeCriteriaDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026PrivilegeCriteriaDTO

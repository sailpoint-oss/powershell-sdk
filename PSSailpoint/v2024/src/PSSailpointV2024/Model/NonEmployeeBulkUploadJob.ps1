...
function Initialize-V2024NonEmployeeBulkUploadJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeBulkUploadJob' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeBulkUploadJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeBulkUploadJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

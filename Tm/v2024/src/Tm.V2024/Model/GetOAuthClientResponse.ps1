...
function Initialize-V2024GetOAuthClientResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024GetOAuthClientResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToGetOAuthClientResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024GetOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaWorkflowLibraryFormFields {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaWorkflowLibraryFormFields' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowLibraryFormFields {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaWorkflowLibraryFormFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

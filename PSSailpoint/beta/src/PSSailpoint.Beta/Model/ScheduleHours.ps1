...
function Initialize-BetaScheduleHours {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaScheduleHours' | Write-Debug
...
ScheduleHours<PSCustomObject>
#>
function ConvertFrom-BetaJsonToScheduleHours {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaScheduleHours' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaScheduleHours

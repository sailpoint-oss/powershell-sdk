...
function Initialize-BetaIdentityAttributesChanged {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityAttributesChanged' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributesChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityAttributesChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

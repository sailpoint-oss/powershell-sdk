...
function Initialize-V2024ListFormDefinitionsByTenantResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ListFormDefinitionsByTenantResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToListFormDefinitionsByTenantResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ListFormDefinitionsByTenantResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

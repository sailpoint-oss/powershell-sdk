...
function Initialize-V2024ReviewableRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ReviewableRole' | Write-Debug
...
function ConvertFrom-V2024JsonToReviewableRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ReviewableRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026MfaConfigTestResponse {
    [CmdletBinding()]
    Param (
    )

    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MfaConfigTestResponse' | Write-Debug
...
MfaConfigTestResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMfaConfigTestResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MfaConfigTestResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MfaConfigTestResponse

...
function Initialize-BetaSourceAppAccountSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceAppAccountSource' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceAppAccountSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceAppAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

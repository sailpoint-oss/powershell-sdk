...
function Initialize-BetaSlimDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSlimDiscoveredApplications' | Write-Debug
...
function ConvertFrom-BetaJsonToSlimDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSlimDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

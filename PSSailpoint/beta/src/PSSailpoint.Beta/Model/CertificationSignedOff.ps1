...
function Initialize-BetaCertificationSignedOff {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCertificationSignedOff' | Write-Debug
...
CertificationSignedOff<PSCustomObject>
#>
function ConvertFrom-BetaJsonToCertificationSignedOff {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCertificationSignedOff' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaCertificationSignedOff

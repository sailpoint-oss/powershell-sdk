...
function Initialize-V2024SendTestNotificationRequestDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024SendTestNotificationRequestDto' | Write-Debug
...
function ConvertFrom-V2024JsonToSendTestNotificationRequestDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024SendTestNotificationRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

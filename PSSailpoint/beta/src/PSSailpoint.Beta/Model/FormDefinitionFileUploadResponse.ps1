...
function Initialize-BetaFormDefinitionFileUploadResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionFileUploadResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToFormDefinitionFileUploadResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionFileUploadResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaRoleMiningPotentialRoleExportResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleExportResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleExportResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleExportResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

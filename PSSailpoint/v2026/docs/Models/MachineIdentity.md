...
keywords: ['powershell', 'PowerShell', 'sdk', 'MachineIdentity', 'V2026MachineIdentity'] 
slug: /tools/sdk/powershell/v2026/models/machine-identity
...
```powershell
$MachineIdentity = Initialize-V2026MachineIdentity  -Id id12345 `
 -Name aName `

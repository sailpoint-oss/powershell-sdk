...
function Initialize-V2024QueuedCheckConfigDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024QueuedCheckConfigDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToQueuedCheckConfigDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024QueuedCheckConfigDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

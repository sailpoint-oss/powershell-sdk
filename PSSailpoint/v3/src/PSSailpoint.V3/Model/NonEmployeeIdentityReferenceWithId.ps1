...
function Initialize-NonEmployeeIdentityReferenceWithId {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeIdentityReferenceWithId' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeIdentityReferenceWithId {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeIdentityReferenceWithId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

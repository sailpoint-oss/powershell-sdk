...
function Initialize-V2024CertificationTask {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CertificationTask' | Write-Debug
...
function ConvertFrom-V2024JsonToCertificationTask {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CertificationTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-AccessProfileBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => AccessProfileBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-JsonToAccessProfileBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => AccessProfileBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

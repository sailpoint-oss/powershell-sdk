...
function Get-AccountAggregationStatusV1 {
    ...
    Process {
        'Calling method: Get-AccountAggregationStatusV1' | Write-Debug
        ...
        $LocalVarUri = '/account-aggregations/v1/{id}/status'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getAccountAggregationStatusV1."
        }

...
function Initialize-BetaNonEmployeeApprovalItemDetail {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalItemDetail' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeApprovalItemDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

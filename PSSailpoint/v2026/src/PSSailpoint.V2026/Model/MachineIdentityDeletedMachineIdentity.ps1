...
function Initialize-V2026MachineIdentityDeletedMachineIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityDeletedMachineIdentity' | Write-Debug
...
MachineIdentityDeletedMachineIdentity<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMachineIdentityDeletedMachineIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityDeletedMachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MachineIdentityDeletedMachineIdentity

...
function Initialize-V2025Role {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025Role' | Write-Debug
...
Role<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025Role' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025Role

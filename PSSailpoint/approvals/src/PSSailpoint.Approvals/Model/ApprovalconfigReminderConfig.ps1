...
function Initialize-ApprovalconfigReminderConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApprovalsV1 => ApprovalconfigReminderConfig' | Write-Debug
...
ApprovalconfigReminderConfig<PSCustomObject>
#>
function ConvertFrom-JsonToApprovalconfigReminderConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApprovalsV1 => ApprovalconfigReminderConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApprovalconfigReminderConfig

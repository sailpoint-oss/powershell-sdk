...
function Initialize-V2024RoleDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleDocument' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

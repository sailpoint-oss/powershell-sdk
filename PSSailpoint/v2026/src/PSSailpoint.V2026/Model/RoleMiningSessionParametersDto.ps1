...
function Initialize-V2026RoleMiningSessionParametersDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningSessionParametersDto' | Write-Debug
...
RoleMiningSessionParametersDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMiningSessionParametersDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningSessionParametersDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMiningSessionParametersDto

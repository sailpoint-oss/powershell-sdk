...
function Initialize-Formdefinitiondynamicschemarequest {
    [CmdletBinding()]
    Param (
...
Formdefinitiondynamicschemarequest<PSCustomObject>
#>
function ConvertFrom-JsonToFormdefinitiondynamicschemarequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Formdefinitiondynamicschemarequest

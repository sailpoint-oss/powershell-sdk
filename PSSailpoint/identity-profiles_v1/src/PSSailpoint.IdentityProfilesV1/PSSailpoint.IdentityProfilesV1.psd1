#
# Module manifest for module 'PSSailpoint.IdentityProfilesV1'
#
...
RootModule = 'PSSailpoint.IdentityProfilesV1.psm1'
...
Description = 'PSSailpoint.IdentityProfilesV1 - the PowerShell module for Identity Security Cloud API - Identity Profiles'

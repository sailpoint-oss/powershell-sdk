...
function Initialize-V2024PasswordDigitTokenReset {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024PasswordDigitTokenReset' | Write-Debug
...
function ConvertFrom-V2024JsonToPasswordDigitTokenReset {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024PasswordDigitTokenReset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

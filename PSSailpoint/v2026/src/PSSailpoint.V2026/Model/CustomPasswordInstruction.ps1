...
function Initialize-V2026CustomPasswordInstruction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CustomPasswordInstruction' | Write-Debug
...
CustomPasswordInstruction<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCustomPasswordInstruction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CustomPasswordInstruction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CustomPasswordInstruction

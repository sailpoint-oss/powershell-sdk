...
TestSourceConnectionMultihostV1200Response<PSCustomObject>
#>

function Initialize-TestSourceConnectionMultihostV1200Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to TestSourceConnectionMultihostV1200Response<PSCustomObject>
...
TestSourceConnectionMultihostV1200Response<PSCustomObject>
#>
function ConvertFrom-JsonToTestSourceConnectionMultihostV1200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in TestSourceConnectionMultihostV1200Response

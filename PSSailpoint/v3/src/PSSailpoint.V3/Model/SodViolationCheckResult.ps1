...
function Initialize-SodViolationCheckResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SodViolationCheckResult' | Write-Debug
...
function ConvertFrom-JsonToSodViolationCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SodViolationCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

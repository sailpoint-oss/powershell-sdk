...
function Initialize-AccountItemRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => AccountItemRef' | Write-Debug
...
function ConvertFrom-JsonToAccountItemRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => AccountItemRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Remove-V2026Identity {
    ...
    Process {
        'Calling method: Remove-V2026Identity' | Write-Debug
...
function Get-V2026Identity {
    ...
    Process {
        'Calling method: Get-V2026Identity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026IdentityOwnershipDetails {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentityOwnershipDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
RoleAssignmentDto
#>
function Get-V2026RoleAssignment {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026RoleAssignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026RoleAssignments {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026RoleAssignments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026EntitlementsByIdentity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026EntitlementsByIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026Identities {
    ...
    Process {
        'Calling method: Get-V2026Identities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Reset-V2026Identity {
    ...
    Process {
        'Calling method: Reset-V2026Identity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Send-V2026IdentityVerificationAccountToken {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2026IdentityVerificationAccountToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaskStatus
#>
function Start-V2026IdentitiesInvite {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Start-V2026IdentitiesInvite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaskResultResponse
#>
function Start-V2026IdentityProcessing {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Start-V2026IdentityProcessing' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentitySyncJob
#>
function Sync-V2026hronizeAttributesForIdentity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Sync-V2026hronizeAttributesForIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

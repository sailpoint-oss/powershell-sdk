...
function Initialize-V2026MultiHostIntegrations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrations' | Write-Debug
...
MultiHostIntegrations<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMultiHostIntegrations {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MultiHostIntegrations

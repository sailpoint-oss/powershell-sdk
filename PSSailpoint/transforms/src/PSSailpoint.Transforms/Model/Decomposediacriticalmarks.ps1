...
function Initialize-Decomposediacriticalmarks {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Decomposediacriticalmarks' | Write-Debug
...
function ConvertFrom-JsonToDecomposediacriticalmarks {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Decomposediacriticalmarks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

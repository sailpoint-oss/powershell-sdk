...
function Initialize-V2025ManualDiscoverApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ManualDiscoverApplications' | Write-Debug
...
ManualDiscoverApplications<PSCustomObject>
#>
function ConvertFrom-V2025JsonToManualDiscoverApplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ManualDiscoverApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ManualDiscoverApplications
        $AllProperties = ("file")

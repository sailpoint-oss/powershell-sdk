...
function Initialize-BetaContextAttributeDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaContextAttributeDto' | Write-Debug
...
function ConvertFrom-BetaJsonToContextAttributeDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaContextAttributeDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

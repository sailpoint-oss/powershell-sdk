...
function Initialize-Errormessagedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DataSegmentationV1 => Errormessagedto' | Write-Debug
...
function ConvertFrom-JsonToErrormessagedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DataSegmentationV1 => Errormessagedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'NonEmployeeApprovalSummary', 'V2026NonEmployeeApprovalSummary'] 
slug: /tools/sdk/powershell/v2026/models/non-employee-approval-summary
...
```powershell
$NonEmployeeApprovalSummary = Initialize-V2026NonEmployeeApprovalSummary  -Approved 2 `
 -Pending 2 `
 -Rejected 2
```

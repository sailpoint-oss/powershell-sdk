...
function Initialize-V2024EntitlementApprovalScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024EntitlementApprovalScheme' | Write-Debug
...
EntitlementApprovalScheme<PSCustomObject>
#>
function ConvertFrom-V2024JsonToEntitlementApprovalScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024EntitlementApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024EntitlementApprovalScheme

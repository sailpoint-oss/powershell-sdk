...
function Initialize-V2024EmailNotificationOption {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024EmailNotificationOption' | Write-Debug
...
EmailNotificationOption<PSCustomObject>
#>
function ConvertFrom-V2024JsonToEmailNotificationOption {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024EmailNotificationOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024EmailNotificationOption

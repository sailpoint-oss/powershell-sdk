...
function Initialize-VendorConnectorMappingDeletedAt {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => VendorConnectorMappingDeletedAt' | Write-Debug
...
function ConvertFrom-JsonToVendorConnectorMappingDeletedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => VendorConnectorMappingDeletedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

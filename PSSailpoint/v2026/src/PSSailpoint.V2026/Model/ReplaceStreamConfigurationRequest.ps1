...
function Initialize-V2026ReplaceStreamConfigurationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ReplaceStreamConfigurationRequest' | Write-Debug
...
ReplaceStreamConfigurationRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToReplaceStreamConfigurationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ReplaceStreamConfigurationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ReplaceStreamConfigurationRequest

...
function Initialize-V2025ResourceObject {
    [CmdletBinding()]
    Param (
    )

    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ResourceObject' | Write-Debug
...
ResourceObject<PSCustomObject>
#>
function ConvertFrom-V2025JsonToResourceObject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ResourceObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ResourceObject

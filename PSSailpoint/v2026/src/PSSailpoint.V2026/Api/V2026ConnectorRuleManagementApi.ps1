...
#>
function New-V2026ConnectorRule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026ConnectorRule' | Write-Debug
...
None
#>
function Remove-V2026ConnectorRule {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026ConnectorRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConnectorRuleResponse
#>
function Get-V2026ConnectorRule {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ConnectorRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConnectorRuleResponse[]
#>
function Get-V2026ConnectorRuleList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026ConnectorRuleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConnectorRuleResponse
#>
function Send-V2026ConnectorRule {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2026ConnectorRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Test-V2026ConnectorRule {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Test-V2026ConnectorRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

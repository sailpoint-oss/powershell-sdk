...
function Initialize-Nonemployeerequestlite {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagementV1 => Nonemployeerequestlite' | Write-Debug
...
function ConvertFrom-JsonToNonemployeerequestlite {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagementV1 => Nonemployeerequestlite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaCertificationSignedOffCertification {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCertificationSignedOffCertification' | Write-Debug
...
function ConvertFrom-BetaJsonToCertificationSignedOffCertification {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCertificationSignedOffCertification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

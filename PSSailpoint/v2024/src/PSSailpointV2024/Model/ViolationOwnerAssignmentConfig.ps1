...
function Initialize-V2024ViolationOwnerAssignmentConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ViolationOwnerAssignmentConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToViolationOwnerAssignmentConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ViolationOwnerAssignmentConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

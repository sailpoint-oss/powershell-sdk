...
function Initialize-V2024RoleAssignmentRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleAssignmentRef' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleAssignmentRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleAssignmentRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
ListMachineIdentitiesV1401Response<PSCustomObject>
#>

function Initialize-ListMachineIdentitiesV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListMachineIdentitiesV1401Response<PSCustomObject>
...
ListMachineIdentitiesV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToListMachineIdentitiesV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListMachineIdentitiesV1401Response
        $AllProperties = ("error")

...
function Initialize-ErrorMessageDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Certifications => ErrorMessageDto' | Write-Debug
...
function ConvertFrom-JsonToErrorMessageDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Certifications => ErrorMessageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

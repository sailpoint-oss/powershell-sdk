...
function Initialize-V2024OutlierFeatureSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024OutlierFeatureSummary' | Write-Debug
...
OutlierFeatureSummary<PSCustomObject>
#>
function ConvertFrom-V2024JsonToOutlierFeatureSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024OutlierFeatureSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024OutlierFeatureSummary

...
TriggerInputSourceAccountCreated<PSCustomObject>
#>

function Initialize-BetaTriggerInputSourceAccountCreated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceAccountCreated' | Write-Debug
...
Convert from JSON to TriggerInputSourceAccountCreated<PSCustomObject>
...
TriggerInputSourceAccountCreated<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputSourceAccountCreated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceAccountCreated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputSourceAccountCreated

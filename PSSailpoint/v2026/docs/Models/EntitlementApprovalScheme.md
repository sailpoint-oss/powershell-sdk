...
keywords: ['powershell', 'PowerShell', 'sdk', 'EntitlementApprovalScheme', 'V2026EntitlementApprovalScheme'] 
slug: /tools/sdk/powershell/v2026/models/entitlement-approval-scheme
...
```powershell
$EntitlementApprovalScheme = Initialize-V2026EntitlementApprovalScheme  -ApproverType GOVERNANCE_GROUP `

...
function Initialize-V2024SearchSchedule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SearchSchedule' | Write-Debug
...
function ConvertFrom-V2024JsonToSearchSchedule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SearchSchedule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

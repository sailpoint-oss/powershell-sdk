...
function Initialize-ModelError {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CustomFormsV1 => ModelError' | Write-Debug
...
function ConvertFrom-JsonToModelError {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CustomFormsV1 => ModelError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

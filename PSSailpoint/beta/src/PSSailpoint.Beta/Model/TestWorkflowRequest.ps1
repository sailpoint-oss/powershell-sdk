...
function Initialize-BetaTestWorkflowRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTestWorkflowRequest' | Write-Debug
...
TestWorkflowRequest<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTestWorkflowRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTestWorkflowRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTestWorkflowRequest
        $AllProperties = ("input")

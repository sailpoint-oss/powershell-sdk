...
function Initialize-DependantAppConnectionsAccountSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => DependantAppConnectionsAccountSource' | Write-Debug
...
function ConvertFrom-JsonToDependantAppConnectionsAccountSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => DependantAppConnectionsAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

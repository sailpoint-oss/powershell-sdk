...
function Initialize-V2024EntitlementApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024EntitlementApprovalScheme' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlementApprovalScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024EntitlementApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

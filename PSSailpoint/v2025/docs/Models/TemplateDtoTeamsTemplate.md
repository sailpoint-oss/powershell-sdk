...
keywords: ['powershell', 'PowerShell', 'sdk', 'TemplateDtoTeamsTemplate', 'V2025TemplateDtoTeamsTemplate'] 
slug: /tools/sdk/powershell/v2025/models/template-dto-teams-template
...
```powershell
$TemplateDtoTeamsTemplate = Initialize-V2025TemplateDtoTeamsTemplate  -Key null `
 -Title null `

...
function Initialize-Sourceappcreatedto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AppsV1 => Sourceappcreatedto' | Write-Debug
...
Sourceappcreatedto<PSCustomObject>
#>
function ConvertFrom-JsonToSourceappcreatedto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AppsV1 => Sourceappcreatedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Sourceappcreatedto

...
function Initialize-BetaTestWorkflowRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTestWorkflowRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToTestWorkflowRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTestWorkflowRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

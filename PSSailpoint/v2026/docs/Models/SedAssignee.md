...
keywords: ['powershell', 'PowerShell', 'sdk', 'SedAssignee', 'V2026SedAssignee'] 
slug: /tools/sdk/powershell/v2026/models/sed-assignee
...
```powershell
$SedAssignee = Initialize-V2026SedAssignee  -Type SOURCE_OWNER `

...
function Initialize-AccessItemAssociated {
    [CmdletBinding()]
    Param (
...
AccessItemAssociated<PSCustomObject>
#>
function ConvertFrom-JsonToAccessItemAssociated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccessItemAssociated

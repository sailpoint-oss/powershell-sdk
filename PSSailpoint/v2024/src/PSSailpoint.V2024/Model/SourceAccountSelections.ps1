...
SourceAccountSelections<PSCustomObject>
#>

function Initialize-V2024SourceAccountSelections {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SourceAccountSelections' | Write-Debug
...
Convert from JSON to SourceAccountSelections<PSCustomObject>
...
SourceAccountSelections<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSourceAccountSelections {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SourceAccountSelections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SourceAccountSelections
        $AllProperties = ("type", "id", "name", "accounts")

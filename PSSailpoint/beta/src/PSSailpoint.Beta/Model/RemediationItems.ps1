...
function Initialize-BetaRemediationItems {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRemediationItems' | Write-Debug
...
function ConvertFrom-BetaJsonToRemediationItems {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRemediationItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

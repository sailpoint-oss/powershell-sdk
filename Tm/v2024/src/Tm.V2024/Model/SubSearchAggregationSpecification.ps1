...
function Initialize-V2024SubSearchAggregationSpecification {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024SubSearchAggregationSpecification' | Write-Debug
...
function ConvertFrom-V2024JsonToSubSearchAggregationSpecification {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024SubSearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

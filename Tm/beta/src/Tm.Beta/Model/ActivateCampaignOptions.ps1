...
function Initialize-BetaActivateCampaignOptions {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaActivateCampaignOptions' | Write-Debug
...
function ConvertFrom-BetaJsonToActivateCampaignOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaActivateCampaignOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

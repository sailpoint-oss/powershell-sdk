...
function Initialize-V2024SavedSearchDetailFilters {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SavedSearchDetailFilters' | Write-Debug
...
function ConvertFrom-V2024JsonToSavedSearchDetailFilters {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SavedSearchDetailFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

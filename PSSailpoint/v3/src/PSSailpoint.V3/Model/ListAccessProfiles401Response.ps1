...
function Initialize-ListAccessProfiles401Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ListAccessProfiles401Response' | Write-Debug
...
function ConvertFrom-JsonToListAccessProfiles401Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ListAccessProfiles401Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

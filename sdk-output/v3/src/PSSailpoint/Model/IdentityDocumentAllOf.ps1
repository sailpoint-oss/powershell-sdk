...
IdentityDocumentAllOf<PSCustomObject>
#>

function Initialize-IdentityDocumentAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => IdentityDocumentAllOf' | Write-Debug
...
Convert from JSON to IdentityDocumentAllOf<PSCustomObject>
...
IdentityDocumentAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityDocumentAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )

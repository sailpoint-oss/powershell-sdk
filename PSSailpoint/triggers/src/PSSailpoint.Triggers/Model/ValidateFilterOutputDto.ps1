...
function Initialize-ValidateFilterOutputDto {
    [CmdletBinding()]
    Param (
...
ValidateFilterOutputDto<PSCustomObject>
#>
function ConvertFrom-JsonToValidateFilterOutputDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ValidateFilterOutputDto

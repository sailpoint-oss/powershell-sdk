...
function Initialize-AccessRequestItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => AccessRequestItem' | Write-Debug
...
function ConvertFrom-JsonToAccessRequestItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => AccessRequestItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

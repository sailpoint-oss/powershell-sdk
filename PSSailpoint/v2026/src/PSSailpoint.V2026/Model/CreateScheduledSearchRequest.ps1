...
function Initialize-V2026CreateScheduledSearchRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CreateScheduledSearchRequest' | Write-Debug
...
CreateScheduledSearchRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCreateScheduledSearchRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CreateScheduledSearchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CreateScheduledSearchRequest

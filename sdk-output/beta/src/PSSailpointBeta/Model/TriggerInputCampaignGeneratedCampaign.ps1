...
TriggerInputCampaignGeneratedCampaign<PSCustomObject>
#>

function Initialize-BetaTriggerInputCampaignGeneratedCampaign {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputCampaignGeneratedCampaign' | Write-Debug
...
Convert from JSON to TriggerInputCampaignGeneratedCampaign<PSCustomObject>
...
TriggerInputCampaignGeneratedCampaign<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputCampaignGeneratedCampaign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputCampaignGeneratedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputCampaignGeneratedCampaign

...
function Initialize-V2024Sed {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Sed' | Write-Debug
...
Sed<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSed {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Sed' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024Sed

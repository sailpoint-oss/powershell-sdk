...
function Initialize-SubSearchAggregationSpecification {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => SubSearchAggregationSpecification' | Write-Debug
...
function ConvertFrom-JsonToSubSearchAggregationSpecification {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => SubSearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026ClusterManualUpgradeJobsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInner' | Write-Debug
...
ClusterManualUpgradeJobsInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToClusterManualUpgradeJobsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ClusterManualUpgradeJobsInner

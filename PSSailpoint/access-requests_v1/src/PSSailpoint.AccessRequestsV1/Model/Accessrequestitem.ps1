...
function Initialize-Accessrequestitem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestsV1 => Accessrequestitem' | Write-Debug
...
function ConvertFrom-JsonToAccessrequestitem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestsV1 => Accessrequestitem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function New-SendToken {
    ...
    Process {
        'Calling method: New-SendToken' | Write-Debug
...
#>
function Ping-VerificationStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Ping-VerificationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
VerificationResponse
#>
function Send-DuoVerifyRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Send-DuoVerifyRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Send-KbaAnswers {
    ...
    Process {
        'Calling method: Send-KbaAnswers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
VerificationResponse
#>
function Send-OktaVerifyRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Send-OktaVerifyRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TokenAuthResponse
#>
function Send-TokenAuthRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Send-TokenAuthRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

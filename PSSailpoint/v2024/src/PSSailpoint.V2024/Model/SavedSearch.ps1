...
function Initialize-V2024SavedSearch {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SavedSearch' | Write-Debug
...
function ConvertFrom-V2024JsonToSavedSearch {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

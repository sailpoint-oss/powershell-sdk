...
function Initialize-Managedclustertype {
    [CmdletBinding()]
    Param (
...
Managedclustertype<PSCustomObject>
#>
function ConvertFrom-JsonToManagedclustertype {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Managedclustertype

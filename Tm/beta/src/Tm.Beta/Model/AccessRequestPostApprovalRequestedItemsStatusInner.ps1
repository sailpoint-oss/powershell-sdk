...
function Initialize-BetaAccessRequestPostApprovalRequestedItemsStatusInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPostApprovalRequestedItemsStatusInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

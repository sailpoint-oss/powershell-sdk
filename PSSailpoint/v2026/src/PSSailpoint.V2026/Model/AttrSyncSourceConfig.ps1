...
function Initialize-V2026AttrSyncSourceConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AttrSyncSourceConfig' | Write-Debug
...
AttrSyncSourceConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAttrSyncSourceConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AttrSyncSourceConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AttrSyncSourceConfig

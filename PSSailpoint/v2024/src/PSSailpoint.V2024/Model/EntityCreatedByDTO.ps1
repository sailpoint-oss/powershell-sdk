...
function Initialize-V2024EntityCreatedByDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024EntityCreatedByDTO' | Write-Debug
...
function ConvertFrom-V2024JsonToEntityCreatedByDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024EntityCreatedByDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

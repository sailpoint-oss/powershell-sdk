...
function Initialize-V2024CancelledRequestDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CancelledRequestDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToCancelledRequestDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CancelledRequestDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

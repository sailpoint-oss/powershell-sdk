...
keywords: ['powershell', 'PowerShell', 'sdk', 'ExportPayload', 'V2026ExportPayload'] 
slug: /tools/sdk/powershell/v2026/models/export-payload
...
```powershell
$ExportPayload = Initialize-V2026ExportPayload  -Description Export Job 1 Test `
 -ExcludeTypes null `
 -IncludeTypes null `

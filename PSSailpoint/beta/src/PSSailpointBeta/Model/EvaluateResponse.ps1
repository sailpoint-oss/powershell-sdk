...
function Initialize-BetaEvaluateResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaEvaluateResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToEvaluateResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaEvaluateResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

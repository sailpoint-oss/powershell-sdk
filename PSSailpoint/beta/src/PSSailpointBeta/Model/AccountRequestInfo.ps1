...
function Initialize-BetaAccountRequestInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccountRequestInfo' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountRequestInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccountRequestInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

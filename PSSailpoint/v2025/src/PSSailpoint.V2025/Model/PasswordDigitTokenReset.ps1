...
function Initialize-V2025PasswordDigitTokenReset {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025PasswordDigitTokenReset' | Write-Debug
...
PasswordDigitTokenReset<PSCustomObject>
#>
function ConvertFrom-V2025JsonToPasswordDigitTokenReset {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025PasswordDigitTokenReset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025PasswordDigitTokenReset

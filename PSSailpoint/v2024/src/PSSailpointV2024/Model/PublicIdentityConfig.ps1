...
function Initialize-V2024PublicIdentityConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PublicIdentityConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToPublicIdentityConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PublicIdentityConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
Describe -tag 'PSSailpoint.V3' -name 'CertificationCampaignsApi' {
    ...
    Context 'Remove-CampaignTemplate' {
        It 'Test Remove-CampaignTemplate' {
            #$TestResult = Remove-CampaignTemplate -Id "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Remove-CampaignTemplateSchedule' {
        It 'Test Remove-CampaignTemplateSchedule' {
            #$TestResult = Remove-CampaignTemplateSchedule -Id "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Get-CampaignTemplateSchedule' {
        It 'Test Get-CampaignTemplateSchedule' {
            #$TestResult = Get-CampaignTemplateSchedule -Id "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

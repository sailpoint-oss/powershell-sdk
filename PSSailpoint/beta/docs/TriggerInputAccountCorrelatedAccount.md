...
```powershell
$TriggerInputAccountCorrelatedAccount = Initialize-PSSailpointBetaTriggerInputAccountCorrelatedAccount  -Type ACCOUNT `
...
```powershell
$TriggerInputAccountCorrelatedAccount | ConvertTo-JSON
```

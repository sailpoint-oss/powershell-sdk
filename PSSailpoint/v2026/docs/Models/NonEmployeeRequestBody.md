...
keywords: ['powershell', 'PowerShell', 'sdk', 'NonEmployeeRequestBody', 'V2026NonEmployeeRequestBody'] 
slug: /tools/sdk/powershell/v2026/models/non-employee-request-body
...
```powershell
$NonEmployeeRequestBody = Initialize-V2026NonEmployeeRequestBody  -AccountName william.smith `
 -FirstName William `
 -LastName Smith `

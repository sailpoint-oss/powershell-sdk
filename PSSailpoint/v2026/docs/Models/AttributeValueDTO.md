...
keywords: ['powershell', 'PowerShell', 'sdk', 'AttributeValueDTO', 'V2026AttributeValueDTO'] 
slug: /tools/sdk/powershell/v2026/models/attribute-value-dto
...
```powershell
$AttributeValueDTO = Initialize-V2026AttributeValueDTO  -Value public `
 -Name Public `
 -Status active
```

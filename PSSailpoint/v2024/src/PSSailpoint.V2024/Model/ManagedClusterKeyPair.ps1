...
function Initialize-V2024ManagedClusterKeyPair {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManagedClusterKeyPair' | Write-Debug
...
function ConvertFrom-V2024JsonToManagedClusterKeyPair {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManagedClusterKeyPair' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccessProfileBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessProfileBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessProfileBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
ExportSpConfigV1401Response<PSCustomObject>
#>

function Initialize-ExportSpConfigV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ExportSpConfigV1401Response<PSCustomObject>
...
ExportSpConfigV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToExportSpConfigV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ExportSpConfigV1401Response
        $AllProperties = ("error")

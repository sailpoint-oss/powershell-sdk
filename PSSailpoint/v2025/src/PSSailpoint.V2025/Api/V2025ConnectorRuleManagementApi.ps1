...
#>
function New-V2025ConnectorRule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025ConnectorRule' | Write-Debug
...
None
#>
function Remove-V2025ConnectorRule {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025ConnectorRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConnectorRuleResponse
#>
function Get-V2025ConnectorRule {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ConnectorRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConnectorRuleResponse[]
#>
function Get-V2025ConnectorRuleList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ConnectorRuleList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConnectorRuleResponse
#>
function Send-V2025ConnectorRule {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025ConnectorRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Test-V2025ConnectorRule {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Test-V2025ConnectorRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

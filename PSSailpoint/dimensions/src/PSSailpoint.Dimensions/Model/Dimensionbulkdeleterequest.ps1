...
function Initialize-Dimensionbulkdeleterequest {
    [CmdletBinding()]
    Param (
...
Dimensionbulkdeleterequest<PSCustomObject>
#>
function ConvertFrom-JsonToDimensionbulkdeleterequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Dimensionbulkdeleterequest

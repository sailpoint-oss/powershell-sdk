...
function Initialize-BetaWorkflowDefinition {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaWorkflowDefinition' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowDefinition {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaWorkflowDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

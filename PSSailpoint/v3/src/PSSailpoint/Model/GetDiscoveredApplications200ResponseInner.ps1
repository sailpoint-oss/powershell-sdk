...
#>
function ConvertFrom-JsonToGetDiscoveredApplications200ResponseInner {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            $matchInstance = ConvertFrom-JsonToFullDiscoveredApplicationsInner[] $Json
            ...
            Write-Debug "Failed to match 'FullDiscoveredApplicationsInner[]' defined in oneOf (GetDiscoveredApplications200ResponseInner). Proceeding to the next one if any."
        }

        # try to match SlimDiscoveredApplicationsInner[] defined in the oneOf schemas
        try {
            $matchInstance = ConvertFrom-JsonToSlimDiscoveredApplicationsInner[] $Json
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'SlimDiscoveredApplicationsInner[]' defined in oneOf (GetDiscoveredApplications200ResponseInner). Proceeding to the next one if any."
        }

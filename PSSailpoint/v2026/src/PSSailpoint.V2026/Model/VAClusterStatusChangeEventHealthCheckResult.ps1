...
function Initialize-V2026VAClusterStatusChangeEventHealthCheckResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026VAClusterStatusChangeEventHealthCheckResult' | Write-Debug
...
VAClusterStatusChangeEventHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-V2026JsonToVAClusterStatusChangeEventHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026VAClusterStatusChangeEventHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026VAClusterStatusChangeEventHealthCheckResult

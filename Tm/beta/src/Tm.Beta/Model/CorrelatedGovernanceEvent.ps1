...
function Initialize-BetaCorrelatedGovernanceEvent {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCorrelatedGovernanceEvent' | Write-Debug
...
function ConvertFrom-BetaJsonToCorrelatedGovernanceEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCorrelatedGovernanceEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

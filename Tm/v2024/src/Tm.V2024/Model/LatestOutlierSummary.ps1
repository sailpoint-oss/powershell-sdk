...
function Initialize-V2024LatestOutlierSummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024LatestOutlierSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToLatestOutlierSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024LatestOutlierSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

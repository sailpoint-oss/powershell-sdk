...
function Initialize-V2024OutliersContributingFeatureAccessItems {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024OutliersContributingFeatureAccessItems' | Write-Debug
...
function ConvertFrom-V2024JsonToOutliersContributingFeatureAccessItems {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024OutliersContributingFeatureAccessItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

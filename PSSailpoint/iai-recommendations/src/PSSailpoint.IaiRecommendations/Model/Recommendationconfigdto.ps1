...
function Initialize-Recommendationconfigdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        ...
        if ($PeerGroupPercentageThreshold -and $PeerGroupPercentageThreshold -gt 1) {
          throw "invalid value for 'PeerGroupPercentageThreshold', must be smaller than or equal to 1."
        }

        if ($PeerGroupPercentageThreshold -and $PeerGroupPercentageThreshold -lt 0) {
          throw "invalid value for 'PeerGroupPercentageThreshold', must be greater than or equal to 0."
        }
...
Recommendationconfigdto<PSCustomObject>
#>
function ConvertFrom-JsonToRecommendationconfigdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Recommendationconfigdto

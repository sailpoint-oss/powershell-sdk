...
function Initialize-V2026ClientLogConfigurationDurationMinutes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ClientLogConfigurationDurationMinutes' | Write-Debug
...
ClientLogConfigurationDurationMinutes<PSCustomObject>
#>
function ConvertFrom-V2026JsonToClientLogConfigurationDurationMinutes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ClientLogConfigurationDurationMinutes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ClientLogConfigurationDurationMinutes

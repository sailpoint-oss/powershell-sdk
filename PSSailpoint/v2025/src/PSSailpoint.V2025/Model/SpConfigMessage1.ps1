...
function Initialize-V2025SpConfigMessage1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SpConfigMessage1' | Write-Debug
...
SpConfigMessage1<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSpConfigMessage1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SpConfigMessage1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SpConfigMessage1

...
function Initialize-Listforminstancesbytenantresponse {
    [CmdletBinding()]
    Param (
...
Listforminstancesbytenantresponse<PSCustomObject>
#>
function ConvertFrom-JsonToListforminstancesbytenantresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Listforminstancesbytenantresponse

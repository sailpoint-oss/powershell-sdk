...
Machineclassificationcriterialevel3<PSCustomObject>
#>

function Initialize-Machineclassificationcriterialevel3 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineClassificationConfigV1 => Machineclassificationcriterialevel3' | Write-Debug
...
Convert from JSON to Machineclassificationcriterialevel3<PSCustomObject>
...
Machineclassificationcriterialevel3<PSCustomObject>
#>
function ConvertFrom-JsonToMachineclassificationcriterialevel3 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineClassificationConfigV1 => Machineclassificationcriterialevel3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Machineclassificationcriterialevel3

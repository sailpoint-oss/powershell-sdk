...
function Initialize-AppaccountdetailsSourceAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AppsV1 => AppaccountdetailsSourceAccount' | Write-Debug
...
AppaccountdetailsSourceAccount<PSCustomObject>
#>
function ConvertFrom-JsonToAppaccountdetailsSourceAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AppsV1 => AppaccountdetailsSourceAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AppaccountdetailsSourceAccount

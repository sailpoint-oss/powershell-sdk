...
function Initialize-BetaAccountAction {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAction' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAction {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026RequestOnBehalfOfConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RequestOnBehalfOfConfig' | Write-Debug
...
RequestOnBehalfOfConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRequestOnBehalfOfConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RequestOnBehalfOfConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RequestOnBehalfOfConfig

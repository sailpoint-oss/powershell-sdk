...
function Initialize-JsonPatchOperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.GlobalTenantSecuritySettings => JsonPatchOperation' | Write-Debug
...
function ConvertFrom-JsonToJsonPatchOperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.GlobalTenantSecuritySettings => JsonPatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

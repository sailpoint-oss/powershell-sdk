...
#>
function ConvertFrom-V2025JsonToWorkflowLibraryActionExampleOutput {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'SystemCollectionsHashtable' defined in oneOf (V2025WorkflowLibraryActionExampleOutput). Proceeding to the next one if any."
        }

...
keywords: ['powershell', 'PowerShell', 'sdk', 'RequestedItemDtoRef', 'V2026RequestedItemDtoRef'] 
slug: /tools/sdk/powershell/v2026/models/requested-item-dto-ref
...
```powershell
$RequestedItemDtoRef = Initialize-V2026RequestedItemDtoRef  -Type ACCESS_PROFILE `

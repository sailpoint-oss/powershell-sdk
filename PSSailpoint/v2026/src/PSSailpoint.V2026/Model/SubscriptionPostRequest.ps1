...
function Initialize-V2026SubscriptionPostRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SubscriptionPostRequest' | Write-Debug
...
SubscriptionPostRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSubscriptionPostRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SubscriptionPostRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SubscriptionPostRequest

...
function Initialize-ViolationContextPolicy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ViolationContextPolicy' | Write-Debug
...
function ConvertFrom-JsonToViolationContextPolicy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ViolationContextPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

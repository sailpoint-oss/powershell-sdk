...
#>
function ConvertFrom-V2026JsonToGetCampaign200Response {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                Write-Debug "Failed to match 'Campaign' defined in anyOf (V2026GetCampaign200Response). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'SlimCampaign' defined in anyOf (V2026GetCampaign200Response). Proceeding to the next one if any."
            }
        }

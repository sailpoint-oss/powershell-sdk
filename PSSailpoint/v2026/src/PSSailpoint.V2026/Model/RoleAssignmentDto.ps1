...
function Initialize-V2026RoleAssignmentDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleAssignmentDto' | Write-Debug
...
RoleAssignmentDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleAssignmentDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleAssignmentDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Accountactionrequestdto {
    [CmdletBinding()]
    Param (
...
Accountactionrequestdto<PSCustomObject>
#>
function ConvertFrom-JsonToAccountactionrequestdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Accountactionrequestdto

...
keywords: ['powershell', 'PowerShell', 'sdk', 'TaggedObjectDto', 'V2026TaggedObjectDto'] 
slug: /tools/sdk/powershell/v2026/models/tagged-object-dto
...
```powershell
$TaggedObjectDto = Initialize-V2026TaggedObjectDto  -Type IDENTITY `

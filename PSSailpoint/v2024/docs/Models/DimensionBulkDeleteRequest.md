...
$DimensionBulkDeleteRequest = @"{  "DimensionIds": ["2c9180847812e0b1017817051919ecca", "2c9180887812e0b201781e129f151816"] }"@
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToDimensionBulkDeleteRequest -Json $DimensionBulkDeleteRequest
```

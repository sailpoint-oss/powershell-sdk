...
function Initialize-BetaIdentityCreated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityCreated' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityCreated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityCreated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ViolationContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ViolationContext' | Write-Debug
...
function ConvertFrom-V2024JsonToViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

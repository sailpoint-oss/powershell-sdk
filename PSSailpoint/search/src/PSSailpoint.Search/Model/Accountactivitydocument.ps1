...
function Initialize-Accountactivitydocument {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => Accountactivitydocument' | Write-Debug
...
Accountactivitydocument<PSCustomObject>
#>
function ConvertFrom-JsonToAccountactivitydocument {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => Accountactivitydocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

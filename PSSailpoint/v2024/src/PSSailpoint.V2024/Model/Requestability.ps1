...
function Initialize-V2024Requestability {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Requestability' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestability {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Requestability' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

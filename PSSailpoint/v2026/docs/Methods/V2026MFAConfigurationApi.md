...
keywords: ['powershell', 'PowerShell', 'sdk', 'MFAConfiguration', 'V2026MFAConfiguration'] 
slug: /tools/sdk/powershell/v2026/methods/mfa-configuration
...
------------- | ------------- | -------------
[**Get-V2026MFADuoConfig**](#get-mfa-duo-config) | **GET** `/mfa/duo-web/config` | Configuration of duo mfa method
[**Get-V2026MFAKbaConfig**](#get-mfa-kba-config) | **GET** `/mfa/kba/config` | Configuration of kba mfa method
[**Get-V2026MFAOktaConfig**](#get-mfa-okta-config) | **GET** `/mfa/okta-verify/config` | Configuration of okta mfa method
[**Set-V2026MFADuoConfig**](#set-mfa-duo-config) | **PUT** `/mfa/duo-web/config` | Set duo mfa configuration
[**Set-V2026MFAKBAConfig**](#set-mfakba-config) | **POST** `/mfa/kba/config/answers` | Set mfa kba configuration
[**Set-V2026MFAOktaConfig**](#set-mfa-okta-config) | **PUT** `/mfa/okta-verify/config` | Set okta mfa configuration
[**Test-V2026MFAConfig**](#test-mfa-config) | **GET** `/mfa/{method}/test` | Mfa method&#39;s test configuration
...
try {
    Get-V2026MFADuoConfig 
    
    # Below is a request that includes all optional parameters
    # Get-V2026MFADuoConfig  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026MFADuoConfig"
...
try {
    Get-V2026MFAKbaConfig 
    
    # Below is a request that includes all optional parameters
    # Get-V2026MFAKbaConfig -AllLanguages $AllLanguages  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026MFAKbaConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026MFAOktaConfig 
    
    # Below is a request that includes all optional parameters
    # Get-V2026MFAOktaConfig  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026MFAOktaConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToMfaDuoConfig -Json $MfaDuoConfig
    Set-V2026MFADuoConfig -MfaDuoConfig $Result 
    
    # Below is a request that includes all optional parameters
    # Set-V2026MFADuoConfig -MfaDuoConfig $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Set-V2026MFADuoConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToKbaAnswerRequestItem -Json $KbaAnswerRequestItem
    Set-V2026MFAKBAConfig -KbaAnswerRequestItem $Result 
    
    # Below is a request that includes all optional parameters
    # Set-V2026MFAKBAConfig -KbaAnswerRequestItem $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Set-V2026MFAKBAConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToMfaOktaConfig -Json $MfaOktaConfig
    Set-V2026MFAOktaConfig -MfaOktaConfig $Result 
    
    # Below is a request that includes all optional parameters
    # Set-V2026MFAOktaConfig -MfaOktaConfig $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Set-V2026MFAOktaConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Test-V2026MFAConfig -Method $Method 
    
    # Below is a request that includes all optional parameters
    # Test-V2026MFAConfig -Method $Method  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Test-V2026MFAConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

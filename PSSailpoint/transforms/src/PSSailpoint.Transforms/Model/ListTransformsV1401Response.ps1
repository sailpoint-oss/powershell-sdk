...
ListTransformsV1401Response<PSCustomObject>
#>

function Initialize-ListTransformsV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListTransformsV1401Response<PSCustomObject>
...
ListTransformsV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToListTransformsV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListTransformsV1401Response
        $AllProperties = ("error")

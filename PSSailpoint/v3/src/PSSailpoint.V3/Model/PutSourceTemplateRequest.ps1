...
function Initialize-PutSourceTemplateRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => PutSourceTemplateRequest' | Write-Debug
...
PutSourceTemplateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPutSourceTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => PutSourceTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PutSourceTemplateRequest
        $AllProperties = ("file")

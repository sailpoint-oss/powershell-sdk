...
function Initialize-MachineIdentityRequest {
    [CmdletBinding()]
    Param (
...
MachineIdentityRequest<PSCustomObject>
#>
function ConvertFrom-JsonToMachineIdentityRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in MachineIdentityRequest

...
ProfileSelectAction<PSCustomObject>
#>

function Initialize-NERMProfileSelectAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMProfileSelectAction' | Write-Debug
...
Convert from JSON to ProfileSelectAction<PSCustomObject>
...
ProfileSelectAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToProfileSelectAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMProfileSelectAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMProfileSelectAction

...
function Initialize-BetaLoadEntitlementTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaLoadEntitlementTask' | Write-Debug
...
LoadEntitlementTask<PSCustomObject>
#>
function ConvertFrom-BetaJsonToLoadEntitlementTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaLoadEntitlementTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaLoadEntitlementTask

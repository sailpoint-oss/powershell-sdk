...
function Initialize-BetaRequestedItemStatusRequesterComment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusRequesterComment' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestedItemStatusRequesterComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusRequesterComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

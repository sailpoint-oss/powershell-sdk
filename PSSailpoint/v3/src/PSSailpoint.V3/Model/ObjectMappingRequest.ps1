...
function Initialize-ObjectMappingRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ObjectMappingRequest' | Write-Debug
...
function ConvertFrom-JsonToObjectMappingRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ObjectMappingRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

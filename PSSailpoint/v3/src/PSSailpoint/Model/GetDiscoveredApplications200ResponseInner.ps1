...
function ConvertFrom-JsonToGetDiscoveredApplications200ResponseInner {
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'FullDiscoveredApplications' defined in oneOf (GetDiscoveredApplications200ResponseInner). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'SlimDiscoveredApplications' defined in oneOf (GetDiscoveredApplications200ResponseInner). Proceeding to the next one if any."
        }

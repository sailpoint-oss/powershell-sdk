...
function Initialize-IdentityLifecycleState {
    [CmdletBinding()]
    Param (
...
IdentityLifecycleState<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityLifecycleState {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in IdentityLifecycleState

...
TriggerInputSourceUpdated<PSCustomObject>
#>

function Initialize-BetaTriggerInputSourceUpdated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceUpdated' | Write-Debug
...
Convert from JSON to TriggerInputSourceUpdated<PSCustomObject>
...
TriggerInputSourceUpdated<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputSourceUpdated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceUpdated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputSourceUpdated

...
function Initialize-V2024AccountAggregationCompleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccountAggregationCompleted' | Write-Debug
...
AccountAggregationCompleted<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccountAggregationCompleted {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccountAggregationCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AccountAggregationCompleted

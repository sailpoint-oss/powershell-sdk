...
function New-ManagedClusterTypeV1 {
    ...
    Process {
        'Calling method: New-ManagedClusterTypeV1' | Write-Debug
...
None
#>
function Remove-ManagedClusterTypeV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-ManagedClusterTypeV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/managed-cluster-types/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteManagedClusterTypeV1."
        }
...
function Get-ManagedClusterTypeV1 {
    ...
    Process {
        'Calling method: Get-ManagedClusterTypeV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/managed-cluster-types/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getManagedClusterTypeV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-ManagedClusterTypesV1 {
    ...
    Process {
        'Calling method: Get-ManagedClusterTypesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-ManagedClusterTypeV1 {
    ...
    Process {
        'Calling method: Update-ManagedClusterTypeV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/managed-cluster-types/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling updateManagedClusterTypeV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

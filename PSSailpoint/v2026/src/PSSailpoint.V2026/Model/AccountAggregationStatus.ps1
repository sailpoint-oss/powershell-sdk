...
function Initialize-V2026AccountAggregationStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccountAggregationStatus' | Write-Debug
...
AccountAggregationStatus<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccountAggregationStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccountAggregationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccountAggregationStatus

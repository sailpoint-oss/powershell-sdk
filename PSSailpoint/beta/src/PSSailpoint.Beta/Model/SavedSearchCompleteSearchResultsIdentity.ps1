...
function Initialize-BetaSavedSearchCompleteSearchResultsIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSavedSearchCompleteSearchResultsIdentity' | Write-Debug
...
SavedSearchCompleteSearchResultsIdentity<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSavedSearchCompleteSearchResultsIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSavedSearchCompleteSearchResultsIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSavedSearchCompleteSearchResultsIdentity

...
function Initialize-Roleinsight {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsight' | Write-Debug
...
Roleinsight<PSCustomObject>
#>
function ConvertFrom-JsonToRoleinsight {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsight' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleinsight

...
function Initialize-BetaFormInstanceResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaFormInstanceResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToFormInstanceResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaFormInstanceResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

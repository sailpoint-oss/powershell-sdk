...
function Initialize-V2024WorkflowLibraryOperator {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkflowLibraryOperator' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowLibraryOperator {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkflowLibraryOperator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

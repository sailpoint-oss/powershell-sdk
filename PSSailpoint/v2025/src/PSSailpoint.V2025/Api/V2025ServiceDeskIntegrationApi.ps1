...
#>
function New-V2025ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025ServiceDeskIntegration' | Write-Debug
...
None
#>
function Remove-V2025ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Get-V2025ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025ServiceDeskIntegrationTemplate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ServiceDeskIntegrationTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025ServiceDeskIntegrationTypes {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2025ServiceDeskIntegrationTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto[]
#>
function Get-V2025ServiceDeskIntegrations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2025ServiceDeskIntegrations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025StatusCheckDetails {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2025StatusCheckDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Update-V2025ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Send-V2025ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
QueuedCheckConfigDetails
#>
function Update-V2025StatusCheckDetails {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Update-V2025StatusCheckDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

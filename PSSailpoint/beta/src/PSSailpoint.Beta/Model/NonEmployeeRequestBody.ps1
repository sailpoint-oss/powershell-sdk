...
function Initialize-BetaNonEmployeeRequestBody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeRequestBody' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeRequestBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeRequestBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

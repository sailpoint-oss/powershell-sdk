...
function Initialize-BetaSpConfigExportJobStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSpConfigExportJobStatus' | Write-Debug
...
SpConfigExportJobStatus<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSpConfigExportJobStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSpConfigExportJobStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSpConfigExportJobStatus

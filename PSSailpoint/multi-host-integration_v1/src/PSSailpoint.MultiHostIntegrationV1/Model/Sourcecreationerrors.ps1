...
function Initialize-Sourcecreationerrors {
    [CmdletBinding()]
    Param (
...
Sourcecreationerrors<PSCustomObject>
#>
function ConvertFrom-JsonToSourcecreationerrors {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Sourcecreationerrors

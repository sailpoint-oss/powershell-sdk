...
function Initialize-V2026QueuedCheckConfigDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026QueuedCheckConfigDetails' | Write-Debug
...
QueuedCheckConfigDetails<PSCustomObject>
#>
function ConvertFrom-V2026JsonToQueuedCheckConfigDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026QueuedCheckConfigDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026QueuedCheckConfigDetails

...
keywords: ['powershell', 'PowerShell', 'sdk', 'IntelAccessAccountWire', 'V2026IntelAccessAccountWire'] 
slug: /tools/sdk/powershell/v2026/models/intel-access-account-wire
...
```powershell
$IntelAccessAccountWire = Initialize-V2026IntelAccessAccountWire  -Id 2c91808874ff91550175097daaec161c `
 -Name jdoe `
 -Source null `
 -Disabled false `
 -Locked false `

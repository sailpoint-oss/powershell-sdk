...
function Initialize-V2024CreateFormDefinitionRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CreateFormDefinitionRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateFormDefinitionRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CreateFormDefinitionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

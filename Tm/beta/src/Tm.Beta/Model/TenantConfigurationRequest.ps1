...
function Initialize-BetaTenantConfigurationRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaTenantConfigurationRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToTenantConfigurationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaTenantConfigurationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

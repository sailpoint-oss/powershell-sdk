...
function Initialize-V2024ManagedClusterAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManagedClusterAttributes' | Write-Debug
...
function ConvertFrom-V2024JsonToManagedClusterAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManagedClusterAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

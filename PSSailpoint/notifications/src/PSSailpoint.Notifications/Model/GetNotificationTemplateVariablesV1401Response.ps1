...
GetNotificationTemplateVariablesV1401Response<PSCustomObject>
#>

function Initialize-GetNotificationTemplateVariablesV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to GetNotificationTemplateVariablesV1401Response<PSCustomObject>
...
GetNotificationTemplateVariablesV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetNotificationTemplateVariablesV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in GetNotificationTemplateVariablesV1401Response
        $AllProperties = ("error")

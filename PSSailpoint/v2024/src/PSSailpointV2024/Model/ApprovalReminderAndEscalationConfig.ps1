...
function Initialize-V2024ApprovalReminderAndEscalationConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalReminderAndEscalationConfig' | Write-Debug
...
ApprovalReminderAndEscalationConfig<PSCustomObject>
#>
function ConvertFrom-V2024JsonToApprovalReminderAndEscalationConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalReminderAndEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ApprovalReminderAndEscalationConfig

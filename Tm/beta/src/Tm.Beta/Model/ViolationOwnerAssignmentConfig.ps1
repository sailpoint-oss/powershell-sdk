...
function Initialize-BetaViolationOwnerAssignmentConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaViolationOwnerAssignmentConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToViolationOwnerAssignmentConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaViolationOwnerAssignmentConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

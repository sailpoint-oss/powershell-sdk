...
function Initialize-V2024AttributeChange {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AttributeChange' | Write-Debug
...
function ConvertFrom-V2024JsonToAttributeChange {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AttributeChange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

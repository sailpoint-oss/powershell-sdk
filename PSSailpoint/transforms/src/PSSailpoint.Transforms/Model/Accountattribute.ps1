...
function Initialize-Accountattribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Transforms => Accountattribute' | Write-Debug
...
function ConvertFrom-JsonToAccountattribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Transforms => Accountattribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaSourceCreatedActor {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSourceCreatedActor' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceCreatedActor {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSourceCreatedActor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

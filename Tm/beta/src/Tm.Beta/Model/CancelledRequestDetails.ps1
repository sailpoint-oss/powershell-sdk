...
function Initialize-BetaCancelledRequestDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCancelledRequestDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToCancelledRequestDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCancelledRequestDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

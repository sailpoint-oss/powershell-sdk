...
keywords: ['powershell', 'PowerShell', 'sdk', 'DataAccessSecurity', 'V2026DataAccessSecurity'] 
slug: /tools/sdk/powershell/v2026/methods/data-access-security
...
------------- | ------------- | -------------
[**Suspend-V2026Task**](#cancel-task) | **POST** `/das/tasks/cancel/{id}` | Cancel a DAS task.
[**New-V2026Application**](#create-application) | **POST** `/das/applications` | Create application
[**New-V2026Schedule**](#create-schedule) | **POST** `/das/tasks/schedules` | Create a new schedule.
[**Invoke-V2026DasOwnersAssignPost**](#das-owners-assign-post) | **POST** `/das/owners/assign` | Assign owner to application resource.
[**Invoke-V2026DasOwnersOwnerIdentityIdResourcesGet**](#das-owners-owner-identity-id-resources-get) | **GET** `/das/owners/{ownerIdentityId}/resources` | List resources for owner.
[**Invoke-V2026DasOwnersReelectPost**](#das-owners-reelect-post) | **POST** `/das/owners/reelect` | Re-elect resource owner.
[**Invoke-V2026DasOwnersResourcesResourceIdGet**](#das-owners-resources-resource-id-get) | **GET** `/das/owners/resources/{resourceId}` | List owners for resource.
[**Invoke-V2026DasOwnersSourceIdentityIdReassignDestinationIdentityIdPost**](#das-owners-source-identity-id-reassign-destination-identity-id-post) | **POST** `/das/owners/{sourceIdentityId}/reassign/{destinationIdentityId}` | Reassign resource owner.
[**Remove-V2026Application**](#delete-application) | **DELETE** `/das/applications/{id}` | Delete an application by identifier.
[**Remove-V2026Schedule**](#delete-schedule) | **DELETE** `/das/tasks/schedules/{id}` | Delete a DAS schedule.
[**Remove-V2026Task**](#delete-task) | **DELETE** `/das/tasks/{id}` | Delete a DAS task.
[**Get-V2026Application**](#get-application) | **GET** `/das/applications/{id}` | Retrieve application details by identifier.
[**Get-V2026Applications**](#get-applications) | **GET** `/das/applications` | Search applications in DAS.
[**Get-V2026Owners**](#get-owners) | **GET** `/das/owners/applications/{appId}` | Retrieve owners per application.
[**Get-V2026Schedule**](#get-schedule) | **GET** `/das/tasks/schedules/{id}` | Get a DAS schedule.
[**Get-V2026Schedules**](#get-schedules) | **GET** `/das/tasks/schedules` | List all schedules.
[**Get-V2026Task**](#get-task) | **GET** `/das/tasks/{id}` | Get a DAS task.
[**Get-V2026Tasks**](#get-tasks) | **GET** `/das/tasks` | Lists all DAS tasks.
[**Send-V2026Application**](#put-application) | **PUT** `/das/applications/{id}` | Update application by identifier.
[**Send-V2026Schedule**](#put-schedule) | **PUT** `/das/tasks/schedules/{id}` | Update a schedule.
[**Start-V2026TaskRerun**](#start-task-rerun) | **POST** `/das/tasks/rerun/{id}` | Rerun a DAS task.
...
try {
    Suspend-V2026Task -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Suspend-V2026Task -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Suspend-V2026Task"
...
try {
    $Result = ConvertFrom-V2026JsonToBaseCreateApplicationRequest -Json $BaseCreateApplicationRequest
    New-V2026Application -BaseCreateApplicationRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Application -BaseCreateApplicationRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Application"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToCreateScheduleRequest -Json $CreateScheduleRequest
    New-V2026Schedule -CreateScheduleRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Schedule -CreateScheduleRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Schedule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAssignResourceOwnerRequest -Json $AssignResourceOwnerRequest
    Invoke-V2026DasOwnersAssignPost -AssignResourceOwnerRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026DasOwnersAssignPost -AssignResourceOwnerRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026DasOwnersAssignPost"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Invoke-V2026DasOwnersOwnerIdentityIdResourcesGet -OwnerIdentityId $OwnerIdentityId 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026DasOwnersOwnerIdentityIdResourcesGet -OwnerIdentityId $OwnerIdentityId -Limit $Limit -Offset $Offset  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026DasOwnersOwnerIdentityIdResourcesGet"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToReelectRequest -Json $ReelectRequest
    Invoke-V2026DasOwnersReelectPost -ReelectRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026DasOwnersReelectPost -ReelectRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026DasOwnersReelectPost"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Invoke-V2026DasOwnersResourcesResourceIdGet -ResourceId $ResourceId 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026DasOwnersResourcesResourceIdGet -ResourceId $ResourceId -Limit $Limit -Offset $Offset  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026DasOwnersResourcesResourceIdGet"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Invoke-V2026DasOwnersSourceIdentityIdReassignDestinationIdentityIdPost -SourceIdentityId $SourceIdentityId -DestinationIdentityId $DestinationIdentityId 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026DasOwnersSourceIdentityIdReassignDestinationIdentityIdPost -SourceIdentityId $SourceIdentityId -DestinationIdentityId $DestinationIdentityId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026DasOwnersSourceIdentityIdReassignDestinationIdentityIdPost"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026Application -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Application -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Application"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026Schedule -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Schedule -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Schedule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026Task -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Task -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Task"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Application -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Application -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Application"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Applications 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Applications -Filters $Filters -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Applications"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Owners -AppId $AppId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Owners -AppId $AppId -Limit $Limit -Offset $Offset  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Owners"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Schedule -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Schedule -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Schedule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Schedules -Filters $Filters -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Schedules"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Task"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Tasks -Filters $Filters -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Tasks"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToBaseCreateApplicationRequest -Json $BaseCreateApplicationRequest
    Send-V2026Application -Id $Id -BaseCreateApplicationRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026Application -Id $Id -BaseCreateApplicationRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026Application"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToUpdateScheduleRequest -Json $UpdateScheduleRequest
    Send-V2026Schedule -Id $Id -UpdateScheduleRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026Schedule -Id $Id -UpdateScheduleRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026Schedule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Start-V2026TaskRerun -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Start-V2026TaskRerun -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Start-V2026TaskRerun"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-V2026JsonPatchOperation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026JsonPatchOperation' | Write-Debug
...
JsonPatchOperation<PSCustomObject>
#>
function ConvertFrom-V2026JsonToJsonPatchOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026JsonPatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026JsonPatchOperation

...
function Initialize-BetaNonEmployeeApprovalItemBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeApprovalItemBase' | Write-Debug
...
NonEmployeeApprovalItemBase<PSCustomObject>
#>
function ConvertFrom-BetaJsonToNonEmployeeApprovalItemBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeApprovalItemBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaNonEmployeeApprovalItemBase

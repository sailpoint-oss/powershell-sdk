...
function Initialize-V2026OrphanIdentitiesReportArguments {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026OrphanIdentitiesReportArguments' | Write-Debug
...
OrphanIdentitiesReportArguments<PSCustomObject>
#>
function ConvertFrom-V2026JsonToOrphanIdentitiesReportArguments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026OrphanIdentitiesReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026OrphanIdentitiesReportArguments

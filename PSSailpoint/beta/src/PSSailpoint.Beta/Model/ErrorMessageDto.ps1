...
function Initialize-BetaErrorMessageDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaErrorMessageDto' | Write-Debug
...
ErrorMessageDto<PSCustomObject>
#>
function ConvertFrom-BetaJsonToErrorMessageDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaErrorMessageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaErrorMessageDto

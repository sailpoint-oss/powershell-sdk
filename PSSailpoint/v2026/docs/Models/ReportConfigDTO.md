...
keywords: ['powershell', 'PowerShell', 'sdk', 'ReportConfigDTO', 'V2026ReportConfigDTO'] 
slug: /tools/sdk/powershell/v2026/models/report-config-dto
...
```powershell
$ReportConfigDTO = Initialize-V2026ReportConfigDTO  -ColumnName SOD Business Name `
 -Required true `
 -Included false `
 -Order 2
```

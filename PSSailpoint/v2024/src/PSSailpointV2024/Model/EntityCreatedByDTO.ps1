...
function Initialize-V2024EntityCreatedByDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024EntityCreatedByDTO' | Write-Debug
...
function ConvertFrom-V2024JsonToEntityCreatedByDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024EntityCreatedByDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

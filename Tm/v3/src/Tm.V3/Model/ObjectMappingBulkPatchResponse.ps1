...
function Initialize-ObjectMappingBulkPatchResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ObjectMappingBulkPatchResponse' | Write-Debug
...
function ConvertFrom-JsonToObjectMappingBulkPatchResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ObjectMappingBulkPatchResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

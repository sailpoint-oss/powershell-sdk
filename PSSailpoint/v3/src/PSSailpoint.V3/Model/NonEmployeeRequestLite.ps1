...
function Initialize-NonEmployeeRequestLite {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeRequestLite' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeRequestLite {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeRequestLite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'DateMath', 'V2026DateMath'] 
slug: /tools/sdk/powershell/v2026/models/date-math
tags: ['SDK', 'Software Development Kit', 'DateMath', 'V2026DateMath']
---
...
```powershell
$DateMath = Initialize-V2026DateMath  -Expression now+1w `
 -RoundUp false `

...
function Initialize-ClustermanualupgradeJobsInnerManagedProcessConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClustersV1 => ClustermanualupgradeJobsInnerManagedProcessConfiguration' | Write-Debug
...
ClustermanualupgradeJobsInnerManagedProcessConfiguration<PSCustomObject>
#>
function ConvertFrom-JsonToClustermanualupgradeJobsInnerManagedProcessConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClustersV1 => ClustermanualupgradeJobsInnerManagedProcessConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermanualupgradeJobsInnerManagedProcessConfiguration

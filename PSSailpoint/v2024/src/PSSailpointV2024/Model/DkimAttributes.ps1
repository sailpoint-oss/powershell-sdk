...
function Initialize-V2024DkimAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024DkimAttributes' | Write-Debug
...
function ConvertFrom-V2024JsonToDkimAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024DkimAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
GetTaskStatusV1401Response<PSCustomObject>
#>

function Initialize-GetTaskStatusV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to GetTaskStatusV1401Response<PSCustomObject>
...
GetTaskStatusV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetTaskStatusV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in GetTaskStatusV1401Response
        $AllProperties = ("error")

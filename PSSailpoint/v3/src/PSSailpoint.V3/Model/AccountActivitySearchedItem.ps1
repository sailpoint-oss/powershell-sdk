...
function Initialize-AccountActivitySearchedItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccountActivitySearchedItem' | Write-Debug
...
function ConvertFrom-JsonToAccountActivitySearchedItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccountActivitySearchedItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

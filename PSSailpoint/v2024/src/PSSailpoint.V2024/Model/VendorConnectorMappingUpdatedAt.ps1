...
function Initialize-V2024VendorConnectorMappingUpdatedAt {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024VendorConnectorMappingUpdatedAt' | Write-Debug
...
function ConvertFrom-V2024JsonToVendorConnectorMappingUpdatedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024VendorConnectorMappingUpdatedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

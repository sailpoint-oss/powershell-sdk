...
SourceManagerCorrelationMapping<PSCustomObject>
#>

function Initialize-V2025SourceManagerCorrelationMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SourceManagerCorrelationMapping' | Write-Debug
...
Convert from JSON to SourceManagerCorrelationMapping<PSCustomObject>
...
SourceManagerCorrelationMapping<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSourceManagerCorrelationMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SourceManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SourceManagerCorrelationMapping

...
function Initialize-AccountAttributesCreate {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccountAttributesCreate' | Write-Debug
...
function ConvertFrom-JsonToAccountAttributesCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccountAttributesCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

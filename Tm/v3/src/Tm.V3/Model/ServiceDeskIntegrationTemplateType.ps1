...
function Initialize-ServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ServiceDeskIntegrationTemplateType' | Write-Debug
...
function ConvertFrom-JsonToServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ServiceDeskIntegrationTemplateType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

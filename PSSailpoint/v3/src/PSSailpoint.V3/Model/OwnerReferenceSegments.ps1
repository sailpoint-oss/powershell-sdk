...
function Initialize-OwnerReferenceSegments {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => OwnerReferenceSegments' | Write-Debug
...
function ConvertFrom-JsonToOwnerReferenceSegments {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => OwnerReferenceSegments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

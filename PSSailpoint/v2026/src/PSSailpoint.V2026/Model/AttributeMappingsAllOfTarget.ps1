...
function Initialize-V2026AttributeMappingsAllOfTarget {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AttributeMappingsAllOfTarget' | Write-Debug
...
AttributeMappingsAllOfTarget<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAttributeMappingsAllOfTarget {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AttributeMappingsAllOfTarget' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AttributeMappingsAllOfTarget

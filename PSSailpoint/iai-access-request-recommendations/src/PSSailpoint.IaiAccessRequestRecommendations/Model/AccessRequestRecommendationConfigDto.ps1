...
function Initialize-AccessRequestRecommendationConfigDto {
    [CmdletBinding()]
    Param (
...
AccessRequestRecommendationConfigDto<PSCustomObject>
#>
function ConvertFrom-JsonToAccessRequestRecommendationConfigDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccessRequestRecommendationConfigDto

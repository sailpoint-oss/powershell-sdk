...
function Initialize-V2025MultiHostIntegrationsConnectorAttributesMultiHostAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025MultiHostIntegrationsConnectorAttributesMultiHostAttributes' | Write-Debug
...
MultiHostIntegrationsConnectorAttributesMultiHostAttributes<PSCustomObject>
#>
function ConvertFrom-V2025JsonToMultiHostIntegrationsConnectorAttributesMultiHostAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025MultiHostIntegrationsConnectorAttributesMultiHostAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025MultiHostIntegrationsConnectorAttributesMultiHostAttributes

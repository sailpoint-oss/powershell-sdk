...
function Get-V2026OrgConfig {
    ...
    Process {
        'Calling method: Get-V2026OrgConfig' | Write-Debug
...
String[]
#>
function Get-V2026ValidTimeZones {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2026ValidTimeZones' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
OrgConfig
#>
function Update-V2026OrgConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Update-V2026OrgConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccountAttributesChangedSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesChangedSource' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesChangedSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesChangedSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

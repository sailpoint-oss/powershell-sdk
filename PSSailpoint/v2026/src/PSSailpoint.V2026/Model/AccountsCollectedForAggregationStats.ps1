...
function Initialize-V2026AccountsCollectedForAggregationStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccountsCollectedForAggregationStats' | Write-Debug
...
AccountsCollectedForAggregationStats<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccountsCollectedForAggregationStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccountsCollectedForAggregationStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccountsCollectedForAggregationStats

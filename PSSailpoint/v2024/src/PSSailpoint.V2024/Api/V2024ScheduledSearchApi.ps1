...
ScheduledSearch
#>
function New-V2024ScheduledSearch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2024ScheduledSearch' | Write-Debug
...
None
#>
function Remove-V2024ScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2024ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ScheduledSearch
#>
function Get-V2024ScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-V2024UnsubscribeScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2024UnsubscribeScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ScheduledSearch
#>
function Update-V2024ScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2024ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

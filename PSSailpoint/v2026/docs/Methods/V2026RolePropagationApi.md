...
keywords: ['powershell', 'PowerShell', 'sdk', 'RolePropagation', 'V2026RolePropagation'] 
slug: /tools/sdk/powershell/v2026/methods/role-propagation
...
------------- | ------------- | -------------
[**Suspend-V2026RolePropagation**](#cancel-role-propagation) | **POST** `/role-propagation/terminate` | Terminate Role Propagation process
[**Get-V2026OngoingRolePropagation**](#get-ongoing-role-propagation) | **GET** `/role-propagation/is-running` | Get ongoing Role Propagation process
[**Get-V2026RolePropagationConfig**](#get-role-propagation-config) | **GET** `/role-propagation-config` | Get Role Change Propagation Configuration
[**Get-V2026RolePropagationStatus**](#get-role-propagation-status) | **GET** `/role-propagation/{rolePropagationId}/status` | Get status of Role-Propagation process
[**Set-V2026RolePropagationConfig**](#set-role-propagation-config) | **PUT** `/role-propagation-config` | Update Role Change Propagation Configuration
[**Start-V2026RolePropagation**](#start-role-propagation) | **POST** `/role-propagation` | Initiate Role Propagation process
...
try {
    Suspend-V2026RolePropagation -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Suspend-V2026RolePropagation -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Suspend-V2026RolePropagation"
...
try {
    Get-V2026OngoingRolePropagation -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026OngoingRolePropagation -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026OngoingRolePropagation"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026RolePropagationConfig -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026RolePropagationConfig -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026RolePropagationConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026RolePropagationStatus -XSailPointExperimental $XSailPointExperimental -RolePropagationId $RolePropagationId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026RolePropagationStatus -XSailPointExperimental $XSailPointExperimental -RolePropagationId $RolePropagationId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026RolePropagationStatus"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToRolePropagationConfigInput -Json $RolePropagationConfigInput
    Set-V2026RolePropagationConfig -XSailPointExperimental $XSailPointExperimental -RolePropagationConfigInput $Result 
    
    # Below is a request that includes all optional parameters
    # Set-V2026RolePropagationConfig -XSailPointExperimental $XSailPointExperimental -RolePropagationConfigInput $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Set-V2026RolePropagationConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Start-V2026RolePropagation -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Start-V2026RolePropagation -XSailPointExperimental $XSailPointExperimental -SkipRoleRefresh $SkipRoleRefresh  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Start-V2026RolePropagation"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

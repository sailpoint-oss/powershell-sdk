...
function Initialize-RequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => RequestedItemStatusProvisioningDetails' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => RequestedItemStatusProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

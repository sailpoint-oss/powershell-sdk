...
function Initialize-BetaVAClusterStatusChangeEventHealthCheckResult {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaVAClusterStatusChangeEventHealthCheckResult' | Write-Debug
...
function ConvertFrom-BetaJsonToVAClusterStatusChangeEventHealthCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaVAClusterStatusChangeEventHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

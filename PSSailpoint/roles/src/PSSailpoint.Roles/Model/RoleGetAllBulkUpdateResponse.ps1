...
function Initialize-RoleGetAllBulkUpdateResponse {
    [CmdletBinding()]
    Param (
...
RoleGetAllBulkUpdateResponse<PSCustomObject>
#>
function ConvertFrom-JsonToRoleGetAllBulkUpdateResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in RoleGetAllBulkUpdateResponse

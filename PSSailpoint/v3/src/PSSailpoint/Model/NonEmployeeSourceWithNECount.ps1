...
function Initialize-NonEmployeeSourceWithNECount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeSourceWithNECount' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSourceWithNECount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeSourceWithNECount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

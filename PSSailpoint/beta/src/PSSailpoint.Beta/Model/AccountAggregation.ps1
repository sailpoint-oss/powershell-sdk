...
function Initialize-BetaAccountAggregation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAggregation' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAggregation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

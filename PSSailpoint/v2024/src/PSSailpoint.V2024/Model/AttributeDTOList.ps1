...
function Initialize-V2024AttributeDTOList {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AttributeDTOList' | Write-Debug
...
function ConvertFrom-V2024JsonToAttributeDTOList {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AttributeDTOList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

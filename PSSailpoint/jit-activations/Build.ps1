...
$FunctionPath = "$PSScriptRoot/src/PSSailpoint.JitActivations/Api", "$PSScriptRoot/src/PSSailpoint.JitActivations/Client","$PSScriptRoot/src/PSSailpoint.JitActivations/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\PSSailpoint.JitActivations\PSSailpoint.JitActivations.psd1"

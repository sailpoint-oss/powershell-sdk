...
function Initialize-Jitactivationdeactivateresponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.JitActivationsV1 => Jitactivationdeactivateresponse' | Write-Debug
...
function ConvertFrom-JsonToJitactivationdeactivateresponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.JitActivationsV1 => Jitactivationdeactivateresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

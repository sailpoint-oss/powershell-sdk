...
WorkItemsForm<PSCustomObject>
#>

function Initialize-V2024WorkItemsForm {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024WorkItemsForm' | Write-Debug
...
Convert from JSON to WorkItemsForm<PSCustomObject>
...
WorkItemsForm<PSCustomObject>
#>
function ConvertFrom-V2024JsonToWorkItemsForm {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024WorkItemsForm' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024WorkItemsForm

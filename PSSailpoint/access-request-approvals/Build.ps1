...
$FunctionPath = "$PSScriptRoot/src/PSSailpoint.AccessRequestApprovals/Api", "$PSScriptRoot/src/PSSailpoint.AccessRequestApprovals/Client","$PSScriptRoot/src/PSSailpoint.AccessRequestApprovals/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\PSSailpoint.AccessRequestApprovals\PSSailpoint.AccessRequestApprovals.psd1"

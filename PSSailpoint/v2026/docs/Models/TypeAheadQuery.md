...
keywords: ['powershell', 'PowerShell', 'sdk', 'TypeAheadQuery', 'V2026TypeAheadQuery'] 
slug: /tools/sdk/powershell/v2026/models/type-ahead-query
...
```powershell
$TypeAheadQuery = Initialize-V2026TypeAheadQuery  -Query Work `
 -Field source.name `
 -NestedType access `
 -MaxExpansions 10 `
 -Size 100 `

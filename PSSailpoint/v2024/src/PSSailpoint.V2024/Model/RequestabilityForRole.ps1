...
function Initialize-V2024RequestabilityForRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RequestabilityForRole' | Write-Debug
...
RequestabilityForRole<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRequestabilityForRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RequestabilityForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

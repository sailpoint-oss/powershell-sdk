...
function Initialize-V2024SourceAppOwner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SourceAppOwner' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceAppOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SourceAppOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

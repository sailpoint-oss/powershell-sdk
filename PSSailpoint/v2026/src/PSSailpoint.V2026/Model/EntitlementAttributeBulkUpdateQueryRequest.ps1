...
function Initialize-V2026EntitlementAttributeBulkUpdateQueryRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026EntitlementAttributeBulkUpdateQueryRequest' | Write-Debug
...
EntitlementAttributeBulkUpdateQueryRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToEntitlementAttributeBulkUpdateQueryRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026EntitlementAttributeBulkUpdateQueryRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026EntitlementAttributeBulkUpdateQueryRequest

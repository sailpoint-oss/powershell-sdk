...
function Initialize-V2024ReviewableEntitlement {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ReviewableEntitlement' | Write-Debug
...
function ConvertFrom-V2024JsonToReviewableEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ReviewableEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

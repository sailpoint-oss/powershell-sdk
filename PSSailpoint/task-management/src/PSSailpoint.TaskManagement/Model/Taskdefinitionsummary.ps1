...
function Initialize-Taskdefinitionsummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TaskManagement => Taskdefinitionsummary' | Write-Debug
...
function ConvertFrom-JsonToTaskdefinitionsummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TaskManagement => Taskdefinitionsummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

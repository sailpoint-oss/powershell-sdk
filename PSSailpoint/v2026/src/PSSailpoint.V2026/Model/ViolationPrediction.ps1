...
function Initialize-V2026ViolationPrediction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ViolationPrediction' | Write-Debug
...
ViolationPrediction<PSCustomObject>
#>
function ConvertFrom-V2026JsonToViolationPrediction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ViolationPrediction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ViolationPrediction

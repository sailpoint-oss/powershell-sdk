...
function Initialize-BetaIdentityAttribute1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityAttribute1' | Write-Debug
...
IdentityAttribute1<PSCustomObject>
#>
function ConvertFrom-BetaJsonToIdentityAttribute1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityAttribute1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaIdentityAttribute1

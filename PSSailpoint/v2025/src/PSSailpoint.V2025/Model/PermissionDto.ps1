...
function Initialize-V2025PermissionDto {
    [CmdletBinding()]
    Param (
    )

    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025PermissionDto' | Write-Debug
...
PermissionDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToPermissionDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025PermissionDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025PermissionDto

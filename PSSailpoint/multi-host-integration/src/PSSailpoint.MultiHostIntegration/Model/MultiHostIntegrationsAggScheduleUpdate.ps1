...
function Initialize-MultiHostIntegrationsAggScheduleUpdate {
    [CmdletBinding()]
    Param (
...
MultiHostIntegrationsAggScheduleUpdate<PSCustomObject>
#>
function ConvertFrom-JsonToMultiHostIntegrationsAggScheduleUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in MultiHostIntegrationsAggScheduleUpdate

...
function Initialize-V2024AccountAttributesChangedIdentity {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccountAttributesChangedIdentity' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAttributesChangedIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccountAttributesChangedIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountUncorrelated', 'V2026AccountUncorrelated'] 
slug: /tools/sdk/powershell/v2026/models/account-uncorrelated
...
```powershell
$AccountUncorrelated = Initialize-V2026AccountUncorrelated  -Identity null `
 -Source null `
 -Account null `
 -EntitlementCount 0
```

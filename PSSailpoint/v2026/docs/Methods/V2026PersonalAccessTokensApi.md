...
keywords: ['powershell', 'PowerShell', 'sdk', 'PersonalAccessTokens', 'V2026PersonalAccessTokens'] 
slug: /tools/sdk/powershell/v2026/methods/personal-access-tokens
...
------------- | ------------- | -------------
[**New-V2026PersonalAccessToken**](#create-personal-access-token) | **POST** `/personal-access-tokens` | Create personal access token
[**Remove-V2026PersonalAccessToken**](#delete-personal-access-token) | **DELETE** `/personal-access-tokens/{id}` | Delete personal access token
[**Get-V2026PersonalAccessTokens**](#list-personal-access-tokens) | **GET** `/personal-access-tokens` | List personal access tokens
[**Update-V2026PersonalAccessToken**](#patch-personal-access-token) | **PATCH** `/personal-access-tokens/{id}` | Patch personal access token
...
try {
    $Result = ConvertFrom-V2026JsonToCreatePersonalAccessTokenRequest -Json $CreatePersonalAccessTokenRequest
    New-V2026PersonalAccessToken -CreatePersonalAccessTokenRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026PersonalAccessToken -CreatePersonalAccessTokenRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026PersonalAccessToken"
...
try {
    Remove-V2026PersonalAccessToken -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026PersonalAccessToken -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026PersonalAccessToken"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026PersonalAccessTokens 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PersonalAccessTokens -OwnerId $OwnerId -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026PersonalAccessTokens"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026PersonalAccessToken -Id $Id -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026PersonalAccessToken -Id $Id -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026PersonalAccessToken"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

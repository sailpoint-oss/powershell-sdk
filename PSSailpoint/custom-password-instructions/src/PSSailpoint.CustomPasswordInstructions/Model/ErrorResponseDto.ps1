...
function Initialize-ErrorResponseDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CustomPasswordInstructions => ErrorResponseDto' | Write-Debug
...
function ConvertFrom-JsonToErrorResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CustomPasswordInstructions => ErrorResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

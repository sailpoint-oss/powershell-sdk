...
keywords: ['powershell', 'PowerShell', 'sdk', 'ReportResults', 'V2026ReportResults'] 
slug: /tools/sdk/powershell/v2026/models/report-results
...
```powershell
$ReportResults = Initialize-V2026ReportResults  -ReportType IDENTITIES_DETAILS `

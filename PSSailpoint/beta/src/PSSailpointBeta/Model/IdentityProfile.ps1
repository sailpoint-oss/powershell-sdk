...
function Initialize-BetaIdentityProfile {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaIdentityProfile' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityProfile {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaIdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

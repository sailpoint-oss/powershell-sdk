...
function Initialize-PutCorrelationConfigRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => PutCorrelationConfigRequest' | Write-Debug
...
PutCorrelationConfigRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPutCorrelationConfigRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => PutCorrelationConfigRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PutCorrelationConfigRequest
        $AllProperties = ("file")

...
function Initialize-Sodexemptcriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => Sodexemptcriteria' | Write-Debug
...
function ConvertFrom-JsonToSodexemptcriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => Sodexemptcriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

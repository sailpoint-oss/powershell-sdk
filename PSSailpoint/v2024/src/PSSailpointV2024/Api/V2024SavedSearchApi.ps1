...
function New-V2024SavedSearch {
    ...
    Process {
        'Calling method: New-V2024SavedSearch' | Write-Debug
...
None
#>
function Remove-V2024SavedSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2024SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-V2024ExecuteSavedSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2024ExecuteSavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2024SavedSearch {
    ...
    Process {
        'Calling method: Get-V2024SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SavedSearch[]
#>
function Get-V2024SavedSearches {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2024SavedSearches' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SavedSearch
#>
function Send-V2024SavedSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2024SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

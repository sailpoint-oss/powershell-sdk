...
function Initialize-Provisioningcriterialevel2 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfiles => Provisioningcriterialevel2' | Write-Debug
...
function ConvertFrom-JsonToProvisioningcriterialevel2 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfiles => Provisioningcriterialevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ServiceDeskIntegrationDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SimIntegrations => ServiceDeskIntegrationDto' | Write-Debug
...
function ConvertFrom-JsonToServiceDeskIntegrationDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SimIntegrations => ServiceDeskIntegrationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

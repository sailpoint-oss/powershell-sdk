...
keywords: ['powershell', 'PowerShell', 'sdk', 'AuthUsers', 'V2026AuthUsers'] 
slug: /tools/sdk/powershell/v2026/methods/auth-users
...
------------- | ------------- | -------------
[**Get-V2026AuthUser**](#get-auth-user) | **GET** `/auth-users/{id}` | Auth user details
[**Update-V2026AuthUser**](#patch-auth-user) | **PATCH** `/auth-users/{id}` | Auth user update
...
try {
    Get-V2026AuthUser -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AuthUser -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AuthUser"
...
try {
    ...
    Update-V2026AuthUser -Id $Id -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026AuthUser -Id $Id -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026AuthUser"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

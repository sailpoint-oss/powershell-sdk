...
function Initialize-V2026MultiHostIntegrationsConnectorAttributesMultiHostAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsConnectorAttributesMultiHostAttributes' | Write-Debug
...
MultiHostIntegrationsConnectorAttributesMultiHostAttributes<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMultiHostIntegrationsConnectorAttributesMultiHostAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsConnectorAttributesMultiHostAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MultiHostIntegrationsConnectorAttributesMultiHostAttributes

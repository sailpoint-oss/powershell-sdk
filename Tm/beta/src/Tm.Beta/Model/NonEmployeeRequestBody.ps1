...
function Initialize-BetaNonEmployeeRequestBody {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeRequestBody' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeRequestBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeRequestBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-SourceBeforeProvisioningRule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SourceBeforeProvisioningRule' | Write-Debug
...
function ConvertFrom-JsonToSourceBeforeProvisioningRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SourceBeforeProvisioningRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

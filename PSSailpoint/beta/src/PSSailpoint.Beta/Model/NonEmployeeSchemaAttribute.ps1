...
function Initialize-BetaNonEmployeeSchemaAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeSchemaAttribute' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSchemaAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeSchemaAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

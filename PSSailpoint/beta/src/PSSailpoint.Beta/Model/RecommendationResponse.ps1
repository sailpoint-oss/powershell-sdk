...
function Initialize-BetaRecommendationResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRecommendationResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommendationResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRecommendationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

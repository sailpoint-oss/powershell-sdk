...
keywords: ['powershell', 'PowerShell', 'sdk', 'InnerHit', 'V2026InnerHit'] 
slug: /tools/sdk/powershell/v2026/models/inner-hit
...
```powershell
$InnerHit = Initialize-V2026InnerHit  -Query source.name:\"Active Directory\" `
 -Type access
```

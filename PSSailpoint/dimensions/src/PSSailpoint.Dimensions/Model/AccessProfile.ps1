...
function Initialize-AccessProfile {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Dimensions => AccessProfile' | Write-Debug
...
function ConvertFrom-JsonToAccessProfile {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Dimensions => AccessProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

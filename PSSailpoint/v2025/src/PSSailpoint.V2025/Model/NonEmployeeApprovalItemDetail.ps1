...
function Initialize-V2025NonEmployeeApprovalItemDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeApprovalItemDetail' | Write-Debug
...
NonEmployeeApprovalItemDetail<PSCustomObject>
#>
function ConvertFrom-V2025JsonToNonEmployeeApprovalItemDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeApprovalItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025NonEmployeeApprovalItemDetail

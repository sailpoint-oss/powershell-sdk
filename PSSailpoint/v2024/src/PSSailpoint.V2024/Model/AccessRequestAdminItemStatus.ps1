...
function Initialize-V2024AccessRequestAdminItemStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestAdminItemStatus' | Write-Debug
...
Convert from JSON to AccessRequestAdminItemStatus<PSCustomObject>
...
AccessRequestAdminItemStatus<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccessRequestAdminItemStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestAdminItemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AccessRequestAdminItemStatus

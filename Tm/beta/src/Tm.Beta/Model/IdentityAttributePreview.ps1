...
function Initialize-BetaIdentityAttributePreview {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityAttributePreview' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributePreview {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityAttributePreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaSourceEntitlementRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceEntitlementRequestConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceEntitlementRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceEntitlementRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

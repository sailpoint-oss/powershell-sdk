...
function Initialize-V2024RoleSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

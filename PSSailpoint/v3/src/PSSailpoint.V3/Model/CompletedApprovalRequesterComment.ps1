...
function Initialize-CompletedApprovalRequesterComment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CompletedApprovalRequesterComment' | Write-Debug
...
function ConvertFrom-JsonToCompletedApprovalRequesterComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CompletedApprovalRequesterComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

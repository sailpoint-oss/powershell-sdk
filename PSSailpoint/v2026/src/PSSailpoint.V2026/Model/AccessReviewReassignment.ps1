...
function Initialize-V2026AccessReviewReassignment {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessReviewReassignment' | Write-Debug
...
AccessReviewReassignment<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessReviewReassignment {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessReviewReassignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessReviewReassignment

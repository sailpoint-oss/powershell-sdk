...
function Initialize-V2024AccessRequestPostApprovalRequestedItemsStatusInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestPostApprovalRequestedItemsStatusInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ProvisioningPolicyDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ProvisioningPolicyDto' | Write-Debug
...
ProvisioningPolicyDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToProvisioningPolicyDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ProvisioningPolicyDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ProvisioningPolicyDto

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ActivityConfigurationSettings', 'V2026ActivityConfigurationSettings'] 
slug: /tools/sdk/powershell/v2026/models/activity-configuration-settings
...
```powershell
$ActivityConfigurationSettings = Initialize-V2026ActivityConfigurationSettings  -IsEnabled true `

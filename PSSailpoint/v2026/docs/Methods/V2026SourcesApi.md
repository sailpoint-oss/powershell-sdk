...
keywords: ['powershell', 'PowerShell', 'sdk', 'Sources', 'V2026Sources'] 
slug: /tools/sdk/powershell/v2026/methods/sources
...
------------- | ------------- | -------------
[**New-V2026ProvisioningPolicy**](#create-provisioning-policy) | **POST** `/sources/{sourceId}/provisioning-policies` | Create provisioning policy
[**New-V2026Source**](#create-source) | **POST** `/sources` | Creates a source in identitynow.
[**New-V2026SourceSchedule**](#create-source-schedule) | **POST** `/sources/{sourceId}/schedules` | Create schedule on source
[**New-V2026SourceSchema**](#create-source-schema) | **POST** `/sources/{sourceId}/schemas` | Create schema on source
[**Remove-V2026AccountsAsync**](#delete-accounts-async) | **POST** `/sources/{id}/remove-accounts` | Remove all accounts in source
[**Remove-V2026NativeChangeDetectionConfig**](#delete-native-change-detection-config) | **DELETE** `/sources/{sourceId}/native-change-detection-config` | Delete native change detection configuration
[**Remove-V2026ProvisioningPolicy**](#delete-provisioning-policy) | **DELETE** `/sources/{sourceId}/provisioning-policies/{usageType}` | Delete provisioning policy by usagetype
...
[**Get-V2026SourceSchemas**](#get-source-schemas) | **GET** `/sources/{sourceId}/schemas` | List schemas on source
[**Import-V2026Accounts**](#import-accounts) | **POST** `/sources/{id}/load-accounts` | Account aggregation
[**Import-V2026AccountsSchema**](#import-accounts-schema) | **POST** `/sources/{id}/schemas/accounts` | Uploads source accounts schema template
[**Import-V2026ConnectorFile**](#import-connector-file) | **POST** `/sources/{sourceId}/upload-connector-file` | Upload connector file to source
[**Import-V2026Entitlements**](#import-entitlements) | **POST** `/sources/{sourceId}/load-entitlements` | Entitlement aggregation
[**Import-V2026EntitlementsSchema**](#import-entitlements-schema) | **POST** `/sources/{id}/schemas/entitlements` | Uploads source entitlements schema template
[**Import-V2026UncorrelatedAccounts**](#import-uncorrelated-accounts) | **POST** `/sources/{id}/load-uncorrelated-accounts` | Process uncorrelated accounts
[**Get-V2026PasswordPolicyHoldersOnSource**](#list-password-policy-holders-on-source) | **GET** `/sources/{sourceId}/password-policies` | Get Password Policy for source
[**Get-V2026ProvisioningPolicies**](#list-provisioning-policies) | **GET** `/sources/{sourceId}/provisioning-policies` | Lists provisioningpolicies
[**Get-V2026Sources**](#list-sources) | **GET** `/sources` | Lists all sources in identitynow.
[**Ping-V2026Cluster**](#ping-cluster) | **POST** `/sources/{sourceId}/connector/ping-cluster` | Ping cluster for source connector
[**Send-V2026CorrelationConfig**](#put-correlation-config) | **PUT** `/sources/{id}/correlation-config` | Update source correlation configuration
[**Send-V2026NativeChangeDetectionConfig**](#put-native-change-detection-config) | **PUT** `/sources/{sourceId}/native-change-detection-config` | Update native change detection configuration
[**Send-V2026ProvisioningPolicy**](#put-provisioning-policy) | **PUT** `/sources/{sourceId}/provisioning-policies/{usageType}` | Update provisioning policy by usagetype
[**Send-V2026Source**](#put-source) | **PUT** `/sources/{id}` | Update source (full)
[**Send-V2026SourceAttrSyncConfig**](#put-source-attr-sync-config) | **PUT** `/sources/{id}/attribute-sync-config` | Update attribute sync config
[**Send-V2026SourceSchema**](#put-source-schema) | **PUT** `/sources/{sourceId}/schemas/{schemaId}` | Update source schema (full)
[**Search-V2026ResourceObjects**](#search-resource-objects) | **POST** `/sources/{sourceId}/connector/peek-resource-objects` | Peek source connector&#39;s resource objects
...
[**Update-V2026Source**](#update-source) | **PATCH** `/sources/{id}` | Update source (partial)
[**Update-V2026SourceEntitlementRequestConfig**](#update-source-entitlement-request-config) | **PUT** `/sources/{id}/entitlement-request-config` | Update source entitlement request configuration
[**Update-V2026SourceSchedule**](#update-source-schedule) | **PATCH** `/sources/{sourceId}/schedules/{scheduleType}` | Update source schedule (partial)
[**Update-V2026SourceSchema**](#update-source-schema) | **PATCH** `/sources/{sourceId}/schemas/{schemaId}` | Update source schema (partial)
...
try {
    $Result = ConvertFrom-V2026JsonToProvisioningPolicyDto -Json $ProvisioningPolicyDto
    New-V2026ProvisioningPolicy -SourceId $SourceId -ProvisioningPolicyDto $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026ProvisioningPolicy -SourceId $SourceId -ProvisioningPolicyDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026ProvisioningPolicy"
...
try {
    $Result = ConvertFrom-V2026JsonToSource -Json $Source
    New-V2026Source -Source $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Source -Source $Result -ProvisionAsCsv $ProvisionAsCsv  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Source"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSchedule1 -Json $Schedule1
    New-V2026SourceSchedule -SourceId $SourceId -Schedule1 $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026SourceSchedule -SourceId $SourceId -Schedule1 $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026SourceSchedule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSchema -Json $Schema
    New-V2026SourceSchema -SourceId $SourceId -Schema $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026SourceSchema -SourceId $SourceId -Schema $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026SourceSchema"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026AccountsAsync -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026AccountsAsync -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026AccountsAsync"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026NativeChangeDetectionConfig -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026NativeChangeDetectionConfig -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026NativeChangeDetectionConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026ProvisioningPolicy -SourceId $SourceId -UsageType $UsageType 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026ProvisioningPolicy -SourceId $SourceId -UsageType $UsageType  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026ProvisioningPolicy"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026Source -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Source -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Source"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026SourceSchedule -SourceId $SourceId -ScheduleType $ScheduleType 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026SourceSchedule -SourceId $SourceId -ScheduleType $ScheduleType  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026SourceSchedule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026SourceSchema -SourceId $SourceId -SchemaId $SchemaId 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026SourceSchema -SourceId $SourceId -SchemaId $SchemaId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026SourceSchema"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026AccountsSchema -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AccountsSchema -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccountsSchema"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026CorrelationConfig -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026CorrelationConfig -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026CorrelationConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026EntitlementsSchema -Id $Id 
...
try {
    Get-V2026NativeChangeDetectionConfig -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026NativeChangeDetectionConfig -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026NativeChangeDetectionConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ProvisioningPolicy -SourceId $SourceId -UsageType $UsageType 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ProvisioningPolicy -SourceId $SourceId -UsageType $UsageType  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ProvisioningPolicy"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Source -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Source -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Source"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SourceAttrSyncConfig -Id $Id -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SourceAttrSyncConfig -Id $Id -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SourceAttrSyncConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SourceConfig -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SourceConfig -Id $Id -Locale $Locale  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SourceConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SourceConnections -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SourceConnections -SourceId $SourceId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SourceConnections"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SourceEntitlementRequestConfig -Id $Id -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SourceEntitlementRequestConfig -Id $Id -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SourceEntitlementRequestConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SourceSchedule -SourceId $SourceId -ScheduleType $ScheduleType 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SourceSchedule -SourceId $SourceId -ScheduleType $ScheduleType  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SourceSchedule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SourceSchedules -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SourceSchedules -SourceId $SourceId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SourceSchedules"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SourceSchema -SourceId $SourceId -SchemaId $SchemaId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SourceSchema -SourceId $SourceId -SchemaId $SchemaId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SourceSchema"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SourceSchemas -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SourceSchemas -SourceId $SourceId -IncludeTypes $IncludeTypes -IncludeNames $IncludeNames  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SourceSchemas"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Import-V2026Accounts -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Import-V2026Accounts -Id $Id -File $File -DisableOptimization $DisableOptimization  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Import-V2026Accounts"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Import-V2026AccountsSchema -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Import-V2026AccountsSchema -Id $Id -File $File  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Import-V2026AccountsSchema"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Import-V2026ConnectorFile -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Import-V2026ConnectorFile -SourceId $SourceId -File $File  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Import-V2026ConnectorFile"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Import-V2026Entitlements -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Import-V2026Entitlements -SourceId $SourceId -File $File  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Import-V2026Entitlements"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Import-V2026EntitlementsSchema -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Import-V2026EntitlementsSchema -Id $Id -SchemaName $SchemaName -File $File  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Import-V2026EntitlementsSchema"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Import-V2026UncorrelatedAccounts -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Import-V2026UncorrelatedAccounts -Id $Id -File $File  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Import-V2026UncorrelatedAccounts"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026PasswordPolicyHoldersOnSource -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PasswordPolicyHoldersOnSource -SourceId $SourceId -Offset $Offset -Limit $Limit -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026PasswordPolicyHoldersOnSource"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ProvisioningPolicies -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ProvisioningPolicies -SourceId $SourceId -Offset $Offset -Limit $Limit  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ProvisioningPolicies"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Sources -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters -ForSubadmin $ForSubadmin -IncludeIDNSource $IncludeIDNSource  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Sources"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Ping-V2026Cluster -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Ping-V2026Cluster -SourceId $SourceId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Ping-V2026Cluster"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToCorrelationConfig -Json $CorrelationConfig
    Send-V2026CorrelationConfig -Id $Id -CorrelationConfig $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026CorrelationConfig -Id $Id -CorrelationConfig $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026CorrelationConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToNativeChangeDetectionConfig -Json $NativeChangeDetectionConfig
    Send-V2026NativeChangeDetectionConfig -Id $Id -NativeChangeDetectionConfig $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026NativeChangeDetectionConfig -Id $Id -NativeChangeDetectionConfig $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026NativeChangeDetectionConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToProvisioningPolicyDto -Json $ProvisioningPolicyDto
    Send-V2026ProvisioningPolicy -SourceId $SourceId -UsageType $UsageType -ProvisioningPolicyDto $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ProvisioningPolicy -SourceId $SourceId -UsageType $UsageType -ProvisioningPolicyDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ProvisioningPolicy"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSource -Json $Source
    Send-V2026Source -Id $Id -Source $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026Source -Id $Id -Source $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026Source"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAttrSyncSourceConfig -Json $AttrSyncSourceConfig
    Send-V2026SourceAttrSyncConfig -Id $Id -XSailPointExperimental $XSailPointExperimental -AttrSyncSourceConfig $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026SourceAttrSyncConfig -Id $Id -XSailPointExperimental $XSailPointExperimental -AttrSyncSourceConfig $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026SourceAttrSyncConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSchema -Json $Schema
    Send-V2026SourceSchema -SourceId $SourceId -SchemaId $SchemaId -Schema $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026SourceSchema -SourceId $SourceId -SchemaId $SchemaId -Schema $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026SourceSchema"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToResourceObjectsRequest -Json $ResourceObjectsRequest
    Search-V2026ResourceObjects -SourceId $SourceId -ResourceObjectsRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Search-V2026ResourceObjects -SourceId $SourceId -ResourceObjectsRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Search-V2026ResourceObjects"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Sync-V2026AttributesForSource -Id $Id -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Sync-V2026AttributesForSource -Id $Id -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Sync-V2026AttributesForSource"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Test-V2026SourceConfiguration -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Test-V2026SourceConfiguration -SourceId $SourceId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Test-V2026SourceConfiguration"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToPasswordPolicyHoldersDtoInner -Json $PasswordPolicyHoldersDtoInner
    Update-V2026PasswordPolicyHolders -SourceId $SourceId -PasswordPolicyHoldersDtoInner $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026PasswordPolicyHolders -SourceId $SourceId -PasswordPolicyHoldersDtoInner $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026PasswordPolicyHolders"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToProvisioningPolicyDto -Json $ProvisioningPolicyDto
    Update-V2026ProvisioningPoliciesInBulk -SourceId $SourceId -ProvisioningPolicyDto $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ProvisioningPoliciesInBulk -SourceId $SourceId -ProvisioningPolicyDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ProvisioningPoliciesInBulk"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToJsonPatchOperation -Json $JsonPatchOperation
    Update-V2026ProvisioningPolicy -SourceId $SourceId -UsageType $UsageType -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ProvisioningPolicy -SourceId $SourceId -UsageType $UsageType -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ProvisioningPolicy"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToJsonPatchOperation -Json $JsonPatchOperation
    Update-V2026Source -Id $Id -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026Source -Id $Id -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026Source"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSourceEntitlementRequestConfig -Json $SourceEntitlementRequestConfig
    Update-V2026SourceEntitlementRequestConfig -Id $Id -XSailPointExperimental $XSailPointExperimental -SourceEntitlementRequestConfig $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026SourceEntitlementRequestConfig -Id $Id -XSailPointExperimental $XSailPointExperimental -SourceEntitlementRequestConfig $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026SourceEntitlementRequestConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToJsonPatchOperation -Json $JsonPatchOperation
    Update-V2026SourceSchedule -SourceId $SourceId -ScheduleType $ScheduleType -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026SourceSchedule -SourceId $SourceId -ScheduleType $ScheduleType -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026SourceSchedule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToJsonPatchOperation -Json $JsonPatchOperation
    Update-V2026SourceSchema -SourceId $SourceId -SchemaId $SchemaId -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026SourceSchema -SourceId $SourceId -SchemaId $SchemaId -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026SourceSchema"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-NativeChangeDetectionConfig {
    [CmdletBinding()]
    Param (
...
NativeChangeDetectionConfig<PSCustomObject>
#>
function ConvertFrom-JsonToNativeChangeDetectionConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in NativeChangeDetectionConfig

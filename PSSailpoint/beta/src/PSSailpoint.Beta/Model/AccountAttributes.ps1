...
function Initialize-BetaAccountAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAttributes' | Write-Debug
...
AccountAttributes<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAccountAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaAccountAttributes

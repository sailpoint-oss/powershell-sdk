...
function Initialize-BetaAccountStatusChanged {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountStatusChanged' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountStatusChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountStatusChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

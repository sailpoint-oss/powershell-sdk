...
function Initialize-V2024NonEmployeeSourceLite {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeSourceLite' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeSourceLite {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeSourceLite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024IdentityDeleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityDeleted' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityDeleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityDeleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

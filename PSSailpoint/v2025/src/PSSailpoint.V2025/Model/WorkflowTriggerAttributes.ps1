...
#>
function ConvertFrom-V2025JsonToWorkflowTriggerAttributes {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToEventAttributes $Json
                ...
                Write-Debug "Failed to match 'EventAttributes' defined in anyOf (V2025WorkflowTriggerAttributes). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToExternalAttributes $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'ExternalAttributes' defined in anyOf (V2025WorkflowTriggerAttributes). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToScheduledAttributes $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'ScheduledAttributes' defined in anyOf (V2025WorkflowTriggerAttributes). Proceeding to the next one if any."
            }
        }

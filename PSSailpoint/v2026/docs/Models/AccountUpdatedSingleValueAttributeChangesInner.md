...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountUpdatedSingleValueAttributeChangesInner', 'V2026AccountUpdatedSingleValueAttributeChangesInner'] 
slug: /tools/sdk/powershell/v2026/models/account-updated-single-value-attribute-changes-inner
...
```powershell
$AccountUpdatedSingleValueAttributeChangesInner = Initialize-V2026AccountUpdatedSingleValueAttributeChangesInner  -Name displayName `
 -OldValue null `
 -NewValue null
```

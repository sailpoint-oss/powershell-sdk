...
function Initialize-V2025ConnectorRuleCreateRequestSignature {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ConnectorRuleCreateRequestSignature' | Write-Debug
...
ConnectorRuleCreateRequestSignature<PSCustomObject>
#>
function ConvertFrom-V2025JsonToConnectorRuleCreateRequestSignature {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ConnectorRuleCreateRequestSignature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ConnectorRuleCreateRequestSignature

...
function Initialize-V2025ValidateFilterInputDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ValidateFilterInputDto' | Write-Debug
...
ValidateFilterInputDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToValidateFilterInputDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ValidateFilterInputDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ValidateFilterInputDto

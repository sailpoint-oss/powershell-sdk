...
function Initialize-V2025NonEmployeeRequestWithoutApprovalItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeRequestWithoutApprovalItem' | Write-Debug
...
NonEmployeeRequestWithoutApprovalItem<PSCustomObject>
#>
function ConvertFrom-V2025JsonToNonEmployeeRequestWithoutApprovalItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeRequestWithoutApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025NonEmployeeRequestWithoutApprovalItem

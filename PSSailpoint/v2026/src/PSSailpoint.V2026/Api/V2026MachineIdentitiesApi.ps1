...
#>
function New-V2026MachineIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026MachineIdentity' | Write-Debug
...
None
#>
function Remove-V2026MachineIdentity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026MachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MachineIdentityResponse
#>
function Get-V2026MachineIdentity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026MachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MachineIdentityResponse[]
#>
function Get-V2026MachineIdentities {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026MachineIdentities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026MachineIdentityUserEntitlements {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026MachineIdentityUserEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Start-V2026MachineIdentityAggregation {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Start-V2026MachineIdentityAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MachineIdentityResponse
#>
function Update-V2026MachineIdentity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026MachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Get-AccountActivityV1 {
    ...
    Process {
        'Calling method: Get-AccountActivityV1' | Write-Debug
        ...
        $LocalVarUri = '/account-activities/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getAccountActivityV1."
        }
...
function Get-AccountActivitiesV1 {
    ...
    Process {
        'Calling method: Get-AccountActivitiesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/account-activities/v1'

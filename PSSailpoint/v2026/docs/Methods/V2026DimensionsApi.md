...
keywords: ['powershell', 'PowerShell', 'sdk', 'Dimensions', 'V2026Dimensions'] 
slug: /tools/sdk/powershell/v2026/methods/dimensions
...
------------- | ------------- | -------------
[**New-V2026Dimension**](#create-dimension) | **POST** `/roles/{roleId}/dimensions` | Create a dimension
[**Remove-V2026BulkDimensions**](#delete-bulk-dimensions) | **POST** `/roles/{roleId}/dimensions/bulk-delete` | Delete dimension(s)
[**Remove-V2026Dimension**](#delete-dimension) | **DELETE** `/roles/{roleId}/dimensions/{dimensionId}` | Delete a dimension
[**Get-V2026Dimension**](#get-dimension) | **GET** `/roles/{roleId}/dimensions/{dimensionId}` | Get a dimension under role.
[**Get-V2026DimensionEntitlements**](#get-dimension-entitlements) | **GET** `/roles/{roleId}/dimensions/{dimensionId}/entitlements` | List dimension&#39;s entitlements
[**Get-V2026DimensionAccessProfiles**](#list-dimension-access-profiles) | **GET** `/roles/{roleId}/dimensions/{dimensionId}/access-profiles` | List dimension&#39;s access profiles
[**Get-V2026Dimensions**](#list-dimensions) | **GET** `/roles/{roleId}/dimensions` | List dimensions
[**Update-V2026Dimension**](#patch-dimension) | **PATCH** `/roles/{roleId}/dimensions/{dimensionId}` | Patch a specified dimension
...
try {
    $Result = ConvertFrom-V2026JsonToDimension -Json $Dimension
    New-V2026Dimension -RoleId $RoleId -Dimension $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Dimension -RoleId $RoleId -Dimension $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Dimension"
...
try {
    $Result = ConvertFrom-V2026JsonToDimensionBulkDeleteRequest -Json $DimensionBulkDeleteRequest
    Remove-V2026BulkDimensions -RoleId $RoleId -DimensionBulkDeleteRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026BulkDimensions -RoleId $RoleId -DimensionBulkDeleteRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026BulkDimensions"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026Dimension -RoleId $RoleId -DimensionId $DimensionId 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Dimension -RoleId $RoleId -DimensionId $DimensionId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Dimension"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Dimension -RoleId $RoleId -DimensionId $DimensionId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Dimension -RoleId $RoleId -DimensionId $DimensionId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Dimension"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026DimensionEntitlements -RoleId $RoleId -DimensionId $DimensionId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026DimensionEntitlements -RoleId $RoleId -DimensionId $DimensionId -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026DimensionEntitlements"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026DimensionAccessProfiles -RoleId $RoleId -DimensionId $DimensionId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026DimensionAccessProfiles -RoleId $RoleId -DimensionId $DimensionId -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026DimensionAccessProfiles"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Dimensions -RoleId $RoleId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Dimensions -RoleId $RoleId -ForSubadmin $ForSubadmin -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Dimensions"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026Dimension -RoleId $RoleId -DimensionId $DimensionId -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026Dimension -RoleId $RoleId -DimensionId $DimensionId -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026Dimension"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-BetaVendorConnectorMapping {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaVendorConnectorMapping' | Write-Debug
...
function ConvertFrom-BetaJsonToVendorConnectorMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaVendorConnectorMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
ClustermanualupgradeJobsInnerManagedProcessConfigurationToolbox<PSCustomObject>
#>

function Initialize-ClustermanualupgradeJobsInnerManagedProcessConfigurationToolbox {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClustersV1 => ClustermanualupgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
...
Convert from JSON to ClustermanualupgradeJobsInnerManagedProcessConfigurationToolbox<PSCustomObject>
...
ClustermanualupgradeJobsInnerManagedProcessConfigurationToolbox<PSCustomObject>
#>
function ConvertFrom-JsonToClustermanualupgradeJobsInnerManagedProcessConfigurationToolbox {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClustersV1 => ClustermanualupgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermanualupgradeJobsInnerManagedProcessConfigurationToolbox

...
function Initialize-V2024TenantConfigurationRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024TenantConfigurationRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToTenantConfigurationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024TenantConfigurationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024AccessRequestItemResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequestItemResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequestItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

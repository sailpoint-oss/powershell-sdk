...
function Initialize-BetaIdentityAttributesChangedChangesInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityAttributesChangedChangesInner' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributesChangedChangesInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityAttributesChangedChangesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

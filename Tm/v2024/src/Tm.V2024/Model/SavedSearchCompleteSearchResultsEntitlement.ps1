...
function Initialize-V2024SavedSearchCompleteSearchResultsEntitlement {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024SavedSearchCompleteSearchResultsEntitlement' | Write-Debug
...
function ConvertFrom-V2024JsonToSavedSearchCompleteSearchResultsEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024SavedSearchCompleteSearchResultsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

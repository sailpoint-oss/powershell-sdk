...
function Initialize-V2024RoleMiningPotentialRoleExportResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningPotentialRoleExportResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningPotentialRoleExportResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningPotentialRoleExportResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

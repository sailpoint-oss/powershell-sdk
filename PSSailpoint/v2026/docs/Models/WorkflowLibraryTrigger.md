...
keywords: ['powershell', 'PowerShell', 'sdk', 'WorkflowLibraryTrigger', 'V2026WorkflowLibraryTrigger'] 
slug: /tools/sdk/powershell/v2026/models/workflow-library-trigger
...
```powershell
$WorkflowLibraryTrigger = Initialize-V2026WorkflowLibraryTrigger  -Id idn:identity-attributes-changed `
 -Type EVENT `
 -Deprecated null `
 -DeprecatedBy null `

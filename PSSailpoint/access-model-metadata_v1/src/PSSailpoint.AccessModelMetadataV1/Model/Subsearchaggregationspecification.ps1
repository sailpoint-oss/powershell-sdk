...
Subsearchaggregationspecification<PSCustomObject>
#>

function Initialize-Subsearchaggregationspecification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Subsearchaggregationspecification' | Write-Debug
...
Convert from JSON to Subsearchaggregationspecification<PSCustomObject>
...
Subsearchaggregationspecification<PSCustomObject>
#>
function ConvertFrom-JsonToSubsearchaggregationspecification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Subsearchaggregationspecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Subsearchaggregationspecification

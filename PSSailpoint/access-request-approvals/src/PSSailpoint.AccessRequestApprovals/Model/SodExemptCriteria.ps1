...
function Initialize-SodExemptCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestApprovals => SodExemptCriteria' | Write-Debug
...
function ConvertFrom-JsonToSodExemptCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestApprovals => SodExemptCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

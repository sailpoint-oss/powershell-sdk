...
function Initialize-CampaignReportsConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CampaignReportsConfig' | Write-Debug
...
function ConvertFrom-JsonToCampaignReportsConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CampaignReportsConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
#>
function ConvertFrom-JsonToRoleMiningSessionResponseCreatedBy {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            $matchInstance = ConvertFrom-JsonToEntityCreatedByDTO $Json
            ...
            Write-Debug "Failed to match 'EntityCreatedByDTO' defined in oneOf (RoleMiningSessionResponseCreatedBy). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'String' defined in oneOf (RoleMiningSessionResponseCreatedBy). Proceeding to the next one if any."
        }

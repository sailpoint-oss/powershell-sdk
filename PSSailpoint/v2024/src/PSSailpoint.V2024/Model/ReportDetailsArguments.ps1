    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                Write-Debug "Failed to match 'AccountsExportReportArguments' defined in anyOf (V2024ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'IdentitiesDetailsReportArguments' defined in anyOf (V2024ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'IdentitiesReportArguments' defined in anyOf (V2024ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'IdentityProfileIdentityErrorReportArguments' defined in anyOf (V2024ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2024JsonToOrphanIdentitiesReportArguments $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'OrphanIdentitiesReportArguments' defined in anyOf (V2024ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'SearchExportReportArguments' defined in anyOf (V2024ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2024JsonToUncorrelatedAccountsReportArguments $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'UncorrelatedAccountsReportArguments' defined in anyOf (V2024ReportDetailsArguments). Proceeding to the next one if any."
            }
        }

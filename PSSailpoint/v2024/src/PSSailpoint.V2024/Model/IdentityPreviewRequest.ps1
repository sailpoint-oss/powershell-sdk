...
function Initialize-V2024IdentityPreviewRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityPreviewRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityPreviewRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityPreviewRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

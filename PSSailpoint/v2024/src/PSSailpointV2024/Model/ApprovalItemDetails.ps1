...
function Initialize-V2024ApprovalItemDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalItemDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalItemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

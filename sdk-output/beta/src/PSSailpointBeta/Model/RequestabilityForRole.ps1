...
function Initialize-BetaRequestabilityForRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRequestabilityForRole' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestabilityForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRequestabilityForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

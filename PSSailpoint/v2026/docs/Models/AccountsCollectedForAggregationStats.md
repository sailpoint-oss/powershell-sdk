...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountsCollectedForAggregationStats', 'V2026AccountsCollectedForAggregationStats'] 
slug: /tools/sdk/powershell/v2026/models/accounts-collected-for-aggregation-stats
...
```powershell
$AccountsCollectedForAggregationStats = Initialize-V2026AccountsCollectedForAggregationStats  -Scanned 200 `
 -Unchanged 190 `
 -Changed 6 `
 -Added 4 `
 -Removed 3

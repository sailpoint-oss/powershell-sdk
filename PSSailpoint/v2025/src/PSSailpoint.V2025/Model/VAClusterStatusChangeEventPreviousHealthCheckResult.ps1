...
function Initialize-V2025VAClusterStatusChangeEventPreviousHealthCheckResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
...
VAClusterStatusChangeEventPreviousHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-V2025JsonToVAClusterStatusChangeEventPreviousHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025VAClusterStatusChangeEventPreviousHealthCheckResult

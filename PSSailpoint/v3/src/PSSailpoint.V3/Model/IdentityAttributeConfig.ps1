...
function Initialize-IdentityAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityAttributeConfig' | Write-Debug
...
function ConvertFrom-JsonToIdentityAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

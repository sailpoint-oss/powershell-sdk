...
function Initialize-ApprovalReminderAndEscalationConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ApprovalReminderAndEscalationConfig' | Write-Debug
...
function ConvertFrom-JsonToApprovalReminderAndEscalationConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ApprovalReminderAndEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

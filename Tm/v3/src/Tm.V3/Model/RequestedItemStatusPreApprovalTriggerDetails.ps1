...
function Initialize-RequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

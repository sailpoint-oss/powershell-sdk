...
function Initialize-BetaIdentityCompareResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityCompareResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityCompareResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityCompareResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

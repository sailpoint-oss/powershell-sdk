...
function Initialize-V2025Tag {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025Tag' | Write-Debug
...
Tag<PSCustomObject>
#>
function ConvertFrom-V2025JsonToTag {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025Tag' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025Tag

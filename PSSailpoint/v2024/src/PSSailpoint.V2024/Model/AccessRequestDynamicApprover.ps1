...
function Initialize-V2024AccessRequestDynamicApprover {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestDynamicApprover' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestDynamicApprover {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestDynamicApprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

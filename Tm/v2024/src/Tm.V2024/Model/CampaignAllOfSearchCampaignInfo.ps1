...
function Initialize-V2024CampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CampaignAllOfSearchCampaignInfo' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CampaignAllOfSearchCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

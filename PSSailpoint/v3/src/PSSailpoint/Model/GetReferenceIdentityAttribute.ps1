...
function Initialize-GetReferenceIdentityAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => GetReferenceIdentityAttribute' | Write-Debug
...
function ConvertFrom-JsonToGetReferenceIdentityAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => GetReferenceIdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

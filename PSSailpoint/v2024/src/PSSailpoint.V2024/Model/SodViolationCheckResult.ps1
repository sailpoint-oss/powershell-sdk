...
function Initialize-V2024SodViolationCheckResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SodViolationCheckResult' | Write-Debug
...
function ConvertFrom-V2024JsonToSodViolationCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SodViolationCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

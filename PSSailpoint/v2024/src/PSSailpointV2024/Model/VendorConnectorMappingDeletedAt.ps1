...
function Initialize-V2024VendorConnectorMappingDeletedAt {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024VendorConnectorMappingDeletedAt' | Write-Debug
...
function ConvertFrom-V2024JsonToVendorConnectorMappingDeletedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024VendorConnectorMappingDeletedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

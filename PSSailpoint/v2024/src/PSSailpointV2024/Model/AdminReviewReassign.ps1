...
function Initialize-V2024AdminReviewReassign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AdminReviewReassign' | Write-Debug
...
function ConvertFrom-V2024JsonToAdminReviewReassign {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AdminReviewReassign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ApprovalStatusDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalStatusDto' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalStatusDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalStatusDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

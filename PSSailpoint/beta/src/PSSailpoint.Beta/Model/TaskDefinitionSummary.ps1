...
function Initialize-BetaTaskDefinitionSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTaskDefinitionSummary' | Write-Debug
...
TaskDefinitionSummary<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTaskDefinitionSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTaskDefinitionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTaskDefinitionSummary

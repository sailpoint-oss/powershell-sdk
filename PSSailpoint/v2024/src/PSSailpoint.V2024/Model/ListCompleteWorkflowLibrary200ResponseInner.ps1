...
#>
function ConvertFrom-V2024JsonToListCompleteWorkflowLibrary200ResponseInner {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -eq 0) { # no match yet
            ...
            try {
                ...
                Write-Debug "Failed to match 'WorkflowLibraryAction' defined in anyOf (V2024ListCompleteWorkflowLibrary200ResponseInner). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -eq 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'WorkflowLibraryOperator' defined in anyOf (V2024ListCompleteWorkflowLibrary200ResponseInner). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -eq 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'WorkflowLibraryTrigger' defined in anyOf (V2024ListCompleteWorkflowLibrary200ResponseInner). Proceeding to the next one if any."
            }
        }

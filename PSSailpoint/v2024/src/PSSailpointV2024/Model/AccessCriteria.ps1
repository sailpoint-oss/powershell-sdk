...
function Initialize-V2024AccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessCriteria' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

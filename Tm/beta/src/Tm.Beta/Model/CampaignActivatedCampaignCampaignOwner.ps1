...
function Initialize-BetaCampaignActivatedCampaignCampaignOwner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCampaignActivatedCampaignCampaignOwner' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignActivatedCampaignCampaignOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCampaignActivatedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'SPConfig', 'V2026SPConfig'] 
slug: /tools/sdk/powershell/v2026/methods/sp-config
...
------------- | ------------- | -------------
[**Export-V2026SpConfig**](#export-sp-config) | **POST** `/sp-config/export` | Initiates configuration objects export job
[**Get-V2026SpConfigExport**](#get-sp-config-export) | **GET** `/sp-config/export/{id}/download` | Download export job result.
[**Get-V2026SpConfigExportStatus**](#get-sp-config-export-status) | **GET** `/sp-config/export/{id}` | Get export job status
[**Get-V2026SpConfigImport**](#get-sp-config-import) | **GET** `/sp-config/import/{id}/download` | Download import job result
[**Get-V2026SpConfigImportStatus**](#get-sp-config-import-status) | **GET** `/sp-config/import/{id}` | Get import job status
[**Import-V2026SpConfig**](#import-sp-config) | **POST** `/sp-config/import` | Initiates configuration objects import job
[**Get-V2026SpConfigObjects**](#list-sp-config-objects) | **GET** `/sp-config/config-objects` | List config objects
...
try {
    $Result = ConvertFrom-V2026JsonToExportPayload -Json $ExportPayload
    Export-V2026SpConfig -ExportPayload $Result 
    
    # Below is a request that includes all optional parameters
    # Export-V2026SpConfig -ExportPayload $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Export-V2026SpConfig"
...
try {
    Get-V2026SpConfigExport -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SpConfigExport -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SpConfigExport"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SpConfigExportStatus -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SpConfigExportStatus -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SpConfigExportStatus"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SpConfigImport -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SpConfigImport -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SpConfigImport"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SpConfigImportStatus -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SpConfigImportStatus -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SpConfigImportStatus"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Import-V2026SpConfig -Data $Data 
    
    # Below is a request that includes all optional parameters
    # Import-V2026SpConfig -Data $Data -Preview $Preview -Options $Options  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Import-V2026SpConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SpConfigObjects 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SpConfigObjects  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SpConfigObjects"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-V2026AccessItemRemoved {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessItemRemoved' | Write-Debug
...
AccessItemRemoved<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessItemRemoved {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessItemRemoved' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessItemRemoved

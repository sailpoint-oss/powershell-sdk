...
function New-V2026SavedSearch {
    ...
    Process {
        'Calling method: New-V2026SavedSearch' | Write-Debug
...
None
#>
function Remove-V2026SavedSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-V2026ExecuteSavedSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2026ExecuteSavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026SavedSearch {
    ...
    Process {
        'Calling method: Get-V2026SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SavedSearch[]
#>
function Get-V2026SavedSearches {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026SavedSearches' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SavedSearch
#>
function Send-V2026SavedSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2026SavedSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024CommonAccessItemResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CommonAccessItemResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToCommonAccessItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CommonAccessItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

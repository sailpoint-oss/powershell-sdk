...
function Initialize-V2024ConfigurationDetailsResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConfigurationDetailsResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToConfigurationDetailsResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConfigurationDetailsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

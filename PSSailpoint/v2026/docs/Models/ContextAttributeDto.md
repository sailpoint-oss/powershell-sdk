...
keywords: ['powershell', 'PowerShell', 'sdk', 'ContextAttributeDto', 'V2026ContextAttributeDto'] 
slug: /tools/sdk/powershell/v2026/models/context-attribute-dto
...
```powershell
$ContextAttributeDto = Initialize-V2026ContextAttributeDto  -Attribute location `
 -Value null `
 -Derived false
```

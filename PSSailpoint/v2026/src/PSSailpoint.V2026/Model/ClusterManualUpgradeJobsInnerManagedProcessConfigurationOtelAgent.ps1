...
function Initialize-V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent<PSCustomObject>
#>
function ConvertFrom-V2026JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent

...
function Initialize-V2026AccountActivitySearchedItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccountActivitySearchedItem' | Write-Debug
...
AccountActivitySearchedItem<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccountActivitySearchedItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccountActivitySearchedItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccountActivitySearchedItem

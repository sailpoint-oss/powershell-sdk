...
function New-V2026Dimension {
    ...
    Process {
        'Calling method: New-V2026Dimension' | Write-Debug
...
TaskResultDto
#>
function Remove-V2026BulkDimensions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026BulkDimensions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-V2026Dimension {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026Dimension' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026Dimension {
    ...
    Process {
        'Calling method: Get-V2026Dimension' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Entitlement[]
#>
function Get-V2026DimensionEntitlements {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026DimensionEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessProfile[]
#>
function Get-V2026DimensionAccessProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026DimensionAccessProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026Dimensions {
    ...
    Process {
        'Calling method: Get-V2026Dimensions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Dimension
#>
function Update-V2026Dimension {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026Dimension' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

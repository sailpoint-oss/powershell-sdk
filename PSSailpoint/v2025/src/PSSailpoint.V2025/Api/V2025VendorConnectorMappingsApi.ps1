...
#>
function New-V2025VendorConnectorMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025VendorConnectorMapping' | Write-Debug
...
#>
function Remove-V2025VendorConnectorMapping {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Remove-V2025VendorConnectorMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
VendorConnectorMapping[]
#>
function Get-V2025VendorConnectorMappings {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2025VendorConnectorMappings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Taskdefinitionsummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TaskManagementV1 => Taskdefinitionsummary' | Write-Debug
...
function ConvertFrom-JsonToTaskdefinitionsummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TaskManagementV1 => Taskdefinitionsummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-WorkflowLibraryTrigger {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => WorkflowLibraryTrigger' | Write-Debug
...
function ConvertFrom-JsonToWorkflowLibraryTrigger {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => WorkflowLibraryTrigger' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

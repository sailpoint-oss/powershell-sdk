...
function Initialize-V2024IdentityReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityReference' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

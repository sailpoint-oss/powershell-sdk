...
function Initialize-BetaAccountAggregationCompleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAggregationCompleted' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAggregationCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAggregationCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

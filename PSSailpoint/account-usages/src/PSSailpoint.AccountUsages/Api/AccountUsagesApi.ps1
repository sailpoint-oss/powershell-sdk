...
function Get-UsagesByAccountIdV1 {
    ...
    Process {
        'Calling method: Get-UsagesByAccountIdV1' | Write-Debug
        ...
        $LocalVarUri = '/account-usages/v1/{accountId}/summaries'
        if (!$AccountId) {
            throw "Error! The required parameter `AccountId` missing when calling getUsagesByAccountIdV1."
        }

...
keywords: ['powershell', 'PowerShell', 'sdk', 'Branding', 'V2026Branding'] 
slug: /tools/sdk/powershell/v2026/methods/branding
...
------------- | ------------- | -------------
[**New-V2026BrandingItem**](#create-branding-item) | **POST** `/brandings` | Create a branding item
[**Remove-V2026Branding**](#delete-branding) | **DELETE** `/brandings/{name}` | Delete a branding item
[**Get-V2026Branding**](#get-branding) | **GET** `/brandings/{name}` | Get a branding item
[**Get-V2026BrandingList**](#get-branding-list) | **GET** `/brandings` | List of branding items
[**Set-V2026BrandingItem**](#set-branding-item) | **PUT** `/brandings/{name}` | Update a branding item
...
try {
    New-V2026BrandingItem -Name $Name -ProductName $ProductName 
    
    # Below is a request that includes all optional parameters
    # New-V2026BrandingItem -Name $Name -ProductName $ProductName -ActionButtonColor $ActionButtonColor -ActiveLinkColor $ActiveLinkColor -NavigationColor $NavigationColor -EmailFromAddress $EmailFromAddress -LoginInformationalMessage $LoginInformationalMessage -FileStandard $FileStandard  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026BrandingItem"
...
try {
    Remove-V2026Branding -Name $Name 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Branding -Name $Name  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Branding"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Branding -Name $Name 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Branding -Name $Name  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Branding"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026BrandingList 
    
    # Below is a request that includes all optional parameters
    # Get-V2026BrandingList  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026BrandingList"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Set-V2026BrandingItem -Name $Name -Name2 $Name2 -ProductName $ProductName 
    
    # Below is a request that includes all optional parameters
    # Set-V2026BrandingItem -Name $Name -Name2 $Name2 -ProductName $ProductName -ActionButtonColor $ActionButtonColor -ActiveLinkColor $ActiveLinkColor -NavigationColor $NavigationColor -EmailFromAddress $EmailFromAddress -LoginInformationalMessage $LoginInformationalMessage -FileStandard $FileStandard  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Set-V2026BrandingItem"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-BetaAccessRequestItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequestItem' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequestItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

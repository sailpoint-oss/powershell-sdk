...
function Initialize-BetaProvisioningCriteriaLevel1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaProvisioningCriteriaLevel1' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningCriteriaLevel1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaProvisioningCriteriaLevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

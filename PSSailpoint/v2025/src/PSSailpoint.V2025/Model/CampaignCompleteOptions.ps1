...
function Initialize-V2025CampaignCompleteOptions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CampaignCompleteOptions' | Write-Debug
...
CampaignCompleteOptions<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCampaignCompleteOptions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CampaignCompleteOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CampaignCompleteOptions

...
function Initialize-BetaAccessProfileUsage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccessProfileUsage' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileUsage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccessProfileUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

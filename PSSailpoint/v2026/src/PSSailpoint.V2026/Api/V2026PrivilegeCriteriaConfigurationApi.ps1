...
#>
function Get-V2026PrivilegeCriteriaConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2026PrivilegeCriteriaConfig' | Write-Debug
...
PrivilegeCriteriaConfigDTO
#>
function Update-V2026PrivilegeCriteriaConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026PrivilegeCriteriaConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

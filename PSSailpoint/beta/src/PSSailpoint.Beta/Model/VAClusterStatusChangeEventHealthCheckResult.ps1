...
function Initialize-BetaVAClusterStatusChangeEventHealthCheckResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaVAClusterStatusChangeEventHealthCheckResult' | Write-Debug
...
function ConvertFrom-BetaJsonToVAClusterStatusChangeEventHealthCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaVAClusterStatusChangeEventHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "PSSailpoint.Beta"; ModuleVersion = "1.7.100"}
```
...
*BetaIAIRoleMiningApi* | [**Update-BetaPotentialRoleSession**](docs/BetaIAIRoleMiningApi.md#Update-BetaPotentialRoleSession) | **PATCH** /role-mining-sessions/{sessionId}/potential-role-summaries/{potentialRoleId} | Update potential role in session
...
## Documentation for Models
 ...
 - [PSSailpoint.Beta\Model.AdditionalOwnerRef](docs/AdditionalOwnerRef.md)
 ...
 - [PSSailpoint.Beta\Model.ArrayInner2](docs/ArrayInner2.md)
 ...
 - [PSSailpoint.Beta\Model.JsonPatchOperationRoleMining](docs/JsonPatchOperationRoleMining.md)
 - [PSSailpoint.Beta\Model.JsonPatchOperationRoleMiningValue](docs/JsonPatchOperationRoleMiningValue.md)
 ...
 - [PSSailpoint.Beta\Model.RoleMiningPotentialRolePotentialRoleRef](docs/RoleMiningPotentialRolePotentialRoleRef.md)
 ...
 - [PSSailpoint.Beta\Model.TemplateDtoSlackTemplate](docs/TemplateDtoSlackTemplate.md)
 - [PSSailpoint.Beta\Model.TemplateDtoTeamsTemplate](docs/TemplateDtoTeamsTemplate.md)

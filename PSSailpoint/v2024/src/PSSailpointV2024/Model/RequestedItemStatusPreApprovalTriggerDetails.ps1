...
function Initialize-V2024RequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

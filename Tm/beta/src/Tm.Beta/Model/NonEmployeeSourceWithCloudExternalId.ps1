...
function Initialize-BetaNonEmployeeSourceWithCloudExternalId {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeSourceWithCloudExternalId' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSourceWithCloudExternalId {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeSourceWithCloudExternalId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

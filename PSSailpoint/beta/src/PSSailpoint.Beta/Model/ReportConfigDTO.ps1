...
function Initialize-BetaReportConfigDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaReportConfigDTO' | Write-Debug
...
function ConvertFrom-BetaJsonToReportConfigDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaReportConfigDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

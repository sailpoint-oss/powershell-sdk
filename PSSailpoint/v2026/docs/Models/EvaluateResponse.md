...
keywords: ['powershell', 'PowerShell', 'sdk', 'EvaluateResponse', 'V2026EvaluateResponse'] 
slug: /tools/sdk/powershell/v2026/models/evaluate-response
...
```powershell
$EvaluateResponse = Initialize-V2026EvaluateResponse  -ReassignToId 869320b6b6f34a169b6178b1a865e66f `
 -LookupTrail null
```

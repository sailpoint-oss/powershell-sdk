...
Aggregation1<PSCustomObject>
#>

function Initialize-Aggregation1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => Aggregation1' | Write-Debug
...
Convert from JSON to Aggregation1<PSCustomObject>
...
Aggregation1<PSCustomObject>
#>
function ConvertFrom-JsonToAggregation1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => Aggregation1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Aggregation1

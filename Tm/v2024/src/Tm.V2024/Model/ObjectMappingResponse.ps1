...
function Initialize-V2024ObjectMappingResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ObjectMappingResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToObjectMappingResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ObjectMappingResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

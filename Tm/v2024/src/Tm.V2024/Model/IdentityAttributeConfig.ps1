...
function Initialize-V2024IdentityAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024IdentityAttributeConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024IdentityAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

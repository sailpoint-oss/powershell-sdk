...
keywords: ['powershell', 'PowerShell', 'sdk', 'PasswordInfoAccount', 'V2026PasswordInfoAccount'] 
slug: /tools/sdk/powershell/v2026/models/password-info-account
...
```powershell
$PasswordInfoAccount = Initialize-V2026PasswordInfoAccount  -AccountId CN=Abby Smith,OU=Austin,OU=Americas,OU=Demo,DC=seri,DC=acme,DC=com `

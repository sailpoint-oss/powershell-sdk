...
function Initialize-V2024FeatureValueDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024FeatureValueDto' | Write-Debug
...
function ConvertFrom-V2024JsonToFeatureValueDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024FeatureValueDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

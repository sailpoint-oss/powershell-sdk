...
function Initialize-V2026IdentityAttributesChangedChangesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IdentityAttributesChangedChangesInner' | Write-Debug
...
IdentityAttributesChangedChangesInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIdentityAttributesChangedChangesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IdentityAttributesChangedChangesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IdentityAttributesChangedChangesInner

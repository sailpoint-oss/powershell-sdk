...
function Initialize-V2024CloseAccessRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CloseAccessRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCloseAccessRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CloseAccessRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

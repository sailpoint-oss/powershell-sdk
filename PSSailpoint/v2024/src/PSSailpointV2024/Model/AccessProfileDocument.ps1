...
function Initialize-V2024AccessProfileDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileDocument' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

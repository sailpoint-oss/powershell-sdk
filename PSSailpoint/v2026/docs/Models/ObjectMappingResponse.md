...
keywords: ['powershell', 'PowerShell', 'sdk', 'ObjectMappingResponse', 'V2026ObjectMappingResponse'] 
slug: /tools/sdk/powershell/v2026/models/object-mapping-response
...
```powershell
$ObjectMappingResponse = Initialize-V2026ObjectMappingResponse  -ObjectMappingId 3d6e0144-963f-4bd6-8d8d-d77b4e507ce4 `
 -ObjectType IDENTITY `
 -JsonPath $.name `

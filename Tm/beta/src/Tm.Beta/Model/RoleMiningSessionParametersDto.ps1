...
function Initialize-BetaRoleMiningSessionParametersDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningSessionParametersDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningSessionParametersDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningSessionParametersDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

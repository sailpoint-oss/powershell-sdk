...
function Initialize-BetaCompleteInvocation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCompleteInvocation' | Write-Debug
...
CompleteInvocation<PSCustomObject>
#>
function ConvertFrom-BetaJsonToCompleteInvocation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCompleteInvocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaCompleteInvocation

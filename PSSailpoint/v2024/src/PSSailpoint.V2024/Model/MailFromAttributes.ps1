...
function Initialize-V2024MailFromAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024MailFromAttributes' | Write-Debug
...
function ConvertFrom-V2024JsonToMailFromAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024MailFromAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

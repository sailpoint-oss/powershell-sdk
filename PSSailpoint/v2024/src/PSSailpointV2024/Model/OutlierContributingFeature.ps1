...
function Initialize-V2024OutlierContributingFeature {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024OutlierContributingFeature' | Write-Debug
...
function ConvertFrom-V2024JsonToOutlierContributingFeature {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024OutlierContributingFeature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

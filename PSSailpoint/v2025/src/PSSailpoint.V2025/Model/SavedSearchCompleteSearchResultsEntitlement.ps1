...
function Initialize-V2025SavedSearchCompleteSearchResultsEntitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SavedSearchCompleteSearchResultsEntitlement' | Write-Debug
...
SavedSearchCompleteSearchResultsEntitlement<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSavedSearchCompleteSearchResultsEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SavedSearchCompleteSearchResultsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SavedSearchCompleteSearchResultsEntitlement

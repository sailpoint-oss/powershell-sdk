...
keywords: ['powershell', 'PowerShell', 'sdk', 'FullDiscoveredApplications', 'V2026FullDiscoveredApplications'] 
slug: /tools/sdk/powershell/v2026/models/full-discovered-applications
...
```powershell
$FullDiscoveredApplications = Initialize-V2026FullDiscoveredApplications  -Id null `
 -Name ExampleApp `
 -DiscoverySource csv `

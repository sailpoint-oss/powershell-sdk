...
function Initialize-V2025PutConnectorSourceTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025PutConnectorSourceTemplateRequest' | Write-Debug
...
PutConnectorSourceTemplateRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToPutConnectorSourceTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025PutConnectorSourceTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025PutConnectorSourceTemplateRequest
        $AllProperties = ("file")

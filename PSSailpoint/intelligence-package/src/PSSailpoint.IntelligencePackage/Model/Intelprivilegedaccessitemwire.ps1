...
function Initialize-Intelprivilegedaccessitemwire {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IntelligencePackageV1 => Intelprivilegedaccessitemwire' | Write-Debug
...
function ConvertFrom-JsonToIntelprivilegedaccessitemwire {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IntelligencePackageV1 => Intelprivilegedaccessitemwire' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

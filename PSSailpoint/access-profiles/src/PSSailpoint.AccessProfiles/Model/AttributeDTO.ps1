...
function Initialize-AttributeDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfiles => AttributeDTO' | Write-Debug
...
function ConvertFrom-JsonToAttributeDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfiles => AttributeDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaFullDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaFullDiscoveredApplications' | Write-Debug
...
function ConvertFrom-BetaJsonToFullDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaFullDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

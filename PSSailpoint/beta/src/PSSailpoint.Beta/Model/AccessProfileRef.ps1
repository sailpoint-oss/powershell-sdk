...
function Initialize-BetaAccessProfileRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessProfileRef' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessProfileRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Closeaccessrequest {
    [CmdletBinding()]
    Param (
...
Closeaccessrequest<PSCustomObject>
#>
function ConvertFrom-JsonToCloseaccessrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Closeaccessrequest

...
function Initialize-Revocability {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfilesV1 => Revocability' | Write-Debug
...
Revocability<PSCustomObject>
#>
function ConvertFrom-JsonToRevocability {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfilesV1 => Revocability' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Revocability

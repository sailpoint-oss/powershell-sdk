...
function Initialize-BetaImportFormDefinitions202ResponseErrorsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaImportFormDefinitions202ResponseErrorsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToImportFormDefinitions202ResponseErrorsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaImportFormDefinitions202ResponseErrorsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccountUncorrelated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountUncorrelated' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountUncorrelated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountUncorrelated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

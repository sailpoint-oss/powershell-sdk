...
function Initialize-Objectmappingrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ConfigurationHubV1 => Objectmappingrequest' | Write-Debug
...
Objectmappingrequest<PSCustomObject>
#>
function ConvertFrom-JsonToObjectmappingrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ConfigurationHubV1 => Objectmappingrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Objectmappingrequest

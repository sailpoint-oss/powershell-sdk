...
function Initialize-FilterAggregation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Search => FilterAggregation' | Write-Debug
...
function ConvertFrom-JsonToFilterAggregation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Search => FilterAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

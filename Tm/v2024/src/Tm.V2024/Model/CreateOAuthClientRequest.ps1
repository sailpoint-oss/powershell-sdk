...
function Initialize-V2024CreateOAuthClientRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CreateOAuthClientRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateOAuthClientRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CreateOAuthClientRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025TenantUiMetadataItemUpdateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025TenantUiMetadataItemUpdateRequest' | Write-Debug
...
TenantUiMetadataItemUpdateRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToTenantUiMetadataItemUpdateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025TenantUiMetadataItemUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025TenantUiMetadataItemUpdateRequest

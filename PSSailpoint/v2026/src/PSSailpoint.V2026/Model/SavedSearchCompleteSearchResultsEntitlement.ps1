...
function Initialize-V2026SavedSearchCompleteSearchResultsEntitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SavedSearchCompleteSearchResultsEntitlement' | Write-Debug
...
SavedSearchCompleteSearchResultsEntitlement<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSavedSearchCompleteSearchResultsEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SavedSearchCompleteSearchResultsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SavedSearchCompleteSearchResultsEntitlement

...
function Initialize-VendorConnectorMappingUpdatedAt {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => VendorConnectorMappingUpdatedAt' | Write-Debug
...
function ConvertFrom-JsonToVendorConnectorMappingUpdatedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => VendorConnectorMappingUpdatedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeRejectApprovalDecision {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => NonEmployeeRejectApprovalDecision' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeRejectApprovalDecision {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => NonEmployeeRejectApprovalDecision' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

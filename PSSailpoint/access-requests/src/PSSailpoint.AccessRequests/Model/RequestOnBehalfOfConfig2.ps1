...
RequestOnBehalfOfConfig2<PSCustomObject>
#>

function Initialize-RequestOnBehalfOfConfig2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => RequestOnBehalfOfConfig2' | Write-Debug
...
Convert from JSON to RequestOnBehalfOfConfig2<PSCustomObject>
...
RequestOnBehalfOfConfig2<PSCustomObject>
#>
function ConvertFrom-JsonToRequestOnBehalfOfConfig2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => RequestOnBehalfOfConfig2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RequestOnBehalfOfConfig2

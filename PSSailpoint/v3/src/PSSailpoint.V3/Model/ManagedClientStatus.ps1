...
function Initialize-ManagedClientStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ManagedClientStatus' | Write-Debug
...
function ConvertFrom-JsonToManagedClientStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ManagedClientStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

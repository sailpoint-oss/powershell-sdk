...
function Remove-V2024Icon {
    ...
    Process {
        'Calling method: Remove-V2024Icon' | Write-Debug
        ...
        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling deleteIcon."
        }
...
function Set-V2024Icon {
    ...
    Process {
        'Calling method: Set-V2024Icon' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling setIcon."
        }
        $LocalVarHeaderParameters['X-SailPoint-Experimental'] = $XSailPointExperimental

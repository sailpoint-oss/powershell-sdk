...
function Initialize-V2024SodPolicyConflictingAccessCriteria {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SodPolicyConflictingAccessCriteria' | Write-Debug
...
SodPolicyConflictingAccessCriteria<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSodPolicyConflictingAccessCriteria {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SodPolicyConflictingAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SodPolicyConflictingAccessCriteria

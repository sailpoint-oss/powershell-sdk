...
function Initialize-V2025FullDiscoveredApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025FullDiscoveredApplications' | Write-Debug
...
FullDiscoveredApplications<PSCustomObject>
#>
function ConvertFrom-V2025JsonToFullDiscoveredApplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025FullDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

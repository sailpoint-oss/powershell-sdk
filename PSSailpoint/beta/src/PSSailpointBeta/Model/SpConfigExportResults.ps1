...
function Initialize-BetaSpConfigExportResults {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSpConfigExportResults' | Write-Debug
...
function ConvertFrom-BetaJsonToSpConfigExportResults {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSpConfigExportResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

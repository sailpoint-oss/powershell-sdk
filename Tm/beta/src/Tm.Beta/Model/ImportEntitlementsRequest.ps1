...
function Initialize-BetaImportEntitlementsRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaImportEntitlementsRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToImportEntitlementsRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaImportEntitlementsRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

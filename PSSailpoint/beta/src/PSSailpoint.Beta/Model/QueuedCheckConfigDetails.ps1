...
function Initialize-BetaQueuedCheckConfigDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaQueuedCheckConfigDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToQueuedCheckConfigDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaQueuedCheckConfigDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

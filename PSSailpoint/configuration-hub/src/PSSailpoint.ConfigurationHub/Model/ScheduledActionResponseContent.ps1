...
function Initialize-ScheduledActionResponseContent {
    [CmdletBinding()]
    Param (
...
ScheduledActionResponseContent<PSCustomObject>
#>
function ConvertFrom-JsonToScheduledActionResponseContent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ScheduledActionResponseContent

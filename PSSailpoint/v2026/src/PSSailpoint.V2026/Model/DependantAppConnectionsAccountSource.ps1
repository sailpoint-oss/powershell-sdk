...
function Initialize-V2026DependantAppConnectionsAccountSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026DependantAppConnectionsAccountSource' | Write-Debug
...
DependantAppConnectionsAccountSource<PSCustomObject>
#>
function ConvertFrom-V2026JsonToDependantAppConnectionsAccountSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026DependantAppConnectionsAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026DependantAppConnectionsAccountSource

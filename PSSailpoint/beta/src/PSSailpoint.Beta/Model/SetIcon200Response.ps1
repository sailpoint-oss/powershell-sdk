...
function Initialize-BetaSetIcon200Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSetIcon200Response' | Write-Debug
...
function ConvertFrom-BetaJsonToSetIcon200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSetIcon200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

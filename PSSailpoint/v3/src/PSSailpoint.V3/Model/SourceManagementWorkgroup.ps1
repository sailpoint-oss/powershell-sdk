...
function Initialize-SourceManagementWorkgroup {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SourceManagementWorkgroup' | Write-Debug
...
function ConvertFrom-JsonToSourceManagementWorkgroup {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SourceManagementWorkgroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

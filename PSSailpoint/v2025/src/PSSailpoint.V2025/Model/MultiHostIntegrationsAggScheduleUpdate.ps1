...
function Initialize-V2025MultiHostIntegrationsAggScheduleUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025MultiHostIntegrationsAggScheduleUpdate' | Write-Debug
...
MultiHostIntegrationsAggScheduleUpdate<PSCustomObject>
#>
function ConvertFrom-V2025JsonToMultiHostIntegrationsAggScheduleUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025MultiHostIntegrationsAggScheduleUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025MultiHostIntegrationsAggScheduleUpdate

...
function Initialize-V2024AccountActivityDocument {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccountActivityDocument' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountActivityDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccountActivityDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

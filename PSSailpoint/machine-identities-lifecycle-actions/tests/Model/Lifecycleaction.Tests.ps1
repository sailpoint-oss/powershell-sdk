...
Describe -tag 'PSSailpoint.MachineIdentitiesLifecycleActions' -name 'Lifecycleaction' {
    Context 'Lifecycleaction' {
        It 'Initialize-Lifecycleaction' {
            # a simple test to create an object
            #$NewObject = Initialize-Lifecycleaction
            #$NewObject | Should -BeOfType Lifecycleaction

...
function Initialize-BetaCreateDomainDkim405Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCreateDomainDkim405Response' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateDomainDkim405Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCreateDomainDkim405Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

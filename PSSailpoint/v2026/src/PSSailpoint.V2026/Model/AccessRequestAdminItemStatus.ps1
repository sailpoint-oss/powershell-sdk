...
function Initialize-V2026AccessRequestAdminItemStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestAdminItemStatus' | Write-Debug
...
AccessRequestAdminItemStatus<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessRequestAdminItemStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestAdminItemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessRequestAdminItemStatus

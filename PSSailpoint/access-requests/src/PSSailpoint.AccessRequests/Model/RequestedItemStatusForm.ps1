...
RequestedItemStatusForm<PSCustomObject>
#>

function Initialize-RequestedItemStatusForm {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => RequestedItemStatusForm' | Write-Debug
...
Convert from JSON to RequestedItemStatusForm<PSCustomObject>
...
RequestedItemStatusForm<PSCustomObject>
#>
function ConvertFrom-JsonToRequestedItemStatusForm {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => RequestedItemStatusForm' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RequestedItemStatusForm

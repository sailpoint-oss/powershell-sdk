...
function Initialize-BetaAccountsCollectedForAggregation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountsCollectedForAggregation' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountsCollectedForAggregation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountsCollectedForAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

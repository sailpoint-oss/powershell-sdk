...
function Initialize-Identitydocuments {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => Identitydocuments' | Write-Debug
...
Convert from JSON to Identitydocuments<PSCustomObject>
...
Identitydocuments<PSCustomObject>
#>
function ConvertFrom-JsonToIdentitydocuments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => Identitydocuments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

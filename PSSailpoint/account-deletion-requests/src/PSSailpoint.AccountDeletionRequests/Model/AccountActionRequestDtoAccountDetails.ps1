...
function Initialize-AccountActionRequestDtoAccountDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccountDeletionRequests => AccountActionRequestDtoAccountDetails' | Write-Debug
...
function ConvertFrom-JsonToAccountActionRequestDtoAccountDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccountDeletionRequests => AccountActionRequestDtoAccountDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'CertificationDto', 'V2026CertificationDto'] 
slug: /tools/sdk/powershell/v2026/models/certification-dto
...
```powershell
$CertificationDto = Initialize-V2026CertificationDto  -CampaignRef null `
 -Phase null `

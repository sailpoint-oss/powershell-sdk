...
function Initialize-BetaSubscriptionPutRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSubscriptionPutRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToSubscriptionPutRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSubscriptionPutRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

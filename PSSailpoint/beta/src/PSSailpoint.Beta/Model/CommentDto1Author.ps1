...
function Initialize-BetaCommentDto1Author {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCommentDto1Author' | Write-Debug
...
function ConvertFrom-BetaJsonToCommentDto1Author {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCommentDto1Author' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

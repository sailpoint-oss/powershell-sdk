...
function Initialize-V2024CreateExternalExecuteWorkflow200Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CreateExternalExecuteWorkflow200Response' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateExternalExecuteWorkflow200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CreateExternalExecuteWorkflow200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

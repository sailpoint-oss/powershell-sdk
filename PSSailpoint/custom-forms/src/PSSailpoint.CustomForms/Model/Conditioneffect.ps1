...
function Initialize-Conditioneffect {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CustomFormsV1 => Conditioneffect' | Write-Debug
...
Conditioneffect<PSCustomObject>
#>
function ConvertFrom-JsonToConditioneffect {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CustomFormsV1 => Conditioneffect' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Conditioneffect

...
function Initialize-V2026IdentityEntitlementDetailsAccountTarget {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IdentityEntitlementDetailsAccountTarget' | Write-Debug
...
IdentityEntitlementDetailsAccountTarget<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIdentityEntitlementDetailsAccountTarget {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IdentityEntitlementDetailsAccountTarget' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IdentityEntitlementDetailsAccountTarget

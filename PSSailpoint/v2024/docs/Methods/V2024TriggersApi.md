...
try {
    ...
    Complete-V2024TriggerInvocation -Id $Id -CompleteInvocation $Result 
...
try {
    ...
    New-V2024Subscription -SubscriptionPostRequest $Result 
...
try {
    Remove-V2024Subscription -Id $Id 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2024Subscriptions -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2024TriggerInvocationStatus -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2024Triggers -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
...
try {
    ...
    Update-V2024Subscription -Id $Id -SubscriptionPatchRequestInner $Result 
...
try {
    ...
    Start-V2024TestTriggerInvocation -TestInvocation $Result 
...
try {
    ...
    Test-V2024SubscriptionFilter -ValidateFilterInputDto $Result 
...
try {
    ...
    Update-V2024Subscription -Id $Id -SubscriptionPutRequest $Result 

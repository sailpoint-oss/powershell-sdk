...
function Initialize-VendorConnectorMappingUpdatedAt {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => VendorConnectorMappingUpdatedAt' | Write-Debug
...
function ConvertFrom-JsonToVendorConnectorMappingUpdatedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => VendorConnectorMappingUpdatedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

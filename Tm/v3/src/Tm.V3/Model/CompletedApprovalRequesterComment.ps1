...
function Initialize-CompletedApprovalRequesterComment {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => CompletedApprovalRequesterComment' | Write-Debug
...
function ConvertFrom-JsonToCompletedApprovalRequesterComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => CompletedApprovalRequesterComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

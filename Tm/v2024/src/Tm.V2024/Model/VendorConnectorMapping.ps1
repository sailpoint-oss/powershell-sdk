...
function Initialize-V2024VendorConnectorMapping {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024VendorConnectorMapping' | Write-Debug
...
function ConvertFrom-V2024JsonToVendorConnectorMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024VendorConnectorMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaOutlierSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaOutlierSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToOutlierSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaOutlierSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

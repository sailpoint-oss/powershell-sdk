...
function Initialize-V2026CreateFormDefinitionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CreateFormDefinitionRequest' | Write-Debug
...
CreateFormDefinitionRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCreateFormDefinitionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CreateFormDefinitionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CreateFormDefinitionRequest

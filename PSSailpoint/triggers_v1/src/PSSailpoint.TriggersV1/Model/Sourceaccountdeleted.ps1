...
function Initialize-Sourceaccountdeleted {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Sourceaccountdeleted' | Write-Debug
...
Sourceaccountdeleted<PSCustomObject>
#>
function ConvertFrom-JsonToSourceaccountdeleted {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Sourceaccountdeleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Sourceaccountdeleted

...
function Initialize-V2024RoleMiningPotentialRoleEditEntitlements {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RoleMiningPotentialRoleEditEntitlements' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningPotentialRoleEditEntitlements {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RoleMiningPotentialRoleEditEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

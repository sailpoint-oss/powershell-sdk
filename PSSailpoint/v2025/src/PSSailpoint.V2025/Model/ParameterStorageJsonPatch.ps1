...
ParameterStorageJsonPatch<PSCustomObject>
#>

function Initialize-V2025ParameterStorageJsonPatch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ParameterStorageJsonPatch' | Write-Debug
...
Convert from JSON to ParameterStorageJsonPatch<PSCustomObject>
...
ParameterStorageJsonPatch<PSCustomObject>
#>
function ConvertFrom-V2025JsonToParameterStorageJsonPatch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ParameterStorageJsonPatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ParameterStorageJsonPatch

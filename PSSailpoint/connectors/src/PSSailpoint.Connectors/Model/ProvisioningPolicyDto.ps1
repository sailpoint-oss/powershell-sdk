...
function Initialize-ProvisioningPolicyDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Connectors => ProvisioningPolicyDto' | Write-Debug
...
function ConvertFrom-JsonToProvisioningPolicyDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Connectors => ProvisioningPolicyDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

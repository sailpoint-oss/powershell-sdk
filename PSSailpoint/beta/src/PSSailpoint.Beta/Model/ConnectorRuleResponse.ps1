...
function Initialize-BetaConnectorRuleResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToConnectorRuleResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay<PSCustomObject>
#>
function ConvertFrom-V2026JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay

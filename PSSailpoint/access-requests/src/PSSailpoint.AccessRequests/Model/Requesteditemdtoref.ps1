...
function Initialize-Requesteditemdtoref {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestsV1 => Requesteditemdtoref' | Write-Debug
...
function ConvertFrom-JsonToRequesteditemdtoref {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestsV1 => Requesteditemdtoref' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

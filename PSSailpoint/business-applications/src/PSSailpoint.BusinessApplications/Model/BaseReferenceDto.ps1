...
function Initialize-BaseReferenceDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.BusinessApplications => BaseReferenceDto' | Write-Debug
...
function ConvertFrom-JsonToBaseReferenceDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.BusinessApplications => BaseReferenceDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

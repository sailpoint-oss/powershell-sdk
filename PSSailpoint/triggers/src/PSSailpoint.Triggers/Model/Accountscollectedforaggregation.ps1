...
function Initialize-Accountscollectedforaggregation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Accountscollectedforaggregation' | Write-Debug
...
Accountscollectedforaggregation<PSCustomObject>
#>
function ConvertFrom-JsonToAccountscollectedforaggregation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Accountscollectedforaggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accountscollectedforaggregation

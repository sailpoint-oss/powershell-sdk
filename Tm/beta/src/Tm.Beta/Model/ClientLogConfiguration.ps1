...
function Initialize-BetaClientLogConfiguration {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaClientLogConfiguration' | Write-Debug
...
function ConvertFrom-BetaJsonToClientLogConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaClientLogConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

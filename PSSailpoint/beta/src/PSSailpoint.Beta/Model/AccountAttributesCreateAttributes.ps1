...
function Initialize-BetaAccountAttributesCreateAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesCreateAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesCreateAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesCreateAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

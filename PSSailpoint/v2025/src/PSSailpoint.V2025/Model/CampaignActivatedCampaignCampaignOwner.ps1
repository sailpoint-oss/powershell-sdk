...
function Initialize-V2025CampaignActivatedCampaignCampaignOwner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CampaignActivatedCampaignCampaignOwner' | Write-Debug
...
CampaignActivatedCampaignCampaignOwner<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCampaignActivatedCampaignCampaignOwner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CampaignActivatedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CampaignActivatedCampaignCampaignOwner

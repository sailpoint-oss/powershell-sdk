...
function Initialize-V2024RoleMiningPotentialRoleProvisionRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningPotentialRoleProvisionRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningPotentialRoleProvisionRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningPotentialRoleProvisionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

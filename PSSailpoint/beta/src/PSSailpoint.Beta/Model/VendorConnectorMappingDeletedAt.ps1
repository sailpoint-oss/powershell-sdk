...
function Initialize-BetaVendorConnectorMappingDeletedAt {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaVendorConnectorMappingDeletedAt' | Write-Debug
...
function ConvertFrom-BetaJsonToVendorConnectorMappingDeletedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaVendorConnectorMappingDeletedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024RoleMiningEntitlement {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RoleMiningEntitlement' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RoleMiningEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

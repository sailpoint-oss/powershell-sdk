...
function Initialize-V2025UpdateMultiHostSourcesRequestInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025UpdateMultiHostSourcesRequestInner' | Write-Debug
...
UpdateMultiHostSourcesRequestInner<PSCustomObject>
#>
function ConvertFrom-V2025JsonToUpdateMultiHostSourcesRequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025UpdateMultiHostSourcesRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025UpdateMultiHostSourcesRequestInner

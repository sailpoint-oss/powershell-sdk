...
function Initialize-V2024SearchAggregationSpecification {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SearchAggregationSpecification' | Write-Debug
...
function ConvertFrom-V2024JsonToSearchAggregationSpecification {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SourceAccountCreated {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024SourceAccountCreated' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceAccountCreated {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024SourceAccountCreated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccessItemAppResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessItemAppResponse' | Write-Debug
...
AccessItemAppResponse<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAccessItemAppResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessItemAppResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026TenantConfigurationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TenantConfigurationRequest' | Write-Debug
...
TenantConfigurationRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTenantConfigurationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TenantConfigurationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TenantConfigurationRequest

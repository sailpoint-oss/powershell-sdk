...
function Initialize-AccessItemRequestedFor {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => AccessItemRequestedFor' | Write-Debug
...
function ConvertFrom-JsonToAccessItemRequestedFor {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => AccessItemRequestedFor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

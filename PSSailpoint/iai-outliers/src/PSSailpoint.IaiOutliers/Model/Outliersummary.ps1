...
function Initialize-Outliersummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiOutliersV1 => Outliersummary' | Write-Debug
...
Outliersummary<PSCustomObject>
#>
function ConvertFrom-JsonToOutliersummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiOutliersV1 => Outliersummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Outliersummary

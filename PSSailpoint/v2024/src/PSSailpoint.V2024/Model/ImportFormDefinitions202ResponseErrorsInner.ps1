...
function Initialize-V2024ImportFormDefinitions202ResponseErrorsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ImportFormDefinitions202ResponseErrorsInner' | Write-Debug
...
function ConvertFrom-V2024JsonToImportFormDefinitions202ResponseErrorsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ImportFormDefinitions202ResponseErrorsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

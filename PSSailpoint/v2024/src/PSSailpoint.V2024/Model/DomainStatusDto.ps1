...
function Initialize-V2024DomainStatusDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024DomainStatusDto' | Write-Debug
...
DomainStatusDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToDomainStatusDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024DomainStatusDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024DomainStatusDto
        $AllProperties = ("id", "domain", "dkimEnabled", "dkimTokens", "dkimVerificationStatus", "region")

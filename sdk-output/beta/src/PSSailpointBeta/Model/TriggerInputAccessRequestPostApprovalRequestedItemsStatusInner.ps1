...
TriggerInputAccessRequestPostApprovalRequestedItemsStatusInner<PSCustomObject>
#>

function Initialize-BetaTriggerInputAccessRequestPostApprovalRequestedItemsStatusInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputAccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
...
Convert from JSON to TriggerInputAccessRequestPostApprovalRequestedItemsStatusInner<PSCustomObject>
...
TriggerInputAccessRequestPostApprovalRequestedItemsStatusInner<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputAccessRequestPostApprovalRequestedItemsStatusInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputAccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputAccessRequestPostApprovalRequestedItemsStatusInner

...
function Initialize-BetaWorkflowExecutionEvent {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaWorkflowExecutionEvent' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowExecutionEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaWorkflowExecutionEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

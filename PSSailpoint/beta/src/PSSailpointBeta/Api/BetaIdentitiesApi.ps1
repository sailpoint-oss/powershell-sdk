...
None
#>
function Invoke-BetaCheckIdentityExists {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-BetaCheckIdentityExists' | Write-Debug
        ...
        if (!$IdentityId) {
            throw "Error! The required parameter `IdentityId` missing when calling checkIdentityExists."
        }

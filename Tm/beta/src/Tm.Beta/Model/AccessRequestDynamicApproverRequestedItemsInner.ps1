...
function Initialize-BetaAccessRequestDynamicApproverRequestedItemsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestDynamicApproverRequestedItemsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

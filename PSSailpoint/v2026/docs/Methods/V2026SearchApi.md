...
keywords: ['powershell', 'PowerShell', 'sdk', 'Search', 'V2026Search'] 
slug: /tools/sdk/powershell/v2026/methods/search
...
------------- | ------------- | -------------
[**Search-V2026Aggregate**](#search-aggregate) | **POST** `/search/aggregate` | Perform a search query aggregation
[**Search-V2026Count**](#search-count) | **POST** `/search/count` | Count documents satisfying a query
[**Search-V2026Get**](#search-get) | **GET** `/search/{index}/{id}` | Get a document by id
[**Search-V2026Post**](#search-post) | **POST** `/search` | Perform search
...
try {
    $Result = ConvertFrom-V2026JsonToSearch -Json $Search
    Search-V2026Aggregate -Search $Result 
    
    # Below is a request that includes all optional parameters
    # Search-V2026Aggregate -Search $Result -Offset $Offset -Limit $Limit -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Search-V2026Aggregate"
...
try {
    $Result = ConvertFrom-V2026JsonToSearch -Json $Search
    Search-V2026Count -Search $Result 
    
    # Below is a request that includes all optional parameters
    # Search-V2026Count -Search $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Search-V2026Count"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Search-V2026Get -Index $Index -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Search-V2026Get -Index $Index -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Search-V2026Get"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSearch -Json $Search
    Search-V2026Post -Search $Result 
    
    # Below is a request that includes all optional parameters
    # Search-V2026Post -Search $Result -Offset $Offset -Limit $Limit -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Search-V2026Post"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

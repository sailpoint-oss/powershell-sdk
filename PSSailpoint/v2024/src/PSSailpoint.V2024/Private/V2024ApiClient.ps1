...
function Invoke-V2024ApiClient {
    ...
    'Calling method: Invoke-V2024ApiClient' | Write-Debug
    $PSBoundParameters | Out-DebugParameter | Write-Debug

    $Configuration = Get-DefaultConfiguration
    $RequestUri = $Configuration["BaseUrl"] + "v2024" + $Uri
    ...
    # Add Custom Header
    $HeaderParameters['X-SailPoint-SDK'] = "Powershell-1.7.14"
    $HeaderParameters['User-Agent'] = "OpenAPI-Generator/1.7.14/ps"

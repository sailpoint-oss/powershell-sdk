...
function Initialize-V2026SearchFormDefinitionsByTenant400Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SearchFormDefinitionsByTenant400Response' | Write-Debug
...
SearchFormDefinitionsByTenant400Response<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSearchFormDefinitionsByTenant400Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SearchFormDefinitionsByTenant400Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SearchFormDefinitionsByTenant400Response

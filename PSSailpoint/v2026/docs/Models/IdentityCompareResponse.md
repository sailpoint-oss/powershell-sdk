...
keywords: ['powershell', 'PowerShell', 'sdk', 'IdentityCompareResponse', 'V2026IdentityCompareResponse'] 
slug: /tools/sdk/powershell/v2026/models/identity-compare-response
...
```powershell
$IdentityCompareResponse = Initialize-V2026IdentityCompareResponse  -AccessItemDiff null
```

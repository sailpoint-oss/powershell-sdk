...
function Initialize-BetaSourceAccountCreated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSourceAccountCreated' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceAccountCreated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSourceAccountCreated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Approvalrequestedtarget {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApprovalsV1 => Approvalrequestedtarget' | Write-Debug
...
Approvalrequestedtarget<PSCustomObject>
#>
function ConvertFrom-JsonToApprovalrequestedtarget {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApprovalsV1 => Approvalrequestedtarget' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Approvalrequestedtarget

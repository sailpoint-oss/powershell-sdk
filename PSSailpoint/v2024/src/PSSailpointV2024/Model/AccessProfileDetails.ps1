...
function Initialize-V2024AccessProfileDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

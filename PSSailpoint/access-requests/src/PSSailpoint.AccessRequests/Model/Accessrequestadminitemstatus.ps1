...
function Initialize-Accessrequestadminitemstatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestsV1 => Accessrequestadminitemstatus' | Write-Debug
...
Accessrequestadminitemstatus<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestadminitemstatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestsV1 => Accessrequestadminitemstatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

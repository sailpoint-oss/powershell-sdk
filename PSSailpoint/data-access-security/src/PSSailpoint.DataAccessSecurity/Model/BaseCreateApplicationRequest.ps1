...
function Initialize-BaseCreateApplicationRequest {
    [CmdletBinding()]
    Param (
...
BaseCreateApplicationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToBaseCreateApplicationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in BaseCreateApplicationRequest

...
function Initialize-IdentityDocumentAllOfIdentityProfile {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => IdentityDocumentAllOfIdentityProfile' | Write-Debug
...
function ConvertFrom-JsonToIdentityDocumentAllOfIdentityProfile {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => IdentityDocumentAllOfIdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

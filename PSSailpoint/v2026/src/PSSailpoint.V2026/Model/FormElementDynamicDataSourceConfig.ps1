...
function Initialize-V2026FormElementDynamicDataSourceConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026FormElementDynamicDataSourceConfig' | Write-Debug
...
FormElementDynamicDataSourceConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToFormElementDynamicDataSourceConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026FormElementDynamicDataSourceConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026FormElementDynamicDataSourceConfig

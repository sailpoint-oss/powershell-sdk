...
keywords: ['powershell', 'PowerShell', 'sdk', 'RequestedItemAccountSelections', 'V2026RequestedItemAccountSelections'] 
slug: /tools/sdk/powershell/v2026/models/requested-item-account-selections
...
```powershell
$RequestedItemAccountSelections = Initialize-V2026RequestedItemAccountSelections  -Description An access profile for the admins `

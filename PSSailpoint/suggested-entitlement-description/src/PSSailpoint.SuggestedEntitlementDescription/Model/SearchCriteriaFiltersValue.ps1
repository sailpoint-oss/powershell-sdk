...
function Initialize-SearchCriteriaFiltersValue {
    [CmdletBinding()]
    Param (
...
SearchCriteriaFiltersValue<PSCustomObject>
#>
function ConvertFrom-JsonToSearchCriteriaFiltersValue {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SearchCriteriaFiltersValue

...
function Initialize-Machineidentityuserentitlementresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentitiesV1 => Machineidentityuserentitlementresponse' | Write-Debug
...
Machineidentityuserentitlementresponse<PSCustomObject>
#>
function ConvertFrom-JsonToMachineidentityuserentitlementresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentitiesV1 => Machineidentityuserentitlementresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Machineidentityuserentitlementresponse

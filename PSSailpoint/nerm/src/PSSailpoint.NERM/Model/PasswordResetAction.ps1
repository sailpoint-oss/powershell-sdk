...
PasswordResetAction<PSCustomObject>
#>

function Initialize-NERMPasswordResetAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMPasswordResetAction' | Write-Debug
...
Convert from JSON to PasswordResetAction<PSCustomObject>
...
PasswordResetAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToPasswordResetAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMPasswordResetAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMPasswordResetAction

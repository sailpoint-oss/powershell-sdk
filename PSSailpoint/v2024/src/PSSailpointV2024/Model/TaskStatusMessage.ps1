...
function Initialize-V2024TaskStatusMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TaskStatusMessage' | Write-Debug
...
function ConvertFrom-V2024JsonToTaskStatusMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TaskStatusMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

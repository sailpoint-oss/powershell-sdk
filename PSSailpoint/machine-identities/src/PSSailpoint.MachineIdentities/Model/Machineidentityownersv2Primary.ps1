...
Machineidentityownersv2Primary<PSCustomObject>
#>

function Initialize-Machineidentityownersv2Primary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentities => Machineidentityownersv2Primary' | Write-Debug
...
Convert from JSON to Machineidentityownersv2Primary<PSCustomObject>
...
Machineidentityownersv2Primary<PSCustomObject>
#>
function ConvertFrom-JsonToMachineidentityownersv2Primary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentities => Machineidentityownersv2Primary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Machineidentityownersv2Primary

...
function Initialize-V2026DependantConnectionsMissingDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026DependantConnectionsMissingDto' | Write-Debug
...
DependantConnectionsMissingDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToDependantConnectionsMissingDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026DependantConnectionsMissingDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026DependantConnectionsMissingDto

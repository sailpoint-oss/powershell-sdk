...
function Initialize-IdentityProfileIdentityErrorReportArguments {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityProfileIdentityErrorReportArguments' | Write-Debug
...
function ConvertFrom-JsonToIdentityProfileIdentityErrorReportArguments {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityProfileIdentityErrorReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-PasswordInfoAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => PasswordInfoAccount' | Write-Debug
...
PasswordInfoAccount<PSCustomObject>
#>
function ConvertFrom-JsonToPasswordInfoAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => PasswordInfoAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PasswordInfoAccount

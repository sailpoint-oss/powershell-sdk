...
function Initialize-V2026SimIntegrationDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SimIntegrationDetails' | Write-Debug
...
SimIntegrationDetails<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSimIntegrationDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SimIntegrationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SimIntegrationDetails

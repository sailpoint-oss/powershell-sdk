...
Search1<PSCustomObject>
#>

function Initialize-Search1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => Search1' | Write-Debug
...
Convert from JSON to Search1<PSCustomObject>
...
Search1<PSCustomObject>
#>
function ConvertFrom-JsonToSearch1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => Search1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Search1

...
function Initialize-Roleminingpotentialrolesummary {
    [CmdletBinding()]
    Param (
...
Roleminingpotentialrolesummary<PSCustomObject>
#>
function ConvertFrom-JsonToRoleminingpotentialrolesummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Roleminingpotentialrolesummary

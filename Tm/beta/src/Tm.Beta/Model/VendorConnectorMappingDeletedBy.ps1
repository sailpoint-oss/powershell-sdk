...
function Initialize-BetaVendorConnectorMappingDeletedBy {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaVendorConnectorMappingDeletedBy' | Write-Debug
...
function ConvertFrom-BetaJsonToVendorConnectorMappingDeletedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaVendorConnectorMappingDeletedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

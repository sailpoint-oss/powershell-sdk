...
keywords: ['powershell', 'PowerShell', 'sdk', 'V3ConnectorDto', 'V2026V3ConnectorDto'] 
slug: /tools/sdk/powershell/v2026/models/v3-connector-dto
...
```powershell
$V3ConnectorDto = Initialize-V2026V3ConnectorDto  -Name name `
 -Type ServiceNow `

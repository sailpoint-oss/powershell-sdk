...
TemplateDtoSlackTemplate<PSCustomObject>
#>

function Initialize-V2024TemplateDtoSlackTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TemplateDtoSlackTemplate' | Write-Debug
...
Convert from JSON to TemplateDtoSlackTemplate<PSCustomObject>
...
TemplateDtoSlackTemplate<PSCustomObject>
#>
function ConvertFrom-V2024JsonToTemplateDtoSlackTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TemplateDtoSlackTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024TemplateDtoSlackTemplate

...
function Initialize-MachineAccountSubtypeConfigDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountSubtypes => MachineAccountSubtypeConfigDto' | Write-Debug
...
function ConvertFrom-JsonToMachineAccountSubtypeConfigDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountSubtypes => MachineAccountSubtypeConfigDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaManagedCluster {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaManagedCluster' | Write-Debug
...
function ConvertFrom-BetaJsonToManagedCluster {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaManagedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

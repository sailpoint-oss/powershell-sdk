...
function Initialize-BetaAccessRequestDynamicApprover {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestDynamicApprover' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestDynamicApprover {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestDynamicApprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024WorkflowExecutionEvent {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024WorkflowExecutionEvent' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowExecutionEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024WorkflowExecutionEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
```powershell
$TriggerInputSourceAccountUpdated = Initialize-PSSailpointBetaTriggerInputSourceAccountUpdated  -Uuid b7264868-7201-415f-9118-b581d431c688 `
...
```powershell
$TriggerInputSourceAccountUpdated | ConvertTo-JSON
```

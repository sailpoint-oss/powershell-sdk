...
function Initialize-V2024VendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024VendorConnectorMappingUpdatedBy' | Write-Debug
...
function ConvertFrom-V2024JsonToVendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024VendorConnectorMappingUpdatedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

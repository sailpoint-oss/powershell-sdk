...
function Initialize-SubscriptionpatchrequestInner {
    [CmdletBinding()]
    Param (
...
SubscriptionpatchrequestInner<PSCustomObject>
#>
function ConvertFrom-JsonToSubscriptionpatchrequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SubscriptionpatchrequestInner

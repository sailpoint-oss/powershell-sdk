...
function Initialize-V2026DecomposeDiacriticalMarks {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026DecomposeDiacriticalMarks' | Write-Debug
...
DecomposeDiacriticalMarks<PSCustomObject>
#>
function ConvertFrom-V2026JsonToDecomposeDiacriticalMarks {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026DecomposeDiacriticalMarks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026DecomposeDiacriticalMarks

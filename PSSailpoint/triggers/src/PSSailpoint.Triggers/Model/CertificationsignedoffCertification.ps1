...
function Initialize-CertificationsignedoffCertification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => CertificationsignedoffCertification' | Write-Debug
...
CertificationsignedoffCertification<PSCustomObject>
#>
function ConvertFrom-JsonToCertificationsignedoffCertification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => CertificationsignedoffCertification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CertificationsignedoffCertification

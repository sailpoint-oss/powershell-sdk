...
function Initialize-BetaQueuedCheckConfigDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaQueuedCheckConfigDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToQueuedCheckConfigDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaQueuedCheckConfigDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

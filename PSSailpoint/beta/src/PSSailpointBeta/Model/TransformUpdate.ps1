...
TransformUpdate<PSCustomObject>
#>

function Initialize-BetaTransformUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTransformUpdate' | Write-Debug
...
Convert from JSON to TransformUpdate<PSCustomObject>
...
TransformUpdate<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTransformUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTransformUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTransformUpdate

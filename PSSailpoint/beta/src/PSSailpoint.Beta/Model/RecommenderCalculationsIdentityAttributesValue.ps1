...
function Initialize-BetaRecommenderCalculationsIdentityAttributesValue {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRecommenderCalculationsIdentityAttributesValue' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommenderCalculationsIdentityAttributesValue {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRecommenderCalculationsIdentityAttributesValue' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

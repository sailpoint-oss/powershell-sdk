...
function Initialize-V2024NonEmployeeApprovalItemDetail {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024NonEmployeeApprovalItemDetail' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeApprovalItemDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024NonEmployeeApprovalItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

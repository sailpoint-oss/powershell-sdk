...
function Initialize-V2024ProvisioningCompleted {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ProvisioningCompleted' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ProvisioningCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

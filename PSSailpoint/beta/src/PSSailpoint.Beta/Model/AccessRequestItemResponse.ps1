...
function Initialize-BetaAccessRequestItemResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequestItemResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequestItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

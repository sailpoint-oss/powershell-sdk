...
slug: /tools/sdk/powershell/notifications/models/notification-template-context
...
------------ | ------------- | ------------- | -------------
**Attributes** | **map[string]AnyType** | A JSON object that stores the context. | [optional] 

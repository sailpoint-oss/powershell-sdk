...
function Initialize-V2024FormCondition {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024FormCondition' | Write-Debug
...
function ConvertFrom-V2024JsonToFormCondition {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024FormCondition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeBulkUploadStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeBulkUploadStatus' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeBulkUploadStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeBulkUploadStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

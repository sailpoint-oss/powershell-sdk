...
function Initialize-AccountToggleRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccountToggleRequest' | Write-Debug
...
function ConvertFrom-JsonToAccountToggleRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccountToggleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

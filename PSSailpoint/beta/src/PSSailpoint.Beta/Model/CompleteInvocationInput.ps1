...
function Initialize-BetaCompleteInvocationInput {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCompleteInvocationInput' | Write-Debug
...
function ConvertFrom-BetaJsonToCompleteInvocationInput {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCompleteInvocationInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

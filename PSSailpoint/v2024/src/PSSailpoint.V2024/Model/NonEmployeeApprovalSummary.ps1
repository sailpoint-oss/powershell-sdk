...
function Initialize-V2024NonEmployeeApprovalSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeApprovalSummary' | Write-Debug
...
NonEmployeeApprovalSummary<PSCustomObject>
#>
function ConvertFrom-V2024JsonToNonEmployeeApprovalSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeApprovalSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024NonEmployeeApprovalSummary

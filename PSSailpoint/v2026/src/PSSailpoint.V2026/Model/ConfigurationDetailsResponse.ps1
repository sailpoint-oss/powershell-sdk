...
function Initialize-V2026ConfigurationDetailsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ConfigurationDetailsResponse' | Write-Debug
...
ConfigurationDetailsResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToConfigurationDetailsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ConfigurationDetailsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ConfigurationDetailsResponse

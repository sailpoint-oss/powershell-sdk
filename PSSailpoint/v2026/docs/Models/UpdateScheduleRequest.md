...
keywords: ['powershell', 'PowerShell', 'sdk', 'UpdateScheduleRequest', 'V2026UpdateScheduleRequest'] 
slug: /tools/sdk/powershell/v2026/models/update-schedule-request
...
```powershell
$UpdateScheduleRequest = Initialize-V2026UpdateScheduleRequest  -TaskTypeName DataSync `
 -ScheduleType Daily `
 -Interval 1440 `

...
function Initialize-BetaEntitlementRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaEntitlementRef' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaEntitlementRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

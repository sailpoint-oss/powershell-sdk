...
function Initialize-V2026RoleAssignmentDtoAssignmentContext {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleAssignmentDtoAssignmentContext' | Write-Debug
...
RoleAssignmentDtoAssignmentContext<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleAssignmentDtoAssignmentContext {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleAssignmentDtoAssignmentContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleAssignmentDtoAssignmentContext

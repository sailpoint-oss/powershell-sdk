...
function Initialize-BetaConfigurationItemRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConfigurationItemRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToConfigurationItemRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConfigurationItemRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

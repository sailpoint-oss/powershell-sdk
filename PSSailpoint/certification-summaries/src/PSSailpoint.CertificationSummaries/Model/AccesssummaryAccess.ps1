...
function Initialize-AccesssummaryAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationSummariesV1 => AccesssummaryAccess' | Write-Debug
...
AccesssummaryAccess<PSCustomObject>
#>
function ConvertFrom-JsonToAccesssummaryAccess {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationSummariesV1 => AccesssummaryAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccesssummaryAccess

...
function Initialize-ServiceProviderConfiguration {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ServiceProviderConfiguration' | Write-Debug
...
function ConvertFrom-JsonToServiceProviderConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ServiceProviderConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

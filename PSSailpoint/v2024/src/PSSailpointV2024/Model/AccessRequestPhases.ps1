...
function Initialize-V2024AccessRequestPhases {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequestPhases' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestPhases {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequestPhases' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

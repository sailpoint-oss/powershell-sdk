...
function Initialize-SourceBeforeProvisioningRule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => SourceBeforeProvisioningRule' | Write-Debug
...
function ConvertFrom-JsonToSourceBeforeProvisioningRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => SourceBeforeProvisioningRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

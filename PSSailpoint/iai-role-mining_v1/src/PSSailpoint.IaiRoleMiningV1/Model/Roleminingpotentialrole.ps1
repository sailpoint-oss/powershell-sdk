...
function Initialize-Roleminingpotentialrole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingpotentialrole' | Write-Debug
...
Roleminingpotentialrole<PSCustomObject>
#>
function ConvertFrom-JsonToRoleminingpotentialrole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingpotentialrole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleminingpotentialrole

...
ViolationPrediction
#>
function Start-V2026PredictSodViolations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Start-V2026PredictSodViolations' | Write-Debug
...
SodViolationCheck
#>
function Start-V2026ViolationCheck {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Start-V2026ViolationCheck' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

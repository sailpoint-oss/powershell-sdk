...
keywords: ['powershell', 'PowerShell', 'sdk', 'BulkApproveEntitlementRecommendationResult', 'V2026BulkApproveEntitlementRecommendationResult'] 
slug: /tools/sdk/powershell/v2026/models/bulk-approve-entitlement-recommendation-result
...
```powershell
$BulkApproveEntitlementRecommendationResult = Initialize-V2026BulkApproveEntitlementRecommendationResult  -Id 79db50d4-723c-4aa0-a824-83c2205d82d1 `
 -Status SUCCESS `
 -FailedReason null
```

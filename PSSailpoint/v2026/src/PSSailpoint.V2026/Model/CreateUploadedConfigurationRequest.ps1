...
function Initialize-V2026CreateUploadedConfigurationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CreateUploadedConfigurationRequest' | Write-Debug
...
CreateUploadedConfigurationRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCreateUploadedConfigurationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CreateUploadedConfigurationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CreateUploadedConfigurationRequest

...
function Initialize-V2024CampaignActivatedCampaign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignActivatedCampaign' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignActivatedCampaign {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignActivatedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

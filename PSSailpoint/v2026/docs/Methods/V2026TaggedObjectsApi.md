...
keywords: ['powershell', 'PowerShell', 'sdk', 'TaggedObjects', 'V2026TaggedObjects'] 
slug: /tools/sdk/powershell/v2026/methods/tagged-objects
...
------------- | ------------- | -------------
[**Remove-V2026TaggedObject**](#delete-tagged-object) | **DELETE** `/tagged-objects/{type}/{id}` | Delete object tags
[**Remove-V2026TagsToManyObject**](#delete-tags-to-many-object) | **POST** `/tagged-objects/bulk-remove` | Remove tags from multiple objects
[**Get-V2026TaggedObject**](#get-tagged-object) | **GET** `/tagged-objects/{type}/{id}` | Get tagged object
[**Get-V2026TaggedObjects**](#list-tagged-objects) | **GET** `/tagged-objects` | List tagged objects
[**Get-V2026TaggedObjectsByType**](#list-tagged-objects-by-type) | **GET** `/tagged-objects/{type}` | List tagged objects by type
[**Send-V2026TaggedObject**](#put-tagged-object) | **PUT** `/tagged-objects/{type}/{id}` | Update tagged object
[**Set-V2026TagToObject**](#set-tag-to-object) | **POST** `/tagged-objects` | Add tag to object
[**Set-V2026TagsToManyObjects**](#set-tags-to-many-objects) | **POST** `/tagged-objects/bulk-add` | Tag multiple objects
...
try {
    Remove-V2026TaggedObject -Type $Type -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026TaggedObject -Type $Type -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026TaggedObject"
...
try {
    $Result = ConvertFrom-V2026JsonToBulkRemoveTaggedObject -Json $BulkRemoveTaggedObject
    Remove-V2026TagsToManyObject -BulkRemoveTaggedObject $Result 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026TagsToManyObject -BulkRemoveTaggedObject $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026TagsToManyObject"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026TaggedObject -Type $Type -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026TaggedObject -Type $Type -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026TaggedObject"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026TaggedObjects 
    
    # Below is a request that includes all optional parameters
    # Get-V2026TaggedObjects -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026TaggedObjects"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026TaggedObjectsByType -Type $Type 
    
    # Below is a request that includes all optional parameters
    # Get-V2026TaggedObjectsByType -Type $Type -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026TaggedObjectsByType"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToTaggedObject -Json $TaggedObject
    Send-V2026TaggedObject -Type $Type -Id $Id -TaggedObject $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026TaggedObject -Type $Type -Id $Id -TaggedObject $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026TaggedObject"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToTaggedObject -Json $TaggedObject
    Set-V2026TagToObject -TaggedObject $Result 
    
    # Below is a request that includes all optional parameters
    # Set-V2026TagToObject -TaggedObject $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Set-V2026TagToObject"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToBulkAddTaggedObject -Json $BulkAddTaggedObject
    Set-V2026TagsToManyObjects -BulkAddTaggedObject $Result 
    
    # Below is a request that includes all optional parameters
    # Set-V2026TagsToManyObjects -BulkAddTaggedObject $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Set-V2026TagsToManyObjects"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-V2024FieldDetailsDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024FieldDetailsDto' | Write-Debug
...
function ConvertFrom-V2024JsonToFieldDetailsDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024FieldDetailsDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

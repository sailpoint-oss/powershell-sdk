...
function Initialize-BetaCancelableAccountActivity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCancelableAccountActivity' | Write-Debug
...
function ConvertFrom-BetaJsonToCancelableAccountActivity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCancelableAccountActivity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaLoadEntitlementTask {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaLoadEntitlementTask' | Write-Debug
...
function ConvertFrom-BetaJsonToLoadEntitlementTask {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaLoadEntitlementTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
GetAccessRequestConfigV1401Response<PSCustomObject>
#>

function Initialize-GetAccessRequestConfigV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to GetAccessRequestConfigV1401Response<PSCustomObject>
...
GetAccessRequestConfigV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAccessRequestConfigV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in GetAccessRequestConfigV1401Response
        $AllProperties = ("error")

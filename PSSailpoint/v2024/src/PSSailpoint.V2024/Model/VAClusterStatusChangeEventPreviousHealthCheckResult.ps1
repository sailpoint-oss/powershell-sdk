...
function Initialize-V2024VAClusterStatusChangeEventPreviousHealthCheckResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
...
VAClusterStatusChangeEventPreviousHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-V2024JsonToVAClusterStatusChangeEventPreviousHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024VAClusterStatusChangeEventPreviousHealthCheckResult

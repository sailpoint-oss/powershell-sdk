...
function Initialize-V2024PublicIdentityConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024PublicIdentityConfig' | Write-Debug
...
PublicIdentityConfig<PSCustomObject>
#>
function ConvertFrom-V2024JsonToPublicIdentityConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024PublicIdentityConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024PublicIdentityConfig

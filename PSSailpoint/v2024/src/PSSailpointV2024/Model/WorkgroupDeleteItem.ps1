...
function Initialize-V2024WorkgroupDeleteItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkgroupDeleteItem' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkgroupDeleteItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkgroupDeleteItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

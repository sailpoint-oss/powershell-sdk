...
ApprovalScheme<PSCustomObject>
#>

function Initialize-BetaApprovalScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaApprovalScheme' | Write-Debug
...
Convert from JSON to ApprovalScheme<PSCustomObject>
...
ApprovalScheme<PSCustomObject>
#>
function ConvertFrom-BetaJsonToApprovalScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaApprovalScheme

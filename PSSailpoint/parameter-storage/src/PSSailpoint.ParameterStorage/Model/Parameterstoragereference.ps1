...
function Initialize-Parameterstoragereference {
    [CmdletBinding()]
    Param (
...
Parameterstoragereference<PSCustomObject>
#>
function ConvertFrom-JsonToParameterstoragereference {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Parameterstoragereference

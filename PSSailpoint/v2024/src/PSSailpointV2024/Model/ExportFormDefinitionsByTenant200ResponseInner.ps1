...
function Initialize-V2024ExportFormDefinitionsByTenant200ResponseInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ExportFormDefinitionsByTenant200ResponseInner' | Write-Debug
...
function ConvertFrom-V2024JsonToExportFormDefinitionsByTenant200ResponseInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ExportFormDefinitionsByTenant200ResponseInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

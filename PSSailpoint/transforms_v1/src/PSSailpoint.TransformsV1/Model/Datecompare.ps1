...
function Initialize-Datecompare {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Datecompare' | Write-Debug
...
Datecompare<PSCustomObject>
#>
function ConvertFrom-JsonToDatecompare {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Datecompare' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Datecompare

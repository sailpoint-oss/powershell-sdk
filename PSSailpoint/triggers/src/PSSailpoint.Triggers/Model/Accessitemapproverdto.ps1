...
function Initialize-Accessitemapproverdto {
    [CmdletBinding()]
    Param (
...
Accessitemapproverdto<PSCustomObject>
#>
function ConvertFrom-JsonToAccessitemapproverdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Accessitemapproverdto

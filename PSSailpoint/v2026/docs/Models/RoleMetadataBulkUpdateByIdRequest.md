...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMetadataBulkUpdateByIdRequest', 'V2026RoleMetadataBulkUpdateByIdRequest'] 
slug: /tools/sdk/powershell/v2026/models/role-metadata-bulk-update-by-id-request
...
```powershell
$RoleMetadataBulkUpdateByIdRequest = Initialize-V2026RoleMetadataBulkUpdateByIdRequest  -Roles [b1db89554cfa431cb8b9921ea38d9367] `
 -Operation REPLACE `
 -ReplaceScope ALL `

...
function Initialize-ObjectMappingBulkCreateRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ObjectMappingBulkCreateRequest' | Write-Debug
...
function ConvertFrom-JsonToObjectMappingBulkCreateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ObjectMappingBulkCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

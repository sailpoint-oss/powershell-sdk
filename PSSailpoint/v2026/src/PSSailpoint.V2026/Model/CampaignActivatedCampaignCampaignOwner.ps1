...
function Initialize-V2026CampaignActivatedCampaignCampaignOwner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CampaignActivatedCampaignCampaignOwner' | Write-Debug
...
CampaignActivatedCampaignCampaignOwner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCampaignActivatedCampaignCampaignOwner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CampaignActivatedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CampaignActivatedCampaignCampaignOwner

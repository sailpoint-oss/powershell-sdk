...
function Initialize-AccessRequestPreApprovalRequestedItemsInner {
    [CmdletBinding()]
    Param (
...
AccessRequestPreApprovalRequestedItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToAccessRequestPreApprovalRequestedItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccessRequestPreApprovalRequestedItemsInner

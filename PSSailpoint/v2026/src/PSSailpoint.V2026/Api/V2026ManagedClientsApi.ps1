...
ManagedClient
#>
function New-V2026ManagedClient {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026ManagedClient' | Write-Debug
...
None
#>
function Remove-V2026ManagedClient {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClient
#>
function Get-V2026ManagedClient {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026ManagedClientHealthIndicators {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ManagedClientHealthIndicators' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClientStatus
#>
function Get-V2026ManagedClientStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ManagedClientStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClient[]
#>
function Get-V2026ManagedClients {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026ManagedClients' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClient
#>
function Update-V2026ManagedClient {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026IdentityAttributeTransform {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IdentityAttributeTransform' | Write-Debug
...
IdentityAttributeTransform<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIdentityAttributeTransform {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IdentityAttributeTransform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IdentityAttributeTransform

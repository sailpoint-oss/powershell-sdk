...
function Initialize-V2026CampaignGeneratedCampaignCampaignOwner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CampaignGeneratedCampaignCampaignOwner' | Write-Debug
...
CampaignGeneratedCampaignCampaignOwner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCampaignGeneratedCampaignCampaignOwner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CampaignGeneratedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CampaignGeneratedCampaignCampaignOwner

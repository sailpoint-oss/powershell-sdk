...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApplicationItem', 'V2026ApplicationItem'] 
slug: /tools/sdk/powershell/v2026/models/application-item
...
```powershell
$ApplicationItem = Initialize-V2026ApplicationItem  -Id 12345 `
 -Name HR File Server `

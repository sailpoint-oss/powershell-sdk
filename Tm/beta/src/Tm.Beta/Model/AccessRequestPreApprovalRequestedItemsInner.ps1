...
function Initialize-BetaAccessRequestPreApprovalRequestedItemsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestPreApprovalRequestedItemsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPreApprovalRequestedItemsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestPreApprovalRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

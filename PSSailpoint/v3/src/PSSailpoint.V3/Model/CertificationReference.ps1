...
function Initialize-CertificationReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CertificationReference' | Write-Debug
...
function ConvertFrom-JsonToCertificationReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CertificationReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

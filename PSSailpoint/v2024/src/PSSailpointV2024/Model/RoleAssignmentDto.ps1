...
function Initialize-V2024RoleAssignmentDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleAssignmentDto' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleAssignmentDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleAssignmentDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

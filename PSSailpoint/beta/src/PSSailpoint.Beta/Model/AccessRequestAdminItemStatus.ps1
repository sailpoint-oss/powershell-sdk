...
function Initialize-BetaAccessRequestAdminItemStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequestAdminItemStatus' | Write-Debug
...
AccessRequestAdminItemStatus<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAccessRequestAdminItemStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequestAdminItemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaAccessRequestAdminItemStatus

...
function Initialize-Entitlementref {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfiles => Entitlementref' | Write-Debug
...
function ConvertFrom-JsonToEntitlementref {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfiles => Entitlementref' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-AccessProfileDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessProfileDocument' | Write-Debug
...
function ConvertFrom-JsonToAccessProfileDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessProfileDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Accessrequestrecommendationactionitemdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiAccessRequestRecommendationsV1 => Accessrequestrecommendationactionitemdto' | Write-Debug
...
Accessrequestrecommendationactionitemdto<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestrecommendationactionitemdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiAccessRequestRecommendationsV1 => Accessrequestrecommendationactionitemdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessrequestrecommendationactionitemdto

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalForwardHistory1', 'BetaApprovalForwardHistory1'] 
slug: /tools/sdk/powershell/beta/models/approval-forward-history1
...
```powershell
$ApprovalForwardHistory1 = Initialize-BetaApprovalForwardHistory1  -OldApproverName Frank Mir `

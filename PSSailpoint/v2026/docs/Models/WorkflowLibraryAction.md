...
keywords: ['powershell', 'PowerShell', 'sdk', 'WorkflowLibraryAction', 'V2026WorkflowLibraryAction'] 
slug: /tools/sdk/powershell/v2026/models/workflow-library-action
...
```powershell
$WorkflowLibraryAction = Initialize-V2026WorkflowLibraryAction  -Id sp:create-campaign `

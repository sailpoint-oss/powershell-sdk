...
function Initialize-V2025CustomPasswordInstruction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CustomPasswordInstruction' | Write-Debug
...
CustomPasswordInstruction<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCustomPasswordInstruction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CustomPasswordInstruction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CustomPasswordInstruction

...
function Initialize-BetaCreateFormInstanceRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCreateFormInstanceRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateFormInstanceRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCreateFormInstanceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

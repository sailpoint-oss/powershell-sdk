...
function Initialize-Requesteditemstatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => Requesteditemstatus' | Write-Debug
...
function ConvertFrom-JsonToRequesteditemstatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => Requesteditemstatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

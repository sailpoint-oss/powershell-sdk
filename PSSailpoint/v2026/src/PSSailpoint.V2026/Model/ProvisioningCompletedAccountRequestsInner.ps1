...
function Initialize-V2026ProvisioningCompletedAccountRequestsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ProvisioningCompletedAccountRequestsInner' | Write-Debug
...
ProvisioningCompletedAccountRequestsInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToProvisioningCompletedAccountRequestsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ProvisioningCompletedAccountRequestsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ProvisioningCompletedAccountRequestsInner

...
function Initialize-V2026RoleInsightsInsight {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleInsightsInsight' | Write-Debug
...
RoleInsightsInsight<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleInsightsInsight {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleInsightsInsight' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleInsightsInsight

...
function Initialize-FieldDetailsDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Connectors => FieldDetailsDto' | Write-Debug
...
FieldDetailsDto<PSCustomObject>
#>
function ConvertFrom-JsonToFieldDetailsDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Connectors => FieldDetailsDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FieldDetailsDto

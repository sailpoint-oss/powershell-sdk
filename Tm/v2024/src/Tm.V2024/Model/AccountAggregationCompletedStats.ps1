...
function Initialize-V2024AccountAggregationCompletedStats {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccountAggregationCompletedStats' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAggregationCompletedStats {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccountAggregationCompletedStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

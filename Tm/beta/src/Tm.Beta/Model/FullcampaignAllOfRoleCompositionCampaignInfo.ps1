...
function Initialize-BetaFullcampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaFullcampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
...
function ConvertFrom-BetaJsonToFullcampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaFullcampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026OutlierFeatureSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026OutlierFeatureSummary' | Write-Debug
...
OutlierFeatureSummary<PSCustomObject>
#>
function ConvertFrom-V2026JsonToOutlierFeatureSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026OutlierFeatureSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026OutlierFeatureSummary

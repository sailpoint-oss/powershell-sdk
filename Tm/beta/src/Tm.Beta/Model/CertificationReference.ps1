...
function Initialize-BetaCertificationReference {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCertificationReference' | Write-Debug
...
function ConvertFrom-BetaJsonToCertificationReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCertificationReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

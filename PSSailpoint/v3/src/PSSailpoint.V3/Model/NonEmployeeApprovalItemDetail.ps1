...
function Initialize-NonEmployeeApprovalItemDetail {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalItemDetail' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeApprovalItemDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025AccessRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccessRequest' | Write-Debug
...
AccessRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccessRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccessRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

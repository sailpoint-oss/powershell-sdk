...
IdentityProfile
#>
function New-V2026IdentityProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026IdentityProfile' | Write-Debug
...
#>
function Remove-V2026IdentityProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026IdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaskResultSimplified
#>
function Remove-V2026IdentityProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String[]]
    ...
    Process {
        'Calling method: Remove-V2026IdentityProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Export-V2026IdentityProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Export-V2026IdentityProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function New-V2026IdentityPreview {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: New-V2026IdentityPreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026DefaultIdentityAttributeConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026DefaultIdentityAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityProfile
#>
function Get-V2026IdentityProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ObjectImportResult
#>
function Import-V2026IdentityProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Import-V2026IdentityProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityProfile[]
#>
function Get-V2026IdentityProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int32]]
    ...
    Process {
        'Calling method: Get-V2026IdentityProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Sync-V2026IdentityProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Sync-V2026IdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
IdentityProfile
#>
function Update-V2026IdentityProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026IdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

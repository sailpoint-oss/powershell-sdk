...
function Initialize-V2024ReviewableEntitlementAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ReviewableEntitlementAccount' | Write-Debug
...
ReviewableEntitlementAccount<PSCustomObject>
#>
function ConvertFrom-V2024JsonToReviewableEntitlementAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ReviewableEntitlementAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

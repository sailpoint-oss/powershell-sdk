...
function Initialize-AccessProfileBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessProfileBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-JsonToAccessProfileBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessProfileBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024IdentityCertificationDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityCertificationDto' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityCertificationDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityCertificationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

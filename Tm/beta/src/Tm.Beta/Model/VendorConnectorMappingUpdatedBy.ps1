...
function Initialize-BetaVendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaVendorConnectorMappingUpdatedBy' | Write-Debug
...
function ConvertFrom-BetaJsonToVendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaVendorConnectorMappingUpdatedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

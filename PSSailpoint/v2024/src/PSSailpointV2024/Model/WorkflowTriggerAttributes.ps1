...
function ConvertFrom-V2024JsonToWorkflowTriggerAttributes {
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'EventAttributes' defined in oneOf (V2024WorkflowTriggerAttributes). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'ExternalAttributes' defined in oneOf (V2024WorkflowTriggerAttributes). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'ScheduledAttributes' defined in oneOf (V2024WorkflowTriggerAttributes). Proceeding to the next one if any."
        }

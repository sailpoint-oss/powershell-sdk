...
function Initialize-BetaAccountCorrelatedAccount {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountCorrelatedAccount' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountCorrelatedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountCorrelatedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Rolemetadatabulkupdatebyidrequest {
    [CmdletBinding()]
    Param (
...
Rolemetadatabulkupdatebyidrequest<PSCustomObject>
#>
function ConvertFrom-JsonToRolemetadatabulkupdatebyidrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Rolemetadatabulkupdatebyidrequest

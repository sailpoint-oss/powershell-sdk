...
function Initialize-V2024ViolationPrediction {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ViolationPrediction' | Write-Debug
...
function ConvertFrom-V2024JsonToViolationPrediction {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ViolationPrediction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

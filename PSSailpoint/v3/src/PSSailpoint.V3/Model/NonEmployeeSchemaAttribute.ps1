...
function Initialize-NonEmployeeSchemaAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeSchemaAttribute' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSchemaAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeSchemaAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

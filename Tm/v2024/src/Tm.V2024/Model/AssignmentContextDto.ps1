...
function Initialize-V2024AssignmentContextDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AssignmentContextDto' | Write-Debug
...
function ConvertFrom-V2024JsonToAssignmentContextDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AssignmentContextDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeApprovalItemBase {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalItemBase' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeApprovalItemBase {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalItemBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

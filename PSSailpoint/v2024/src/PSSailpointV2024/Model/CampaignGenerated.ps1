...
function Initialize-V2024CampaignGenerated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignGenerated' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignGenerated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignGenerated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ImportUploadedBackupRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ImportUploadedBackupRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToImportUploadedBackupRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ImportUploadedBackupRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaWorkflowExecution {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaWorkflowExecution' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowExecution {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaWorkflowExecution' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

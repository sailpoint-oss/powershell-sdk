...
function Initialize-BetaApprovalReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalReference' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

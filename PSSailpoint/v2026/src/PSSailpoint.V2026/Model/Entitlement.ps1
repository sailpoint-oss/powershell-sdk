...
function Initialize-V2026Entitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026Entitlement' | Write-Debug
...
Entitlement<PSCustomObject>
#>
function ConvertFrom-V2026JsonToEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026Entitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

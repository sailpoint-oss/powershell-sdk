...
function Initialize-Entitlementbulkupdaterequest {
    [CmdletBinding()]
    Param (
...
Entitlementbulkupdaterequest<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementbulkupdaterequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Entitlementbulkupdaterequest

...
#>
function Get-V2024EntitlementsByIdentity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024EntitlementsByIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Send-V2024IdentityVerificationAccountToken {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2024IdentityVerificationAccountToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaskStatus
#>
function Start-V2024IdentitiesInvite {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Start-V2024IdentitiesInvite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025WorkgroupMemberAddItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025WorkgroupMemberAddItem' | Write-Debug
...
WorkgroupMemberAddItem<PSCustomObject>
#>
function ConvertFrom-V2025JsonToWorkgroupMemberAddItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025WorkgroupMemberAddItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025WorkgroupMemberAddItem

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ActivateCampaignOptions', 'V2026ActivateCampaignOptions'] 
slug: /tools/sdk/powershell/v2026/models/activate-campaign-options
...
```powershell
$ActivateCampaignOptions = Initialize-V2026ActivateCampaignOptions  -TimeZone -05:00
```

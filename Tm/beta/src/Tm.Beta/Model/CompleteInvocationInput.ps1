...
function Initialize-BetaCompleteInvocationInput {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCompleteInvocationInput' | Write-Debug
...
function ConvertFrom-BetaJsonToCompleteInvocationInput {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCompleteInvocationInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

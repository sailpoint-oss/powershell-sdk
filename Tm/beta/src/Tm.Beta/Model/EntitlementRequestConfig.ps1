...
function Initialize-BetaEntitlementRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaEntitlementRequestConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaEntitlementRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

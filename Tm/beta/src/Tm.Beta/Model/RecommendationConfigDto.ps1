...
function Initialize-BetaRecommendationConfigDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRecommendationConfigDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommendationConfigDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRecommendationConfigDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

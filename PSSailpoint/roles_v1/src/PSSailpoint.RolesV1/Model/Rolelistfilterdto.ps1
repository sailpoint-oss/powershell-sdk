...
function Initialize-Rolelistfilterdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RolesV1 => Rolelistfilterdto' | Write-Debug
...
Rolelistfilterdto<PSCustomObject>
#>
function ConvertFrom-JsonToRolelistfilterdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RolesV1 => Rolelistfilterdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Rolelistfilterdto

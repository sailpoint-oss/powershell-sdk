...
keywords: ['powershell', 'PowerShell', 'sdk', 'DeliveryRequest', 'V2026DeliveryRequest'] 
slug: /tools/sdk/powershell/v2026/models/delivery-request
...
```powershell
$DeliveryRequest = Initialize-V2026DeliveryRequest  -Method urn:ietf:rfc:8935 `

...
function Initialize-BetaConfigurationDetailsResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConfigurationDetailsResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToConfigurationDetailsResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConfigurationDetailsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

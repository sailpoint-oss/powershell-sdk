...
function Initialize-V2024AccountUsage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountUsage' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountUsage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

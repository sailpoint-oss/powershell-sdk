...
function Initialize-BetaIdentityProfileExportedObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityProfileExportedObject' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityProfileExportedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityProfileExportedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

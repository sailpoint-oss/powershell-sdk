...
function Initialize-V2026SourceManagerCorrelationMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SourceManagerCorrelationMapping' | Write-Debug
...
SourceManagerCorrelationMapping<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSourceManagerCorrelationMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SourceManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SourceManagerCorrelationMapping

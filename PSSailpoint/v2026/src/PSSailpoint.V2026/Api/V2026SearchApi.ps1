...
AggregationResult
#>
function Search-V2026Aggregate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Search-V2026Aggregate' | Write-Debug
...
function Search-V2026Count {
    ...
    Process {
        'Calling method: Search-V2026Count' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Search-V2026Get {
    ...
    Process {
        'Calling method: Search-V2026Get' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Search-V2026Post {
    ...
    Process {
        'Calling method: Search-V2026Post' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

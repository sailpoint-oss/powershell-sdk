#
# Module manifest for module 'PSSailpoint.GovernanceGroupsV1'
#
...
RootModule = 'PSSailpoint.GovernanceGroupsV1.psm1'
...
GUID = 'c1961c5e-28f8-9ec7-3028-b2c44128bcdf'
...
Description = 'PSSailpoint.GovernanceGroupsV1 - the PowerShell module for Identity Security Cloud API - Governance Groups'
...
FunctionsToExport = 'New-WorkgroupV1', 'Remove-WorkgroupMembersV1', 'Remove-WorkgroupV1', 
               'Remove-WorkgroupsInBulkV1', 'Get-WorkgroupV1', 'Get-ConnectionsV1', 
               'Get-WorkgroupMembersV1', 'Get-WorkgroupsV1', 'Update-WorkgroupV1', 
               'Update-WorkgroupMembersV1', 'Get-Configuration', 'Set-Configuration', 

...
function Initialize-CampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
...
function ConvertFrom-JsonToCampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

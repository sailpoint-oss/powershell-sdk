...
keywords: ['powershell', 'PowerShell', 'sdk', 'OutlierValueType', 'V2026OutlierValueType'] 
slug: /tools/sdk/powershell/v2026/models/outlier-value-type
...
```powershell
$OutlierValueType = Initialize-V2026OutlierValueType  -Name INTEGER `
 -Ordinal 0
```

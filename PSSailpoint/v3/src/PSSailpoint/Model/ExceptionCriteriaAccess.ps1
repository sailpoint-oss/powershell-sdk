...
function Initialize-ExceptionCriteriaAccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ExceptionCriteriaAccess' | Write-Debug
...
function ConvertFrom-JsonToExceptionCriteriaAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ExceptionCriteriaAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

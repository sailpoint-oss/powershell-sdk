...
function Initialize-V3CreateConnectorDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => V3CreateConnectorDto' | Write-Debug
...
function ConvertFrom-JsonToV3CreateConnectorDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => V3CreateConnectorDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024RoleMiningIdentity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningIdentity' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

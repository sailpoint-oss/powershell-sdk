...
function Initialize-V2024RoleInsightsInsight {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleInsightsInsight' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleInsightsInsight {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleInsightsInsight' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

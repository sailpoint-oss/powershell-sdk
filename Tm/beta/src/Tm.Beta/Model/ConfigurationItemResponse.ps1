...
function Initialize-BetaConfigurationItemResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaConfigurationItemResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToConfigurationItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaConfigurationItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

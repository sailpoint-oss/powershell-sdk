...
StartApplicationDiscoveryV1403ResponseOneOf<PSCustomObject>
#>

function Initialize-StartApplicationDiscoveryV1403ResponseOneOf {
    [CmdletBinding()]
    Param (
...
Convert from JSON to StartApplicationDiscoveryV1403ResponseOneOf<PSCustomObject>
...
StartApplicationDiscoveryV1403ResponseOneOf<PSCustomObject>
#>
function ConvertFrom-JsonToStartApplicationDiscoveryV1403ResponseOneOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in StartApplicationDiscoveryV1403ResponseOneOf
        $AllProperties = ("error")

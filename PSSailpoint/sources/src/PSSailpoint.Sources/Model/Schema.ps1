...
function Initialize-Schema {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => Schema' | Write-Debug
...
Schema<PSCustomObject>
#>
function ConvertFrom-JsonToSchema {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => Schema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Schema

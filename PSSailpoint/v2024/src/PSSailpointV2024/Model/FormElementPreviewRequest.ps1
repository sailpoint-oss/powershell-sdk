...
function Initialize-V2024FormElementPreviewRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024FormElementPreviewRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToFormElementPreviewRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024FormElementPreviewRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

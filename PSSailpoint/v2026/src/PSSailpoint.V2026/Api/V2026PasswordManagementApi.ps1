...
function New-V2026DigitToken {
    ...
    Process {
        'Calling method: New-V2026DigitToken' | Write-Debug
...
PasswordStatus
#>
function Get-V2026PasswordChangeStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026PasswordChangeStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordInfo
#>
function Search-V2026PasswordInfo {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Search-V2026PasswordInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Set-V2026Password {
    ...
    Process {
        'Calling method: Set-V2026Password' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

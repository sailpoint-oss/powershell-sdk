...
function Initialize-Jsonpatchoperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchAttributeConfiguration => Jsonpatchoperation' | Write-Debug
...
function ConvertFrom-JsonToJsonpatchoperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchAttributeConfiguration => Jsonpatchoperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

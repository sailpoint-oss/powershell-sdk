...
function Initialize-V2024SpConfigObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SpConfigObject' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SpConfigObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

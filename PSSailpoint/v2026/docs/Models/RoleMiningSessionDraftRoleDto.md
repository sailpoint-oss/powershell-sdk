...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMiningSessionDraftRoleDto', 'V2026RoleMiningSessionDraftRoleDto'] 
slug: /tools/sdk/powershell/v2026/models/role-mining-session-draft-role-dto
...
```powershell
$RoleMiningSessionDraftRoleDto = Initialize-V2026RoleMiningSessionDraftRoleDto  -Name Saved RM Session - 07/10 `

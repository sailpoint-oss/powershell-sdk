...
Describe -tag 'PSSailpoint.MachineIdentitiesLifecycleActions' -name 'LifecycleActionSubmitComment' {
    Context 'LifecycleActionSubmitComment' {
        It 'Initialize-LifecycleActionSubmitComment' {
            # a simple test to create an object
            #$NewObject = Initialize-LifecycleActionSubmitComment -Comment "TEST_VALUE"
            #$NewObject | Should -BeOfType LifecycleActionSubmitComment

...
function Initialize-BetaCampaignTemplate {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCampaignTemplate' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignTemplate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCampaignTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SodPolicySchedule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SodPolicySchedule' | Write-Debug
...
function ConvertFrom-V2024JsonToSodPolicySchedule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SodPolicySchedule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

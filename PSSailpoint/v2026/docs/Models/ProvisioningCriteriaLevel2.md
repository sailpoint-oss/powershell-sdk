...
keywords: ['powershell', 'PowerShell', 'sdk', 'ProvisioningCriteriaLevel2', 'V2026ProvisioningCriteriaLevel2'] 
slug: /tools/sdk/powershell/v2026/models/provisioning-criteria-level2
...
```powershell
$ProvisioningCriteriaLevel2 = Initialize-V2026ProvisioningCriteriaLevel2  -Operation null `
 -Attribute email `

...
function Initialize-BetaCreatePersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCreatePersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToCreatePersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCreatePersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

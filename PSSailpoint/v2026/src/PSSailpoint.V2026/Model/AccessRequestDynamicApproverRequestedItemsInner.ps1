...
function Initialize-V2026AccessRequestDynamicApproverRequestedItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
...
AccessRequestDynamicApproverRequestedItemsInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessRequestDynamicApproverRequestedItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessRequestDynamicApproverRequestedItemsInner

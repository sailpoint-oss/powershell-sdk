...
UserEntitlementV2Source<PSCustomObject>
#>

function Initialize-UserEntitlementV2Source {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentities => UserEntitlementV2Source' | Write-Debug
...
Convert from JSON to UserEntitlementV2Source<PSCustomObject>
...
UserEntitlementV2Source<PSCustomObject>
#>
function ConvertFrom-JsonToUserEntitlementV2Source {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentities => UserEntitlementV2Source' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserEntitlementV2Source

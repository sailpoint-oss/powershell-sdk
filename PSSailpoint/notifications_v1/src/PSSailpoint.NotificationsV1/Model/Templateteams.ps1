...
function Initialize-Templateteams {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NotificationsV1 => Templateteams' | Write-Debug
...
Templateteams<PSCustomObject>
#>
function ConvertFrom-JsonToTemplateteams {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NotificationsV1 => Templateteams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Templateteams

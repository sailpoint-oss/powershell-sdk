...
function Initialize-V2024ConditionEffect {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ConditionEffect' | Write-Debug
...
function ConvertFrom-V2024JsonToConditionEffect {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ConditionEffect' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
ScheduledSearch
#>
function New-V2025ScheduledSearch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025ScheduledSearch' | Write-Debug
...
None
#>
function Remove-V2025ScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ScheduledSearch
#>
function Get-V2025ScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-V2025UnsubscribeScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2025UnsubscribeScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ScheduledSearch
#>
function Update-V2025ScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

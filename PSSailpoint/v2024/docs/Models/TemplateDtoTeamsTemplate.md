...
keywords: ['powershell', 'PowerShell', 'sdk', 'TemplateDtoTeamsTemplate', 'V2024TemplateDtoTeamsTemplate'] 
slug: /tools/sdk/powershell/v2024/models/template-dto-teams-template
...
```powershell
$TemplateDtoTeamsTemplate = Initialize-V2024TemplateDtoTeamsTemplate  -Key null `
 -Title null `

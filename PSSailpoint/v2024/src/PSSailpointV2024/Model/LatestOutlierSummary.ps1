...
function Initialize-V2024LatestOutlierSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024LatestOutlierSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToLatestOutlierSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024LatestOutlierSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

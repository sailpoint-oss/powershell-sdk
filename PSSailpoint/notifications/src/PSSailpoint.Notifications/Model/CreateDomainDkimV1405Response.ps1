...
CreateDomainDkimV1405Response<PSCustomObject>
#>

function Initialize-CreateDomainDkimV1405Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to CreateDomainDkimV1405Response<PSCustomObject>
...
CreateDomainDkimV1405Response<PSCustomObject>
#>
function ConvertFrom-JsonToCreateDomainDkimV1405Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in CreateDomainDkimV1405Response

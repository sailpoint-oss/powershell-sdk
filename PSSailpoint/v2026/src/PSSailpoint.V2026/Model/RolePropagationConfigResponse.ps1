...
function Initialize-V2026RolePropagationConfigResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RolePropagationConfigResponse' | Write-Debug
...
RolePropagationConfigResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRolePropagationConfigResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RolePropagationConfigResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RolePropagationConfigResponse

...
function Initialize-ApprovalIdentityRecord {
    [CmdletBinding()]
    Param (
...
ApprovalIdentityRecord<PSCustomObject>
#>
function ConvertFrom-JsonToApprovalIdentityRecord {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ApprovalIdentityRecord

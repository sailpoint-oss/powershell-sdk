...
function New-WorkgroupV1 {
    ...
    Process {
        'Calling method: New-WorkgroupV1' | Write-Debug
...
function Remove-WorkgroupMembersV1 {
    ...
    Process {
        'Calling method: Remove-WorkgroupMembersV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/workgroups/v1/{workgroupId}/members/bulk-delete'
        if (!$WorkgroupId) {
            throw "Error! The required parameter `WorkgroupId` missing when calling deleteWorkgroupMembersV1."
        }
...
function Remove-WorkgroupV1 {
    ...
    Process {
        'Calling method: Remove-WorkgroupV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/workgroups/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteWorkgroupV1."
        }
...
function Remove-WorkgroupsInBulkV1 {
    ...
    Process {
        'Calling method: Remove-WorkgroupsInBulkV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-WorkgroupV1 {
    ...
    Process {
        'Calling method: Get-WorkgroupV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/workgroups/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getWorkgroupV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-ConnectionsV1 {
    ...
    Process {
        'Calling method: Get-ConnectionsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/workgroups/v1/{workgroupId}/connections'
        if (!$WorkgroupId) {
            throw "Error! The required parameter `WorkgroupId` missing when calling listConnectionsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{workgroupId}', [System.Web.HTTPUtility]::UrlEncode($WorkgroupId))
...
#>
function Get-WorkgroupMembersV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-WorkgroupMembersV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/workgroups/v1/{workgroupId}/members'
        if (!$WorkgroupId) {
            throw "Error! The required parameter `WorkgroupId` missing when calling listWorkgroupMembersV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{workgroupId}', [System.Web.HTTPUtility]::UrlEncode($WorkgroupId))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "ListWorkgroupMembersV1200ResponseInner[]" `
                                -IsBodyNullable $false
...
function Get-WorkgroupsV1 {
    ...
    Process {
        'Calling method: Get-WorkgroupsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-WorkgroupV1 {
    ...
    Process {
        'Calling method: Update-WorkgroupV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/workgroups/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling patchWorkgroupV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Update-WorkgroupMembersV1 {
    ...
    Process {
        'Calling method: Update-WorkgroupMembersV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/workgroups/v1/{workgroupId}/members/bulk-add'
        if (!$WorkgroupId) {
            throw "Error! The required parameter `WorkgroupId` missing when calling updateWorkgroupMembersV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{workgroupId}', [System.Web.HTTPUtility]::UrlEncode($WorkgroupId))

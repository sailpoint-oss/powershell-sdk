...
function Initialize-V2026SpConfigExportResults {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SpConfigExportResults' | Write-Debug
...
SpConfigExportResults<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSpConfigExportResults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SpConfigExportResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SpConfigExportResults

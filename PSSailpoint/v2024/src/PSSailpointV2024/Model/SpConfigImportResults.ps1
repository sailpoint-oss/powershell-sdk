...
function Initialize-V2024SpConfigImportResults {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SpConfigImportResults' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigImportResults {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SpConfigImportResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

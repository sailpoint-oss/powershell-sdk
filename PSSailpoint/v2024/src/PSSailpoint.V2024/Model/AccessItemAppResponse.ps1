...
function Initialize-V2024AccessItemAppResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessItemAppResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessItemAppResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessItemAppResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

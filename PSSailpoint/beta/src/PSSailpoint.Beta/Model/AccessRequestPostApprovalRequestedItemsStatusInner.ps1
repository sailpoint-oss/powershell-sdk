...
function Initialize-BetaAccessRequestPostApprovalRequestedItemsStatusInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPostApprovalRequestedItemsStatusInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

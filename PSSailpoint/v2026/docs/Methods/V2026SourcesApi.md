...
try {
    Get-V2026SourceEntitlementRequestConfig -XSailPointExperimental $XSailPointExperimental 
...
try {
    ...
    Update-V2026SourceEntitlementRequestConfig -XSailPointExperimental $XSailPointExperimental -SourceEntitlementRequestConfig $Result 

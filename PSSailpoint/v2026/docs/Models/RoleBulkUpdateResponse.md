...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleBulkUpdateResponse', 'V2026RoleBulkUpdateResponse'] 
slug: /tools/sdk/powershell/v2026/models/role-bulk-update-response
...
```powershell
$RoleBulkUpdateResponse = Initialize-V2026RoleBulkUpdateResponse  -Id 2c9180867817ac4d017817c491119a20 `
 -Type Role `
 -Status CREATED `

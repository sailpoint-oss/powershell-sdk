...
function Initialize-V2025VAClusterStatusChangeEventHealthCheckResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025VAClusterStatusChangeEventHealthCheckResult' | Write-Debug
...
VAClusterStatusChangeEventHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-V2025JsonToVAClusterStatusChangeEventHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025VAClusterStatusChangeEventHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025VAClusterStatusChangeEventHealthCheckResult

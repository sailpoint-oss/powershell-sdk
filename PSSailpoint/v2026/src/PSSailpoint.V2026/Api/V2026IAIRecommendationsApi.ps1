...
#>
function Get-V2026Recommendations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2026Recommendations' | Write-Debug
...
#>
function Get-V2026RecommendationsConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026RecommendationsConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
RecommendationConfigDto
#>
function Update-V2026RecommendationsConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026RecommendationsConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

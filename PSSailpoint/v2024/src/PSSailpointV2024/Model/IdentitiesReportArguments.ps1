...
function Initialize-V2024IdentitiesReportArguments {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentitiesReportArguments' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentitiesReportArguments {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentitiesReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ObjectMappingResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ObjectMappingResponse' | Write-Debug
...
ObjectMappingResponse<PSCustomObject>
#>
function ConvertFrom-V2024JsonToObjectMappingResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ObjectMappingResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ObjectMappingResponse

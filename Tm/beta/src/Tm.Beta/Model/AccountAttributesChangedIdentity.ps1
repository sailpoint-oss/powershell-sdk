...
function Initialize-BetaAccountAttributesChangedIdentity {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountAttributesChangedIdentity' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesChangedIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountAttributesChangedIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

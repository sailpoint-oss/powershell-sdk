...
function Initialize-Approvaldetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccountDeletionRequestsV1 => Approvaldetails' | Write-Debug
...
Approvaldetails<PSCustomObject>
#>
function ConvertFrom-JsonToApprovaldetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccountDeletionRequestsV1 => Approvaldetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Approvaldetails

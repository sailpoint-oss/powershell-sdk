...
function Initialize-BetaViolationContextPolicy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaViolationContextPolicy' | Write-Debug
...
function ConvertFrom-BetaJsonToViolationContextPolicy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaViolationContextPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

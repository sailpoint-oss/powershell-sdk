...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountCorrelatedSource', 'V2026AccountCorrelatedSource'] 
slug: /tools/sdk/powershell/v2026/models/account-correlated-source
...
```powershell
$AccountCorrelatedSource = Initialize-V2026AccountCorrelatedSource  -Type SOURCE `

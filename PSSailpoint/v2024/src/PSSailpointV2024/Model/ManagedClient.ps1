...
function Initialize-V2024ManagedClient {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ManagedClient' | Write-Debug
...
function ConvertFrom-V2024JsonToManagedClient {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ManualDiscoverApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ManualDiscoverApplications' | Write-Debug
...
function ConvertFrom-V2024JsonToManualDiscoverApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ManualDiscoverApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

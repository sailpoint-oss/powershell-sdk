...
function Initialize-V2026MultiHostIntegrationsCreateSources {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsCreateSources' | Write-Debug
...
MultiHostIntegrationsCreateSources<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMultiHostIntegrationsCreateSources {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsCreateSources' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MultiHostIntegrationsCreateSources

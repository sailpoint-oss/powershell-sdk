...
function Initialize-ViolationOwnerAssignmentConfigOwnerRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SodPolicies => ViolationOwnerAssignmentConfigOwnerRef' | Write-Debug
...
function ConvertFrom-JsonToViolationOwnerAssignmentConfigOwnerRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SodPolicies => ViolationOwnerAssignmentConfigOwnerRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

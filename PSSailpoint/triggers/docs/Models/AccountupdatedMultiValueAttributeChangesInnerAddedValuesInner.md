---
id: accountupdated-multi-value-attribute-changes-inner-added-values-inner
...
```powershell
$AccountupdatedMultiValueAttributeChangesInnerAddedValuesInner = Initialize-AccountupdatedMultiValueAttributeChangesInnerAddedValuesInner 
```

- Convert the resource to JSON
```powershell
$AccountupdatedMultiValueAttributeChangesInnerAddedValuesInner | ConvertTo-JSON
```

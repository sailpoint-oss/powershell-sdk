...
function Initialize-AccessModelMetadata {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessModelMetadata' | Write-Debug
...
function ConvertFrom-JsonToAccessModelMetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessModelMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-RoleBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RoleBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-JsonToRoleBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RoleBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Entitlementaccessrequestconfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Entitlements => Entitlementaccessrequestconfig' | Write-Debug
...
function ConvertFrom-JsonToEntitlementaccessrequestconfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Entitlements => Entitlementaccessrequestconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

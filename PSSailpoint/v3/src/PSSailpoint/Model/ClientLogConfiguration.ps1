...
function Initialize-ClientLogConfiguration {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ClientLogConfiguration' | Write-Debug
...
function ConvertFrom-JsonToClientLogConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ClientLogConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

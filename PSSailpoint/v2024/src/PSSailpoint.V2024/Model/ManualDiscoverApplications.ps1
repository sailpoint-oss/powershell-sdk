...
function Initialize-V2024ManualDiscoverApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManualDiscoverApplications' | Write-Debug
...
ManualDiscoverApplications<PSCustomObject>
#>
function ConvertFrom-V2024JsonToManualDiscoverApplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManualDiscoverApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ManualDiscoverApplications
        $AllProperties = ("file")

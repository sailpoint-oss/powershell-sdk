...
function Initialize-BetaAccountAttributesChangedIdentity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesChangedIdentity' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesChangedIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesChangedIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

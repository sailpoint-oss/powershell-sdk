...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMiningIdentityDistributionDistributionInner', 'V2025RoleMiningIdentityDistributionDistributionInner'] 
slug: /tools/sdk/powershell/v2025/models/role-mining-identity-distribution-distribution-inner
...
```powershell
$RoleMiningIdentityDistributionDistributionInner = Initialize-V2025RoleMiningIdentityDistributionDistributionInner  -AttributeValue NM Tier 3 `
 -Count 6
```

...
function Initialize-V2026AttrSyncSourceAttributeConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AttrSyncSourceAttributeConfig' | Write-Debug
...
AttrSyncSourceAttributeConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAttrSyncSourceAttributeConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AttrSyncSourceAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AttrSyncSourceAttributeConfig

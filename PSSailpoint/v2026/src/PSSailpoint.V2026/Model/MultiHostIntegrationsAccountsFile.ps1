...
function Initialize-V2026MultiHostIntegrationsAccountsFile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsAccountsFile' | Write-Debug
...
MultiHostIntegrationsAccountsFile<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMultiHostIntegrationsAccountsFile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsAccountsFile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MultiHostIntegrationsAccountsFile

...
function Initialize-BetaCampaignReportsConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCampaignReportsConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignReportsConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCampaignReportsConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

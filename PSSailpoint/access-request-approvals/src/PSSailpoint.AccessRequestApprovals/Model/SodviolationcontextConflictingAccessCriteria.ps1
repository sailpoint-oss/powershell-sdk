...
function Initialize-SodviolationcontextConflictingAccessCriteria {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => SodviolationcontextConflictingAccessCriteria' | Write-Debug
...
SodviolationcontextConflictingAccessCriteria<PSCustomObject>
#>
function ConvertFrom-JsonToSodviolationcontextConflictingAccessCriteria {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => SodviolationcontextConflictingAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SodviolationcontextConflictingAccessCriteria

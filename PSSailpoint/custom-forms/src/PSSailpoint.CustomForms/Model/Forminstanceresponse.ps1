...
function Initialize-Forminstanceresponse {
    [CmdletBinding()]
    Param (
...
Forminstanceresponse<PSCustomObject>
#>
function ConvertFrom-JsonToForminstanceresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Forminstanceresponse

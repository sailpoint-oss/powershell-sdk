...
function Initialize-V2024SodViolationCheck {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SodViolationCheck' | Write-Debug
...
function ConvertFrom-V2024JsonToSodViolationCheck {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SodViolationCheck' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

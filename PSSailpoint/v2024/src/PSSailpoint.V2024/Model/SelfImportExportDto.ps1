...
function Initialize-V2024SelfImportExportDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SelfImportExportDto' | Write-Debug
...
SelfImportExportDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSelfImportExportDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SelfImportExportDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SelfImportExportDto

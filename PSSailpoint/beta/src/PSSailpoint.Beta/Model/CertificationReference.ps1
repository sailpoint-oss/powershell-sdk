...
function Initialize-BetaCertificationReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCertificationReference' | Write-Debug
...
function ConvertFrom-BetaJsonToCertificationReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCertificationReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

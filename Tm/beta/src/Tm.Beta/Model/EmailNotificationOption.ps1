...
function Initialize-BetaEmailNotificationOption {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaEmailNotificationOption' | Write-Debug
...
function ConvertFrom-BetaJsonToEmailNotificationOption {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaEmailNotificationOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'SourceManagerCorrelationMapping', 'V2026SourceManagerCorrelationMapping'] 
slug: /tools/sdk/powershell/v2026/models/source-manager-correlation-mapping
...
```powershell
$SourceManagerCorrelationMapping = Initialize-V2026SourceManagerCorrelationMapping  -AccountAttributeName manager `

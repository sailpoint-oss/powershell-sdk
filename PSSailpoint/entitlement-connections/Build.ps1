...
$FunctionPath = "$PSScriptRoot/src/PSSailpoint.EntitlementConnections/Api", "$PSScriptRoot/src/PSSailpoint.EntitlementConnections/Client","$PSScriptRoot/src/PSSailpoint.EntitlementConnections/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\PSSailpoint.EntitlementConnections\PSSailpoint.EntitlementConnections.psd1"

...
keywords: ['powershell', 'PowerShell', 'sdk', 'PutClientLogConfigurationRequest', 'V2026PutClientLogConfigurationRequest'] 
slug: /tools/sdk/powershell/v2026/models/put-client-log-configuration-request
...
```powershell
$PutClientLogConfigurationRequest = Initialize-V2026PutClientLogConfigurationRequest  -ClientId 3a38a51992e8445ab51a549c0a70ee66 `
 -DurationMinutes 120 `
 -RootLevel null `
 -LogLevels INFO `

...
function Initialize-BetaConditionEffectConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConditionEffectConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToConditionEffectConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConditionEffectConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

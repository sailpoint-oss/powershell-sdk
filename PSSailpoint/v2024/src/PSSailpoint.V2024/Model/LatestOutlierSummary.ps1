...
function Initialize-V2024LatestOutlierSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024LatestOutlierSummary' | Write-Debug
...
LatestOutlierSummary<PSCustomObject>
#>
function ConvertFrom-V2024JsonToLatestOutlierSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024LatestOutlierSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024LatestOutlierSummary

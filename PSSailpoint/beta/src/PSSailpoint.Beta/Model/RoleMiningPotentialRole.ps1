...
function Initialize-BetaRoleMiningPotentialRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRole' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

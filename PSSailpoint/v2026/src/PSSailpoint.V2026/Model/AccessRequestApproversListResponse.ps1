...
function Initialize-V2026AccessRequestApproversListResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestApproversListResponse' | Write-Debug
...
AccessRequestApproversListResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessRequestApproversListResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestApproversListResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessRequestApproversListResponse

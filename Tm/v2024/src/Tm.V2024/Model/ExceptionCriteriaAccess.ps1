...
function Initialize-V2024ExceptionCriteriaAccess {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ExceptionCriteriaAccess' | Write-Debug
...
function ConvertFrom-V2024JsonToExceptionCriteriaAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ExceptionCriteriaAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

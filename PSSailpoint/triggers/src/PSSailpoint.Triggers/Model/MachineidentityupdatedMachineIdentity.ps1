...
function Initialize-MachineidentityupdatedMachineIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => MachineidentityupdatedMachineIdentity' | Write-Debug
...
MachineidentityupdatedMachineIdentity<PSCustomObject>
#>
function ConvertFrom-JsonToMachineidentityupdatedMachineIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => MachineidentityupdatedMachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MachineidentityupdatedMachineIdentity

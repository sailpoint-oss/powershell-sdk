...
function Initialize-V2025EmailNotificationOption {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025EmailNotificationOption' | Write-Debug
...
EmailNotificationOption<PSCustomObject>
#>
function ConvertFrom-V2025JsonToEmailNotificationOption {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025EmailNotificationOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025EmailNotificationOption

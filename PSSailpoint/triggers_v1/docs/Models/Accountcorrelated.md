...
slug: /tools/sdk/powershell/triggersv1/models/accountcorrelated
...
**Attributes** | [**map[string]AnyType**](any-type) | The attributes associated with the account.  Attributes are unique per source. | [required]

...
function Initialize-IdentityProfilesConnections {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => IdentityProfilesConnections' | Write-Debug
...
function ConvertFrom-JsonToIdentityProfilesConnections {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => IdentityProfilesConnections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Accountupdated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Accountupdated' | Write-Debug
...
Accountupdated<PSCustomObject>
#>
function ConvertFrom-JsonToAccountupdated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Accountupdated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accountupdated

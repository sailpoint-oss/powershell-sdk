...
function Initialize-V2025KbaAnswerRequestItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025KbaAnswerRequestItem' | Write-Debug
...
KbaAnswerRequestItem<PSCustomObject>
#>
function ConvertFrom-V2025JsonToKbaAnswerRequestItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025KbaAnswerRequestItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025KbaAnswerRequestItem

...
function Initialize-V2024TypeAheadQuery {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TypeAheadQuery' | Write-Debug
...
function ConvertFrom-V2024JsonToTypeAheadQuery {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TypeAheadQuery' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

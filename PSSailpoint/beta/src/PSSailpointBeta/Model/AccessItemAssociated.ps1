...
function Initialize-BetaAccessItemAssociated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccessItemAssociated' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessItemAssociated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccessItemAssociated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

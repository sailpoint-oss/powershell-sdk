...
function Initialize-Commonaccessitemaccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiCommonAccessV1 => Commonaccessitemaccess' | Write-Debug
...
Commonaccessitemaccess<PSCustomObject>
#>
function ConvertFrom-JsonToCommonaccessitemaccess {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiCommonAccessV1 => Commonaccessitemaccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Commonaccessitemaccess

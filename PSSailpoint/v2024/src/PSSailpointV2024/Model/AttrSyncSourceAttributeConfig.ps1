...
function Initialize-V2024AttrSyncSourceAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AttrSyncSourceAttributeConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToAttrSyncSourceAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AttrSyncSourceAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

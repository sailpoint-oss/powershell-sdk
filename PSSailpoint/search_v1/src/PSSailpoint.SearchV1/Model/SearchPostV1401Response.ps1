...
SearchPostV1401Response<PSCustomObject>
#>

function Initialize-SearchPostV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to SearchPostV1401Response<PSCustomObject>
...
SearchPostV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToSearchPostV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SearchPostV1401Response
        $AllProperties = ("error")

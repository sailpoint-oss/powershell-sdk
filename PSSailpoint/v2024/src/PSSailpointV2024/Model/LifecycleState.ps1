...
function Initialize-V2024LifecycleState {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024LifecycleState' | Write-Debug
...
function ConvertFrom-V2024JsonToLifecycleState {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

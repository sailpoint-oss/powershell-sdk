...
function Initialize-AccessProfileApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessProfileApprovalScheme' | Write-Debug
...
function ConvertFrom-JsonToAccessProfileApprovalScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessProfileApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ObjectMappingBulkCreateRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ObjectMappingBulkCreateRequest' | Write-Debug
...
function ConvertFrom-JsonToObjectMappingBulkCreateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ObjectMappingBulkCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

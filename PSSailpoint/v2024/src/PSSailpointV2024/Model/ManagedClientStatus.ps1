...
function Initialize-V2024ManagedClientStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ManagedClientStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToManagedClientStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ManagedClientStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

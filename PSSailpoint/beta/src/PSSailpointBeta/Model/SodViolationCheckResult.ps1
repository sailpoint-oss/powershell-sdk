...
function Initialize-BetaSodViolationCheckResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSodViolationCheckResult' | Write-Debug
...
function ConvertFrom-BetaJsonToSodViolationCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSodViolationCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

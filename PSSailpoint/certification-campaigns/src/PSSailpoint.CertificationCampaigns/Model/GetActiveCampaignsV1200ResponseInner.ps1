...
GetActiveCampaignsV1200ResponseInner<PSCustomObject>
#>
function ConvertFrom-JsonToGetActiveCampaignsV1200ResponseInner {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                Write-Debug "Failed to match 'Campaign2' defined in anyOf (GetActiveCampaignsV1200ResponseInner). Proceeding to the next one if any."
            }
        }

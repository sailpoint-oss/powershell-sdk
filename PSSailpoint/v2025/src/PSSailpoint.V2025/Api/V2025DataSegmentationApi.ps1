...
function New-V2025DataSegment {
    ...
    Process {
        'Calling method: New-V2025DataSegment' | Write-Debug
...
None
#>
function Remove-V2025DataSegment {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025DataSegment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025DataSegment {
    ...
    Process {
        'Calling method: Get-V2025DataSegment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025DataSegmentIdentityMembership {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025DataSegmentIdentityMembership' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Boolean
#>
function Get-V2025DataSegmentationEnabledForUser {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025DataSegmentationEnabledForUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
DataSegment[]
#>
function Get-V2025DataSegments {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025DataSegments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
DataSegment
#>
function Update-V2025DataSegment {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025DataSegment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Publish-V2025DataSegment {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Publish-V2025DataSegment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-AccountcorrelatedAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => AccountcorrelatedAccount' | Write-Debug
...
AccountcorrelatedAccount<PSCustomObject>
#>
function ConvertFrom-JsonToAccountcorrelatedAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => AccountcorrelatedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountcorrelatedAccount

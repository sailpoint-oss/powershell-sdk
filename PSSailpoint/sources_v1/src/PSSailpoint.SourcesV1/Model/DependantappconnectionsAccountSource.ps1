...
function Initialize-DependantappconnectionsAccountSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => DependantappconnectionsAccountSource' | Write-Debug
...
DependantappconnectionsAccountSource<PSCustomObject>
#>
function ConvertFrom-JsonToDependantappconnectionsAccountSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => DependantappconnectionsAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DependantappconnectionsAccountSource

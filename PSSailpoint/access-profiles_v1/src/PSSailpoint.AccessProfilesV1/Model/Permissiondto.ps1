...
function Initialize-Permissiondto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfilesV1 => Permissiondto' | Write-Debug
...
function ConvertFrom-JsonToPermissiondto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfilesV1 => Permissiondto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026JitActivationExtendResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026JitActivationExtendResponse' | Write-Debug
...
JitActivationExtendResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToJitActivationExtendResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026JitActivationExtendResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

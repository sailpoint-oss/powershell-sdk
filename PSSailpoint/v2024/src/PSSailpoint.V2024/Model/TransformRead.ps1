...
function Initialize-V2024TransformRead {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TransformRead' | Write-Debug
...
function ConvertFrom-V2024JsonToTransformRead {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TransformRead' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

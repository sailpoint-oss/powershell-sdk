...
function Initialize-V2025RoleDocumentAllOfDimensions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleDocumentAllOfDimensions' | Write-Debug
...
RoleDocumentAllOfDimensions<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleDocumentAllOfDimensions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleDocumentAllOfDimensions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleDocumentAllOfDimensions

...
function Initialize-V2026SavedSearchDetailFilters {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SavedSearchDetailFilters' | Write-Debug
...
SavedSearchDetailFilters<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSavedSearchDetailFilters {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SavedSearchDetailFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SavedSearchDetailFilters

...
function Initialize-V2024ApprovalComment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalComment' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

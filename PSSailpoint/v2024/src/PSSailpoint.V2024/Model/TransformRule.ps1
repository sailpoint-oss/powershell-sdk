...
function Initialize-V2024TransformRule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TransformRule' | Write-Debug
...
function ConvertFrom-V2024JsonToTransformRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TransformRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024TransformRule

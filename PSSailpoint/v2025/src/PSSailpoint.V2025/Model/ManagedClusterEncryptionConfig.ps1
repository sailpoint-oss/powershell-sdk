...
function Initialize-V2025ManagedClusterEncryptionConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ManagedClusterEncryptionConfig' | Write-Debug
...
ManagedClusterEncryptionConfig<PSCustomObject>
#>
function ConvertFrom-V2025JsonToManagedClusterEncryptionConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ManagedClusterEncryptionConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ManagedClusterEncryptionConfig

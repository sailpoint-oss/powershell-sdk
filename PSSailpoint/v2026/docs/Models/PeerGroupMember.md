...
keywords: ['powershell', 'PowerShell', 'sdk', 'PeerGroupMember', 'V2026PeerGroupMember'] 
slug: /tools/sdk/powershell/v2026/models/peer-group-member
...
```powershell
$PeerGroupMember = Initialize-V2026PeerGroupMember  -Id null `
 -Type null `
 -PeerGroupId null `
 -Attributes null
```

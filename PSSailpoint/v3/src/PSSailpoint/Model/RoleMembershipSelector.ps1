...
function Initialize-RoleMembershipSelector {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => RoleMembershipSelector' | Write-Debug
...
function ConvertFrom-JsonToRoleMembershipSelector {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => RoleMembershipSelector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

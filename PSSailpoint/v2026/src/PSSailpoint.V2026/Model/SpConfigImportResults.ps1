...
function Initialize-V2026SpConfigImportResults {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SpConfigImportResults' | Write-Debug
...
SpConfigImportResults<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSpConfigImportResults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SpConfigImportResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SpConfigImportResults

...
$StartInvocationInput = @"{  "TriggerId": "idn:access-requested", "VarInput": {"identityId": "201327fda1c44704ac01181e963d463c}", "ContentJson": {"workflowId": "1234}" }}}"@
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToStartInvocationInput -Json $StartInvocationInput
```

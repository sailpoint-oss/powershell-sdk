...
Namenormalizer<PSCustomObject>
#>

function Initialize-Namenormalizer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Namenormalizer' | Write-Debug
...
Convert from JSON to Namenormalizer<PSCustomObject>
...
Namenormalizer<PSCustomObject>
#>
function ConvertFrom-JsonToNamenormalizer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Namenormalizer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Namenormalizer

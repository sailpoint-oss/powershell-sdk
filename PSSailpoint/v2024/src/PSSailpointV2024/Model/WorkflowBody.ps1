...
function Initialize-V2024WorkflowBody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkflowBody' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkflowBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

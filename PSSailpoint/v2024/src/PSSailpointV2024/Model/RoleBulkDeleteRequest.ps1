...
function Initialize-V2024RoleBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

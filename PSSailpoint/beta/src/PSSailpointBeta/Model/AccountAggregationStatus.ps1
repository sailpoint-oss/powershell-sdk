...
function Initialize-BetaAccountAggregationStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccountAggregationStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAggregationStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccountAggregationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

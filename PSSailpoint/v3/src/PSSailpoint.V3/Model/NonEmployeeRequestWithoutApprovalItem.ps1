...
function Initialize-NonEmployeeRequestWithoutApprovalItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeRequestWithoutApprovalItem' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeRequestWithoutApprovalItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeRequestWithoutApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-CorrelationconfigAttributeAssignmentsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => CorrelationconfigAttributeAssignmentsInner' | Write-Debug
...
CorrelationconfigAttributeAssignmentsInner<PSCustomObject>
#>
function ConvertFrom-JsonToCorrelationconfigAttributeAssignmentsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => CorrelationconfigAttributeAssignmentsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CorrelationconfigAttributeAssignmentsInner

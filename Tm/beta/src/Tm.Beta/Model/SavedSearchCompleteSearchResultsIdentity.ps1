...
function Initialize-BetaSavedSearchCompleteSearchResultsIdentity {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSavedSearchCompleteSearchResultsIdentity' | Write-Debug
...
function ConvertFrom-BetaJsonToSavedSearchCompleteSearchResultsIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSavedSearchCompleteSearchResultsIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

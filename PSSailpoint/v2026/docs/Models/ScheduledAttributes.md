...
keywords: ['powershell', 'PowerShell', 'sdk', 'ScheduledAttributes', 'V2026ScheduledAttributes'] 
slug: /tools/sdk/powershell/v2026/models/scheduled-attributes
...
```powershell
$ScheduledAttributes = Initialize-V2026ScheduledAttributes  -Frequency daily `

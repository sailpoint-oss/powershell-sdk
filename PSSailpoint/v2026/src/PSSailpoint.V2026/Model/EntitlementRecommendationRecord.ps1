...
function Initialize-V2026EntitlementRecommendationRecord {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026EntitlementRecommendationRecord' | Write-Debug
...
EntitlementRecommendationRecord<PSCustomObject>
#>
function ConvertFrom-V2026JsonToEntitlementRecommendationRecord {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026EntitlementRecommendationRecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026EntitlementRecommendationRecord

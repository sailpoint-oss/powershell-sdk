...
function Initialize-NonEmployeeSourceLite {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeSourceLite' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSourceLite {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeSourceLite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

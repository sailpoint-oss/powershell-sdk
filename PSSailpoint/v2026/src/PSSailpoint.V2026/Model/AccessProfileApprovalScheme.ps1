...
function Initialize-V2026AccessProfileApprovalScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessProfileApprovalScheme' | Write-Debug
...
AccessProfileApprovalScheme<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessProfileApprovalScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessProfileApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessProfileApprovalScheme

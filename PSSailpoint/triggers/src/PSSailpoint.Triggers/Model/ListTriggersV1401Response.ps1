...
ListTriggersV1401Response<PSCustomObject>
#>

function Initialize-ListTriggersV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListTriggersV1401Response<PSCustomObject>
...
ListTriggersV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToListTriggersV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListTriggersV1401Response
        $AllProperties = ("error")

...
function Initialize-V2026ParameterStorageUpdateParameter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageUpdateParameter' | Write-Debug
...
ParameterStorageUpdateParameter<PSCustomObject>
#>
function ConvertFrom-V2026JsonToParameterStorageUpdateParameter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageUpdateParameter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ParameterStorageUpdateParameter

...
function Initialize-V2026RoleDocumentAllOfEntitlements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleDocumentAllOfEntitlements' | Write-Debug
...
RoleDocumentAllOfEntitlements<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleDocumentAllOfEntitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleDocumentAllOfEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleDocumentAllOfEntitlements

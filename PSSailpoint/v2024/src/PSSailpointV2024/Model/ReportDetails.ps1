...
function Initialize-V2024ReportDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ReportDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToReportDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ReportDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024NonEmployeeSourceWithNECount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeSourceWithNECount' | Write-Debug
...
NonEmployeeSourceWithNECount<PSCustomObject>
#>
function ConvertFrom-V2024JsonToNonEmployeeSourceWithNECount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeSourceWithNECount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024NonEmployeeSourceWithNECount

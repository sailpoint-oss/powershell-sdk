...
function Initialize-Accessitemdiff {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IdentityHistoryV1 => Accessitemdiff' | Write-Debug
...
Accessitemdiff<PSCustomObject>
#>
function ConvertFrom-JsonToAccessitemdiff {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IdentityHistoryV1 => Accessitemdiff' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessitemdiff

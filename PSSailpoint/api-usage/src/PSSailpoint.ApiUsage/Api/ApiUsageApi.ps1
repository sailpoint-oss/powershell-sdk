...
function Get-TotalCountV1 {
    ...
    Process {
        'Calling method: Get-TotalCountV1' | Write-Debug
        ...
        $LocalVarUri = '/api-usage/v1/count'

        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling getTotalCountV1."
        }
...
function Get-ApiSummaryV1 {
    ...
    Process {
        'Calling method: Get-ApiSummaryV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api-usage/v1/summary'

        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling listApiSummaryV1."
        }
        $LocalVarHeaderParameters['X-SailPoint-Experimental'] = $XSailPointExperimental

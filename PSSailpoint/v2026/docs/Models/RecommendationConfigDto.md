...
keywords: ['powershell', 'PowerShell', 'sdk', 'RecommendationConfigDto', 'V2026RecommendationConfigDto'] 
slug: /tools/sdk/powershell/v2026/models/recommendation-config-dto
...
```powershell
$RecommendationConfigDto = Initialize-V2026RecommendationConfigDto  -RecommenderFeatures [jobTitle, location, peer_group, department, active] `

...
function Initialize-V2024NetworkConfiguration {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NetworkConfiguration' | Write-Debug
...
function ConvertFrom-V2024JsonToNetworkConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NetworkConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
AggregationResult
#>
function Search-V2025Aggregate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Search-V2025Aggregate' | Write-Debug
...
function Search-V2025Count {
    ...
    Process {
        'Calling method: Search-V2025Count' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Search-V2025Get {
    ...
    Process {
        'Calling method: Search-V2025Get' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Search-V2025Post {
    ...
    Process {
        'Calling method: Search-V2025Post' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

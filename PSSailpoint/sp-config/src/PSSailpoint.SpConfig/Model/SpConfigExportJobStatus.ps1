...
function Initialize-SpConfigExportJobStatus {
    [CmdletBinding()]
    Param (
...
SpConfigExportJobStatus<PSCustomObject>
#>
function ConvertFrom-JsonToSpConfigExportJobStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SpConfigExportJobStatus

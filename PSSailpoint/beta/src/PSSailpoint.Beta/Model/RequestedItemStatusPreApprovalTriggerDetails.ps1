...
function Initialize-BetaRequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
...
RequestedItemStatusPreApprovalTriggerDetails<PSCustomObject>
#>
function ConvertFrom-BetaJsonToRequestedItemStatusPreApprovalTriggerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaRequestedItemStatusPreApprovalTriggerDetails

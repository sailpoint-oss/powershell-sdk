...
keywords: ['powershell', 'PowerShell', 'sdk', 'ServiceProviderConfiguration', 'V2026ServiceProviderConfiguration'] 
slug: /tools/sdk/powershell/v2026/models/service-provider-configuration
...
```powershell
$ServiceProviderConfiguration = Initialize-V2026ServiceProviderConfiguration  -Enabled true `
 -BypassIdp true `

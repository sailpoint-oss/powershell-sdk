...
function Initialize-V2025OrphanIdentitiesReportArguments {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025OrphanIdentitiesReportArguments' | Write-Debug
...
OrphanIdentitiesReportArguments<PSCustomObject>
#>
function ConvertFrom-V2025JsonToOrphanIdentitiesReportArguments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025OrphanIdentitiesReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025OrphanIdentitiesReportArguments

...
Comment1<PSCustomObject>
#>

function Initialize-Comment1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => Comment1' | Write-Debug
...
Convert from JSON to Comment1<PSCustomObject>
...
Comment1<PSCustomObject>
#>
function ConvertFrom-JsonToComment1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => Comment1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Comment1

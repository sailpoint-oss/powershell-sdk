...
function Initialize-Provisioningcriterialevel3 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfilesV1 => Provisioningcriterialevel3' | Write-Debug
...
Provisioningcriterialevel3<PSCustomObject>
#>
function ConvertFrom-JsonToProvisioningcriterialevel3 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfilesV1 => Provisioningcriterialevel3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

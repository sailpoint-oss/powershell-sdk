...
function Initialize-V2024CreateScheduledSearchRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CreateScheduledSearchRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateScheduledSearchRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CreateScheduledSearchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaEntitlementApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaEntitlementApprovalScheme' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementApprovalScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaEntitlementApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

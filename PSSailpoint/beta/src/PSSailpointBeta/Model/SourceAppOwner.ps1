...
function Initialize-BetaSourceAppOwner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSourceAppOwner' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceAppOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSourceAppOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaViolationContextPolicy {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaViolationContextPolicy' | Write-Debug
...
function ConvertFrom-BetaJsonToViolationContextPolicy {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaViolationContextPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

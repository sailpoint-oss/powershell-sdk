...
function Initialize-BetaIdentityAttributeTransform {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributeTransform' | Write-Debug
...
IdentityAttributeTransform<PSCustomObject>
#>
function ConvertFrom-BetaJsonToIdentityAttributeTransform {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributeTransform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaIdentityAttributeTransform

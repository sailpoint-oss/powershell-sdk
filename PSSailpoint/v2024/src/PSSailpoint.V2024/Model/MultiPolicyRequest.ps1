...
function Initialize-V2024MultiPolicyRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024MultiPolicyRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToMultiPolicyRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024MultiPolicyRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

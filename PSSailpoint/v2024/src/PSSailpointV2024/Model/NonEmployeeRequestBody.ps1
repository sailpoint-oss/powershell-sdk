...
function Initialize-V2024NonEmployeeRequestBody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeRequestBody' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeRequestBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeRequestBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
IdentityProofingAction<PSCustomObject>
#>

function Initialize-NERMIdentityProofingAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMIdentityProofingAction' | Write-Debug
...
Convert from JSON to IdentityProofingAction<PSCustomObject>
...
IdentityProofingAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToIdentityProofingAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMIdentityProofingAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMIdentityProofingAction

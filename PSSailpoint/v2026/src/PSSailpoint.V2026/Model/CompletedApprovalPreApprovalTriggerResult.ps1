...
function Initialize-V2026CompletedApprovalPreApprovalTriggerResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CompletedApprovalPreApprovalTriggerResult' | Write-Debug
...
CompletedApprovalPreApprovalTriggerResult<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCompletedApprovalPreApprovalTriggerResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CompletedApprovalPreApprovalTriggerResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CompletedApprovalPreApprovalTriggerResult

...
keywords: ['powershell', 'PowerShell', 'sdk', 'EmailNotificationOption', 'V2026EmailNotificationOption'] 
slug: /tools/sdk/powershell/v2026/models/email-notification-option
...
```powershell
$EmailNotificationOption = Initialize-V2026EmailNotificationOption  -NotifyManagers true `

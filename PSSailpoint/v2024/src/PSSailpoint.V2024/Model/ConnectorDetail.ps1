...
function Initialize-V2024ConnectorDetail {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConnectorDetail' | Write-Debug
...
function ConvertFrom-V2024JsonToConnectorDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConnectorDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

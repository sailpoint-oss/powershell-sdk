...
function Initialize-V2026BulkApproveRequestDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026BulkApproveRequestDTO' | Write-Debug
...
BulkApproveRequestDTO<PSCustomObject>
#>
function ConvertFrom-V2026JsonToBulkApproveRequestDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026BulkApproveRequestDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026BulkApproveRequestDTO

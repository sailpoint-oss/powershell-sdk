...
function Initialize-BetaCampaignActivatedCampaignCampaignOwner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCampaignActivatedCampaignCampaignOwner' | Write-Debug
...
CampaignActivatedCampaignCampaignOwner<PSCustomObject>
#>
function ConvertFrom-BetaJsonToCampaignActivatedCampaignCampaignOwner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCampaignActivatedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaCampaignActivatedCampaignCampaignOwner

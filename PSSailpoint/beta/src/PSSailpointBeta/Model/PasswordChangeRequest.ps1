...
function Initialize-BetaPasswordChangeRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaPasswordChangeRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToPasswordChangeRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaPasswordChangeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaErrorResponseDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaErrorResponseDto' | Write-Debug
...
function ConvertFrom-BetaJsonToErrorResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaErrorResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

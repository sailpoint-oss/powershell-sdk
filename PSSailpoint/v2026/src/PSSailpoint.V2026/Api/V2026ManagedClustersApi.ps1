...
ManagedCluster
#>
function New-V2026ManagedCluster {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026ManagedCluster' | Write-Debug
...
None
#>
function Remove-V2026ManagedCluster {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026ManagedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026ClientLogConfiguration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ClientLogConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedCluster
#>
function Get-V2026ManagedCluster {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ManagedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedCluster[]
#>
function Get-V2026ManagedClusters {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026ManagedClusters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ClientLogConfiguration
#>
function Send-V2026ClientLogConfiguration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2026ClientLogConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-V2026 {
    ...
    Process {
        'Calling method: Update-V2026' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedCluster
#>
function Update-V2026ManagedCluster {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026ManagedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

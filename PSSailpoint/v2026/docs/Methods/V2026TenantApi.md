...
keywords: ['powershell', 'PowerShell', 'sdk', 'Tenant', 'V2026Tenant'] 
slug: /tools/sdk/powershell/v2026/methods/tenant
...
------------- | ------------- | -------------
[**Get-V2026Tenant**](#get-tenant) | **GET** `/tenant` | Get tenant information.
...
try {
    ...
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Tenant"

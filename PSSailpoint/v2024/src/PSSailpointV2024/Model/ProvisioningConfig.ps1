...
function Initialize-V2024ProvisioningConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ProvisioningConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ProvisioningConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

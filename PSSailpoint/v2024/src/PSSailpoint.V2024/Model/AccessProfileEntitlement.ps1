...
function Initialize-V2024AccessProfileEntitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessProfileEntitlement' | Write-Debug
...
AccessProfileEntitlement<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccessProfileEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessProfileEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

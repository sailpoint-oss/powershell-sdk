...
function Initialize-BetaJsonPatchOperation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaJsonPatchOperation' | Write-Debug
...
JsonPatchOperation<PSCustomObject>
#>
function ConvertFrom-BetaJsonToJsonPatchOperation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaJsonPatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaJsonPatchOperation

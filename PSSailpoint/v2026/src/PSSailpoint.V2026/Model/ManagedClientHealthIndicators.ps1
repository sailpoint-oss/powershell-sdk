...
function Initialize-V2026ManagedClientHealthIndicators {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ManagedClientHealthIndicators' | Write-Debug
...
ManagedClientHealthIndicators<PSCustomObject>
#>
function ConvertFrom-V2026JsonToManagedClientHealthIndicators {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ManagedClientHealthIndicators' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ManagedClientHealthIndicators

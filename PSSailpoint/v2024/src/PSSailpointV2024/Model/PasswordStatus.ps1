...
function Initialize-V2024PasswordStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PasswordStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToPasswordStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PasswordStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

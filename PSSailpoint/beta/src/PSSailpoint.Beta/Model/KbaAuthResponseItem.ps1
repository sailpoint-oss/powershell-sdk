...
function Initialize-BetaKbaAuthResponseItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaKbaAuthResponseItem' | Write-Debug
...
function ConvertFrom-BetaJsonToKbaAuthResponseItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaKbaAuthResponseItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

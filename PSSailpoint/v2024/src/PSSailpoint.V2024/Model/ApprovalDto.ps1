...
function Initialize-V2024ApprovalDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ApprovalDto' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ApprovalDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

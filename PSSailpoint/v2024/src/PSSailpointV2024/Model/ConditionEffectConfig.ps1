...
function Initialize-V2024ConditionEffectConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ConditionEffectConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToConditionEffectConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ConditionEffectConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

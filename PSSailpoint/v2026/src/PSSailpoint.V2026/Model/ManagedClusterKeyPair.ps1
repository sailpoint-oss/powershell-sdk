...
function Initialize-V2026ManagedClusterKeyPair {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ManagedClusterKeyPair' | Write-Debug
...
ManagedClusterKeyPair<PSCustomObject>
#>
function ConvertFrom-V2026JsonToManagedClusterKeyPair {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ManagedClusterKeyPair' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ManagedClusterKeyPair

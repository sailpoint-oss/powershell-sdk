...
keywords: ['powershell', 'PowerShell', 'sdk', 'MfaDuoConfig', 'V2026MfaDuoConfig'] 
slug: /tools/sdk/powershell/v2026/models/mfa-duo-config
...
```powershell
$MfaDuoConfig = Initialize-V2026MfaDuoConfig  -MfaMethod duo-web `
 -Enabled true `
 -VarHost example.com `

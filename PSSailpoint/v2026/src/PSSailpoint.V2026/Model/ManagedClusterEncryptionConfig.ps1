...
function Initialize-V2026ManagedClusterEncryptionConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ManagedClusterEncryptionConfig' | Write-Debug
...
ManagedClusterEncryptionConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToManagedClusterEncryptionConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ManagedClusterEncryptionConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ManagedClusterEncryptionConfig

...
function Initialize-BetaCreateOAuthClientRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCreateOAuthClientRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateOAuthClientRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCreateOAuthClientRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

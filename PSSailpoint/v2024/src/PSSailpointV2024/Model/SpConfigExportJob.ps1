...
function Initialize-V2024SpConfigExportJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SpConfigExportJob' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigExportJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SpConfigExportJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

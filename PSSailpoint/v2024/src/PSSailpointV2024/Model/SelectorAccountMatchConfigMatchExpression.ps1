...
function Initialize-V2024SelectorAccountMatchConfigMatchExpression {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SelectorAccountMatchConfigMatchExpression' | Write-Debug
...
function ConvertFrom-V2024JsonToSelectorAccountMatchConfigMatchExpression {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SelectorAccountMatchConfigMatchExpression' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

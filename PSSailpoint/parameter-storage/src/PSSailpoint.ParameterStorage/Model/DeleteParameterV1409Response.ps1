...
DeleteParameterV1409Response<PSCustomObject>
#>

function Initialize-DeleteParameterV1409Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to DeleteParameterV1409Response<PSCustomObject>
...
DeleteParameterV1409Response<PSCustomObject>
#>
function ConvertFrom-JsonToDeleteParameterV1409Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in DeleteParameterV1409Response

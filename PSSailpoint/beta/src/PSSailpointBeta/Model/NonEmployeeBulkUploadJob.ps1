...
function Initialize-BetaNonEmployeeBulkUploadJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaNonEmployeeBulkUploadJob' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeBulkUploadJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaNonEmployeeBulkUploadJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

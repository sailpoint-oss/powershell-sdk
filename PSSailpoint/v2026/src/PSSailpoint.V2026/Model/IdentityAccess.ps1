...
#>
function ConvertFrom-V2026JsonToIdentityAccess {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            $matchInstance = ConvertFrom-V2026JsonToAccessProfileEntitlement $Json
            ...
            Write-Debug "Failed to match 'AccessProfileEntitlement' defined in oneOf (V2026IdentityAccess). Proceeding to the next one if any."
        }

        # try to match AccessProfileRole defined in the oneOf schemas
        try {
            $matchInstance = ConvertFrom-V2026JsonToAccessProfileRole $Json
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'AccessProfileRole' defined in oneOf (V2026IdentityAccess). Proceeding to the next one if any."
        }

        # try to match AccessProfileSummary defined in the oneOf schemas
        try {
            $matchInstance = ConvertFrom-V2026JsonToAccessProfileSummary $Json
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'AccessProfileSummary' defined in oneOf (V2026IdentityAccess). Proceeding to the next one if any."
        }

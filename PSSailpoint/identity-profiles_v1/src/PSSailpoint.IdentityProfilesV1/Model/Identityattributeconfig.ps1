...
function Initialize-Identityattributeconfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IdentityProfilesV1 => Identityattributeconfig' | Write-Debug
...
function ConvertFrom-JsonToIdentityattributeconfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IdentityProfilesV1 => Identityattributeconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026EntitlementAttributeBulkUpdateFilterRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026EntitlementAttributeBulkUpdateFilterRequest' | Write-Debug
...
EntitlementAttributeBulkUpdateFilterRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToEntitlementAttributeBulkUpdateFilterRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026EntitlementAttributeBulkUpdateFilterRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026EntitlementAttributeBulkUpdateFilterRequest

...
keywords: ['powershell', 'PowerShell', 'sdk', 'SavedSearchDetailFilters', 'V2026SavedSearchDetailFilters'] 
slug: /tools/sdk/powershell/v2026/models/saved-search-detail-filters
...
```powershell
$SavedSearchDetailFilters = Initialize-V2026SavedSearchDetailFilters  -Type null `
 -Range null `
 -Terms null `
 -Exclude false
```

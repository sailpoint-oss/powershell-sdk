...
function Initialize-Entitlementconnection {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.EntitlementConnections => Entitlementconnection' | Write-Debug
...
Entitlementconnection<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementconnection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.EntitlementConnections => Entitlementconnection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Entitlementconnection

...
function Initialize-CampaignActivatedCampaign {
    [CmdletBinding()]
    Param (
...
CampaignActivatedCampaign<PSCustomObject>
#>
function ConvertFrom-JsonToCampaignActivatedCampaign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in CampaignActivatedCampaign

...
function Initialize-ApprovalItemDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ApprovalItemDetails' | Write-Debug
...
function ConvertFrom-JsonToApprovalItemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ApprovalItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

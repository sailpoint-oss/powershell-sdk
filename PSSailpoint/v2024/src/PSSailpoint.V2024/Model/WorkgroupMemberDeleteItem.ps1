...
function Initialize-V2024WorkgroupMemberDeleteItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024WorkgroupMemberDeleteItem' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkgroupMemberDeleteItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024WorkgroupMemberDeleteItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

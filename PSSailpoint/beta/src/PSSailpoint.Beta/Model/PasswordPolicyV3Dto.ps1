...
function Initialize-BetaPasswordPolicyV3Dto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaPasswordPolicyV3Dto' | Write-Debug
...
PasswordPolicyV3Dto<PSCustomObject>
#>
function ConvertFrom-BetaJsonToPasswordPolicyV3Dto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaPasswordPolicyV3Dto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

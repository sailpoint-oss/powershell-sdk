...
function Initialize-BetaRoleMiningSessionDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningSessionDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

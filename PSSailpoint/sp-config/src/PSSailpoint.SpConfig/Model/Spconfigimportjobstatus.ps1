...
function Initialize-Spconfigimportjobstatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigimportjobstatus' | Write-Debug
...
Spconfigimportjobstatus<PSCustomObject>
#>
function ConvertFrom-JsonToSpconfigimportjobstatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigimportjobstatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Spconfigimportjobstatus

...
function Initialize-Userapp {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AppsV1 => Userapp' | Write-Debug
...
Userapp<PSCustomObject>
#>
function ConvertFrom-JsonToUserapp {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AppsV1 => Userapp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Userapp

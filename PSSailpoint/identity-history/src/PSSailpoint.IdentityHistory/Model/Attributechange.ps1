...
function Initialize-Attributechange {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IdentityHistory => Attributechange' | Write-Debug
...
function ConvertFrom-JsonToAttributechange {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IdentityHistory => Attributechange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

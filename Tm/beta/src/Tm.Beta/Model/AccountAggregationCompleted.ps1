...
function Initialize-BetaAccountAggregationCompleted {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountAggregationCompleted' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAggregationCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountAggregationCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SourceAppAccountSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SourceAppAccountSource' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceAppAccountSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SourceAppAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

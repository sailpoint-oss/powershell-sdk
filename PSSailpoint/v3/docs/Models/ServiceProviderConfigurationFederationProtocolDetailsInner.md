...
$ServiceProviderConfigurationFederationProtocolDetailsInner = @"undefined"@
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToServiceProviderConfigurationFederationProtocolDetailsInner -Json $ServiceProviderConfigurationFederationProtocolDetailsInner
```

...
function Initialize-V2026FullDiscoveredApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026FullDiscoveredApplications' | Write-Debug
...
FullDiscoveredApplications<PSCustomObject>
#>
function ConvertFrom-V2026JsonToFullDiscoveredApplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026FullDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026FullDiscoveredApplications

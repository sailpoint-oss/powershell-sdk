...
function New-BetaLauncher {
    ...
    Process {
        'Calling method: New-BetaLauncher' | Write-Debug
...
function Remove-BetaLauncher {
    ...
    Process {
        'Calling method: Remove-BetaLauncher' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Send-BetaLauncher {
    ...
    Process {
        'Calling method: Send-BetaLauncher' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

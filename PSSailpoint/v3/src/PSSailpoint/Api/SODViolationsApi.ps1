...
function Get-ArmConfig {
    ...
    Process {
        'Calling method: Get-ArmConfig' | Write-Debug
        ...
        $LocalVarUri = '/sod-violations/config'
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "PublicOrgConfigArmData" `
...
ViolationPrediction
#>
function Start-PredictSodViolations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Start-PredictSodViolations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Start-ViolationCheck {
    ...
    Process {
        'Calling method: Start-ViolationCheck' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

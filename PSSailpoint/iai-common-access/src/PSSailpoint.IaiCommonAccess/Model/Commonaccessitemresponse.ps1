...
function Initialize-Commonaccessitemresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiCommonAccessV1 => Commonaccessitemresponse' | Write-Debug
...
Commonaccessitemresponse<PSCustomObject>
#>
function ConvertFrom-JsonToCommonaccessitemresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiCommonAccessV1 => Commonaccessitemresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Commonaccessitemresponse

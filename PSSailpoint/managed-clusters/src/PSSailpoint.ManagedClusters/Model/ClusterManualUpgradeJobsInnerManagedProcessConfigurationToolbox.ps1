...
function Initialize-ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClusters => ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
...
function ConvertFrom-JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClusters => ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

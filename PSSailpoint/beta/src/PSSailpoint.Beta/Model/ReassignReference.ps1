...
function Initialize-BetaReassignReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaReassignReference' | Write-Debug
...
ReassignReference<PSCustomObject>
#>
function ConvertFrom-BetaJsonToReassignReference {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaReassignReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaReassignReference

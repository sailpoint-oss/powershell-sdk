...
function Initialize-Provisioningcriterialevel1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Dimensions => Provisioningcriterialevel1' | Write-Debug
...
function ConvertFrom-JsonToProvisioningcriterialevel1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Dimensions => Provisioningcriterialevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

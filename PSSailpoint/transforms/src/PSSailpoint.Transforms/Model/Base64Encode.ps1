...
function Initialize-Base64Encode {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Transforms => Base64Encode' | Write-Debug
...
function ConvertFrom-JsonToBase64Encode {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Transforms => Base64Encode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

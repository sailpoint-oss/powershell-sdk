...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessDuration', 'V2026AccessDuration'] 
slug: /tools/sdk/powershell/v2026/models/access-duration
...
```powershell
$AccessDuration = Initialize-V2026AccessDuration  -Value 6 `
 -TimeUnit MONTHS
```

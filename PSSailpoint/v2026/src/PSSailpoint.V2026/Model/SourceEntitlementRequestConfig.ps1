...
function Initialize-V2026SourceEntitlementRequestConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SourceEntitlementRequestConfig' | Write-Debug
...
SourceEntitlementRequestConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSourceEntitlementRequestConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SourceEntitlementRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SourceEntitlementRequestConfig

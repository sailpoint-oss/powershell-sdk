...
function Initialize-V2024Ref {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Ref' | Write-Debug
...
Ref<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Ref' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024Ref

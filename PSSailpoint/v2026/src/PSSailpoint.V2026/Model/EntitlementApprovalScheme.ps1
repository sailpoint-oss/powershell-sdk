...
function Initialize-V2026EntitlementApprovalScheme {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026EntitlementApprovalScheme' | Write-Debug
...
EntitlementApprovalScheme<PSCustomObject>
#>
function ConvertFrom-V2026JsonToEntitlementApprovalScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026EntitlementApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026EntitlementApprovalScheme

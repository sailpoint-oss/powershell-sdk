...
function Initialize-BetaCommonAccessResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCommonAccessResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToCommonAccessResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCommonAccessResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ProvisioningPolicyDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ProvisioningPolicyDto' | Write-Debug
...
function ConvertFrom-JsonToProvisioningPolicyDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ProvisioningPolicyDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

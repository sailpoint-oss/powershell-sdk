...
function Initialize-V2024KbaAnswerResponseItem {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024KbaAnswerResponseItem' | Write-Debug
...
function ConvertFrom-V2024JsonToKbaAnswerResponseItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024KbaAnswerResponseItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

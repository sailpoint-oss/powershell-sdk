...
function Initialize-PatchServiceDeskIntegrationRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => PatchServiceDeskIntegrationRequest' | Write-Debug
...
function ConvertFrom-JsonToPatchServiceDeskIntegrationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => PatchServiceDeskIntegrationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

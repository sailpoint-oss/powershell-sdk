...
function Initialize-V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon<PSCustomObject>
#>
function ConvertFrom-V2024JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon

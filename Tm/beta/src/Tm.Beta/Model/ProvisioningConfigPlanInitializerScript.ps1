...
function Initialize-BetaProvisioningConfigPlanInitializerScript {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaProvisioningConfigPlanInitializerScript' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningConfigPlanInitializerScript {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaProvisioningConfigPlanInitializerScript' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

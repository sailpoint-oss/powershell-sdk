...
function Initialize-V2024ObjectMappingBulkCreateResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ObjectMappingBulkCreateResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToObjectMappingBulkCreateResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ObjectMappingBulkCreateResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'SpConfigMessage', 'V2026SpConfigMessage'] 
slug: /tools/sdk/powershell/v2026/models/sp-config-message
...
```powershell
$SpConfigMessage = Initialize-V2026SpConfigMessage  -Key UNKNOWN_REFERENCE_RESOLVER `

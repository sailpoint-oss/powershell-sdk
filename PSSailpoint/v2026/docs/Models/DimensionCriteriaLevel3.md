...
keywords: ['powershell', 'PowerShell', 'sdk', 'DimensionCriteriaLevel3', 'V2026DimensionCriteriaLevel3'] 
slug: /tools/sdk/powershell/v2026/models/dimension-criteria-level3
...
```powershell
$DimensionCriteriaLevel3 = Initialize-V2026DimensionCriteriaLevel3  -Operation null `
 -Key null `

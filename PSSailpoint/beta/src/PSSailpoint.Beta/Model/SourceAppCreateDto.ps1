...
function Initialize-BetaSourceAppCreateDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceAppCreateDto' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceAppCreateDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceAppCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

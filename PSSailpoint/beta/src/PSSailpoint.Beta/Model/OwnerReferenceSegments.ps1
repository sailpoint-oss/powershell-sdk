...
function Initialize-BetaOwnerReferenceSegments {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaOwnerReferenceSegments' | Write-Debug
...
function ConvertFrom-BetaJsonToOwnerReferenceSegments {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaOwnerReferenceSegments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

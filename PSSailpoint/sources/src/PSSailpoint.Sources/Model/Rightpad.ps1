...
function Initialize-Rightpad {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => Rightpad' | Write-Debug
...
Rightpad<PSCustomObject>
#>
function ConvertFrom-JsonToRightpad {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => Rightpad' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Rightpad

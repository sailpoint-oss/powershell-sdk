...
function Initialize-V2024TransformDefinition {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TransformDefinition' | Write-Debug
...
function ConvertFrom-V2024JsonToTransformDefinition {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TransformDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

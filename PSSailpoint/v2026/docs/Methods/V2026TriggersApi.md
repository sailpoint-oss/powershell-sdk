...
keywords: ['powershell', 'PowerShell', 'sdk', 'Triggers', 'V2026Triggers'] 
slug: /tools/sdk/powershell/v2026/methods/triggers
...
------------- | ------------- | -------------
[**Complete-V2026TriggerInvocation**](#complete-trigger-invocation) | **POST** `/trigger-invocations/{id}/complete` | Complete trigger invocation
[**New-V2026Subscription**](#create-subscription) | **POST** `/trigger-subscriptions` | Create a subscription
[**Remove-V2026Subscription**](#delete-subscription) | **DELETE** `/trigger-subscriptions/{id}` | Delete a subscription
[**Get-V2026Subscriptions**](#list-subscriptions) | **GET** `/trigger-subscriptions` | List subscriptions
[**Get-V2026TriggerInvocationStatus**](#list-trigger-invocation-status) | **GET** `/trigger-invocations/status` | List latest invocation statuses
[**Get-V2026Triggers**](#list-triggers) | **GET** `/triggers` | List triggers
[**Update-V2026Subscription**](#patch-subscription) | **PATCH** `/trigger-subscriptions/{id}` | Patch a subscription
[**Start-V2026TestTriggerInvocation**](#start-test-trigger-invocation) | **POST** `/trigger-invocations/test` | Start a test invocation
[**Test-V2026SubscriptionFilter**](#test-subscription-filter) | **POST** `/trigger-subscriptions/validate-filter` | Validate a subscription filter
[**Update-V2026Subscription**](#update-subscription) | **PUT** `/trigger-subscriptions/{id}` | Update a subscription
...
try {
    $Result = ConvertFrom-V2026JsonToCompleteInvocation -Json $CompleteInvocation
    Complete-V2026TriggerInvocation -Id $Id -CompleteInvocation $Result 
    
    # Below is a request that includes all optional parameters
    # Complete-V2026TriggerInvocation -Id $Id -CompleteInvocation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Complete-V2026TriggerInvocation"
...
try {
    $Result = ConvertFrom-V2026JsonToSubscriptionPostRequest -Json $SubscriptionPostRequest
    New-V2026Subscription -SubscriptionPostRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Subscription -SubscriptionPostRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Subscription"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026Subscription -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Subscription -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Subscription"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Subscriptions 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Subscriptions -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Subscriptions"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026TriggerInvocationStatus 
    
    # Below is a request that includes all optional parameters
    # Get-V2026TriggerInvocationStatus -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026TriggerInvocationStatus"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Triggers -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Triggers"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSubscriptionPatchRequestInner -Json $SubscriptionPatchRequestInner
    Update-V2026Subscription -Id $Id -SubscriptionPatchRequestInner $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026Subscription -Id $Id -SubscriptionPatchRequestInner $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026Subscription"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToTestInvocation -Json $TestInvocation
    Start-V2026TestTriggerInvocation -TestInvocation $Result 
    
    # Below is a request that includes all optional parameters
    # Start-V2026TestTriggerInvocation -TestInvocation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Start-V2026TestTriggerInvocation"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToValidateFilterInputDto -Json $ValidateFilterInputDto
    Test-V2026SubscriptionFilter -ValidateFilterInputDto $Result 
    
    # Below is a request that includes all optional parameters
    # Test-V2026SubscriptionFilter -ValidateFilterInputDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Test-V2026SubscriptionFilter"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSubscriptionPutRequest -Json $SubscriptionPutRequest
    Update-V2026Subscription -Id $Id -SubscriptionPutRequest $Result 

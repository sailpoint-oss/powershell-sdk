...
function Initialize-V2025AccessItemEntitlementResponse {
    [CmdletBinding()]
    Param (
...
AccessItemEntitlementResponse<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccessItemEntitlementResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccessItemEntitlementResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

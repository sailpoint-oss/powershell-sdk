...
function Initialize-V2024RequestableObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RequestableObject' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestableObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RequestableObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

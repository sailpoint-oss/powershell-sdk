...
function Initialize-V2026RoleMiningSessionDraftRoleDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningSessionDraftRoleDto' | Write-Debug
...
RoleMiningSessionDraftRoleDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMiningSessionDraftRoleDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningSessionDraftRoleDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMiningSessionDraftRoleDto

...
function Initialize-Jsonpatchoperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentities => Jsonpatchoperation' | Write-Debug
...
function ConvertFrom-JsonToJsonpatchoperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentities => Jsonpatchoperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaLocalizedMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaLocalizedMessage' | Write-Debug
...
LocalizedMessage<PSCustomObject>
#>
function ConvertFrom-BetaJsonToLocalizedMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaLocalizedMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaLocalizedMessage

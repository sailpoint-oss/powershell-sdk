...
function Initialize-V2024AttrSyncSourceAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AttrSyncSourceAttributeConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToAttrSyncSourceAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AttrSyncSourceAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

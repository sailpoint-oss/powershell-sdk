...
function Initialize-V2024RecommendationResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RecommendationResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToRecommendationResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RecommendationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

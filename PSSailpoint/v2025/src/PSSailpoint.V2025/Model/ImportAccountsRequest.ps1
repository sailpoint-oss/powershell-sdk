...
function Initialize-V2025ImportAccountsRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ImportAccountsRequest' | Write-Debug
...
ImportAccountsRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToImportAccountsRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ImportAccountsRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ImportAccountsRequest

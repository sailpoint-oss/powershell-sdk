...
function Initialize-BetaCreateOAuthClientRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCreateOAuthClientRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateOAuthClientRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCreateOAuthClientRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccessProfileApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessProfileApprovalScheme' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileApprovalScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessProfileApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026RoleMiningPotentialRoleSourceUsage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleSourceUsage' | Write-Debug
...
RoleMiningPotentialRoleSourceUsage<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMiningPotentialRoleSourceUsage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleSourceUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMiningPotentialRoleSourceUsage

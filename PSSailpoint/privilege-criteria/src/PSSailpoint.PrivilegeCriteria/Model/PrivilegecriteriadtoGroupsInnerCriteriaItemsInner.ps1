...
function Initialize-PrivilegecriteriadtoGroupsInnerCriteriaItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PrivilegeCriteriaV1 => PrivilegecriteriadtoGroupsInnerCriteriaItemsInner' | Write-Debug
...
PrivilegecriteriadtoGroupsInnerCriteriaItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToPrivilegecriteriadtoGroupsInnerCriteriaItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PrivilegeCriteriaV1 => PrivilegecriteriadtoGroupsInnerCriteriaItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrivilegecriteriadtoGroupsInnerCriteriaItemsInner

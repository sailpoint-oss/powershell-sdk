...
function Initialize-NonEmployeeRequestWithoutApprovalItem {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => NonEmployeeRequestWithoutApprovalItem' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeRequestWithoutApprovalItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => NonEmployeeRequestWithoutApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

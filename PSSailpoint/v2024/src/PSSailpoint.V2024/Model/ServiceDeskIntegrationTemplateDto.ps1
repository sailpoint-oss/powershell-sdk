...
function Initialize-V2024ServiceDeskIntegrationTemplateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ServiceDeskIntegrationTemplateDto' | Write-Debug
...
ServiceDeskIntegrationTemplateDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToServiceDeskIntegrationTemplateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ServiceDeskIntegrationTemplateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ServiceDeskIntegrationTemplateDto

...
function Initialize-V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox<PSCustomObject>
#>
function ConvertFrom-V2026JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox

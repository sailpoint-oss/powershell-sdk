...
function Initialize-V2024WorkflowOAuthClient {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024WorkflowOAuthClient' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowOAuthClient {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024WorkflowOAuthClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

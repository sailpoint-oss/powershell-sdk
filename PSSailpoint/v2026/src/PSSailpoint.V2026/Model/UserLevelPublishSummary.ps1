...
function Initialize-V2026UserLevelPublishSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026UserLevelPublishSummary' | Write-Debug
...
UserLevelPublishSummary<PSCustomObject>
#>
function ConvertFrom-V2026JsonToUserLevelPublishSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026UserLevelPublishSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026UserLevelPublishSummary

...
ProfileAttributeRuleDate1<PSCustomObject>
#>

function Initialize-NERMProfileAttributeRuleDate1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMProfileAttributeRuleDate1' | Write-Debug
...
Convert from JSON to ProfileAttributeRuleDate1<PSCustomObject>
...
ProfileAttributeRuleDate1<PSCustomObject>
#>
function ConvertFrom-NERMJsonToProfileAttributeRuleDate1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMProfileAttributeRuleDate1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMProfileAttributeRuleDate1
        $AllProperties = ("type", "condition_object_type", "condition_object_id", "secondary_attribute_type", "secondary_attribute_id", "comparison_operator", "value", "secondary_value", "tertiary_value")

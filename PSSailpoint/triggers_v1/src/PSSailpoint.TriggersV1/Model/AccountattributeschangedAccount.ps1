...
function Initialize-AccountattributeschangedAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => AccountattributeschangedAccount' | Write-Debug
...
AccountattributeschangedAccount<PSCustomObject>
#>
function ConvertFrom-JsonToAccountattributeschangedAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => AccountattributeschangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountattributeschangedAccount

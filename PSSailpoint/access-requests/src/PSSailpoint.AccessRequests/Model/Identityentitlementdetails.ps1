...
function Initialize-Identityentitlementdetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => Identityentitlementdetails' | Write-Debug
...
function ConvertFrom-JsonToIdentityentitlementdetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => Identityentitlementdetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

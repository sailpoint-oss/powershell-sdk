...
function Initialize-ManualDiscoverApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ManualDiscoverApplications' | Write-Debug
...
ManualDiscoverApplications<PSCustomObject>
#>
function ConvertFrom-JsonToManualDiscoverApplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ManualDiscoverApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ManualDiscoverApplications
        $AllProperties = ("file")

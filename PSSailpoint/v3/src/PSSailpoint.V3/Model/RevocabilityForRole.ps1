...
function Initialize-RevocabilityForRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RevocabilityForRole' | Write-Debug
...
RevocabilityForRole<PSCustomObject>
#>
function ConvertFrom-JsonToRevocabilityForRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RevocabilityForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RevocabilityForRole

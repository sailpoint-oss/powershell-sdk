...
function Initialize-V2024TemplateDtoDefault {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TemplateDtoDefault' | Write-Debug
...
function ConvertFrom-V2024JsonToTemplateDtoDefault {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TemplateDtoDefault' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

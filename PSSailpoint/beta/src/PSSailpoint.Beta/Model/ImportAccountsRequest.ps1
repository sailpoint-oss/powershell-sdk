...
function Initialize-BetaImportAccountsRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaImportAccountsRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToImportAccountsRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaImportAccountsRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

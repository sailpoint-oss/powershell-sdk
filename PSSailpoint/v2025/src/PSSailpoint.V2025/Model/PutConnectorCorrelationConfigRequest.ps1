...
function Initialize-V2025PutConnectorCorrelationConfigRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025PutConnectorCorrelationConfigRequest' | Write-Debug
...
PutConnectorCorrelationConfigRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToPutConnectorCorrelationConfigRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025PutConnectorCorrelationConfigRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025PutConnectorCorrelationConfigRequest
        $AllProperties = ("file")

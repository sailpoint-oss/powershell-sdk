...
function Initialize-V2024SodViolationContextCheckCompleted1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SodViolationContextCheckCompleted1' | Write-Debug
...
SodViolationContextCheckCompleted1<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSodViolationContextCheckCompleted1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SodViolationContextCheckCompleted1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SodViolationContextCheckCompleted1

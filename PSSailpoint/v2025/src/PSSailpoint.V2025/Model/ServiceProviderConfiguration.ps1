...
function Initialize-V2025ServiceProviderConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ServiceProviderConfiguration' | Write-Debug
...
ServiceProviderConfiguration<PSCustomObject>
#>
function ConvertFrom-V2025JsonToServiceProviderConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ServiceProviderConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ServiceProviderConfiguration

...
function Initialize-MachineIdentityCreatedMachineIdentity {
    [CmdletBinding()]
    Param (
...
MachineIdentityCreatedMachineIdentity<PSCustomObject>
#>
function ConvertFrom-JsonToMachineIdentityCreatedMachineIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in MachineIdentityCreatedMachineIdentity

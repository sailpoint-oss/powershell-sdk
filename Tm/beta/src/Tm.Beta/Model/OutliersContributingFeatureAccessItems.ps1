...
function Initialize-BetaOutliersContributingFeatureAccessItems {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaOutliersContributingFeatureAccessItems' | Write-Debug
...
function ConvertFrom-BetaJsonToOutliersContributingFeatureAccessItems {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaOutliersContributingFeatureAccessItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

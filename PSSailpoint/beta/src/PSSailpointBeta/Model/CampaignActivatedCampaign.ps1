...
function Initialize-BetaCampaignActivatedCampaign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaCampaignActivatedCampaign' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignActivatedCampaign {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaCampaignActivatedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

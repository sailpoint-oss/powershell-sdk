...
function Initialize-V2024GetReferenceIdentityAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024GetReferenceIdentityAttribute' | Write-Debug
...
function ConvertFrom-V2024JsonToGetReferenceIdentityAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024GetReferenceIdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

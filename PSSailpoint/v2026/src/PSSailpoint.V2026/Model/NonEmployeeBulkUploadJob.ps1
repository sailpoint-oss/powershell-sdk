...
function Initialize-V2026NonEmployeeBulkUploadJob {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeBulkUploadJob' | Write-Debug
...
NonEmployeeBulkUploadJob<PSCustomObject>
#>
function ConvertFrom-V2026JsonToNonEmployeeBulkUploadJob {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeBulkUploadJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026NonEmployeeBulkUploadJob

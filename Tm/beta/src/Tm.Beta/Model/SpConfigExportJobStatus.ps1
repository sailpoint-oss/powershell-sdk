...
function Initialize-BetaSpConfigExportJobStatus {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSpConfigExportJobStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToSpConfigExportJobStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSpConfigExportJobStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaFormElementValidationsSet {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaFormElementValidationsSet' | Write-Debug
...
function ConvertFrom-BetaJsonToFormElementValidationsSet {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaFormElementValidationsSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

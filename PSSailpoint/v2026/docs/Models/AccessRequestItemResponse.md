...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessRequestItemResponse', 'V2026AccessRequestItemResponse'] 
slug: /tools/sdk/powershell/v2026/models/access-request-item-response
...
```powershell
$AccessRequestItemResponse = Initialize-V2026AccessRequestItemResponse  -Operation Add `
 -AccessItemType role `
 -Name Role-1 `
 -Decision APPROVED `

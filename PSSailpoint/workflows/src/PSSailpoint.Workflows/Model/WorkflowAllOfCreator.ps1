...
function Initialize-WorkflowAllOfCreator {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.WorkflowsV1 => WorkflowAllOfCreator' | Write-Debug
...
function ConvertFrom-JsonToWorkflowAllOfCreator {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.WorkflowsV1 => WorkflowAllOfCreator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

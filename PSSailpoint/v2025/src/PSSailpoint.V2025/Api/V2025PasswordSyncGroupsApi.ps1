...
PasswordSyncGroup
#>
function New-V2025PasswordSyncGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025PasswordSyncGroup' | Write-Debug
...
None
#>
function Remove-V2025PasswordSyncGroup {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025PasswordSyncGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordSyncGroup
#>
function Get-V2025PasswordSyncGroup {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025PasswordSyncGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordSyncGroup[]
#>
function Get-V2025PasswordSyncGroups {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2025PasswordSyncGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordSyncGroup
#>
function Update-V2025PasswordSyncGroup {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025PasswordSyncGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

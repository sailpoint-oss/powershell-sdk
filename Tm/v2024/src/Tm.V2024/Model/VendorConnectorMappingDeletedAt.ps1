...
function Initialize-V2024VendorConnectorMappingDeletedAt {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024VendorConnectorMappingDeletedAt' | Write-Debug
...
function ConvertFrom-V2024JsonToVendorConnectorMappingDeletedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024VendorConnectorMappingDeletedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

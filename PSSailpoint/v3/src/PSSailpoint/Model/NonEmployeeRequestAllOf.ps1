...
function Initialize-NonEmployeeRequestAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeRequestAllOf' | Write-Debug
...
NonEmployeeRequestAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToNonEmployeeRequestAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeRequestAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NonEmployeeRequestAllOf

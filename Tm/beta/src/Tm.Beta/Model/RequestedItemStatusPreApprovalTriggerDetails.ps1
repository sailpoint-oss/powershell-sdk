...
function Initialize-BetaRequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestedItemStatusPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Accessrequestrecommendationitemdetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiAccessRequestRecommendationsV1 => Accessrequestrecommendationitemdetail' | Write-Debug
...
Accessrequestrecommendationitemdetail<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestrecommendationitemdetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiAccessRequestRecommendationsV1 => Accessrequestrecommendationitemdetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessrequestrecommendationitemdetail

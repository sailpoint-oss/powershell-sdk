...
function Initialize-Createforminstancerequest {
    [CmdletBinding()]
    Param (
...
Createforminstancerequest<PSCustomObject>
#>
function ConvertFrom-JsonToCreateforminstancerequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Createforminstancerequest

...
function Initialize-CampaigngeneratedCampaign {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => CampaigngeneratedCampaign' | Write-Debug
...
CampaigngeneratedCampaign<PSCustomObject>
#>
function ConvertFrom-JsonToCampaigngeneratedCampaign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => CampaigngeneratedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CampaigngeneratedCampaign

...
keywords: ['powershell', 'PowerShell', 'sdk', 'PasswordDictionary', 'V2026PasswordDictionary'] 
slug: /tools/sdk/powershell/v2026/methods/password-dictionary
...
------------- | ------------- | -------------
[**Get-V2026PasswordDictionary**](#get-password-dictionary) | **GET** `/password-dictionary` | Get password dictionary
[**Send-V2026PasswordDictionary**](#put-password-dictionary) | **PUT** `/password-dictionary` | Update password dictionary
...
try {
    Get-V2026PasswordDictionary 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PasswordDictionary  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026PasswordDictionary"
...
try {
    Send-V2026PasswordDictionary 
    
    # Below is a request that includes all optional parameters
    # Send-V2026PasswordDictionary -File $File  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026PasswordDictionary"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-BetaWorkflowExecutionEvent {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaWorkflowExecutionEvent' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowExecutionEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaWorkflowExecutionEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

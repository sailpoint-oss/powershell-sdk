...
function Initialize-BetaCampaignActivatedCampaign {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCampaignActivatedCampaign' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignActivatedCampaign {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCampaignActivatedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

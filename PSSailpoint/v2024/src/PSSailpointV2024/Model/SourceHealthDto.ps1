...
function Initialize-V2024SourceHealthDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SourceHealthDto' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceHealthDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SourceHealthDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeApprovalItemDetailAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeApprovalItemDetailAllOf' | Write-Debug
...
NonEmployeeApprovalItemDetailAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToNonEmployeeApprovalItemDetailAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeApprovalItemDetailAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NonEmployeeApprovalItemDetailAllOf

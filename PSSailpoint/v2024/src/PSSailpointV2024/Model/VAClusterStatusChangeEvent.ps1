...
function Initialize-V2024VAClusterStatusChangeEvent {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024VAClusterStatusChangeEvent' | Write-Debug
...
function ConvertFrom-V2024JsonToVAClusterStatusChangeEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024VAClusterStatusChangeEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

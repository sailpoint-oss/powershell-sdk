...
function Initialize-V2024AccessReviewReassignment {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccessReviewReassignment' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessReviewReassignment {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccessReviewReassignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024Entitlement1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Entitlement1' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlement1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Entitlement1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

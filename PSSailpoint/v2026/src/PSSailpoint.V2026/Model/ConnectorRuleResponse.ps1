...
function Initialize-V2026ConnectorRuleResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ConnectorRuleResponse' | Write-Debug
...
ConnectorRuleResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToConnectorRuleResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ConnectorRuleResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ConnectorRuleResponse

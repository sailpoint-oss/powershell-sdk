...
function Initialize-ErrorResponseDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClusters => ErrorResponseDto' | Write-Debug
...
function ConvertFrom-JsonToErrorResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClusters => ErrorResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

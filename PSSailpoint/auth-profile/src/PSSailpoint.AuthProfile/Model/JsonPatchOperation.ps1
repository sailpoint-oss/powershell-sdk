...
function Initialize-JsonPatchOperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AuthProfile => JsonPatchOperation' | Write-Debug
...
function ConvertFrom-JsonToJsonPatchOperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AuthProfile => JsonPatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

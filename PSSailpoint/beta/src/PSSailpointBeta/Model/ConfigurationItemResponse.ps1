...
function Initialize-BetaConfigurationItemResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaConfigurationItemResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToConfigurationItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaConfigurationItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaGetFormDefinitionByKey400Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaGetFormDefinitionByKey400Response' | Write-Debug
...
function ConvertFrom-BetaJsonToGetFormDefinitionByKey400Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaGetFormDefinitionByKey400Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

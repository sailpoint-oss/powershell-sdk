...
function Initialize-ErrorResponseDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TaggedObjects => ErrorResponseDto' | Write-Debug
...
function ConvertFrom-JsonToErrorResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TaggedObjects => ErrorResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

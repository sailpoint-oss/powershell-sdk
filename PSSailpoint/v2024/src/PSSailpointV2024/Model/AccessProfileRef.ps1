...
function Initialize-V2024AccessProfileRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileRef' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

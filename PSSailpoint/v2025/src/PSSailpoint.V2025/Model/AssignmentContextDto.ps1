...
function Initialize-V2025AssignmentContextDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AssignmentContextDto' | Write-Debug
...
AssignmentContextDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAssignmentContextDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AssignmentContextDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AssignmentContextDto

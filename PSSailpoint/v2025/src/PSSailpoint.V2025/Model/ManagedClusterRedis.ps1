...
function Initialize-V2025ManagedClusterRedis {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ManagedClusterRedis' | Write-Debug
...
ManagedClusterRedis<PSCustomObject>
#>
function ConvertFrom-V2025JsonToManagedClusterRedis {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ManagedClusterRedis' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ManagedClusterRedis

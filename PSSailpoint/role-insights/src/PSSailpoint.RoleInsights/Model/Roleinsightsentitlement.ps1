...
function Initialize-Roleinsightsentitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsightsentitlement' | Write-Debug
...
Roleinsightsentitlement<PSCustomObject>
#>
function ConvertFrom-JsonToRoleinsightsentitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsightsentitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleinsightsentitlement

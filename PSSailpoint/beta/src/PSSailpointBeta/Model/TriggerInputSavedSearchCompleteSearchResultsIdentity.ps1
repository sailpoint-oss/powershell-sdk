...
TriggerInputSavedSearchCompleteSearchResultsIdentity<PSCustomObject>
#>

function Initialize-BetaTriggerInputSavedSearchCompleteSearchResultsIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputSavedSearchCompleteSearchResultsIdentity' | Write-Debug
...
Convert from JSON to TriggerInputSavedSearchCompleteSearchResultsIdentity<PSCustomObject>
...
TriggerInputSavedSearchCompleteSearchResultsIdentity<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputSavedSearchCompleteSearchResultsIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputSavedSearchCompleteSearchResultsIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputSavedSearchCompleteSearchResultsIdentity

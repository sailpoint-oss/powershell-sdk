...
function Initialize-AppAccessProfileSelectorAccountMatchConfigMatchExpression {
    [CmdletBinding()]
    Param (
...
AppAccessProfileSelectorAccountMatchConfigMatchExpression<PSCustomObject>
#>
function ConvertFrom-JsonToAppAccessProfileSelectorAccountMatchConfigMatchExpression {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AppAccessProfileSelectorAccountMatchConfigMatchExpression

...
function Initialize-V2024Certification {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Certification' | Write-Debug
...
function ConvertFrom-V2024JsonToCertification {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Certification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

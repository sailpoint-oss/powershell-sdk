...
function Initialize-V2024AccessProfileUpdateItem {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccessProfileUpdateItem' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileUpdateItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccessProfileUpdateItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccountStatusChangedAccount {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountStatusChangedAccount' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountStatusChangedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountStatusChangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024BrandingItemCreate {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024BrandingItemCreate' | Write-Debug
...
function ConvertFrom-V2024JsonToBrandingItemCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024BrandingItemCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

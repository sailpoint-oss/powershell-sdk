...
#>
function ConvertFrom-V2025JsonToAttributeRequestValue {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'String' defined in oneOf (V2025AttributeRequestValue). Proceeding to the next one if any."
        }

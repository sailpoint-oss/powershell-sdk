...
function Initialize-BetaAccessRequestPreApproval {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestPreApproval' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPreApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestPreApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

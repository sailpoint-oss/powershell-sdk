...
function Initialize-Identityentitlementdetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestsV1 => Identityentitlementdetails' | Write-Debug
...
Identityentitlementdetails<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityentitlementdetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestsV1 => Identityentitlementdetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Identityentitlementdetails

...
function Initialize-V2025ScheduledActionResponseContent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ScheduledActionResponseContent' | Write-Debug
...
ScheduledActionResponseContent<PSCustomObject>
#>
function ConvertFrom-V2025JsonToScheduledActionResponseContent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ScheduledActionResponseContent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ScheduledActionResponseContent

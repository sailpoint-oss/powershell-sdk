...
function Initialize-IdentityExceptionReportReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityExceptionReportReference' | Write-Debug
...
function ConvertFrom-JsonToIdentityExceptionReportReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityExceptionReportReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

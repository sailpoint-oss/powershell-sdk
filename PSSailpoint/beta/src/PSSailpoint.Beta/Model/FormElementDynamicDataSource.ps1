...
function Initialize-BetaFormElementDynamicDataSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormElementDynamicDataSource' | Write-Debug
...
function ConvertFrom-BetaJsonToFormElementDynamicDataSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormElementDynamicDataSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

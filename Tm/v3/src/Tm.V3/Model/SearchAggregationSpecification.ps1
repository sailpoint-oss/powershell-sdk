...
function Initialize-SearchAggregationSpecification {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => SearchAggregationSpecification' | Write-Debug
...
function ConvertFrom-JsonToSearchAggregationSpecification {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => SearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAssignmentContextDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAssignmentContextDto' | Write-Debug
...
function ConvertFrom-BetaJsonToAssignmentContextDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAssignmentContextDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

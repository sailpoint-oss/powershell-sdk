...
function Initialize-EntitlementRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Dimensions => EntitlementRef' | Write-Debug
...
function ConvertFrom-JsonToEntitlementRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Dimensions => EntitlementRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

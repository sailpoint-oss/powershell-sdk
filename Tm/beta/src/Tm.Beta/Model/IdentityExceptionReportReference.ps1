...
function Initialize-BetaIdentityExceptionReportReference {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityExceptionReportReference' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityExceptionReportReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityExceptionReportReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

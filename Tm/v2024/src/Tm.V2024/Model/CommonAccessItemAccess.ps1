...
function Initialize-V2024CommonAccessItemAccess {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CommonAccessItemAccess' | Write-Debug
...
function ConvertFrom-V2024JsonToCommonAccessItemAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CommonAccessItemAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

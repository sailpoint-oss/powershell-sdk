...
function Initialize-V2024RoleMiningPotentialRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleMiningPotentialRole' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningPotentialRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleMiningPotentialRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

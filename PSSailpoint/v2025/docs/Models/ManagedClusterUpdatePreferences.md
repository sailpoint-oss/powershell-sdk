...
keywords: ['powershell', 'PowerShell', 'sdk', 'ManagedClusterUpdatePreferences', 'V2025ManagedClusterUpdatePreferences'] 
slug: /tools/sdk/powershell/v2025/models/managed-cluster-update-preferences
...
```powershell
$ManagedClusterUpdatePreferences = Initialize-V2025ManagedClusterUpdatePreferences  -ProcessGroups processGroup1 `

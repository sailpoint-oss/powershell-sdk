...
ImportSpConfigV1Request<PSCustomObject>
#>

function Initialize-ImportSpConfigV1Request {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ImportSpConfigV1Request<PSCustomObject>
...
ImportSpConfigV1Request<PSCustomObject>
#>
function ConvertFrom-JsonToImportSpConfigV1Request {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ImportSpConfigV1Request

...
function Initialize-V2026PreApprovalTriggerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026PreApprovalTriggerDetails' | Write-Debug
...
PreApprovalTriggerDetails<PSCustomObject>
#>
function ConvertFrom-V2026JsonToPreApprovalTriggerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026PreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026PreApprovalTriggerDetails

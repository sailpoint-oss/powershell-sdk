...
function Initialize-V2024RequestedItemStatusPreApprovalTriggerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
...
RequestedItemStatusPreApprovalTriggerDetails<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRequestedItemStatusPreApprovalTriggerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RequestedItemStatusPreApprovalTriggerDetails

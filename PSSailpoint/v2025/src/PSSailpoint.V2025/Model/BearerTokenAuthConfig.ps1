...
function Initialize-V2025BearerTokenAuthConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025BearerTokenAuthConfig' | Write-Debug
...
BearerTokenAuthConfig<PSCustomObject>
#>
function ConvertFrom-V2025JsonToBearerTokenAuthConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025BearerTokenAuthConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025BearerTokenAuthConfig

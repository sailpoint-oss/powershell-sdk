...
#>
function Approve-AccessRequestV1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Approve-AccessRequestV1' | Write-Debug
        ...
        $LocalVarUri = '/access-request-approvals/v1/{approvalId}/approve'
        if (!$ApprovalId) {
            throw "Error! The required parameter `ApprovalId` missing when calling approveAccessRequestV1."
        }
...
SystemCollectionsHashtable
#>
function Invoke-ForwardAccessRequestV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-ForwardAccessRequestV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-request-approvals/v1/{approvalId}/forward'
        if (!$ApprovalId) {
            throw "Error! The required parameter `ApprovalId` missing when calling forwardAccessRequestV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{approvalId}', [System.Web.HTTPUtility]::UrlEncode($ApprovalId))
...
function Get-AccessRequestApprovalSummaryV1 {
    ...
    Process {
        'Calling method: Get-AccessRequestApprovalSummaryV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-request-approvals/v1/approval-summary'
...
function Get-AccessRequestApproversV1 {
    ...
    Process {
        'Calling method: Get-AccessRequestApproversV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-request-approvals/v1/{accessRequestId}/approvers'
        if (!$AccessRequestId) {
            throw "Error! The required parameter `AccessRequestId` missing when calling listAccessRequestApproversV1."
        }
...
function Get-CompletedApprovalsV1 {
    ...
    Process {
        'Calling method: Get-CompletedApprovalsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-request-approvals/v1/completed'
...
function Get-PendingApprovalsV1 {
    ...
    Process {
        'Calling method: Get-PendingApprovalsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-request-approvals/v1/pending'
...
function Deny-AccessRequestV1 {
    ...
    Process {
        'Calling method: Deny-AccessRequestV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/access-request-approvals/v1/{approvalId}/reject'
        if (!$ApprovalId) {
            throw "Error! The required parameter `ApprovalId` missing when calling rejectAccessRequestV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{approvalId}', [System.Web.HTTPUtility]::UrlEncode($ApprovalId))

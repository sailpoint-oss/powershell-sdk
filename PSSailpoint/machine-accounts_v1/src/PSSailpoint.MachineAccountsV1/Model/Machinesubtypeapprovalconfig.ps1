...
function Initialize-Machinesubtypeapprovalconfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountsV1 => Machinesubtypeapprovalconfig' | Write-Debug
...
Machinesubtypeapprovalconfig<PSCustomObject>
#>
function ConvertFrom-JsonToMachinesubtypeapprovalconfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountsV1 => Machinesubtypeapprovalconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Machinesubtypeapprovalconfig

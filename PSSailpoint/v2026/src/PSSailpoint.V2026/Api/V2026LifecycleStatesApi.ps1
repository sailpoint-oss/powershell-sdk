...
LifecycleState
#>
function New-V2026LifecycleState {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026LifecycleState' | Write-Debug
...
#>
function Remove-V2026LifecycleState {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LifecycleState
#>
function Get-V2026LifecycleState {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LifecycleState[]
#>
function Get-V2026LifecycleStates {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026LifecycleStates' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Set-V2026LifecycleState {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-V2026LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LifecycleState
#>
function Update-V2026LifecycleStates {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026LifecycleStates' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

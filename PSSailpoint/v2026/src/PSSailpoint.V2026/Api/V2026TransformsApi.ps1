...
function New-V2026Transform {
    ...
    Process {
        'Calling method: New-V2026Transform' | Write-Debug
...
None
#>
function Remove-V2026Transform {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026Transform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026Transform {
    ...
    Process {
        'Calling method: Get-V2026Transform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026Transforms {
    ...
    Process {
        'Calling method: Get-V2026Transforms' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TransformRead
#>
function Update-V2026Transform {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026Transform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

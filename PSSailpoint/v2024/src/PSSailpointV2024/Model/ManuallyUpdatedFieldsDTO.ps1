...
function Initialize-V2024ManuallyUpdatedFieldsDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ManuallyUpdatedFieldsDTO' | Write-Debug
...
function ConvertFrom-V2024JsonToManuallyUpdatedFieldsDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ManuallyUpdatedFieldsDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

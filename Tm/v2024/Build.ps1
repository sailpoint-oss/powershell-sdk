...
$FunctionPath = "$PSScriptRoot/src/Tm.V2024/Api", "$PSScriptRoot/src/Tm.V2024/Client","$PSScriptRoot/src/Tm.V2024/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\Tm.V2024\Tm.V2024.psd1"

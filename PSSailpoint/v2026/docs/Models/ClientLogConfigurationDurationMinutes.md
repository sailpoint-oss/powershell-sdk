...
keywords: ['powershell', 'PowerShell', 'sdk', 'ClientLogConfigurationDurationMinutes', 'V2026ClientLogConfigurationDurationMinutes'] 
slug: /tools/sdk/powershell/v2026/models/client-log-configuration-duration-minutes
...
```powershell
$ClientLogConfigurationDurationMinutes = Initialize-V2026ClientLogConfigurationDurationMinutes  -ClientId 3a38a51992e8445ab51a549c0a70ee66 `
 -DurationMinutes 120 `
 -RootLevel null `
 -LogLevels INFO
```

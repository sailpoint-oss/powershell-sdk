...
function Initialize-AccountActionRequestDtoCorrelatedIdentity {
    [CmdletBinding()]
    Param (
...
AccountActionRequestDtoCorrelatedIdentity<PSCustomObject>
#>
function ConvertFrom-JsonToAccountActionRequestDtoCorrelatedIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccountActionRequestDtoCorrelatedIdentity

...
function Initialize-V2024SimIntegrationDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SimIntegrationDetails' | Write-Debug
...
SimIntegrationDetails<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSimIntegrationDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SimIntegrationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SimIntegrationDetails

...
function Initialize-V2025DependantAppConnections {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025DependantAppConnections' | Write-Debug
...
DependantAppConnections<PSCustomObject>
#>
function ConvertFrom-V2025JsonToDependantAppConnections {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025DependantAppConnections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025DependantAppConnections

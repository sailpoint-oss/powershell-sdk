...
function Initialize-Base64encode {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Base64encode' | Write-Debug
...
function ConvertFrom-JsonToBase64encode {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Base64encode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

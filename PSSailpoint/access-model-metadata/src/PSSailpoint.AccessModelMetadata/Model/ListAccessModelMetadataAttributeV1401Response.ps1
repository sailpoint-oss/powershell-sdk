...
ListAccessModelMetadataAttributeV1401Response<PSCustomObject>
#>

function Initialize-ListAccessModelMetadataAttributeV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListAccessModelMetadataAttributeV1401Response<PSCustomObject>
...
ListAccessModelMetadataAttributeV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToListAccessModelMetadataAttributeV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListAccessModelMetadataAttributeV1401Response
        $AllProperties = ("error")

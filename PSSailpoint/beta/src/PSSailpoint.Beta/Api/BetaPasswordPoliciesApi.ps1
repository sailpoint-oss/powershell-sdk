...
PasswordPolicyV3Dto
#>
function New-BetaPasswordPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-BetaPasswordPolicy' | Write-Debug
...
None
#>
function Remove-BetaPasswordPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-BetaPasswordPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto
#>
function Get-BetaPasswordPolicyById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-BetaPasswordPolicyById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto[]
#>
function Get-BetaPasswordPolicies {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-BetaPasswordPolicies' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto
#>
function Set-BetaPasswordPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-BetaPasswordPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

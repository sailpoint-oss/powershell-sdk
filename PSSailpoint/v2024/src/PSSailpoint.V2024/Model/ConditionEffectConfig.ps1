...
function Initialize-V2024ConditionEffectConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConditionEffectConfig' | Write-Debug
...
ConditionEffectConfig<PSCustomObject>
#>
function ConvertFrom-V2024JsonToConditionEffectConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConditionEffectConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ConditionEffectConfig

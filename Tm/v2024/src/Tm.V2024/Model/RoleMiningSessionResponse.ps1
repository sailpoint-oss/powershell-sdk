...
function Initialize-V2024RoleMiningSessionResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RoleMiningSessionResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningSessionResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RoleMiningSessionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

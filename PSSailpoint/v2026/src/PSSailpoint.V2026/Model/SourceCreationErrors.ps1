...
function Initialize-V2026SourceCreationErrors {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SourceCreationErrors' | Write-Debug
...
SourceCreationErrors<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSourceCreationErrors {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SourceCreationErrors' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SourceCreationErrors

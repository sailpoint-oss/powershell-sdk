...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleDocumentAllOfEntitlements', 'V2026RoleDocumentAllOfEntitlements'] 
slug: /tools/sdk/powershell/v2026/models/role-document-all-of-entitlements
...
```powershell
$RoleDocumentAllOfEntitlements = Initialize-V2026RoleDocumentAllOfEntitlements  -HasPermissions false `

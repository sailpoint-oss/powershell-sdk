...
function Initialize-Accountattribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Sources => Accountattribute' | Write-Debug
...
function ConvertFrom-JsonToAccountattribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Sources => Accountattribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-CompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => CompletedApprovalPreApprovalTriggerResult' | Write-Debug
...
function ConvertFrom-JsonToCompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => CompletedApprovalPreApprovalTriggerResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaSubstring {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSubstring' | Write-Debug
...
Substring<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSubstring {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSubstring' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSubstring

...
$IdentityAssociationDetailsAssociationDetailsInner = @"{  "AssociationType": "CAMPAIGN_OWNER", "Entities": {"id": "b660a232f05b4e04812ca974b3011e0f", "name": "Gaston.800ddf9640a", "type": "CAMPAIGN_CAMPAIGNER}" }}"@
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToIdentityAssociationDetailsAssociationDetailsInner -Json $IdentityAssociationDetailsAssociationDetailsInner
```

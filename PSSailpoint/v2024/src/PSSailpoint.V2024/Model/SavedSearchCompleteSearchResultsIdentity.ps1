...
function Initialize-V2024SavedSearchCompleteSearchResultsIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SavedSearchCompleteSearchResultsIdentity' | Write-Debug
...
SavedSearchCompleteSearchResultsIdentity<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSavedSearchCompleteSearchResultsIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SavedSearchCompleteSearchResultsIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SavedSearchCompleteSearchResultsIdentity

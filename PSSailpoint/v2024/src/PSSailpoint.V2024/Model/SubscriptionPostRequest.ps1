...
function Initialize-V2024SubscriptionPostRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SubscriptionPostRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToSubscriptionPostRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SubscriptionPostRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

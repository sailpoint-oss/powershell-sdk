...
function Initialize-BetaAttrSyncSourceConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAttrSyncSourceConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToAttrSyncSourceConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAttrSyncSourceConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

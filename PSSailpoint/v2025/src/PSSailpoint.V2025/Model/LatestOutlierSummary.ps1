...
LatestOutlierSummary<PSCustomObject>
#>

function Initialize-V2025LatestOutlierSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025LatestOutlierSummary' | Write-Debug
...
Convert from JSON to LatestOutlierSummary<PSCustomObject>
...
LatestOutlierSummary<PSCustomObject>
#>
function ConvertFrom-V2025JsonToLatestOutlierSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025LatestOutlierSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025LatestOutlierSummary

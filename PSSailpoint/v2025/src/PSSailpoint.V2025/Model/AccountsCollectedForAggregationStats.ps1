...
function Initialize-V2025AccountsCollectedForAggregationStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccountsCollectedForAggregationStats' | Write-Debug
...
AccountsCollectedForAggregationStats<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccountsCollectedForAggregationStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccountsCollectedForAggregationStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccountsCollectedForAggregationStats

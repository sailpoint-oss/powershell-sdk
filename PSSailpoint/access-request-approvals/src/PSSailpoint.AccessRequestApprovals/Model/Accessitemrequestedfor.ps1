...
function Initialize-Accessitemrequestedfor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => Accessitemrequestedfor' | Write-Debug
...
Accessitemrequestedfor<PSCustomObject>
#>
function ConvertFrom-JsonToAccessitemrequestedfor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => Accessitemrequestedfor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessitemrequestedfor

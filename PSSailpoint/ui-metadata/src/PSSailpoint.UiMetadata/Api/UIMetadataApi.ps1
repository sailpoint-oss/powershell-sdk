...
function Get-TenantUiMetadataV1 {
    ...
    Process {
        'Calling method: Get-TenantUiMetadataV1' | Write-Debug
        ...
        $LocalVarUri = '/ui-metadata/v1/tenant'

        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling getTenantUiMetadataV1."
        }
...
function Set-TenantUiMetadataV1 {
    ...
    Process {
        'Calling method: Set-TenantUiMetadataV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling setTenantUiMetadataV1."
        }
        $LocalVarHeaderParameters['X-SailPoint-Experimental'] = $XSailPointExperimental

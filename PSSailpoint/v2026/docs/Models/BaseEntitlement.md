...
keywords: ['powershell', 'PowerShell', 'sdk', 'BaseEntitlement', 'V2026BaseEntitlement'] 
slug: /tools/sdk/powershell/v2026/models/base-entitlement
...
```powershell
$BaseEntitlement = Initialize-V2026BaseEntitlement  -HasPermissions false `

...
function Initialize-V2025AccountsCollectedForAggregation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccountsCollectedForAggregation' | Write-Debug
...
AccountsCollectedForAggregation<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccountsCollectedForAggregation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccountsCollectedForAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccountsCollectedForAggregation

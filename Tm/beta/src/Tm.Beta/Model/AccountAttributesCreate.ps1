...
function Initialize-BetaAccountAttributesCreate {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountAttributesCreate' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountAttributesCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaImportEntitlementsBySourceRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaImportEntitlementsBySourceRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToImportEntitlementsBySourceRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaImportEntitlementsBySourceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-DependantConnectionsMissingDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => DependantConnectionsMissingDto' | Write-Debug
...
function ConvertFrom-JsonToDependantConnectionsMissingDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => DependantConnectionsMissingDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

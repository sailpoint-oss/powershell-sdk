...
keywords: ['powershell', 'PowerShell', 'sdk', 'WorkflowExecutionEvent', 'V2026WorkflowExecutionEvent'] 
slug: /tools/sdk/powershell/v2026/models/workflow-execution-event
...
```powershell
$WorkflowExecutionEvent = Initialize-V2026WorkflowExecutionEvent  -Type WorkflowTaskScheduled `

...
function Initialize-V2025Trim {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025Trim' | Write-Debug
...
Trim<PSCustomObject>
#>
function ConvertFrom-V2025JsonToTrim {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025Trim' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025Trim

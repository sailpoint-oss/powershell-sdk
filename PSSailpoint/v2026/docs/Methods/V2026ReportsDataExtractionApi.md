...
keywords: ['powershell', 'PowerShell', 'sdk', 'ReportsDataExtraction', 'V2026ReportsDataExtraction'] 
slug: /tools/sdk/powershell/v2026/methods/reports-data-extraction
...
------------- | ------------- | -------------
[**Suspend-V2026Report**](#cancel-report) | **POST** `/reports/{id}/cancel` | Cancel report
[**Get-V2026Report**](#get-report) | **GET** `/reports/{taskResultId}` | Get report file
[**Get-V2026ReportResult**](#get-report-result) | **GET** `/reports/{taskResultId}/result` | Get report result
[**Start-V2026Report**](#start-report) | **POST** `/reports/run` | Run report
...
try {
    Suspend-V2026Report -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Suspend-V2026Report -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Suspend-V2026Report"
...
try {
    Get-V2026Report -TaskResultId $TaskResultId -FileFormat $FileFormat 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Report -TaskResultId $TaskResultId -FileFormat $FileFormat -Name $Name -Auditable $Auditable  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Report"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ReportResult -TaskResultId $TaskResultId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ReportResult -TaskResultId $TaskResultId -Completed $Completed  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ReportResult"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToReportDetails -Json $ReportDetails
    Start-V2026Report -ReportDetails $Result 
    
    # Below is a request that includes all optional parameters
    # Start-V2026Report -ReportDetails $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Start-V2026Report"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-V2024EmailNotificationOption {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024EmailNotificationOption' | Write-Debug
...
function ConvertFrom-V2024JsonToEmailNotificationOption {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024EmailNotificationOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

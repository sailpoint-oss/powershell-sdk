...
function Initialize-Accessmodelmetadatabulkupdateresponse {
    [CmdletBinding()]
    Param (
...
Accessmodelmetadatabulkupdateresponse<PSCustomObject>
#>
function ConvertFrom-JsonToAccessmodelmetadatabulkupdateresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Accessmodelmetadatabulkupdateresponse

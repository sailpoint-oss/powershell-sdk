...
function Initialize-Accountv2 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Accountv2' | Write-Debug
...
Accountv2<PSCustomObject>
#>
function ConvertFrom-JsonToAccountv2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Accountv2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accountv2

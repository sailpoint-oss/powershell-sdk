...
function Initialize-BetaNonEmployeeRequestSummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeRequestSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeRequestSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeRequestSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

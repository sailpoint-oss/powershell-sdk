...
E164phone<PSCustomObject>
#>

function Initialize-V2024E164phone {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024E164phone' | Write-Debug
...
Convert from JSON to E164phone<PSCustomObject>
...
E164phone<PSCustomObject>
#>
function ConvertFrom-V2024JsonToE164phone {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024E164phone' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024E164phone
        $AllProperties = ("defaultRegion", "requiresPeriodicRefresh", "input")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "defaultRegion"))) { #optional property not found
            $DefaultRegion = $null
        } else {
            $DefaultRegion = $JsonParameters.PSobject.Properties["defaultRegion"].value
        }

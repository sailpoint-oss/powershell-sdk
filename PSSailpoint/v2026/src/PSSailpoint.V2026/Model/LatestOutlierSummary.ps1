...
function Initialize-V2026LatestOutlierSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026LatestOutlierSummary' | Write-Debug
...
LatestOutlierSummary<PSCustomObject>
#>
function ConvertFrom-V2026JsonToLatestOutlierSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026LatestOutlierSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026LatestOutlierSummary

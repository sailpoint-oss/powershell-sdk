...
function Initialize-Configurationdetailsresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.WorkReassignmentV1 => Configurationdetailsresponse' | Write-Debug
...
Configurationdetailsresponse<PSCustomObject>
#>
function ConvertFrom-JsonToConfigurationdetailsresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.WorkReassignmentV1 => Configurationdetailsresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Configurationdetailsresponse

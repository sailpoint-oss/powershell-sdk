...
function Initialize-BetaOutlierFeatureSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaOutlierFeatureSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToOutlierFeatureSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaOutlierFeatureSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

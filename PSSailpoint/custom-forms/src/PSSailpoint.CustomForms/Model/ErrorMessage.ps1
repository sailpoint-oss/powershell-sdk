...
function Initialize-ErrorMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CustomForms => ErrorMessage' | Write-Debug
...
function ConvertFrom-JsonToErrorMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CustomForms => ErrorMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

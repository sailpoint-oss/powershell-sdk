...
function Initialize-BetaIdentityAttributesChanged {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributesChanged' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributesChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributesChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

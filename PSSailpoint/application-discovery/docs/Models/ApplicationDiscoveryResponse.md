...
slug: /tools/sdk/powershell/applicationdiscovery/models/application-discovery-response
...
**Attributes** | **map[string]AnyType** | Attributes of the app discovery task | [optional] 

...
function Initialize-BetaIdentityProfileExportedObject {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityProfileExportedObject' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityProfileExportedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityProfileExportedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeSourceWithNECount {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => NonEmployeeSourceWithNECount' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSourceWithNECount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => NonEmployeeSourceWithNECount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

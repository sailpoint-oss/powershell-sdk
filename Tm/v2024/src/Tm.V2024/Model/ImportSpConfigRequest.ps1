...
function Initialize-V2024ImportSpConfigRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ImportSpConfigRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToImportSpConfigRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ImportSpConfigRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
SearchcriteriaTextQuery<PSCustomObject>
#>

function Initialize-SearchcriteriaTextQuery {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SuggestedEntitlementDescriptionV1 => SearchcriteriaTextQuery' | Write-Debug
...
Convert from JSON to SearchcriteriaTextQuery<PSCustomObject>
...
SearchcriteriaTextQuery<PSCustomObject>
#>
function ConvertFrom-JsonToSearchcriteriaTextQuery {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SuggestedEntitlementDescriptionV1 => SearchcriteriaTextQuery' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SearchcriteriaTextQuery
        $AllProperties = ("terms", "fields", "matchAny")

...
function Initialize-BetaFormInstanceCreatedBy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormInstanceCreatedBy' | Write-Debug
...
FormInstanceCreatedBy<PSCustomObject>
#>
function ConvertFrom-BetaJsonToFormInstanceCreatedBy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormInstanceCreatedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaFormInstanceCreatedBy

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountCorrelated', 'V2026AccountCorrelated'] 
slug: /tools/sdk/powershell/v2026/models/account-correlated
...
```powershell
$AccountCorrelated = Initialize-V2026AccountCorrelated  -Identity null `
 -Source null `
 -Account null `

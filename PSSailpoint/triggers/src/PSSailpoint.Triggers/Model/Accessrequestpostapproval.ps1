...
function Initialize-Accessrequestpostapproval {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Accessrequestpostapproval' | Write-Debug
...
Accessrequestpostapproval<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestpostapproval {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Accessrequestpostapproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessrequestpostapproval

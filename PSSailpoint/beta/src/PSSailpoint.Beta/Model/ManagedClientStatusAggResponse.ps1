...
ManagedClientStatusAggResponse<PSCustomObject>
#>
...
function Initialize-BetaManagedClientStatusAggResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaManagedClientStatusAggResponse' | Write-Debug
...
Convert from JSON to ManagedClientStatusAggResponse<PSCustomObject>
...
ManagedClientStatusAggResponse<PSCustomObject>
#>
function ConvertFrom-BetaJsonToManagedClientStatusAggResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaManagedClientStatusAggResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaManagedClientStatusAggResponse

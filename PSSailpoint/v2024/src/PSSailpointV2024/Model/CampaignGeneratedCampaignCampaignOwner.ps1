...
function Initialize-V2024CampaignGeneratedCampaignCampaignOwner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignGeneratedCampaignCampaignOwner' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignGeneratedCampaignCampaignOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignGeneratedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
$RoleMetadataBulkUpdateByFilterRequest = @"{  "Filters": " requestable eq false", "Operation": "REPLACE", "ReplaceScope": "ALL", "Values": [{"attribute": "iscFederalClassifications", "values":["topSecret"]}] }"@
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToRoleMetadataBulkUpdateByFilterRequest -Json $RoleMetadataBulkUpdateByFilterRequest
```

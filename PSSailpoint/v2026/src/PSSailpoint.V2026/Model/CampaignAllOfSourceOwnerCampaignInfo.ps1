...
function Initialize-V2026CampaignAllOfSourceOwnerCampaignInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CampaignAllOfSourceOwnerCampaignInfo' | Write-Debug
...
CampaignAllOfSourceOwnerCampaignInfo<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCampaignAllOfSourceOwnerCampaignInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CampaignAllOfSourceOwnerCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CampaignAllOfSourceOwnerCampaignInfo

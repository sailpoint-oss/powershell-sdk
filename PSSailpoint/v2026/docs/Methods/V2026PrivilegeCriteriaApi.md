...
keywords: ['powershell', 'PowerShell', 'sdk', 'PrivilegeCriteria', 'V2026PrivilegeCriteria'] 
slug: /tools/sdk/powershell/v2026/methods/privilege-criteria
...
------------- | ------------- | -------------
[**New-V2026CustomPrivilegeCriteria**](#create-custom-privilege-criteria) | **POST** `/criteria/privilege` | Create custom privilege criteria
[**Remove-V2026CustomPrivilegeCriteria**](#delete-custom-privilege-criteria) | **DELETE** `/criteria/privilege/{criteriaId}` | Delete privilege criteria
[**Get-V2026PrivilegeCriteria**](#get-privilege-criteria) | **GET** `/criteria/privilege/{criteriaId}` | Get privilege criteria
[**Get-V2026PrivilegeCriteria**](#list-privilege-criteria) | **GET** `/criteria/privilege` | List privilege criteria
[**Send-V2026CustomPrivilegeCriteriaValue**](#put-custom-privilege-criteria-value) | **PUT** `/criteria/privilege/{criteriaId}` | Update privilege criteria
...
try {
    $Result = ConvertFrom-V2026JsonToCreatePrivilegeCriteriaRequest -Json $CreatePrivilegeCriteriaRequest
    New-V2026CustomPrivilegeCriteria -CreatePrivilegeCriteriaRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026CustomPrivilegeCriteria -CreatePrivilegeCriteriaRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026CustomPrivilegeCriteria"
...
try {
    Remove-V2026CustomPrivilegeCriteria -CriteriaId $CriteriaId 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026CustomPrivilegeCriteria -CriteriaId $CriteriaId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026CustomPrivilegeCriteria"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026PrivilegeCriteria -CriteriaId $CriteriaId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PrivilegeCriteria -CriteriaId $CriteriaId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026PrivilegeCriteria"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026PrivilegeCriteria -Filters $Filters 
...
try {
    $Result = ConvertFrom-V2026JsonToPrivilegeCriteriaDTO -Json $PrivilegeCriteriaDTO
    Send-V2026CustomPrivilegeCriteriaValue -CriteriaId $CriteriaId -PrivilegeCriteriaDTO $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026CustomPrivilegeCriteriaValue -CriteriaId $CriteriaId -PrivilegeCriteriaDTO $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026CustomPrivilegeCriteriaValue"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

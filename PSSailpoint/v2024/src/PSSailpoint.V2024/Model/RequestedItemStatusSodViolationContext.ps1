...
function Initialize-V2024RequestedItemStatusSodViolationContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatusSodViolationContext' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestedItemStatusSodViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatusSodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

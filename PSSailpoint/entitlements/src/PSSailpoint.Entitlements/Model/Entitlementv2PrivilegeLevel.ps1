...
function Initialize-Entitlementv2PrivilegeLevel {
    [CmdletBinding()]
    Param (
...
Entitlementv2PrivilegeLevel<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementv2PrivilegeLevel {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Entitlementv2PrivilegeLevel

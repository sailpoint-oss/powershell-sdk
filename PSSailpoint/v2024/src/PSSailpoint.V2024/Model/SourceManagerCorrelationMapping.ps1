...
function Initialize-V2024SourceManagerCorrelationMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SourceManagerCorrelationMapping' | Write-Debug
...
SourceManagerCorrelationMapping<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSourceManagerCorrelationMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SourceManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SourceManagerCorrelationMapping

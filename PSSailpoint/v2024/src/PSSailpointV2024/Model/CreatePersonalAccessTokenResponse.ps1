...
function Initialize-V2024CreatePersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CreatePersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToCreatePersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CreatePersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

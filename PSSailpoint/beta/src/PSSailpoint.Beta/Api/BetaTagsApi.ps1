...
function New-BetaTag {
    ...
    Process {
        'Calling method: New-BetaTag' | Write-Debug
...
function Remove-BetaTagById {
    ...
    Process {
        'Calling method: Remove-BetaTagById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-BetaTagById {
    ...
    Process {
        'Calling method: Get-BetaTagById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-BetaTags {
    ...
    Process {
        'Calling method: Get-BetaTags' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

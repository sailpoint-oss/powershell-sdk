...
function Initialize-BetaApprovalReminderAndEscalationConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaApprovalReminderAndEscalationConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalReminderAndEscalationConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaApprovalReminderAndEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

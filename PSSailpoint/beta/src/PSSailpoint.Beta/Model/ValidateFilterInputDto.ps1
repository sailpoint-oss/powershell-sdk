...
function Initialize-BetaValidateFilterInputDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaValidateFilterInputDto' | Write-Debug
...
function ConvertFrom-BetaJsonToValidateFilterInputDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaValidateFilterInputDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

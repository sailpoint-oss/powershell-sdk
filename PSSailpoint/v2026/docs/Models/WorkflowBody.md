...
keywords: ['powershell', 'PowerShell', 'sdk', 'WorkflowBody', 'V2026WorkflowBody'] 
slug: /tools/sdk/powershell/v2026/models/workflow-body
...
```powershell
$WorkflowBody = Initialize-V2026WorkflowBody  -Name Send Email `
 -Owner null `

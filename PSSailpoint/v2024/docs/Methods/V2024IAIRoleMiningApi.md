...
try {
    $Result = ConvertFrom-V2024JsonToJsonPatchOperationRoleMining -Json $JsonPatchOperationRoleMining
    Update-V2024PotentialRole -SessionId $SessionId -PotentialRoleId $PotentialRoleId -XSailPointExperimental $XSailPointExperimental -JsonPatchOperationRoleMining $Result 
...
try {
    $Result = ConvertFrom-V2024JsonToJsonPatchOperationRoleMining -Json $JsonPatchOperationRoleMining
    Update-V2024PotentialRoleSession -SessionId $SessionId -PotentialRoleId $PotentialRoleId -XSailPointExperimental $XSailPointExperimental -JsonPatchOperationRoleMining $Result 

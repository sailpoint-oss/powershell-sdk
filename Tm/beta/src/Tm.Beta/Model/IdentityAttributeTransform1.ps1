...
function Initialize-BetaIdentityAttributeTransform1 {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityAttributeTransform1' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributeTransform1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityAttributeTransform1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

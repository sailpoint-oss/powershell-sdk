...
UserEntitlementV2<PSCustomObject>
#>

function Initialize-UserEntitlementV2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentities => UserEntitlementV2' | Write-Debug
...
Convert from JSON to UserEntitlementV2<PSCustomObject>
...
UserEntitlementV2<PSCustomObject>
#>
function ConvertFrom-JsonToUserEntitlementV2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentities => UserEntitlementV2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserEntitlementV2

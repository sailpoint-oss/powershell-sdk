...
function Initialize-BetaRoleInsightsInsight {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleInsightsInsight' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleInsightsInsight {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleInsightsInsight' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

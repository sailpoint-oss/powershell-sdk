...
function Initialize-V2024SavedSearchDetail {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SavedSearchDetail' | Write-Debug
...
function ConvertFrom-V2024JsonToSavedSearchDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SavedSearchDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

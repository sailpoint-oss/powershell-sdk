...
function Initialize-V2024CampaignFilterDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignFilterDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignFilterDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignFilterDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

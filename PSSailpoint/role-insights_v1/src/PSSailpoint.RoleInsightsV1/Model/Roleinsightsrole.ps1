...
function Initialize-Roleinsightsrole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsightsrole' | Write-Debug
...
Roleinsightsrole<PSCustomObject>
#>
function ConvertFrom-JsonToRoleinsightsrole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsightsrole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleinsightsrole

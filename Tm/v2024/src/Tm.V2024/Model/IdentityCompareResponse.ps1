...
function Initialize-V2024IdentityCompareResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024IdentityCompareResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityCompareResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024IdentityCompareResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

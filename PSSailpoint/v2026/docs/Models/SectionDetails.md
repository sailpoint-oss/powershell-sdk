...
keywords: ['powershell', 'PowerShell', 'sdk', 'SectionDetails', 'V2026SectionDetails'] 
slug: /tools/sdk/powershell/v2026/models/section-details
...
```powershell
$SectionDetails = Initialize-V2026SectionDetails  -Name Field1 `
 -Label Section 1 `
 -FormItems []
```

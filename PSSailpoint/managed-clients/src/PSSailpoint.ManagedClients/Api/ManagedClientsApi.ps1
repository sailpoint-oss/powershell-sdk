...
function New-ManagedClientV1 {
    ...
    Process {
        'Calling method: New-ManagedClientV1' | Write-Debug
...
None
#>
function Remove-ManagedClientV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-ManagedClientV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/managed-clients/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteManagedClientV1."
        }
...
function Get-ManagedClientHealthIndicatorsV1 {
    ...
    Process {
        'Calling method: Get-ManagedClientHealthIndicatorsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/managed-clients/v1/{id}/health-indicators'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getManagedClientHealthIndicatorsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-ManagedClientStatusV1 {
    ...
    Process {
        'Calling method: Get-ManagedClientStatusV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/managed-clients/v1/{id}/status'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getManagedClientStatusV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$Type) {
            throw "Error! The required parameter `Type` missing when calling getManagedClientStatusV1."
        }
...
function Get-ManagedClientV1 {
    ...
    Process {
        'Calling method: Get-ManagedClientV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/managed-clients/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getManagedClientV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-ManagedClientsV1 {
    ...
    Process {
        'Calling method: Get-ManagedClientsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-ManagedClientV1 {
    ...
    Process {
        'Calling method: Update-ManagedClientV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/managed-clients/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling updateManagedClientV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

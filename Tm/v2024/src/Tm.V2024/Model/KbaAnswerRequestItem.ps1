...
function Initialize-V2024KbaAnswerRequestItem {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024KbaAnswerRequestItem' | Write-Debug
...
function ConvertFrom-V2024JsonToKbaAnswerRequestItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024KbaAnswerRequestItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaSendTestNotificationRequestDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSendTestNotificationRequestDto' | Write-Debug
...
function ConvertFrom-BetaJsonToSendTestNotificationRequestDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSendTestNotificationRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

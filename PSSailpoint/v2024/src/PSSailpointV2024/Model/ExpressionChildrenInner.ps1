...
function Initialize-V2024ExpressionChildrenInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ExpressionChildrenInner' | Write-Debug
...
function ConvertFrom-V2024JsonToExpressionChildrenInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ExpressionChildrenInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

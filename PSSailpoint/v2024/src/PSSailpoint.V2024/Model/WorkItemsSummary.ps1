...
function Initialize-V2024WorkItemsSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024WorkItemsSummary' | Write-Debug
...
WorkItemsSummary<PSCustomObject>
#>
function ConvertFrom-V2024JsonToWorkItemsSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024WorkItemsSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024WorkItemsSummary

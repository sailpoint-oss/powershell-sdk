...
function Initialize-V2024ServiceDeskIntegrationDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ServiceDeskIntegrationDto' | Write-Debug
...
function ConvertFrom-V2024JsonToServiceDeskIntegrationDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ServiceDeskIntegrationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'Lookup', 'V2026Lookup'] 
slug: /tools/sdk/powershell/v2026/models/lookup
tags: ['SDK', 'Software Development Kit', 'Lookup', 'V2026Lookup']
---
...
```powershell
$Lookup = Initialize-V2026Lookup  -Table {USA=Americas, FRA=EMEA, AUS=APAC, default=Unknown Region} `

...
keywords: ['powershell', 'PowerShell', 'sdk', 'UserLevelSummaryDTO', 'V2026UserLevelSummaryDTO'] 
slug: /tools/sdk/powershell/v2026/models/user-level-summary-dto
...
```powershell
$UserLevelSummaryDTO = Initialize-V2026UserLevelSummaryDTO  -Id beb02a57-010f-4c29-a6d2-fae9628bda73 `

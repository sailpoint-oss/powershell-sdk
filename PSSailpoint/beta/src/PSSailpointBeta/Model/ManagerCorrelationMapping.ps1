...
function Initialize-BetaManagerCorrelationMapping {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaManagerCorrelationMapping' | Write-Debug
...
function ConvertFrom-BetaJsonToManagerCorrelationMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

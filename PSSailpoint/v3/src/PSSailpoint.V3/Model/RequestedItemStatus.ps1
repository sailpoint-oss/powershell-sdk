...
function Initialize-RequestedItemStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RequestedItemStatus' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RequestedItemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Bulkreassignrequestdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApprovalsV1 => Bulkreassignrequestdto' | Write-Debug
...
Bulkreassignrequestdto<PSCustomObject>
#>
function ConvertFrom-JsonToBulkreassignrequestdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApprovalsV1 => Bulkreassignrequestdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Bulkreassignrequestdto

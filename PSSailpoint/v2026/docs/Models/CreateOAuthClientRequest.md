...
keywords: ['powershell', 'PowerShell', 'sdk', 'CreateOAuthClientRequest', 'V2026CreateOAuthClientRequest'] 
slug: /tools/sdk/powershell/v2026/models/create-o-auth-client-request
...
```powershell
$CreateOAuthClientRequest = Initialize-V2026CreateOAuthClientRequest  -BusinessName Acme-Solar `

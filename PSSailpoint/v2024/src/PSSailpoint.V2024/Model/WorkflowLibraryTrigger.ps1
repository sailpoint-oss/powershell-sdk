...
function Initialize-V2024WorkflowLibraryTrigger {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024WorkflowLibraryTrigger' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowLibraryTrigger {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024WorkflowLibraryTrigger' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

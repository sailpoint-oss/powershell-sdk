...
function Initialize-BetaLoadAccountsTaskTaskAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaLoadAccountsTaskTaskAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToLoadAccountsTaskTaskAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaLoadAccountsTaskTaskAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

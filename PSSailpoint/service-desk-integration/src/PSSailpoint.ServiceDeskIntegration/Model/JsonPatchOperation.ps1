...
function Initialize-JsonPatchOperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ServiceDeskIntegration => JsonPatchOperation' | Write-Debug
...
function ConvertFrom-JsonToJsonPatchOperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ServiceDeskIntegration => JsonPatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-CampaignAllOfSourceOwnerCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CampaignAllOfSourceOwnerCampaignInfo' | Write-Debug
...
function ConvertFrom-JsonToCampaignAllOfSourceOwnerCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CampaignAllOfSourceOwnerCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'MachineAccountClassify', 'V2026MachineAccountClassify'] 
slug: /tools/sdk/powershell/v2026/methods/machine-account-classify
...
------------- | ------------- | -------------
[**Send-V2026ClassifyMachineAccount**](#send-classify-machine-account) | **POST** `/accounts/{id}/classify` | Classify a Single Machine Account
...
try {
    Send-V2026ClassifyMachineAccount -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ClassifyMachineAccount -Id $Id -ClassificationMode $ClassificationMode  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ClassifyMachineAccount"

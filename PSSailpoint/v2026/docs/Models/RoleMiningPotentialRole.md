...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMiningPotentialRole', 'V2026RoleMiningPotentialRole'] 
slug: /tools/sdk/powershell/v2026/models/role-mining-potential-role
...
```powershell
$RoleMiningPotentialRole = Initialize-V2026RoleMiningPotentialRole  -CreatedBy null `
 -Density 75 `

...
function Initialize-Sodpolicy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SodPoliciesV1 => Sodpolicy' | Write-Debug
...
function ConvertFrom-JsonToSodpolicy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SodPoliciesV1 => Sodpolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

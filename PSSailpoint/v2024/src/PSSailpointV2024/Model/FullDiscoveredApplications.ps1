...
function Initialize-V2024FullDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024FullDiscoveredApplications' | Write-Debug
...
function ConvertFrom-V2024JsonToFullDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024FullDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
AccountActivity
#>
function Get-V2024AccountActivity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2024AccountActivity' | Write-Debug
...
AccountActivity[]
#>
function Get-V2024AccountActivities {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024AccountActivities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

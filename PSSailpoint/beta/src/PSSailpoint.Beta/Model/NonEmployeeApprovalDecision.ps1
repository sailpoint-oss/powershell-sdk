...
function Initialize-BetaNonEmployeeApprovalDecision {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeApprovalDecision' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeApprovalDecision {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeApprovalDecision' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

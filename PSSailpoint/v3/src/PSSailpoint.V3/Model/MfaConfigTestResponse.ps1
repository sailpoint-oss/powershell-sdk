...
function Initialize-MfaConfigTestResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => MfaConfigTestResponse' | Write-Debug
...
function ConvertFrom-JsonToMfaConfigTestResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => MfaConfigTestResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

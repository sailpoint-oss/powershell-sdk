...
#>
function Add-V2026AccessRequestRecommendationsIgnoredItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Add-V2026AccessRequestRecommendationsIgnoredItem' | Write-Debug
...
AccessRequestRecommendationActionItemResponseDto
#>
function Add-V2026AccessRequestRecommendationsRequestedItem {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Add-V2026AccessRequestRecommendationsRequestedItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessRequestRecommendationActionItemResponseDto
#>
function Add-V2026AccessRequestRecommendationsViewedItem {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Add-V2026AccessRequestRecommendationsViewedItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessRequestRecommendationActionItemResponseDto[]
#>
function Add-V2026AccessRequestRecommendationsViewedItems {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Add-V2026AccessRequestRecommendationsViewedItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026AccessRequestRecommendations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026AccessRequestRecommendations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026AccessRequestRecommendationsConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026AccessRequestRecommendationsConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessRequestRecommendationActionItemResponseDto[]
#>
function Get-V2026AccessRequestRecommendationsIgnoredItems {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026AccessRequestRecommendationsIgnoredItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessRequestRecommendationActionItemResponseDto[]
#>
function Get-V2026AccessRequestRecommendationsRequestedItems {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026AccessRequestRecommendationsRequestedItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessRequestRecommendationActionItemResponseDto[]
#>
function Get-V2026AccessRequestRecommendationsViewedItems {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026AccessRequestRecommendationsViewedItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessRequestRecommendationConfigDto
#>
function Set-V2026AccessRequestRecommendationsConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-V2026AccessRequestRecommendationsConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

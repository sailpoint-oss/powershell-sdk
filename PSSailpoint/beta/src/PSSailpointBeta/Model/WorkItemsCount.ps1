...
function Initialize-BetaWorkItemsCount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaWorkItemsCount' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkItemsCount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaWorkItemsCount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

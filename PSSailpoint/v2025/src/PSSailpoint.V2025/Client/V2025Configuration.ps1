...
Get the configuration object 'V2025Configuration'.
...
#>
function Get-V2025Configuration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://sailpoint.api.identitynow.com/v2025";
    }
...
System.Collections.Hashtable
#>
function Set-V2025Configuration {
...
None
#>
function Set-V2025ConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-V2025ConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-V2025ConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
String
#>
function Get-V2025UrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-V2025ConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-V2025KeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'V2025ConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-V2025ConfigurationHttpSigning{

...
function Initialize-NonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

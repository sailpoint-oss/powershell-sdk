...
function Initialize-Localizedmessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentitiesV1 => Localizedmessage' | Write-Debug
...
function ConvertFrom-JsonToLocalizedmessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentitiesV1 => Localizedmessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

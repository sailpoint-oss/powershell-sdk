...
function Initialize-Roleinsightsinsight {
    [CmdletBinding()]
    Param (
...
Roleinsightsinsight<PSCustomObject>
#>
function ConvertFrom-JsonToRoleinsightsinsight {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Roleinsightsinsight

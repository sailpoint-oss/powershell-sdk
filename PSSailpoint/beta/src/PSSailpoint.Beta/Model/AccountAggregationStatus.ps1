...
function Initialize-BetaAccountAggregationStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAggregationStatus' | Write-Debug
...
AccountAggregationStatus<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAccountAggregationStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAggregationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaAccountAggregationStatus

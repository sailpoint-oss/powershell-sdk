...
CampaignActivatedCampaign<PSCustomObject>
#>

function Initialize-V2024CampaignActivatedCampaign {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CampaignActivatedCampaign' | Write-Debug
...
Convert from JSON to CampaignActivatedCampaign<PSCustomObject>
...
CampaignActivatedCampaign<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCampaignActivatedCampaign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CampaignActivatedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024CampaignActivatedCampaign

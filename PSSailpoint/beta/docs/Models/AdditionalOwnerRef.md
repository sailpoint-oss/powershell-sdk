...
keywords: ['powershell', 'PowerShell', 'sdk', 'AdditionalOwnerRef', 'BetaAdditionalOwnerRef'] 
slug: /tools/sdk/powershell/beta/models/additional-owner-ref
...
```powershell
$AdditionalOwnerRef = Initialize-BetaAdditionalOwnerRef  -Type IDENTITY `

...
function Initialize-V2024AttributeDefinition {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AttributeDefinition' | Write-Debug
...
AttributeDefinition<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAttributeDefinition {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AttributeDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

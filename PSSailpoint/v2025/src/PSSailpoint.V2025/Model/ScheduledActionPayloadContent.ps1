...
function Initialize-V2025ScheduledActionPayloadContent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ScheduledActionPayloadContent' | Write-Debug
...
ScheduledActionPayloadContent<PSCustomObject>
#>
function ConvertFrom-V2025JsonToScheduledActionPayloadContent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ScheduledActionPayloadContent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ScheduledActionPayloadContent

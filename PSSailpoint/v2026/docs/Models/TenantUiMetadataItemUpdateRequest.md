...
keywords: ['powershell', 'PowerShell', 'sdk', 'TenantUiMetadataItemUpdateRequest', 'V2026TenantUiMetadataItemUpdateRequest'] 
slug: /tools/sdk/powershell/v2026/models/tenant-ui-metadata-item-update-request
...
```powershell
$TenantUiMetadataItemUpdateRequest = Initialize-V2026TenantUiMetadataItemUpdateRequest  -IframeWhiteList http://example.com http://example2.com `
 -UsernameLabel Email `

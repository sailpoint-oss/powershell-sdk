#
# Module manifest for module 'PSSailpoint.IaiOutliersV1'
#
...
RootModule = 'PSSailpoint.IaiOutliersV1.psm1'
...
GUID = '0cab800a-5174-313d-f857-09119122e9d0'
...
Description = 'PSSailpoint.IaiOutliersV1 - the PowerShell module for Identity Security Cloud API - IAI Outliers'
...
FunctionsToExport = 'Export-OutliersZipV1', 'Get-IdentityOutlierSnapshotsV1', 
               'Get-IdentityOutliersV1', 'Get-LatestIdentityOutlierSnapshotsV1', 
               'Get-OutlierContributingFeatureSummaryV1', 
               'Get-PeerGroupOutliersContributingFeaturesV1', 
               'Invoke-IgnoreIdentityOutliersV1', 
               'Get-OutliersContributingFeatureAccessItemsV1', 
               'Invoke-UnIgnoreIdentityOutliersV1', 'Get-Configuration', 

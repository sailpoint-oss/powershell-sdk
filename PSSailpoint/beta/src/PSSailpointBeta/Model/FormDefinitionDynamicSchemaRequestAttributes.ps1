...
function Initialize-BetaFormDefinitionDynamicSchemaRequestAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaFormDefinitionDynamicSchemaRequestAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToFormDefinitionDynamicSchemaRequestAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaFormDefinitionDynamicSchemaRequestAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

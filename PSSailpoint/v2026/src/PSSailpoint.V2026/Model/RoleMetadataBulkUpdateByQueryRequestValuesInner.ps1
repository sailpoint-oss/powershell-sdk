...
function Initialize-V2026RoleMetadataBulkUpdateByQueryRequestValuesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMetadataBulkUpdateByQueryRequestValuesInner' | Write-Debug
...
RoleMetadataBulkUpdateByQueryRequestValuesInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMetadataBulkUpdateByQueryRequestValuesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMetadataBulkUpdateByQueryRequestValuesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMetadataBulkUpdateByQueryRequestValuesInner

...
function Initialize-Queryresultfilter {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessModelMetadata => Queryresultfilter' | Write-Debug
...
function ConvertFrom-JsonToQueryresultfilter {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessModelMetadata => Queryresultfilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

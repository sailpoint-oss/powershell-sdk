...
Campaign2AllOfSearchCampaignInfo<PSCustomObject>
#>

function Initialize-Campaign2AllOfSearchCampaignInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Campaign2AllOfSearchCampaignInfo' | Write-Debug
...
Convert from JSON to Campaign2AllOfSearchCampaignInfo<PSCustomObject>
...
Campaign2AllOfSearchCampaignInfo<PSCustomObject>
#>
function ConvertFrom-JsonToCampaign2AllOfSearchCampaignInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Campaign2AllOfSearchCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Campaign2AllOfSearchCampaignInfo

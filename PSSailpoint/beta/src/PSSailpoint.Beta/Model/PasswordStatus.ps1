...
function Initialize-BetaPasswordStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaPasswordStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToPasswordStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaPasswordStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

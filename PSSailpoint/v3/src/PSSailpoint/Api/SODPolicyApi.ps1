...
function Get-ArmPublicKey {
    ...
    Process {
        'Calling method: Get-ArmPublicKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/sod-config/public-keys/target'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getArmPublicKey."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-ArmRiskById {
    ...
    Process {
        'Calling method: Get-ArmRiskById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/sod-risks/risks/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getArmRiskById."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

...
keywords: ['powershell', 'PowerShell', 'sdk', 'Certifications', 'V2026Certifications'] 
slug: /tools/sdk/powershell/v2026/methods/certifications
...
------------- | ------------- | -------------
[**Get-V2026CertificationTask**](#get-certification-task) | **GET** `/certification-tasks/{id}` | Certification task by id
[**Get-V2026IdentityCertification**](#get-identity-certification) | **GET** `/certifications/{id}` | Identity certification by id
[**Get-V2026IdentityCertificationItemPermissions**](#get-identity-certification-item-permissions) | **GET** `/certifications/{certificationId}/access-review-items/{itemId}/permissions` | Permissions for entitlement certification item
[**Get-V2026PendingCertificationTasks**](#get-pending-certification-tasks) | **GET** `/certification-tasks` | List of pending certification tasks
[**Get-V2026CertificationReviewers**](#list-certification-reviewers) | **GET** `/certifications/{id}/reviewers` | List of reviewers for certification
[**Get-V2026IdentityAccessReviewItems**](#list-identity-access-review-items) | **GET** `/certifications/{id}/access-review-items` | List of access review items
[**Get-V2026IdentityCertifications**](#list-identity-certifications) | **GET** `/certifications` | List identity campaign certifications
[**Select-V2026IdentityDecision**](#make-identity-decision) | **POST** `/certifications/{id}/decide` | Decide on a certification item
[**Invoke-V2026ReassignIdentityCertifications**](#reassign-identity-certifications) | **POST** `/certifications/{id}/reassign` | Reassign identities or items
[**Invoke-V2026SignOffIdentityCertification**](#sign-off-identity-certification) | **POST** `/certifications/{id}/sign-off` | Finalize identity certification decisions
[**Submit-V2026ReassignCertsAsync**](#submit-reassign-certs-async) | **POST** `/certifications/{id}/reassign-async` | Reassign certifications asynchronously
...
try {
    Get-V2026CertificationTask -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026CertificationTask -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026CertificationTask"
...
try {
    Get-V2026IdentityCertification -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026IdentityCertification -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026IdentityCertification"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026IdentityCertificationItemPermissions -CertificationId $CertificationId -ItemId $ItemId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026IdentityCertificationItemPermissions -CertificationId $CertificationId -ItemId $ItemId -Filters $Filters -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026IdentityCertificationItemPermissions"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026PendingCertificationTasks -ReviewerIdentity $ReviewerIdentity -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026PendingCertificationTasks"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026CertificationReviewers -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026CertificationReviewers -Id $Id -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026CertificationReviewers"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026IdentityAccessReviewItems -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026IdentityAccessReviewItems -Id $Id -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters -Entitlements $Entitlements -AccessProfiles $AccessProfiles -Roles $Roles  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026IdentityAccessReviewItems"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026IdentityCertifications 
    
    # Below is a request that includes all optional parameters
    # Get-V2026IdentityCertifications -ReviewerIdentity $ReviewerIdentity -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026IdentityCertifications"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToReviewDecision -Json $ReviewDecision
    Select-V2026IdentityDecision -Id $Id -ReviewDecision $Result 
    
    # Below is a request that includes all optional parameters
    # Select-V2026IdentityDecision -Id $Id -ReviewDecision $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Select-V2026IdentityDecision"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToReviewReassign -Json $ReviewReassign
    Invoke-V2026ReassignIdentityCertifications -Id $Id -ReviewReassign $Result 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026ReassignIdentityCertifications -Id $Id -ReviewReassign $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026ReassignIdentityCertifications"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Invoke-V2026SignOffIdentityCertification -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026SignOffIdentityCertification -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026SignOffIdentityCertification"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToReviewReassign -Json $ReviewReassign
    Submit-V2026ReassignCertsAsync -Id $Id -ReviewReassign $Result 
    
    # Below is a request that includes all optional parameters
    # Submit-V2026ReassignCertsAsync -Id $Id -ReviewReassign $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Submit-V2026ReassignCertsAsync"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

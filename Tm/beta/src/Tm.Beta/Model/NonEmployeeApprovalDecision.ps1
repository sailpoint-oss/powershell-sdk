...
function Initialize-BetaNonEmployeeApprovalDecision {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalDecision' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeApprovalDecision {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalDecision' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

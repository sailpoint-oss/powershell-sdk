...
function Initialize-BetaRoleMiningSessionResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningSessionResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

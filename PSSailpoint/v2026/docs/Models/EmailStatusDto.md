...
keywords: ['powershell', 'PowerShell', 'sdk', 'EmailStatusDto', 'V2026EmailStatusDto'] 
slug: /tools/sdk/powershell/v2026/models/email-status-dto
...
```powershell
$EmailStatusDto = Initialize-V2026EmailStatusDto  -Id null `

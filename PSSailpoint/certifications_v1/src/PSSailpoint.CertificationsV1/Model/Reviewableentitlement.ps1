...
function Initialize-Reviewableentitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationsV1 => Reviewableentitlement' | Write-Debug
...
function ConvertFrom-JsonToReviewableentitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationsV1 => Reviewableentitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ReviewableAccessProfile {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ReviewableAccessProfile' | Write-Debug
...
function ConvertFrom-JsonToReviewableAccessProfile {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ReviewableAccessProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

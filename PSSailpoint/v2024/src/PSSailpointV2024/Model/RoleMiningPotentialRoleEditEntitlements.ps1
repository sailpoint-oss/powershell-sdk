...
function Initialize-V2024RoleMiningPotentialRoleEditEntitlements {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleMiningPotentialRoleEditEntitlements' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningPotentialRoleEditEntitlements {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleMiningPotentialRoleEditEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

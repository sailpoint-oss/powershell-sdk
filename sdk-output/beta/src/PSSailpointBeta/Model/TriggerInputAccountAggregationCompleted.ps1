...
TriggerInputAccountAggregationCompleted<PSCustomObject>
#>

function Initialize-BetaTriggerInputAccountAggregationCompleted {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountAggregationCompleted' | Write-Debug
...
Convert from JSON to TriggerInputAccountAggregationCompleted<PSCustomObject>
...
TriggerInputAccountAggregationCompleted<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputAccountAggregationCompleted {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountAggregationCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputAccountAggregationCompleted

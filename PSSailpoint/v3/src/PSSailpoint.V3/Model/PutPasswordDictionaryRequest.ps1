...
function Initialize-PutPasswordDictionaryRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => PutPasswordDictionaryRequest' | Write-Debug
...
function ConvertFrom-JsonToPutPasswordDictionaryRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => PutPasswordDictionaryRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

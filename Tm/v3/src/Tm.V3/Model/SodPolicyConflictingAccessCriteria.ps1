...
function Initialize-SodPolicyConflictingAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => SodPolicyConflictingAccessCriteria' | Write-Debug
...
function ConvertFrom-JsonToSodPolicyConflictingAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => SodPolicyConflictingAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

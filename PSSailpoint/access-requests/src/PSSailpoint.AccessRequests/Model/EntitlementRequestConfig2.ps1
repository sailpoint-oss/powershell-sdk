...
EntitlementRequestConfig2<PSCustomObject>
#>

function Initialize-EntitlementRequestConfig2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => EntitlementRequestConfig2' | Write-Debug
...
Convert from JSON to EntitlementRequestConfig2<PSCustomObject>
...
EntitlementRequestConfig2<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementRequestConfig2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => EntitlementRequestConfig2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EntitlementRequestConfig2

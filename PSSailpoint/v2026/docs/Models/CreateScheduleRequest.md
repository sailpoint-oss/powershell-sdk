...
keywords: ['powershell', 'PowerShell', 'sdk', 'CreateScheduleRequest', 'V2026CreateScheduleRequest'] 
slug: /tools/sdk/powershell/v2026/models/create-schedule-request
...
```powershell
$CreateScheduleRequest = Initialize-V2026CreateScheduleRequest  -TaskTypeName DataSync `
 -ScheduleType Daily `
 -Interval 1440 `

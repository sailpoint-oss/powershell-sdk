...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleGetAllBulkUpdateResponse', 'V2026RoleGetAllBulkUpdateResponse'] 
slug: /tools/sdk/powershell/v2026/models/role-get-all-bulk-update-response
...
```powershell
$RoleGetAllBulkUpdateResponse = Initialize-V2026RoleGetAllBulkUpdateResponse  -Id 2c9180867817ac4d017817c491119a20 `
 -Type Role `
 -Status CREATED `

...
#>
function New-V2024MultiHostIntegration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2024MultiHostIntegration' | Write-Debug
...
None
#>
function New-V2024SourcesWithinMultiHost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: New-V2024SourcesWithinMultiHost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-V2024MultiHost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2024MultiHost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2024AcctAggregationGroups {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024AcctAggregationGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MultiHostIntegrationsAggScheduleUpdate[]
#>
function Get-V2024EntitlementAggregationGroups {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024EntitlementAggregationGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MultiHostIntegrations
#>
function Get-V2024MultiHostIntegrations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024MultiHostIntegrations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MultiHostIntegrations[]
#>
function Get-V2024MultiHostIntegrationsList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int32]]
    ...
    Process {
        'Calling method: Get-V2024MultiHostIntegrationsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2024MultiHostSourceCreationErrors {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024MultiHostSourceCreationErrors' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2024MultihostIntegrationTypes {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2024MultihostIntegrationTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MultiHostSources[]
#>
function Get-V2024SourcesWithinMultiHost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024SourcesWithinMultiHost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Test-V2024ConnectionMultiHostSources {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Test-V2024ConnectionMultiHostSources' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Test-V2024SourceConnectionMultihost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Test-V2024SourceConnectionMultihost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Update-V2024MultiHostSources {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2024MultiHostSources' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

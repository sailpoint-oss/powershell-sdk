...
function Initialize-BetaRecommenderCalculations {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRecommenderCalculations' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommenderCalculations {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRecommenderCalculations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

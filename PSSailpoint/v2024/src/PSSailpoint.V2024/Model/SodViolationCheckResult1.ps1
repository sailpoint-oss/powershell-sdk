...
function Initialize-V2024SodViolationCheckResult1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SodViolationCheckResult1' | Write-Debug
...
SodViolationCheckResult1<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSodViolationCheckResult1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SodViolationCheckResult1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SodViolationCheckResult1

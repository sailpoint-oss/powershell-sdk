...
function Initialize-V2024AccessItemAccessProfileResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessItemAccessProfileResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessItemAccessProfileResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessItemAccessProfileResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

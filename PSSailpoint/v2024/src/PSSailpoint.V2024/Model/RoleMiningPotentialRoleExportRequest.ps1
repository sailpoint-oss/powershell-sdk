...
function Initialize-V2024RoleMiningPotentialRoleExportRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningPotentialRoleExportRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningPotentialRoleExportRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleMiningPotentialRoleExportRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

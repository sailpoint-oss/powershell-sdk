...
slug: /tools/sdk/powershell/transforms/models/replace-all
...
------------ | ------------- | ------------- | -------------
**Table** | **map[string]AnyType** | An attribute of key-value pairs. Each pair identifies the pattern to search for as its key, and the replacement string as its value. | [required]

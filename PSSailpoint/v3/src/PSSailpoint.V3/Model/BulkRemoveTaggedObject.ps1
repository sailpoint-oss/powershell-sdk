...
function Initialize-BulkRemoveTaggedObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => BulkRemoveTaggedObject' | Write-Debug
...
function ConvertFrom-JsonToBulkRemoveTaggedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => BulkRemoveTaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

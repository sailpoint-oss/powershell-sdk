...
function Initialize-V2026CertificationSignedOff {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CertificationSignedOff' | Write-Debug
...
CertificationSignedOff<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCertificationSignedOff {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CertificationSignedOff' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CertificationSignedOff

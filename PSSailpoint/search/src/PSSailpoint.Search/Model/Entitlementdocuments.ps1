...
Entitlementdocuments<PSCustomObject>
#>

function Initialize-Entitlementdocuments {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => Entitlementdocuments' | Write-Debug
...
Convert from JSON to Entitlementdocuments<PSCustomObject>
...
Entitlementdocuments<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementdocuments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => Entitlementdocuments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Entitlementdocuments
        $AllProperties = ("id", "name", "modified", "synced", "displayName", "source", "segments", "segmentCount", "requestable", "cloudGoverned", "created", "privileged", "tags", "attribute", "value", "sourceSchemaObjectType", "schema", "hash", "attributes", "truncatedAttributes", "containsDataAccess", "manuallyUpdatedFields", "permissions", "pod", "org", "_type", "type", "_version")

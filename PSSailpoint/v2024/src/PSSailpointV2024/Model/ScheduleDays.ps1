...
function Initialize-V2024ScheduleDays {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ScheduleDays' | Write-Debug
...
function ConvertFrom-V2024JsonToScheduleDays {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ScheduleDays' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026InviteIdentitiesRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026InviteIdentitiesRequest' | Write-Debug
...
InviteIdentitiesRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToInviteIdentitiesRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026InviteIdentitiesRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026InviteIdentitiesRequest

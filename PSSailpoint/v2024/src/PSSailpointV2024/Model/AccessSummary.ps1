...
function Initialize-V2024AccessSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

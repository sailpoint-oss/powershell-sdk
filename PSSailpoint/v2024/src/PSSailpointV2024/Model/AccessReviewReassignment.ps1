...
function Initialize-V2024AccessReviewReassignment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessReviewReassignment' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessReviewReassignment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessReviewReassignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
Get the configuration object 'BetaConfiguration'.
...
#>
function Get-BetaConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://sailpoint.api.identitynow.com/beta";
    }
...
System.Collections.Hashtable
#>
function Set-BetaConfiguration {
...
None
#>
function Set-BetaConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-BetaConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-BetaConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
String
#>
function Get-BetaUrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-BetaConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-BetaKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'BetaConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-BetaConfigurationHttpSigning{

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountAttributesChanged', 'V2026AccountAttributesChanged'] 
slug: /tools/sdk/powershell/v2026/models/account-attributes-changed
...
```powershell
$AccountAttributesChanged = Initialize-V2026AccountAttributesChanged  -Identity null `
 -Source null `
 -Account null `
 -Changes null
```

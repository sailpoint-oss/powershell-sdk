...
function Initialize-Workgroupdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.GovernanceGroupsV1 => Workgroupdto' | Write-Debug
...
Workgroupdto<PSCustomObject>
#>
function ConvertFrom-JsonToWorkgroupdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.GovernanceGroupsV1 => Workgroupdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Workgroupdto

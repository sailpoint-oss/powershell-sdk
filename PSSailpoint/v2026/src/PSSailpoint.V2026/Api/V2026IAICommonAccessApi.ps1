...
#>
function New-V2026CommonAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026CommonAccess' | Write-Debug
...
#>
function Get-V2026CommonAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026CommonAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Update-V2026CommonAccessStatusInBulk {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026CommonAccessStatusInBulk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

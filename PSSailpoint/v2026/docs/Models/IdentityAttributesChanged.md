...
keywords: ['powershell', 'PowerShell', 'sdk', 'IdentityAttributesChanged', 'V2026IdentityAttributesChanged'] 
slug: /tools/sdk/powershell/v2026/models/identity-attributes-changed
...
```powershell
$IdentityAttributesChanged = Initialize-V2026IdentityAttributesChanged  -Identity null `
 -Changes null
```

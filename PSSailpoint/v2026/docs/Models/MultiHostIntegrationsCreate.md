...
keywords: ['powershell', 'PowerShell', 'sdk', 'MultiHostIntegrationsCreate', 'V2026MultiHostIntegrationsCreate'] 
slug: /tools/sdk/powershell/v2026/models/multi-host-integrations-create
...
```powershell
$MultiHostIntegrationsCreate = Initialize-V2026MultiHostIntegrationsCreate  -Name My Multi-Host Integration `

...
keywords: ['powershell', 'PowerShell', 'sdk', 'MachineClassificationCriteriaLevel3', 'V2026MachineClassificationCriteriaLevel3'] 
slug: /tools/sdk/powershell/v2026/models/machine-classification-criteria-level3
...
```powershell
$MachineClassificationCriteriaLevel3 = Initialize-V2026MachineClassificationCriteriaLevel3  -Operation null `
 -CaseSensitive false `
 -DataType null `

...
function Initialize-V2024ApprovalComment1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalComment1' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalComment1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalComment1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

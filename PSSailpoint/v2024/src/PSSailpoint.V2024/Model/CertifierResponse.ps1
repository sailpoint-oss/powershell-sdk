...
function Initialize-V2024CertifierResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CertifierResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToCertifierResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CertifierResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

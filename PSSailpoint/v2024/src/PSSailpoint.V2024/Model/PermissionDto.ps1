...
function Initialize-V2024PermissionDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024PermissionDto' | Write-Debug
...
function ConvertFrom-V2024JsonToPermissionDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024PermissionDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

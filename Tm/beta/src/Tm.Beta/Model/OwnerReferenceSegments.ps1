...
function Initialize-BetaOwnerReferenceSegments {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaOwnerReferenceSegments' | Write-Debug
...
function ConvertFrom-BetaJsonToOwnerReferenceSegments {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaOwnerReferenceSegments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

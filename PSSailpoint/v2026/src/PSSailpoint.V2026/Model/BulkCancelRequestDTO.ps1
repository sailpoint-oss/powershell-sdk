...
function Initialize-V2026BulkCancelRequestDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026BulkCancelRequestDTO' | Write-Debug
...
BulkCancelRequestDTO<PSCustomObject>
#>
function ConvertFrom-V2026JsonToBulkCancelRequestDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026BulkCancelRequestDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026BulkCancelRequestDTO

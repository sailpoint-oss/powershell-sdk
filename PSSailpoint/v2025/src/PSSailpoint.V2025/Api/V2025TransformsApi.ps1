...
function New-V2025Transform {
    ...
    Process {
        'Calling method: New-V2025Transform' | Write-Debug
...
None
#>
function Remove-V2025Transform {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025Transform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025Transform {
    ...
    Process {
        'Calling method: Get-V2025Transform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025Transforms {
    ...
    Process {
        'Calling method: Get-V2025Transforms' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TransformRead
#>
function Update-V2025Transform {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025Transform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-GenerateRandomString {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => GenerateRandomString' | Write-Debug
...
function ConvertFrom-JsonToGenerateRandomString {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => GenerateRandomString' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-JsonPatchOperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountSubtypes => JsonPatchOperation' | Write-Debug
...
function ConvertFrom-JsonToJsonPatchOperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountSubtypes => JsonPatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

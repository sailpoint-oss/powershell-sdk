...
function Initialize-CampaignAllOfSourceOwnerCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => CampaignAllOfSourceOwnerCampaignInfo' | Write-Debug
...
function ConvertFrom-JsonToCampaignAllOfSourceOwnerCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => CampaignAllOfSourceOwnerCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

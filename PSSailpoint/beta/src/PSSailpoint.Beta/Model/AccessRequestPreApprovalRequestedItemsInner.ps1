...
function Initialize-BetaAccessRequestPreApprovalRequestedItemsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequestPreApprovalRequestedItemsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPreApprovalRequestedItemsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequestPreApprovalRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaPasswordPolicyV3Dto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaPasswordPolicyV3Dto' | Write-Debug
...
function ConvertFrom-BetaJsonToPasswordPolicyV3Dto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaPasswordPolicyV3Dto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

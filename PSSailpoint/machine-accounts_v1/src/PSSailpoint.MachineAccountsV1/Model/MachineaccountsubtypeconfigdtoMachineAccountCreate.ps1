...
function Initialize-MachineaccountsubtypeconfigdtoMachineAccountCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountsV1 => MachineaccountsubtypeconfigdtoMachineAccountCreate' | Write-Debug
...
MachineaccountsubtypeconfigdtoMachineAccountCreate<PSCustomObject>
#>
function ConvertFrom-JsonToMachineaccountsubtypeconfigdtoMachineAccountCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountsV1 => MachineaccountsubtypeconfigdtoMachineAccountCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MachineaccountsubtypeconfigdtoMachineAccountCreate

...
function Initialize-Eventdocuments {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => Eventdocuments' | Write-Debug
...
Convert from JSON to Eventdocuments<PSCustomObject>
...
Eventdocuments<PSCustomObject>
#>
function ConvertFrom-JsonToEventdocuments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => Eventdocuments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

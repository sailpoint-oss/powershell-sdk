...
function Initialize-V2024EventAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024EventAttributes' | Write-Debug
...
function ConvertFrom-V2024JsonToEventAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024EventAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
**Enabled** | **Boolean** | Whether the Role is enabled or not. This field is false by default. | [optional] 
**Requestable** | **Boolean** | Whether the Role can be the target of Access Requests. This field is false by default. | [optional] 

...
function Initialize-BetaEntitlementAccessModelMetadata {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaEntitlementAccessModelMetadata' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementAccessModelMetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaEntitlementAccessModelMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

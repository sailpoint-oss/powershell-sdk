...
function Initialize-DataaccessImpactScore {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Certifications => DataaccessImpactScore' | Write-Debug
...
function ConvertFrom-JsonToDataaccessImpactScore {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Certifications => DataaccessImpactScore' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

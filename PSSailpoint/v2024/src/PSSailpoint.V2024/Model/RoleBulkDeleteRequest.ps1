...
function Initialize-V2024RoleBulkDeleteRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleBulkDeleteRequest' | Write-Debug
...
RoleBulkDeleteRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRoleBulkDeleteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RoleBulkDeleteRequest

...
function Initialize-V2026LifecycleStateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026LifecycleStateDto' | Write-Debug
...
LifecycleStateDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToLifecycleStateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026LifecycleStateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026LifecycleStateDto

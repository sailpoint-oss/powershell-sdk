...
function Initialize-Passworddigittokenreset {
    [CmdletBinding()]
    Param (
...
Passworddigittokenreset<PSCustomObject>
#>
function ConvertFrom-JsonToPassworddigittokenreset {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Passworddigittokenreset

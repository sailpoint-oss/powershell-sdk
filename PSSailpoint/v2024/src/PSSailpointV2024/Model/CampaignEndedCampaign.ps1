...
function Initialize-V2024CampaignEndedCampaign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignEndedCampaign' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignEndedCampaign {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignEndedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

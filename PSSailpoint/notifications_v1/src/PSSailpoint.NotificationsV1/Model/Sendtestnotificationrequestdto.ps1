...
function Initialize-Sendtestnotificationrequestdto {
    [CmdletBinding()]
    Param (
...
Sendtestnotificationrequestdto<PSCustomObject>
#>
function ConvertFrom-JsonToSendtestnotificationrequestdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Sendtestnotificationrequestdto

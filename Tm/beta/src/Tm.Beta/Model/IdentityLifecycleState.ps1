...
function Initialize-BetaIdentityLifecycleState {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityLifecycleState' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityLifecycleState {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityLifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ApprovalSchemeForRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalSchemeForRole' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalSchemeForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalSchemeForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

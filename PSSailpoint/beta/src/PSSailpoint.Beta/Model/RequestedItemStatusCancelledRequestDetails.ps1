...
function Initialize-BetaRequestedItemStatusCancelledRequestDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusCancelledRequestDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestedItemStatusCancelledRequestDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusCancelledRequestDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

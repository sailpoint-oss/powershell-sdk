...
function Initialize-V2025RequestedItemDtoRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RequestedItemDtoRef' | Write-Debug
...
RequestedItemDtoRef<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRequestedItemDtoRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RequestedItemDtoRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RequestedItemDtoRef
        $AllProperties = ("type", "id", "comment", "clientMetadata", "removeDate", "assignmentId", "nativeIdentity", "accountSelection")

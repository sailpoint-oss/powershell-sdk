...
function Initialize-Accountstatuschanged {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IdentityHistoryV1 => Accountstatuschanged' | Write-Debug
...
Accountstatuschanged<PSCustomObject>
#>
function ConvertFrom-JsonToAccountstatuschanged {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IdentityHistoryV1 => Accountstatuschanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accountstatuschanged

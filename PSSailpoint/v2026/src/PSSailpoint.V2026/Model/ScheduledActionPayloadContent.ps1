...
function Initialize-V2026ScheduledActionPayloadContent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ScheduledActionPayloadContent' | Write-Debug
...
ScheduledActionPayloadContent<PSCustomObject>
#>
function ConvertFrom-V2026JsonToScheduledActionPayloadContent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ScheduledActionPayloadContent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ScheduledActionPayloadContent

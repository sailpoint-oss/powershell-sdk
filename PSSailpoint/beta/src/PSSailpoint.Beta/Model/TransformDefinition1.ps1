...
function Initialize-BetaTransformDefinition1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTransformDefinition1' | Write-Debug
...
function ConvertFrom-BetaJsonToTransformDefinition1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTransformDefinition1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-PreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => PreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-JsonToPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => PreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountAttributes', 'V2026AccountAttributes'] 
slug: /tools/sdk/powershell/v2026/models/account-attributes
...
```powershell
$AccountAttributes = Initialize-V2026AccountAttributes  -Attributes {city=Austin, displayName=John Doe, userName=jdoe, sAMAccountName=jDoe, mail=john.doe@sailpoint.com}
```

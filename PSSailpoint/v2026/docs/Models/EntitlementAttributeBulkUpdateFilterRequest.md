...
keywords: ['powershell', 'PowerShell', 'sdk', 'EntitlementAttributeBulkUpdateFilterRequest', 'V2026EntitlementAttributeBulkUpdateFilterRequest'] 
slug: /tools/sdk/powershell/v2026/models/entitlement-attribute-bulk-update-filter-request
...
```powershell
$EntitlementAttributeBulkUpdateFilterRequest = Initialize-V2026EntitlementAttributeBulkUpdateFilterRequest  -Filters id eq 2c9180867817ac4d017817c491119a20 `
 -Operation add `

...
function Initialize-BetaFieldDetailsDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFieldDetailsDto' | Write-Debug
...
function ConvertFrom-BetaJsonToFieldDetailsDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFieldDetailsDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

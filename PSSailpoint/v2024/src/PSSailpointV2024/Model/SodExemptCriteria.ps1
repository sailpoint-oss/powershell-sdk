...
function Initialize-V2024SodExemptCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SodExemptCriteria' | Write-Debug
...
function ConvertFrom-V2024JsonToSodExemptCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SodExemptCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

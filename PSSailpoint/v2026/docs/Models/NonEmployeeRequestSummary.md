...
keywords: ['powershell', 'PowerShell', 'sdk', 'NonEmployeeRequestSummary', 'V2026NonEmployeeRequestSummary'] 
slug: /tools/sdk/powershell/v2026/models/non-employee-request-summary
...
```powershell
$NonEmployeeRequestSummary = Initialize-V2026NonEmployeeRequestSummary  -Approved 2 `
 -Rejected 2 `
 -Pending 2 `
 -NonEmployeeCount 2
```

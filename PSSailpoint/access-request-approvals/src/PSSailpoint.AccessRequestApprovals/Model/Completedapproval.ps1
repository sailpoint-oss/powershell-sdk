...
function Initialize-Completedapproval {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => Completedapproval' | Write-Debug
...
Completedapproval<PSCustomObject>
#>
function ConvertFrom-JsonToCompletedapproval {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => Completedapproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

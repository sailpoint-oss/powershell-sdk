...
function Initialize-BetaDkimAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaDkimAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToDkimAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaDkimAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

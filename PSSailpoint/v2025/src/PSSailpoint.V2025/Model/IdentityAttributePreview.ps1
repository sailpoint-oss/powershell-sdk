...
function Initialize-V2025IdentityAttributePreview {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025IdentityAttributePreview' | Write-Debug
...
IdentityAttributePreview<PSCustomObject>
#>
function ConvertFrom-V2025JsonToIdentityAttributePreview {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025IdentityAttributePreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025IdentityAttributePreview

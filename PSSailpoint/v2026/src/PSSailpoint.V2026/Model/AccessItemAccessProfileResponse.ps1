...
function Initialize-V2026AccessItemAccessProfileResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessItemAccessProfileResponse' | Write-Debug
...
AccessItemAccessProfileResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessItemAccessProfileResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessItemAccessProfileResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessItemAccessProfileResponse

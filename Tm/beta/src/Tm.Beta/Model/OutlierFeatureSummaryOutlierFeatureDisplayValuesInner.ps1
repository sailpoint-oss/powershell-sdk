...
function Initialize-BetaOutlierFeatureSummaryOutlierFeatureDisplayValuesInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaOutlierFeatureSummaryOutlierFeatureDisplayValuesInner' | Write-Debug
...
function ConvertFrom-BetaJsonToOutlierFeatureSummaryOutlierFeatureDisplayValuesInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaOutlierFeatureSummaryOutlierFeatureDisplayValuesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ImportFormDefinitions202Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ImportFormDefinitions202Response' | Write-Debug
...
function ConvertFrom-V2024JsonToImportFormDefinitions202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ImportFormDefinitions202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

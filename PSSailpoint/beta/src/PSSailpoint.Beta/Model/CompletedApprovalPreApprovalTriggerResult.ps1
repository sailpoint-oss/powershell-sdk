...
function Initialize-BetaCompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCompletedApprovalPreApprovalTriggerResult' | Write-Debug
...
function ConvertFrom-BetaJsonToCompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCompletedApprovalPreApprovalTriggerResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

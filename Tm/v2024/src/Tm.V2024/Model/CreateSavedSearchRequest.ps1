...
function Initialize-V2024CreateSavedSearchRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CreateSavedSearchRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateSavedSearchRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CreateSavedSearchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

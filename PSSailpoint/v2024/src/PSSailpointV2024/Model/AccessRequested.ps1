...
function Initialize-V2024AccessRequested {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequested' | Write-Debug
...
AccessRequested<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccessRequested {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequested' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026ListFormInstancesByTenantResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ListFormInstancesByTenantResponse' | Write-Debug
...
ListFormInstancesByTenantResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToListFormInstancesByTenantResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ListFormInstancesByTenantResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ListFormInstancesByTenantResponse

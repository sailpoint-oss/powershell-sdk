...
function Initialize-V2024EntitlementRevocationRequestConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024EntitlementRevocationRequestConfig' | Write-Debug
...
EntitlementRevocationRequestConfig<PSCustomObject>
#>
function ConvertFrom-V2024JsonToEntitlementRevocationRequestConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024EntitlementRevocationRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024EntitlementRevocationRequestConfig

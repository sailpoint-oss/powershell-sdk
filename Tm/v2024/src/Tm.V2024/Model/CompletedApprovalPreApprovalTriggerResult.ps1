...
function Initialize-V2024CompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CompletedApprovalPreApprovalTriggerResult' | Write-Debug
...
function ConvertFrom-V2024JsonToCompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CompletedApprovalPreApprovalTriggerResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

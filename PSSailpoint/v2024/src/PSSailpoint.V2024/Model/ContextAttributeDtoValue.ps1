...
#>
function ConvertFrom-V2024JsonToContextAttributeDtoValue {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'String' defined in oneOf (V2024ContextAttributeDtoValue). Proceeding to the next one if any."
        }

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessRequestRecommendationItemDetail', 'V2026AccessRequestRecommendationItemDetail'] 
slug: /tools/sdk/powershell/v2026/models/access-request-recommendation-item-detail
...
```powershell
$AccessRequestRecommendationItemDetail = Initialize-V2026AccessRequestRecommendationItemDetail  -IdentityId 2c91808570313110017040b06f344ec9 `
 -Access null `
 -Ignored true `
 -Requested true `
 -Viewed true `

...
slug: /tools/sdk/powershell/simintegrations/models/sim-integration-details
...
**Attributes** | **SystemCollectionsHashtable** | The attributes map containing the credentials used to configure the integration. | [optional] 
**Sources** | **[]String** | The list of sources (managed resources) | [optional] 
**Cluster** | **String** | The cluster/proxy | [optional] 
**StatusMap** | **SystemCollectionsHashtable** | Custom mapping between the integration result and the provisioning result | [optional] 
**Request** | **SystemCollectionsHashtable** | Request data to customize desc and body of the created ticket | [optional] 

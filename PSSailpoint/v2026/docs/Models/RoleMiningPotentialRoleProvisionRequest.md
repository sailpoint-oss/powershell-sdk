...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMiningPotentialRoleProvisionRequest', 'V2026RoleMiningPotentialRoleProvisionRequest'] 
slug: /tools/sdk/powershell/v2026/models/role-mining-potential-role-provision-request
...
```powershell
$RoleMiningPotentialRoleProvisionRequest = Initialize-V2026RoleMiningPotentialRoleProvisionRequest  -RoleName Finance - Accounting `

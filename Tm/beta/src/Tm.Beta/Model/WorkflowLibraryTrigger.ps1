...
function Initialize-BetaWorkflowLibraryTrigger {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaWorkflowLibraryTrigger' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowLibraryTrigger {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaWorkflowLibraryTrigger' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ProvisioningConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ProvisioningConfig' | Write-Debug
...
ProvisioningConfig<PSCustomObject>
#>
function ConvertFrom-V2024JsonToProvisioningConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ProvisioningConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ProvisioningConfig

...
function Initialize-V2024ExceptionCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ExceptionCriteria' | Write-Debug
...
function ConvertFrom-V2024JsonToExceptionCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ExceptionCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

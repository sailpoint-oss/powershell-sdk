...
keywords: ['powershell', 'PowerShell', 'sdk', 'CreateWorkflowRequest', 'V2026CreateWorkflowRequest'] 
slug: /tools/sdk/powershell/v2026/models/create-workflow-request
...
```powershell
$CreateWorkflowRequest = Initialize-V2026CreateWorkflowRequest  -Name Send Email `
 -Owner null `

...
function Initialize-V2024IdentityWithNewAccessAccessRefsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024IdentityWithNewAccessAccessRefsInner' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityWithNewAccessAccessRefsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024IdentityWithNewAccessAccessRefsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'LifecycleState', 'V2026LifecycleState'] 
slug: /tools/sdk/powershell/v2026/models/lifecycle-state
...
```powershell
$LifecycleState = Initialize-V2026LifecycleState  -Id id12345 `
 -Name aName `

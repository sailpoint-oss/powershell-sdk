...
function Search-AggregateV1 {
    ...
    Process {
        'Calling method: Search-AggregateV1' | Write-Debug
        ...
        $LocalVarUri = '/search/v1/aggregate'
        ...
        if (!$Search) {
            throw "Error! The required parameter `Search` missing when calling searchAggregateV1."
        }
...
function Search-CountV1 {
    ...
    Process {
        'Calling method: Search-CountV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/search/v1/count'

        if (!$Search) {
            throw "Error! The required parameter `Search` missing when calling searchCountV1."
        }
...
function Search-GetV1 {
    ...
    Process {
        'Calling method: Search-GetV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/search/v1/{index}/{id}'
        if (!$Index) {
            throw "Error! The required parameter `Index` missing when calling searchGetV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{index}', [System.Web.HTTPUtility]::UrlEncode($Index))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling searchGetV1."
        }
...
function Search-PostV1 {
    ...
    Process {
        'Calling method: Search-PostV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$Search) {
            throw "Error! The required parameter `Search` missing when calling searchPostV1."
        }

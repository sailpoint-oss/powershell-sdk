...
keywords: ['powershell', 'PowerShell', 'sdk', 'TaskResultDetailsMessagesInner', 'V2026TaskResultDetailsMessagesInner'] 
slug: /tools/sdk/powershell/v2026/models/task-result-details-messages-inner
...
```powershell
$TaskResultDetailsMessagesInner = Initialize-V2026TaskResultDetailsMessagesInner  -Type WARN `
 -VarError false `
 -Warning true `

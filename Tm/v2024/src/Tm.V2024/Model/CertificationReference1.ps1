...
function Initialize-V2024CertificationReference1 {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CertificationReference1' | Write-Debug
...
function ConvertFrom-V2024JsonToCertificationReference1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CertificationReference1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

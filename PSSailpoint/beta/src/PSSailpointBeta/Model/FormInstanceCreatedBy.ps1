...
function Initialize-BetaFormInstanceCreatedBy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaFormInstanceCreatedBy' | Write-Debug
...
function ConvertFrom-BetaJsonToFormInstanceCreatedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaFormInstanceCreatedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

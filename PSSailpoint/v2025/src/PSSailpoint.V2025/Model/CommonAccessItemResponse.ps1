...
function Initialize-V2025CommonAccessItemResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CommonAccessItemResponse' | Write-Debug
...
CommonAccessItemResponse<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCommonAccessItemResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CommonAccessItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CommonAccessItemResponse

...
function Initialize-V2024AccessRequestResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequestResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequestResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024RoleMiningPotentialRoleProvisionRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleMiningPotentialRoleProvisionRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningPotentialRoleProvisionRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleMiningPotentialRoleProvisionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

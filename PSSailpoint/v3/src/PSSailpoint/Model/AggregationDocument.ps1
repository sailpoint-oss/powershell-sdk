...
AggregationDocument<PSCustomObject>
#>

function Initialize-AggregationDocument {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => AggregationDocument' | Write-Debug
...
Convert from JSON to AggregationDocument<PSCustomObject>
...
AggregationDocument<PSCustomObject>
#>
function ConvertFrom-JsonToAggregationDocument {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => AggregationDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AggregationDocument

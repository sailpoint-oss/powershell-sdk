...
AuthProfile
#>
function Get-V2024ProfileConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2024ProfileConfig' | Write-Debug
...
function Get-V2024ProfileConfigList {
    ...
    Process {
        'Calling method: Get-V2024ProfileConfigList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-V2024ProfileConfig {
    ...
    Process {
        'Calling method: Update-V2024ProfileConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

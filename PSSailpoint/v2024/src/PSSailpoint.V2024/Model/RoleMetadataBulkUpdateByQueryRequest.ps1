...
function Initialize-V2024RoleMetadataBulkUpdateByQueryRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleMetadataBulkUpdateByQueryRequest' | Write-Debug
...
RoleMetadataBulkUpdateByQueryRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRoleMetadataBulkUpdateByQueryRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleMetadataBulkUpdateByQueryRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RoleMetadataBulkUpdateByQueryRequest

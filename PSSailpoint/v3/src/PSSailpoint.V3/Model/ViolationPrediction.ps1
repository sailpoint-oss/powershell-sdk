...
function Initialize-ViolationPrediction {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ViolationPrediction' | Write-Debug
...
function ConvertFrom-JsonToViolationPrediction {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ViolationPrediction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

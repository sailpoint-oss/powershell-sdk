...
function Initialize-Dimensioncriterialevel1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DimensionsV1 => Dimensioncriterialevel1' | Write-Debug
...
Dimensioncriterialevel1<PSCustomObject>
#>
function ConvertFrom-JsonToDimensioncriterialevel1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DimensionsV1 => Dimensioncriterialevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Dimensioncriterialevel1

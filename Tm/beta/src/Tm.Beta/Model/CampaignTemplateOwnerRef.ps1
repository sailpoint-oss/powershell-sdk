...
function Initialize-BetaCampaignTemplateOwnerRef {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCampaignTemplateOwnerRef' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignTemplateOwnerRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCampaignTemplateOwnerRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAppAccountDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAppAccountDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToAppAccountDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAppAccountDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

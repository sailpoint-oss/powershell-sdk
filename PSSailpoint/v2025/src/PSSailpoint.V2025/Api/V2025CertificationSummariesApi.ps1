...
AccessSummary[]
#>
function Get-V2025IdentityAccessSummaries {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2025IdentityAccessSummaries' | Write-Debug
...
#>
function Get-V2025IdentityDecisionSummary {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025IdentityDecisionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025IdentitySummaries {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025IdentitySummaries' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CertificationIdentitySummary
#>
function Get-V2025IdentitySummary {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025IdentitySummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

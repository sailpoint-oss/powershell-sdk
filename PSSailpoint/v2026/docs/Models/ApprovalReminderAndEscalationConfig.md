...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalReminderAndEscalationConfig', 'V2026ApprovalReminderAndEscalationConfig'] 
slug: /tools/sdk/powershell/v2026/models/approval-reminder-and-escalation-config
...
```powershell
$ApprovalReminderAndEscalationConfig = Initialize-V2026ApprovalReminderAndEscalationConfig  -DaysUntilEscalation 0 `

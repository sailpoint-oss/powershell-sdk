...
function Initialize-SubSearchAggregationSpecification {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => SubSearchAggregationSpecification' | Write-Debug
...
function ConvertFrom-JsonToSubSearchAggregationSpecification {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => SubSearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaCampaignEnded {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCampaignEnded' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignEnded {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCampaignEnded' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaTemplateTeams {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTemplateTeams' | Write-Debug
...
function ConvertFrom-BetaJsonToTemplateTeams {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTemplateTeams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

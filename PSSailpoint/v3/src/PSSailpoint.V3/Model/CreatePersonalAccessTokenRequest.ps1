...
function Initialize-CreatePersonalAccessTokenRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CreatePersonalAccessTokenRequest' | Write-Debug
...
function ConvertFrom-JsonToCreatePersonalAccessTokenRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CreatePersonalAccessTokenRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Identityreference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccountDeletionRequests => Identityreference' | Write-Debug
...
function ConvertFrom-JsonToIdentityreference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccountDeletionRequests => Identityreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024EntitlementAccessRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024EntitlementAccessRequestConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlementAccessRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024EntitlementAccessRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

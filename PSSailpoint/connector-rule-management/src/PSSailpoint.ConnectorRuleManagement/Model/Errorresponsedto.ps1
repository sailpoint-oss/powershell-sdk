...
function Initialize-Errorresponsedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ConnectorRuleManagementV1 => Errorresponsedto' | Write-Debug
...
function ConvertFrom-JsonToErrorresponsedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ConnectorRuleManagementV1 => Errorresponsedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'PermissionCollectorSettings', 'V2026PermissionCollectorSettings'] 
slug: /tools/sdk/powershell/v2026/models/permission-collector-settings
...
```powershell
$PermissionCollectorSettings = Initialize-V2026PermissionCollectorSettings  -IsEnabled true `

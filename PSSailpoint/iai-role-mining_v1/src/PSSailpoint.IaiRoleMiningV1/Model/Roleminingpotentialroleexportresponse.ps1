...
function Initialize-Roleminingpotentialroleexportresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingpotentialroleexportresponse' | Write-Debug
...
Roleminingpotentialroleexportresponse<PSCustomObject>
#>
function ConvertFrom-JsonToRoleminingpotentialroleexportresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingpotentialroleexportresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleminingpotentialroleexportresponse

...
$ConnectorDetail1 = @"{  Name: "JDBC", SourceConfigXml: "<Form connectorName='Active Directory - Direct' directConnect='true' name='Active Directory' status='released' type='SourceConfig' xmlns='http://www.sailpoint.com/xsd/sailpoint_form_1_0.xsd'>
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToConnectorDetail1 -Json $ConnectorDetail1
```

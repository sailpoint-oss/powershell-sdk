...
function Initialize-V2026StreamConfigResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026StreamConfigResponse' | Write-Debug
...
StreamConfigResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToStreamConfigResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026StreamConfigResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026StreamConfigResponse

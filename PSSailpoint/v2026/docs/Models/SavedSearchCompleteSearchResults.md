...
keywords: ['powershell', 'PowerShell', 'sdk', 'SavedSearchCompleteSearchResults', 'V2026SavedSearchCompleteSearchResults'] 
slug: /tools/sdk/powershell/v2026/models/saved-search-complete-search-results
...
```powershell
$SavedSearchCompleteSearchResults = Initialize-V2026SavedSearchCompleteSearchResults  -Account null `
 -Entitlement null `
 -Identity null
```

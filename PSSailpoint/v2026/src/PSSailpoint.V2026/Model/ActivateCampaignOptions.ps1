...
function Initialize-V2026ActivateCampaignOptions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ActivateCampaignOptions' | Write-Debug
...
ActivateCampaignOptions<PSCustomObject>
#>
function ConvertFrom-V2026JsonToActivateCampaignOptions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ActivateCampaignOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ActivateCampaignOptions

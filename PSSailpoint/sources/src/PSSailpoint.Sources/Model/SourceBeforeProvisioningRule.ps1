...
function Initialize-SourceBeforeProvisioningRule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Sources => SourceBeforeProvisioningRule' | Write-Debug
...
function ConvertFrom-JsonToSourceBeforeProvisioningRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Sources => SourceBeforeProvisioningRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

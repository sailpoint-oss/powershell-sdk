...
function Initialize-V2026AppAccountDetailsSourceAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AppAccountDetailsSourceAccount' | Write-Debug
...
AppAccountDetailsSourceAccount<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAppAccountDetailsSourceAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AppAccountDetailsSourceAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AppAccountDetailsSourceAccount

...
function Initialize-BetaBaseReferenceDto1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaBaseReferenceDto1' | Write-Debug
...
function ConvertFrom-BetaJsonToBaseReferenceDto1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaBaseReferenceDto1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

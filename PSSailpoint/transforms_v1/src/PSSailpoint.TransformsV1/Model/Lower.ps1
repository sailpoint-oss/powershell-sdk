...
function Initialize-Lower {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Lower' | Write-Debug
...
Lower<PSCustomObject>
#>
function ConvertFrom-JsonToLower {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Lower' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Lower

...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleCriteriaLevel3', 'V2026RoleCriteriaLevel3'] 
slug: /tools/sdk/powershell/v2026/models/role-criteria-level3
...
```powershell
$RoleCriteriaLevel3 = Initialize-V2026RoleCriteriaLevel3  -Operation null `
 -Key null `

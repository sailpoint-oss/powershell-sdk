...
function Initialize-BetaConflictingAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaConflictingAccessCriteria' | Write-Debug
...
function ConvertFrom-BetaJsonToConflictingAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaConflictingAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ListFormInstancesByTenantResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ListFormInstancesByTenantResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToListFormInstancesByTenantResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ListFormInstancesByTenantResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-AccessRequestItemForm {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Triggers => AccessRequestItemForm' | Write-Debug
...
function ConvertFrom-JsonToAccessRequestItemForm {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Triggers => AccessRequestItemForm' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

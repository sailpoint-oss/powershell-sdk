...
function Initialize-V2026ParameterStorageAttestationDocument {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageAttestationDocument' | Write-Debug
...
ParameterStorageAttestationDocument<PSCustomObject>
#>
function ConvertFrom-V2026JsonToParameterStorageAttestationDocument {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageAttestationDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ParameterStorageAttestationDocument

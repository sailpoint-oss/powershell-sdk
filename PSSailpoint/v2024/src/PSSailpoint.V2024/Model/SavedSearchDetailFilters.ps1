...
function Initialize-V2024SavedSearchDetailFilters {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SavedSearchDetailFilters' | Write-Debug
...
function ConvertFrom-V2024JsonToSavedSearchDetailFilters {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SavedSearchDetailFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SavedSearchDetailFilters

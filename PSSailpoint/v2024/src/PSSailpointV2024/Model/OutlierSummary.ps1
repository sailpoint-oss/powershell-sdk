...
function Initialize-V2024OutlierSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024OutlierSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToOutlierSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024OutlierSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

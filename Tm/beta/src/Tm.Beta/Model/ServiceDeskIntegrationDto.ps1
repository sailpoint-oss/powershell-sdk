...
function Initialize-BetaServiceDeskIntegrationDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaServiceDeskIntegrationDto' | Write-Debug
...
function ConvertFrom-BetaJsonToServiceDeskIntegrationDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaServiceDeskIntegrationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024IdentityCertified {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityCertified' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityCertified {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityCertified' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-VendorConnectorMappingDeletedBy {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => VendorConnectorMappingDeletedBy' | Write-Debug
...
function ConvertFrom-JsonToVendorConnectorMappingDeletedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => VendorConnectorMappingDeletedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

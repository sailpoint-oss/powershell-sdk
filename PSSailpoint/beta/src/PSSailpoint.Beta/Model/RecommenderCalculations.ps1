...
function Initialize-BetaRecommenderCalculations {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRecommenderCalculations' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommenderCalculations {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRecommenderCalculations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

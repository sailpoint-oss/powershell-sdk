...
function Initialize-Roleminingpotentialroleexportrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingpotentialroleexportrequest' | Write-Debug
...
Roleminingpotentialroleexportrequest<PSCustomObject>
#>
function ConvertFrom-JsonToRoleminingpotentialroleexportrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingpotentialroleexportrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleminingpotentialroleexportrequest

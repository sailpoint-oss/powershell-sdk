...
keywords: ['powershell', 'PowerShell', 'sdk', 'SearchAggregationSpecification', 'V2026SearchAggregationSpecification'] 
slug: /tools/sdk/powershell/v2026/models/search-aggregation-specification
...
```powershell
$SearchAggregationSpecification = Initialize-V2026SearchAggregationSpecification  -Nested null `
 -Metric null `
 -VarFilter null `
 -Bucket null `
 -SubAggregation null

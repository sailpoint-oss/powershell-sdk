...
function Initialize-V2024ConditionRule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConditionRule' | Write-Debug
...
function ConvertFrom-V2024JsonToConditionRule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConditionRule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

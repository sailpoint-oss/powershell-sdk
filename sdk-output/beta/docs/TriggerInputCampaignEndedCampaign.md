...
```powershell
$TriggerInputCampaignEndedCampaign = Initialize-PSSailpointBetaTriggerInputCampaignEndedCampaign  -Id 2c91808576f886190176f88cac5a0010 `
...
```powershell
$TriggerInputCampaignEndedCampaign | ConvertTo-JSON
```

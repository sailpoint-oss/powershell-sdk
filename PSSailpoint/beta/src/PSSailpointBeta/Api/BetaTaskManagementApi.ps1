...
None
#>
function Get-BetaPendingTaskHeaders {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-BetaPendingTaskHeaders' | Write-Debug
...
function Get-BetaPendingTasks {
    ...
    Process {
        'Calling method: Get-BetaPendingTasks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-BetaTaskStatus {
    ...
    Process {
        'Calling method: Get-BetaTaskStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-BetaTaskStatusList {
    ...
    Process {
        'Calling method: Get-BetaTaskStatusList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaskStatus
#>
function Update-BetaTaskStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-BetaTaskStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

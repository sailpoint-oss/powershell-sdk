...
function Initialize-IdentityProfileExportedObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityProfileExportedObject' | Write-Debug
...
function ConvertFrom-JsonToIdentityProfileExportedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityProfileExportedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

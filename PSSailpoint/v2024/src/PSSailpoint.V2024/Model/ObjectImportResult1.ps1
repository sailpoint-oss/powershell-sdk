...
function Initialize-V2024ObjectImportResult1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ObjectImportResult1' | Write-Debug
...
ObjectImportResult1<PSCustomObject>
#>
function ConvertFrom-V2024JsonToObjectImportResult1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ObjectImportResult1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ObjectImportResult1

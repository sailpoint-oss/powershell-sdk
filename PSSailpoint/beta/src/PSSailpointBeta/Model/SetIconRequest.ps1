...
function Initialize-BetaSetIconRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSetIconRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToSetIconRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSetIconRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

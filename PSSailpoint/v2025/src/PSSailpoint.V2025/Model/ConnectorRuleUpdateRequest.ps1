...
function Initialize-V2025ConnectorRuleUpdateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ConnectorRuleUpdateRequest' | Write-Debug
...
ConnectorRuleUpdateRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToConnectorRuleUpdateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ConnectorRuleUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ConnectorRuleUpdateRequest

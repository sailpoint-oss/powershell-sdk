#
# Module manifest for module 'PSSailpoint.AccessRequestApprovalsV1'
#
...
RootModule = 'PSSailpoint.AccessRequestApprovalsV1.psm1'
...
Description = 'PSSailpoint.AccessRequestApprovalsV1 - the PowerShell module for Identity Security Cloud API - Access Request Approvals'

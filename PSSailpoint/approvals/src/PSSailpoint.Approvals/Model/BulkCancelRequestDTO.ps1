...
function Initialize-BulkCancelRequestDTO {
    [CmdletBinding()]
    Param (
...
BulkCancelRequestDTO<PSCustomObject>
#>
function ConvertFrom-JsonToBulkCancelRequestDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in BulkCancelRequestDTO

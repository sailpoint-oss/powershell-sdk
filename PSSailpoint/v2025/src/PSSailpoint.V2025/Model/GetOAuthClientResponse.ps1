...
function Initialize-V2025GetOAuthClientResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025GetOAuthClientResponse' | Write-Debug
...
GetOAuthClientResponse<PSCustomObject>
#>
function ConvertFrom-V2025JsonToGetOAuthClientResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025GetOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025GetOAuthClientResponse

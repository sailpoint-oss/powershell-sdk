...
function Initialize-Errorbody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Intelligence => Errorbody' | Write-Debug
...
function ConvertFrom-JsonToErrorbody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Intelligence => Errorbody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

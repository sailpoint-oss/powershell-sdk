...
function Initialize-SourceappAccountSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AppsV1 => SourceappAccountSource' | Write-Debug
...
SourceappAccountSource<PSCustomObject>
#>
function ConvertFrom-JsonToSourceappAccountSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AppsV1 => SourceappAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SourceappAccountSource

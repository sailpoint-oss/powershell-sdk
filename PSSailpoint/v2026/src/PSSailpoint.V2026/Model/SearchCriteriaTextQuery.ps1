...
function Initialize-V2026SearchCriteriaTextQuery {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SearchCriteriaTextQuery' | Write-Debug
...
SearchCriteriaTextQuery<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSearchCriteriaTextQuery {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SearchCriteriaTextQuery' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SearchCriteriaTextQuery

...
function Initialize-V2024SelfImportExportDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SelfImportExportDto' | Write-Debug
...
function ConvertFrom-V2024JsonToSelfImportExportDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SelfImportExportDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

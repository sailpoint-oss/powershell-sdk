...
function New-V2026DataSegment {
    ...
    Process {
        'Calling method: New-V2026DataSegment' | Write-Debug
...
None
#>
function Remove-V2026DataSegment {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026DataSegment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026DataSegment {
    ...
    Process {
        'Calling method: Get-V2026DataSegment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026DataSegmentIdentityMembership {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026DataSegmentIdentityMembership' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Boolean
#>
function Get-V2026DataSegmentationEnabledForUser {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026DataSegmentationEnabledForUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
DataSegment[]
#>
function Get-V2026DataSegments {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026DataSegments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
DataSegment
#>
function Update-V2026DataSegment {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026DataSegment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Publish-V2026DataSegment {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Publish-V2026DataSegment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

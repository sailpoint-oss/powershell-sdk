...
function Initialize-V2024ConnectorRuleUpdateRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ConnectorRuleUpdateRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToConnectorRuleUpdateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ConnectorRuleUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

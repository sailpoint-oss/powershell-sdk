...
function Initialize-NonEmployeeRequestBody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeRequestBody' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeRequestBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeRequestBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

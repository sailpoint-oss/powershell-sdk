...
function Initialize-V2025WorkflowTrigger {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025WorkflowTrigger' | Write-Debug
...
WorkflowTrigger<PSCustomObject>
#>
function ConvertFrom-V2025JsonToWorkflowTrigger {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025WorkflowTrigger' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025WorkflowTrigger

...
function Initialize-V2024CreateOAuthClientResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CreateOAuthClientResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateOAuthClientResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CreateOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaRoleMiningPotentialRoleApplication {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleApplication' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleApplication {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaIdentityExceptionReportReference1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityExceptionReportReference1' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityExceptionReportReference1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityExceptionReportReference1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

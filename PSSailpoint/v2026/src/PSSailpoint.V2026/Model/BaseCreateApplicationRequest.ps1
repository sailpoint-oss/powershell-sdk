...
function Initialize-V2026BaseCreateApplicationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026BaseCreateApplicationRequest' | Write-Debug
...
BaseCreateApplicationRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToBaseCreateApplicationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026BaseCreateApplicationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026BaseCreateApplicationRequest

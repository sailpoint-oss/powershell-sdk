...
#>
function Get-AuthOrgLockoutConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-AuthOrgLockoutConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-AuthOrgServiceProviderConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-AuthOrgServiceProviderConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-AuthOrgSessionConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-AuthOrgSessionConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LockoutConfiguration
#>
function Update-AuthOrgLockoutConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Update-AuthOrgLockoutConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceProviderConfiguration
#>
function Update-AuthOrgServiceProviderConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Update-AuthOrgServiceProviderConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SessionConfiguration
#>
function Update-AuthOrgSessionConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Update-AuthOrgSessionConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

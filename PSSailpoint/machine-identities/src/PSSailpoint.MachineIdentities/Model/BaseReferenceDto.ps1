...
function Initialize-BaseReferenceDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentities => BaseReferenceDto' | Write-Debug
...
function ConvertFrom-JsonToBaseReferenceDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentities => BaseReferenceDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

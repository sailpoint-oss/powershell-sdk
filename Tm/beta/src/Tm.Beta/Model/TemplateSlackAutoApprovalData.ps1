...
function Initialize-BetaTemplateSlackAutoApprovalData {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaTemplateSlackAutoApprovalData' | Write-Debug
...
function ConvertFrom-BetaJsonToTemplateSlackAutoApprovalData {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaTemplateSlackAutoApprovalData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaNonEmployeeRequestWithoutApprovalItem {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeRequestWithoutApprovalItem' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeRequestWithoutApprovalItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeRequestWithoutApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

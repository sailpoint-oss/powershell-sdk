...
function Initialize-V2024VAClusterStatusChangeEventHealthCheckResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024VAClusterStatusChangeEventHealthCheckResult' | Write-Debug
...
function ConvertFrom-V2024JsonToVAClusterStatusChangeEventHealthCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024VAClusterStatusChangeEventHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

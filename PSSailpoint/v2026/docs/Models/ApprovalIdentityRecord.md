...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalIdentityRecord', 'V2026ApprovalIdentityRecord'] 
slug: /tools/sdk/powershell/v2026/models/approval-identity-record
...
```powershell
$ApprovalIdentityRecord = Initialize-V2026ApprovalIdentityRecord  -IdentityID 17e633e7d57e481569df76323169deb6a `
 -Type IDENTITY `
 -Name Jim Bob `
 -ActionedAs null `
 -Members null `

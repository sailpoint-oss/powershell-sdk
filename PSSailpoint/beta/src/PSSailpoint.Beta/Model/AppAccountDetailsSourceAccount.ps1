...
function Initialize-BetaAppAccountDetailsSourceAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAppAccountDetailsSourceAccount' | Write-Debug
...
AppAccountDetailsSourceAccount<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAppAccountDetailsSourceAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAppAccountDetailsSourceAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaAppAccountDetailsSourceAccount

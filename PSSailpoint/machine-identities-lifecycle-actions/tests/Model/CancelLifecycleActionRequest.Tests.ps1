...
Describe -tag 'PSSailpoint.MachineIdentitiesLifecycleActions' -name 'CancelLifecycleActionRequest' {
    Context 'CancelLifecycleActionRequest' {
        It 'Initialize-CancelLifecycleActionRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-CancelLifecycleActionRequest -Comment "TEST_VALUE"
            #$NewObject | Should -BeOfType CancelLifecycleActionRequest

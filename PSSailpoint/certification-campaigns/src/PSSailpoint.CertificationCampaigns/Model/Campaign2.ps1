...
Campaign2<PSCustomObject>
#>

function Initialize-Campaign2 {
    [CmdletBinding()]
    Param (
...
Convert from JSON to Campaign2<PSCustomObject>
...
Campaign2<PSCustomObject>
#>
function ConvertFrom-JsonToCampaign2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Campaign2

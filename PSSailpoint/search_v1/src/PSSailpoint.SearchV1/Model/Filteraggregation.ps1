...
function Initialize-Filteraggregation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => Filteraggregation' | Write-Debug
...
Filteraggregation<PSCustomObject>
#>
function ConvertFrom-JsonToFilteraggregation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => Filteraggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Filteraggregation

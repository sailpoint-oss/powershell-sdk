...
function Initialize-V2026OutlierContributingFeature {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026OutlierContributingFeature' | Write-Debug
...
OutlierContributingFeature<PSCustomObject>
#>
function ConvertFrom-V2026JsonToOutlierContributingFeature {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026OutlierContributingFeature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026OutlierContributingFeature

...
function Initialize-Applicationcrawlersettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DataAccessSecurityV1 => Applicationcrawlersettings' | Write-Debug
...
Applicationcrawlersettings<PSCustomObject>
#>
function ConvertFrom-JsonToApplicationcrawlersettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DataAccessSecurityV1 => Applicationcrawlersettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Applicationcrawlersettings

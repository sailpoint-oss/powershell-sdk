...
function Initialize-V2026ClientLogConfigurationExpiration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ClientLogConfigurationExpiration' | Write-Debug
...
ClientLogConfigurationExpiration<PSCustomObject>
#>
function ConvertFrom-V2026JsonToClientLogConfigurationExpiration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ClientLogConfigurationExpiration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ClientLogConfigurationExpiration

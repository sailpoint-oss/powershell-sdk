...
function Initialize-BetaIdentityAttributeTransform {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityAttributeTransform' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributeTransform {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityAttributeTransform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

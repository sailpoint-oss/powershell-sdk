...
function Initialize-Appaccessprofileselector {
    [CmdletBinding()]
    Param (
...
Appaccessprofileselector<PSCustomObject>
#>
function ConvertFrom-JsonToAppaccessprofileselector {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Appaccessprofileselector

...
function Initialize-ApprovalForwardHistory {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ApprovalForwardHistory' | Write-Debug
...
function ConvertFrom-JsonToApprovalForwardHistory {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ApprovalForwardHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

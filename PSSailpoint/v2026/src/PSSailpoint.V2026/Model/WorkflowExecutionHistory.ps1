...
function Initialize-V2026WorkflowExecutionHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026WorkflowExecutionHistory' | Write-Debug
...
WorkflowExecutionHistory<PSCustomObject>
#>
function ConvertFrom-V2026JsonToWorkflowExecutionHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026WorkflowExecutionHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026WorkflowExecutionHistory

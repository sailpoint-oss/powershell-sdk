...
AccessSummary[]
#>
function Get-V2024IdentityAccessSummaries {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2024IdentityAccessSummaries' | Write-Debug
...
#>
function Get-V2024IdentityDecisionSummary {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024IdentityDecisionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2024IdentitySummaries {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024IdentitySummaries' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CertificationIdentitySummary
#>
function Get-V2024IdentitySummary {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024IdentitySummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

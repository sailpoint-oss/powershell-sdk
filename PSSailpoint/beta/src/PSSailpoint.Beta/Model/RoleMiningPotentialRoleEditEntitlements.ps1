...
function Initialize-BetaRoleMiningPotentialRoleEditEntitlements {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRoleEditEntitlements' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleEditEntitlements {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRoleEditEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

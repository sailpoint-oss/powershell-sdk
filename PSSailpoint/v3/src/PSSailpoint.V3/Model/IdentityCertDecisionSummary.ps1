...
function Initialize-IdentityCertDecisionSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityCertDecisionSummary' | Write-Debug
...
function ConvertFrom-JsonToIdentityCertDecisionSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityCertDecisionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

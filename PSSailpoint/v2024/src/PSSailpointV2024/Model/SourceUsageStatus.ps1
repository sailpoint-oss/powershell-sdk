...
function Initialize-V2024SourceUsageStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SourceUsageStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceUsageStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SourceUsageStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ManagedClusterRequest', 'V2026ManagedClusterRequest'] 
slug: /tools/sdk/powershell/v2026/models/managed-cluster-request
...
```powershell
$ManagedClusterRequest = Initialize-V2026ManagedClusterRequest  -Name Managed Cluster Name `
 -Type null `

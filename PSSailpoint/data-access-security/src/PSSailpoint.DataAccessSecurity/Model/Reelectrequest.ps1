...
function Initialize-Reelectrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DataAccessSecurityV1 => Reelectrequest' | Write-Debug
...
Reelectrequest<PSCustomObject>
#>
function ConvertFrom-JsonToReelectrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DataAccessSecurityV1 => Reelectrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Reelectrequest

...
function Initialize-VendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => VendorConnectorMappingUpdatedBy' | Write-Debug
...
function ConvertFrom-JsonToVendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => VendorConnectorMappingUpdatedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

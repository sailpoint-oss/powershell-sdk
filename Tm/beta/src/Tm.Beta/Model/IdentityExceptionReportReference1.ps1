...
function Initialize-BetaIdentityExceptionReportReference1 {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityExceptionReportReference1' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityExceptionReportReference1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityExceptionReportReference1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

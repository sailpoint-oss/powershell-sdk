...
TransformAllOf<PSCustomObject>
#>

function Initialize-BetaTransformAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTransformAllOf' | Write-Debug
...
Convert from JSON to TransformAllOf<PSCustomObject>
...
TransformAllOf<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTransformAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTransformAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTransformAllOf

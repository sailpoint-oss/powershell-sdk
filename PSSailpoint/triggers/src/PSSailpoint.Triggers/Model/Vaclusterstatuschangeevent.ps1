...
function Initialize-Vaclusterstatuschangeevent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Vaclusterstatuschangeevent' | Write-Debug
...
Vaclusterstatuschangeevent<PSCustomObject>
#>
function ConvertFrom-JsonToVaclusterstatuschangeevent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Vaclusterstatuschangeevent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Vaclusterstatuschangeevent

...
SetAttributesAction<PSCustomObject>
#>

function Initialize-NERMSetAttributesAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMSetAttributesAction' | Write-Debug
...
Convert from JSON to SetAttributesAction<PSCustomObject>
...
SetAttributesAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToSetAttributesAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMSetAttributesAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMSetAttributesAction

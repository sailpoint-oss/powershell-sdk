...
function Initialize-BetaVendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaVendorConnectorMappingUpdatedBy' | Write-Debug
...
function ConvertFrom-BetaJsonToVendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaVendorConnectorMappingUpdatedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

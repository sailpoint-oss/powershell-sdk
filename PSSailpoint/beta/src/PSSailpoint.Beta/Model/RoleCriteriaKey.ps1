...
function Initialize-BetaRoleCriteriaKey {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleCriteriaKey' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleCriteriaKey {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleCriteriaKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

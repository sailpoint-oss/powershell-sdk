...
TriggerInputSourceAccountDeleted<PSCustomObject>
#>

function Initialize-BetaTriggerInputSourceAccountDeleted {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceAccountDeleted' | Write-Debug
...
Convert from JSON to TriggerInputSourceAccountDeleted<PSCustomObject>
...
TriggerInputSourceAccountDeleted<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputSourceAccountDeleted {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputSourceAccountDeleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputSourceAccountDeleted

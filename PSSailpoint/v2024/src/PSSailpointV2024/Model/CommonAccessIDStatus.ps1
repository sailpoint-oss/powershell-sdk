...
function Initialize-V2024CommonAccessIDStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CommonAccessIDStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToCommonAccessIDStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CommonAccessIDStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

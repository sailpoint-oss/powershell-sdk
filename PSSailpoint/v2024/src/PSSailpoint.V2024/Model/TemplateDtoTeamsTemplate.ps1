...
function Initialize-V2024TemplateDtoTeamsTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TemplateDtoTeamsTemplate' | Write-Debug
...
TemplateDtoTeamsTemplate<PSCustomObject>
#>
function ConvertFrom-V2024JsonToTemplateDtoTeamsTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TemplateDtoTeamsTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024TemplateDtoTeamsTemplate

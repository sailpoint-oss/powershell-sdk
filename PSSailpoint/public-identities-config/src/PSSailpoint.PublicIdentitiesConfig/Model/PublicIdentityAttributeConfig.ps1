...
function Initialize-PublicIdentityAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PublicIdentitiesConfig => PublicIdentityAttributeConfig' | Write-Debug
...
function ConvertFrom-JsonToPublicIdentityAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PublicIdentitiesConfig => PublicIdentityAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
#>
function ConvertFrom-V2024JsonToDateCompareFirstDate {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'AccountAttribute' defined in oneOf (V2024DateCompareFirstDate). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'DateFormat' defined in oneOf (V2024DateCompareFirstDate). Proceeding to the next one if any."
        }

...
function Initialize-BetaIdentityHistoryResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityHistoryResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityHistoryResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityHistoryResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

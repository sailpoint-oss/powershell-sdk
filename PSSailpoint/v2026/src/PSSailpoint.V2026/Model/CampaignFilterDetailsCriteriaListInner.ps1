...
function Initialize-V2026CampaignFilterDetailsCriteriaListInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CampaignFilterDetailsCriteriaListInner' | Write-Debug
...
CampaignFilterDetailsCriteriaListInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCampaignFilterDetailsCriteriaListInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CampaignFilterDetailsCriteriaListInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CampaignFilterDetailsCriteriaListInner

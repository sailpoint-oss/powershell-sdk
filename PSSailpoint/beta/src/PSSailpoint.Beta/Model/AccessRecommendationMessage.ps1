...
function Initialize-BetaAccessRecommendationMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRecommendationMessage' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRecommendationMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRecommendationMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-TaskResultDetailsMessagesInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => TaskResultDetailsMessagesInner' | Write-Debug
...
function ConvertFrom-JsonToTaskResultDetailsMessagesInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => TaskResultDetailsMessagesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026CompleteInvocationInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CompleteInvocationInput' | Write-Debug
...
CompleteInvocationInput<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCompleteInvocationInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CompleteInvocationInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CompleteInvocationInput

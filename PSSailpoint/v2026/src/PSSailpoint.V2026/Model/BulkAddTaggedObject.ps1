...
function Initialize-V2026BulkAddTaggedObject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026BulkAddTaggedObject' | Write-Debug
...
BulkAddTaggedObject<PSCustomObject>
#>
function ConvertFrom-V2026JsonToBulkAddTaggedObject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026BulkAddTaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026BulkAddTaggedObject

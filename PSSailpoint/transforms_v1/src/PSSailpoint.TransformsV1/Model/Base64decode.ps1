...
Base64decode<PSCustomObject>
#>

function Initialize-Base64decode {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Base64decode' | Write-Debug
...
Convert from JSON to Base64decode<PSCustomObject>
...
Base64decode<PSCustomObject>
#>
function ConvertFrom-JsonToBase64decode {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Base64decode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Base64decode

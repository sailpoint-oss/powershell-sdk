...
keywords: ['powershell', 'PowerShell', 'sdk', 'DataSegmentation', 'V2026DataSegmentation'] 
slug: /tools/sdk/powershell/v2026/methods/data-segmentation
...
------------- | ------------- | -------------
[**New-V2026DataSegment**](#create-data-segment) | **POST** `/data-segments` | Create segment
[**Remove-V2026DataSegment**](#delete-data-segment) | **DELETE** `/data-segments/{segmentId}` | Delete segment by id
[**Get-V2026DataSegment**](#get-data-segment) | **GET** `/data-segments/{segmentId}` | Get segment by id
[**Get-V2026DataSegmentIdentityMembership**](#get-data-segment-identity-membership) | **GET** `/data-segments/membership/{identityId}` | Get segmentmembership by identity id
[**Get-V2026DataSegmentationEnabledForUser**](#get-data-segmentation-enabled-for-user) | **GET** `/data-segments/user-enabled/{identityId}` | Is segmentation enabled by identity
[**Get-V2026DataSegments**](#list-data-segments) | **GET** `/data-segments` | Get segments
[**Update-V2026DataSegment**](#patch-data-segment) | **PATCH** `/data-segments/{segmentId}` | Update segment
[**Publish-V2026DataSegment**](#publish-data-segment) | **POST** `/data-segments/{segmentId}` | Publish segment by id
...
try {
    $Result = ConvertFrom-V2026JsonToDataSegment -Json $DataSegment
    New-V2026DataSegment -DataSegment $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026DataSegment -DataSegment $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026DataSegment"
...
try {
    Remove-V2026DataSegment -Id $Id -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026DataSegment -Id $Id -XSailPointExperimental $XSailPointExperimental -Published $Published  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026DataSegment"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026DataSegment -Id $Id -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026DataSegment -Id $Id -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026DataSegment"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026DataSegmentIdentityMembership -IdentityId $IdentityId -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026DataSegmentIdentityMembership -IdentityId $IdentityId -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026DataSegmentIdentityMembership"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026DataSegmentationEnabledForUser -IdentityId $IdentityId -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026DataSegmentationEnabledForUser -IdentityId $IdentityId -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026DataSegmentationEnabledForUser"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026DataSegments -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026DataSegments -XSailPointExperimental $XSailPointExperimental -Enabled $Enabled -Unique $Unique -Published $Published -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026DataSegments"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026DataSegment -Id $Id -XSailPointExperimental $XSailPointExperimental -RequestBody $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026DataSegment -Id $Id -XSailPointExperimental $XSailPointExperimental -RequestBody $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026DataSegment"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToRequestBody -Json $RequestBody
    Publish-V2026DataSegment -XSailPointExperimental $XSailPointExperimental -RequestBody $Result 
    
    # Below is a request that includes all optional parameters
    # Publish-V2026DataSegment -XSailPointExperimental $XSailPointExperimental -RequestBody $Result -PublishAll $PublishAll  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Publish-V2026DataSegment"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

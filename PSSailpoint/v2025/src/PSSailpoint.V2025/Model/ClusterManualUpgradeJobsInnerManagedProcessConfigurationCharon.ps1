...
function Initialize-V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon<PSCustomObject>
#>
function ConvertFrom-V2025JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationCharon

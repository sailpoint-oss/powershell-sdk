...
function Initialize-V2024CampaignAllOfRoleCompositionCampaignInfoRemediatorRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CampaignAllOfRoleCompositionCampaignInfoRemediatorRef' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignAllOfRoleCompositionCampaignInfoRemediatorRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CampaignAllOfRoleCompositionCampaignInfoRemediatorRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024CampaignAllOfRoleCompositionCampaignInfoRemediatorRef

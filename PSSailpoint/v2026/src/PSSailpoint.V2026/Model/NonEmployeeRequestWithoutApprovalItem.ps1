...
function Initialize-V2026NonEmployeeRequestWithoutApprovalItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeRequestWithoutApprovalItem' | Write-Debug
...
NonEmployeeRequestWithoutApprovalItem<PSCustomObject>
#>
function ConvertFrom-V2026JsonToNonEmployeeRequestWithoutApprovalItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeRequestWithoutApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026NonEmployeeRequestWithoutApprovalItem

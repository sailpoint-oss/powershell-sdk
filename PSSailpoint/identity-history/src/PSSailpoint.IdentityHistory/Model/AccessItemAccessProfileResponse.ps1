...
function Initialize-AccessItemAccessProfileResponse {
    [CmdletBinding()]
    Param (
...
AccessItemAccessProfileResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAccessItemAccessProfileResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccessItemAccessProfileResponse

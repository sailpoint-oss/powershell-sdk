...
function Initialize-V2024PublicIdentityAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024PublicIdentityAttributeConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToPublicIdentityAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024PublicIdentityAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

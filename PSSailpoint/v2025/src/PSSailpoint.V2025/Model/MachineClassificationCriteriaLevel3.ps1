...
function Initialize-V2025MachineClassificationCriteriaLevel3 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025MachineClassificationCriteriaLevel3' | Write-Debug
...
MachineClassificationCriteriaLevel3<PSCustomObject>
#>
function ConvertFrom-V2025JsonToMachineClassificationCriteriaLevel3 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025MachineClassificationCriteriaLevel3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025MachineClassificationCriteriaLevel3

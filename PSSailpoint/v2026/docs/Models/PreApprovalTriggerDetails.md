...
keywords: ['powershell', 'PowerShell', 'sdk', 'PreApprovalTriggerDetails', 'V2026PreApprovalTriggerDetails'] 
slug: /tools/sdk/powershell/v2026/models/pre-approval-trigger-details
...
```powershell
$PreApprovalTriggerDetails = Initialize-V2026PreApprovalTriggerDetails  -Comment Access is Approved `
 -Reviewer John Doe `
 -Decision APPROVED
```

...
function Initialize-V2025RoleInsightsEntitlementChanges {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleInsightsEntitlementChanges' | Write-Debug
...
RoleInsightsEntitlementChanges<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleInsightsEntitlementChanges {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleInsightsEntitlementChanges' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleInsightsEntitlementChanges

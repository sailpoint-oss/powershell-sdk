...
function Initialize-V2024Subscription {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Subscription' | Write-Debug
...
function ConvertFrom-V2024JsonToSubscription {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Subscription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

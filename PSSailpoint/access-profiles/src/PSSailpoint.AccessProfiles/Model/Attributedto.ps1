...
function Initialize-Attributedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfilesV1 => Attributedto' | Write-Debug
...
function ConvertFrom-JsonToAttributedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfilesV1 => Attributedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Entitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Entitlements => Entitlement' | Write-Debug
...
function ConvertFrom-JsonToEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Entitlements => Entitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

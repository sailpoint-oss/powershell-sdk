...
function Initialize-V2024RecommendationConfigDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RecommendationConfigDto' | Write-Debug
...
function ConvertFrom-V2024JsonToRecommendationConfigDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RecommendationConfigDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

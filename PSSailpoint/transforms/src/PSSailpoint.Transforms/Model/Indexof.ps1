...
function Initialize-Indexof {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Indexof' | Write-Debug
...
Indexof<PSCustomObject>
#>
function ConvertFrom-JsonToIndexof {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Indexof' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Indexof

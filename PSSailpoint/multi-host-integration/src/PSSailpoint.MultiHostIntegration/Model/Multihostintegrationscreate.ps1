...
function Initialize-Multihostintegrationscreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MultiHostIntegrationV1 => Multihostintegrationscreate' | Write-Debug
...
Multihostintegrationscreate<PSCustomObject>
#>
function ConvertFrom-JsonToMultihostintegrationscreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MultiHostIntegrationV1 => Multihostintegrationscreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Multihostintegrationscreate

...
NonEmployeeRequestWithoutApprovalItemAllOf<PSCustomObject>
#>

function Initialize-BetaNonEmployeeRequestWithoutApprovalItemAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaNonEmployeeRequestWithoutApprovalItemAllOf' | Write-Debug
...
Convert from JSON to NonEmployeeRequestWithoutApprovalItemAllOf<PSCustomObject>
...
NonEmployeeRequestWithoutApprovalItemAllOf<PSCustomObject>
#>
function ConvertFrom-BetaJsonToNonEmployeeRequestWithoutApprovalItemAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaNonEmployeeRequestWithoutApprovalItemAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaNonEmployeeRequestWithoutApprovalItemAllOf
        $AllProperties = ("accountName", "firstName", "lastName", "email", "phone", "manager", "nonEmployeeSource", "data", "approvalStatus", "comment", "completionDate", "startDate", "endDate", "modified", "created")

...
keywords: ['powershell', 'PowerShell', 'sdk', 'NonEmployeeSchemaAttributeBody', 'V2026NonEmployeeSchemaAttributeBody'] 
slug: /tools/sdk/powershell/v2026/models/non-employee-schema-attribute-body
...
```powershell
$NonEmployeeSchemaAttributeBody = Initialize-V2026NonEmployeeSchemaAttributeBody  -Type TEXT `
 -Label Account Name `

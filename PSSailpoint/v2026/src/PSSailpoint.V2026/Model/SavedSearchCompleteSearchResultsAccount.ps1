...
function Initialize-V2026SavedSearchCompleteSearchResultsAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SavedSearchCompleteSearchResultsAccount' | Write-Debug
...
SavedSearchCompleteSearchResultsAccount<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSavedSearchCompleteSearchResultsAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SavedSearchCompleteSearchResultsAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SavedSearchCompleteSearchResultsAccount

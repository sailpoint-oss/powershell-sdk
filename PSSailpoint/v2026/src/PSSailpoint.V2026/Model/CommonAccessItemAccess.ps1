...
function Initialize-V2026CommonAccessItemAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CommonAccessItemAccess' | Write-Debug
...
CommonAccessItemAccess<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCommonAccessItemAccess {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CommonAccessItemAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CommonAccessItemAccess

...
#>
function New-V2026ConnectorCustomizer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026ConnectorCustomizer' | Write-Debug
...
#>
function New-V2026ConnectorCustomizerVersion {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: New-V2026ConnectorCustomizerVersion' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-V2026ConnectorCustomizer {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026ConnectorCustomizer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026ConnectorCustomizer {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ConnectorCustomizer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConnectorCustomizersResponse[]
#>
function Get-V2026ConnectorCustomizers {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026ConnectorCustomizers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Send-V2026ConnectorCustomizer {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2026ConnectorCustomizer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

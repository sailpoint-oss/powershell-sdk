...
function Initialize-RequestedItemStatusSodViolationContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RequestedItemStatusSodViolationContext' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemStatusSodViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RequestedItemStatusSodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccessRequestPostApprovalRequestedItemsStatusInnerApprovalInfoInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

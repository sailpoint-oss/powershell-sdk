...
function Initialize-Concatenation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Concatenation' | Write-Debug
...
function ConvertFrom-JsonToConcatenation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Concatenation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

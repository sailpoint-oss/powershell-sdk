...
function Initialize-Outlierscontributingfeatureaccessitems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiOutliersV1 => Outlierscontributingfeatureaccessitems' | Write-Debug
...
Outlierscontributingfeatureaccessitems<PSCustomObject>
#>
function ConvertFrom-JsonToOutlierscontributingfeatureaccessitems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiOutliersV1 => Outlierscontributingfeatureaccessitems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Outlierscontributingfeatureaccessitems

...
function Initialize-V2024AccessRequestPostApproval {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequestPostApproval' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestPostApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequestPostApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaPasswordDigitTokenReset {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaPasswordDigitTokenReset' | Write-Debug
...
function ConvertFrom-BetaJsonToPasswordDigitTokenReset {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaPasswordDigitTokenReset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

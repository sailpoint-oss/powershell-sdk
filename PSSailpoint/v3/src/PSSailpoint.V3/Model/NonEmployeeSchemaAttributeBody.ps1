...
function Initialize-NonEmployeeSchemaAttributeBody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeSchemaAttributeBody' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSchemaAttributeBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeSchemaAttributeBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

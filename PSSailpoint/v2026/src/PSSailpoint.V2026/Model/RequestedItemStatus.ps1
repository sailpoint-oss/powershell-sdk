...
function Initialize-V2026RequestedItemStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemStatus' | Write-Debug
...
RequestedItemStatus<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRequestedItemStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

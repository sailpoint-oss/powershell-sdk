...
function Initialize-AccountattributeschangedIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => AccountattributeschangedIdentity' | Write-Debug
...
AccountattributeschangedIdentity<PSCustomObject>
#>
function ConvertFrom-JsonToAccountattributeschangedIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => AccountattributeschangedIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountattributeschangedIdentity

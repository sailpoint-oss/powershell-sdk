...
function Initialize-Accessitementitlementresponse {
    [CmdletBinding()]
    Param (
...
Accessitementitlementresponse<PSCustomObject>
#>
function ConvertFrom-JsonToAccessitementitlementresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Accessitementitlementresponse

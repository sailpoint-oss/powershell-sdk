...
#>
function ConvertFrom-V2024JsonToTaskStatusMessageParametersInner {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -eq 0) { # no match yet
            ...
            try {
                ...
                Write-Debug "Failed to match 'String' defined in anyOf (V2024TaskStatusMessageParametersInner). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -eq 0) { # no match yet
            ...
            try {
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'SystemCollectionsHashtable' defined in anyOf (V2024TaskStatusMessageParametersInner). Proceeding to the next one if any."
            }
        }

...
function Initialize-NonEmployeeRequestWithoutApprovalItemAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeRequestWithoutApprovalItemAllOf' | Write-Debug
...
NonEmployeeRequestWithoutApprovalItemAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToNonEmployeeRequestWithoutApprovalItemAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeRequestWithoutApprovalItemAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NonEmployeeRequestWithoutApprovalItemAllOf

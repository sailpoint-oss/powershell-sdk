...
function Initialize-V2024CompleteInvocationInput {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CompleteInvocationInput' | Write-Debug
...
function ConvertFrom-V2024JsonToCompleteInvocationInput {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CompleteInvocationInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

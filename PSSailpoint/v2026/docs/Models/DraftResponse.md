...
keywords: ['powershell', 'PowerShell', 'sdk', 'DraftResponse', 'V2026DraftResponse'] 
slug: /tools/sdk/powershell/v2026/models/draft-response
...
```powershell
$DraftResponse = Initialize-V2026DraftResponse  -JobId 07659d7d-2cce-47c0-9e49-185787ee565a `
 -Status COMPLETE `
 -Type CREATE_DRAFT `

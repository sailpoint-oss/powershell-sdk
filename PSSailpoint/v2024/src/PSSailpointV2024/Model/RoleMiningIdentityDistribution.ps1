...
function Initialize-V2024RoleMiningIdentityDistribution {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleMiningIdentityDistribution' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningIdentityDistribution {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleMiningIdentityDistribution' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

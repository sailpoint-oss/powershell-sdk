#
# Module manifest for module 'PSSailpoint.ConnectorsV1'
#
...
RootModule = 'PSSailpoint.ConnectorsV1.psm1'
...
Description = 'PSSailpoint.ConnectorsV1 - the PowerShell module for Identity Security Cloud API - Connectors'

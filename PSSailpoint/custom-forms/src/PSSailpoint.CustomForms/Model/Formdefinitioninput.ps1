...
function Initialize-Formdefinitioninput {
    [CmdletBinding()]
    Param (
...
Formdefinitioninput<PSCustomObject>
#>
function ConvertFrom-JsonToFormdefinitioninput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Formdefinitioninput

...
function Initialize-V2024EntitlementRequestConfig1 {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024EntitlementRequestConfig1' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlementRequestConfig1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024EntitlementRequestConfig1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

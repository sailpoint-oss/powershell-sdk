...
function Initialize-V2026AssignResourceOwnerRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AssignResourceOwnerRequest' | Write-Debug
...
AssignResourceOwnerRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAssignResourceOwnerRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AssignResourceOwnerRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AssignResourceOwnerRequest

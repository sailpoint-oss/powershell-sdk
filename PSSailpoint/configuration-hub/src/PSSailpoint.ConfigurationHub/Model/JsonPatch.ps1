...
function Initialize-JsonPatch {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ConfigurationHub => JsonPatch' | Write-Debug
...
function ConvertFrom-JsonToJsonPatch {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ConfigurationHub => JsonPatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

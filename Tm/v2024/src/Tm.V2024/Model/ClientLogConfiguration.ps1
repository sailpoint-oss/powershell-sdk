...
function Initialize-V2024ClientLogConfiguration {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ClientLogConfiguration' | Write-Debug
...
function ConvertFrom-V2024JsonToClientLogConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ClientLogConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

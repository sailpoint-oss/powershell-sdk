...
AccountActivity
#>
function Get-V2026AccountActivity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2026AccountActivity' | Write-Debug
...
AccountActivity[]
#>
function Get-V2026AccountActivities {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026AccountActivities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

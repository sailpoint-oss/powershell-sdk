...
function Initialize-ProvisioningCriteriaLevel1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ProvisioningCriteriaLevel1' | Write-Debug
...
function ConvertFrom-JsonToProvisioningCriteriaLevel1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ProvisioningCriteriaLevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

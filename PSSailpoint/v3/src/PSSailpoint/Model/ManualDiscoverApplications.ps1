...
function Initialize-ManualDiscoverApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ManualDiscoverApplications' | Write-Debug
...
function ConvertFrom-JsonToManualDiscoverApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ManualDiscoverApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

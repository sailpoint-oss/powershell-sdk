...
function Initialize-V2024WorkgroupDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024WorkgroupDto' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkgroupDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024WorkgroupDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

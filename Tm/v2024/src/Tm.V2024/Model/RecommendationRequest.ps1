...
function Initialize-V2024RecommendationRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RecommendationRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToRecommendationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RecommendationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Correlatedgovernanceevent {
    [CmdletBinding()]
    Param (
...
Correlatedgovernanceevent<PSCustomObject>
#>
function ConvertFrom-JsonToCorrelatedgovernanceevent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Correlatedgovernanceevent

...
function Initialize-V2026ListCampaignFilters200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ListCampaignFilters200Response' | Write-Debug
...
ListCampaignFilters200Response<PSCustomObject>
#>
function ConvertFrom-V2026JsonToListCampaignFilters200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ListCampaignFilters200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ListCampaignFilters200Response

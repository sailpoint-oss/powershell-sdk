...
function Initialize-V2026AccessProfileBulkDeleteResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessProfileBulkDeleteResponse' | Write-Debug
...
AccessProfileBulkDeleteResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessProfileBulkDeleteResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessProfileBulkDeleteResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessProfileBulkDeleteResponse

...
function Initialize-BetaProvisioningConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaProvisioningConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaProvisioningConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024CreateFormDefinitionRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CreateFormDefinitionRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateFormDefinitionRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CreateFormDefinitionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Get-IdentityAccessSummariesV1 {
    ...
    Process {
        'Calling method: Get-IdentityAccessSummariesV1' | Write-Debug
        ...
        $LocalVarUri = '/certifications/v1/{id}/access-summaries/{type}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getIdentityAccessSummariesV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
        if (!$Type) {
            throw "Error! The required parameter `Type` missing when calling getIdentityAccessSummariesV1."
        }
...
function Get-IdentityDecisionSummaryV1 {
    ...
    Process {
        'Calling method: Get-IdentityDecisionSummaryV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/certifications/v1/{id}/decision-summary'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getIdentityDecisionSummaryV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-IdentitySummariesV1 {
    ...
    Process {
        'Calling method: Get-IdentitySummariesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/certifications/v1/{id}/identity-summaries'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getIdentitySummariesV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-IdentitySummaryV1 {
    ...
    Process {
        'Calling method: Get-IdentitySummaryV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/certifications/v1/{id}/identity-summaries/{identitySummaryId}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getIdentitySummaryV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
        if (!$IdentitySummaryId) {
            throw "Error! The required parameter `IdentitySummaryId` missing when calling getIdentitySummaryV1."
        }

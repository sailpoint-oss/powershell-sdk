...
function Initialize-V2024ApprovalSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'Schedule2', 'V2026Schedule2'] 
slug: /tools/sdk/powershell/v2026/models/schedule2
...
```powershell
$Schedule2 = Initialize-V2026Schedule2  -Type null `
 -Months null `
 -Days null `
 -Hours null `

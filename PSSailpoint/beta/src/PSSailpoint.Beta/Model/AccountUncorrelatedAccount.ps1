...
function Initialize-BetaAccountUncorrelatedAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountUncorrelatedAccount' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountUncorrelatedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountUncorrelatedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Invoke-V2ApiClient {
    ...
    'Calling method: Invoke-V2ApiClient' | Write-Debug
    $PSBoundParameters | Out-DebugParameter | Write-Debug

    $Configuration = Get-DefaultConfiguration
    $RequestUri = $Configuration["BaseUrl"] + "v2" + $Uri
    ...
    # Add Custom Header
    $HeaderParameters['X-SailPoint-SDK'] = "Powershell-1.0.3"
    $HeaderParameters['User-Agent'] = "OpenAPI-Generator/1.0.3/ps"

...
function Initialize-V2024CompletedApproval {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CompletedApproval' | Write-Debug
...
function ConvertFrom-V2024JsonToCompletedApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CompletedApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Accountaggregationstatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccountAggregationsV1 => Accountaggregationstatus' | Write-Debug
...
Accountaggregationstatus<PSCustomObject>
#>
function ConvertFrom-JsonToAccountaggregationstatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccountAggregationsV1 => Accountaggregationstatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accountaggregationstatus

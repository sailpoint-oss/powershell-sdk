...
function Initialize-V2024WorkflowExecutionEvent {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkflowExecutionEvent' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowExecutionEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkflowExecutionEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

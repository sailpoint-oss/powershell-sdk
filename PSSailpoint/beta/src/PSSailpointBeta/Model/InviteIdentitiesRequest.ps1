...
function Initialize-BetaInviteIdentitiesRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaInviteIdentitiesRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToInviteIdentitiesRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaInviteIdentitiesRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

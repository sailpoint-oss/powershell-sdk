...
function Initialize-Workgroupdeleteitem {
    [CmdletBinding()]
    Param (
...
Workgroupdeleteitem<PSCustomObject>
#>
function ConvertFrom-JsonToWorkgroupdeleteitem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Workgroupdeleteitem

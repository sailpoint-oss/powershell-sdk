...
function Initialize-BetaErrorMessageDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaErrorMessageDto' | Write-Debug
...
function ConvertFrom-BetaJsonToErrorMessageDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaErrorMessageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccountUnlockRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountUnlockRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountUnlockRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountUnlockRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

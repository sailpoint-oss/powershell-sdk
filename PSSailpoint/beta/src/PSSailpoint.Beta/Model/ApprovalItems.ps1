...
function Initialize-BetaApprovalItems {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalItems' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalItems {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

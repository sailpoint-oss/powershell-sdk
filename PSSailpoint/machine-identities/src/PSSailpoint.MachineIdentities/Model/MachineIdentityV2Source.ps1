...
MachineIdentityV2Source<PSCustomObject>
#>

function Initialize-MachineIdentityV2Source {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentities => MachineIdentityV2Source' | Write-Debug
...
Convert from JSON to MachineIdentityV2Source<PSCustomObject>
...
MachineIdentityV2Source<PSCustomObject>
#>
function ConvertFrom-JsonToMachineIdentityV2Source {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentities => MachineIdentityV2Source' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MachineIdentityV2Source

...
function Initialize-BetaSedBatchStats {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSedBatchStats' | Write-Debug
...
function ConvertFrom-BetaJsonToSedBatchStats {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSedBatchStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
#>
function Get-V2025PublicIdentityConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2025PublicIdentityConfig' | Write-Debug
...
PublicIdentityConfig
#>
function Update-V2025PublicIdentityConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Update-V2025PublicIdentityConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

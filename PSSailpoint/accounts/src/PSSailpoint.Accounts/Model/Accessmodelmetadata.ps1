...
function Initialize-Accessmodelmetadata {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Accounts => Accessmodelmetadata' | Write-Debug
...
function ConvertFrom-JsonToAccessmodelmetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Accounts => Accessmodelmetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

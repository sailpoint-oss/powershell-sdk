...
function Initialize-V2024ObjectMappingBulkCreateResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ObjectMappingBulkCreateResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToObjectMappingBulkCreateResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ObjectMappingBulkCreateResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

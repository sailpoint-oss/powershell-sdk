...
function Initialize-BetaSourceAppCreateDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSourceAppCreateDto' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceAppCreateDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSourceAppCreateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

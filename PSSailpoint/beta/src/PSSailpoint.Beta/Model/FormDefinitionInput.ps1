...
function Initialize-BetaFormDefinitionInput {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionInput' | Write-Debug
...
function ConvertFrom-BetaJsonToFormDefinitionInput {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

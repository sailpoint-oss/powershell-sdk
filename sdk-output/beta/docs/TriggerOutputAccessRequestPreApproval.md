...
```powershell
$TriggerOutputAccessRequestPreApproval = Initialize-PSSailpointBetaTriggerOutputAccessRequestPreApproval  -Approved false `
...
```powershell
$TriggerOutputAccessRequestPreApproval | ConvertTo-JSON
```

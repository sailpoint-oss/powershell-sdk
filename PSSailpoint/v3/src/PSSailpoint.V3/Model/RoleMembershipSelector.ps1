...
function Initialize-RoleMembershipSelector {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RoleMembershipSelector' | Write-Debug
...
function ConvertFrom-JsonToRoleMembershipSelector {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RoleMembershipSelector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

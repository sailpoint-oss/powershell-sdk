...
#>
function New-V2026CampaignFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026CampaignFilter' | Write-Debug
...
None
#>
function Remove-V2026CampaignFilters {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String[]]
    ...
    Process {
        'Calling method: Remove-V2026CampaignFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CampaignFilterDetails
#>
function Get-V2026CampaignFilterById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026CampaignFilterById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026CampaignFilters {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026CampaignFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CampaignFilterDetails
#>
function Update-V2026CampaignFilter {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026CampaignFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

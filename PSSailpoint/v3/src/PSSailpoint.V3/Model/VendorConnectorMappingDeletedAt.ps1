...
function Initialize-VendorConnectorMappingDeletedAt {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => VendorConnectorMappingDeletedAt' | Write-Debug
...
function ConvertFrom-JsonToVendorConnectorMappingDeletedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => VendorConnectorMappingDeletedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'FormInstanceRecipient', 'V2026FormInstanceRecipient'] 
slug: /tools/sdk/powershell/v2026/models/form-instance-recipient
...
```powershell
$FormInstanceRecipient = Initialize-V2026FormInstanceRecipient  -Id 00000000-0000-0000-0000-000000000000 `
 -Type IDENTITY
```

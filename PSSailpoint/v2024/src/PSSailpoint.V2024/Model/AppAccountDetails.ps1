...
function Initialize-V2024AppAccountDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AppAccountDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToAppAccountDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AppAccountDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

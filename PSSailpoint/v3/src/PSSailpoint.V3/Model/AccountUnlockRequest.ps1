...
function Initialize-AccountUnlockRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccountUnlockRequest' | Write-Debug
...
function ConvertFrom-JsonToAccountUnlockRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccountUnlockRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ConfigurationItemRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ConfigurationItemRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToConfigurationItemRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ConfigurationItemRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

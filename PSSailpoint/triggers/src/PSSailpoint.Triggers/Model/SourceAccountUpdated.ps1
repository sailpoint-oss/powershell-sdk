...
function Initialize-SourceAccountUpdated {
    [CmdletBinding()]
    Param (
...
SourceAccountUpdated<PSCustomObject>
#>
function ConvertFrom-JsonToSourceAccountUpdated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SourceAccountUpdated

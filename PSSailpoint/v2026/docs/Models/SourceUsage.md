...
keywords: ['powershell', 'PowerShell', 'sdk', 'SourceUsage', 'V2026SourceUsage'] 
slug: /tools/sdk/powershell/v2026/models/source-usage
...
```powershell
$SourceUsage = Initialize-V2026SourceUsage  -Date Fri Apr 21 00:00:00 UTC 2023 `
 -Count 10.45
```

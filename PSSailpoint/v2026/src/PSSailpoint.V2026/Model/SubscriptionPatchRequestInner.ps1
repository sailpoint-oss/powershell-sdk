...
function Initialize-V2026SubscriptionPatchRequestInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SubscriptionPatchRequestInner' | Write-Debug
...
SubscriptionPatchRequestInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSubscriptionPatchRequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SubscriptionPatchRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SubscriptionPatchRequestInner

...
function Initialize-BetaNonEmployeeRejectApprovalDecision {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeRejectApprovalDecision' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeRejectApprovalDecision {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeRejectApprovalDecision' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
Describe -tag 'PSSailpoint.Beta' -name 'BetaBetaApplicationDiscoveryApi' {
    ...
    Context 'Get-BetaManualDiscoverApplicationsCsvTemplate' {
        It 'Test Get-BetaManualDiscoverApplicationsCsvTemplate' {
            #$TestResult = Get-BetaManualDiscoverApplicationsCsvTemplate
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
    ...
    Context 'Send-BetaManualDiscoverApplicationsCsvTemplate' {
        It 'Test Send-BetaManualDiscoverApplicationsCsvTemplate' {
            #$TestResult = Send-BetaManualDiscoverApplicationsCsvTemplate -File "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

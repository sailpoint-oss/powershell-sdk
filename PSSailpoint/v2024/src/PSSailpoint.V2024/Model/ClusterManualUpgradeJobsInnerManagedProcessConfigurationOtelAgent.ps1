...
function Initialize-V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent<PSCustomObject>
#>
function ConvertFrom-V2024JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent

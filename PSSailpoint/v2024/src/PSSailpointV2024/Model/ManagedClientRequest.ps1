...
function Initialize-V2024ManagedClientRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ManagedClientRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToManagedClientRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ManagedClientRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

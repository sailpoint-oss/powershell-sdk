...
function Initialize-V2024ReviewReassign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ReviewReassign' | Write-Debug
...
function ConvertFrom-V2024JsonToReviewReassign {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ReviewReassign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

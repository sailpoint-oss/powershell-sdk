...
keywords: ['powershell', 'PowerShell', 'sdk', 'Aggregations', 'V2026Aggregations'] 
slug: /tools/sdk/powershell/v2026/models/aggregations
...
```powershell
$Aggregations = Initialize-V2026Aggregations  -Nested null `
 -Metric null `
 -VarFilter null `
 -Bucket null
```

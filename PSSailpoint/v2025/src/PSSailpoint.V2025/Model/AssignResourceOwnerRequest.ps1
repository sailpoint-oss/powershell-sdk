...
function Initialize-V2025AssignResourceOwnerRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AssignResourceOwnerRequest' | Write-Debug
...
AssignResourceOwnerRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAssignResourceOwnerRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AssignResourceOwnerRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AssignResourceOwnerRequest

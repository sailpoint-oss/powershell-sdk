...
function Initialize-V2024TestInvocation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TestInvocation' | Write-Debug
...
function ConvertFrom-V2024JsonToTestInvocation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TestInvocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

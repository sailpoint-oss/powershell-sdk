...
LifecycleActionSubmitResponse<PSCustomObject>
#>

function Initialize-LifecycleActionSubmitResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentitiesLifecycleActions => LifecycleActionSubmitResponse' | Write-Debug
...
Convert from JSON to LifecycleActionSubmitResponse<PSCustomObject>
...
LifecycleActionSubmitResponse<PSCustomObject>
#>
function ConvertFrom-JsonToLifecycleActionSubmitResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentitiesLifecycleActions => LifecycleActionSubmitResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LifecycleActionSubmitResponse
        $AllProperties = ("requestId", "status", "action", "targetId", "resourceId", "createdAt")

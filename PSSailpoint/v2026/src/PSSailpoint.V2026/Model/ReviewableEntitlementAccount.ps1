...
function Initialize-V2026ReviewableEntitlementAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ReviewableEntitlementAccount' | Write-Debug
...
ReviewableEntitlementAccount<PSCustomObject>
#>
function ConvertFrom-V2026JsonToReviewableEntitlementAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ReviewableEntitlementAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ReviewableEntitlementAccount

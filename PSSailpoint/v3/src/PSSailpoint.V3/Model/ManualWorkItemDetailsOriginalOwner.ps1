...
function Initialize-ManualWorkItemDetailsOriginalOwner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ManualWorkItemDetailsOriginalOwner' | Write-Debug
...
function ConvertFrom-JsonToManualWorkItemDetailsOriginalOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ManualWorkItemDetailsOriginalOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

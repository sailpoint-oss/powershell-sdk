...
function Initialize-BetaMfaConfigTestResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaMfaConfigTestResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToMfaConfigTestResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaMfaConfigTestResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ProvisioningConfigPlanInitializerScript {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ProvisioningConfigPlanInitializerScript' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningConfigPlanInitializerScript {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ProvisioningConfigPlanInitializerScript' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

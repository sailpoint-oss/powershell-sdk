...
function Initialize-V2024AccessProfile {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessProfile' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfile {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaProvisioningCompletedAccountRequestsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaProvisioningCompletedAccountRequestsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningCompletedAccountRequestsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaProvisioningCompletedAccountRequestsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

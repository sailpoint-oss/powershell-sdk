...
CreateWorkflow<PSCustomObject>
#>

function Initialize-NERMCreateWorkflow {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMCreateWorkflow' | Write-Debug
...
Convert from JSON to CreateWorkflow<PSCustomObject>
...
CreateWorkflow<PSCustomObject>
#>
function ConvertFrom-NERMJsonToCreateWorkflow {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMCreateWorkflow' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMCreateWorkflow

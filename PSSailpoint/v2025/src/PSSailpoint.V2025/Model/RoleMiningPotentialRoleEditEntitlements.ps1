...
function Initialize-V2025RoleMiningPotentialRoleEditEntitlements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningPotentialRoleEditEntitlements' | Write-Debug
...
RoleMiningPotentialRoleEditEntitlements<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleMiningPotentialRoleEditEntitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningPotentialRoleEditEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleMiningPotentialRoleEditEntitlements

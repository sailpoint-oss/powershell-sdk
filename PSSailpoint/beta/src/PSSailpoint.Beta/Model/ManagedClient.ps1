...
function Initialize-BetaManagedClient {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaManagedClient' | Write-Debug
...
function ConvertFrom-BetaJsonToManagedClient {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
#>
function Send-ClassifyMachineAccountV1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Send-ClassifyMachineAccountV1' | Write-Debug
        ...
        $LocalVarUri = '/accounts/v1/{id}/classify'
        if (!$Id) {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "SendClassifyMachineAccountV1200Response" `

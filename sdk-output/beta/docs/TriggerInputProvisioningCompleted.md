...
```powershell
$TriggerInputProvisioningCompleted = Initialize-PSSailpointBetaTriggerInputProvisioningCompleted  -TrackingNumber 4b4d982dddff4267ab12f0f1e72b5a6d `
...
```powershell
$TriggerInputProvisioningCompleted | ConvertTo-JSON
```

...
keywords: ['powershell', 'PowerShell', 'sdk', 'PrivilegedRecommendationGroup', 'V2026PrivilegedRecommendationGroup'] 
slug: /tools/sdk/powershell/v2026/models/privileged-recommendation-group
...
```powershell
$PrivilegedRecommendationGroup = Initialize-V2026PrivilegedRecommendationGroup  -EntitlementName Domain Admins `

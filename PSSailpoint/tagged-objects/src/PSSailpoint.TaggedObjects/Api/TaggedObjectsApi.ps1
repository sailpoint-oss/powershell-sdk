...
None
#>
function Remove-TaggedObjectV1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Remove-TaggedObjectV1' | Write-Debug
        ...
        $LocalVarUri = '/tagged-objects/v1/{type}/{id}'
        if (!$Type) {
            throw "Error! The required parameter `Type` missing when calling deleteTaggedObjectV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{type}', [System.Web.HTTPUtility]::UrlEncode($Type))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteTaggedObjectV1."
        }
...
None
#>
function Remove-TagsToManyObjectV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Remove-TagsToManyObjectV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-TaggedObjectV1 {
    ...
    Process {
        'Calling method: Get-TaggedObjectV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/tagged-objects/v1/{type}/{id}'
        if (!$Type) {
            throw "Error! The required parameter `Type` missing when calling getTaggedObjectV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{type}', [System.Web.HTTPUtility]::UrlEncode($Type))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getTaggedObjectV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-TaggedObjectsByTypeV1 {
    ...
    Process {
        'Calling method: Get-TaggedObjectsByTypeV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/tagged-objects/v1/{type}'
        if (!$Type) {
            throw "Error! The required parameter `Type` missing when calling listTaggedObjectsByTypeV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{type}', [System.Web.HTTPUtility]::UrlEncode($Type))
...
function Get-TaggedObjectsV1 {
    ...
    Process {
        'Calling method: Get-TaggedObjectsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Send-TaggedObjectV1 {
    ...
    Process {
        'Calling method: Send-TaggedObjectV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/tagged-objects/v1/{type}/{id}'
        if (!$Type) {
            throw "Error! The required parameter `Type` missing when calling putTaggedObjectV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{type}', [System.Web.HTTPUtility]::UrlEncode($Type))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling putTaggedObjectV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Set-TagToObjectV1 {
    ...
    Process {
        'Calling method: Set-TagToObjectV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Set-TagsToManyObjectsV1 {
    ...
    Process {
        'Calling method: Set-TagsToManyObjectsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

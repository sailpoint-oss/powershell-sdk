...
function Initialize-ScheduledactionpayloadContentBackupOptions {
    [CmdletBinding()]
    Param (
...
ScheduledactionpayloadContentBackupOptions<PSCustomObject>
#>
function ConvertFrom-JsonToScheduledactionpayloadContentBackupOptions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ScheduledactionpayloadContentBackupOptions

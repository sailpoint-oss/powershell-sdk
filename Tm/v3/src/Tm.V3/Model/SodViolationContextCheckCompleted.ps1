...
function Initialize-SodViolationContextCheckCompleted {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => SodViolationContextCheckCompleted' | Write-Debug
...
function ConvertFrom-JsonToSodViolationContextCheckCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => SodViolationContextCheckCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-GetReferenceIdentityAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => GetReferenceIdentityAttribute' | Write-Debug
...
function ConvertFrom-JsonToGetReferenceIdentityAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => GetReferenceIdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

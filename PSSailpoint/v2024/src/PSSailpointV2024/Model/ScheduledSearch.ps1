...
function Initialize-V2024ScheduledSearch {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ScheduledSearch' | Write-Debug
...
function ConvertFrom-V2024JsonToScheduledSearch {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

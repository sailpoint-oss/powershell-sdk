...
function Initialize-V2026IntelAccessAccountWire {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IntelAccessAccountWire' | Write-Debug
...
IntelAccessAccountWire<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIntelAccessAccountWire {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IntelAccessAccountWire' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IntelAccessAccountWire

...
keywords: ['powershell', 'PowerShell', 'sdk', 'UserLevelRequest', 'V2026UserLevelRequest'] 
slug: /tools/sdk/powershell/v2026/models/user-level-request
...
```powershell
$UserLevelRequest = Initialize-V2026UserLevelRequest  -Name Custom User Level Name `

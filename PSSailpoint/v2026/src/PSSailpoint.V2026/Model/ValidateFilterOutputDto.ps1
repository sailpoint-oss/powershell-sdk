...
function Initialize-V2026ValidateFilterOutputDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ValidateFilterOutputDto' | Write-Debug
...
ValidateFilterOutputDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToValidateFilterOutputDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ValidateFilterOutputDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ValidateFilterOutputDto

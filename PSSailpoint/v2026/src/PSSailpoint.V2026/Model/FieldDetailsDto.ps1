...
function Initialize-V2026FieldDetailsDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026FieldDetailsDto' | Write-Debug
...
FieldDetailsDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToFieldDetailsDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026FieldDetailsDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026FieldDetailsDto

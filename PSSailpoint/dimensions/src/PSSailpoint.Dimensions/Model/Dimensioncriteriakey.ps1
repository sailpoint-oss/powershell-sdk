...
function Initialize-Dimensioncriteriakey {
    [CmdletBinding()]
    Param (
...
Dimensioncriteriakey<PSCustomObject>
#>
function ConvertFrom-JsonToDimensioncriteriakey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Dimensioncriteriakey

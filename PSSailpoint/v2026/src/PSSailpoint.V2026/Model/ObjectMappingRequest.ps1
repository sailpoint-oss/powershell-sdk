...
function Initialize-V2026ObjectMappingRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ObjectMappingRequest' | Write-Debug
...
ObjectMappingRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToObjectMappingRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ObjectMappingRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ObjectMappingRequest

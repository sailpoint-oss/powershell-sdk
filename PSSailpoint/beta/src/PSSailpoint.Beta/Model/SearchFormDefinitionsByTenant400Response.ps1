...
function Initialize-BetaSearchFormDefinitionsByTenant400Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSearchFormDefinitionsByTenant400Response' | Write-Debug
...
function ConvertFrom-BetaJsonToSearchFormDefinitionsByTenant400Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSearchFormDefinitionsByTenant400Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

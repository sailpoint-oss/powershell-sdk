...
function Initialize-BetaNonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

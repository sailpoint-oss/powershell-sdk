...
function Initialize-V2026EntitlementAccessRequestConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026EntitlementAccessRequestConfig' | Write-Debug
...
EntitlementAccessRequestConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToEntitlementAccessRequestConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026EntitlementAccessRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026EntitlementAccessRequestConfig

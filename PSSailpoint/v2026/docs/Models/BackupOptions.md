...
keywords: ['powershell', 'PowerShell', 'sdk', 'BackupOptions', 'V2026BackupOptions'] 
slug: /tools/sdk/powershell/v2026/models/backup-options
...
```powershell
$BackupOptions = Initialize-V2026BackupOptions  -IncludeTypes null `

...
function Initialize-BetaManualDiscoverApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaManualDiscoverApplications' | Write-Debug
...
function ConvertFrom-BetaJsonToManualDiscoverApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaManualDiscoverApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

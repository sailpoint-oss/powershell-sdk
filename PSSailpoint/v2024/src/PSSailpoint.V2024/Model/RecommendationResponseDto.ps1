...
function Initialize-V2024RecommendationResponseDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RecommendationResponseDto' | Write-Debug
...
function ConvertFrom-V2024JsonToRecommendationResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RecommendationResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

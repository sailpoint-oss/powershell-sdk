...
AccountInfoRef<PSCustomObject>
#>

function Initialize-V2025AccountInfoRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccountInfoRef' | Write-Debug
...
Convert from JSON to AccountInfoRef<PSCustomObject>
...
AccountInfoRef<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccountInfoRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccountInfoRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccountInfoRef
        $AllProperties = ("uuid", "nativeIdentity", "type", "id", "name")

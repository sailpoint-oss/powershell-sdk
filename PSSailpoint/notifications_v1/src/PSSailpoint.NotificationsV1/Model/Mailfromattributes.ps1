...
function Initialize-Mailfromattributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NotificationsV1 => Mailfromattributes' | Write-Debug
...
Mailfromattributes<PSCustomObject>
#>
function ConvertFrom-JsonToMailfromattributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NotificationsV1 => Mailfromattributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Mailfromattributes

...
keywords: ['powershell', 'PowerShell', 'sdk', 'CreatePersonalAccessTokenRequest', 'V2026CreatePersonalAccessTokenRequest'] 
slug: /tools/sdk/powershell/v2026/models/create-personal-access-token-request
...
```powershell
$CreatePersonalAccessTokenRequest = Initialize-V2026CreatePersonalAccessTokenRequest  -Name NodeJS Integration `

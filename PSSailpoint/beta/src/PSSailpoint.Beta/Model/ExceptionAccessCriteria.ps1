...
function Initialize-BetaExceptionAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaExceptionAccessCriteria' | Write-Debug
...
function ConvertFrom-BetaJsonToExceptionAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaExceptionAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

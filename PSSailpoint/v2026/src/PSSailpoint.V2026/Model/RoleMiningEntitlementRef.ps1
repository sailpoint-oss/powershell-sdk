...
function Initialize-V2026RoleMiningEntitlementRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningEntitlementRef' | Write-Debug
...
RoleMiningEntitlementRef<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMiningEntitlementRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningEntitlementRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMiningEntitlementRef

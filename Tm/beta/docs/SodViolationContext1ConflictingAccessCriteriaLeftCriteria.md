...
```powershell
$SodViolationContext1ConflictingAccessCriteriaLeftCriteria = Initialize-Tm.BetaSodViolationContext1ConflictingAccessCriteriaLeftCriteria  -CriteriaList null
```

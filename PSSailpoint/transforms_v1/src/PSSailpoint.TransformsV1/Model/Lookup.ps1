...
function Initialize-Lookup {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Lookup' | Write-Debug
...
Lookup<PSCustomObject>
#>
function ConvertFrom-JsonToLookup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Lookup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Lookup

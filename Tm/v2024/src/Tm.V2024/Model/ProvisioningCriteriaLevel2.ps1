...
function Initialize-V2024ProvisioningCriteriaLevel2 {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ProvisioningCriteriaLevel2' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningCriteriaLevel2 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ProvisioningCriteriaLevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeSourceWithCloudExternalId {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => NonEmployeeSourceWithCloudExternalId' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSourceWithCloudExternalId {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => NonEmployeeSourceWithCloudExternalId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

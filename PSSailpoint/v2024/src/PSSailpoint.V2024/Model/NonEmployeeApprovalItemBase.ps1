...
function Initialize-V2024NonEmployeeApprovalItemBase {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeApprovalItemBase' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeApprovalItemBase {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeApprovalItemBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

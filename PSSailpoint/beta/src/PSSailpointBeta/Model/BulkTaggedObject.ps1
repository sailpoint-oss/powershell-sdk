...
function Initialize-BetaBulkTaggedObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaBulkTaggedObject' | Write-Debug
...
function ConvertFrom-BetaJsonToBulkTaggedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaBulkTaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

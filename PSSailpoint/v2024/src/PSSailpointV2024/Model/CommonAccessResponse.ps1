...
function Initialize-V2024CommonAccessResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CommonAccessResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToCommonAccessResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CommonAccessResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026AccessRequestPostApprovalRequestedItemsStatusInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
...
AccessRequestPostApprovalRequestedItemsStatusInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessRequestPostApprovalRequestedItemsStatusInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestPostApprovalRequestedItemsStatusInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessRequestPostApprovalRequestedItemsStatusInner

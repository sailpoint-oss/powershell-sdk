...
function Initialize-V2024AccessProfileSummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccessProfileSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccessProfileSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-SetLifecycleStateV1200Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.LifecycleStates => SetLifecycleStateV1200Response' | Write-Debug
...
function ConvertFrom-JsonToSetLifecycleStateV1200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.LifecycleStates => SetLifecycleStateV1200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

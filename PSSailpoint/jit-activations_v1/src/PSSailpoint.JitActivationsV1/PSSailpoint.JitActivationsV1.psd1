#
# Module manifest for module 'PSSailpoint.JitActivationsV1'
#
...
RootModule = 'PSSailpoint.JitActivationsV1.psm1'
...
Description = 'PSSailpoint.JitActivationsV1 - the PowerShell module for Identity Security Cloud API - JIT Activations'

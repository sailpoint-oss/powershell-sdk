...
function Initialize-BetaCommonAccessItemResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCommonAccessItemResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToCommonAccessItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCommonAccessItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

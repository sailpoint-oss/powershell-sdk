...
function Initialize-BetaGetFormDefinitionByKey400Response {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaGetFormDefinitionByKey400Response' | Write-Debug
...
function ConvertFrom-BetaJsonToGetFormDefinitionByKey400Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaGetFormDefinitionByKey400Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

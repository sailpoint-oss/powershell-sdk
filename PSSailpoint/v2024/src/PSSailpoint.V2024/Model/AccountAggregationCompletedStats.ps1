...
function Initialize-V2024AccountAggregationCompletedStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccountAggregationCompletedStats' | Write-Debug
...
AccountAggregationCompletedStats<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccountAggregationCompletedStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccountAggregationCompletedStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AccountAggregationCompletedStats

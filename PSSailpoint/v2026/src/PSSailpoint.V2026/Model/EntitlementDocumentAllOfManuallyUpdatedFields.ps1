...
function Initialize-V2026EntitlementDocumentAllOfManuallyUpdatedFields {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026EntitlementDocumentAllOfManuallyUpdatedFields' | Write-Debug
...
EntitlementDocumentAllOfManuallyUpdatedFields<PSCustomObject>
#>
function ConvertFrom-V2026JsonToEntitlementDocumentAllOfManuallyUpdatedFields {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026EntitlementDocumentAllOfManuallyUpdatedFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026EntitlementDocumentAllOfManuallyUpdatedFields

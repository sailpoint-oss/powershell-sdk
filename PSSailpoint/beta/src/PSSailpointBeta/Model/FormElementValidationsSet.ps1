...
function Initialize-BetaFormElementValidationsSet {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaFormElementValidationsSet' | Write-Debug
...
function ConvertFrom-BetaJsonToFormElementValidationsSet {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaFormElementValidationsSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

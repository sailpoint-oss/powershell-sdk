...
function Initialize-V2026ExceptionCriteriaAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ExceptionCriteriaAccess' | Write-Debug
...
ExceptionCriteriaAccess<PSCustomObject>
#>
function ConvertFrom-V2026JsonToExceptionCriteriaAccess {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ExceptionCriteriaAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ExceptionCriteriaAccess

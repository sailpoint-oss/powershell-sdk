...
function Initialize-BetaAccountAttributesChangedSource {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountAttributesChangedSource' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesChangedSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountAttributesChangedSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

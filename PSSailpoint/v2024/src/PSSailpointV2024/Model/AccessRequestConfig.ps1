...
function Initialize-V2024AccessRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequestConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

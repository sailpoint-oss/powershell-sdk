...
function Initialize-V2026NonEmployeeSourceWithCloudExternalId {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeSourceWithCloudExternalId' | Write-Debug
...
NonEmployeeSourceWithCloudExternalId<PSCustomObject>
#>
function ConvertFrom-V2026JsonToNonEmployeeSourceWithCloudExternalId {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeSourceWithCloudExternalId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026NonEmployeeSourceWithCloudExternalId

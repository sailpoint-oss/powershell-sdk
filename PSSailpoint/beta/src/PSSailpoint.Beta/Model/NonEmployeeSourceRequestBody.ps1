...
function Initialize-BetaNonEmployeeSourceRequestBody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeSourceRequestBody' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSourceRequestBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeSourceRequestBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

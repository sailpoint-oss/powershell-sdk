...
function Initialize-BetaAccessProfileApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessProfileApprovalScheme' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileApprovalScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessProfileApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ExceptionAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ExceptionAccessCriteria' | Write-Debug
...
function ConvertFrom-JsonToExceptionAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ExceptionAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

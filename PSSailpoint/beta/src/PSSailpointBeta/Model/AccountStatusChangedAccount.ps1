...
function Initialize-BetaAccountStatusChangedAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccountStatusChangedAccount' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountStatusChangedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccountStatusChangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
RoleDocumentAllOfEntitlements<PSCustomObject>
#>

function Initialize-V2024RoleDocumentAllOfEntitlements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleDocumentAllOfEntitlements' | Write-Debug
...
Convert from JSON to RoleDocumentAllOfEntitlements<PSCustomObject>
...
RoleDocumentAllOfEntitlements<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRoleDocumentAllOfEntitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleDocumentAllOfEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RoleDocumentAllOfEntitlements

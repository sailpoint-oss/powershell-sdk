...
#>
function New-V2024CommonAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2024CommonAccess' | Write-Debug
...
#>
function Get-V2024CommonAccess {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024CommonAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Update-V2024CommonAccessStatusInBulk {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2024CommonAccessStatusInBulk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

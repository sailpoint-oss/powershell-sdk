...
function Initialize-V2024RoleIdentity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleIdentity' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

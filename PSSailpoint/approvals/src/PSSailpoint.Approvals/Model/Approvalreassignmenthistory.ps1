...
function Initialize-Approvalreassignmenthistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApprovalsV1 => Approvalreassignmenthistory' | Write-Debug
...
Approvalreassignmenthistory<PSCustomObject>
#>
function ConvertFrom-JsonToApprovalreassignmenthistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApprovalsV1 => Approvalreassignmenthistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Approvalreassignmenthistory

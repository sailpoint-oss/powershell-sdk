...
function Initialize-IdentityProfileExportedObject {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => IdentityProfileExportedObject' | Write-Debug
...
function ConvertFrom-JsonToIdentityProfileExportedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => IdentityProfileExportedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
GetTenantUiMetadataV1401Response<PSCustomObject>
#>

function Initialize-GetTenantUiMetadataV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to GetTenantUiMetadataV1401Response<PSCustomObject>
...
GetTenantUiMetadataV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetTenantUiMetadataV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in GetTenantUiMetadataV1401Response
        $AllProperties = ("error")

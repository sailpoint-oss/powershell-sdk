...
------------- | ------------- | -------------
[**Approve-V2026BulkAccessRequest**](#approve-bulk-access-request) | **POST** `/access-request-approvals/bulk-approve` | Bulk approve access request
[**Suspend-V2026AccessRequest**](#cancel-access-request) | **POST** `/access-requests/cancel` | Cancel access request
[**Suspend-V2026AccessRequestInBulk**](#cancel-access-request-in-bulk) | **POST** `/access-requests/bulk-cancel` | Bulk cancel access request
[**Close-V2026AccessRequest**](#close-access-request) | **POST** `/access-requests/close` | Close access request
[**New-V2026AccessRequest**](#create-access-request) | **POST** `/access-requests` | Submit access request
[**Get-V2026AccessRequestConfig**](#get-access-request-config) | **GET** `/access-request-config` | Get access request configuration
[**Get-V2026EntitlementDetailsForIdentity**](#get-entitlement-details-for-identity) | **GET** `/revocable-objects` | Identity entitlement details
[**Get-V2026AccessRequestStatus**](#list-access-request-status) | **GET** `/access-request-status` | Access request status
[**Get-V2026AdministratorsAccessRequestStatus**](#list-administrators-access-request-status) | **GET** `/access-request-administration` | Access request status for administrators
[**Invoke-V2026LoadAccountSelections**](#load-account-selections) | **POST** `/access-requests/accounts-selection` | Get accounts selections for identity
...
try {
    $Result = ConvertFrom-V2026JsonToBulkApproveAccessRequest -Json $BulkApproveAccessRequest
    Approve-V2026BulkAccessRequest -BulkApproveAccessRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Approve-V2026BulkAccessRequest -BulkApproveAccessRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Approve-V2026BulkAccessRequest"
...
try {
    $Result = ConvertFrom-V2026JsonToCancelAccessRequest -Json $CancelAccessRequest
    Suspend-V2026AccessRequest -CancelAccessRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Suspend-V2026AccessRequest -CancelAccessRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Suspend-V2026AccessRequest"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToBulkCancelAccessRequest -Json $BulkCancelAccessRequest
    Suspend-V2026AccessRequestInBulk -BulkCancelAccessRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Suspend-V2026AccessRequestInBulk -BulkCancelAccessRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Suspend-V2026AccessRequestInBulk"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToCloseAccessRequest -Json $CloseAccessRequest
    Close-V2026AccessRequest -CloseAccessRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Close-V2026AccessRequest -CloseAccessRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Close-V2026AccessRequest"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAccessRequest -Json $AccessRequest
    New-V2026AccessRequest -AccessRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026AccessRequest -AccessRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026AccessRequest"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026EntitlementDetailsForIdentity -IdentityId $IdentityId -EntitlementId $EntitlementId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026EntitlementDetailsForIdentity -IdentityId $IdentityId -EntitlementId $EntitlementId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026EntitlementDetailsForIdentity"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026AccessRequestStatus -RequestedFor $RequestedFor -RequestedBy $RequestedBy -RegardingIdentity $RegardingIdentity -AssignedTo $AssignedTo -Count $Count -Limit $Limit -Offset $Offset -Filters $Filters -Sorters $Sorters -RequestState $RequestState  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccessRequestStatus"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026AdministratorsAccessRequestStatus -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AdministratorsAccessRequestStatus -XSailPointExperimental $XSailPointExperimental -RequestedFor $RequestedFor -RequestedBy $RequestedBy -RegardingIdentity $RegardingIdentity -AssignedTo $AssignedTo -Count $Count -Limit $Limit -Offset $Offset -Filters $Filters -Sorters $Sorters -RequestState $RequestState  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AdministratorsAccessRequestStatus"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAccountsSelectionRequest -Json $AccountsSelectionRequest
    Invoke-V2026LoadAccountSelections -XSailPointExperimental $XSailPointExperimental -AccountsSelectionRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026LoadAccountSelections -XSailPointExperimental $XSailPointExperimental -AccountsSelectionRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026LoadAccountSelections"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

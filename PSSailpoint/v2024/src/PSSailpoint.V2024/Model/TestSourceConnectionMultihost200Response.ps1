...
function Initialize-V2024TestSourceConnectionMultihost200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TestSourceConnectionMultihost200Response' | Write-Debug
...
TestSourceConnectionMultihost200Response<PSCustomObject>
#>
function ConvertFrom-V2024JsonToTestSourceConnectionMultihost200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TestSourceConnectionMultihost200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024TestSourceConnectionMultihost200Response

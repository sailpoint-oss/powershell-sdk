...
V3ConnectorDto
#>
function New-V2025CustomConnector {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025CustomConnector' | Write-Debug
...
None
#>
function Remove-V2025CustomConnector {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025CustomConnector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025Connector {
    ...
    Process {
        'Calling method: Get-V2025Connector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String
#>
function Get-V2025ConnectorCorrelationConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ConnectorCorrelationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
V3ConnectorDto[]
#>
function Get-V2025ConnectorList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ConnectorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String
#>
function Get-V2025ConnectorSourceConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ConnectorSourceConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String
#>
function Get-V2025ConnectorSourceTemplate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ConnectorSourceTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
String
#>
function Get-V2025ConnectorTranslations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ConnectorTranslations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
UpdateDetail
#>
function Send-V2025ConnectorCorrelationConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025ConnectorCorrelationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/connectors/{scriptName}/correlation-config'
        if (!$ScriptName) {
            throw "Error! The required parameter `ScriptName` missing when calling putConnectorCorrelationConfig."
        }
        $LocalVarUri = $LocalVarUri.replace('{scriptName}', [System.Web.HTTPUtility]::UrlEncode($ScriptName))

        if (!$File) {
            throw "Error! The required parameter `File` missing when calling putConnectorCorrelationConfig."
        }
...
UpdateDetail
#>
function Send-V2025ConnectorSourceConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025ConnectorSourceConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
UpdateDetail
#>
function Send-V2025ConnectorSourceTemplate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025ConnectorSourceTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
UpdateDetail
#>
function Send-V2025ConnectorTranslations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025ConnectorTranslations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConnectorDetail
#>
function Update-V2025Connector {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025Connector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaIdentityAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityAttribute' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAttributeValueDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAttributeValueDTO' | Write-Debug
...
function ConvertFrom-BetaJsonToAttributeValueDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAttributeValueDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

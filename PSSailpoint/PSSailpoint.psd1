...
FunctionsToExport = 'New-AccessProfile', 'Remove-AccessProfile', 
               ...
               'Import-BetaAccounts', 'Import-BetaSourceAccountsSchema', 
               ...
               'Update-BetaSourceSchema', 'Import-BetaUncorrelatedAccounts', 
               'Get-BetaStatusBySourceId', 'Get-BetaUsagesBySourceId', 
               'Export-BetaSpConfig', 'Get-BetaSpConfigExport', 
               'Get-BetaSpConfigExportStatus', 'Get-BetaSpConfigImport', 
               'Get-BetaSpConfigImportStatus', 'Import-BetaSpConfig', 
               'Get-BetaSpConfigObjects', 'Get-BetaSedBatchStats', 
               'Get-BetaSedBatches', 'Get-BetaSeds', 'Update-BetaSed', 
               'Submit-BetaSedApproval', 'Submit-BetaSedAssignment', 
               'Submit-BetaSedBatchRequest', 'Remove-BetaTaggedObject', 
               'Remove-BetaTagsToManyObject', 'Get-BetaTaggedObject', 
               'Get-BetaTaggedObjects', 'Get-BetaTaggedObjectsByType', 
               'Send-BetaTaggedObject', 'Set-BetaTagToObject', 
               'Set-BetaTagsToManyObjects', 'Get-BetaPendingTaskHeaders', 
               'Get-BetaPendingTasks', 'Get-BetaTaskStatus', 
               'Get-BetaTaskStatusList', 'Update-BetaTaskStatus', 'Get-BetaTenant', 
               ...
               'Get-BetaTenantUiMetadata', 'Set-BetaTenantUiMetadata', 

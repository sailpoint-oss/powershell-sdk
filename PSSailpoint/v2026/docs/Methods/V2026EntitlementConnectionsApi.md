...
keywords: ['powershell', 'PowerShell', 'sdk', 'EntitlementConnections', 'V2026EntitlementConnections'] 
slug: /tools/sdk/powershell/v2026/methods/entitlement-connections
...
------------- | ------------- | -------------
[**Get-V2026EntitlementConnections**](#list-entitlement-connections) | **GET** `/entitlement-connections` | List entitlement connections
[**Get-V2026EntitlementConnectionsForCurrentIdentity**](#list-entitlement-connections-for-current-identity) | **GET** `/entitlement-connections/current-identity` | List my entitlement connections
[**Update-V2026EntitlementConnectionById**](#patch-entitlement-connection-by-id) | **PATCH** `/entitlement-connections/{connectionId}` | Update entitlement connection
[**Update-V2026EntitlementConnectionByQuery**](#patch-entitlement-connection-by-query) | **PATCH** `/entitlement-connections` | Update connection by query
[**Update-V2026EntitlementConnectionsBulk**](#update-entitlement-connections-bulk) | **POST** `/entitlement-connections` | Update connections in bulk
...
try {
    Get-V2026EntitlementConnections 
    
    # Below is a request that includes all optional parameters
    # Get-V2026EntitlementConnections -Offset $Offset -Limit $Limit -Count $Count -SearchAfter $SearchAfter -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026EntitlementConnections"
...
try {
    Get-V2026EntitlementConnectionsForCurrentIdentity 
    
    # Below is a request that includes all optional parameters
    # Get-V2026EntitlementConnectionsForCurrentIdentity -Offset $Offset -Limit $Limit -Count $Count -SearchAfter $SearchAfter -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026EntitlementConnectionsForCurrentIdentity"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026EntitlementConnectionById -ConnectionId $ConnectionId -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026EntitlementConnectionById -ConnectionId $ConnectionId -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026EntitlementConnectionById"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToJsonPatchOperation -Json $JsonPatchOperation
    Update-V2026EntitlementConnectionByQuery -EntitlementId $EntitlementId -IdentityId $IdentityId -AccountId $AccountId -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026EntitlementConnectionByQuery -EntitlementId $EntitlementId -IdentityId $IdentityId -AccountId $AccountId -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026EntitlementConnectionByQuery"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToEntitlementConnectionBulkUpdateItem -Json $EntitlementConnectionBulkUpdateItem
    Update-V2026EntitlementConnectionsBulk -EntitlementConnectionBulkUpdateItem $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026EntitlementConnectionsBulk -EntitlementConnectionBulkUpdateItem $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026EntitlementConnectionsBulk"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

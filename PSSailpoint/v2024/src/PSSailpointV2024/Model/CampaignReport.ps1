...
function Initialize-V2024CampaignReport {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignReport' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignReport {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignReport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

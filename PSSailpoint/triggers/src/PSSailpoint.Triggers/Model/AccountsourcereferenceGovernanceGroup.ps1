...
function Initialize-AccountsourcereferenceGovernanceGroup {
    [CmdletBinding()]
    Param (
...
AccountsourcereferenceGovernanceGroup<PSCustomObject>
#>
function ConvertFrom-JsonToAccountsourcereferenceGovernanceGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccountsourcereferenceGovernanceGroup

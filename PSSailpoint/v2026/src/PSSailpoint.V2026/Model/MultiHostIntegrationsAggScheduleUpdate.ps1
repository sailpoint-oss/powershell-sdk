...
function Initialize-V2026MultiHostIntegrationsAggScheduleUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsAggScheduleUpdate' | Write-Debug
...
MultiHostIntegrationsAggScheduleUpdate<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMultiHostIntegrationsAggScheduleUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MultiHostIntegrationsAggScheduleUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MultiHostIntegrationsAggScheduleUpdate

...
function Initialize-V2026ManualWorkItemDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ManualWorkItemDetails' | Write-Debug
...
ManualWorkItemDetails<PSCustomObject>
#>
function ConvertFrom-V2026JsonToManualWorkItemDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ManualWorkItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ManualWorkItemDetails

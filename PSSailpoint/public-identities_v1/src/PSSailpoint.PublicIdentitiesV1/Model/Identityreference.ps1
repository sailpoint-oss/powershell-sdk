...
function Initialize-Identityreference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PublicIdentitiesV1 => Identityreference' | Write-Debug
...
function ConvertFrom-JsonToIdentityreference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PublicIdentitiesV1 => Identityreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Requesteditemaccountselections {
    [CmdletBinding()]
    Param (
...
Requesteditemaccountselections<PSCustomObject>
#>
function ConvertFrom-JsonToRequesteditemaccountselections {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Requesteditemaccountselections

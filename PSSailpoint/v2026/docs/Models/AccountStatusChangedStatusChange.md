...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountStatusChangedStatusChange', 'V2026AccountStatusChangedStatusChange'] 
slug: /tools/sdk/powershell/v2026/models/account-status-changed-status-change
...
```powershell
$AccountStatusChangedStatusChange = Initialize-V2026AccountStatusChangedStatusChange  -PreviousStatus enabled `
 -NewStatus disabled
```

...
function Initialize-V2024ServiceDeskIntegrationDto1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ServiceDeskIntegrationDto1' | Write-Debug
...
function ConvertFrom-V2024JsonToServiceDeskIntegrationDto1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ServiceDeskIntegrationDto1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ClusterManualUpgradeJobsInner {
    [CmdletBinding()]
    Param (
...
ClusterManualUpgradeJobsInner<PSCustomObject>
#>
function ConvertFrom-JsonToClusterManualUpgradeJobsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ClusterManualUpgradeJobsInner

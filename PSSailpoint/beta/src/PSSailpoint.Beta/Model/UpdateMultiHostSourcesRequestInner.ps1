...
function Initialize-BetaUpdateMultiHostSourcesRequestInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaUpdateMultiHostSourcesRequestInner' | Write-Debug
...
UpdateMultiHostSourcesRequestInner<PSCustomObject>
#>
function ConvertFrom-BetaJsonToUpdateMultiHostSourcesRequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaUpdateMultiHostSourcesRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaUpdateMultiHostSourcesRequestInner

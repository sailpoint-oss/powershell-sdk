...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessItemRequestedFor', 'V2026AccessItemRequestedFor'] 
slug: /tools/sdk/powershell/v2026/models/access-item-requested-for
...
```powershell
$AccessItemRequestedFor = Initialize-V2026AccessItemRequestedFor  -Type IDENTITY `

...
function Initialize-V2024WorkgroupMemberAddItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkgroupMemberAddItem' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkgroupMemberAddItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkgroupMemberAddItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

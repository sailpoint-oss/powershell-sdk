...
function Initialize-MultihostintegrationsConnectorAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MultiHostIntegrationV1 => MultihostintegrationsConnectorAttributes' | Write-Debug
...
MultihostintegrationsConnectorAttributes<PSCustomObject>
#>
function ConvertFrom-JsonToMultihostintegrationsConnectorAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MultiHostIntegrationV1 => MultihostintegrationsConnectorAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $MultihostintegrationsConnectorAttributesAdditionalProperties = @{}

        # check if Json contains properties not defined in MultihostintegrationsConnectorAttributes
        ...
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            ...
            if (!($AllProperties.Contains($name))) {
                $MultihostintegrationsConnectorAttributesAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "showEntitlementSchema" = ${ShowEntitlementSchema}
            "multiHostAttributes" = ${MultiHostAttributes}
            "AdditionalProperties" = $MultihostintegrationsConnectorAttributesAdditionalProperties
        }

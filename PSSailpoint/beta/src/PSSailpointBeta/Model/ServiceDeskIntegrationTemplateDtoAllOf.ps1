...
function Initialize-BetaServiceDeskIntegrationTemplateDtoAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaServiceDeskIntegrationTemplateDtoAllOf' | Write-Debug
...
ServiceDeskIntegrationTemplateDtoAllOf<PSCustomObject>
#>
function ConvertFrom-BetaJsonToServiceDeskIntegrationTemplateDtoAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaServiceDeskIntegrationTemplateDtoAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaServiceDeskIntegrationTemplateDtoAllOf

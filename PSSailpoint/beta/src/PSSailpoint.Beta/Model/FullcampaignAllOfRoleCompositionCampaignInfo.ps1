...
function Initialize-BetaFullcampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFullcampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
...
function ConvertFrom-BetaJsonToFullcampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFullcampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024RecommendationResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RecommendationResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToRecommendationResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RecommendationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Sourceentitlementrequestconfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => Sourceentitlementrequestconfig' | Write-Debug
...
Sourceentitlementrequestconfig<PSCustomObject>
#>
function ConvertFrom-JsonToSourceentitlementrequestconfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => Sourceentitlementrequestconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Sourceentitlementrequestconfig

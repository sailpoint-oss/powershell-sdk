...
function Initialize-ConnectorrulecreaterequestSignature {
    [CmdletBinding()]
    Param (
...
ConnectorrulecreaterequestSignature<PSCustomObject>
#>
function ConvertFrom-JsonToConnectorrulecreaterequestSignature {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ConnectorrulecreaterequestSignature

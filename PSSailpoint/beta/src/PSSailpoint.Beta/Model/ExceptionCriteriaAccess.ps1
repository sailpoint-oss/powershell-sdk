...
function Initialize-BetaExceptionCriteriaAccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaExceptionCriteriaAccess' | Write-Debug
...
function ConvertFrom-BetaJsonToExceptionCriteriaAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaExceptionCriteriaAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

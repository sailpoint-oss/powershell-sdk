...
function Initialize-BetaRoleMiningSessionResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningSessionResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningSessionResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningSessionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

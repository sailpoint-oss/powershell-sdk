...
function Initialize-V2024SourceAccountUpdated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SourceAccountUpdated' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceAccountUpdated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SourceAccountUpdated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

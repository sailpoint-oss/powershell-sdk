...
function Initialize-Accessprofiledetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AppsV1 => Accessprofiledetails' | Write-Debug
...
Accessprofiledetails<PSCustomObject>
#>
function ConvertFrom-JsonToAccessprofiledetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AppsV1 => Accessprofiledetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessprofiledetails

...
Schedule2Days<PSCustomObject>
#>

function Initialize-Schedule2Days {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Schedule2Days' | Write-Debug
...
Convert from JSON to Schedule2Days<PSCustomObject>
...
Schedule2Days<PSCustomObject>
#>
function ConvertFrom-JsonToSchedule2Days {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Schedule2Days' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Schedule2Days

...
function Initialize-InviteIdentitiesRequest {
    [CmdletBinding()]
    Param (
...
InviteIdentitiesRequest<PSCustomObject>
#>
function ConvertFrom-JsonToInviteIdentitiesRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in InviteIdentitiesRequest

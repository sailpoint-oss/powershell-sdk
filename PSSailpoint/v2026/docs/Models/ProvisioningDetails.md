...
keywords: ['powershell', 'PowerShell', 'sdk', 'ProvisioningDetails', 'V2026ProvisioningDetails'] 
slug: /tools/sdk/powershell/v2026/models/provisioning-details
...
```powershell
$ProvisioningDetails = Initialize-V2026ProvisioningDetails  -OrderedSubPhaseReferences manualWorkItemDetails
```

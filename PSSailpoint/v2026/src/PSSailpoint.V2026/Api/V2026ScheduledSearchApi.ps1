...
ScheduledSearch
#>
function New-V2026ScheduledSearch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026ScheduledSearch' | Write-Debug
...
None
#>
function Remove-V2026ScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ScheduledSearch
#>
function Get-V2026ScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Invoke-V2026UnsubscribeScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2026UnsubscribeScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ScheduledSearch
#>
function Update-V2026ScheduledSearch {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026ScheduledSearch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

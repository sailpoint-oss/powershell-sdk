...
function Export-SpConfigV1 {
    ...
    Process {
        'Calling method: Export-SpConfigV1' | Write-Debug
...
function Get-SpConfigExportStatusV1 {
    ...
    Process {
        'Calling method: Get-SpConfigExportStatusV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/sp-config/v1/export/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getSpConfigExportStatusV1."
        }
...
function Get-SpConfigExportV1 {
    ...
    Process {
        'Calling method: Get-SpConfigExportV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/sp-config/v1/export/{id}/download'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getSpConfigExportV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-SpConfigImportStatusV1 {
    ...
    Process {
        'Calling method: Get-SpConfigImportStatusV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/sp-config/v1/import/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getSpConfigImportStatusV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-SpConfigImportV1 {
    ...
    Process {
        'Calling method: Get-SpConfigImportV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/sp-config/v1/import/{id}/download'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getSpConfigImportV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Import-SpConfigV1 {
    ...
    Process {
        'Calling method: Import-SpConfigV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/sp-config/v1/import'
        ...
        if (!$Data) {
            throw "Error! The required parameter `Data` missing when calling importSpConfigV1."
        }
...
function Get-SpConfigObjectsV1 {
    ...
    Process {
        'Calling method: Get-SpConfigObjectsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/sp-config/v1/config-objects'

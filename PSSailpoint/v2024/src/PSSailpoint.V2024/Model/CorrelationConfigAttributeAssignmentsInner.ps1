...
function Initialize-V2024CorrelationConfigAttributeAssignmentsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CorrelationConfigAttributeAssignmentsInner' | Write-Debug
...
CorrelationConfigAttributeAssignmentsInner<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCorrelationConfigAttributeAssignmentsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CorrelationConfigAttributeAssignmentsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024CorrelationConfigAttributeAssignmentsInner

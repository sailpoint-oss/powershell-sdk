...
function Initialize-BetaAccountAttributesCreateAttributes {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountAttributesCreateAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesCreateAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountAttributesCreateAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

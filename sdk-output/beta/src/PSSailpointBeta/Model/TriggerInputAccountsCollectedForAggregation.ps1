...
TriggerInputAccountsCollectedForAggregation<PSCustomObject>
#>

function Initialize-BetaTriggerInputAccountsCollectedForAggregation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountsCollectedForAggregation' | Write-Debug
...
Convert from JSON to TriggerInputAccountsCollectedForAggregation<PSCustomObject>
...
TriggerInputAccountsCollectedForAggregation<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputAccountsCollectedForAggregation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountsCollectedForAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputAccountsCollectedForAggregation

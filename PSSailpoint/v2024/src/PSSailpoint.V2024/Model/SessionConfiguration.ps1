...
function Initialize-V2024SessionConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SessionConfiguration' | Write-Debug
...
SessionConfiguration<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSessionConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SessionConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SessionConfiguration

...
function Initialize-RequestedAccountRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RequestedAccountRef' | Write-Debug
...
function ConvertFrom-JsonToRequestedAccountRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RequestedAccountRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Parameterstoragenewparameter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ParameterStorageV1 => Parameterstoragenewparameter' | Write-Debug
...
Parameterstoragenewparameter<PSCustomObject>
#>
function ConvertFrom-JsonToParameterstoragenewparameter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ParameterStorageV1 => Parameterstoragenewparameter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Parameterstoragenewparameter

...
function Initialize-V2026ObjectMappingBulkCreateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ObjectMappingBulkCreateRequest' | Write-Debug
...
ObjectMappingBulkCreateRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToObjectMappingBulkCreateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ObjectMappingBulkCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ObjectMappingBulkCreateRequest

...
function Initialize-V2024RoleInsightsRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleInsightsRole' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleInsightsRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleInsightsRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

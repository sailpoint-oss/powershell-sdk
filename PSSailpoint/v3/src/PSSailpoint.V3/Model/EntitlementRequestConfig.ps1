...
function Initialize-EntitlementRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => EntitlementRequestConfig' | Write-Debug
...
function ConvertFrom-JsonToEntitlementRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => EntitlementRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

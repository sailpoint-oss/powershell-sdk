...
keywords: ['powershell', 'PowerShell', 'sdk', 'ErrorMessage', 'V2026ErrorMessage'] 
slug: /tools/sdk/powershell/v2026/models/error-message
...
```powershell
$ErrorMessage = Initialize-V2026ErrorMessage  -Locale en-US `

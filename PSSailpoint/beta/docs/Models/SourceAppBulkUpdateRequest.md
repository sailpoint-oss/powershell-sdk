...
$SourceAppBulkUpdateRequest = @"{  "AppIds": ["2c91808a7624751a01762f19d665220d", "2c91808a7624751a01762f19d67c220e", "2c91808a7624751a01762f19d692220f"], "JsonPatch": [{"op": "replace", "path": "/enabled", "value": "false}"}, {"op": "replace", "path": "/matchAllAccounts", "value": "false}]" }]}"@
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToSourceAppBulkUpdateRequest -Json $SourceAppBulkUpdateRequest
```

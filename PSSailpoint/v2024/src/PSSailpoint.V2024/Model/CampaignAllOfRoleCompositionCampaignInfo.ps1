...
function Initialize-V2024CampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
...
CampaignAllOfRoleCompositionCampaignInfo<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCampaignAllOfRoleCompositionCampaignInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

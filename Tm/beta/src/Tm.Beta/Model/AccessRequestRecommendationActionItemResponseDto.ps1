...
function Initialize-BetaAccessRequestRecommendationActionItemResponseDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestRecommendationActionItemResponseDto' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestRecommendationActionItemResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestRecommendationActionItemResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

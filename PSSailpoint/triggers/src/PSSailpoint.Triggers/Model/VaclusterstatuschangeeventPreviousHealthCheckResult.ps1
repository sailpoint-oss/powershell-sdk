...
function Initialize-VaclusterstatuschangeeventPreviousHealthCheckResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => VaclusterstatuschangeeventPreviousHealthCheckResult' | Write-Debug
...
VaclusterstatuschangeeventPreviousHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-JsonToVaclusterstatuschangeeventPreviousHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => VaclusterstatuschangeeventPreviousHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VaclusterstatuschangeeventPreviousHealthCheckResult

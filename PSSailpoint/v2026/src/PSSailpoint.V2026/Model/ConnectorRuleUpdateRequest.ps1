...
function Initialize-V2026ConnectorRuleUpdateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ConnectorRuleUpdateRequest' | Write-Debug
...
ConnectorRuleUpdateRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToConnectorRuleUpdateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ConnectorRuleUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ConnectorRuleUpdateRequest

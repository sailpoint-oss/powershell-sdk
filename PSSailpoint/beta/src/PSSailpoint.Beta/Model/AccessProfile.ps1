...
function Initialize-BetaAccessProfile {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessProfile' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfile {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

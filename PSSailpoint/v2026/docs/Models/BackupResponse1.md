...
keywords: ['powershell', 'PowerShell', 'sdk', 'BackupResponse1', 'V2026BackupResponse1'] 
slug: /tools/sdk/powershell/v2026/models/backup-response1
...
```powershell
$BackupResponse1 = Initialize-V2026BackupResponse1  -JobId 3469b87d-48ca-439a-868f-2160001da8c1 `
 -Status COMPLETE `
 -Type BACKUP `
 -Tenant tenant-name `

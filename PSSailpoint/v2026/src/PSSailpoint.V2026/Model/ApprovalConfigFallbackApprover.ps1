...
function Initialize-V2026ApprovalConfigFallbackApprover {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigFallbackApprover' | Write-Debug
...
ApprovalConfigFallbackApprover<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApprovalConfigFallbackApprover {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigFallbackApprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApprovalConfigFallbackApprover

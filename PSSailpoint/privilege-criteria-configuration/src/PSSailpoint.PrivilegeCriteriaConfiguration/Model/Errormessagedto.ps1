...
function Initialize-Errormessagedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PrivilegeCriteriaConfiguration => Errormessagedto' | Write-Debug
...
function ConvertFrom-JsonToErrormessagedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PrivilegeCriteriaConfiguration => Errormessagedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

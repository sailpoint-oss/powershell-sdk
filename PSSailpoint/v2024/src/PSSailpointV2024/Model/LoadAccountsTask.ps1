...
function Initialize-V2024LoadAccountsTask {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024LoadAccountsTask' | Write-Debug
...
function ConvertFrom-V2024JsonToLoadAccountsTask {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024LoadAccountsTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

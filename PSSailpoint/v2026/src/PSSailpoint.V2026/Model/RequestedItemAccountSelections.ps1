...
function Initialize-V2026RequestedItemAccountSelections {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemAccountSelections' | Write-Debug
...
RequestedItemAccountSelections<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRequestedItemAccountSelections {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemAccountSelections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RequestedItemAccountSelections

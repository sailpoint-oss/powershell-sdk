...
CloseSessionAction<PSCustomObject>
#>

function Initialize-NERMCloseSessionAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMCloseSessionAction' | Write-Debug
...
Convert from JSON to CloseSessionAction<PSCustomObject>
...
CloseSessionAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToCloseSessionAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMCloseSessionAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMCloseSessionAction

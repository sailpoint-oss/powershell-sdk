...
function Initialize-VaclusterstatuschangeeventApplication {
    [CmdletBinding()]
    Param (
...
VaclusterstatuschangeeventApplication<PSCustomObject>
#>
function ConvertFrom-JsonToVaclusterstatuschangeeventApplication {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in VaclusterstatuschangeeventApplication

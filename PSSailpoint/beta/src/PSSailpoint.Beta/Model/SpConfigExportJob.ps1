...
function Initialize-BetaSpConfigExportJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSpConfigExportJob' | Write-Debug
...
function ConvertFrom-BetaJsonToSpConfigExportJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSpConfigExportJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

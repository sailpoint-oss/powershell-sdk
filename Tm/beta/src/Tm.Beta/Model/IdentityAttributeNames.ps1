...
function Initialize-BetaIdentityAttributeNames {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityAttributeNames' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributeNames {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityAttributeNames' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

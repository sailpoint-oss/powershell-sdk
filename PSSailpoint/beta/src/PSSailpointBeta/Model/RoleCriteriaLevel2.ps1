...
function Initialize-BetaRoleCriteriaLevel2 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRoleCriteriaLevel2' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleCriteriaLevel2 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRoleCriteriaLevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

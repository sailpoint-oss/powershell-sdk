...
function Initialize-V2025ScheduledAttributes {
    [CmdletBinding()]
    Param (
...
ScheduledAttributes<PSCustomObject>
#>
function ConvertFrom-V2025JsonToScheduledAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ScheduledAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

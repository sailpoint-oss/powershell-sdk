...
ManualWorkItemDetails1<PSCustomObject>
#>

function Initialize-V2024ManualWorkItemDetails1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManualWorkItemDetails1' | Write-Debug
...
Convert from JSON to ManualWorkItemDetails1<PSCustomObject>
...
ManualWorkItemDetails1<PSCustomObject>
#>
function ConvertFrom-V2024JsonToManualWorkItemDetails1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManualWorkItemDetails1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ManualWorkItemDetails1

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessRequestPreApproval', 'V2026AccessRequestPreApproval'] 
slug: /tools/sdk/powershell/v2026/models/access-request-pre-approval
...
```powershell
$AccessRequestPreApproval = Initialize-V2026AccessRequestPreApproval  -AccessRequestId 2c91808b6ef1d43e016efba0ce470904 `
 -RequestedFor null `
 -RequestedItems null `
 -RequestedBy null
```

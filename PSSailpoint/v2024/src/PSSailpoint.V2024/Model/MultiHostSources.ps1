...
MultiHostSources<PSCustomObject>
#>

function Initialize-V2024MultiHostSources {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024MultiHostSources' | Write-Debug
        ...
        if (!$ConnectorName) {
            throw "invalid value for 'ConnectorName', 'ConnectorName' cannot be null."
        }
...
Convert from JSON to MultiHostSources<PSCustomObject>
...
MultiHostSources<PSCustomObject>
#>
function ConvertFrom-V2024JsonToMultiHostSources {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024MultiHostSources' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024MultiHostSources
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "connectorName"))) {
            throw "Error! JSON cannot be serialized due to the required property 'connectorName' missing."
        } else {

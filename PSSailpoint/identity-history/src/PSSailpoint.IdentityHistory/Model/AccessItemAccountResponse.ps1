...
function Initialize-AccessItemAccountResponse {
    [CmdletBinding()]
    Param (
...
AccessItemAccountResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAccessItemAccountResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccessItemAccountResponse

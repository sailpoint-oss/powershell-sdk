...
function Initialize-V2025ConnectorRuleValidationResponseDetailsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ConnectorRuleValidationResponseDetailsInner' | Write-Debug
...
ConnectorRuleValidationResponseDetailsInner<PSCustomObject>
#>
function ConvertFrom-V2025JsonToConnectorRuleValidationResponseDetailsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ConnectorRuleValidationResponseDetailsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ConnectorRuleValidationResponseDetailsInner

...
#>
function New-V2026ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026ServiceDeskIntegration' | Write-Debug
...
None
#>
function Remove-V2026ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Get-V2026ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026ServiceDeskIntegrationTemplate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ServiceDeskIntegrationTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026ServiceDeskIntegrationTypes {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2026ServiceDeskIntegrationTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto[]
#>
function Get-V2026ServiceDeskIntegrations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026ServiceDeskIntegrations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026StatusCheckDetails {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2026StatusCheckDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Update-V2026ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ServiceDeskIntegrationDto
#>
function Send-V2026ServiceDeskIntegration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2026ServiceDeskIntegration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
QueuedCheckConfigDetails
#>
function Update-V2026StatusCheckDetails {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Update-V2026StatusCheckDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

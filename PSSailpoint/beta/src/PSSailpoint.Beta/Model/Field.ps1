...
function Initialize-BetaField {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaField' | Write-Debug
...
Field<PSCustomObject>
#>
function ConvertFrom-BetaJsonToField {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaField' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaField

...
#>
function New-V2026MultiHostIntegration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026MultiHostIntegration' | Write-Debug
...
None
#>
function New-V2026SourcesWithinMultiHost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: New-V2026SourcesWithinMultiHost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-V2026MultiHost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026MultiHost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-V2026MultiHostSources {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026MultiHostSources' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026AcctAggregationGroups {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026AcctAggregationGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MultiHostIntegrationsAggScheduleUpdate[]
#>
function Get-V2026EntitlementAggregationGroups {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026EntitlementAggregationGroups' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MultiHostIntegrations
#>
function Get-V2026MultiHostIntegrations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026MultiHostIntegrations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MultiHostIntegrations[]
#>
function Get-V2026MultiHostIntegrationsList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int32]]
    ...
    Process {
        'Calling method: Get-V2026MultiHostIntegrationsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026MultiHostSourceCreationErrors {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026MultiHostSourceCreationErrors' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026MultihostIntegrationTypes {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2026MultihostIntegrationTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MultiHostSources[]
#>
function Get-V2026SourcesWithinMultiHost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026SourcesWithinMultiHost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Test-V2026ConnectionMultiHostSources {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Test-V2026ConnectionMultiHostSources' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Test-V2026SourceConnectionMultihost {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Test-V2026SourceConnectionMultihost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Update-V2026MultiHostSources {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026MultiHostSources' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

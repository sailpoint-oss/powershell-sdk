...
function Initialize-BetaRoleMiningPotentialRoleApplication {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRoleMiningPotentialRoleApplication' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleApplication {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRoleMiningPotentialRoleApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Activityinsights {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationsV1 => Activityinsights' | Write-Debug
...
function ConvertFrom-JsonToActivityinsights {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationsV1 => Activityinsights' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

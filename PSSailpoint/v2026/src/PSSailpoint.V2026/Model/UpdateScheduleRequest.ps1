...
function Initialize-V2026UpdateScheduleRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026UpdateScheduleRequest' | Write-Debug
...
UpdateScheduleRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToUpdateScheduleRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026UpdateScheduleRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026UpdateScheduleRequest

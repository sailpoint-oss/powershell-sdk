...
keywords: ['powershell', 'PowerShell', 'sdk', 'PasswordDigitToken', 'V2026PasswordDigitToken'] 
slug: /tools/sdk/powershell/v2026/models/password-digit-token
...
```powershell
$PasswordDigitToken = Initialize-V2026PasswordDigitToken  -DigitToken 09087713 `

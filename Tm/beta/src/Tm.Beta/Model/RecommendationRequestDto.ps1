...
function Initialize-BetaRecommendationRequestDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRecommendationRequestDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommendationRequestDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRecommendationRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

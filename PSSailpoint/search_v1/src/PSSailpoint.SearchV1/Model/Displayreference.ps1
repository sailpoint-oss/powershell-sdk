...
function Initialize-Displayreference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => Displayreference' | Write-Debug
...
function ConvertFrom-JsonToDisplayreference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => Displayreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

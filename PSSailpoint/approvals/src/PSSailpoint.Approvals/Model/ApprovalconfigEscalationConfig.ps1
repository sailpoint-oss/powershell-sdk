...
function Initialize-ApprovalconfigEscalationConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Approvals => ApprovalconfigEscalationConfig' | Write-Debug
...
function ConvertFrom-JsonToApprovalconfigEscalationConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Approvals => ApprovalconfigEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Provisioningcompleted {
    [CmdletBinding()]
    Param (
...
Provisioningcompleted<PSCustomObject>
#>
function ConvertFrom-JsonToProvisioningcompleted {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Provisioningcompleted

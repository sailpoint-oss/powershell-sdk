...
function Initialize-ErrorMessageDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.WorkItems => ErrorMessageDto' | Write-Debug
...
function ConvertFrom-JsonToErrorMessageDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.WorkItems => ErrorMessageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

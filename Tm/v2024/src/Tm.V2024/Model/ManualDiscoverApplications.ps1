...
function Initialize-V2024ManualDiscoverApplications {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ManualDiscoverApplications' | Write-Debug
...
function ConvertFrom-V2024JsonToManualDiscoverApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ManualDiscoverApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

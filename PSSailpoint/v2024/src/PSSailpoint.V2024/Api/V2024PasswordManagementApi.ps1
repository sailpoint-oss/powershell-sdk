...
function New-V2024DigitToken {
    ...
    Process {
        'Calling method: New-V2024DigitToken' | Write-Debug
...
PasswordStatus
#>
function Get-V2024PasswordChangeStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2024PasswordChangeStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordInfo
#>
function Search-V2024PasswordInfo {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Search-V2024PasswordInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Set-V2024Password {
    ...
    Process {
        'Calling method: Set-V2024Password' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
Campaign2AllOfRoleCompositionCampaignInfo<PSCustomObject>
#>

function Initialize-Campaign2AllOfRoleCompositionCampaignInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Campaign2AllOfRoleCompositionCampaignInfo' | Write-Debug
...
Convert from JSON to Campaign2AllOfRoleCompositionCampaignInfo<PSCustomObject>
...
Campaign2AllOfRoleCompositionCampaignInfo<PSCustomObject>
#>
function ConvertFrom-JsonToCampaign2AllOfRoleCompositionCampaignInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Campaign2AllOfRoleCompositionCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Campaign2AllOfRoleCompositionCampaignInfo

...
function Initialize-MultihostintegrationsConnectorAttributesMultiHostAttributes {
    [CmdletBinding()]
    Param (
...
MultihostintegrationsConnectorAttributesMultiHostAttributes<PSCustomObject>
#>
function ConvertFrom-JsonToMultihostintegrationsConnectorAttributesMultiHostAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in MultihostintegrationsConnectorAttributesMultiHostAttributes

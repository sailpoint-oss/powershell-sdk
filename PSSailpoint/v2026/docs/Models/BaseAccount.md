...
keywords: ['powershell', 'PowerShell', 'sdk', 'BaseAccount', 'V2026BaseAccount'] 
slug: /tools/sdk/powershell/v2026/models/base-account
...
```powershell
$BaseAccount = Initialize-V2026BaseAccount  -Id 2c91808568c529c60168cca6f90c1313 `
 -Name John Doe `
 -AccountId John.Doe `
 -Source null `
 -Disabled false `

...
function Initialize-V2024IdentityListItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityListItem' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityListItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityListItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

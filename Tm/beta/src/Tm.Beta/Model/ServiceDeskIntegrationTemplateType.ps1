...
function Initialize-BetaServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaServiceDeskIntegrationTemplateType' | Write-Debug
...
function ConvertFrom-BetaJsonToServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaServiceDeskIntegrationTemplateType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

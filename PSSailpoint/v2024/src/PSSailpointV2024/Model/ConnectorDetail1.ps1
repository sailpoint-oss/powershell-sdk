...
function Initialize-V2024ConnectorDetail1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ConnectorDetail1' | Write-Debug
...
function ConvertFrom-V2024JsonToConnectorDetail1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ConnectorDetail1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

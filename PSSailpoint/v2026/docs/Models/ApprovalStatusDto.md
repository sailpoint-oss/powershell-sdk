...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalStatusDto', 'V2026ApprovalStatusDto'] 
slug: /tools/sdk/powershell/v2026/models/approval-status-dto
...
```powershell
$ApprovalStatusDto = Initialize-V2026ApprovalStatusDto  -Forwarded false `
 -OriginalOwner null `
 -CurrentOwner null `

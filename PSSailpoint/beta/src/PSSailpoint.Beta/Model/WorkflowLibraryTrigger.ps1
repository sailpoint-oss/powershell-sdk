...
function Initialize-BetaWorkflowLibraryTrigger {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaWorkflowLibraryTrigger' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowLibraryTrigger {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaWorkflowLibraryTrigger' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

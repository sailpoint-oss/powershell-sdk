...
function Initialize-EntitlementDocumentAllOfSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => EntitlementDocumentAllOfSource' | Write-Debug
...
function ConvertFrom-JsonToEntitlementDocumentAllOfSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => EntitlementDocumentAllOfSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

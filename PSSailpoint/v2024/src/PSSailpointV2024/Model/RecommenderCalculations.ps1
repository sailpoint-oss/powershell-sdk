...
function Initialize-V2024RecommenderCalculations {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RecommenderCalculations' | Write-Debug
...
function ConvertFrom-V2024JsonToRecommenderCalculations {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RecommenderCalculations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Attributemappings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountMappingsV1 => Attributemappings' | Write-Debug
...
Attributemappings<PSCustomObject>
#>
function ConvertFrom-JsonToAttributemappings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountMappingsV1 => Attributemappings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Attributemappings

...
function Initialize-V2024AccessRequestRecommendationItemDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestRecommendationItemDetail' | Write-Debug
...
AccessRequestRecommendationItemDetail<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccessRequestRecommendationItemDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestRecommendationItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AccessRequestRecommendationItemDetail

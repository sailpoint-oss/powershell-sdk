...
function Initialize-V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox<PSCustomObject>
#>
function ConvertFrom-V2025JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox

...
function Initialize-Searchaggregationspecification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Searchaggregationspecification' | Write-Debug
...
Searchaggregationspecification<PSCustomObject>
#>
function ConvertFrom-JsonToSearchaggregationspecification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Searchaggregationspecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Searchaggregationspecification

...
function Initialize-V2026JWK {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026JWK' | Write-Debug
...
JWK<PSCustomObject>
#>
function ConvertFrom-V2026JsonToJWK {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026JWK' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026JWK

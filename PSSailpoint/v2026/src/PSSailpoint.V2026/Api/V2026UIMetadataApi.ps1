...
#>
function Get-V2026TenantUiMetadata {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2026TenantUiMetadata' | Write-Debug
...
TenantUiMetadataItemResponse
#>
function Set-V2026TenantUiMetadata {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-V2026TenantUiMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccessRequestResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequestResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequestResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
RoleMiningPotentialRoleSummaryDistribution<PSCustomObject>
#>

function Initialize-BetaRoleMiningPotentialRoleSummaryDistribution {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRoleMiningPotentialRoleSummaryDistribution' | Write-Debug
...
Convert from JSON to RoleMiningPotentialRoleSummaryDistribution<PSCustomObject>
...
RoleMiningPotentialRoleSummaryDistribution<PSCustomObject>
#>
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleSummaryDistribution {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRoleMiningPotentialRoleSummaryDistribution' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaRoleMiningPotentialRoleSummaryDistribution
        $AllProperties = ("identityDistribution", "potentialRoleRef", "identityCount", "entitlementCount", "identityGroupStatus", "provisionState", "roleId", "density", "freshness", "quality")

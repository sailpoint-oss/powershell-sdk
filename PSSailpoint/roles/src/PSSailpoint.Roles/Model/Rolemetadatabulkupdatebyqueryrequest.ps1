...
function Initialize-Rolemetadatabulkupdatebyqueryrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RolesV1 => Rolemetadatabulkupdatebyqueryrequest' | Write-Debug
...
Rolemetadatabulkupdatebyqueryrequest<PSCustomObject>
#>
function ConvertFrom-JsonToRolemetadatabulkupdatebyqueryrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RolesV1 => Rolemetadatabulkupdatebyqueryrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Rolemetadatabulkupdatebyqueryrequest

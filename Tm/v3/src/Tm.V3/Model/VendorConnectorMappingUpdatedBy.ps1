...
function Initialize-VendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => VendorConnectorMappingUpdatedBy' | Write-Debug
...
function ConvertFrom-JsonToVendorConnectorMappingUpdatedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => VendorConnectorMappingUpdatedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

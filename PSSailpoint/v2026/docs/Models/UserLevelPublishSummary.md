...
keywords: ['powershell', 'PowerShell', 'sdk', 'UserLevelPublishSummary', 'V2026UserLevelPublishSummary'] 
slug: /tools/sdk/powershell/v2026/models/user-level-publish-summary
...
```powershell
$UserLevelPublishSummary = Initialize-V2026UserLevelPublishSummary  -UserLevelId 6e110911-5984-491b-be74-2707980a46a7 `
 -Publish true `
 -Status ACTIVE `

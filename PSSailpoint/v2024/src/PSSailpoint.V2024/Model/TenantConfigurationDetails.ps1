...
function Initialize-V2024TenantConfigurationDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TenantConfigurationDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToTenantConfigurationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TenantConfigurationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

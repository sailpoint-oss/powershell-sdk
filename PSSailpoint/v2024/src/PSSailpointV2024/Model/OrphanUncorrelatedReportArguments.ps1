...
function Initialize-V2024OrphanUncorrelatedReportArguments {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024OrphanUncorrelatedReportArguments' | Write-Debug
...
function ConvertFrom-V2024JsonToOrphanUncorrelatedReportArguments {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024OrphanUncorrelatedReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

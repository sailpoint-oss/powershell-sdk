...
function Initialize-BetaNonEmployeeSourceRequestBody {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeSourceRequestBody' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSourceRequestBody {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeSourceRequestBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-IdentityProfilesConnections {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityProfilesConnections' | Write-Debug
...
function ConvertFrom-JsonToIdentityProfilesConnections {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityProfilesConnections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaViolationPrediction {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaViolationPrediction' | Write-Debug
...
function ConvertFrom-BetaJsonToViolationPrediction {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaViolationPrediction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

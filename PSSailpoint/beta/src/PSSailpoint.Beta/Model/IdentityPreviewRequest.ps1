...
function Initialize-BetaIdentityPreviewRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityPreviewRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityPreviewRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityPreviewRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

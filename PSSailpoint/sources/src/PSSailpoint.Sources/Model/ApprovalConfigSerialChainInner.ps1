...
function Initialize-ApprovalConfigSerialChainInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Sources => ApprovalConfigSerialChainInner' | Write-Debug
...
function ConvertFrom-JsonToApprovalConfigSerialChainInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Sources => ApprovalConfigSerialChainInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

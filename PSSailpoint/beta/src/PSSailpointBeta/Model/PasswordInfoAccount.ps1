...
function Initialize-BetaPasswordInfoAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaPasswordInfoAccount' | Write-Debug
...
function ConvertFrom-BetaJsonToPasswordInfoAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaPasswordInfoAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

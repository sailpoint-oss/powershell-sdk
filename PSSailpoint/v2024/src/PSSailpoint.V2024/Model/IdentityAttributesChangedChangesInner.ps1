...
function Initialize-V2024IdentityAttributesChangedChangesInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityAttributesChangedChangesInner' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityAttributesChangedChangesInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityAttributesChangedChangesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

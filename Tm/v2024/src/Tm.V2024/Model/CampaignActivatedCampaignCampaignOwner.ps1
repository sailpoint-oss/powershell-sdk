...
function Initialize-V2024CampaignActivatedCampaignCampaignOwner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CampaignActivatedCampaignCampaignOwner' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignActivatedCampaignCampaignOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CampaignActivatedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ManagerCorrelationMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManagerCorrelationMapping' | Write-Debug
...
ManagerCorrelationMapping<PSCustomObject>
#>
function ConvertFrom-V2024JsonToManagerCorrelationMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ManagerCorrelationMapping

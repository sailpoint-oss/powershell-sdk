...
keywords: ['powershell', 'PowerShell', 'sdk', 'ExportOptions', 'V2026ExportOptions'] 
slug: /tools/sdk/powershell/v2026/models/export-options
...
```powershell
$ExportOptions = Initialize-V2026ExportOptions  -ExcludeTypes null `
 -IncludeTypes null `

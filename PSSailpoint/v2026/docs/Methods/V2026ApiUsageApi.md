...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApiUsage', 'V2026ApiUsage'] 
slug: /tools/sdk/powershell/v2026/methods/api-usage
...
------------- | ------------- | -------------
[**Get-V2026TotalCount**](#get-total-count) | **GET** `/api-usage/count` | Total number of API requests
[**Get-V2026ApiSummary**](#list-api-summary) | **GET** `/api-usage/summary` | Get Api Summary
...
try {
    Get-V2026TotalCount -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026TotalCount -XSailPointExperimental $XSailPointExperimental -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026TotalCount"
...
try {
    Get-V2026ApiSummary -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ApiSummary -XSailPointExperimental $XSailPointExperimental -Filters $Filters -Limit $Limit -Offset $Offset  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ApiSummary"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMetadataBulkUpdateByFilterRequest', 'V2026RoleMetadataBulkUpdateByFilterRequest'] 
slug: /tools/sdk/powershell/v2026/models/role-metadata-bulk-update-by-filter-request
...
```powershell
$RoleMetadataBulkUpdateByFilterRequest = Initialize-V2026RoleMetadataBulkUpdateByFilterRequest  -Filters  requestable eq false `
 -Operation REPLACE `
 -ReplaceScope ALL `

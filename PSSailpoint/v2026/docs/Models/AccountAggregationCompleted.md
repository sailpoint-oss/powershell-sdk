...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountAggregationCompleted', 'V2026AccountAggregationCompleted'] 
slug: /tools/sdk/powershell/v2026/models/account-aggregation-completed
...
```powershell
$AccountAggregationCompleted = Initialize-V2026AccountAggregationCompleted  -Source null `
 -Status Success `

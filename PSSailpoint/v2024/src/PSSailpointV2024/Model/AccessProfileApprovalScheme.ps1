...
function Initialize-V2024AccessProfileApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileApprovalScheme' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileApprovalScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

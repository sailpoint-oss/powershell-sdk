...
function Initialize-Rolemetadatabulkupdatebyfilterrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RolesV1 => Rolemetadatabulkupdatebyfilterrequest' | Write-Debug
...
Rolemetadatabulkupdatebyfilterrequest<PSCustomObject>
#>
function ConvertFrom-JsonToRolemetadatabulkupdatebyfilterrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RolesV1 => Rolemetadatabulkupdatebyfilterrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Rolemetadatabulkupdatebyfilterrequest

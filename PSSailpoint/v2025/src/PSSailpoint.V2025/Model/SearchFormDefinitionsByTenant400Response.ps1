...
function Initialize-V2025SearchFormDefinitionsByTenant400Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SearchFormDefinitionsByTenant400Response' | Write-Debug
...
SearchFormDefinitionsByTenant400Response<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSearchFormDefinitionsByTenant400Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SearchFormDefinitionsByTenant400Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SearchFormDefinitionsByTenant400Response

...
function Initialize-CampaignCompleteOptions {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CampaignCompleteOptions' | Write-Debug
...
function ConvertFrom-JsonToCampaignCompleteOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CampaignCompleteOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

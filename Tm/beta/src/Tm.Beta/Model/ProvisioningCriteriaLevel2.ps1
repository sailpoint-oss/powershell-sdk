...
function Initialize-BetaProvisioningCriteriaLevel2 {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaProvisioningCriteriaLevel2' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningCriteriaLevel2 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaProvisioningCriteriaLevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

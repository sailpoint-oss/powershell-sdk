...
function Initialize-V2024SlimDiscoveredApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SlimDiscoveredApplications' | Write-Debug
...
SlimDiscoveredApplications<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSlimDiscoveredApplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SlimDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SlimDiscoveredApplications

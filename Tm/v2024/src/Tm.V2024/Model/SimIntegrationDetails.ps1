...
function Initialize-V2024SimIntegrationDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024SimIntegrationDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToSimIntegrationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024SimIntegrationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApplicationCrawlerSettings', 'V2026ApplicationCrawlerSettings'] 
slug: /tools/sdk/powershell/v2026/models/application-crawler-settings
...
```powershell
$ApplicationCrawlerSettings = Initialize-V2026ApplicationCrawlerSettings  -IsEnabled true `

...
TriggerInputSavedSearchCompleteSearchResultsAccount<PSCustomObject>
#>

function Initialize-BetaTriggerInputSavedSearchCompleteSearchResultsAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputSavedSearchCompleteSearchResultsAccount' | Write-Debug
...
Convert from JSON to TriggerInputSavedSearchCompleteSearchResultsAccount<PSCustomObject>
...
TriggerInputSavedSearchCompleteSearchResultsAccount<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputSavedSearchCompleteSearchResultsAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputSavedSearchCompleteSearchResultsAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputSavedSearchCompleteSearchResultsAccount

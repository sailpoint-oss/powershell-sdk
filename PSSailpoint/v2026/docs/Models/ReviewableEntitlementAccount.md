...
keywords: ['powershell', 'PowerShell', 'sdk', 'ReviewableEntitlementAccount', 'V2026ReviewableEntitlementAccount'] 
slug: /tools/sdk/powershell/v2026/models/reviewable-entitlement-account
...
```powershell
$ReviewableEntitlementAccount = Initialize-V2026ReviewableEntitlementAccount  -NativeIdentity CN=Alison Ferguso `
 -Disabled false `
 -Locked false `
 -Type null `

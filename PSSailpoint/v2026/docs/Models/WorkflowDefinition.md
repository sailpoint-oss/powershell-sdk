...
keywords: ['powershell', 'PowerShell', 'sdk', 'WorkflowDefinition', 'V2026WorkflowDefinition'] 
slug: /tools/sdk/powershell/v2026/models/workflow-definition
...
```powershell
$WorkflowDefinition = Initialize-V2026WorkflowDefinition  -Start Send Email Test `

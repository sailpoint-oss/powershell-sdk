...
function Initialize-V2024TestWorkflowRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TestWorkflowRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToTestWorkflowRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TestWorkflowRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

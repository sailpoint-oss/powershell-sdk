...
function Initialize-V2025AccessReviewItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccessReviewItem' | Write-Debug
...
AccessReviewItem<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccessReviewItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccessReviewItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccessReviewItem

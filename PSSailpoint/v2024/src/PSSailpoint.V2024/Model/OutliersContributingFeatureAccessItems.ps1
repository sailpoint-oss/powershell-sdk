...
function Initialize-V2024OutliersContributingFeatureAccessItems {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024OutliersContributingFeatureAccessItems' | Write-Debug
...
OutliersContributingFeatureAccessItems<PSCustomObject>
#>
function ConvertFrom-V2024JsonToOutliersContributingFeatureAccessItems {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024OutliersContributingFeatureAccessItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024OutliersContributingFeatureAccessItems

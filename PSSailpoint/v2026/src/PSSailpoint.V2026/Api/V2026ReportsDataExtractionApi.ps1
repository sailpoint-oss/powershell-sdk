...
function Suspend-V2026Report {
    ...
    Process {
        'Calling method: Suspend-V2026Report' | Write-Debug
...
function Get-V2026Report {
    ...
    Process {
        'Calling method: Get-V2026Report' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ReportResults
#>
function Get-V2026ReportResult {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ReportResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Start-V2026Report {
    ...
    Process {
        'Calling method: Start-V2026Report' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SpConfigMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SpConfigMessage' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SpConfigMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

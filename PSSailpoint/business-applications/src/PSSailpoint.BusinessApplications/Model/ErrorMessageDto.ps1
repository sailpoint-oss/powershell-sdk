...
function Initialize-ErrorMessageDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.BusinessApplications => ErrorMessageDto' | Write-Debug
...
function ConvertFrom-JsonToErrorMessageDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.BusinessApplications => ErrorMessageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

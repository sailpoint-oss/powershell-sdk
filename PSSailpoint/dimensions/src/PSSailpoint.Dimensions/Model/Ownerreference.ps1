...
function Initialize-Ownerreference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Dimensions => Ownerreference' | Write-Debug
...
function ConvertFrom-JsonToOwnerreference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Dimensions => Ownerreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

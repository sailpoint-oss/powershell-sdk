...
function Initialize-Simintegrationdetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SimIntegrationsV1 => Simintegrationdetails' | Write-Debug
...
Simintegrationdetails<PSCustomObject>
#>
function ConvertFrom-JsonToSimintegrationdetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SimIntegrationsV1 => Simintegrationdetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Simintegrationdetails

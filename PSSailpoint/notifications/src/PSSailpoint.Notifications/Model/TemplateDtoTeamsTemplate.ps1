...
function Initialize-TemplateDtoTeamsTemplate {
    [CmdletBinding()]
    Param (
...
TemplateDtoTeamsTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToTemplateDtoTeamsTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in TemplateDtoTeamsTemplate

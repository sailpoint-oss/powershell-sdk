...
slug: /tools/sdk/powershell/intelligencepackagev1/models/intelprivilegedaccessitemwire-source
...
```powershell
$IntelprivilegedaccessitemwireSource = Initialize-IntelprivilegedaccessitemwireSource  -Name Workday `
 -Id src-2
```

...
function Initialize-Searchaggregationspecification {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessModelMetadata => Searchaggregationspecification' | Write-Debug
...
function ConvertFrom-JsonToSearchaggregationspecification {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessModelMetadata => Searchaggregationspecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

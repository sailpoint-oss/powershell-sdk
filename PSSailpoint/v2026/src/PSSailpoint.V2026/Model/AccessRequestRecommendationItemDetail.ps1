...
function Initialize-V2026AccessRequestRecommendationItemDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestRecommendationItemDetail' | Write-Debug
...
AccessRequestRecommendationItemDetail<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessRequestRecommendationItemDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestRecommendationItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessRequestRecommendationItemDetail

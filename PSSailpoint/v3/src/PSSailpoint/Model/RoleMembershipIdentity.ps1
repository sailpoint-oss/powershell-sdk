...
function Initialize-RoleMembershipIdentity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => RoleMembershipIdentity' | Write-Debug
...
function ConvertFrom-JsonToRoleMembershipIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => RoleMembershipIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

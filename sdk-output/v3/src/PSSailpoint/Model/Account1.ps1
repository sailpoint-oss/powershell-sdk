...
function Initialize-Account1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => Account1' | Write-Debug
...
Convert from JSON to Account1<PSCustomObject>
...
Account1<PSCustomObject>
#>
function ConvertFrom-JsonToAccount1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => Account1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Account1

...
function Initialize-BetaIdentityAttributesChangedChangesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributesChangedChangesInner' | Write-Debug
...
IdentityAttributesChangedChangesInner<PSCustomObject>
#>
function ConvertFrom-BetaJsonToIdentityAttributesChangedChangesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributesChangedChangesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaIdentityAttributesChangedChangesInner

...
function Initialize-MachineidentityupdatedUserEntitlementChanges {
    [CmdletBinding()]
    Param (
...
MachineidentityupdatedUserEntitlementChanges<PSCustomObject>
#>
function ConvertFrom-JsonToMachineidentityupdatedUserEntitlementChanges {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in MachineidentityupdatedUserEntitlementChanges

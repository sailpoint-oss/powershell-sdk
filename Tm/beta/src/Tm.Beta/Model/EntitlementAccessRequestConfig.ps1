...
function Initialize-BetaEntitlementAccessRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaEntitlementAccessRequestConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementAccessRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaEntitlementAccessRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

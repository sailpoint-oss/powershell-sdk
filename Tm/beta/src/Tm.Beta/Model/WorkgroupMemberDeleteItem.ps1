...
function Initialize-BetaWorkgroupMemberDeleteItem {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaWorkgroupMemberDeleteItem' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkgroupMemberDeleteItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaWorkgroupMemberDeleteItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

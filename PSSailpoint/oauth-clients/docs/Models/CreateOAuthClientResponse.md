...
slug: /tools/sdk/powershell/oauthclients/models/create-o-auth-client-response
...
**GrantTypes** | **[]GrantType** | A list of OAuth 2.0 grant types this API Client can be used with | [required]

...
function Initialize-ReviewableEntitlementAccount {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ReviewableEntitlementAccount' | Write-Debug
...
function ConvertFrom-JsonToReviewableEntitlementAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ReviewableEntitlementAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

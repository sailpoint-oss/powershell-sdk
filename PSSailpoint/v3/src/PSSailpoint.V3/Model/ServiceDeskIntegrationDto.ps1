...
function Initialize-ServiceDeskIntegrationDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ServiceDeskIntegrationDto' | Write-Debug
...
function ConvertFrom-JsonToServiceDeskIntegrationDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ServiceDeskIntegrationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

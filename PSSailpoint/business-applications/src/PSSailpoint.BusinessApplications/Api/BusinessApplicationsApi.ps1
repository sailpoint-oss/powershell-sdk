...
BusinessApplication
#>
function New-BusinessApplicationV1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-BusinessApplicationV1' | Write-Debug
        ...
        if ($LocalVarContentTypes.Contains('application/json-patch+json') -or ($BusinessApplication -is [array])) {
            $LocalVarBodyParameter = $BusinessApplication | ConvertTo-Json -AsArray -Depth 100
        } else {
            $LocalVarBodyParameter = $BusinessApplication | ForEach-Object {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "BusinessApplication" `
...
BusinessApplication
#>
function Get-BusinessApplicationV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-BusinessApplicationV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/business-applications/v1/{id}'
        if (!$Id) {
...
BusinessApplication[]
#>
function Get-BusinessApplicationsV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-BusinessApplicationsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
BusinessApplication
#>
function Update-BusinessApplicationV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-BusinessApplicationV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        # HTTP header 'Content-Type'
        $LocalVarContentTypes = @('application/json-patch+json', 'application/json')

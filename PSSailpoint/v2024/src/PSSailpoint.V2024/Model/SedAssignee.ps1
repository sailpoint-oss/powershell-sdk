...
function Initialize-V2024SedAssignee {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SedAssignee' | Write-Debug
...
function ConvertFrom-V2024JsonToSedAssignee {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SedAssignee' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AttrSyncSourceAttributeConfig', 'V2026AttrSyncSourceAttributeConfig'] 
slug: /tools/sdk/powershell/v2026/models/attr-sync-source-attribute-config
...
```powershell
$AttrSyncSourceAttributeConfig = Initialize-V2026AttrSyncSourceAttributeConfig  -Name email `
 -DisplayName Email `
 -Enabled true `
 -Target mail
```

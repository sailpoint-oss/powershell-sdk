...
#>
function New-V2026PersonalAccessToken {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026PersonalAccessToken' | Write-Debug
...
None
#>
function Remove-V2026PersonalAccessToken {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026PersonalAccessToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026PersonalAccessTokens {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026PersonalAccessTokens' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
GetPersonalAccessTokenResponse
#>
function Update-V2026PersonalAccessToken {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026PersonalAccessToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

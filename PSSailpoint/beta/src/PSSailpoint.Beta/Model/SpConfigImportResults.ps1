...
function Initialize-BetaSpConfigImportResults {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSpConfigImportResults' | Write-Debug
...
function ConvertFrom-BetaJsonToSpConfigImportResults {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSpConfigImportResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

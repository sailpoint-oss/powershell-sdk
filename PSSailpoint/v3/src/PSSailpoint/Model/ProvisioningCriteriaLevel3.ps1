...
function Initialize-ProvisioningCriteriaLevel3 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ProvisioningCriteriaLevel3' | Write-Debug
...
function ConvertFrom-JsonToProvisioningCriteriaLevel3 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ProvisioningCriteriaLevel3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

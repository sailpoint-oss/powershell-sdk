...
TriggerInputAccessRequestDynamicApprover<PSCustomObject>
#>

function Initialize-BetaTriggerInputAccessRequestDynamicApprover {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputAccessRequestDynamicApprover' | Write-Debug
...
Convert from JSON to TriggerInputAccessRequestDynamicApprover<PSCustomObject>
...
TriggerInputAccessRequestDynamicApprover<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputAccessRequestDynamicApprover {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputAccessRequestDynamicApprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputAccessRequestDynamicApprover

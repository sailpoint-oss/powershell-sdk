...
function Initialize-V2024SlimDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024SlimDiscoveredApplications' | Write-Debug
...
function ConvertFrom-V2024JsonToSlimDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024SlimDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

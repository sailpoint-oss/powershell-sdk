...
keywords: ['powershell', 'PowerShell', 'sdk', 'CommonAccessItemRequest', 'V2026CommonAccessItemRequest'] 
slug: /tools/sdk/powershell/v2026/models/common-access-item-request
...
```powershell
$CommonAccessItemRequest = Initialize-V2026CommonAccessItemRequest  -Access null `
 -Status null
```

...
function Initialize-V2026VAClusterStatusChangeEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026VAClusterStatusChangeEvent' | Write-Debug
...
VAClusterStatusChangeEvent<PSCustomObject>
#>
function ConvertFrom-V2026JsonToVAClusterStatusChangeEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026VAClusterStatusChangeEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026VAClusterStatusChangeEvent

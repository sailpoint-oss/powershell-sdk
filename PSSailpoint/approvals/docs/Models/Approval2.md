...
**BatchRequest** | **ApprovalBatch** |  | [optional] 
**ApprovalConfig** | **ApprovalConfig** |  | [optional] 
...
**StaticAttributes** | **map[string]AnyType** | Field that can include any static additional info that may be needed by the service that the approval request originated from | [optional] 

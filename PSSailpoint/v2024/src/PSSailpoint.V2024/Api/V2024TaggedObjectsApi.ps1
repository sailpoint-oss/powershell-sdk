...
None
#>
function Remove-V2024TaggedObject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Remove-V2024TaggedObject' | Write-Debug
...
None
#>
function Remove-V2024TagsToManyObject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Remove-V2024TagsToManyObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject
#>
function Get-V2024TaggedObject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [ValidateSet("ACCESS_PROFILE", "APPLICATION", "CAMPAIGN", "ENTITLEMENT", "IDENTITY", "ROLE", "SOD_POLICY", "SOURCE")]
    ...
    Process {
        'Calling method: Get-V2024TaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject[]
#>
function Get-V2024TaggedObjects {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2024TaggedObjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject[]
#>
function Get-V2024TaggedObjectsByType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [ValidateSet("ACCESS_PROFILE", "APPLICATION", "CAMPAIGN", "ENTITLEMENT", "IDENTITY", "ROLE", "SOD_POLICY", "SOURCE")]
    ...
    Process {
        'Calling method: Get-V2024TaggedObjectsByType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaggedObject
#>
function Send-V2024TaggedObject {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [ValidateSet("ACCESS_PROFILE", "APPLICATION", "CAMPAIGN", "ENTITLEMENT", "IDENTITY", "ROLE", "SOD_POLICY", "SOURCE")]
    ...
    Process {
        'Calling method: Send-V2024TaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Set-V2024TagToObject {
    ...
    Process {
        'Calling method: Set-V2024TagToObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Set-V2024TagsToManyObjects {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Set-V2024TagsToManyObjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

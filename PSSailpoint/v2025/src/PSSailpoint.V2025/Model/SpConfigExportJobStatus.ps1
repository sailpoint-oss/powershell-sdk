...
function Initialize-V2025SpConfigExportJobStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SpConfigExportJobStatus' | Write-Debug
...
SpConfigExportJobStatus<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSpConfigExportJobStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SpConfigExportJobStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SpConfigExportJobStatus

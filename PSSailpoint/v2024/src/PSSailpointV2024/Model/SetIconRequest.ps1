...
function Initialize-V2024SetIconRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SetIconRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToSetIconRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SetIconRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

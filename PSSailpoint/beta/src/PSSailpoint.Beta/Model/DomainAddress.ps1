...
function Initialize-BetaDomainAddress {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaDomainAddress' | Write-Debug
...
function ConvertFrom-BetaJsonToDomainAddress {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaDomainAddress' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

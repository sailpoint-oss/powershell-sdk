...
function Initialize-BetaRevocability {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRevocability' | Write-Debug
...
Revocability<PSCustomObject>
#>
function ConvertFrom-BetaJsonToRevocability {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRevocability' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024WorkflowTrigger {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkflowTrigger' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowTrigger {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkflowTrigger' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

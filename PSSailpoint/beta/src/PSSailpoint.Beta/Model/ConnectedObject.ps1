...
function Initialize-BetaConnectedObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConnectedObject' | Write-Debug
...
function ConvertFrom-BetaJsonToConnectedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConnectedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

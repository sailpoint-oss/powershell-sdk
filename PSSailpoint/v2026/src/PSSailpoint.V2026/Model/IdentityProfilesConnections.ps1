...
function Initialize-V2026IdentityProfilesConnections {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IdentityProfilesConnections' | Write-Debug
...
IdentityProfilesConnections<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIdentityProfilesConnections {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IdentityProfilesConnections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IdentityProfilesConnections

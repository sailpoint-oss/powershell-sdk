...
function Initialize-V2025EventAttributes {
    [CmdletBinding()]
    Param (
...
EventAttributes<PSCustomObject>
#>
function ConvertFrom-V2025JsonToEventAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025EventAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025EventAttributes

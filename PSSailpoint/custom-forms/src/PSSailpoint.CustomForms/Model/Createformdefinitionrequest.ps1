...
function Initialize-Createformdefinitionrequest {
    [CmdletBinding()]
    Param (
...
Createformdefinitionrequest<PSCustomObject>
#>
function ConvertFrom-JsonToCreateformdefinitionrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Createformdefinitionrequest

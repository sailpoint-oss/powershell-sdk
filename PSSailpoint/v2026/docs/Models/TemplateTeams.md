...
keywords: ['powershell', 'PowerShell', 'sdk', 'TemplateTeams', 'V2026TemplateTeams'] 
slug: /tools/sdk/powershell/v2026/models/template-teams
...
```powershell
$TemplateTeams = Initialize-V2026TemplateTeams  -Key null `
 -Title null `

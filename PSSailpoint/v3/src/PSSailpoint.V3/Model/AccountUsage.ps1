...
function Initialize-AccountUsage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccountUsage' | Write-Debug
...
AccountUsage<PSCustomObject>
#>
function ConvertFrom-JsonToAccountUsage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccountUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountUsage

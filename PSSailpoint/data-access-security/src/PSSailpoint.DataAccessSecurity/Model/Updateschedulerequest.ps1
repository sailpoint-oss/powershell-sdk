...
Updateschedulerequest<PSCustomObject>
#>

function Initialize-Updateschedulerequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DataAccessSecurityV1 => Updateschedulerequest' | Write-Debug
...
Convert from JSON to Updateschedulerequest<PSCustomObject>
...
Updateschedulerequest<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateschedulerequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DataAccessSecurityV1 => Updateschedulerequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Updateschedulerequest

...
function Initialize-V2024IdentityProfilesConnections {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityProfilesConnections' | Write-Debug
...
IdentityProfilesConnections<PSCustomObject>
#>
function ConvertFrom-V2024JsonToIdentityProfilesConnections {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityProfilesConnections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024IdentityProfilesConnections

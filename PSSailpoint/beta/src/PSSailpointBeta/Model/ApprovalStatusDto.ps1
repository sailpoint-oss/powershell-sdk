...
function Initialize-BetaApprovalStatusDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaApprovalStatusDto' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalStatusDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaApprovalStatusDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

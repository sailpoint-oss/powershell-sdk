...
function Initialize-V2024WorkflowExecution {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkflowExecution' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowExecution {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkflowExecution' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

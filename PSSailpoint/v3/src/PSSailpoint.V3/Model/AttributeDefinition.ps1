...
function Initialize-AttributeDefinition {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AttributeDefinition' | Write-Debug
...
function ConvertFrom-JsonToAttributeDefinition {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AttributeDefinition' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

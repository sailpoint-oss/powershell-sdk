...
Describe -tag 'PSSailpoint.V2026' -name 'V2026IdpDetails' {
    Context 'V2026IdpDetails' {
        It 'Initialize-V2026IdpDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-V2026IdpDetails -Role "TEST_VALUE" -EntityId "TEST_VALUE" -Binding "TEST_VALUE" -AuthnContext "TEST_VALUE" -LogoutUrl "TEST_VALUE" -IncludeAuthnContext "TEST_VALUE" -NameId "TEST_VALUE" -JitConfiguration "TEST_VALUE" -Cert "TEST_VALUE" -LoginUrlPost "TEST_VALUE" -LoginUrlRedirect "TEST_VALUE" -MappingAttribute "TEST_VALUE" -CertificateExpirationDate "TEST_VALUE" -CertificateName "TEST_VALUE"

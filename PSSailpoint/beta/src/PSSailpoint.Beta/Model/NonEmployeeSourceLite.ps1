...
function Initialize-BetaNonEmployeeSourceLite {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeSourceLite' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSourceLite {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeSourceLite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

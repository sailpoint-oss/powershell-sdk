...
function Initialize-Accessmodelmetadata {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.EntitlementsV1 => Accessmodelmetadata' | Write-Debug
...
Accessmodelmetadata<PSCustomObject>
#>
function ConvertFrom-JsonToAccessmodelmetadata {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.EntitlementsV1 => Accessmodelmetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accessmodelmetadata

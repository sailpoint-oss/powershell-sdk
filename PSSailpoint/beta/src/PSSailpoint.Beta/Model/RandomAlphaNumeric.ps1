...
function Initialize-BetaRandomAlphaNumeric {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRandomAlphaNumeric' | Write-Debug
...
function ConvertFrom-BetaJsonToRandomAlphaNumeric {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRandomAlphaNumeric' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Machineidentityaggregationresponse {
    [CmdletBinding()]
    Param (
...
Machineidentityaggregationresponse<PSCustomObject>
#>
function ConvertFrom-JsonToMachineidentityaggregationresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Machineidentityaggregationresponse

...
function New-V2024Segment {
    ...
    Process {
        'Calling method: New-V2024Segment' | Write-Debug
...
function Remove-V2024Segment {
    ...
    Process {
        'Calling method: Remove-V2024Segment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2024Segment {
    ...
    Process {
        'Calling method: Get-V2024Segment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2024Segments {
    ...
    Process {
        'Calling method: Get-V2024Segments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-V2024Segment {
    ...
    Process {
        'Calling method: Update-V2024Segment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/segments/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling patchSegment."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

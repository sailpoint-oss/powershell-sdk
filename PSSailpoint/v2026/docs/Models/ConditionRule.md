...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConditionRule', 'V2026ConditionRule'] 
slug: /tools/sdk/powershell/v2026/models/condition-rule
...
```powershell
$ConditionRule = Initialize-V2026ConditionRule  -SourceType ELEMENT `
 -Source department `
 -Operator EQ `
 -ValueType STRING `
 -Value Engineering

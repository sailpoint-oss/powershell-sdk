...
function New-ParameterV1 {
    ...
    Process {
        'Calling method: New-ParameterV1' | Write-Debug
...
function Remove-ParameterV1 {
    ...
    Process {
        'Calling method: Remove-ParameterV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/parameter-storage/v1/parameters/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteParameterV1."
        }
...
function Get-AttestationDocumentV1 {
    ...
    Process {
        'Calling method: Get-AttestationDocumentV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/parameter-storage/v1/attestation'

        if (!$Key) {
            throw "Error! The required parameter `Key` missing when calling getAttestationDocumentV1."
        }
...
function Get-ParameterReferencesV1 {
    ...
    Process {
        'Calling method: Get-ParameterReferencesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/parameter-storage/v1/parameters/{id}/references'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getParameterReferencesV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
None
#>
function Get-ParameterStorageSpecificationV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-ParameterStorageSpecificationV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-ParameterV1 {
    ...
    Process {
        'Calling method: Get-ParameterV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/parameter-storage/v1/parameters/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getParameterV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Search-ParametersV1 {
    ...
    Process {
        'Calling method: Search-ParametersV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-ParameterV1 {
    ...
    Process {
        'Calling method: Update-ParameterV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/parameter-storage/v1/parameters/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling updateParameterV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

...
function Initialize-BetaOwnerReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaOwnerReference' | Write-Debug
...
function ConvertFrom-BetaJsonToOwnerReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaOwnerReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

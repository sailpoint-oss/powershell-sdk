...
BaseAccessAllOf<PSCustomObject>
#>

function Initialize-BaseAccessAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => BaseAccessAllOf' | Write-Debug
...
Convert from JSON to BaseAccessAllOf<PSCustomObject>
...
BaseAccessAllOf<PSCustomObject>
#>
function ConvertFrom-JsonToBaseAccessAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => BaseAccessAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BaseAccessAllOf

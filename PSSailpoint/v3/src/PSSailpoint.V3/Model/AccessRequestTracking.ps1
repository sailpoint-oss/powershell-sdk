...
function Initialize-AccessRequestTracking {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessRequestTracking' | Write-Debug
...
AccessRequestTracking<PSCustomObject>
#>
function ConvertFrom-JsonToAccessRequestTracking {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessRequestTracking' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccessRequestTracking

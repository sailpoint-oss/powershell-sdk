...
function Initialize-V2024UpdateDetail {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024UpdateDetail' | Write-Debug
...
function ConvertFrom-V2024JsonToUpdateDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024UpdateDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

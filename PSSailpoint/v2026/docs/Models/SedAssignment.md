...
keywords: ['powershell', 'PowerShell', 'sdk', 'SedAssignment', 'V2026SedAssignment'] 
slug: /tools/sdk/powershell/v2026/models/sed-assignment
...
```powershell
$SedAssignment = Initialize-V2026SedAssignment  -Assignee null `
 -Items null
```

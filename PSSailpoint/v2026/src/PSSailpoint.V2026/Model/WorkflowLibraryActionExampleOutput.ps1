...
#>
function ConvertFrom-V2026JsonToWorkflowLibraryActionExampleOutput {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'SystemCollectionsHashtable' defined in oneOf (V2026WorkflowLibraryActionExampleOutput). Proceeding to the next one if any."
        }

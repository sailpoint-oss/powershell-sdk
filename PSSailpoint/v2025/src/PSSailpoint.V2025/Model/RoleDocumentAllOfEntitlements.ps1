...
function Initialize-V2025RoleDocumentAllOfEntitlements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleDocumentAllOfEntitlements' | Write-Debug
...
RoleDocumentAllOfEntitlements<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleDocumentAllOfEntitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleDocumentAllOfEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleDocumentAllOfEntitlements

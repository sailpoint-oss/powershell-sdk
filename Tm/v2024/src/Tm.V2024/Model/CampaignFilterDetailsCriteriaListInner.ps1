...
function Initialize-V2024CampaignFilterDetailsCriteriaListInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CampaignFilterDetailsCriteriaListInner' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignFilterDetailsCriteriaListInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CampaignFilterDetailsCriteriaListInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BulkIdentitiesAccountsResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Accounts => BulkIdentitiesAccountsResponse' | Write-Debug
...
function ConvertFrom-JsonToBulkIdentitiesAccountsResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Accounts => BulkIdentitiesAccountsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

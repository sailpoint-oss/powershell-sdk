...
function Initialize-BetaRoleMiningSessionDraftRoleDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionDraftRoleDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningSessionDraftRoleDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionDraftRoleDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

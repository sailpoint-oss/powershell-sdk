...
function Initialize-V2024IdentityHistoryResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityHistoryResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityHistoryResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityHistoryResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

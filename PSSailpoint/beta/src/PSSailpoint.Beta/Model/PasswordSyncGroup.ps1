...
function Initialize-BetaPasswordSyncGroup {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaPasswordSyncGroup' | Write-Debug
...
function ConvertFrom-BetaJsonToPasswordSyncGroup {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaPasswordSyncGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

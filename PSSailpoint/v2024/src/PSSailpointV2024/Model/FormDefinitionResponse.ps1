...
function Initialize-V2024FormDefinitionResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024FormDefinitionResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToFormDefinitionResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024FormDefinitionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ObjectMappingBulkCreateRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ObjectMappingBulkCreateRequest' | Write-Debug
...
function ConvertFrom-JsonToObjectMappingBulkCreateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ObjectMappingBulkCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

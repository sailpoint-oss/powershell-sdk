...
function Initialize-Identityentitlements {
    [CmdletBinding()]
    Param (
...
Identityentitlements<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityentitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Identityentitlements

...
function Initialize-V2024ManagedClient {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManagedClient' | Write-Debug
...
ManagedClient<PSCustomObject>
#>
function ConvertFrom-V2024JsonToManagedClient {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
#>
function New-V2024PersonalAccessToken {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2024PersonalAccessToken' | Write-Debug
...
None
#>
function Remove-V2024PersonalAccessToken {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2024PersonalAccessToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2024PersonalAccessTokens {
    ...
    Process {
        'Calling method: Get-V2024PersonalAccessTokens' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-V2024PersonalAccessToken {
    ...
    Process {
        'Calling method: Update-V2024PersonalAccessToken' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

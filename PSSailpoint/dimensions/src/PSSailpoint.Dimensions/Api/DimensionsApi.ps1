...
function New-DimensionV1 {
    ...
    Process {
        'Calling method: New-DimensionV1' | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{roleId}/dimensions'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling createDimensionV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))

        if (!$Dimension) {
            throw "Error! The required parameter `Dimension` missing when calling createDimensionV1."
        }
...
function Remove-BulkDimensionsV1 {
    ...
    Process {
        'Calling method: Remove-BulkDimensionsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{roleId}/dimensions/bulk-delete'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling deleteBulkDimensionsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
...
function Remove-DimensionV1 {
    ...
    Process {
        'Calling method: Remove-DimensionV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{roleId}/dimensions/{dimensionId}'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling deleteDimensionV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
        if (!$DimensionId) {
            throw "Error! The required parameter `DimensionId` missing when calling deleteDimensionV1."
        }
...
Entitlement[]
#>
function Get-DimensionEntitlementsV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-DimensionEntitlementsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{roleId}/dimensions/{dimensionId}/entitlements'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling getDimensionEntitlementsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
        if (!$DimensionId) {
            throw "Error! The required parameter `DimensionId` missing when calling getDimensionEntitlementsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{dimensionId}', [System.Web.HTTPUtility]::UrlEncode($DimensionId))
...
function Get-DimensionV1 {
    ...
    Process {
        'Calling method: Get-DimensionV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{roleId}/dimensions/{dimensionId}'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling getDimensionV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
        if (!$DimensionId) {
            throw "Error! The required parameter `DimensionId` missing when calling getDimensionV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{dimensionId}', [System.Web.HTTPUtility]::UrlEncode($DimensionId))
...
function Get-DimensionAccessProfilesV1 {
    ...
    Process {
        'Calling method: Get-DimensionAccessProfilesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{roleId}/dimensions/{dimensionId}/access-profiles'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling listDimensionAccessProfilesV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
        if (!$DimensionId) {
            throw "Error! The required parameter `DimensionId` missing when calling listDimensionAccessProfilesV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{dimensionId}', [System.Web.HTTPUtility]::UrlEncode($DimensionId))
...
function Get-DimensionsV1 {
    ...
    Process {
        'Calling method: Get-DimensionsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{roleId}/dimensions'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling listDimensionsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
...
function Update-DimensionV1 {
    ...
    Process {
        'Calling method: Update-DimensionV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{roleId}/dimensions/{dimensionId}'
        if (!$RoleId) {
            throw "Error! The required parameter `RoleId` missing when calling patchDimensionV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{roleId}', [System.Web.HTTPUtility]::UrlEncode($RoleId))
        if (!$DimensionId) {
            throw "Error! The required parameter `DimensionId` missing when calling patchDimensionV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{dimensionId}', [System.Web.HTTPUtility]::UrlEncode($DimensionId))

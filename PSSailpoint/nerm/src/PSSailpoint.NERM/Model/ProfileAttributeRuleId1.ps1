...
ProfileAttributeRuleId1<PSCustomObject>
#>

function Initialize-NERMProfileAttributeRuleId1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMProfileAttributeRuleId1' | Write-Debug
...
Convert from JSON to ProfileAttributeRuleId1<PSCustomObject>
...
ProfileAttributeRuleId1<PSCustomObject>
#>
function ConvertFrom-NERMJsonToProfileAttributeRuleId1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMProfileAttributeRuleId1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMProfileAttributeRuleId1

...
function Initialize-Identityentitlementdetailsaccounttarget {
    [CmdletBinding()]
    Param (
...
Identityentitlementdetailsaccounttarget<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityentitlementdetailsaccounttarget {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Identityentitlementdetailsaccounttarget

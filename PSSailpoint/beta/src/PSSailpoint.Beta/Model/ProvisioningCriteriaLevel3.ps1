...
function Initialize-BetaProvisioningCriteriaLevel3 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaProvisioningCriteriaLevel3' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningCriteriaLevel3 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaProvisioningCriteriaLevel3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

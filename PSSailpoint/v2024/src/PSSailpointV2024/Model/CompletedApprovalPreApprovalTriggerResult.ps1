...
function Initialize-V2024CompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CompletedApprovalPreApprovalTriggerResult' | Write-Debug
...
function ConvertFrom-V2024JsonToCompletedApprovalPreApprovalTriggerResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CompletedApprovalPreApprovalTriggerResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

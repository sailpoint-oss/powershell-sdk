...
function Initialize-V2026ConnectorRuleCreateRequestSignature {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ConnectorRuleCreateRequestSignature' | Write-Debug
...
ConnectorRuleCreateRequestSignature<PSCustomObject>
#>
function ConvertFrom-V2026JsonToConnectorRuleCreateRequestSignature {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ConnectorRuleCreateRequestSignature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ConnectorRuleCreateRequestSignature

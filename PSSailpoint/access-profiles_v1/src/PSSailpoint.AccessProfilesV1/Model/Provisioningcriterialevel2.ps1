...
function Initialize-Provisioningcriterialevel2 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfilesV1 => Provisioningcriterialevel2' | Write-Debug
...
function ConvertFrom-JsonToProvisioningcriterialevel2 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfilesV1 => Provisioningcriterialevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

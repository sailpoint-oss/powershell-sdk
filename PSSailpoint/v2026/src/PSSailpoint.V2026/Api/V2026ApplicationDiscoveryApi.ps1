...
#>
function Get-V2026DiscoveredApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2026DiscoveredApplications' | Write-Debug
...
#>
function Get-V2026ManualDiscoverApplicationsCsvTemplate {
    [CmdletBinding()]
    Param (
        [String]
    ...
    Process {
        'Calling method: Get-V2026ManualDiscoverApplicationsCsvTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Send-V2026ManualDiscoverApplicationsCsvTemplate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.IO.FileInfo]
    ...
    Process {
        'Calling method: Send-V2026ManualDiscoverApplicationsCsvTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Start-V2026ApplicationDiscovery {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Start-V2026ApplicationDiscovery' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

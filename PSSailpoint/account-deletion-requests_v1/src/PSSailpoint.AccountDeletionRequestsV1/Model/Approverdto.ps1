...
function Initialize-Approverdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccountDeletionRequestsV1 => Approverdto' | Write-Debug
...
Approverdto<PSCustomObject>
#>
function ConvertFrom-JsonToApproverdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccountDeletionRequestsV1 => Approverdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Approverdto

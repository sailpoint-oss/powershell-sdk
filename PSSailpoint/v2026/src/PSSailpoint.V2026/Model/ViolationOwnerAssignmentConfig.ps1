...
function Initialize-V2026ViolationOwnerAssignmentConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ViolationOwnerAssignmentConfig' | Write-Debug
...
ViolationOwnerAssignmentConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToViolationOwnerAssignmentConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ViolationOwnerAssignmentConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ViolationOwnerAssignmentConfig

...
function Initialize-V2024NameNormalizer {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NameNormalizer' | Write-Debug
...
function ConvertFrom-V2024JsonToNameNormalizer {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NameNormalizer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

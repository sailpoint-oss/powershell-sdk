...
slug: /tools/sdk/powershell/machineaccounts/models/machine-account
...
**MachineIdentity** | **AnyType** | The machine identity this account is associated with | [optional] 
**OwnerIdentity** | **AnyType** | The identity who owns this account. | [optional] 
...
**Attributes** | **map[string]AnyType** | Custom attributes specific to the machine account | [optional] 
**ConnectorAttributes** | **map[string]AnyType** | The connector attributes for the account | [required]

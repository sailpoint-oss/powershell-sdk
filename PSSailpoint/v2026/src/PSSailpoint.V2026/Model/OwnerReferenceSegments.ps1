...
function Initialize-V2026OwnerReferenceSegments {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026OwnerReferenceSegments' | Write-Debug
...
OwnerReferenceSegments<PSCustomObject>
#>
function ConvertFrom-V2026JsonToOwnerReferenceSegments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026OwnerReferenceSegments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026OwnerReferenceSegments

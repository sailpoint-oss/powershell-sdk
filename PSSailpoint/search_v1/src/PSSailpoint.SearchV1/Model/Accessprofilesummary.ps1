...
function Initialize-Accessprofilesummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => Accessprofilesummary' | Write-Debug
...
function ConvertFrom-JsonToAccessprofilesummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => Accessprofilesummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024IdentityProfileIdentityErrorReportArguments {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityProfileIdentityErrorReportArguments' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityProfileIdentityErrorReportArguments {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityProfileIdentityErrorReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

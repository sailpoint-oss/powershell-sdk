...
function Initialize-V2024TaskResultResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TaskResultResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToTaskResultResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TaskResultResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

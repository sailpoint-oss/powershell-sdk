...
Rule<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRule {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            $matchInstance = ConvertFrom-V2026JsonToGenerateRandomString $Json
            ...
            Write-Debug "Failed to match 'GenerateRandomString' defined in oneOf (V2026Rule). Proceeding to the next one if any."
        }

        # try to match GetReferenceIdentityAttribute defined in the oneOf schemas
        try {
            $matchInstance = ConvertFrom-V2026JsonToGetReferenceIdentityAttribute $Json
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'GetReferenceIdentityAttribute' defined in oneOf (V2026Rule). Proceeding to the next one if any."
        }

        # try to match TransformRule defined in the oneOf schemas
        try {
            $matchInstance = ConvertFrom-V2026JsonToTransformRule $Json
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'TransformRule' defined in oneOf (V2026Rule). Proceeding to the next one if any."
        }

...
function Initialize-V2024SourceAccountDeleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SourceAccountDeleted' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceAccountDeleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SourceAccountDeleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-AccessItemRoleResponse {
    [CmdletBinding()]
    Param (
...
AccessItemRoleResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAccessItemRoleResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccessItemRoleResponse

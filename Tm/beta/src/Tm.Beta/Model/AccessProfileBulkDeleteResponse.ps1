...
function Initialize-BetaAccessProfileBulkDeleteResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessProfileBulkDeleteResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileBulkDeleteResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessProfileBulkDeleteResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

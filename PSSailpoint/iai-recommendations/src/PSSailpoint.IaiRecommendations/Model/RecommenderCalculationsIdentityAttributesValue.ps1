...
function Initialize-RecommenderCalculationsIdentityAttributesValue {
    [CmdletBinding()]
    Param (
...
RecommenderCalculationsIdentityAttributesValue<PSCustomObject>
#>
function ConvertFrom-JsonToRecommenderCalculationsIdentityAttributesValue {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in RecommenderCalculationsIdentityAttributesValue
        $AllProperties = ("value")

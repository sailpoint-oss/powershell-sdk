...
function Initialize-V2024BulkAddTaggedObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024BulkAddTaggedObject' | Write-Debug
...
function ConvertFrom-V2024JsonToBulkAddTaggedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024BulkAddTaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

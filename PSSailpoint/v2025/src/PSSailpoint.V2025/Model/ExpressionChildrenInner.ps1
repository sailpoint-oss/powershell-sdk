...
function Initialize-V2025ExpressionChildrenInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ExpressionChildrenInner' | Write-Debug
...
ExpressionChildrenInner<PSCustomObject>
#>
function ConvertFrom-V2025JsonToExpressionChildrenInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ExpressionChildrenInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ExpressionChildrenInner

...
function Initialize-V2026ReassignmentTrailDTO {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ReassignmentTrailDTO' | Write-Debug
...
ReassignmentTrailDTO<PSCustomObject>
#>
function ConvertFrom-V2026JsonToReassignmentTrailDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ReassignmentTrailDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ReassignmentTrailDTO

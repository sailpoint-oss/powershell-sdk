...
function Initialize-BetaCampaignAlert {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCampaignAlert' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignAlert {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCampaignAlert' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

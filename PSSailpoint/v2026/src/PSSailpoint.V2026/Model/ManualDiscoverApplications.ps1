...
function Initialize-V2026ManualDiscoverApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ManualDiscoverApplications' | Write-Debug
...
ManualDiscoverApplications<PSCustomObject>
#>
function ConvertFrom-V2026JsonToManualDiscoverApplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ManualDiscoverApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ManualDiscoverApplications
        $AllProperties = ("file")

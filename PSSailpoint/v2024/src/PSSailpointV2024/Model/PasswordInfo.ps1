...
function Initialize-V2024PasswordInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PasswordInfo' | Write-Debug
...
function ConvertFrom-V2024JsonToPasswordInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PasswordInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

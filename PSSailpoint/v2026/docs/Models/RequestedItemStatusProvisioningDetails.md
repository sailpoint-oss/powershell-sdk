...
keywords: ['powershell', 'PowerShell', 'sdk', 'RequestedItemStatusProvisioningDetails', 'V2026RequestedItemStatusProvisioningDetails'] 
slug: /tools/sdk/powershell/v2026/models/requested-item-status-provisioning-details
...
```powershell
$RequestedItemStatusProvisioningDetails = Initialize-V2026RequestedItemStatusProvisioningDetails  -OrderedSubPhaseReferences manualWorkItemDetails
```

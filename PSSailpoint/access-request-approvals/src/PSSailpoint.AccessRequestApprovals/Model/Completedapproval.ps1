...
function Initialize-Completedapproval {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestApprovals => Completedapproval' | Write-Debug
...
function ConvertFrom-JsonToCompletedapproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestApprovals => Completedapproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

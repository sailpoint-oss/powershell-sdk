...
function Initialize-V2026JsonPatchOperationRoleMining {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026JsonPatchOperationRoleMining' | Write-Debug
...
JsonPatchOperationRoleMining<PSCustomObject>
#>
function ConvertFrom-V2026JsonToJsonPatchOperationRoleMining {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026JsonPatchOperationRoleMining' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026JsonPatchOperationRoleMining

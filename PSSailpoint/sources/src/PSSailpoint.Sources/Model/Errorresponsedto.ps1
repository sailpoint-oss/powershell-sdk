...
function Initialize-Errorresponsedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Sources => Errorresponsedto' | Write-Debug
...
function ConvertFrom-JsonToErrorresponsedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Sources => Errorresponsedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SearchFormDefinitionsByTenant400Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SearchFormDefinitionsByTenant400Response' | Write-Debug
...
function ConvertFrom-V2024JsonToSearchFormDefinitionsByTenant400Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SearchFormDefinitionsByTenant400Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025NonEmployeeSchemaAttribute {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeSchemaAttribute' | Write-Debug
...
NonEmployeeSchemaAttribute<PSCustomObject>
#>
function ConvertFrom-V2025JsonToNonEmployeeSchemaAttribute {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeSchemaAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025NonEmployeeSchemaAttribute

...
function Initialize-V2024LoadEntitlementTask {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024LoadEntitlementTask' | Write-Debug
...
function ConvertFrom-V2024JsonToLoadEntitlementTask {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024LoadEntitlementTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

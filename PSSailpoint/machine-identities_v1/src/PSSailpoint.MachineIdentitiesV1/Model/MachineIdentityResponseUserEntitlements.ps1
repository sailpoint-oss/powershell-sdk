...
function Initialize-MachineIdentityResponseUserEntitlements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentitiesV1 => MachineIdentityResponseUserEntitlements' | Write-Debug
...
MachineIdentityResponseUserEntitlements<PSCustomObject>
#>
function ConvertFrom-JsonToMachineIdentityResponseUserEntitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentitiesV1 => MachineIdentityResponseUserEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MachineIdentityResponseUserEntitlements

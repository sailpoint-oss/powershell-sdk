...
ListSourcesV1401Response<PSCustomObject>
#>

function Initialize-ListSourcesV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ListSourcesV1401Response<PSCustomObject>
...
ListSourcesV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToListSourcesV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ListSourcesV1401Response
        $AllProperties = ("error")

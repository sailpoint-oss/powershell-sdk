...
function Initialize-BetaManuallyUpdatedFieldsDTO {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaManuallyUpdatedFieldsDTO' | Write-Debug
...
function ConvertFrom-BetaJsonToManuallyUpdatedFieldsDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaManuallyUpdatedFieldsDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

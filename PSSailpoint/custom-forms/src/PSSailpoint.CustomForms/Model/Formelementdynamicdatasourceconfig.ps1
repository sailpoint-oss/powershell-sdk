...
function Initialize-Formelementdynamicdatasourceconfig {
    [CmdletBinding()]
    Param (
...
Formelementdynamicdatasourceconfig<PSCustomObject>
#>
function ConvertFrom-JsonToFormelementdynamicdatasourceconfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Formelementdynamicdatasourceconfig

...
keywords: ['powershell', 'PowerShell', 'sdk', 'SodViolationContextConflictingAccessCriteria', 'V2026SodViolationContextConflictingAccessCriteria'] 
slug: /tools/sdk/powershell/v2026/models/sod-violation-context-conflicting-access-criteria
...
```powershell
$SodViolationContextConflictingAccessCriteria = Initialize-V2026SodViolationContextConflictingAccessCriteria  -LeftCriteria null `
 -RightCriteria null
```

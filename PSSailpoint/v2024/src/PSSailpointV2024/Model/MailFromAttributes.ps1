...
function Initialize-V2024MailFromAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024MailFromAttributes' | Write-Debug
...
function ConvertFrom-V2024JsonToMailFromAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024MailFromAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

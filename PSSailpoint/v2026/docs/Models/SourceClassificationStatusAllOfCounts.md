...
keywords: ['powershell', 'PowerShell', 'sdk', 'SourceClassificationStatusAllOfCounts', 'V2026SourceClassificationStatusAllOfCounts'] 
slug: /tools/sdk/powershell/v2026/models/source-classification-status-all-of-counts
...
```powershell
$SourceClassificationStatusAllOfCounts = Initialize-V2026SourceClassificationStatusAllOfCounts  -EXPECTED 1000 `
 -RECEIVED 800 `
 -COMPLETED 500
```

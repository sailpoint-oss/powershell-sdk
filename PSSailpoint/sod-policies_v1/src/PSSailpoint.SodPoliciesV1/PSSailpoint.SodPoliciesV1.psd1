#
# Module manifest for module 'PSSailpoint.SodPoliciesV1'
#
...
RootModule = 'PSSailpoint.SodPoliciesV1.psm1'
...
Description = 'PSSailpoint.SodPoliciesV1 - the PowerShell module for Identity Security Cloud API - SOD Policies'

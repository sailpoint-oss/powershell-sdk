...
TenantUiMetadataItemResponse<PSCustomObject>
#>

function Initialize-V2024TenantUiMetadataItemResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TenantUiMetadataItemResponse' | Write-Debug
...
Convert from JSON to TenantUiMetadataItemResponse<PSCustomObject>
...
TenantUiMetadataItemResponse<PSCustomObject>
#>
function ConvertFrom-V2024JsonToTenantUiMetadataItemResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TenantUiMetadataItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024TenantUiMetadataItemResponse

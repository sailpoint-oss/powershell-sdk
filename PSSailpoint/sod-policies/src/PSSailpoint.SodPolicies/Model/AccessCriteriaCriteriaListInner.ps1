...
function Initialize-AccessCriteriaCriteriaListInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SodPolicies => AccessCriteriaCriteriaListInner' | Write-Debug
...
function ConvertFrom-JsonToAccessCriteriaCriteriaListInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SodPolicies => AccessCriteriaCriteriaListInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Entitlementattributebulkupdateidsrequest {
    [CmdletBinding()]
    Param (
...
Entitlementattributebulkupdateidsrequest<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementattributebulkupdateidsrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Entitlementattributebulkupdateidsrequest

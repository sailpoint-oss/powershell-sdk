...
function Initialize-DependantAppConnectionsAccountSource {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => DependantAppConnectionsAccountSource' | Write-Debug
...
function ConvertFrom-JsonToDependantAppConnectionsAccountSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => DependantAppConnectionsAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

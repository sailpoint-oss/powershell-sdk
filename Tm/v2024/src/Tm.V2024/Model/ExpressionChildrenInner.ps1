...
function Initialize-V2024ExpressionChildrenInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ExpressionChildrenInner' | Write-Debug
...
function ConvertFrom-V2024JsonToExpressionChildrenInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ExpressionChildrenInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

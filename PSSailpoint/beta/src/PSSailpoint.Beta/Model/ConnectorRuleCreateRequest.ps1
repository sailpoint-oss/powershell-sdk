...
function Initialize-BetaConnectorRuleCreateRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleCreateRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToConnectorRuleCreateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-RequestedItemStatusSodViolationContext {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => RequestedItemStatusSodViolationContext' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemStatusSodViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => RequestedItemStatusSodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

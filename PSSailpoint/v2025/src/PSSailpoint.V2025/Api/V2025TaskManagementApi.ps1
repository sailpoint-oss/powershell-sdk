...
None
#>
function Get-V2025PendingTaskHeaders {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2025PendingTaskHeaders' | Write-Debug
        ...
        $LocalVarResult = Invoke-V2025ApiClient -Method 'HEAD' `
                                -Uri $LocalVarUri `
...
TaskStatus[]
#>
function Get-V2025PendingTasks {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025PendingTasks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025TaskStatus {
    ...
    Process {
        'Calling method: Get-V2025TaskStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaskStatus[]
#>
function Get-V2025TaskStatusList {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025TaskStatusList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TaskStatus
#>
function Update-V2025TaskStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025TaskStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

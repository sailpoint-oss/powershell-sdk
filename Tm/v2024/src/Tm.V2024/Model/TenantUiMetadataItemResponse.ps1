...
function Initialize-V2024TenantUiMetadataItemResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024TenantUiMetadataItemResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToTenantUiMetadataItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024TenantUiMetadataItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024TaskResultSimplified {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024TaskResultSimplified' | Write-Debug
...
function ConvertFrom-V2024JsonToTaskResultSimplified {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024TaskResultSimplified' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024FilterAggregation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024FilterAggregation' | Write-Debug
...
function ConvertFrom-V2024JsonToFilterAggregation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024FilterAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'NonEmployeeBulkUploadStatus', 'V2026NonEmployeeBulkUploadStatus'] 
slug: /tools/sdk/powershell/v2026/models/non-employee-bulk-upload-status
...
```powershell
$NonEmployeeBulkUploadStatus = Initialize-V2026NonEmployeeBulkUploadStatus  -Status PENDING
```

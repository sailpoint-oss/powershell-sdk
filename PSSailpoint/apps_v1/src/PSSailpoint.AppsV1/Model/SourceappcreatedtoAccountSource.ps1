...
function Initialize-SourceappcreatedtoAccountSource {
    [CmdletBinding()]
    Param (
...
SourceappcreatedtoAccountSource<PSCustomObject>
#>
function ConvertFrom-JsonToSourceappcreatedtoAccountSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SourceappcreatedtoAccountSource

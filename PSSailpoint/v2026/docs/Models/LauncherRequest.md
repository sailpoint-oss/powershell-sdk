...
keywords: ['powershell', 'PowerShell', 'sdk', 'LauncherRequest', 'V2026LauncherRequest'] 
slug: /tools/sdk/powershell/v2026/models/launcher-request
...
```powershell
$LauncherRequest = Initialize-V2026LauncherRequest  -Name Group Create `

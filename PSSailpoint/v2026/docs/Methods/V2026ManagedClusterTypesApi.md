...
slug: /tools/sdk/powershell/v2026/methods/managed-cluster-types
...
------------- | ------------- | -------------
[**New-V2026ManagedClusterType**](#create-managed-cluster-type) | **POST** `/managed-cluster-types` | Create new managed cluster type
[**Remove-V2026ManagedClusterType**](#delete-managed-cluster-type) | **DELETE** `/managed-cluster-types/{id}` | Delete a managed cluster type
[**Get-V2026ManagedClusterType**](#get-managed-cluster-type) | **GET** `/managed-cluster-types/{id}` | Get a managed cluster type
[**Get-V2026ManagedClusterTypes**](#get-managed-cluster-types) | **GET** `/managed-cluster-types` | List managed cluster types
[**Update-V2026ManagedClusterType**](#update-managed-cluster-type) | **PATCH** `/managed-cluster-types/{id}` | Update a managed cluster type
...
try {
    $Result = ConvertFrom-V2026JsonToManagedClusterType -Json $ManagedClusterType
    New-V2026ManagedClusterType -ManagedClusterType $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026ManagedClusterType -ManagedClusterType $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026ManagedClusterType"
...
try {
    Remove-V2026ManagedClusterType -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026ManagedClusterType -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026ManagedClusterType"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ManagedClusterType -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ManagedClusterType -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ManagedClusterType"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ManagedClusterTypes 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ManagedClusterTypes -Type $Type -Pod $Pod -Org $Org -Offset $Offset -Limit $Limit  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ManagedClusterTypes"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026ManagedClusterType -Id $Id -JsonPatch $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ManagedClusterType -Id $Id -JsonPatch $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ManagedClusterType"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-V2025CampaignActivatedCampaign {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CampaignActivatedCampaign' | Write-Debug
...
CampaignActivatedCampaign<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCampaignActivatedCampaign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CampaignActivatedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CampaignActivatedCampaign

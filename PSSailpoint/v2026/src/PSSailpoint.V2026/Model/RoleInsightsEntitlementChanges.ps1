...
function Initialize-V2026RoleInsightsEntitlementChanges {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleInsightsEntitlementChanges' | Write-Debug
...
RoleInsightsEntitlementChanges<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleInsightsEntitlementChanges {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleInsightsEntitlementChanges' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleInsightsEntitlementChanges

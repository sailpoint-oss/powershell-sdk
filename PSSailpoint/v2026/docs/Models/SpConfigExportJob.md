...
keywords: ['powershell', 'PowerShell', 'sdk', 'SpConfigExportJob', 'V2026SpConfigExportJob'] 
slug: /tools/sdk/powershell/v2026/models/sp-config-export-job
...
```powershell
$SpConfigExportJob = Initialize-V2026SpConfigExportJob  -JobId 3469b87d-48ca-439a-868f-2160001da8c1 `
 -Status COMPLETE `
 -Type IMPORT `

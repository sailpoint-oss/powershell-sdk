...
function Initialize-BetaErrorMessageDto1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaErrorMessageDto1' | Write-Debug
...
ErrorMessageDto1<PSCustomObject>
#>
function ConvertFrom-BetaJsonToErrorMessageDto1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaErrorMessageDto1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaErrorMessageDto1

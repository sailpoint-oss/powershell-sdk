...
function Initialize-AccountAttributesCreate {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => AccountAttributesCreate' | Write-Debug
...
function ConvertFrom-JsonToAccountAttributesCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => AccountAttributesCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

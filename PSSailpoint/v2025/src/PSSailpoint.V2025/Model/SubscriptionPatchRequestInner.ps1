...
function Initialize-V2025SubscriptionPatchRequestInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SubscriptionPatchRequestInner' | Write-Debug
...
SubscriptionPatchRequestInner<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSubscriptionPatchRequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SubscriptionPatchRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SubscriptionPatchRequestInner

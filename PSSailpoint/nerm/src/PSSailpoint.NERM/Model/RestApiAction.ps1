...
RestApiAction<PSCustomObject>
#>

function Initialize-NERMRestApiAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMRestApiAction' | Write-Debug
...
Convert from JSON to RestApiAction<PSCustomObject>
...
RestApiAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToRestApiAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMRestApiAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMRestApiAction

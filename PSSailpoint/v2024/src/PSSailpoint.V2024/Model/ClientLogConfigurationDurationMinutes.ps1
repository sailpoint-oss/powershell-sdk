...
function Initialize-V2024ClientLogConfigurationDurationMinutes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ClientLogConfigurationDurationMinutes' | Write-Debug
...
ClientLogConfigurationDurationMinutes<PSCustomObject>
#>
function ConvertFrom-V2024JsonToClientLogConfigurationDurationMinutes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ClientLogConfigurationDurationMinutes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ClientLogConfigurationDurationMinutes

...
function Initialize-SubSearchAggregationSpecification {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SubSearchAggregationSpecification' | Write-Debug
...
function ConvertFrom-JsonToSubSearchAggregationSpecification {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SubSearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

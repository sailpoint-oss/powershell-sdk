...
function Initialize-SavedSearchDetailFilters {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => SavedSearchDetailFilters' | Write-Debug
...
function ConvertFrom-JsonToSavedSearchDetailFilters {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => SavedSearchDetailFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

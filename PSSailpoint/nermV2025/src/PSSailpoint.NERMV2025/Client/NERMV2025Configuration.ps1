...
Get the configuration object 'NERMV2025Configuration'.
...
#>
function Get-NERMV2025Configuration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://acmeco.nonemployee.com/api/v2025";
    }
...
System.Collections.Hashtable
#>
function Set-NERMV2025Configuration {
...
None
#>
function Set-NERMV2025ConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-NERMV2025ConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-NERMV2025ConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
System.Collections.Hashtable[]
#>
function Get-NERMV2025HostSetting {
    return ,@(
          @{
...
String
#>
function Get-NERMV2025UrlFromHostSetting {
    ...
    Process {
        $Hosts = Get-NERMV2025HostSetting
...
System.Collections.Hashtable
#>
function Set-NERMV2025ConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-NERMV2025KeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'NERMV2025ConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-NERMV2025ConfigurationHttpSigning{

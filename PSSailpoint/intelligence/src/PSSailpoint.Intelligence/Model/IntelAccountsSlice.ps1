...
IntelAccountsSlice<PSCustomObject>
#>

function Initialize-IntelAccountsSlice {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Intelligence => IntelAccountsSlice' | Write-Debug
...
Convert from JSON to IntelAccountsSlice<PSCustomObject>
...
IntelAccountsSlice<PSCustomObject>
#>
function ConvertFrom-JsonToIntelAccountsSlice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Intelligence => IntelAccountsSlice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntelAccountsSlice

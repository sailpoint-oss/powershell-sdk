...
$FunctionPath = "$PSScriptRoot/src/PSSailpoint.SodPolicies/Api", "$PSScriptRoot/src/PSSailpoint.SodPolicies/Client","$PSScriptRoot/src/PSSailpoint.SodPolicies/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\PSSailpoint.SodPolicies\PSSailpoint.SodPolicies.psd1"

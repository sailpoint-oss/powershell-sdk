...
function Initialize-V2025MultiHostIntegrationsConnectorAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025MultiHostIntegrationsConnectorAttributes' | Write-Debug
...
MultiHostIntegrationsConnectorAttributes<PSCustomObject>
#>
function ConvertFrom-V2025JsonToMultiHostIntegrationsConnectorAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025MultiHostIntegrationsConnectorAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json
        $V2025MultiHostIntegrationsConnectorAttributesAdditionalProperties = @{}

        # check if Json contains properties not defined in V2025MultiHostIntegrationsConnectorAttributes
        ...
        foreach ($name in $JsonParameters.PsObject.Properties.Name) {
            ...
            if (!($AllProperties.Contains($name))) {
                $V2025MultiHostIntegrationsConnectorAttributesAdditionalProperties[$name] = $JsonParameters.PSobject.Properties[$name].value
            }
        }
        ...
        $PSO = [PSCustomObject]@{
            ...
            "showEntitlementSchema" = ${ShowEntitlementSchema}
            "multiHostAttributes" = ${MultiHostAttributes}
            "AdditionalProperties" = $V2025MultiHostIntegrationsConnectorAttributesAdditionalProperties
        }

...
function Initialize-V2026RequestedItemStatusProvisioningDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemStatusProvisioningDetails' | Write-Debug
...
RequestedItemStatusProvisioningDetails<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRequestedItemStatusProvisioningDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemStatusProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RequestedItemStatusProvisioningDetails

...
function Initialize-BetaFeatureValueDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFeatureValueDto' | Write-Debug
...
function ConvertFrom-BetaJsonToFeatureValueDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFeatureValueDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025TaskResultSimplified {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025TaskResultSimplified' | Write-Debug
...
TaskResultSimplified<PSCustomObject>
#>
function ConvertFrom-V2025JsonToTaskResultSimplified {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025TaskResultSimplified' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025TaskResultSimplified

...
function Initialize-V2025DecomposeDiacriticalMarks {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025DecomposeDiacriticalMarks' | Write-Debug
...
DecomposeDiacriticalMarks<PSCustomObject>
#>
function ConvertFrom-V2025JsonToDecomposeDiacriticalMarks {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025DecomposeDiacriticalMarks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025DecomposeDiacriticalMarks

...
function Initialize-V2024RequestedAccountRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RequestedAccountRef' | Write-Debug
...
RequestedAccountRef<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRequestedAccountRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RequestedAccountRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RequestedAccountRef

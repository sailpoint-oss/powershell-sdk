...
#>
function Approve-V2026AccessRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Approve-V2026AccessRequest' | Write-Debug
...
SystemCollectionsHashtable
#>
function Invoke-V2026ForwardAccessRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2026ForwardAccessRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ApprovalSummary
#>
function Get-V2026AccessRequestApprovalSummary {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026AccessRequestApprovalSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026AccessRequestApprovers {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026AccessRequestApprovers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CompletedApproval[]
#>
function Get-V2026CompletedApprovals {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026CompletedApprovals' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PendingApproval[]
#>
function Get-V2026PendingApprovals {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026PendingApprovals' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SystemCollectionsHashtable
#>
function Deny-V2026AccessRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Deny-V2026AccessRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

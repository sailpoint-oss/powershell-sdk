...
function New-PasswordOrgConfigV1 {
    ...
    Process {
        'Calling method: New-PasswordOrgConfigV1' | Write-Debug
...
function Get-PasswordOrgConfigV1 {
    ...
    Process {
        'Calling method: Get-PasswordOrgConfigV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Send-PasswordOrgConfigV1 {
    ...
    Process {
        'Calling method: Send-PasswordOrgConfigV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

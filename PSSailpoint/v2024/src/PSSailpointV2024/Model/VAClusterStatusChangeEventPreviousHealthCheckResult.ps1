...
function Initialize-V2024VAClusterStatusChangeEventPreviousHealthCheckResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
...
function ConvertFrom-V2024JsonToVAClusterStatusChangeEventPreviousHealthCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

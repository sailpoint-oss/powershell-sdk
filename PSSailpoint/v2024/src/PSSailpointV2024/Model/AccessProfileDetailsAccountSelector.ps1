...
function Initialize-V2024AccessProfileDetailsAccountSelector {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileDetailsAccountSelector' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileDetailsAccountSelector {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileDetailsAccountSelector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AggregationResult', 'V2026AggregationResult'] 
slug: /tools/sdk/powershell/v2026/models/aggregation-result
...
```powershell
$AggregationResult = Initialize-V2026AggregationResult  -Aggregations {Identity Locations={buckets=[{key=Austin, doc_count=109}, {key=London, doc_count=64}, {key=San Jose, doc_count=27}, {key=Brussels, doc_count=26}, {key=Sao Paulo, doc_count=24}, {key=Munich, doc_count=23}, {key=Singapore, doc_count=22}, {key=Tokyo, doc_count=20}, {key=Taipei, doc_count=16}]}} `
 -Hits null
```

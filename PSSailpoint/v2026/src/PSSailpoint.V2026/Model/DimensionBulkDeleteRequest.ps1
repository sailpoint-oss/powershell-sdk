...
function Initialize-V2026DimensionBulkDeleteRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026DimensionBulkDeleteRequest' | Write-Debug
...
DimensionBulkDeleteRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToDimensionBulkDeleteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026DimensionBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026DimensionBulkDeleteRequest

...
function Initialize-NonEmployeeRequestLite {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagement => NonEmployeeRequestLite' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeRequestLite {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagement => NonEmployeeRequestLite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
JsonPatchOperationRoleMining<PSCustomObject>
#>

function Initialize-V2025JsonPatchOperationRoleMining {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025JsonPatchOperationRoleMining' | Write-Debug
...
Convert from JSON to JsonPatchOperationRoleMining<PSCustomObject>
...
JsonPatchOperationRoleMining<PSCustomObject>
#>
function ConvertFrom-V2025JsonToJsonPatchOperationRoleMining {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025JsonPatchOperationRoleMining' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025JsonPatchOperationRoleMining

...
function Initialize-V2024PutSourceTemplateRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PutSourceTemplateRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToPutSourceTemplateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PutSourceTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

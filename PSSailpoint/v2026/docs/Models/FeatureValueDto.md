...
keywords: ['powershell', 'PowerShell', 'sdk', 'FeatureValueDto', 'V2026FeatureValueDto'] 
slug: /tools/sdk/powershell/v2026/models/feature-value-dto
...
```powershell
$FeatureValueDto = Initialize-V2026FeatureValueDto  -Feature department `
 -Numerator 14 `
 -Denominator 14
```

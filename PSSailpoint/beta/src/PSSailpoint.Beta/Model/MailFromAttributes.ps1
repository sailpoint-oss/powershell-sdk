...
function Initialize-BetaMailFromAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaMailFromAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToMailFromAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaMailFromAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

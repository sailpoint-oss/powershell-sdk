...
function Initialize-BetaManualDiscoverApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaManualDiscoverApplications' | Write-Debug
...
function ConvertFrom-BetaJsonToManualDiscoverApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaManualDiscoverApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

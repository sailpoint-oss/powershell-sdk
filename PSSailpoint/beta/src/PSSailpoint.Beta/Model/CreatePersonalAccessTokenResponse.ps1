...
function Initialize-BetaCreatePersonalAccessTokenResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCreatePersonalAccessTokenResponse' | Write-Debug
...
CreatePersonalAccessTokenResponse<PSCustomObject>
#>
function ConvertFrom-BetaJsonToCreatePersonalAccessTokenResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCreatePersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

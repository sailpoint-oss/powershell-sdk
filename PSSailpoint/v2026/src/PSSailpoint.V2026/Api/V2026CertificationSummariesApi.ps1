...
AccessSummary[]
#>
function Get-V2026IdentityAccessSummaries {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2026IdentityAccessSummaries' | Write-Debug
...
#>
function Get-V2026IdentityDecisionSummary {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentityDecisionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026IdentitySummaries {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentitySummaries' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CertificationIdentitySummary
#>
function Get-V2026IdentitySummary {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026IdentitySummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

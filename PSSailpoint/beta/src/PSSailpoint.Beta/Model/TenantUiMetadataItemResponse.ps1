...
function Initialize-BetaTenantUiMetadataItemResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTenantUiMetadataItemResponse' | Write-Debug
...
TenantUiMetadataItemResponse<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTenantUiMetadataItemResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTenantUiMetadataItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTenantUiMetadataItemResponse

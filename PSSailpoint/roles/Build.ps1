...
$FunctionPath = "$PSScriptRoot/src/PSSailpoint.Roles/Api", "$PSScriptRoot/src/PSSailpoint.Roles/Client","$PSScriptRoot/src/PSSailpoint.Roles/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\PSSailpoint.Roles\PSSailpoint.Roles.psd1"

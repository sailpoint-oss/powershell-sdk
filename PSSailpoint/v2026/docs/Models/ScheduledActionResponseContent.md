...
keywords: ['powershell', 'PowerShell', 'sdk', 'ScheduledActionResponseContent', 'V2026ScheduledActionResponseContent'] 
slug: /tools/sdk/powershell/v2026/models/scheduled-action-response-content
...
```powershell
$ScheduledActionResponseContent = Initialize-V2026ScheduledActionResponseContent  -Name Daily Backup `
 -BackupOptions null `

...
function Initialize-V2024SlimCampaign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SlimCampaign' | Write-Debug
...
function ConvertFrom-V2024JsonToSlimCampaign {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SlimCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

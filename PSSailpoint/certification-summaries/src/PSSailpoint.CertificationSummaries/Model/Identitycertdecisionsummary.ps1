...
function Initialize-Identitycertdecisionsummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationSummariesV1 => Identitycertdecisionsummary' | Write-Debug
...
Identitycertdecisionsummary<PSCustomObject>
#>
function ConvertFrom-JsonToIdentitycertdecisionsummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationSummariesV1 => Identitycertdecisionsummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Identitycertdecisionsummary

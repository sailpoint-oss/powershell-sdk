...
function Initialize-V2024V3ConnectorDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024V3ConnectorDto' | Write-Debug
...
function ConvertFrom-V2024JsonToV3ConnectorDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024V3ConnectorDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

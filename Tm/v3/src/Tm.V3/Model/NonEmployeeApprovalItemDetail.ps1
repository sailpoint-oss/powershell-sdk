...
function Initialize-NonEmployeeApprovalItemDetail {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => NonEmployeeApprovalItemDetail' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeApprovalItemDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => NonEmployeeApprovalItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

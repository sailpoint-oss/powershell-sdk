...
function Initialize-CertificationIdentitySummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => CertificationIdentitySummary' | Write-Debug
...
function ConvertFrom-JsonToCertificationIdentitySummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => CertificationIdentitySummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

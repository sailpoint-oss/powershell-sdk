...
function Initialize-V2025WorkflowLibraryOperator {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025WorkflowLibraryOperator' | Write-Debug
...
WorkflowLibraryOperator<PSCustomObject>
#>
function ConvertFrom-V2025JsonToWorkflowLibraryOperator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025WorkflowLibraryOperator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025WorkflowLibraryOperator

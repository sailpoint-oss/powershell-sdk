...
function Initialize-V2026HierarchicalRightSet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026HierarchicalRightSet' | Write-Debug
...
HierarchicalRightSet<PSCustomObject>
#>
function ConvertFrom-V2026JsonToHierarchicalRightSet {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026HierarchicalRightSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026HierarchicalRightSet

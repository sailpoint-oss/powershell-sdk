...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConnectorCustomizers', 'V2026ConnectorCustomizers'] 
slug: /tools/sdk/powershell/v2026/methods/connector-customizers
...
------------- | ------------- | -------------
[**New-V2026ConnectorCustomizer**](#create-connector-customizer) | **POST** `/connector-customizers` | Create connector customizer
[**New-V2026ConnectorCustomizerVersion**](#create-connector-customizer-version) | **POST** `/connector-customizers/{id}/versions` | Creates a connector customizer version
[**Remove-V2026ConnectorCustomizer**](#delete-connector-customizer) | **DELETE** `/connector-customizers/{id}` | Delete connector customizer
[**Get-V2026ConnectorCustomizer**](#get-connector-customizer) | **GET** `/connector-customizers/{id}` | Get connector customizer
[**Get-V2026ConnectorCustomizers**](#list-connector-customizers) | **GET** `/connector-customizers` | List all connector customizers
[**Send-V2026ConnectorCustomizer**](#put-connector-customizer) | **PUT** `/connector-customizers/{id}` | Update connector customizer
...
try {
    $Result = ConvertFrom-V2026JsonToConnectorCustomizerCreateRequest -Json $ConnectorCustomizerCreateRequest
    New-V2026ConnectorCustomizer -ConnectorCustomizerCreateRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026ConnectorCustomizer -ConnectorCustomizerCreateRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026ConnectorCustomizer"
...
try {
    New-V2026ConnectorCustomizerVersion -Id $Id 
    
    # Below is a request that includes all optional parameters
    # New-V2026ConnectorCustomizerVersion -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026ConnectorCustomizerVersion"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026ConnectorCustomizer -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026ConnectorCustomizer -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026ConnectorCustomizer"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ConnectorCustomizer -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ConnectorCustomizer -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ConnectorCustomizer"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ConnectorCustomizers 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ConnectorCustomizers -Offset $Offset -Limit $Limit  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ConnectorCustomizers"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Send-V2026ConnectorCustomizer -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ConnectorCustomizer -Id $Id -ConnectorCustomizerUpdateRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ConnectorCustomizer"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

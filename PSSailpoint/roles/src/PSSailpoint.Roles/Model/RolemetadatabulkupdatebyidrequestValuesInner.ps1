...
function Initialize-RolemetadatabulkupdatebyidrequestValuesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RolesV1 => RolemetadatabulkupdatebyidrequestValuesInner' | Write-Debug
...
RolemetadatabulkupdatebyidrequestValuesInner<PSCustomObject>
#>
function ConvertFrom-JsonToRolemetadatabulkupdatebyidrequestValuesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RolesV1 => RolemetadatabulkupdatebyidrequestValuesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RolemetadatabulkupdatebyidrequestValuesInner

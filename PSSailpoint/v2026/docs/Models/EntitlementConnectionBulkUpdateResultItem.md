...
keywords: ['powershell', 'PowerShell', 'sdk', 'EntitlementConnectionBulkUpdateResultItem', 'V2026EntitlementConnectionBulkUpdateResultItem'] 
slug: /tools/sdk/powershell/v2026/models/entitlement-connection-bulk-update-result-item
...
```powershell
$EntitlementConnectionBulkUpdateResultItem = Initialize-V2026EntitlementConnectionBulkUpdateResultItem  -ConnectionId d532fa5cb15748e2873c6a01e5923ec4 `
 -Type JIT `
 -Status 201 `
 -Description success
```

...
function Initialize-V2024SodViolationContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SodViolationContext' | Write-Debug
...
function ConvertFrom-V2024JsonToSodViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

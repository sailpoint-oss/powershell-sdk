...
function Initialize-Ref {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DataSegmentationV1 => Ref' | Write-Debug
...
Convert from JSON to Ref<PSCustomObject>
...
Ref<PSCustomObject>
#>
function ConvertFrom-JsonToRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DataSegmentationV1 => Ref' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Ref

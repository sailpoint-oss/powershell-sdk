...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleMiningSessionResponse', 'V2026RoleMiningSessionResponse'] 
slug: /tools/sdk/powershell/v2026/models/role-mining-session-response
...
```powershell
$RoleMiningSessionResponse = Initialize-V2026RoleMiningSessionResponse  -Scope null `

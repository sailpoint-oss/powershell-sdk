...
function Initialize-Createschedulerequest {
    [CmdletBinding()]
    Param (
...
Createschedulerequest<PSCustomObject>
#>
function ConvertFrom-JsonToCreateschedulerequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Createschedulerequest

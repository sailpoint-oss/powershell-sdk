...
keywords: ['powershell', 'PowerShell', 'sdk', 'Workflow', 'V2026Workflow'] 
slug: /tools/sdk/powershell/v2026/models/workflow
...
```powershell
$Workflow = Initialize-V2026Workflow  -Name Send Email `
 -Owner null `

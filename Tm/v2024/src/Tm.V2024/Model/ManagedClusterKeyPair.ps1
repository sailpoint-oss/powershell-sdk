...
function Initialize-V2024ManagedClusterKeyPair {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ManagedClusterKeyPair' | Write-Debug
...
function ConvertFrom-V2024JsonToManagedClusterKeyPair {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ManagedClusterKeyPair' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'MfaOktaConfig', 'V2026MfaOktaConfig'] 
slug: /tools/sdk/powershell/v2026/models/mfa-okta-config
...
```powershell
$MfaOktaConfig = Initialize-V2026MfaOktaConfig  -MfaMethod okta-verify `
 -Enabled true `
 -VarHost example.com `

...
keywords: ['powershell', 'PowerShell', 'sdk', 'SpConfigMessage1', 'V2026SpConfigMessage1'] 
slug: /tools/sdk/powershell/v2026/models/sp-config-message1
...
```powershell
$SpConfigMessage1 = Initialize-V2026SpConfigMessage1  -Key UNKNOWN_REFERENCE_RESOLVER `

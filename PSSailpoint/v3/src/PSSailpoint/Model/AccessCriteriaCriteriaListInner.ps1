...
function Initialize-AccessCriteriaCriteriaListInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => AccessCriteriaCriteriaListInner' | Write-Debug
...
function ConvertFrom-JsonToAccessCriteriaCriteriaListInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => AccessCriteriaCriteriaListInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

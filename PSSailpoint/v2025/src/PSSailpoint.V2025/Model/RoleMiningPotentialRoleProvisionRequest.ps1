...
function Initialize-V2025RoleMiningPotentialRoleProvisionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningPotentialRoleProvisionRequest' | Write-Debug
...
RoleMiningPotentialRoleProvisionRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleMiningPotentialRoleProvisionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningPotentialRoleProvisionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleMiningPotentialRoleProvisionRequest

...
function Initialize-V2024BrandingItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024BrandingItem' | Write-Debug
...
function ConvertFrom-V2024JsonToBrandingItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024BrandingItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaRecommendationResponseDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRecommendationResponseDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommendationResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRecommendationResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

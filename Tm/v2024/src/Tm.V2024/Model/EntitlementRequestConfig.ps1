...
function Initialize-V2024EntitlementRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024EntitlementRequestConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlementRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024EntitlementRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

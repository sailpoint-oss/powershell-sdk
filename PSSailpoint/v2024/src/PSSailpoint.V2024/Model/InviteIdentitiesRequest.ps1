...
function Initialize-V2024InviteIdentitiesRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024InviteIdentitiesRequest' | Write-Debug
...
InviteIdentitiesRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToInviteIdentitiesRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024InviteIdentitiesRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024InviteIdentitiesRequest

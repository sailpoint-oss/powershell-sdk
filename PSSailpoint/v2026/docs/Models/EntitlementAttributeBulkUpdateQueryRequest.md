...
keywords: ['powershell', 'PowerShell', 'sdk', 'EntitlementAttributeBulkUpdateQueryRequest', 'V2026EntitlementAttributeBulkUpdateQueryRequest'] 
slug: /tools/sdk/powershell/v2026/models/entitlement-attribute-bulk-update-query-request
...
```powershell
$EntitlementAttributeBulkUpdateQueryRequest = Initialize-V2026EntitlementAttributeBulkUpdateQueryRequest  -Query null `
 -Operation add `

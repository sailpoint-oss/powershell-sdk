...
function Initialize-V2026UpdateStreamConfigurationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026UpdateStreamConfigurationRequest' | Write-Debug
...
UpdateStreamConfigurationRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToUpdateStreamConfigurationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026UpdateStreamConfigurationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026UpdateStreamConfigurationRequest

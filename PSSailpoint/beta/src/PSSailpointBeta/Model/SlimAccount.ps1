...
SlimAccount<PSCustomObject>
#>

function Initialize-BetaSlimAccount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSlimAccount' | Write-Debug
...
Convert from JSON to SlimAccount<PSCustomObject>
...
SlimAccount<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSlimAccount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSlimAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSlimAccount
        $AllProperties = ("id", "name", "created", "modified", "uuid", "nativeIdentity", "description", "disabled", "locked", "manuallyCorrelated", "hasEntitlements", "sourceId", "sourceName", "identityId", "attributes")

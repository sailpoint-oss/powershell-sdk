...
function Initialize-BetaSavedSearchCompleteSearchResults {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSavedSearchCompleteSearchResults' | Write-Debug
...
function ConvertFrom-BetaJsonToSavedSearchCompleteSearchResults {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSavedSearchCompleteSearchResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

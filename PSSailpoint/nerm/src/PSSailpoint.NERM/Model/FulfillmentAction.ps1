...
FulfillmentAction<PSCustomObject>
#>

function Initialize-NERMFulfillmentAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMFulfillmentAction' | Write-Debug
...
Convert from JSON to FulfillmentAction<PSCustomObject>
...
FulfillmentAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToFulfillmentAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMFulfillmentAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMFulfillmentAction
        $AllProperties = ("workflow_id", "description", "page_id", "archived", "requires_comment")

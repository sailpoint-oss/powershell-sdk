...
function Initialize-V2024Owns {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Owns' | Write-Debug
...
Owns<PSCustomObject>
#>
function ConvertFrom-V2024JsonToOwns {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Owns' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024Owns

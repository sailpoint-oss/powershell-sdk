...
function Initialize-Jsonpatchoperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagement => Jsonpatchoperation' | Write-Debug
...
function ConvertFrom-JsonToJsonpatchoperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagement => Jsonpatchoperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

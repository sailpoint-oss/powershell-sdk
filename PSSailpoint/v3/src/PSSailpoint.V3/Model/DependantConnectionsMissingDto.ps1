...
function Initialize-DependantConnectionsMissingDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => DependantConnectionsMissingDto' | Write-Debug
...
function ConvertFrom-JsonToDependantConnectionsMissingDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => DependantConnectionsMissingDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
RequestAction<PSCustomObject>
#>

function Initialize-NERMRequestAction {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMRequestAction' | Write-Debug
...
Convert from JSON to RequestAction<PSCustomObject>
...
RequestAction<PSCustomObject>
#>
function ConvertFrom-NERMJsonToRequestAction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMRequestAction' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMRequestAction

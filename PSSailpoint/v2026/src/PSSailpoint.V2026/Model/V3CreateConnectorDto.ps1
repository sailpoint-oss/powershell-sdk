...
function Initialize-V2026V3CreateConnectorDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026V3CreateConnectorDto' | Write-Debug
...
V3CreateConnectorDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToV3CreateConnectorDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026V3CreateConnectorDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026V3CreateConnectorDto

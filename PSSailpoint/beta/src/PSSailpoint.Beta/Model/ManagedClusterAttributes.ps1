...
function Initialize-BetaManagedClusterAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaManagedClusterAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToManagedClusterAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaManagedClusterAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Baseaccessprofile {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Search => Baseaccessprofile' | Write-Debug
...
function ConvertFrom-JsonToBaseaccessprofile {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Search => Baseaccessprofile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

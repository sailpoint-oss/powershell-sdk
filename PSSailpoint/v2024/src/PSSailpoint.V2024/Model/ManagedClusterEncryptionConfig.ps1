...
function Initialize-V2024ManagedClusterEncryptionConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManagedClusterEncryptionConfig' | Write-Debug
...
ManagedClusterEncryptionConfig<PSCustomObject>
#>
function ConvertFrom-V2024JsonToManagedClusterEncryptionConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManagedClusterEncryptionConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ManagedClusterEncryptionConfig

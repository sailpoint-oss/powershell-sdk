...
function Initialize-NERMForm {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMForm' | Write-Debug
...
Form<PSCustomObject>
#>
function ConvertFrom-NERMJsonToForm {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMForm' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMForm

...
function Initialize-V2024ObjectImportResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ObjectImportResult' | Write-Debug
...
function ConvertFrom-V2024JsonToObjectImportResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ObjectImportResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaCorrelationConfigAttributeAssignmentsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCorrelationConfigAttributeAssignmentsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToCorrelationConfigAttributeAssignmentsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCorrelationConfigAttributeAssignmentsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024V3CreateConnectorDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024V3CreateConnectorDto' | Write-Debug
...
function ConvertFrom-V2024JsonToV3CreateConnectorDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024V3CreateConnectorDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

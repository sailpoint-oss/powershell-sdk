...
function Initialize-Schedule2Months {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Schedule2Months' | Write-Debug
...
Schedule2Months<PSCustomObject>
#>
function ConvertFrom-JsonToSchedule2Months {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationCampaignsV1 => Schedule2Months' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Schedule2Months

...
function Initialize-ManagedClusterAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ManagedClusterAttributes' | Write-Debug
...
function ConvertFrom-JsonToManagedClusterAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ManagedClusterAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

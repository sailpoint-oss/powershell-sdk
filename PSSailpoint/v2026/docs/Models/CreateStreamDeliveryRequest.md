...
keywords: ['powershell', 'PowerShell', 'sdk', 'CreateStreamDeliveryRequest', 'V2026CreateStreamDeliveryRequest'] 
slug: /tools/sdk/powershell/v2026/models/create-stream-delivery-request
...
```powershell
$CreateStreamDeliveryRequest = Initialize-V2026CreateStreamDeliveryRequest  -Method urn:ietf:rfc:8935 `

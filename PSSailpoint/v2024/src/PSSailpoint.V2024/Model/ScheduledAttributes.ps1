...
function Initialize-V2024ScheduledAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ScheduledAttributes' | Write-Debug
...
function ConvertFrom-V2024JsonToScheduledAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ScheduledAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

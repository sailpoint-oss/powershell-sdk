...
function Initialize-BetaCampaignGeneratedCampaign {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCampaignGeneratedCampaign' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignGeneratedCampaign {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCampaignGeneratedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

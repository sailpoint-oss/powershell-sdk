...
function Initialize-V2025ImportSpConfigRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ImportSpConfigRequest' | Write-Debug
...
ImportSpConfigRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToImportSpConfigRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ImportSpConfigRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ImportSpConfigRequest

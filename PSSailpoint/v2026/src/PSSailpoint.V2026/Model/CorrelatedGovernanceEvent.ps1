...
function Initialize-V2026CorrelatedGovernanceEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CorrelatedGovernanceEvent' | Write-Debug
...
CorrelatedGovernanceEvent<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCorrelatedGovernanceEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CorrelatedGovernanceEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CorrelatedGovernanceEvent

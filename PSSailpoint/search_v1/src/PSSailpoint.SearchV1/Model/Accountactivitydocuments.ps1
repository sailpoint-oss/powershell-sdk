...
function Initialize-Accountactivitydocuments {
    [CmdletBinding()]
    Param (
...
Convert from JSON to Accountactivitydocuments<PSCustomObject>
...
Accountactivitydocuments<PSCustomObject>
#>
function ConvertFrom-JsonToAccountactivitydocuments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )

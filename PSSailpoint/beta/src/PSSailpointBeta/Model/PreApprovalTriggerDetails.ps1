...
function Initialize-BetaPreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaPreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

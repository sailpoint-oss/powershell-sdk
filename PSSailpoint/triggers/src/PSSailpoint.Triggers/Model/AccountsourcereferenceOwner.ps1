...
function Initialize-AccountsourcereferenceOwner {
    [CmdletBinding()]
    Param (
...
AccountsourcereferenceOwner<PSCustomObject>
#>
function ConvertFrom-JsonToAccountsourcereferenceOwner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccountsourcereferenceOwner

...
function Initialize-V2026WorkflowTrigger {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026WorkflowTrigger' | Write-Debug
...
WorkflowTrigger<PSCustomObject>
#>
function ConvertFrom-V2026JsonToWorkflowTrigger {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026WorkflowTrigger' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026WorkflowTrigger

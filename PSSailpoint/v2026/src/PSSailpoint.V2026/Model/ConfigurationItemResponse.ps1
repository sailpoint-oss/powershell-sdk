...
function Initialize-V2026ConfigurationItemResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ConfigurationItemResponse' | Write-Debug
...
ConfigurationItemResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToConfigurationItemResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ConfigurationItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ConfigurationItemResponse

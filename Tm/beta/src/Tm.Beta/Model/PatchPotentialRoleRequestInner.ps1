...
function Initialize-BetaPatchPotentialRoleRequestInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaPatchPotentialRoleRequestInner' | Write-Debug
...
function ConvertFrom-BetaJsonToPatchPotentialRoleRequestInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaPatchPotentialRoleRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

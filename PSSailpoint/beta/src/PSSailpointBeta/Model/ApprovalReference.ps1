...
function Initialize-BetaApprovalReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaApprovalReference' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaApprovalReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

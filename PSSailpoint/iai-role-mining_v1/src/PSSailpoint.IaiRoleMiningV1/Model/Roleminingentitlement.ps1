...
function Initialize-Roleminingentitlement {
    [CmdletBinding()]
    Param (
...
Roleminingentitlement<PSCustomObject>
#>
function ConvertFrom-JsonToRoleminingentitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Roleminingentitlement

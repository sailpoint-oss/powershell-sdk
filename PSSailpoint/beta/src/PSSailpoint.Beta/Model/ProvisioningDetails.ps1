...
function Initialize-BetaProvisioningDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaProvisioningDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

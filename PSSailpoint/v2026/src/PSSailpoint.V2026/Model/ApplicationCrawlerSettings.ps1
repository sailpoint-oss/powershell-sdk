...
function Initialize-V2026ApplicationCrawlerSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApplicationCrawlerSettings' | Write-Debug
...
ApplicationCrawlerSettings<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApplicationCrawlerSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApplicationCrawlerSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApplicationCrawlerSettings

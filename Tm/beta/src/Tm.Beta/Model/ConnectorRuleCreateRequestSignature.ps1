...
function Initialize-BetaConnectorRuleCreateRequestSignature {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaConnectorRuleCreateRequestSignature' | Write-Debug
...
function ConvertFrom-BetaJsonToConnectorRuleCreateRequestSignature {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaConnectorRuleCreateRequestSignature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

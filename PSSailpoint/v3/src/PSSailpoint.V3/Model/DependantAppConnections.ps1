...
function Initialize-DependantAppConnections {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => DependantAppConnections' | Write-Debug
...
function ConvertFrom-JsonToDependantAppConnections {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => DependantAppConnections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

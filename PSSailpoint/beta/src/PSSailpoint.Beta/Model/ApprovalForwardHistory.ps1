...
function Initialize-BetaApprovalForwardHistory {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalForwardHistory' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalForwardHistory {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalForwardHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

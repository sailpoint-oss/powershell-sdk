...
function Initialize-Intelaccessaccountwire {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IntelligencePackageV1 => Intelaccessaccountwire' | Write-Debug
        ...
        if (!$ConnectionType) {
            throw "invalid value for 'ConnectionType', 'ConnectionType' cannot be null."
        }
...
function ConvertFrom-JsonToIntelaccessaccountwire {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IntelligencePackageV1 => Intelaccessaccountwire' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Intelaccessaccountwire
        $AllProperties = ("id", "name", "source", "disabled", "locked", "uncorrelated", "authoritative", "systemAccount", "isMachine", "hasEntitlements", "manuallyCorrelated", "connectionType", "nativeIdentity", "created", "modified")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "connectionType"))) {
            throw "Error! JSON cannot be serialized due to the required property 'connectionType' missing."
        } else {

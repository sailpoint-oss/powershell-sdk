...
function Initialize-Custompasswordinstruction {
    [CmdletBinding()]
    Param (
...
Custompasswordinstruction<PSCustomObject>
#>
function ConvertFrom-JsonToCustompasswordinstruction {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Custompasswordinstruction

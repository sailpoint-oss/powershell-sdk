...
keywords: ['powershell', 'PowerShell', 'sdk', 'FormCondition', 'V2026FormCondition'] 
slug: /tools/sdk/powershell/v2026/models/form-condition
...
```powershell
$FormCondition = Initialize-V2026FormCondition  -RuleOperator AND `
 -Rules null `
 -Effects null
```

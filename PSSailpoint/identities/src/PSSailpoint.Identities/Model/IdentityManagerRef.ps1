...
function Initialize-IdentityManagerRef {
    [CmdletBinding()]
    Param (
...
IdentityManagerRef<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityManagerRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in IdentityManagerRef

...
TemplateDtoTeamsTemplate<PSCustomObject>
#>

function Initialize-V2026TemplateDtoTeamsTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TemplateDtoTeamsTemplate' | Write-Debug
...
Convert from JSON to TemplateDtoTeamsTemplate<PSCustomObject>
...
TemplateDtoTeamsTemplate<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTemplateDtoTeamsTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TemplateDtoTeamsTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TemplateDtoTeamsTemplate

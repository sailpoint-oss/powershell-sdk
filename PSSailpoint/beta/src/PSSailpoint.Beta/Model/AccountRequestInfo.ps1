...
function Initialize-BetaAccountRequestInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountRequestInfo' | Write-Debug
...
AccountRequestInfo<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAccountRequestInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountRequestInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaAccountRequestInfo

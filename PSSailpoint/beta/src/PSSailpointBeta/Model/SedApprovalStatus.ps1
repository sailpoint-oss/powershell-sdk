...
function Initialize-BetaSedApprovalStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSedApprovalStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToSedApprovalStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSedApprovalStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-SearchAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SearchAttributeConfig' | Write-Debug
...
function ConvertFrom-JsonToSearchAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SearchAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

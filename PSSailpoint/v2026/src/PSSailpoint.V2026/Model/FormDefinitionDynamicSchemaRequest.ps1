...
function Initialize-V2026FormDefinitionDynamicSchemaRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026FormDefinitionDynamicSchemaRequest' | Write-Debug
...
FormDefinitionDynamicSchemaRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToFormDefinitionDynamicSchemaRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026FormDefinitionDynamicSchemaRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026FormDefinitionDynamicSchemaRequest

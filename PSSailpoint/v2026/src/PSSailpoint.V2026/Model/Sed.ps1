...
function Initialize-V2026Sed {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026Sed' | Write-Debug
...
Sed<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSed {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026Sed' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026Sed

...
function Initialize-BetaAttrSyncSourceAttributeConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAttrSyncSourceAttributeConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToAttrSyncSourceAttributeConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAttrSyncSourceAttributeConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

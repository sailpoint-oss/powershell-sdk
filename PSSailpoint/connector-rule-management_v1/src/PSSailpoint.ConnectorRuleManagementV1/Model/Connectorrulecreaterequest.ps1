...
function Initialize-Connectorrulecreaterequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ConnectorRuleManagementV1 => Connectorrulecreaterequest' | Write-Debug
...
Connectorrulecreaterequest<PSCustomObject>
#>
function ConvertFrom-JsonToConnectorrulecreaterequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ConnectorRuleManagementV1 => Connectorrulecreaterequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Connectorrulecreaterequest

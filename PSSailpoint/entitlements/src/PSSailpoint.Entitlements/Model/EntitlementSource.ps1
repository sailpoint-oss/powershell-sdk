...
function Initialize-EntitlementSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Entitlements => EntitlementSource' | Write-Debug
...
function ConvertFrom-JsonToEntitlementSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Entitlements => EntitlementSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024AccessRequestPreApproval {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccessRequestPreApproval' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestPreApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccessRequestPreApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaTokenAuthRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTokenAuthRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToTokenAuthRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTokenAuthRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

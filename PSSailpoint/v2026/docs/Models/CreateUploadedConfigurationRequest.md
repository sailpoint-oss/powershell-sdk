...
keywords: ['powershell', 'PowerShell', 'sdk', 'CreateUploadedConfigurationRequest', 'V2026CreateUploadedConfigurationRequest'] 
slug: /tools/sdk/powershell/v2026/models/create-uploaded-configuration-request
...
```powershell
$CreateUploadedConfigurationRequest = Initialize-V2026CreateUploadedConfigurationRequest  -VarData null `
 -Name null
```

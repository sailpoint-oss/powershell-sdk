...
function Initialize-V2024BrandingItemCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024BrandingItemCreate' | Write-Debug
...
BrandingItemCreate<PSCustomObject>
#>
function ConvertFrom-V2024JsonToBrandingItemCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024BrandingItemCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024BrandingItemCreate

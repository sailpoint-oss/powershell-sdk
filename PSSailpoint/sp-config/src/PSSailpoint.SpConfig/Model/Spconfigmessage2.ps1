...
Spconfigmessage2<PSCustomObject>
#>

function Initialize-Spconfigmessage2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigmessage2' | Write-Debug
...
Convert from JSON to Spconfigmessage2<PSCustomObject>
...
Spconfigmessage2<PSCustomObject>
#>
function ConvertFrom-JsonToSpconfigmessage2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigmessage2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Spconfigmessage2

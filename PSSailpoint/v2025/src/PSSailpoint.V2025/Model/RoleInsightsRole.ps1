...
function Initialize-V2025RoleInsightsRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleInsightsRole' | Write-Debug
...
RoleInsightsRole<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleInsightsRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleInsightsRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleInsightsRole

...
function Initialize-Iso3166 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Iso3166' | Write-Debug
...
Iso3166<PSCustomObject>
#>
function ConvertFrom-JsonToIso3166 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Iso3166' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Iso3166

...
function Initialize-V2024IdentityWithNewAccessAccessRefsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityWithNewAccessAccessRefsInner' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityWithNewAccessAccessRefsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityWithNewAccessAccessRefsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

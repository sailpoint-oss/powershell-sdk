...
function Initialize-BetaProvisioningCompletedAccountRequestsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaProvisioningCompletedAccountRequestsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningCompletedAccountRequestsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaProvisioningCompletedAccountRequestsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Baseaccessprofile {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => Baseaccessprofile' | Write-Debug
...
function ConvertFrom-JsonToBaseaccessprofile {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => Baseaccessprofile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BulkRejectRequestDTO {
    [CmdletBinding()]
    Param (
...
BulkRejectRequestDTO<PSCustomObject>
#>
function ConvertFrom-JsonToBulkRejectRequestDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in BulkRejectRequestDTO

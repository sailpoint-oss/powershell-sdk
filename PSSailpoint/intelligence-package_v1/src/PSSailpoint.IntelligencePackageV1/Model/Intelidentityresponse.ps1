...
function Initialize-Intelidentityresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IntelligencePackageV1 => Intelidentityresponse' | Write-Debug
...
Intelidentityresponse<PSCustomObject>
#>
function ConvertFrom-JsonToIntelidentityresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IntelligencePackageV1 => Intelidentityresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Intelidentityresponse

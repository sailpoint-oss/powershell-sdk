...
function Initialize-BetaAccountCorrelatedSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountCorrelatedSource' | Write-Debug
...
AccountCorrelatedSource<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAccountCorrelatedSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountCorrelatedSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

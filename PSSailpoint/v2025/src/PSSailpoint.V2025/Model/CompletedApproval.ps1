...
function Initialize-V2025CompletedApproval {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CompletedApproval' | Write-Debug
...
CompletedApproval<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCompletedApproval {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CompletedApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

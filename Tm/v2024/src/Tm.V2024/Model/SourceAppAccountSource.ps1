...
function Initialize-V2024SourceAppAccountSource {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024SourceAppAccountSource' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceAppAccountSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024SourceAppAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

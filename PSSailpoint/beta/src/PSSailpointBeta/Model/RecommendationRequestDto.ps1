...
function Initialize-BetaRecommendationRequestDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRecommendationRequestDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommendationRequestDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRecommendationRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

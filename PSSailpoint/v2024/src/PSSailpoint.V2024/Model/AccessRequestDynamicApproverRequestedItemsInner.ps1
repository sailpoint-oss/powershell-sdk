...
function Initialize-V2024AccessRequestDynamicApproverRequestedItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
...
AccessRequestDynamicApproverRequestedItemsInner<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccessRequestDynamicApproverRequestedItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AccessRequestDynamicApproverRequestedItemsInner

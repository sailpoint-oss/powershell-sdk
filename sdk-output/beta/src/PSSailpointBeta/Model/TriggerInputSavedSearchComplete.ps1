...
TriggerInputSavedSearchComplete<PSCustomObject>
#>

function Initialize-BetaTriggerInputSavedSearchComplete {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputSavedSearchComplete' | Write-Debug
...
Convert from JSON to TriggerInputSavedSearchComplete<PSCustomObject>
...
TriggerInputSavedSearchComplete<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputSavedSearchComplete {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputSavedSearchComplete' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputSavedSearchComplete

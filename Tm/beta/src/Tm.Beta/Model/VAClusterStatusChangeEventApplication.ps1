...
function Initialize-BetaVAClusterStatusChangeEventApplication {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaVAClusterStatusChangeEventApplication' | Write-Debug
...
function ConvertFrom-BetaJsonToVAClusterStatusChangeEventApplication {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaVAClusterStatusChangeEventApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ProvisioningCriteriaLevel1', 'V2026ProvisioningCriteriaLevel1'] 
slug: /tools/sdk/powershell/v2026/models/provisioning-criteria-level1
...
```powershell
$ProvisioningCriteriaLevel1 = Initialize-V2026ProvisioningCriteriaLevel1  -Operation null `
 -Attribute email `

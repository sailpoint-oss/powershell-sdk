...
Convert from JSON to Source2<PSCustomObject>
...
Source2<PSCustomObject>
#>
function ConvertFrom-JsonToSource2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Source2

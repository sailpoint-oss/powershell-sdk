...
function Initialize-V2024AccessRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

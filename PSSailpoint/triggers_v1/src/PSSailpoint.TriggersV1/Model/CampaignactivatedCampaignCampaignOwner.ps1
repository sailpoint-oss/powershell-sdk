...
function Initialize-CampaignactivatedCampaignCampaignOwner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => CampaignactivatedCampaignCampaignOwner' | Write-Debug
...
CampaignactivatedCampaignCampaignOwner<PSCustomObject>
#>
function ConvertFrom-JsonToCampaignactivatedCampaignCampaignOwner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => CampaignactivatedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CampaignactivatedCampaignCampaignOwner

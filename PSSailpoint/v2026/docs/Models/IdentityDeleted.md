...
keywords: ['powershell', 'PowerShell', 'sdk', 'IdentityDeleted', 'V2026IdentityDeleted'] 
slug: /tools/sdk/powershell/v2026/models/identity-deleted
...
```powershell
$IdentityDeleted = Initialize-V2026IdentityDeleted  -Identity null `

...
function Initialize-V2024IdentityAttributeTransform {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024IdentityAttributeTransform' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityAttributeTransform {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024IdentityAttributeTransform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Commonaccessresponse {
    [CmdletBinding()]
    Param (
...
Commonaccessresponse<PSCustomObject>
#>
function ConvertFrom-JsonToCommonaccessresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Commonaccessresponse

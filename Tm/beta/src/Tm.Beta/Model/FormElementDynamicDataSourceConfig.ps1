...
function Initialize-BetaFormElementDynamicDataSourceConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaFormElementDynamicDataSourceConfig' | Write-Debug
...
function ConvertFrom-BetaJsonToFormElementDynamicDataSourceConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaFormElementDynamicDataSourceConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

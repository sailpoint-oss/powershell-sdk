...
keywords: ['powershell', 'PowerShell', 'sdk', 'RoleCriteriaLevel1', 'V2026RoleCriteriaLevel1'] 
slug: /tools/sdk/powershell/v2026/models/role-criteria-level1
...
```powershell
$RoleCriteriaLevel1 = Initialize-V2026RoleCriteriaLevel1  -Operation null `
 -Key null `

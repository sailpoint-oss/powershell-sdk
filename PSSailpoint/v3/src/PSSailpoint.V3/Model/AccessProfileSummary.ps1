...
function Initialize-AccessProfileSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessProfileSummary' | Write-Debug
...
function ConvertFrom-JsonToAccessProfileSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessProfileSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

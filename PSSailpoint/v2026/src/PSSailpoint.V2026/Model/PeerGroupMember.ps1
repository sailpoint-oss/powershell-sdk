...
function Initialize-V2026PeerGroupMember {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026PeerGroupMember' | Write-Debug
...
PeerGroupMember<PSCustomObject>
#>
function ConvertFrom-V2026JsonToPeerGroupMember {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026PeerGroupMember' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026PeerGroupMember

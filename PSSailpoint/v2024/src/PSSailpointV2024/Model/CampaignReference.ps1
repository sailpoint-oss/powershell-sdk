...
function Initialize-V2024CampaignReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignReference' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

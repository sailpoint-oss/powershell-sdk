...
function Initialize-BetaSourceDeletedActor {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceDeletedActor' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceDeletedActor {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceDeletedActor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

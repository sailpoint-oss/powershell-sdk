...
function Initialize-BetaWorkgroupMemberAddItem {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaWorkgroupMemberAddItem' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkgroupMemberAddItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaWorkgroupMemberAddItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

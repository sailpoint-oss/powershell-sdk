...
function Initialize-BetaIdentityReferenceWithNameAndEmail {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityReferenceWithNameAndEmail' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityReferenceWithNameAndEmail {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityReferenceWithNameAndEmail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

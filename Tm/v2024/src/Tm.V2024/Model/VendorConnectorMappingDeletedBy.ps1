...
function Initialize-V2024VendorConnectorMappingDeletedBy {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024VendorConnectorMappingDeletedBy' | Write-Debug
...
function ConvertFrom-V2024JsonToVendorConnectorMappingDeletedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024VendorConnectorMappingDeletedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

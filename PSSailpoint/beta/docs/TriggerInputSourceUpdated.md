...
```powershell
$TriggerInputSourceUpdated = Initialize-PSSailpointBetaTriggerInputSourceUpdated  -Id 2c9180866166b5b0016167c32ef31a66 `
...
```powershell
$TriggerInputSourceUpdated | ConvertTo-JSON
```

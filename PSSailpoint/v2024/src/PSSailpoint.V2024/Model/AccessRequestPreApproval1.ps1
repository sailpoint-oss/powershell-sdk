...
function Initialize-V2024AccessRequestPreApproval1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestPreApproval1' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestPreApproval1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestPreApproval1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-CertificationSignedOff {
    [CmdletBinding()]
    Param (
...
CertificationSignedOff<PSCustomObject>
#>
function ConvertFrom-JsonToCertificationSignedOff {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in CertificationSignedOff

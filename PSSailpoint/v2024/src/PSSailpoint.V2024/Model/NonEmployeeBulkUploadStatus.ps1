...
function Initialize-V2024NonEmployeeBulkUploadStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeBulkUploadStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeBulkUploadStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeBulkUploadStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaDkimAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaDkimAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToDkimAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaDkimAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

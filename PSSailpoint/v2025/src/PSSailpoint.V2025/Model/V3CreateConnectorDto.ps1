...
function Initialize-V2025V3CreateConnectorDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025V3CreateConnectorDto' | Write-Debug
...
V3CreateConnectorDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToV3CreateConnectorDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025V3CreateConnectorDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025V3CreateConnectorDto

...
function Initialize-BetaRandomAlphaNumeric {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRandomAlphaNumeric' | Write-Debug
...
function ConvertFrom-BetaJsonToRandomAlphaNumeric {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRandomAlphaNumeric' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

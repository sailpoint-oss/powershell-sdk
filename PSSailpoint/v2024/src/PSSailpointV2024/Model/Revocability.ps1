...
function Initialize-V2024Revocability {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Revocability' | Write-Debug
...
function ConvertFrom-V2024JsonToRevocability {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Revocability' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026NonEmployeeSourceWithNECount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeSourceWithNECount' | Write-Debug
...
NonEmployeeSourceWithNECount<PSCustomObject>
#>
function ConvertFrom-V2026JsonToNonEmployeeSourceWithNECount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeSourceWithNECount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026NonEmployeeSourceWithNECount

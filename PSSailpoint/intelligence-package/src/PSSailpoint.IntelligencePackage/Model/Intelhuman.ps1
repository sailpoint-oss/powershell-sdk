...
function Initialize-Intelhuman {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IntelligencePackageV1 => Intelhuman' | Write-Debug
...
Intelhuman<PSCustomObject>
#>
function ConvertFrom-JsonToIntelhuman {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IntelligencePackageV1 => Intelhuman' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Intelhuman

...
function Initialize-Accountactivityitem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccountActivities => Accountactivityitem' | Write-Debug
...
function ConvertFrom-JsonToAccountactivityitem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccountActivities => Accountactivityitem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

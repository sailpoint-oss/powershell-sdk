...
$FunctionPath = "$PSScriptRoot/src/PSSailpoint.Icons/Api", "$PSScriptRoot/src/PSSailpoint.Icons/Client","$PSScriptRoot/src/PSSailpoint.Icons/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\PSSailpoint.Icons\PSSailpoint.Icons.psd1"

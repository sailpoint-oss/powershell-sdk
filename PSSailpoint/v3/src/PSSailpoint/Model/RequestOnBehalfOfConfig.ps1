...
function Initialize-RequestOnBehalfOfConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => RequestOnBehalfOfConfig' | Write-Debug
...
function ConvertFrom-JsonToRequestOnBehalfOfConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => RequestOnBehalfOfConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

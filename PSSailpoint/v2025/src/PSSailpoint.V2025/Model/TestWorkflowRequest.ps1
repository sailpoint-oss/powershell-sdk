...
function Initialize-V2025TestWorkflowRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025TestWorkflowRequest' | Write-Debug
...
TestWorkflowRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToTestWorkflowRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025TestWorkflowRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025TestWorkflowRequest
        $AllProperties = ("input")

...
function Initialize-ManagedclienthealthindicatorsBody {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClientsV1 => ManagedclienthealthindicatorsBody' | Write-Debug
...
ManagedclienthealthindicatorsBody<PSCustomObject>
#>
function ConvertFrom-JsonToManagedclienthealthindicatorsBody {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClientsV1 => ManagedclienthealthindicatorsBody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ManagedclienthealthindicatorsBody

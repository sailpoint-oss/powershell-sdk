...
function Initialize-V2025RevocabilityForRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RevocabilityForRole' | Write-Debug
...
RevocabilityForRole<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRevocabilityForRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RevocabilityForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RevocabilityForRole

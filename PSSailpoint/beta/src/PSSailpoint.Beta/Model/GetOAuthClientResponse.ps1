...
function Initialize-BetaGetOAuthClientResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaGetOAuthClientResponse' | Write-Debug
...
GetOAuthClientResponse<PSCustomObject>
#>
function ConvertFrom-BetaJsonToGetOAuthClientResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaGetOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

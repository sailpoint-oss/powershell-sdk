...
function Initialize-Spconfigimportresults {
    [CmdletBinding()]
    Param (
...
Spconfigimportresults<PSCustomObject>
#>
function ConvertFrom-JsonToSpconfigimportresults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Spconfigimportresults

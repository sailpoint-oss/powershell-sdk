...
function Initialize-AuthUserSlimResponse {
    [CmdletBinding()]
    Param (
...
AuthUserSlimResponse<PSCustomObject>
#>
function ConvertFrom-JsonToAuthUserSlimResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AuthUserSlimResponse

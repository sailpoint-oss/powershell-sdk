...
PasswordPolicyV3Dto
#>
function New-V2026PasswordPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026PasswordPolicy' | Write-Debug
...
None
#>
function Remove-V2026PasswordPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026PasswordPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto
#>
function Get-V2026PasswordPolicyById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026PasswordPolicyById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto[]
#>
function Get-V2026PasswordPolicies {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026PasswordPolicies' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto
#>
function Set-V2026PasswordPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-V2026PasswordPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

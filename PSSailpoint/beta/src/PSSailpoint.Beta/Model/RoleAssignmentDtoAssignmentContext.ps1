...
function Initialize-BetaRoleAssignmentDtoAssignmentContext {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleAssignmentDtoAssignmentContext' | Write-Debug
...
RoleAssignmentDtoAssignmentContext<PSCustomObject>
#>
function ConvertFrom-BetaJsonToRoleAssignmentDtoAssignmentContext {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleAssignmentDtoAssignmentContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaRoleAssignmentDtoAssignmentContext

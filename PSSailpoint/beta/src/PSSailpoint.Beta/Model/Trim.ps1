...
function Initialize-BetaTrim {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTrim' | Write-Debug
...
Trim<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTrim {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTrim' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTrim

...
function Initialize-V2026MachineIdentityRequest {
    [CmdletBinding()]
    Param (
...
MachineIdentityRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMachineIdentityRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

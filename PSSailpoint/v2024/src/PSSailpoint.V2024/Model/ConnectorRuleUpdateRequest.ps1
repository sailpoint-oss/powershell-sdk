...
function Initialize-V2024ConnectorRuleUpdateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConnectorRuleUpdateRequest' | Write-Debug
...
ConnectorRuleUpdateRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToConnectorRuleUpdateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConnectorRuleUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ConnectorRuleUpdateRequest

...
function Initialize-V2024BaseAccessAllOfOwner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024BaseAccessAllOfOwner' | Write-Debug
...
function ConvertFrom-V2024JsonToBaseAccessAllOfOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024BaseAccessAllOfOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
Entitlementv2<PSCustomObject>
#>

function Initialize-Entitlementv2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.EntitlementsV1 => Entitlementv2' | Write-Debug
...
Convert from JSON to Entitlementv2<PSCustomObject>
...
Entitlementv2<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementv2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.EntitlementsV1 => Entitlementv2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Entitlementv2

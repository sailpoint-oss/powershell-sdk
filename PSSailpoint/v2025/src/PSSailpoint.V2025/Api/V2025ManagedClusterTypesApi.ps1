...
ManagedClusterType
#>
function New-V2025ManagedClusterType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025ManagedClusterType' | Write-Debug
...
None
#>
function Remove-V2025ManagedClusterType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025ManagedClusterType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClusterType
#>
function Get-V2025ManagedClusterType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ManagedClusterType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClusterType[]
#>
function Get-V2025ManagedClusterTypes {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ManagedClusterTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClusterType
#>
function Update-V2025ManagedClusterType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025ManagedClusterType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

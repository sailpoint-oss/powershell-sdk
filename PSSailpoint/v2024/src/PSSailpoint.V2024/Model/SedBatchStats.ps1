...
function Initialize-V2024SedBatchStats {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SedBatchStats' | Write-Debug
...
function ConvertFrom-V2024JsonToSedBatchStats {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SedBatchStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

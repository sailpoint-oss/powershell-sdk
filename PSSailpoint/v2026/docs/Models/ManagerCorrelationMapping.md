...
keywords: ['powershell', 'PowerShell', 'sdk', 'ManagerCorrelationMapping', 'V2026ManagerCorrelationMapping'] 
slug: /tools/sdk/powershell/v2026/models/manager-correlation-mapping
...
```powershell
$ManagerCorrelationMapping = Initialize-V2026ManagerCorrelationMapping  -AccountAttributeName manager `

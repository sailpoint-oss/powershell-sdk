...
keywords: ['powershell', 'PowerShell', 'sdk', 'Transform', 'V2026Transform'] 
slug: /tools/sdk/powershell/v2026/models/transform
...
```powershell
$Transform = Initialize-V2026Transform  -Name Timestamp To Date `
 -Type dateFormat `
 -Attributes null
```

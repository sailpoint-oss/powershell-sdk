...
ManagedCluster
#>
function New-V2025ManagedCluster {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025ManagedCluster' | Write-Debug
...
None
#>
function Remove-V2025ManagedCluster {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025ManagedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025ClientLogConfiguration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ClientLogConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedCluster
#>
function Get-V2025ManagedCluster {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ManagedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedCluster[]
#>
function Get-V2025ManagedClusters {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2025ManagedClusters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ClientLogConfiguration
#>
function Send-V2025ClientLogConfiguration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025ClientLogConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-V2025 {
    ...
    Process {
        'Calling method: Update-V2025' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/managed-clusters/{id}/manualUpgrade'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling update."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
ManagedCluster
#>
function Update-V2025ManagedCluster {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025ManagedCluster' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

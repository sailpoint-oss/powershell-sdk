...
function Initialize-V2024NonEmployeeRequestWithoutApprovalItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeRequestWithoutApprovalItem' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeRequestWithoutApprovalItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeRequestWithoutApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

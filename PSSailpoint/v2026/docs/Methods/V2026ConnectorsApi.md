...
keywords: ['powershell', 'PowerShell', 'sdk', 'Connectors', 'V2026Connectors'] 
slug: /tools/sdk/powershell/v2026/methods/connectors
...
------------- | ------------- | -------------
[**New-V2026CustomConnector**](#create-custom-connector) | **POST** `/connectors` | Create custom connector
[**Remove-V2026CustomConnector**](#delete-custom-connector) | **DELETE** `/connectors/{scriptName}` | Delete connector by script name
[**Get-V2026Connector**](#get-connector) | **GET** `/connectors/{scriptName}` | Get connector by script name
[**Get-V2026ConnectorCorrelationConfig**](#get-connector-correlation-config) | **GET** `/connectors/{scriptName}/correlation-config` | Get connector correlation configuration
[**Get-V2026ConnectorList**](#get-connector-list) | **GET** `/connectors` | Get connector list
[**Get-V2026ConnectorSourceConfig**](#get-connector-source-config) | **GET** `/connectors/{scriptName}/source-config` | Get connector source configuration
[**Get-V2026ConnectorSourceTemplate**](#get-connector-source-template) | **GET** `/connectors/{scriptName}/source-template` | Get connector source template
[**Get-V2026ConnectorTranslations**](#get-connector-translations) | **GET** `/connectors/{scriptName}/translations/{locale}` | Get connector translations
[**Send-V2026ConnectorCorrelationConfig**](#put-connector-correlation-config) | **PUT** `/connectors/{scriptName}/correlation-config` | Update connector correlation configuration
[**Send-V2026ConnectorSourceConfig**](#put-connector-source-config) | **PUT** `/connectors/{scriptName}/source-config` | Update connector source configuration
[**Send-V2026ConnectorSourceTemplate**](#put-connector-source-template) | **PUT** `/connectors/{scriptName}/source-template` | Update connector source template
[**Send-V2026ConnectorTranslations**](#put-connector-translations) | **PUT** `/connectors/{scriptName}/translations/{locale}` | Update connector translations
[**Update-V2026Connector**](#update-connector) | **PATCH** `/connectors/{scriptName}` | Update connector by script name
...
try {
    $Result = ConvertFrom-V2026JsonToV3CreateConnectorDto -Json $V3CreateConnectorDto
    New-V2026CustomConnector -V3CreateConnectorDto $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026CustomConnector -V3CreateConnectorDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026CustomConnector"
...
try {
    Remove-V2026CustomConnector -ScriptName $ScriptName 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026CustomConnector -ScriptName $ScriptName  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026CustomConnector"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Connector -ScriptName $ScriptName 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Connector -ScriptName $ScriptName -Locale $Locale  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Connector"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ConnectorCorrelationConfig -ScriptName $ScriptName 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ConnectorCorrelationConfig -ScriptName $ScriptName  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ConnectorCorrelationConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ConnectorList 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ConnectorList -Filters $Filters -Limit $Limit -Offset $Offset -Count $Count -Locale $Locale  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ConnectorList"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ConnectorSourceConfig -ScriptName $ScriptName 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ConnectorSourceConfig -ScriptName $ScriptName  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ConnectorSourceConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ConnectorSourceTemplate -ScriptName $ScriptName 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ConnectorSourceTemplate -ScriptName $ScriptName  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ConnectorSourceTemplate"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ConnectorTranslations -ScriptName $ScriptName -Locale $Locale 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ConnectorTranslations -ScriptName $ScriptName -Locale $Locale  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ConnectorTranslations"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Send-V2026ConnectorCorrelationConfig -ScriptName $ScriptName -File $File 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ConnectorCorrelationConfig -ScriptName $ScriptName -File $File  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ConnectorCorrelationConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Send-V2026ConnectorSourceConfig -ScriptName $ScriptName -File $File 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ConnectorSourceConfig -ScriptName $ScriptName -File $File  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ConnectorSourceConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Send-V2026ConnectorSourceTemplate -ScriptName $ScriptName -File $File 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ConnectorSourceTemplate -ScriptName $ScriptName -File $File  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ConnectorSourceTemplate"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Send-V2026ConnectorTranslations -ScriptName $ScriptName -Locale $Locale 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ConnectorTranslations -ScriptName $ScriptName -Locale $Locale  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ConnectorTranslations"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026Connector -ScriptName $ScriptName -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026Connector -ScriptName $ScriptName -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026Connector"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-BetaTaskDefinitionSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTaskDefinitionSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToTaskDefinitionSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTaskDefinitionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

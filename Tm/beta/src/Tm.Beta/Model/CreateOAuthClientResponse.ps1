...
function Initialize-BetaCreateOAuthClientResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCreateOAuthClientResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateOAuthClientResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCreateOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

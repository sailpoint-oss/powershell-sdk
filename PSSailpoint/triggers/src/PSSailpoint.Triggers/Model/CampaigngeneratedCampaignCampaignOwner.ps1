...
function Initialize-CampaigngeneratedCampaignCampaignOwner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => CampaigngeneratedCampaignCampaignOwner' | Write-Debug
...
CampaigngeneratedCampaignCampaignOwner<PSCustomObject>
#>
function ConvertFrom-JsonToCampaigngeneratedCampaignCampaignOwner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => CampaigngeneratedCampaignCampaignOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CampaigngeneratedCampaignCampaignOwner

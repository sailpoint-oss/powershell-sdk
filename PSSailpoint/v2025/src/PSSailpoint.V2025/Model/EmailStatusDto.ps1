...
function Initialize-V2025EmailStatusDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025EmailStatusDto' | Write-Debug
...
EmailStatusDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToEmailStatusDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025EmailStatusDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaRecommenderCalculationsIdentityAttributesValue {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRecommenderCalculationsIdentityAttributesValue' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommenderCalculationsIdentityAttributesValue {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRecommenderCalculationsIdentityAttributesValue' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

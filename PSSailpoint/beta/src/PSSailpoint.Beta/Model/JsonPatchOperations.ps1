...
JsonPatchOperations<PSCustomObject>
#>

function Initialize-BetaJsonPatchOperations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaJsonPatchOperations' | Write-Debug
...
Convert from JSON to JsonPatchOperations<PSCustomObject>
...
JsonPatchOperations<PSCustomObject>
#>
function ConvertFrom-BetaJsonToJsonPatchOperations {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaJsonPatchOperations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaJsonPatchOperations

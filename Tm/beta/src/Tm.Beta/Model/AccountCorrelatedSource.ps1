...
function Initialize-BetaAccountCorrelatedSource {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountCorrelatedSource' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountCorrelatedSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountCorrelatedSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

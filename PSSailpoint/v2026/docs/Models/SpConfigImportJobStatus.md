...
keywords: ['powershell', 'PowerShell', 'sdk', 'SpConfigImportJobStatus', 'V2026SpConfigImportJobStatus'] 
slug: /tools/sdk/powershell/v2026/models/sp-config-import-job-status
...
```powershell
$SpConfigImportJobStatus = Initialize-V2026SpConfigImportJobStatus  -JobId 3469b87d-48ca-439a-868f-2160001da8c1 `
 -Status COMPLETE `
 -Type IMPORT `

...
function Initialize-ErrorResponseDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.WorkItems => ErrorResponseDto' | Write-Debug
...
function ConvertFrom-JsonToErrorResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.WorkItems => ErrorResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

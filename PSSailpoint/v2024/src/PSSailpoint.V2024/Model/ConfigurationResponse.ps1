...
function Initialize-V2024ConfigurationResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConfigurationResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToConfigurationResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConfigurationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeBulkUploadJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeBulkUploadJob' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeBulkUploadJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeBulkUploadJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

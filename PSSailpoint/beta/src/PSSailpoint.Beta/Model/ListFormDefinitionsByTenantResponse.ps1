...
function Initialize-BetaListFormDefinitionsByTenantResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaListFormDefinitionsByTenantResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToListFormDefinitionsByTenantResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaListFormDefinitionsByTenantResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

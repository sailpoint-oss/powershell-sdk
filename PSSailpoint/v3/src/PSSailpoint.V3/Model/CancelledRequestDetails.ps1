...
function Initialize-CancelledRequestDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CancelledRequestDetails' | Write-Debug
...
function ConvertFrom-JsonToCancelledRequestDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CancelledRequestDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

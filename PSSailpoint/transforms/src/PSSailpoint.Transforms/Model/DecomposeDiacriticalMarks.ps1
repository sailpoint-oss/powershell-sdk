...
function Initialize-DecomposeDiacriticalMarks {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Transforms => DecomposeDiacriticalMarks' | Write-Debug
...
function ConvertFrom-JsonToDecomposeDiacriticalMarks {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Transforms => DecomposeDiacriticalMarks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

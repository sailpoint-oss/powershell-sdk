...
function Initialize-BetaResourceBundleMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaResourceBundleMessage' | Write-Debug
...
function ConvertFrom-BetaJsonToResourceBundleMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaResourceBundleMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
#>
function New-V2025CampaignFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025CampaignFilter' | Write-Debug
...
None
#>
function Remove-V2025CampaignFilters {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String[]]
    ...
    Process {
        'Calling method: Remove-V2025CampaignFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CampaignFilterDetails
#>
function Get-V2025CampaignFilterById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025CampaignFilterById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025CampaignFilters {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2025CampaignFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
CampaignFilterDetails
#>
function Update-V2025CampaignFilter {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025CampaignFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

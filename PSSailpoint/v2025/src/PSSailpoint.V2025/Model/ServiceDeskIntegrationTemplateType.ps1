...
function Initialize-V2025ServiceDeskIntegrationTemplateType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ServiceDeskIntegrationTemplateType' | Write-Debug
...
ServiceDeskIntegrationTemplateType<PSCustomObject>
#>
function ConvertFrom-V2025JsonToServiceDeskIntegrationTemplateType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ServiceDeskIntegrationTemplateType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ServiceDeskIntegrationTemplateType

...
function Initialize-BetaCorrelationConfigAttributeAssignmentsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaCorrelationConfigAttributeAssignmentsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToCorrelationConfigAttributeAssignmentsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaCorrelationConfigAttributeAssignmentsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024IdentityWithNewAccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityWithNewAccess' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityWithNewAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityWithNewAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

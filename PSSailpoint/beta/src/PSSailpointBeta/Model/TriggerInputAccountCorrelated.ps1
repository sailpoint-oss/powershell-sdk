...
TriggerInputAccountCorrelated<PSCustomObject>
#>

function Initialize-BetaTriggerInputAccountCorrelated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountCorrelated' | Write-Debug
...
Convert from JSON to TriggerInputAccountCorrelated<PSCustomObject>
...
TriggerInputAccountCorrelated<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputAccountCorrelated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputAccountCorrelated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputAccountCorrelated

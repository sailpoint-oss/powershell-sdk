...
function Initialize-Entitlementattributebulkupdatefilterrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Entitlementattributebulkupdatefilterrequest' | Write-Debug
...
Entitlementattributebulkupdatefilterrequest<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementattributebulkupdatefilterrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessModelMetadataV1 => Entitlementattributebulkupdatefilterrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Entitlementattributebulkupdatefilterrequest

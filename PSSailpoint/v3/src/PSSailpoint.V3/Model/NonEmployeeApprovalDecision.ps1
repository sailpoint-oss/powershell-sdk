...
function Initialize-NonEmployeeApprovalDecision {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalDecision' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeApprovalDecision {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalDecision' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function New-V2026Tag {
    ...
    Process {
        'Calling method: New-V2026Tag' | Write-Debug
...
function Remove-V2026TagById {
    ...
    Process {
        'Calling method: Remove-V2026TagById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026TagById {
    ...
    Process {
        'Calling method: Get-V2026TagById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026Tags {
    ...
    Process {
        'Calling method: Get-V2026Tags' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

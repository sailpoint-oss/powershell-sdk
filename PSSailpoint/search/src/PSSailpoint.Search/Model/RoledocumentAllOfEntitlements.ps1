...
function Initialize-RoledocumentAllOfEntitlements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => RoledocumentAllOfEntitlements' | Write-Debug
...
RoledocumentAllOfEntitlements<PSCustomObject>
#>
function ConvertFrom-JsonToRoledocumentAllOfEntitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => RoledocumentAllOfEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RoledocumentAllOfEntitlements

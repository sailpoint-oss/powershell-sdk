...
function Initialize-V2024PatchPotentialRoleRequestInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024PatchPotentialRoleRequestInner' | Write-Debug
...
function ConvertFrom-V2024JsonToPatchPotentialRoleRequestInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024PatchPotentialRoleRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

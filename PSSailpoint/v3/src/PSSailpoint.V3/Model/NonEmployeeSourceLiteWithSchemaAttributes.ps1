...
function Initialize-NonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

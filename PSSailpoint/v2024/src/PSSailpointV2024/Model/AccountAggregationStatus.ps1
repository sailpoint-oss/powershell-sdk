...
function Initialize-V2024AccountAggregationStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountAggregationStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAggregationStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountAggregationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
slug: /tools/sdk/powershell/customforms/models/list-form-instances-by-tenant-response
...
**FormInput** | **map[string]AnyType** | FormInput is an object of form input labels to value | [optional] 
...
**FormData** | **map[string]AnyType** | FormData is the data provided by the form on submit. The data is in a key -> value map | [optional] 

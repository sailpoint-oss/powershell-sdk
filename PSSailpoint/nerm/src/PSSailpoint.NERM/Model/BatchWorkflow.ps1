...
BatchWorkflow<PSCustomObject>
#>

function Initialize-NERMBatchWorkflow {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMBatchWorkflow' | Write-Debug
...
Convert from JSON to BatchWorkflow<PSCustomObject>
...
BatchWorkflow<PSCustomObject>
#>
function ConvertFrom-NERMJsonToBatchWorkflow {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMBatchWorkflow' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMBatchWorkflow

...
function Initialize-BetaIdentityHistoryResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityHistoryResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityHistoryResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityHistoryResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

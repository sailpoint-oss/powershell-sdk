...
RoleDocumentAllOfEntitlements1<PSCustomObject>
#>

function Initialize-V2024RoleDocumentAllOfEntitlements1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleDocumentAllOfEntitlements1' | Write-Debug
...
Convert from JSON to RoleDocumentAllOfEntitlements1<PSCustomObject>
...
RoleDocumentAllOfEntitlements1<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRoleDocumentAllOfEntitlements1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleDocumentAllOfEntitlements1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RoleDocumentAllOfEntitlements1
        $AllProperties = ("hasPermissions", "description", "attribute", "value", "schema", "privileged", "id", "name", "sourceSchemaObjectType", "hash")

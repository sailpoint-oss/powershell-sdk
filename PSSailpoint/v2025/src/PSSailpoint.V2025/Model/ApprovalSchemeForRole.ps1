...
function Initialize-V2025ApprovalSchemeForRole {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ApprovalSchemeForRole' | Write-Debug
...
ApprovalSchemeForRole<PSCustomObject>
#>
function ConvertFrom-V2025JsonToApprovalSchemeForRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ApprovalSchemeForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ApprovalSchemeForRole

...
function Initialize-BetaCampaignReport {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCampaignReport' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignReport {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCampaignReport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024CampaignAlert {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CampaignAlert' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignAlert {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CampaignAlert' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SpConfigMessage1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SpConfigMessage1' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigMessage1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SpConfigMessage1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

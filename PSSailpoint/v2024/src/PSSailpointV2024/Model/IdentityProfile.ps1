...
function Initialize-V2024IdentityProfile {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityProfile' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityProfile {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

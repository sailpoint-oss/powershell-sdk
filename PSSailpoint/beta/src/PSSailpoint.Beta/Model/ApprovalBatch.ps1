...
function Initialize-BetaApprovalBatch {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalBatch' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalBatch {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalBatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

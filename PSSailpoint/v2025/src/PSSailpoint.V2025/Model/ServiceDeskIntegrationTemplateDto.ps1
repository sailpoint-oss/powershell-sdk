...
function Initialize-V2025ServiceDeskIntegrationTemplateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ServiceDeskIntegrationTemplateDto' | Write-Debug
...
ServiceDeskIntegrationTemplateDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToServiceDeskIntegrationTemplateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ServiceDeskIntegrationTemplateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ServiceDeskIntegrationTemplateDto

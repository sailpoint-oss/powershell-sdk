...
function Initialize-BetaTestSourceConnectionMultihost200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTestSourceConnectionMultihost200Response' | Write-Debug
...
TestSourceConnectionMultihost200Response<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTestSourceConnectionMultihost200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTestSourceConnectionMultihost200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTestSourceConnectionMultihost200Response

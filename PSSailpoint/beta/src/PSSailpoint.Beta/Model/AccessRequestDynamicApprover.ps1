...
function Initialize-BetaAccessRequestDynamicApprover {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessRequestDynamicApprover' | Write-Debug
...
AccessRequestDynamicApprover<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAccessRequestDynamicApprover {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessRequestDynamicApprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaAccessRequestDynamicApprover

...
function Initialize-BetaInvocationStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaInvocationStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToInvocationStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaInvocationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

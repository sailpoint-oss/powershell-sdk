...
function Initialize-V2026RoleMiningPotentialRoleSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleSummary' | Write-Debug
...
RoleMiningPotentialRoleSummary<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMiningPotentialRoleSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMiningPotentialRoleSummary

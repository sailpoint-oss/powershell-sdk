...
function Initialize-V2024SlimDiscoveredApplicationsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SlimDiscoveredApplicationsInner' | Write-Debug
...
SlimDiscoveredApplicationsInner<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSlimDiscoveredApplicationsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SlimDiscoveredApplicationsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SlimDiscoveredApplicationsInner

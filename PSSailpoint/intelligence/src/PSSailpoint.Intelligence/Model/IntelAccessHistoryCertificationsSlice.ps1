...
IntelAccessHistoryCertificationsSlice<PSCustomObject>
#>

function Initialize-IntelAccessHistoryCertificationsSlice {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Intelligence => IntelAccessHistoryCertificationsSlice' | Write-Debug
...
Convert from JSON to IntelAccessHistoryCertificationsSlice<PSCustomObject>
...
IntelAccessHistoryCertificationsSlice<PSCustomObject>
#>
function ConvertFrom-JsonToIntelAccessHistoryCertificationsSlice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Intelligence => IntelAccessHistoryCertificationsSlice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IntelAccessHistoryCertificationsSlice

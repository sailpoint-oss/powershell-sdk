...
function Initialize-GetOAuthClientResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => GetOAuthClientResponse' | Write-Debug
...
function ConvertFrom-JsonToGetOAuthClientResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => GetOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
Get the configuration object 'V2Configuration'.
...
#>
function Get-V2Configuration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://sailpoint.api.identitynow.com/v2";
    }
...
None
#>
function Set-V2ConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-V2ConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-V2ConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
String
#>
function Get-V2UrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-V2ConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-V2KeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'V2ConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-V2ConfigurationHttpSigning{

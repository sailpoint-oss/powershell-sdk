...
function Initialize-BetaForwardApprovalDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaForwardApprovalDto' | Write-Debug
...
function ConvertFrom-BetaJsonToForwardApprovalDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaForwardApprovalDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccountAllOfIdentity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAllOfIdentity' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAllOfIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAllOfIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

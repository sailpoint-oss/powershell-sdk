...
keywords: ['powershell', 'PowerShell', 'sdk', 'CancelledRequestDetails1', 'BetaCancelledRequestDetails1'] 
slug: /tools/sdk/powershell/beta/models/cancelled-request-details1
...
```powershell
$CancelledRequestDetails1 = Initialize-BetaCancelledRequestDetails1  -Comment This request must be cancelled. `
 -Owner null `

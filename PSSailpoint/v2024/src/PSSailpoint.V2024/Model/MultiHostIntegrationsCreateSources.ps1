...
function Initialize-V2024MultiHostIntegrationsCreateSources {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024MultiHostIntegrationsCreateSources' | Write-Debug
...
MultiHostIntegrationsCreateSources<PSCustomObject>
#>
function ConvertFrom-V2024JsonToMultiHostIntegrationsCreateSources {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024MultiHostIntegrationsCreateSources' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024MultiHostIntegrationsCreateSources

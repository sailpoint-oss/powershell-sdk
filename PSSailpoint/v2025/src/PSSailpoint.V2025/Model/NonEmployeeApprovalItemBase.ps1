...
function Initialize-V2025NonEmployeeApprovalItemBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeApprovalItemBase' | Write-Debug
...
NonEmployeeApprovalItemBase<PSCustomObject>
#>
function ConvertFrom-V2025JsonToNonEmployeeApprovalItemBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeApprovalItemBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025NonEmployeeApprovalItemBase

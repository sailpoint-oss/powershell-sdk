...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountActivities', 'V2026AccountActivities'] 
slug: /tools/sdk/powershell/v2026/methods/account-activities
...
------------- | ------------- | -------------
[**Get-V2026AccountActivity**](#get-account-activity) | **GET** `/account-activities/{id}` | Get an account activity
[**Get-V2026AccountActivities**](#list-account-activities) | **GET** `/account-activities` | List account activities
...
try {
    Get-V2026AccountActivity -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AccountActivity -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccountActivity"
...
try {
    Get-V2026AccountActivities 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AccountActivities -RequestedFor $RequestedFor -RequestedBy $RequestedBy -RegardingIdentity $RegardingIdentity -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccountActivities"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

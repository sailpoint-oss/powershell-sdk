...
keywords: ['powershell', 'PowerShell', 'sdk', 'OutlierSummary', 'V2026OutlierSummary'] 
slug: /tools/sdk/powershell/v2026/models/outlier-summary
...
```powershell
$OutlierSummary = Initialize-V2026OutlierSummary  -Type LOW_SIMILARITY `

...
function Initialize-BetaSourceSyncJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceSyncJob' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceSyncJob {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceSyncJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

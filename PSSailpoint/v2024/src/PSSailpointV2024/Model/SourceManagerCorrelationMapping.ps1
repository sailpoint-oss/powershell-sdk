...
function Initialize-V2024SourceManagerCorrelationMapping {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SourceManagerCorrelationMapping' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceManagerCorrelationMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SourceManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

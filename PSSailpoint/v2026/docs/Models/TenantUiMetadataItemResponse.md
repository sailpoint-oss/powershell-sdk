...
keywords: ['powershell', 'PowerShell', 'sdk', 'TenantUiMetadataItemResponse', 'V2026TenantUiMetadataItemResponse'] 
slug: /tools/sdk/powershell/v2026/models/tenant-ui-metadata-item-response
...
```powershell
$TenantUiMetadataItemResponse = Initialize-V2026TenantUiMetadataItemResponse  -IframeWhiteList http://example.com http://example2.com `
 -UsernameLabel Email `

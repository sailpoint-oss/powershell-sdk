...
function Initialize-Accessrequestitemresponse {
    [CmdletBinding()]
    Param (
...
Accessrequestitemresponse<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestitemresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Accessrequestitemresponse

...
function Initialize-V2026ApprovalConfigSerialChainInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigSerialChainInner' | Write-Debug
...
ApprovalConfigSerialChainInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApprovalConfigSerialChainInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigSerialChainInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApprovalConfigSerialChainInner

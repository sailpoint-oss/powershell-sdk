...
function Initialize-JsonPatch {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClusterTypes => JsonPatch' | Write-Debug
...
function ConvertFrom-JsonToJsonPatch {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClusterTypes => JsonPatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

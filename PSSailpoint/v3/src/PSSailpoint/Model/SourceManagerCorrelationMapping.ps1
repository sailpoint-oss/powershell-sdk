...
function Initialize-SourceManagerCorrelationMapping {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => SourceManagerCorrelationMapping' | Write-Debug
...
function ConvertFrom-JsonToSourceManagerCorrelationMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => SourceManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
try {
    ...
    New-V2025ConnectorRule -XSailPointExperimental $XSailPointExperimental -ConnectorRuleCreateRequest $Result 
...
try {
    Remove-V2025ConnectorRule -Id $Id -XSailPointExperimental $XSailPointExperimental 
...
try {
    Get-V2025ConnectorRule -Id $Id -XSailPointExperimental $XSailPointExperimental 
...
try {
    Get-V2025ConnectorRuleList -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2025ConnectorRuleList -XSailPointExperimental $XSailPointExperimental -Limit $Limit -Offset $Offset -Count $Count  
} catch {
...
try {
    Send-V2025ConnectorRule -Id $Id -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Send-V2025ConnectorRule -Id $Id -XSailPointExperimental $XSailPointExperimental -ConnectorRuleUpdateRequest $Result  
} catch {
...
try {
    ...
    Test-V2025ConnectorRule -XSailPointExperimental $XSailPointExperimental -SourceCode $Result 

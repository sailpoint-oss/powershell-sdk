...
function Initialize-BetaAccountInfoDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountInfoDto' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountInfoDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountInfoDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

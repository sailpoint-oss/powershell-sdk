...
function Initialize-V2024RequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatusProvisioningDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatusProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

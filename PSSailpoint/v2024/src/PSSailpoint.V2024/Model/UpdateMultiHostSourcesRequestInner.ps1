...
UpdateMultiHostSourcesRequestInner<PSCustomObject>
#>

function Initialize-V2024UpdateMultiHostSourcesRequestInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024UpdateMultiHostSourcesRequestInner' | Write-Debug
...
Convert from JSON to UpdateMultiHostSourcesRequestInner<PSCustomObject>
...
UpdateMultiHostSourcesRequestInner<PSCustomObject>
#>
function ConvertFrom-V2024JsonToUpdateMultiHostSourcesRequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024UpdateMultiHostSourcesRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024UpdateMultiHostSourcesRequestInner

...
function Initialize-BetaInviteIdentitiesRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaInviteIdentitiesRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToInviteIdentitiesRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaInviteIdentitiesRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

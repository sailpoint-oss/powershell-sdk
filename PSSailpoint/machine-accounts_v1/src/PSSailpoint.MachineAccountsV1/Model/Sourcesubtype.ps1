...
function Initialize-Sourcesubtype {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountsV1 => Sourcesubtype' | Write-Debug
...
Sourcesubtype<PSCustomObject>
#>
function ConvertFrom-JsonToSourcesubtype {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountsV1 => Sourcesubtype' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Sourcesubtype

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConfigType', 'V2026ConfigType'] 
slug: /tools/sdk/powershell/v2026/models/config-type
...
```powershell
$ConfigType = Initialize-V2026ConfigType  -Priority 1 `
 -InternalName null `

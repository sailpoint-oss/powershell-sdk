...
keywords: ['powershell', 'PowerShell', 'sdk', 'SedBatchRequest', 'V2026SedBatchRequest'] 
slug: /tools/sdk/powershell/v2026/models/sed-batch-request
...
```powershell
$SedBatchRequest = Initialize-V2026SedBatchRequest  -Entitlements null `
 -Seds null `
 -SearchCriteria null
```

...
function Initialize-BetaKbaAnswerResponseItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaKbaAnswerResponseItem' | Write-Debug
...
function ConvertFrom-BetaJsonToKbaAnswerResponseItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaKbaAnswerResponseItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

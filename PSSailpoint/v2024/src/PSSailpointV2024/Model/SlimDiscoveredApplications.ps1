...
function Initialize-V2024SlimDiscoveredApplications {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SlimDiscoveredApplications' | Write-Debug
...
function ConvertFrom-V2024JsonToSlimDiscoveredApplications {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SlimDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

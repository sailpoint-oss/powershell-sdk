...
function Initialize-BetaRecommendationRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRecommendationRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommendationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRecommendationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

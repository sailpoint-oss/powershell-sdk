...
function Initialize-V2024PreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024PreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024PreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-DataAccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Certifications => DataAccess' | Write-Debug
...
function ConvertFrom-JsonToDataAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Certifications => DataAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

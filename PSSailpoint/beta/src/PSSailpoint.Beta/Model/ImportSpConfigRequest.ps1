...
function Initialize-BetaImportSpConfigRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaImportSpConfigRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToImportSpConfigRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaImportSpConfigRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

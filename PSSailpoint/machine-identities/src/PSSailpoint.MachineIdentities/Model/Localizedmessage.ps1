...
function Initialize-Localizedmessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentities => Localizedmessage' | Write-Debug
...
function ConvertFrom-JsonToLocalizedmessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentities => Localizedmessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Scheduledactionpayload {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ConfigurationHubV1 => Scheduledactionpayload' | Write-Debug
...
Scheduledactionpayload<PSCustomObject>
#>
function ConvertFrom-JsonToScheduledactionpayload {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ConfigurationHubV1 => Scheduledactionpayload' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Scheduledactionpayload

...
function Initialize-PublicIdentityConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => PublicIdentityConfig' | Write-Debug
...
function ConvertFrom-JsonToPublicIdentityConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => PublicIdentityConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

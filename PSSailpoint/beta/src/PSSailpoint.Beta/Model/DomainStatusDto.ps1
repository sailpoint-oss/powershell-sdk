...
function Initialize-BetaDomainStatusDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaDomainStatusDto' | Write-Debug
...
function ConvertFrom-BetaJsonToDomainStatusDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaDomainStatusDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

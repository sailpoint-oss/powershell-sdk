...
function Initialize-IdentityAttributePreview {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => IdentityAttributePreview' | Write-Debug
...
function ConvertFrom-JsonToIdentityAttributePreview {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => IdentityAttributePreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

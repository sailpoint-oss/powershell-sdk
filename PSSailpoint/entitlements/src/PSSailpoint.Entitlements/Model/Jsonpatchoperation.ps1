...
function Initialize-Jsonpatchoperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.EntitlementsV1 => Jsonpatchoperation' | Write-Debug
...
function ConvertFrom-JsonToJsonpatchoperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.EntitlementsV1 => Jsonpatchoperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaRoleMiningPotentialRoleSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRoleSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRoleSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

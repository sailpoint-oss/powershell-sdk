...
function Initialize-Sourcesubtypewithsource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountsV1 => Sourcesubtypewithsource' | Write-Debug
...
Sourcesubtypewithsource<PSCustomObject>
#>
function ConvertFrom-JsonToSourcesubtypewithsource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountsV1 => Sourcesubtypewithsource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

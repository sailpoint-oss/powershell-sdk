...
function Initialize-AccessCriteriaCriteriaListInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => AccessCriteriaCriteriaListInner' | Write-Debug
...
function ConvertFrom-JsonToAccessCriteriaCriteriaListInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => AccessCriteriaCriteriaListInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

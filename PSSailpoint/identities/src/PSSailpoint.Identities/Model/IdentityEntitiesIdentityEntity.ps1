...
function Initialize-IdentityEntitiesIdentityEntity {
    [CmdletBinding()]
    Param (
...
IdentityEntitiesIdentityEntity<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityEntitiesIdentityEntity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in IdentityEntitiesIdentityEntity

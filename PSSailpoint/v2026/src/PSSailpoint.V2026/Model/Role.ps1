...
function Initialize-V2026Role {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026Role' | Write-Debug
...
Role<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRole {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026Role' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026Role

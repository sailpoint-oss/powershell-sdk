...
function Initialize-AccountActivityItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccountActivityItem' | Write-Debug
...
function ConvertFrom-JsonToAccountActivityItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccountActivityItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

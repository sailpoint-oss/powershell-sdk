...
function Initialize-V2024PasswordInfoAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PasswordInfoAccount' | Write-Debug
...
function ConvertFrom-V2024JsonToPasswordInfoAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PasswordInfoAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

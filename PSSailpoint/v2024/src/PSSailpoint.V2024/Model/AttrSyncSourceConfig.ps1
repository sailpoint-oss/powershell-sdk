...
function Initialize-V2024AttrSyncSourceConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AttrSyncSourceConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToAttrSyncSourceConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AttrSyncSourceConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

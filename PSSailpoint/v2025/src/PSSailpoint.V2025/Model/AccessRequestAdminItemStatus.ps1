...
function Initialize-V2025AccessRequestAdminItemStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccessRequestAdminItemStatus' | Write-Debug
...
AccessRequestAdminItemStatus<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccessRequestAdminItemStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccessRequestAdminItemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

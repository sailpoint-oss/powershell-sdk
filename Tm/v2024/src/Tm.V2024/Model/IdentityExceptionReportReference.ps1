...
function Initialize-V2024IdentityExceptionReportReference {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024IdentityExceptionReportReference' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityExceptionReportReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024IdentityExceptionReportReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-EmailNotificationOption {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => EmailNotificationOption' | Write-Debug
...
function ConvertFrom-JsonToEmailNotificationOption {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => EmailNotificationOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-WorkflowOAuthClient {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => WorkflowOAuthClient' | Write-Debug
...
function ConvertFrom-JsonToWorkflowOAuthClient {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => WorkflowOAuthClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaEntitlementRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaEntitlementRef' | Write-Debug
...
EntitlementRef<PSCustomObject>
#>
function ConvertFrom-BetaJsonToEntitlementRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaEntitlementRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

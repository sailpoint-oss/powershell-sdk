...
function Initialize-BetaAccessRequestPreApproval1 {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestPreApproval1' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPreApproval1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestPreApproval1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

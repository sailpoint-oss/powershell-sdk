...
keywords: ['powershell', 'PowerShell', 'sdk', 'ClassifySource', 'V2026ClassifySource'] 
slug: /tools/sdk/powershell/v2026/methods/classify-source
...
------------- | ------------- | -------------
[**Remove-V2026ClassifyMachineAccountFromSource**](#delete-classify-machine-account-from-source) | **DELETE** `/sources/{sourceId}/classify` | Cancel classify source&#39;s accounts process
[**Get-V2026ClassifyMachineAccountFromSourceStatus**](#get-classify-machine-account-from-source-status) | **GET** `/sources/{sourceId}/classify` | Source accounts classification status
[**Send-V2026ClassifyMachineAccountFromSource**](#send-classify-machine-account-from-source) | **POST** `/sources/{sourceId}/classify` | Classify source&#39;s all accounts
...
try {
    Remove-V2026ClassifyMachineAccountFromSource -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026ClassifyMachineAccountFromSource -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026ClassifyMachineAccountFromSource"
...
try {
    Get-V2026ClassifyMachineAccountFromSourceStatus -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ClassifyMachineAccountFromSourceStatus -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ClassifyMachineAccountFromSourceStatus"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Send-V2026ClassifyMachineAccountFromSource -SourceId $SourceId 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ClassifyMachineAccountFromSource -SourceId $SourceId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ClassifyMachineAccountFromSource"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

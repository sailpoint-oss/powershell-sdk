...
function Initialize-LockoutConfiguration {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => LockoutConfiguration' | Write-Debug
...
function ConvertFrom-JsonToLockoutConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => LockoutConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

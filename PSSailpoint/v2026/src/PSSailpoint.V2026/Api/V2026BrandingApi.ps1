...
BrandingItem
#>
function New-V2026BrandingItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026BrandingItem' | Write-Debug
...
function Remove-V2026Branding {
    ...
    Process {
        'Calling method: Remove-V2026Branding' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026Branding {
    ...
    Process {
        'Calling method: Get-V2026Branding' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
BrandingItem[]
#>
function Get-V2026BrandingList {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2026BrandingList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
BrandingItem
#>
function Set-V2026BrandingItem {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-V2026BrandingItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

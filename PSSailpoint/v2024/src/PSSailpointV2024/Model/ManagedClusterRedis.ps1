...
function Initialize-V2024ManagedClusterRedis {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ManagedClusterRedis' | Write-Debug
...
function ConvertFrom-V2024JsonToManagedClusterRedis {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ManagedClusterRedis' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024NonEmployeeSourceWithNECount {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024NonEmployeeSourceWithNECount' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeSourceWithNECount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024NonEmployeeSourceWithNECount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

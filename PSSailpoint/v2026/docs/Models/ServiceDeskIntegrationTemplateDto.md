...
keywords: ['powershell', 'PowerShell', 'sdk', 'ServiceDeskIntegrationTemplateDto', 'V2026ServiceDeskIntegrationTemplateDto'] 
slug: /tools/sdk/powershell/v2026/models/service-desk-integration-template-dto
...
```powershell
$ServiceDeskIntegrationTemplateDto = Initialize-V2026ServiceDeskIntegrationTemplateDto  -Id id12345 `
 -Name aName `

...
function Initialize-ServiceDeskIntegrationTemplateDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ServiceDeskIntegrationTemplateDto' | Write-Debug
...
function ConvertFrom-JsonToServiceDeskIntegrationTemplateDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ServiceDeskIntegrationTemplateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ReviewableentitlementAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationsV1 => ReviewableentitlementAccount' | Write-Debug
...
function ConvertFrom-JsonToReviewableentitlementAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationsV1 => ReviewableentitlementAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

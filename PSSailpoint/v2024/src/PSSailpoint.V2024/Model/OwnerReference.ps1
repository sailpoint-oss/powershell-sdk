...
function Initialize-V2024OwnerReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024OwnerReference' | Write-Debug
...
function ConvertFrom-V2024JsonToOwnerReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024OwnerReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

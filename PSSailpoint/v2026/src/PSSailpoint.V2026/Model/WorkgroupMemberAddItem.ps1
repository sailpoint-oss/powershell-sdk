...
function Initialize-V2026WorkgroupMemberAddItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026WorkgroupMemberAddItem' | Write-Debug
...
WorkgroupMemberAddItem<PSCustomObject>
#>
function ConvertFrom-V2026JsonToWorkgroupMemberAddItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026WorkgroupMemberAddItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026WorkgroupMemberAddItem

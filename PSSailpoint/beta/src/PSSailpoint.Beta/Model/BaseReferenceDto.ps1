...
function Initialize-BetaBaseReferenceDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaBaseReferenceDto' | Write-Debug
...
function ConvertFrom-BetaJsonToBaseReferenceDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaBaseReferenceDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

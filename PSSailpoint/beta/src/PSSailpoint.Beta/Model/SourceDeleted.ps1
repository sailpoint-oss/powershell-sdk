...
function Initialize-BetaSourceDeleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceDeleted' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceDeleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceDeleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

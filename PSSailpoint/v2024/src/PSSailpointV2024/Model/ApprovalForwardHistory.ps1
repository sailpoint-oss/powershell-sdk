...
function Initialize-V2024ApprovalForwardHistory {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalForwardHistory' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalForwardHistory {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalForwardHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ApprovalBatch {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalBatch' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalBatch {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalBatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

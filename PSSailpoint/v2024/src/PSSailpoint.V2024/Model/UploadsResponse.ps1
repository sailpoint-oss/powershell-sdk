...
function Initialize-V2024UploadsResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024UploadsResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToUploadsResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024UploadsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

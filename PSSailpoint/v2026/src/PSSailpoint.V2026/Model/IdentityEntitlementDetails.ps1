...
function Initialize-V2026IdentityEntitlementDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IdentityEntitlementDetails' | Write-Debug
...
IdentityEntitlementDetails<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIdentityEntitlementDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IdentityEntitlementDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IdentityEntitlementDetails

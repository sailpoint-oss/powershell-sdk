...
function Initialize-V2024OutlierFeatureSummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024OutlierFeatureSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToOutlierFeatureSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024OutlierFeatureSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

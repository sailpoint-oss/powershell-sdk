...
function Initialize-BetaSavedSearchCompleteSearchResults {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSavedSearchCompleteSearchResults' | Write-Debug
...
function ConvertFrom-BetaJsonToSavedSearchCompleteSearchResults {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSavedSearchCompleteSearchResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

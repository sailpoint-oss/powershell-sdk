...
function Initialize-V2024AccessProfileSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaUUIDGenerator {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaUUIDGenerator' | Write-Debug
...
function ConvertFrom-BetaJsonToUUIDGenerator {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaUUIDGenerator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Taskstatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TaskManagement => Taskstatus' | Write-Debug
...
function ConvertFrom-JsonToTaskstatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TaskManagement => Taskstatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

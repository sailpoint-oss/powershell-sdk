...
function Initialize-V2024IdentityWithNewAccess1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024IdentityWithNewAccess1' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityWithNewAccess1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024IdentityWithNewAccess1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

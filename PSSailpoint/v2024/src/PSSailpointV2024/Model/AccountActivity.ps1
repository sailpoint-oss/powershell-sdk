...
function Initialize-V2024AccountActivity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountActivity' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountActivity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountActivity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

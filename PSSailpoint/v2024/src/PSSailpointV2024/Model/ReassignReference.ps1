...
function Initialize-V2024ReassignReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ReassignReference' | Write-Debug
...
function ConvertFrom-V2024JsonToReassignReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ReassignReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessProfileDocument', 'V2026AccessProfileDocument'] 
slug: /tools/sdk/powershell/v2026/models/access-profile-document
...
```powershell
$AccessProfileDocument = Initialize-V2026AccessProfileDocument  -Description Admin access `

...
keywords: ['powershell', 'PowerShell', 'sdk', 'CertificationCampaignFilters', 'V2026CertificationCampaignFilters'] 
slug: /tools/sdk/powershell/v2026/methods/certification-campaign-filters
...
------------- | ------------- | -------------
[**New-V2026CampaignFilter**](#create-campaign-filter) | **POST** `/campaign-filters` | Create campaign filter
[**Remove-V2026CampaignFilters**](#delete-campaign-filters) | **POST** `/campaign-filters/delete` | Deletes campaign filters
[**Get-V2026CampaignFilterById**](#get-campaign-filter-by-id) | **GET** `/campaign-filters/{id}` | Get campaign filter by id
[**Get-V2026CampaignFilters**](#list-campaign-filters) | **GET** `/campaign-filters` | List campaign filters
[**Update-V2026CampaignFilter**](#update-campaign-filter) | **POST** `/campaign-filters/{id}` | Updates a campaign filter
...
try {
    $Result = ConvertFrom-V2026JsonToCampaignFilterDetails -Json $CampaignFilterDetails
    New-V2026CampaignFilter -CampaignFilterDetails $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026CampaignFilter -CampaignFilterDetails $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026CampaignFilter"
...
try {
    ...
    Remove-V2026CampaignFilters -RequestBody $Result 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026CampaignFilters -RequestBody $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026CampaignFilters"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026CampaignFilterById -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026CampaignFilterById -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026CampaignFilterById"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026CampaignFilters 
    
    # Below is a request that includes all optional parameters
    # Get-V2026CampaignFilters -Limit $Limit -Start $Start -IncludeSystemFilters $IncludeSystemFilters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026CampaignFilters"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToCampaignFilterDetails -Json $CampaignFilterDetails
    Update-V2026CampaignFilter -FilterId $FilterId -CampaignFilterDetails $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026CampaignFilter -FilterId $FilterId -CampaignFilterDetails $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026CampaignFilter"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-LauncherrequestReference {
    [CmdletBinding()]
    Param (
...
LauncherrequestReference<PSCustomObject>
#>
function ConvertFrom-JsonToLauncherrequestReference {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in LauncherrequestReference

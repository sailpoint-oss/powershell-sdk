...
function Initialize-Formelementvalidationsset {
    [CmdletBinding()]
    Param (
...
Formelementvalidationsset<PSCustomObject>
#>
function ConvertFrom-JsonToFormelementvalidationsset {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Formelementvalidationsset

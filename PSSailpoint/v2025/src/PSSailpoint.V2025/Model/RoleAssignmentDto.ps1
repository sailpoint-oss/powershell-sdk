...
function Initialize-V2025RoleAssignmentDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleAssignmentDto' | Write-Debug
...
RoleAssignmentDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleAssignmentDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleAssignmentDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

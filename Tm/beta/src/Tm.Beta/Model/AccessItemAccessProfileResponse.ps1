...
function Initialize-BetaAccessItemAccessProfileResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessItemAccessProfileResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessItemAccessProfileResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessItemAccessProfileResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

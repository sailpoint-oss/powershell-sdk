...
function Initialize-V2025SodViolationContextConflictingAccessCriteria {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SodViolationContextConflictingAccessCriteria' | Write-Debug
...
SodViolationContextConflictingAccessCriteria<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSodViolationContextConflictingAccessCriteria {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SodViolationContextConflictingAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SodViolationContextConflictingAccessCriteria

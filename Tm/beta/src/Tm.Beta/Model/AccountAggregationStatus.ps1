...
function Initialize-BetaAccountAggregationStatus {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountAggregationStatus' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAggregationStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountAggregationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-DataAccessCategoriesInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => DataAccessCategoriesInner' | Write-Debug
...
function ConvertFrom-JsonToDataAccessCategoriesInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => DataAccessCategoriesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ErrorMessageDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Branding => ErrorMessageDto' | Write-Debug
...
function ConvertFrom-JsonToErrorMessageDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Branding => ErrorMessageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

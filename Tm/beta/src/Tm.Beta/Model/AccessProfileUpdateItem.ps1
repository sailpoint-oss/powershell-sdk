...
function Initialize-BetaAccessProfileUpdateItem {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessProfileUpdateItem' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileUpdateItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessProfileUpdateItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

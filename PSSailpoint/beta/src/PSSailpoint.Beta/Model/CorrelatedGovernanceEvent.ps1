...
function Initialize-BetaCorrelatedGovernanceEvent {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCorrelatedGovernanceEvent' | Write-Debug
...
function ConvertFrom-BetaJsonToCorrelatedGovernanceEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCorrelatedGovernanceEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

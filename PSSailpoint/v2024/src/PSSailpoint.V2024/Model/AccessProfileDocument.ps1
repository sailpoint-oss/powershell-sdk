...
function Initialize-V2024AccessProfileDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessProfileDocument' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessProfileDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

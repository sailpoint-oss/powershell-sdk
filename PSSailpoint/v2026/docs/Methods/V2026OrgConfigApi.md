...
keywords: ['powershell', 'PowerShell', 'sdk', 'OrgConfig', 'V2026OrgConfig'] 
slug: /tools/sdk/powershell/v2026/methods/org-config
...
------------- | ------------- | -------------
[**Get-V2026OrgConfig**](#get-org-config) | **GET** `/org-config` | Get org config settings
[**Get-V2026ValidTimeZones**](#get-valid-time-zones) | **GET** `/org-config/valid-time-zones` | Get valid time zones
[**Update-V2026OrgConfig**](#patch-org-config) | **PATCH** `/org-config` | Patch org config
...
try {
    ...
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026OrgConfig"
...
try {
    Get-V2026ValidTimeZones -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ValidTimeZones -XSailPointExperimental $XSailPointExperimental -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ValidTimeZones"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026OrgConfig -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026OrgConfig -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026OrgConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

...
function Initialize-V2025IdentityCertDecisionSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025IdentityCertDecisionSummary' | Write-Debug
...
IdentityCertDecisionSummary<PSCustomObject>
#>
function ConvertFrom-V2025JsonToIdentityCertDecisionSummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025IdentityCertDecisionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025IdentityCertDecisionSummary

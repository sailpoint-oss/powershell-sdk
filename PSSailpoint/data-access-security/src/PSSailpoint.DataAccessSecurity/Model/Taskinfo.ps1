...
function Initialize-Taskinfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DataAccessSecurity => Taskinfo' | Write-Debug
...
function ConvertFrom-JsonToTaskinfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DataAccessSecurity => Taskinfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026AccountsCollectedForAggregation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccountsCollectedForAggregation' | Write-Debug
...
AccountsCollectedForAggregation<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccountsCollectedForAggregation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccountsCollectedForAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccountsCollectedForAggregation

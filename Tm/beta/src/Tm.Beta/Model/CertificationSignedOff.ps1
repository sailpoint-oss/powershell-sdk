...
function Initialize-BetaCertificationSignedOff {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCertificationSignedOff' | Write-Debug
...
function ConvertFrom-BetaJsonToCertificationSignedOff {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCertificationSignedOff' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ManuallyUpdatedFieldsDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ManuallyUpdatedFieldsDTO' | Write-Debug
...
ManuallyUpdatedFieldsDTO<PSCustomObject>
#>
function ConvertFrom-V2024JsonToManuallyUpdatedFieldsDTO {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ManuallyUpdatedFieldsDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ManuallyUpdatedFieldsDTO

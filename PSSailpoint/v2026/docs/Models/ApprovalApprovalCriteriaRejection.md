...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalApprovalCriteriaRejection', 'V2026ApprovalApprovalCriteriaRejection'] 
slug: /tools/sdk/powershell/v2026/models/approval-approval-criteria-rejection
...
```powershell
$ApprovalApprovalCriteriaRejection = Initialize-V2026ApprovalApprovalCriteriaRejection  -CalculationType COUNT `
 -Value 30
```

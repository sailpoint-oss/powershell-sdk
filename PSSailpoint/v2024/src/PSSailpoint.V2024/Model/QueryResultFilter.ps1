...
function Initialize-V2024QueryResultFilter {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024QueryResultFilter' | Write-Debug
...
function ConvertFrom-V2024JsonToQueryResultFilter {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024QueryResultFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

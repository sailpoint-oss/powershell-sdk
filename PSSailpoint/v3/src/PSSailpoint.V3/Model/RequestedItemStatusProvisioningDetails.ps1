...
function Initialize-RequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RequestedItemStatusProvisioningDetails' | Write-Debug
...
function ConvertFrom-JsonToRequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RequestedItemStatusProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

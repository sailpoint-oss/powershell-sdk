...
function Initialize-V2024TemplateSlack {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TemplateSlack' | Write-Debug
...
function ConvertFrom-V2024JsonToTemplateSlack {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TemplateSlack' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

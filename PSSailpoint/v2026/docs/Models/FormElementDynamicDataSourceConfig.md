...
keywords: ['powershell', 'PowerShell', 'sdk', 'FormElementDynamicDataSourceConfig', 'V2026FormElementDynamicDataSourceConfig'] 
slug: /tools/sdk/powershell/v2026/models/form-element-dynamic-data-source-config
...
```powershell
$FormElementDynamicDataSourceConfig = Initialize-V2026FormElementDynamicDataSourceConfig  -AggregationBucketField attributes.cloudStatus.exact `
 -Indices [identities] `
 -ObjectType IDENTITY `
 -Query *
```

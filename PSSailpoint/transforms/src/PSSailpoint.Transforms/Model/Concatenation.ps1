...
function Initialize-Concatenation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Transforms => Concatenation' | Write-Debug
...
function ConvertFrom-JsonToConcatenation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Transforms => Concatenation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

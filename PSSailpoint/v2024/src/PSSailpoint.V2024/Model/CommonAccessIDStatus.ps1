...
function Initialize-V2024CommonAccessIDStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CommonAccessIDStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToCommonAccessIDStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CommonAccessIDStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

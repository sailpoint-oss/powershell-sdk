...
keywords: ['powershell', 'PowerShell', 'sdk', 'SodViolationCheckResult', 'V2026SodViolationCheckResult'] 
slug: /tools/sdk/powershell/v2026/models/sod-violation-check-result
...
```powershell
$SodViolationCheckResult = Initialize-V2026SodViolationCheckResult  -Message null `

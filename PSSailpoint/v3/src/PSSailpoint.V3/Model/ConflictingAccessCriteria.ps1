...
function Initialize-ConflictingAccessCriteria {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ConflictingAccessCriteria' | Write-Debug
...
function ConvertFrom-JsonToConflictingAccessCriteria {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ConflictingAccessCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaV3ConnectorDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaV3ConnectorDto' | Write-Debug
...
function ConvertFrom-BetaJsonToV3ConnectorDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaV3ConnectorDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

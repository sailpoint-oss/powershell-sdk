...
function Initialize-V2026RequestedItemStatusSodViolationContext {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemStatusSodViolationContext' | Write-Debug
...
RequestedItemStatusSodViolationContext<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRequestedItemStatusSodViolationContext {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemStatusSodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RequestedItemStatusSodViolationContext

...
function Initialize-V2024RequestedItemStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RequestedItemStatus' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestedItemStatus {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RequestedItemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

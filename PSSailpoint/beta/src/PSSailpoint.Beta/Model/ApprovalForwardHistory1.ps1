...
function Initialize-BetaApprovalForwardHistory1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalForwardHistory1' | Write-Debug
...
ApprovalForwardHistory1<PSCustomObject>
#>
function ConvertFrom-BetaJsonToApprovalForwardHistory1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalForwardHistory1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaApprovalForwardHistory1

...
function Initialize-V2024AccessProfileBulkDeleteResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessProfileBulkDeleteResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileBulkDeleteResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessProfileBulkDeleteResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

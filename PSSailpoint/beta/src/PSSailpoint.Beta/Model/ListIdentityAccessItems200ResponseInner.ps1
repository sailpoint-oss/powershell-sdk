...
function ConvertFrom-BetaJsonToListIdentityAccessItems200ResponseInner {
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'AccessItemAccessProfileResponse' defined in oneOf (BetaListIdentityAccessItems200ResponseInner). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'AccessItemAccountResponse' defined in oneOf (BetaListIdentityAccessItems200ResponseInner). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'AccessItemAppResponse' defined in oneOf (BetaListIdentityAccessItems200ResponseInner). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'AccessItemEntitlementResponse' defined in oneOf (BetaListIdentityAccessItems200ResponseInner). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'AccessItemRoleResponse' defined in oneOf (BetaListIdentityAccessItems200ResponseInner). Proceeding to the next one if any."
        }

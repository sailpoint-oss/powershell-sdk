...
Approval1<PSCustomObject>
#>

function Initialize-V2025Approval1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025Approval1' | Write-Debug
...
Convert from JSON to Approval1<PSCustomObject>
...
Approval1<PSCustomObject>
#>
function ConvertFrom-V2025JsonToApproval1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025Approval1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025Approval1

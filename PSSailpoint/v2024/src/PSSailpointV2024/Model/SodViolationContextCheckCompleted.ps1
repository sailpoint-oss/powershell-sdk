...
function Initialize-V2024SodViolationContextCheckCompleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SodViolationContextCheckCompleted' | Write-Debug
...
function ConvertFrom-V2024JsonToSodViolationContextCheckCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SodViolationContextCheckCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

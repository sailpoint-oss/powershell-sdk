...
function Initialize-Identityreference {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CustomUserLevelsV1 => Identityreference' | Write-Debug
...
Identityreference<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityreference {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CustomUserLevelsV1 => Identityreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Identityreference

...
function New-V2025Dimension {
    ...
    Process {
        'Calling method: New-V2025Dimension' | Write-Debug
...
TaskResultDto
#>
function Remove-V2025BulkDimensions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025BulkDimensions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-V2025Dimension {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025Dimension' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025Dimension {
    ...
    Process {
        'Calling method: Get-V2025Dimension' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Entitlement[]
#>
function Get-V2025DimensionEntitlements {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025DimensionEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessProfile[]
#>
function Get-V2025DimensionAccessProfiles {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025DimensionAccessProfiles' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025Dimensions {
    ...
    Process {
        'Calling method: Get-V2025Dimensions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Dimension
#>
function Update-V2025Dimension {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025Dimension' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

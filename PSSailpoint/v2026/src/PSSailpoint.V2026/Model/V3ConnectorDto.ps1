...
function Initialize-V2026V3ConnectorDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026V3ConnectorDto' | Write-Debug
...
V3ConnectorDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToV3ConnectorDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026V3ConnectorDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026V3ConnectorDto

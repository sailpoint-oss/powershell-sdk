...
#>
function New-V2026RoleInsightRequests {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026RoleInsightRequests' | Write-Debug
...
String
#>
function Invoke-V2026DownloadRoleInsightsEntitlementsChanges {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2026DownloadRoleInsightsEntitlementsChanges' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026EntitlementChangesIdentities {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026EntitlementChangesIdentities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026RoleInsight {
    ...
    Process {
        'Calling method: Get-V2026RoleInsight' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
RoleInsight[]
#>
function Get-V2026RoleInsights {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026RoleInsights' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026RoleInsightsCurrentEntitlements {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026RoleInsightsCurrentEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026RoleInsightsEntitlementsChanges {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026RoleInsightsEntitlementsChanges' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
RoleInsightsResponse
#>
function Get-V2026RoleInsightsRequests {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026RoleInsightsRequests' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
RoleInsightsSummary
#>
function Get-V2026RoleInsightsSummary {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026RoleInsightsSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

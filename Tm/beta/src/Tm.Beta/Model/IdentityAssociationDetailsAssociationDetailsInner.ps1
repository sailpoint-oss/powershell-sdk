...
function Initialize-BetaIdentityAssociationDetailsAssociationDetailsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaIdentityAssociationDetailsAssociationDetailsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAssociationDetailsAssociationDetailsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaIdentityAssociationDetailsAssociationDetailsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

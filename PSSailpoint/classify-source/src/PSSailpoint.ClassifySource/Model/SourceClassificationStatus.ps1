...
function Initialize-SourceClassificationStatus {
    [CmdletBinding()]
    Param (
...
SourceClassificationStatus<PSCustomObject>
#>
function ConvertFrom-JsonToSourceClassificationStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SourceClassificationStatus

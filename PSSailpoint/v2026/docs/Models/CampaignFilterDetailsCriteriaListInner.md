...
keywords: ['powershell', 'PowerShell', 'sdk', 'CampaignFilterDetailsCriteriaListInner', 'V2026CampaignFilterDetailsCriteriaListInner'] 
slug: /tools/sdk/powershell/v2026/models/campaign-filter-details-criteria-list-inner
...
```powershell
$CampaignFilterDetailsCriteriaListInner = Initialize-V2026CampaignFilterDetailsCriteriaListInner  -Type null `
 -Operation null `

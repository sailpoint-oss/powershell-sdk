...
PasswordPolicyV3Dto
#>
function New-V2025PasswordPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025PasswordPolicy' | Write-Debug
...
None
#>
function Remove-V2025PasswordPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025PasswordPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto
#>
function Get-V2025PasswordPolicyById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025PasswordPolicyById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto[]
#>
function Get-V2025PasswordPolicies {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2025PasswordPolicies' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto
#>
function Set-V2025PasswordPolicy {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-V2025PasswordPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

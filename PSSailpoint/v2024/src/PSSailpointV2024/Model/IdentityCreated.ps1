...
function Initialize-V2024IdentityCreated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityCreated' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityCreated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityCreated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

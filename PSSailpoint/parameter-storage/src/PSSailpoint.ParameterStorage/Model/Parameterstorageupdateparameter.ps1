...
function Initialize-Parameterstorageupdateparameter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ParameterStorageV1 => Parameterstorageupdateparameter' | Write-Debug
...
Parameterstorageupdateparameter<PSCustomObject>
#>
function ConvertFrom-JsonToParameterstorageupdateparameter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ParameterStorageV1 => Parameterstorageupdateparameter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Parameterstorageupdateparameter

...
function Initialize-BetaCampaignGenerated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCampaignGenerated' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignGenerated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCampaignGenerated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

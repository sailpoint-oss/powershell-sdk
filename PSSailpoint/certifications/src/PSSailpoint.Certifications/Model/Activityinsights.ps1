...
function Initialize-Activityinsights {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Certifications => Activityinsights' | Write-Debug
...
function ConvertFrom-JsonToActivityinsights {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Certifications => Activityinsights' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

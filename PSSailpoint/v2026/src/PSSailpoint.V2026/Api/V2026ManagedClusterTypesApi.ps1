...
ManagedClusterType
#>
function New-V2026ManagedClusterType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2026ManagedClusterType' | Write-Debug
...
None
#>
function Remove-V2026ManagedClusterType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026ManagedClusterType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClusterType
#>
function Get-V2026ManagedClusterType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ManagedClusterType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClusterType[]
#>
function Get-V2026ManagedClusterTypes {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026ManagedClusterTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClusterType
#>
function Update-V2026ManagedClusterType {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026ManagedClusterType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

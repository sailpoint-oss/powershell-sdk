...
keywords: ['powershell', 'PowerShell', 'sdk', 'RolePropagationConfigResponse', 'V2026RolePropagationConfigResponse'] 
slug: /tools/sdk/powershell/v2026/models/role-propagation-config-response
...
```powershell
$RolePropagationConfigResponse = Initialize-V2026RolePropagationConfigResponse  -Enabled true `

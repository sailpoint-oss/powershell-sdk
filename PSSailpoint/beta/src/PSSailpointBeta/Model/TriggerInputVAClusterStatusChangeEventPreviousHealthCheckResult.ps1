...
TriggerInputVAClusterStatusChangeEventPreviousHealthCheckResult<PSCustomObject>
#>

function Initialize-BetaTriggerInputVAClusterStatusChangeEventPreviousHealthCheckResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputVAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
...
Convert from JSON to TriggerInputVAClusterStatusChangeEventPreviousHealthCheckResult<PSCustomObject>
...
TriggerInputVAClusterStatusChangeEventPreviousHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputVAClusterStatusChangeEventPreviousHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputVAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputVAClusterStatusChangeEventPreviousHealthCheckResult

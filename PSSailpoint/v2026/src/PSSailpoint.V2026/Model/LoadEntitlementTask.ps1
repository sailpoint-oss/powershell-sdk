...
function Initialize-V2026LoadEntitlementTask {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026LoadEntitlementTask' | Write-Debug
...
LoadEntitlementTask<PSCustomObject>
#>
function ConvertFrom-V2026JsonToLoadEntitlementTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026LoadEntitlementTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026LoadEntitlementTask

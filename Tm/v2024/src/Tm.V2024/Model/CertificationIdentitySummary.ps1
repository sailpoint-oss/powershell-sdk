...
function Initialize-V2024CertificationIdentitySummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CertificationIdentitySummary' | Write-Debug
...
function ConvertFrom-V2024JsonToCertificationIdentitySummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CertificationIdentitySummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
RightPad<PSCustomObject>
#>

function Initialize-V2025RightPad {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RightPad' | Write-Debug
...
Convert from JSON to RightPad<PSCustomObject>
...
RightPad<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRightPad {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RightPad' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RightPad

...
keywords: ['powershell', 'PowerShell', 'sdk', 'WorkflowLibraryFormFields', 'V2026WorkflowLibraryFormFields'] 
slug: /tools/sdk/powershell/v2026/models/workflow-library-form-fields
...
```powershell
$WorkflowLibraryFormFields = Initialize-V2026WorkflowLibraryFormFields  -Description First value to compare `

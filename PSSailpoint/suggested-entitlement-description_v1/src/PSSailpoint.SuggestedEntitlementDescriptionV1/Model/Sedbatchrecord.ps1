...
function Initialize-Sedbatchrecord {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SuggestedEntitlementDescriptionV1 => Sedbatchrecord' | Write-Debug
...
Sedbatchrecord<PSCustomObject>
#>
function ConvertFrom-JsonToSedbatchrecord {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SuggestedEntitlementDescriptionV1 => Sedbatchrecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Sedbatchrecord

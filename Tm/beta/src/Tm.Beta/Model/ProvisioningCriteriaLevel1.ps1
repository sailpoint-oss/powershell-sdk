...
function Initialize-BetaProvisioningCriteriaLevel1 {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaProvisioningCriteriaLevel1' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningCriteriaLevel1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaProvisioningCriteriaLevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

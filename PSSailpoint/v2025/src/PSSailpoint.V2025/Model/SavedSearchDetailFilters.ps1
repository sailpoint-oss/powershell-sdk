...
function Initialize-V2025SavedSearchDetailFilters {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SavedSearchDetailFilters' | Write-Debug
...
SavedSearchDetailFilters<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSavedSearchDetailFilters {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SavedSearchDetailFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SavedSearchDetailFilters

...
function Get-PrivilegeCriteriaConfigV1 {
    ...
    Process {
        'Calling method: Get-PrivilegeCriteriaConfigV1' | Write-Debug
        ...
        $LocalVarUri = '/criteria-config/v1/privilege/{criteriaConfigId}'
        if (!$CriteriaConfigId) {
            throw "Error! The required parameter `CriteriaConfigId` missing when calling getPrivilegeCriteriaConfigV1."
        }
...
function Get-PrivilegeCriteriaConfigV1 {
    ...
    Process {
        ...
        $LocalVarUri = '/criteria-config/v1/privilege'

        if (!$Filters) {
            throw "Error! The required parameter `Filters` missing when calling listPrivilegeCriteriaConfigV1."
        }
...
function Update-PrivilegeCriteriaConfigV1 {
    ...
    Process {
        'Calling method: Update-PrivilegeCriteriaConfigV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/criteria-config/v1/privilege/{criteriaConfigId}'
        if (!$CriteriaConfigId) {
            throw "Error! The required parameter `CriteriaConfigId` missing when calling patchPrivilegeCriteriaConfigV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{criteriaConfigId}', [System.Web.HTTPUtility]::UrlEncode($CriteriaConfigId))

        if (!$RequestBody) {
            throw "Error! The required parameter `RequestBody` missing when calling patchPrivilegeCriteriaConfigV1."
        }

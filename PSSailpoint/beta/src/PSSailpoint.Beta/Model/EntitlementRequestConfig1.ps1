...
function Initialize-BetaEntitlementRequestConfig1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaEntitlementRequestConfig1' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementRequestConfig1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaEntitlementRequestConfig1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

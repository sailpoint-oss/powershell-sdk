...
function Initialize-BetaNonEmployeeSource {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaNonEmployeeSource' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaNonEmployeeSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
AttributeDTO
#>
function New-BetaAccessModelMetadataAttribute {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-BetaAccessModelMetadataAttribute' | Write-Debug
...
AttributeValueDTO
#>
function New-BetaAccessModelMetadataAttributeValue {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: New-BetaAccessModelMetadataAttributeValue' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AttributeDTO
#>
function Update-BetaAccessModelMetadataAttribute {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-BetaAccessModelMetadataAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AttributeValueDTO
#>
function Update-BetaAccessModelMetadataAttributeValue {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-BetaAccessModelMetadataAttributeValue' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Certificationreference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Certifications => Certificationreference' | Write-Debug
...
function ConvertFrom-JsonToCertificationreference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Certifications => Certificationreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaRemediationItemDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRemediationItemDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToRemediationItemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRemediationItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
```powershell
$CompletedApprovalPreApprovalTriggerResult = Initialize-Tm.V2024CompletedApprovalPreApprovalTriggerResult  -Comment This request was autoapproved by our automated ETS subscriber `
 -Decision null `

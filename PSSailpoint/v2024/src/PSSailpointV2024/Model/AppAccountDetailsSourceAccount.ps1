...
function Initialize-V2024AppAccountDetailsSourceAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AppAccountDetailsSourceAccount' | Write-Debug
...
function ConvertFrom-V2024JsonToAppAccountDetailsSourceAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AppAccountDetailsSourceAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

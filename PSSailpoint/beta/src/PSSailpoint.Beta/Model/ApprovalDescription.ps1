...
function Initialize-BetaApprovalDescription {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalDescription' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalDescription {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalDescription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026CampaignAllOfRoleCompositionCampaignInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
...
CampaignAllOfRoleCompositionCampaignInfo<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCampaignAllOfRoleCompositionCampaignInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CampaignAllOfRoleCompositionCampaignInfo

...
function Initialize-V2026RequestedItemDtoRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemDtoRef' | Write-Debug
...
RequestedItemDtoRef<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRequestedItemDtoRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemDtoRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RequestedItemDtoRef
        $AllProperties = ("type", "id", "comment", "clientMetadata", "startDate", "removeDate", "accountSelection")

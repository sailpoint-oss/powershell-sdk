...
keywords: ['powershell', 'PowerShell', 'sdk', 'MfaConfigTestResponse', 'V2026MfaConfigTestResponse'] 
slug: /tools/sdk/powershell/v2026/models/mfa-config-test-response
...
```powershell
$MfaConfigTestResponse = Initialize-V2026MfaConfigTestResponse  -State SUCCESS `

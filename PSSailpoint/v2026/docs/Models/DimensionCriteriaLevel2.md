...
keywords: ['powershell', 'PowerShell', 'sdk', 'DimensionCriteriaLevel2', 'V2026DimensionCriteriaLevel2'] 
slug: /tools/sdk/powershell/v2026/models/dimension-criteria-level2
...
```powershell
$DimensionCriteriaLevel2 = Initialize-V2026DimensionCriteriaLevel2  -Operation null `
 -Key null `

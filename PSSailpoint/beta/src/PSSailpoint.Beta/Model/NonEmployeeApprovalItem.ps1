...
function Initialize-BetaNonEmployeeApprovalItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeApprovalItem' | Write-Debug
...
NonEmployeeApprovalItem<PSCustomObject>
#>
function ConvertFrom-BetaJsonToNonEmployeeApprovalItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaNonEmployeeApprovalItem

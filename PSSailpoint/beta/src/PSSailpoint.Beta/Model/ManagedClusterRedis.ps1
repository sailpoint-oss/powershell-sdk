...
function Initialize-BetaManagedClusterRedis {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaManagedClusterRedis' | Write-Debug
...
function ConvertFrom-BetaJsonToManagedClusterRedis {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaManagedClusterRedis' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

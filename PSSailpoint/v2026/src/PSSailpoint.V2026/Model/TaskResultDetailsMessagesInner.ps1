...
function Initialize-V2026TaskResultDetailsMessagesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TaskResultDetailsMessagesInner' | Write-Debug
...
TaskResultDetailsMessagesInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTaskResultDetailsMessagesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TaskResultDetailsMessagesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TaskResultDetailsMessagesInner

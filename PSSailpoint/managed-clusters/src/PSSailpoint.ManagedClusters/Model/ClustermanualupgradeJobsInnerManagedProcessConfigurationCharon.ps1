...
ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon<PSCustomObject>
#>

function Initialize-ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClustersV1 => ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
...
Convert from JSON to ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon<PSCustomObject>
...
ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon<PSCustomObject>
#>
function ConvertFrom-JsonToClustermanualupgradeJobsInnerManagedProcessConfigurationCharon {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClustersV1 => ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermanualupgradeJobsInnerManagedProcessConfigurationCharon

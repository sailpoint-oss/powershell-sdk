...
function Initialize-CreateExternalExecuteWorkflow200Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => CreateExternalExecuteWorkflow200Response' | Write-Debug
...
function ConvertFrom-JsonToCreateExternalExecuteWorkflow200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => CreateExternalExecuteWorkflow200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

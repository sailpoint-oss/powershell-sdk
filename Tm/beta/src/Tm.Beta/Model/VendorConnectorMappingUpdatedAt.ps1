...
function Initialize-BetaVendorConnectorMappingUpdatedAt {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaVendorConnectorMappingUpdatedAt' | Write-Debug
...
function ConvertFrom-BetaJsonToVendorConnectorMappingUpdatedAt {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaVendorConnectorMappingUpdatedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

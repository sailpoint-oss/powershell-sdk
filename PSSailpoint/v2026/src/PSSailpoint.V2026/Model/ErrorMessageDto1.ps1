...
function Initialize-V2026ErrorMessageDto1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ErrorMessageDto1' | Write-Debug
...
ErrorMessageDto1<PSCustomObject>
#>
function ConvertFrom-V2026JsonToErrorMessageDto1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ErrorMessageDto1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ErrorMessageDto1

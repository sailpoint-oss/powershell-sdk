...
function Initialize-V2026AdditionalOwnerRef {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AdditionalOwnerRef' | Write-Debug
...
AdditionalOwnerRef<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAdditionalOwnerRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AdditionalOwnerRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AdditionalOwnerRef

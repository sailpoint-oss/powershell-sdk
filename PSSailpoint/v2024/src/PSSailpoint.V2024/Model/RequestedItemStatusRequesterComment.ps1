...
function Initialize-V2024RequestedItemStatusRequesterComment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatusRequesterComment' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestedItemStatusRequesterComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatusRequesterComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

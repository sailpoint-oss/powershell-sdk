...
function Initialize-V2024TestWorkflow200Response {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024TestWorkflow200Response' | Write-Debug
...
function ConvertFrom-V2024JsonToTestWorkflow200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024TestWorkflow200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

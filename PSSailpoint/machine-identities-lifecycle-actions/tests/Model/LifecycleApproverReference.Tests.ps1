...
Describe -tag 'PSSailpoint.MachineIdentitiesLifecycleActions' -name 'LifecycleApproverReference' {
    Context 'LifecycleApproverReference' {
        It 'Initialize-LifecycleApproverReference' {
            # a simple test to create an object
            #$NewObject = Initialize-LifecycleApproverReference -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE"
            #$NewObject | Should -BeOfType LifecycleApproverReference

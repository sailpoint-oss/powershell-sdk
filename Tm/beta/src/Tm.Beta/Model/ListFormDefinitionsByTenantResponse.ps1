...
function Initialize-BetaListFormDefinitionsByTenantResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaListFormDefinitionsByTenantResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToListFormDefinitionsByTenantResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaListFormDefinitionsByTenantResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

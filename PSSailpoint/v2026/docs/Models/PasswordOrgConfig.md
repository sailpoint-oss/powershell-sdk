...
keywords: ['powershell', 'PowerShell', 'sdk', 'PasswordOrgConfig', 'V2026PasswordOrgConfig'] 
slug: /tools/sdk/powershell/v2026/models/password-org-config
...
```powershell
$PasswordOrgConfig = Initialize-V2026PasswordOrgConfig  -CustomInstructionsEnabled true `

...
function Initialize-BetaApprovalItemDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalItemDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalItemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

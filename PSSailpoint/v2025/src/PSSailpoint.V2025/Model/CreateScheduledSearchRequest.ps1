...
function Initialize-V2025CreateScheduledSearchRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CreateScheduledSearchRequest' | Write-Debug
...
CreateScheduledSearchRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCreateScheduledSearchRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CreateScheduledSearchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CreateScheduledSearchRequest

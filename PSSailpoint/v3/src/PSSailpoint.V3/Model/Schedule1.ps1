...
function Initialize-Schedule1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => Schedule1' | Write-Debug
...
Schedule1<PSCustomObject>
#>
function ConvertFrom-JsonToSchedule1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => Schedule1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

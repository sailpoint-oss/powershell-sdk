...
function Initialize-Bulkapproverequestdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApprovalsV1 => Bulkapproverequestdto' | Write-Debug
...
Bulkapproverequestdto<PSCustomObject>
#>
function ConvertFrom-JsonToBulkapproverequestdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApprovalsV1 => Bulkapproverequestdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Bulkapproverequestdto

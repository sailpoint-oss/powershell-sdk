...
function Initialize-BetaEntityCreatedByDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaEntityCreatedByDTO' | Write-Debug
...
function ConvertFrom-BetaJsonToEntityCreatedByDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaEntityCreatedByDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

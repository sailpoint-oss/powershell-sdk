...
Entitlementmetadatabulkupdatebyqueryrequest<PSCustomObject>
#>

function Initialize-Entitlementmetadatabulkupdatebyqueryrequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Entitlements => Entitlementmetadatabulkupdatebyqueryrequest' | Write-Debug
...
Convert from JSON to Entitlementmetadatabulkupdatebyqueryrequest<PSCustomObject>
...
Entitlementmetadatabulkupdatebyqueryrequest<PSCustomObject>
#>
function ConvertFrom-JsonToEntitlementmetadatabulkupdatebyqueryrequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Entitlements => Entitlementmetadatabulkupdatebyqueryrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Entitlementmetadatabulkupdatebyqueryrequest

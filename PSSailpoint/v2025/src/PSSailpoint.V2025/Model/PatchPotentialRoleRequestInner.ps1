...
function Initialize-V2025PatchPotentialRoleRequestInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025PatchPotentialRoleRequestInner' | Write-Debug
...
PatchPotentialRoleRequestInner<PSCustomObject>
#>
function ConvertFrom-V2025JsonToPatchPotentialRoleRequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025PatchPotentialRoleRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025PatchPotentialRoleRequestInner

...
function Initialize-BetaRoleInsight {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleInsight' | Write-Debug
...
RoleInsight<PSCustomObject>
#>
function ConvertFrom-BetaJsonToRoleInsight {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleInsight' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024SodViolationContextCheckCompleted {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SodViolationContextCheckCompleted' | Write-Debug
...
SodViolationContextCheckCompleted<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSodViolationContextCheckCompleted {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SodViolationContextCheckCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SodViolationContextCheckCompleted

...
function Initialize-BetaIdentityProfileAllOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaIdentityProfileAllOf' | Write-Debug
...
IdentityProfileAllOf<PSCustomObject>
#>
function ConvertFrom-BetaJsonToIdentityProfileAllOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaIdentityProfileAllOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaIdentityProfileAllOf

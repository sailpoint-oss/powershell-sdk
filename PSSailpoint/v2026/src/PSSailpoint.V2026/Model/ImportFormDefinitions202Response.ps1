...
function Initialize-V2026ImportFormDefinitions202Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ImportFormDefinitions202Response' | Write-Debug
...
ImportFormDefinitions202Response<PSCustomObject>
#>
function ConvertFrom-V2026JsonToImportFormDefinitions202Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ImportFormDefinitions202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ImportFormDefinitions202Response

...
function Initialize-V2026LocalizedMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026LocalizedMessage' | Write-Debug
...
LocalizedMessage<PSCustomObject>
#>
function ConvertFrom-V2026JsonToLocalizedMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026LocalizedMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026LocalizedMessage

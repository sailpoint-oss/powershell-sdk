...
function Initialize-Errorresponsedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestApprovals => Errorresponsedto' | Write-Debug
...
function ConvertFrom-JsonToErrorresponsedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestApprovals => Errorresponsedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

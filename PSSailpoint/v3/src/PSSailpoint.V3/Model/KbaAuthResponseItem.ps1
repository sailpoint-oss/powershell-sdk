...
function Initialize-KbaAuthResponseItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => KbaAuthResponseItem' | Write-Debug
...
function ConvertFrom-JsonToKbaAuthResponseItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => KbaAuthResponseItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAdminReviewReassignReassignTo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAdminReviewReassignReassignTo' | Write-Debug
...
function ConvertFrom-BetaJsonToAdminReviewReassignReassignTo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAdminReviewReassignReassignTo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
slug: /tools/sdk/powershell/machineaccountsv1/models/machineaccount
...
**MachineIdentity** | [**AnyType**](any-type) | The machine identity this account is associated with | [optional] 
**OwnerIdentity** | [**AnyType**](any-type) | The identity who owns this account. | [optional] 
...
**Attributes** | [**map[string]AnyType**](any-type) | Custom attributes specific to the machine account | [optional] 
**ConnectorAttributes** | [**map[string]AnyType**](any-type) | The connector attributes for the account | [required]
...
**Source** | [**AnyType**](any-type) | The source this machine account belongs to. | [required]

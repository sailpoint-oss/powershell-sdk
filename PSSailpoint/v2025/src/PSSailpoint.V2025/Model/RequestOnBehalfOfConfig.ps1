...
function Initialize-V2025RequestOnBehalfOfConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RequestOnBehalfOfConfig' | Write-Debug
...
RequestOnBehalfOfConfig<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRequestOnBehalfOfConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RequestOnBehalfOfConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RequestOnBehalfOfConfig

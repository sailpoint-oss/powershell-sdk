...
function Initialize-V2024GetReferenceIdentityAttribute {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024GetReferenceIdentityAttribute' | Write-Debug
...
GetReferenceIdentityAttribute<PSCustomObject>
#>
function ConvertFrom-V2024JsonToGetReferenceIdentityAttribute {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024GetReferenceIdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024GetReferenceIdentityAttribute

...
function Initialize-BetaFormDefinitionResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToFormDefinitionResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

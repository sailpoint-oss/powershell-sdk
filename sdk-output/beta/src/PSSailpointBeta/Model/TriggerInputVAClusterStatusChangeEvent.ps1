...
TriggerInputVAClusterStatusChangeEvent<PSCustomObject>
#>

function Initialize-BetaTriggerInputVAClusterStatusChangeEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputVAClusterStatusChangeEvent' | Write-Debug
...
Convert from JSON to TriggerInputVAClusterStatusChangeEvent<PSCustomObject>
...
TriggerInputVAClusterStatusChangeEvent<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputVAClusterStatusChangeEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputVAClusterStatusChangeEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputVAClusterStatusChangeEvent

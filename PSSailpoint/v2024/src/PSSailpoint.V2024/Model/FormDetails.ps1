...
function Initialize-V2024FormDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024FormDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToFormDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024FormDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

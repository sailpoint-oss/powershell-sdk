...
function Initialize-V2024SpConfigExportResults {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024SpConfigExportResults' | Write-Debug
...
function ConvertFrom-V2024JsonToSpConfigExportResults {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024SpConfigExportResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

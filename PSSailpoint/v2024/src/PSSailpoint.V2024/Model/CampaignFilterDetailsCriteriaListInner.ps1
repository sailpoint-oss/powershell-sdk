...
function Initialize-V2024CampaignFilterDetailsCriteriaListInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CampaignFilterDetailsCriteriaListInner' | Write-Debug
...
CampaignFilterDetailsCriteriaListInner<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCampaignFilterDetailsCriteriaListInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CampaignFilterDetailsCriteriaListInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

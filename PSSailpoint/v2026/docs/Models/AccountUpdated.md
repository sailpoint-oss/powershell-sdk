...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountUpdated', 'V2026AccountUpdated'] 
slug: /tools/sdk/powershell/v2026/models/account-updated
...
```powershell
$AccountUpdated = Initialize-V2026AccountUpdated  -VarEvent null `
 -Source null `
 -Account null `
 -Identity null `

...
function Initialize-BetaLoadAccountsTaskTask {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaLoadAccountsTaskTask' | Write-Debug
...
function ConvertFrom-BetaJsonToLoadAccountsTaskTask {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaLoadAccountsTaskTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

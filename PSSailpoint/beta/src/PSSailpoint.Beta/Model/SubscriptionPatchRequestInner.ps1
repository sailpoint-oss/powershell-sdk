...
function Initialize-BetaSubscriptionPatchRequestInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSubscriptionPatchRequestInner' | Write-Debug
...
function ConvertFrom-BetaJsonToSubscriptionPatchRequestInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSubscriptionPatchRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

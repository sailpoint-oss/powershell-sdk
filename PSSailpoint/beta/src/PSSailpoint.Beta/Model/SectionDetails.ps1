...
function Initialize-BetaSectionDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSectionDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToSectionDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSectionDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaWorkflowOAuthClient {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaWorkflowOAuthClient' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowOAuthClient {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaWorkflowOAuthClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

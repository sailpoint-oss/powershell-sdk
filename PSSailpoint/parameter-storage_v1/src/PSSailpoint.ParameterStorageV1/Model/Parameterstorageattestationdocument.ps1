...
function Initialize-Parameterstorageattestationdocument {
    [CmdletBinding()]
    Param (
...
Parameterstorageattestationdocument<PSCustomObject>
#>
function ConvertFrom-JsonToParameterstorageattestationdocument {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Parameterstorageattestationdocument

...
function Initialize-Connectorruleupdaterequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ConnectorRuleManagementV1 => Connectorruleupdaterequest' | Write-Debug
...
Convert from JSON to Connectorruleupdaterequest<PSCustomObject>
...
Connectorruleupdaterequest<PSCustomObject>
#>
function ConvertFrom-JsonToConnectorruleupdaterequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ConnectorRuleManagementV1 => Connectorruleupdaterequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Connectorruleupdaterequest

...
function Initialize-V2024AccessRequestPostApproval {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestPostApproval' | Write-Debug
...
AccessRequestPostApproval<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccessRequestPostApproval {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestPostApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AccessRequestPostApproval

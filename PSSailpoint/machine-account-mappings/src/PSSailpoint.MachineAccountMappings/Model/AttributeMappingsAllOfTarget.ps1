...
function Initialize-AttributeMappingsAllOfTarget {
    [CmdletBinding()]
    Param (
...
AttributeMappingsAllOfTarget<PSCustomObject>
#>
function ConvertFrom-JsonToAttributeMappingsAllOfTarget {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AttributeMappingsAllOfTarget

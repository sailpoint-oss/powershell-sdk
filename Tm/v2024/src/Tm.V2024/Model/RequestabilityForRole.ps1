...
function Initialize-V2024RequestabilityForRole {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RequestabilityForRole' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestabilityForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RequestabilityForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

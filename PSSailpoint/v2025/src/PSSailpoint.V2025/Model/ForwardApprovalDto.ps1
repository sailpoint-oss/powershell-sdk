...
function Initialize-V2025ForwardApprovalDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ForwardApprovalDto' | Write-Debug
...
ForwardApprovalDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToForwardApprovalDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ForwardApprovalDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ForwardApprovalDto

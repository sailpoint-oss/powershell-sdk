...
function Initialize-BetaTenantConfigurationRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTenantConfigurationRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToTenantConfigurationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTenantConfigurationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaAccountAttributesCreate {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesCreate' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

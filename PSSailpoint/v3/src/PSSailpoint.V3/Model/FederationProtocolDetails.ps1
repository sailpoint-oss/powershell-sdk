...
function Initialize-FederationProtocolDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => FederationProtocolDetails' | Write-Debug
...
function ConvertFrom-JsonToFederationProtocolDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => FederationProtocolDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026Ref {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026Ref' | Write-Debug
...
Ref<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRef {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026Ref' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026Ref

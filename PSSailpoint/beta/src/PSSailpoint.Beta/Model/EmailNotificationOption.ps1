...
function Initialize-BetaEmailNotificationOption {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaEmailNotificationOption' | Write-Debug
...
function ConvertFrom-BetaJsonToEmailNotificationOption {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaEmailNotificationOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'Split', 'V2026Split'] 
slug: /tools/sdk/powershell/v2026/models/split
tags: ['SDK', 'Software Development Kit', 'Split', 'V2026Split']
---
...
```powershell
$Split = Initialize-V2026Split  -Delimiter , `
 -Index 5 `
 -Throws true `

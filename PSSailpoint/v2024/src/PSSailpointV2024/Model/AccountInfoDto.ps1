...
function Initialize-V2024AccountInfoDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountInfoDto' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountInfoDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountInfoDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

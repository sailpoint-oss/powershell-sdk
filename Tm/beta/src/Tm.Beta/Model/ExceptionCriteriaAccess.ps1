...
function Initialize-BetaExceptionCriteriaAccess {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaExceptionCriteriaAccess' | Write-Debug
...
function ConvertFrom-BetaJsonToExceptionCriteriaAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaExceptionCriteriaAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

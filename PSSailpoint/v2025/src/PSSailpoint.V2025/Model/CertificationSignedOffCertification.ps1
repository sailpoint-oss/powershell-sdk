...
function Initialize-V2025CertificationSignedOffCertification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CertificationSignedOffCertification' | Write-Debug
...
CertificationSignedOffCertification<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCertificationSignedOffCertification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CertificationSignedOffCertification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CertificationSignedOffCertification

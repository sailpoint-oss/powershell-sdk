...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalAttributesRequest', 'V2026ApprovalAttributesRequest'] 
slug: /tools/sdk/powershell/v2026/models/approval-attributes-request
...
```powershell
$ApprovalAttributesRequest = Initialize-V2026ApprovalAttributesRequest  -AdditionalAttributes {additionalProp1=string, additionalProp2=string, additionalProp3=string} `
 -Comment comment `

...
function Initialize-BetaEntitlementApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaEntitlementApprovalScheme' | Write-Debug
...
function ConvertFrom-BetaJsonToEntitlementApprovalScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaEntitlementApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

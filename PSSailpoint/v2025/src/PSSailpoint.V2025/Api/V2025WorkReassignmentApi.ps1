...
#>
function New-V2025ReassignmentConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025ReassignmentConfiguration' | Write-Debug
...
None
#>
function Remove-V2025ReassignmentConfiguration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025ReassignmentConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
EvaluateResponse[]
#>
function Get-V2025EvaluateReassignmentConfiguration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025EvaluateReassignmentConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConfigType[]
#>
function Get-V2025ReassignmentConfigTypes {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ReassignmentConfigTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025ReassignmentConfiguration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ReassignmentConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025TenantConfigConfiguration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025TenantConfigConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConfigurationResponse[]
#>
function Get-V2025ReassignmentConfigurations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025ReassignmentConfigurations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ConfigurationItemResponse
#>
function Send-V2025ReassignmentConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025ReassignmentConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TenantConfigurationResponse
#>
function Send-V2025TenantConfiguration {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Send-V2025TenantConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaDecomposeDiacriticalMarks {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaDecomposeDiacriticalMarks' | Write-Debug
...
function ConvertFrom-BetaJsonToDecomposeDiacriticalMarks {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaDecomposeDiacriticalMarks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

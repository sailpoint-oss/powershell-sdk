...
function Initialize-V2025SubscriptionPostRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SubscriptionPostRequest' | Write-Debug
...
SubscriptionPostRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSubscriptionPostRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SubscriptionPostRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SubscriptionPostRequest

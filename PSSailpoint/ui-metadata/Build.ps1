...
$FunctionPath = "$PSScriptRoot/src/PSSailpoint.UiMetadata/Api", "$PSScriptRoot/src/PSSailpoint.UiMetadata/Client","$PSScriptRoot/src/PSSailpoint.UiMetadata/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\PSSailpoint.UiMetadata\PSSailpoint.UiMetadata.psd1"

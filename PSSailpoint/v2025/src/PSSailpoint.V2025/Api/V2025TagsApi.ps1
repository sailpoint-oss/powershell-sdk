...
function New-V2025Tag {
    ...
    Process {
        'Calling method: New-V2025Tag' | Write-Debug
...
function Remove-V2025TagById {
    ...
    Process {
        'Calling method: Remove-V2025TagById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025TagById {
    ...
    Process {
        'Calling method: Get-V2025TagById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2025Tags {
    ...
    Process {
        'Calling method: Get-V2025Tags' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

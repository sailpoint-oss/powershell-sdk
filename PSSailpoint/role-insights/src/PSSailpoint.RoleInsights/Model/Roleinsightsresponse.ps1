...
function Initialize-Roleinsightsresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsightsresponse' | Write-Debug
...
Roleinsightsresponse<PSCustomObject>
#>
function ConvertFrom-JsonToRoleinsightsresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RoleInsightsV1 => Roleinsightsresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleinsightsresponse

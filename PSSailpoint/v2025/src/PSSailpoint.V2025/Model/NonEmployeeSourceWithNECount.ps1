...
function Initialize-V2025NonEmployeeSourceWithNECount {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeSourceWithNECount' | Write-Debug
...
NonEmployeeSourceWithNECount<PSCustomObject>
#>
function ConvertFrom-V2025JsonToNonEmployeeSourceWithNECount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025NonEmployeeSourceWithNECount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025NonEmployeeSourceWithNECount

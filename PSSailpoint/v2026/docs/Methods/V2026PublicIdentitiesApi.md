...
keywords: ['powershell', 'PowerShell', 'sdk', 'PublicIdentities', 'V2026PublicIdentities'] 
slug: /tools/sdk/powershell/v2026/methods/public-identities
...
------------- | ------------- | -------------
[**Get-V2026PublicIdentities**](#get-public-identities) | **GET** `/public-identities` | Get list of public identities
...
try {
    Get-V2026PublicIdentities 
    
    # Below is a request that includes all optional parameters
    # Get-V2026PublicIdentities -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -AddCoreFilters $AddCoreFilters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026PublicIdentities"

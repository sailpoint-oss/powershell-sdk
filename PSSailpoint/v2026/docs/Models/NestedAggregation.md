...
keywords: ['powershell', 'PowerShell', 'sdk', 'NestedAggregation', 'V2026NestedAggregation'] 
slug: /tools/sdk/powershell/v2026/models/nested-aggregation
...
```powershell
$NestedAggregation = Initialize-V2026NestedAggregation  -Name id `
 -Type access
```

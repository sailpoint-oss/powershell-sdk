...
function Initialize-V2024PasswordChangeRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024PasswordChangeRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToPasswordChangeRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024PasswordChangeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

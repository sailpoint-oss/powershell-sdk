...
function Initialize-V2026AccessRequestDynamicApprover {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestDynamicApprover' | Write-Debug
...
AccessRequestDynamicApprover<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessRequestDynamicApprover {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestDynamicApprover' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessRequestDynamicApprover

...
function Initialize-Publicidentityattributeconfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PublicIdentitiesConfigV1 => Publicidentityattributeconfig' | Write-Debug
...
function ConvertFrom-JsonToPublicidentityattributeconfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PublicIdentitiesConfigV1 => Publicidentityattributeconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

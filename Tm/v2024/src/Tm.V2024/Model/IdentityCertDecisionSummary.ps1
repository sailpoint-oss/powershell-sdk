...
function Initialize-V2024IdentityCertDecisionSummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024IdentityCertDecisionSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityCertDecisionSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024IdentityCertDecisionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024CommonAccessItemAccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CommonAccessItemAccess' | Write-Debug
...
function ConvertFrom-V2024JsonToCommonAccessItemAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CommonAccessItemAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

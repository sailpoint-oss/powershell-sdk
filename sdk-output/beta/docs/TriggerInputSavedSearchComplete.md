...
```powershell
$TriggerInputSavedSearchComplete = Initialize-PSSailpointBetaTriggerInputSavedSearchComplete  -FileName Modified.zip `
...
```powershell
$TriggerInputSavedSearchComplete | ConvertTo-JSON
```

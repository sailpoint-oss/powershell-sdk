...
function Initialize-V2024SearchExportReportArguments {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SearchExportReportArguments' | Write-Debug
...
function ConvertFrom-V2024JsonToSearchExportReportArguments {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SearchExportReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026ConnectorCustomizerVersionCreateResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ConnectorCustomizerVersionCreateResponse' | Write-Debug
...
ConnectorCustomizerVersionCreateResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToConnectorCustomizerVersionCreateResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ConnectorCustomizerVersionCreateResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ConnectorCustomizerVersionCreateResponse

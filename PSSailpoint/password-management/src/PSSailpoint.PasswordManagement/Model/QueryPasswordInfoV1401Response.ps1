...
QueryPasswordInfoV1401Response<PSCustomObject>
#>

function Initialize-QueryPasswordInfoV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to QueryPasswordInfoV1401Response<PSCustomObject>
...
QueryPasswordInfoV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToQueryPasswordInfoV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in QueryPasswordInfoV1401Response
        $AllProperties = ("error")

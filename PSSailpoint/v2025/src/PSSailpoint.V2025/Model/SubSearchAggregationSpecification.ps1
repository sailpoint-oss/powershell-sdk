...
function Initialize-V2025SubSearchAggregationSpecification {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SubSearchAggregationSpecification' | Write-Debug
...
SubSearchAggregationSpecification<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSubSearchAggregationSpecification {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SubSearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SubSearchAggregationSpecification

...
```powershell
Remove-Module -FullyQualifiedName @{ModuleName = "PSSailpoint"; ModuleVersion = "1.2.1"}
```
...
## Documentation for Models
 ...
 - [PSSailpoint/Model.IdentityWithNewAccess1AccessRefsInner](docs/IdentityWithNewAccess1AccessRefsInner.md)

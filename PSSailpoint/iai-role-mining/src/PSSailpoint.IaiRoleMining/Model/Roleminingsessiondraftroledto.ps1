...
function Initialize-Roleminingsessiondraftroledto {
    [CmdletBinding()]
    Param (
...
Roleminingsessiondraftroledto<PSCustomObject>
#>
function ConvertFrom-JsonToRoleminingsessiondraftroledto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Roleminingsessiondraftroledto

...
function Initialize-RoleMembershipIdentity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RoleMembershipIdentity' | Write-Debug
...
function ConvertFrom-JsonToRoleMembershipIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RoleMembershipIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

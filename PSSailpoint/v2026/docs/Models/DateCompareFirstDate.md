---
id: v2026-date-compare-first-date
title: DateCompareFirstDate
pagination_label: DateCompareFirstDate
sidebar_label: DateCompareFirstDate
sidebar_class_name: powershellsdk
keywords: ['powershell', 'PowerShell', 'sdk', 'DateCompareFirstDate', 'V2026DateCompareFirstDate'] 
slug: /tools/sdk/powershell/v2026/models/date-compare-first-date
tags: ['SDK', 'Software Development Kit', 'DateCompareFirstDate', 'V2026DateCompareFirstDate']
---
...
```powershell
$DateCompareFirstDate = Initialize-V2026DateCompareFirstDate  -SourceName Workday `

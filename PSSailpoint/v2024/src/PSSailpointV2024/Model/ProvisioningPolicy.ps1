...
function Initialize-V2024ProvisioningPolicy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ProvisioningPolicy' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningPolicy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ProvisioningPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

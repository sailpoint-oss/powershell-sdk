...
Provisioningcriterialevel1<PSCustomObject>
#>

function Initialize-Provisioningcriterialevel1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DimensionsV1 => Provisioningcriterialevel1' | Write-Debug
...
Convert from JSON to Provisioningcriterialevel1<PSCustomObject>
...
Provisioningcriterialevel1<PSCustomObject>
#>
function ConvertFrom-JsonToProvisioningcriterialevel1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DimensionsV1 => Provisioningcriterialevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Provisioningcriterialevel1

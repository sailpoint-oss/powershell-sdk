...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent<PSCustomObject>
#>

function Initialize-V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent' | Write-Debug
...
Convert from JSON to ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent<PSCustomObject>
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent<PSCustomObject>
#>
function ConvertFrom-V2025JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ClusterManualUpgradeJobsInnerManagedProcessConfigurationOtelAgent

...
function New-TagV1 {
    ...
    Process {
        'Calling method: New-TagV1' | Write-Debug
        ...
        if (!$Tag2) {
            throw "Error! The required parameter `Tag2` missing when calling createTagV1."
        }

        if ($LocalVarContentTypes.Contains('application/json-patch+json') -or ($Tag2 -is [array])) {
            $LocalVarBodyParameter = $Tag2 | ConvertTo-Json -AsArray -Depth 100
        } else {
            $LocalVarBodyParameter = $Tag2 | ForEach-Object {
...
function Remove-TagByIdV1 {
    ...
    Process {
        'Calling method: Remove-TagByIdV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/tags/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteTagByIdV1."
        }
...
function Get-TagByIdV1 {
    ...
    Process {
        'Calling method: Get-TagByIdV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/tags/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getTagByIdV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-TagsV1 {
    ...
    Process {
        'Calling method: Get-TagsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

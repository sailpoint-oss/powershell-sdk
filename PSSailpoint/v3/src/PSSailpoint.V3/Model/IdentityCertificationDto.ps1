...
function Initialize-IdentityCertificationDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => IdentityCertificationDto' | Write-Debug
...
function ConvertFrom-JsonToIdentityCertificationDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => IdentityCertificationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'Transforms', 'V2026Transforms'] 
slug: /tools/sdk/powershell/v2026/methods/transforms
...
------------- | ------------- | -------------
[**New-V2026Transform**](#create-transform) | **POST** `/transforms` | Create transform
[**Remove-V2026Transform**](#delete-transform) | **DELETE** `/transforms/{id}` | Delete a transform
[**Get-V2026Transform**](#get-transform) | **GET** `/transforms/{id}` | Transform by id
[**Get-V2026Transforms**](#list-transforms) | **GET** `/transforms` | List transforms
[**Update-V2026Transform**](#update-transform) | **PUT** `/transforms/{id}` | Update a transform
...
try {
    $Result = ConvertFrom-V2026JsonToTransform -Json $Transform
    New-V2026Transform -Transform $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Transform -Transform $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Transform"
...
try {
    Remove-V2026Transform -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Transform -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Transform"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Transform -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Transform -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Transform"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Transforms -Offset $Offset -Limit $Limit -Count $Count -Name $Name -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Transforms"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Update-V2026Transform -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Update-V2026Transform -Id $Id -Transform $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026Transform"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

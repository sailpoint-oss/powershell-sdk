...
function Initialize-Errorresponsedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApiUsage => Errorresponsedto' | Write-Debug
...
function ConvertFrom-JsonToErrorresponsedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApiUsage => Errorresponsedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

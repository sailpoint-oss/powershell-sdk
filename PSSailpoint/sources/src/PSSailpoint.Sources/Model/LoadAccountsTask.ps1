...
function Initialize-LoadAccountsTask {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Sources => LoadAccountsTask' | Write-Debug
...
function ConvertFrom-JsonToLoadAccountsTask {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Sources => LoadAccountsTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

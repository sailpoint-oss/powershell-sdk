...
function Initialize-Requesteditemstatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestsV1 => Requesteditemstatus' | Write-Debug
...
Requesteditemstatus<PSCustomObject>
#>
function ConvertFrom-JsonToRequesteditemstatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestsV1 => Requesteditemstatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ActivateCampaignOptions {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ActivateCampaignOptions' | Write-Debug
...
function ConvertFrom-V2024JsonToActivateCampaignOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ActivateCampaignOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

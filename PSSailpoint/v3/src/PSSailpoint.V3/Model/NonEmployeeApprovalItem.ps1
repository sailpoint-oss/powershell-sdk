...
function Initialize-NonEmployeeApprovalItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalItem' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeApprovalItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

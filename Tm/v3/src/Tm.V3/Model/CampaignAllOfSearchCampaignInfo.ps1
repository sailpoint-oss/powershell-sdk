...
function Initialize-CampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => CampaignAllOfSearchCampaignInfo' | Write-Debug
...
function ConvertFrom-JsonToCampaignAllOfSearchCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => CampaignAllOfSearchCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

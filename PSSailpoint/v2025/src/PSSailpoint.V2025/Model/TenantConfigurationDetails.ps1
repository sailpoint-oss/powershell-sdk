...
function Initialize-V2025TenantConfigurationDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025TenantConfigurationDetails' | Write-Debug
...
TenantConfigurationDetails<PSCustomObject>
#>
function ConvertFrom-V2025JsonToTenantConfigurationDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025TenantConfigurationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025TenantConfigurationDetails

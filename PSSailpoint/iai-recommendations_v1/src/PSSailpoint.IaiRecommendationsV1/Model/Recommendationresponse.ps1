...
function Initialize-Recommendationresponse {
    [CmdletBinding()]
    Param (
        ...
        ${Request},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("YES", "NO", "MAYBE", "NOT_FOUND")]
        [String]
        ${Recommendation},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String[]]
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiRecommendationsV1 => Recommendationresponse' | Write-Debug
...
Recommendationresponse<PSCustomObject>
#>
function ConvertFrom-JsonToRecommendationresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiRecommendationsV1 => Recommendationresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Recommendationresponse

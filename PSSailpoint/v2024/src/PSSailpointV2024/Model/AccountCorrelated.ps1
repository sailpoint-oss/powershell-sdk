...
function Initialize-V2024AccountCorrelated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountCorrelated' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountCorrelated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountCorrelated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025VendorConnectorMappingDeletedAt {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025VendorConnectorMappingDeletedAt' | Write-Debug
...
VendorConnectorMappingDeletedAt<PSCustomObject>
#>
function ConvertFrom-V2025JsonToVendorConnectorMappingDeletedAt {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025VendorConnectorMappingDeletedAt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025VendorConnectorMappingDeletedAt

...
function Initialize-V2024ForwardApprovalDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ForwardApprovalDto' | Write-Debug
...
ForwardApprovalDto<PSCustomObject>
#>
function ConvertFrom-V2024JsonToForwardApprovalDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ForwardApprovalDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ForwardApprovalDto

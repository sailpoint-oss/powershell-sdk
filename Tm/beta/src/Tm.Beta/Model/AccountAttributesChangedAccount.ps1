...
function Initialize-BetaAccountAttributesChangedAccount {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountAttributesChangedAccount' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesChangedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountAttributesChangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

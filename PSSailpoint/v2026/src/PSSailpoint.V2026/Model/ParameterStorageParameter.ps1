...
function Initialize-V2026ParameterStorageParameter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageParameter' | Write-Debug
...
ParameterStorageParameter<PSCustomObject>
#>
function ConvertFrom-V2026JsonToParameterStorageParameter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageParameter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ParameterStorageParameter

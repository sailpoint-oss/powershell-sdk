...
function Initialize-V2024NonEmployeeRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

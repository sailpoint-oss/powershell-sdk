...
------------- | ------------- | -------------
[**New-V2026DomainDkim**](#create-domain-dkim) | **POST** `/verified-domains` | Verify domain address via dkim
[**New-V2026NotificationTemplate**](#create-notification-template) | **POST** `/notification-templates` | Create notification template
[**New-V2026VerifiedFromAddress**](#create-verified-from-address) | **POST** `/verified-from-addresses` | Create verified from address
[**Remove-V2026NotificationTemplatesInBulk**](#delete-notification-templates-in-bulk) | **POST** `/notification-templates/bulk-delete` | Bulk delete notification templates
[**Remove-V2026VerifiedFromAddress**](#delete-verified-from-address) | **DELETE** `/verified-from-addresses/{id}` | Delete verified from address
[**Get-V2026DkimAttributes**](#get-dkim-attributes) | **GET** `/verified-domains` | Get dkim attributes
[**Get-V2026MailFromAttributes**](#get-mail-from-attributes) | **GET** `/mail-from-attributes/{identity}` | Get mail from attributes
[**Get-V2026NotificationPreferences**](#get-notification-preferences) | **GET** `/notification-preferences/{key}` | List notification preferences for tenant.
[**Get-V2026NotificationTemplate**](#get-notification-template) | **GET** `/notification-templates/{id}` | Get notification template by id
...
[**Get-V2026NotificationsTemplateContext**](#get-notifications-template-context) | **GET** `/notification-template-context` | Get notification template context
[**Get-V2026FromAddresses**](#list-from-addresses) | **GET** `/verified-from-addresses` | List from addresses
[**Get-V2026NotificationTemplateDefaults**](#list-notification-template-defaults) | **GET** `/notification-template-defaults` | List notification template defaults
[**Get-V2026NotificationTemplates**](#list-notification-templates) | **GET** `/notification-templates` | List notification templates
[**Send-V2026MailFromAttributes**](#put-mail-from-attributes) | **PUT** `/mail-from-attributes` | Change mail from domain
[**Send-V2026TestNotification**](#send-test-notification) | **POST** `/send-test-notification` | Send test notification
...
try {
    $Result = ConvertFrom-V2026JsonToDomainAddress -Json $DomainAddress
    New-V2026DomainDkim -DomainAddress $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026DomainDkim -DomainAddress $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026DomainDkim"
...
try {
    $Result = ConvertFrom-V2026JsonToTemplateDto -Json $TemplateDto
    New-V2026NotificationTemplate -TemplateDto $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026NotificationTemplate -TemplateDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026NotificationTemplate"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToEmailStatusDto -Json $EmailStatusDto
    New-V2026VerifiedFromAddress -EmailStatusDto $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026VerifiedFromAddress -EmailStatusDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026VerifiedFromAddress"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToTemplateBulkDeleteDto -Json $TemplateBulkDeleteDto
    Remove-V2026NotificationTemplatesInBulk -TemplateBulkDeleteDto $Result 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026NotificationTemplatesInBulk -TemplateBulkDeleteDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026NotificationTemplatesInBulk"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026VerifiedFromAddress -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026VerifiedFromAddress -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026VerifiedFromAddress"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026DkimAttributes 
    
    # Below is a request that includes all optional parameters
    # Get-V2026DkimAttributes -Limit $Limit -Offset $Offset  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026DkimAttributes"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026MailFromAttributes -Identity $Identity 
    
    # Below is a request that includes all optional parameters
    # Get-V2026MailFromAttributes -Identity $Identity  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026MailFromAttributes"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026NotificationPreferences 
    
    # Below is a request that includes all optional parameters
    # Get-V2026NotificationPreferences  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026NotificationPreferences"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026NotificationTemplate -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026NotificationTemplate -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026NotificationTemplate"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026NotificationsTemplateContext 
    
    # Below is a request that includes all optional parameters
    # Get-V2026NotificationsTemplateContext  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026NotificationsTemplateContext"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026FromAddresses 
    
    # Below is a request that includes all optional parameters
    # Get-V2026FromAddresses -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026FromAddresses"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026NotificationTemplateDefaults -Limit $Limit -Offset $Offset -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026NotificationTemplateDefaults"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026NotificationTemplates 
    
    # Below is a request that includes all optional parameters
    # Get-V2026NotificationTemplates -Limit $Limit -Offset $Offset -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026NotificationTemplates"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToMailFromAttributesDto -Json $MailFromAttributesDto
    Send-V2026MailFromAttributes -MailFromAttributesDto $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026MailFromAttributes -MailFromAttributesDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026MailFromAttributes"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSendTestNotificationRequestDto -Json $SendTestNotificationRequestDto
    Send-V2026TestNotification -SendTestNotificationRequestDto $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026TestNotification -SendTestNotificationRequestDto $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026TestNotification"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

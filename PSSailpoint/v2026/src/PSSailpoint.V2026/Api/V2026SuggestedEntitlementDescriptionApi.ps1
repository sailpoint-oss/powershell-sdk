...
#>
function Approve-V2026BulkEntitlementRecommendations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Approve-V2026BulkEntitlementRecommendations' | Write-Debug
        ...
        $LocalVarUri = '/entitlement-recommendations/bulk-approve'

        if (!$BulkApproveEntitlementRecommendationRequest) {
            throw "Error! The required parameter `BulkApproveEntitlementRecommendationRequest` missing when calling approveBulkEntitlementRecommendations."
        }
...
#>
function New-V2026AutoWriteSettings {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: New-V2026AutoWriteSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/suggested-entitlement-descriptions/auto-write-settings'

        if (!$AutoWriteSetting) {
            throw "Error! The required parameter `AutoWriteSetting` missing when calling createAutoWriteSettings."
        }
...
AutoWriteSettingResponse
#>
function Get-V2026AutoWriteSettings {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2026AutoWriteSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SedBatchStats
#>
function Get-V2026SedBatchStats {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2026SedBatchStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026SedBatches {
    ...
    Process {
        'Calling method: Get-V2026SedBatches' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2026PendingEntitlementRecommendationApprovals {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026PendingEntitlementRecommendationApprovals' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/entitlement-recommendations/pending-approvals'
...
#>
function Get-V2026PrivilegedEntitlementRecommendations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int32]]
    ...
    Process {
        'Calling method: Get-V2026PrivilegedEntitlementRecommendations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/privileged-recommendations'
...
function Get-V2026Seds {
    ...
    Process {
        'Calling method: Get-V2026Seds' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
EntitlementRecommendationRecord
#>
function Update-V2026EntitlementRecommendation {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026EntitlementRecommendation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/entitlement-recommendations/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling patchEntitlementRecommendation."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$JsonPatchOperation) {
            throw "Error! The required parameter `JsonPatchOperation` missing when calling patchEntitlementRecommendation."
        }
...
function Update-V2026Sed {
    ...
    Process {
        'Calling method: Update-V2026Sed' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Submit-V2026EntitlementRecommendationsAssignment {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Submit-V2026EntitlementRecommendationsAssignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/entitlement-recommendations/assign'

        if (!$EntitlementRecommendationAssignRequest) {
            throw "Error! The required parameter `EntitlementRecommendationAssignRequest` missing when calling submitEntitlementRecommendationsAssignment."
        }
...
SedApprovalStatus[]
#>
function Submit-V2026SedApproval {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Submit-V2026SedApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Submit-V2026SedAssignment {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Submit-V2026SedAssignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SedBatchResponse
#>
function Submit-V2026SedBatchRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Submit-V2026SedBatchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AutoWriteSettingResponse
#>
function Update-V2026AutoWriteSettings {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Update-V2026AutoWriteSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$AutoWriteSettingPatch) {
            throw "Error! The required parameter `AutoWriteSettingPatch` missing when calling updateAutoWriteSettings."
        }

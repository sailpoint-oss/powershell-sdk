...
function Initialize-V2026RoleMetadataBulkUpdateByFilterRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMetadataBulkUpdateByFilterRequest' | Write-Debug
...
RoleMetadataBulkUpdateByFilterRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMetadataBulkUpdateByFilterRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMetadataBulkUpdateByFilterRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMetadataBulkUpdateByFilterRequest

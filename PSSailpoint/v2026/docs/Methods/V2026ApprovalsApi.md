...
keywords: ['powershell', 'PowerShell', 'sdk', 'Approvals', 'V2026Approvals'] 
slug: /tools/sdk/powershell/v2026/methods/approvals
...
------------- | ------------- | -------------
[**Approve-V2026Approval**](#approve-approval) | **POST** `/generic-approvals/{id}/approve` | Post Approvals Approve
[**Approve-V2026ApprovalInBulk**](#approve-approval-in-bulk) | **POST** `/generic-approvals/bulk-approve` | Post Bulk Approve Approvals
[**Suspend-V2026Approval**](#cancel-approval) | **POST** `/generic-approvals/bulk-cancel` | Post Bulk Cancel Approvals
[**Suspend-V2026ApprovalById**](#cancel-approval-by-id) | **POST** `/generic-approvals/{id}/cancel` | Post Approval Cancel
[**Remove-V2026ApprovalConfigRequest**](#delete-approval-config-request) | **DELETE** `/generic-approvals/config/{id}/{scope}` | Delete Approval Configuration
[**Get-V2026Approval**](#get-approval) | **GET** `/generic-approvals/{id}` | Get an approval
[**Get-V2026Approvals**](#get-approvals) | **GET** `/generic-approvals` | Get approvals
[**Get-V2026ApprovalsConfig**](#get-approvals-config) | **GET** `/generic-approvals/config/{id}` | Get Approval Config
[**Move-V2026Approval**](#move-approval) | **POST** `/generic-approvals/bulk-reassign` | Post Bulk Reassign Approvals
[**Send-V2026ApprovalsConfig**](#put-approvals-config) | **PUT** `/generic-approvals/config/{id}/{scope}` | Put Approval Config
[**Deny-V2026Approval**](#reject-approval) | **POST** `/generic-approvals/{id}/reject` | Post Approvals Reject
[**Deny-V2026ApprovalInBulk**](#reject-approval-in-bulk) | **POST** `/generic-approvals/bulk-reject` | Post Bulk Reject Approvals
[**Update-V2026ApprovalsAttributes**](#update-approvals-attributes) | **POST** `/generic-approvals/{id}/attributes` | Post Approvals Attributes
[**Update-V2026ApprovalsComments**](#update-approvals-comments) | **POST** `/generic-approvals/{id}/comments` | Post Approvals Comments
[**Update-V2026ApprovalsReassign**](#update-approvals-reassign) | **POST** `/generic-approvals/{id}/reassign` | Post Approvals Reassign
...
try {
    Approve-V2026Approval -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Approve-V2026Approval -Id $Id -ApprovalApproveRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Approve-V2026Approval"
...
try {
    $Result = ConvertFrom-V2026JsonToBulkApproveRequestDTO -Json $BulkApproveRequestDTO
    Approve-V2026ApprovalInBulk -BulkApproveRequestDTO $Result 
    
    # Below is a request that includes all optional parameters
    # Approve-V2026ApprovalInBulk -BulkApproveRequestDTO $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Approve-V2026ApprovalInBulk"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToBulkCancelRequestDTO -Json $BulkCancelRequestDTO
    Suspend-V2026Approval -BulkCancelRequestDTO $Result 
    
    # Below is a request that includes all optional parameters
    # Suspend-V2026Approval -BulkCancelRequestDTO $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Suspend-V2026Approval"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Suspend-V2026ApprovalById -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Suspend-V2026ApprovalById -Id $Id -ApprovalCancelRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Suspend-V2026ApprovalById"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Remove-V2026ApprovalConfigRequest -Id $Id -Scope $Scope 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026ApprovalConfigRequest -Id $Id -Scope $Scope  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026ApprovalConfigRequest"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026Approval -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Approval -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Approval"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ApprovalsConfig -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ApprovalsConfig -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ApprovalsConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToBulkReassignRequestDTO -Json $BulkReassignRequestDTO
    Move-V2026Approval -BulkReassignRequestDTO $Result 
    
    # Below is a request that includes all optional parameters
    # Move-V2026Approval -BulkReassignRequestDTO $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Move-V2026Approval"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToApprovalConfig -Json $ApprovalConfig
    Send-V2026ApprovalsConfig -Id $Id -Scope $Scope -ApprovalConfig $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ApprovalsConfig -Id $Id -Scope $Scope -ApprovalConfig $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ApprovalsConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Deny-V2026Approval -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Deny-V2026Approval -Id $Id -ApprovalRejectRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Deny-V2026Approval"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToBulkRejectRequestDTO -Json $BulkRejectRequestDTO
    Deny-V2026ApprovalInBulk -BulkRejectRequestDTO $Result 
    
    # Below is a request that includes all optional parameters
    # Deny-V2026ApprovalInBulk -BulkRejectRequestDTO $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Deny-V2026ApprovalInBulk"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToApprovalAttributesRequest -Json $ApprovalAttributesRequest
    Update-V2026ApprovalsAttributes -Id $Id -ApprovalAttributesRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ApprovalsAttributes -Id $Id -ApprovalAttributesRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ApprovalsAttributes"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToApprovalCommentsRequest -Json $ApprovalCommentsRequest
    Update-V2026ApprovalsComments -Id $Id -ApprovalCommentsRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ApprovalsComments -Id $Id -ApprovalCommentsRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ApprovalsComments"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToApprovalReassignRequest -Json $ApprovalReassignRequest
    Update-V2026ApprovalsReassign -Id $Id -ApprovalReassignRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ApprovalsReassign -Id $Id -ApprovalReassignRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ApprovalsReassign"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

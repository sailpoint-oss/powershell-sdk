...
function Initialize-V2024AccountsCollectedForAggregation {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccountsCollectedForAggregation' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountsCollectedForAggregation {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccountsCollectedForAggregation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaIdentityPreviewRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaIdentityPreviewRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityPreviewRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaIdentityPreviewRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

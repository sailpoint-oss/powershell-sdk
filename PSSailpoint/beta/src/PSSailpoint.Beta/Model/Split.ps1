...
function Initialize-BetaSplit {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSplit' | Write-Debug
...
Split<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSplit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSplit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSplit

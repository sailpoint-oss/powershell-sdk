...
function Initialize-V2026ConnectorRuleValidationResponseDetailsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ConnectorRuleValidationResponseDetailsInner' | Write-Debug
...
ConnectorRuleValidationResponseDetailsInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToConnectorRuleValidationResponseDetailsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ConnectorRuleValidationResponseDetailsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ConnectorRuleValidationResponseDetailsInner

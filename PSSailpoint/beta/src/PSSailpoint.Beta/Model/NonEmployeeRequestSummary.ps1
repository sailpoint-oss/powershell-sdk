...
function Initialize-BetaNonEmployeeRequestSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeRequestSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeRequestSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeRequestSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-IdentityPreviewRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => IdentityPreviewRequest' | Write-Debug
...
function ConvertFrom-JsonToIdentityPreviewRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => IdentityPreviewRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

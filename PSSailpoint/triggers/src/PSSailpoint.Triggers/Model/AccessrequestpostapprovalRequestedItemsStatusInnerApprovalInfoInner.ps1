...
function Initialize-AccessrequestpostapprovalRequestedItemsStatusInnerApprovalInfoInner {
    [CmdletBinding()]
    Param (
...
AccessrequestpostapprovalRequestedItemsStatusInnerApprovalInfoInner<PSCustomObject>
#>
function ConvertFrom-JsonToAccessrequestpostapprovalRequestedItemsStatusInnerApprovalInfoInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccessrequestpostapprovalRequestedItemsStatusInnerApprovalInfoInner

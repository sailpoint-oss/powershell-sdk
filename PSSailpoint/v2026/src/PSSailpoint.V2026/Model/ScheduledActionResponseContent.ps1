...
function Initialize-V2026ScheduledActionResponseContent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ScheduledActionResponseContent' | Write-Debug
...
ScheduledActionResponseContent<PSCustomObject>
#>
function ConvertFrom-V2026JsonToScheduledActionResponseContent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ScheduledActionResponseContent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ScheduledActionResponseContent

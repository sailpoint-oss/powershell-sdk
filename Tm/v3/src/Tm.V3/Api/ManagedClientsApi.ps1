...
function New-ManagedClient {
    ...
    Process {
        'Calling method: New-ManagedClient' | Write-Debug
...
function Remove-ManagedClient {
    ...
    Process {
        'Calling method: Remove-ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-ManagedClient {
    ...
    Process {
        'Calling method: Get-ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
ManagedClientStatus
#>
function Get-ManagedClientStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-ManagedClientStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-ManagedClients {
    ...
    Process {
        'Calling method: Get-ManagedClients' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-ManagedClient {
    ...
    Process {
        'Calling method: Update-ManagedClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

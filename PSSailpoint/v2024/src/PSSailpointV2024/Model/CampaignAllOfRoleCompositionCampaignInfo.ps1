...
function Initialize-V2024CampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ReviewableEntitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ReviewableEntitlement' | Write-Debug
...
function ConvertFrom-JsonToReviewableEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ReviewableEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ObjectMappingResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ObjectMappingResponse' | Write-Debug
...
function ConvertFrom-JsonToObjectMappingResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ObjectMappingResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

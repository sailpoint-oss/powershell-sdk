...
function Initialize-ViolationownerassignmentconfigOwnerRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SodPoliciesV1 => ViolationownerassignmentconfigOwnerRef' | Write-Debug
...
function ConvertFrom-JsonToViolationownerassignmentconfigOwnerRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SodPoliciesV1 => ViolationownerassignmentconfigOwnerRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024EntitlementBulkUpdateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024EntitlementBulkUpdateRequest' | Write-Debug
...
EntitlementBulkUpdateRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToEntitlementBulkUpdateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024EntitlementBulkUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024EntitlementBulkUpdateRequest

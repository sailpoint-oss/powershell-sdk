...
function Initialize-LoadaccountstaskTaskMessagesInner {
    [CmdletBinding()]
    Param (
...
LoadaccountstaskTaskMessagesInner<PSCustomObject>
#>
function ConvertFrom-JsonToLoadaccountstaskTaskMessagesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in LoadaccountstaskTaskMessagesInner

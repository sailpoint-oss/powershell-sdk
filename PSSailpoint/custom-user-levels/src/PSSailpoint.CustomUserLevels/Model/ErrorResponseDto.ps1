...
function Initialize-ErrorResponseDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CustomUserLevels => ErrorResponseDto' | Write-Debug
...
function ConvertFrom-JsonToErrorResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CustomUserLevels => ErrorResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

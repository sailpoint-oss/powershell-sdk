...
function Initialize-BetaAccessProfileBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccessProfileBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccessProfileBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

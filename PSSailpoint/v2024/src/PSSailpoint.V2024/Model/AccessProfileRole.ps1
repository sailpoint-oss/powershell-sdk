...
function Initialize-V2024AccessProfileRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessProfileRole' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessProfileRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

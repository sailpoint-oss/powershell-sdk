...
function Initialize-BetaCreateFormInstanceRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCreateFormInstanceRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateFormInstanceRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCreateFormInstanceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025CommonAccessItemAccess {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CommonAccessItemAccess' | Write-Debug
...
CommonAccessItemAccess<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCommonAccessItemAccess {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CommonAccessItemAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CommonAccessItemAccess

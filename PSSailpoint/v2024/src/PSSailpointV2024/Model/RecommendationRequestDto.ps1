...
function Initialize-V2024RecommendationRequestDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RecommendationRequestDto' | Write-Debug
...
function ConvertFrom-V2024JsonToRecommendationRequestDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RecommendationRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

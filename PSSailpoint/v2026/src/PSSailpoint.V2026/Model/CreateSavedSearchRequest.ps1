...
function Initialize-V2026CreateSavedSearchRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CreateSavedSearchRequest' | Write-Debug
...
CreateSavedSearchRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCreateSavedSearchRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CreateSavedSearchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CreateSavedSearchRequest

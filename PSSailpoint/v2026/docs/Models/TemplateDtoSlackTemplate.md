...
keywords: ['powershell', 'PowerShell', 'sdk', 'TemplateDtoSlackTemplate', 'V2026TemplateDtoSlackTemplate'] 
slug: /tools/sdk/powershell/v2026/models/template-dto-slack-template
...
```powershell
$TemplateDtoSlackTemplate = Initialize-V2026TemplateDtoSlackTemplate  -Key null `

...
function Initialize-V2026MachineIdentityUpdatedMachineIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityUpdatedMachineIdentity' | Write-Debug
...
MachineIdentityUpdatedMachineIdentity<PSCustomObject>
#>
function ConvertFrom-V2026JsonToMachineIdentityUpdatedMachineIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026MachineIdentityUpdatedMachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026MachineIdentityUpdatedMachineIdentity

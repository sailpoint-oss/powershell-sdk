...
function Initialize-Publicidentityconfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PublicIdentitiesConfig => Publicidentityconfig' | Write-Debug
...
function ConvertFrom-JsonToPublicidentityconfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PublicIdentitiesConfig => Publicidentityconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025QueuedCheckConfigDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025QueuedCheckConfigDetails' | Write-Debug
...
QueuedCheckConfigDetails<PSCustomObject>
#>
function ConvertFrom-V2025JsonToQueuedCheckConfigDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025QueuedCheckConfigDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025QueuedCheckConfigDetails

...
function Initialize-E164phone {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => E164phone' | Write-Debug
...
E164phone<PSCustomObject>
#>
function ConvertFrom-JsonToE164phone {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => E164phone' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in E164phone

...
function Initialize-IdentityProfileIdentityErrorReportArguments {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => IdentityProfileIdentityErrorReportArguments' | Write-Debug
...
function ConvertFrom-JsonToIdentityProfileIdentityErrorReportArguments {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => IdentityProfileIdentityErrorReportArguments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

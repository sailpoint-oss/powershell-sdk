...
function Initialize-BetaAccessItemRoleResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessItemRoleResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessItemRoleResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessItemRoleResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025InviteIdentitiesRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025InviteIdentitiesRequest' | Write-Debug
...
InviteIdentitiesRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToInviteIdentitiesRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025InviteIdentitiesRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025InviteIdentitiesRequest

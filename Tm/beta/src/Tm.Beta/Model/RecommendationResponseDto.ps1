...
function Initialize-BetaRecommendationResponseDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRecommendationResponseDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommendationResponseDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRecommendationResponseDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

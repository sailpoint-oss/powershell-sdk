...
function Initialize-BetaBulkWorkgroupMembersRequestInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaBulkWorkgroupMembersRequestInner' | Write-Debug
...
function ConvertFrom-BetaJsonToBulkWorkgroupMembersRequestInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaBulkWorkgroupMembersRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

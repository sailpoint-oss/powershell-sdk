...
function Initialize-BetaVAClusterStatusChangeEvent {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaVAClusterStatusChangeEvent' | Write-Debug
...
function ConvertFrom-BetaJsonToVAClusterStatusChangeEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaVAClusterStatusChangeEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaActivateCampaignOptions {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaActivateCampaignOptions' | Write-Debug
...
function ConvertFrom-BetaJsonToActivateCampaignOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaActivateCampaignOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

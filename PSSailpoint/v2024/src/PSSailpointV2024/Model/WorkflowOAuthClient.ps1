...
function Initialize-V2024WorkflowOAuthClient {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024WorkflowOAuthClient' | Write-Debug
...
function ConvertFrom-V2024JsonToWorkflowOAuthClient {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024WorkflowOAuthClient' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

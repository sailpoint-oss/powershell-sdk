...
function Initialize-BetaRequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusProvisioningDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestedItemStatusProvisioningDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRequestedItemStatusProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

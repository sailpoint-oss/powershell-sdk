...
function Initialize-UpdateStreamStatusRequest {
    [CmdletBinding()]
    Param (
...
UpdateStreamStatusRequest<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateStreamStatusRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in UpdateStreamStatusRequest

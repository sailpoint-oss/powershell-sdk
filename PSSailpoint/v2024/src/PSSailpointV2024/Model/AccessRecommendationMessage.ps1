...
function Initialize-V2024AccessRecommendationMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessRecommendationMessage' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRecommendationMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessRecommendationMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Latestoutliersummary {
    [CmdletBinding()]
    Param (
...
Latestoutliersummary<PSCustomObject>
#>
function ConvertFrom-JsonToLatestoutliersummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Latestoutliersummary

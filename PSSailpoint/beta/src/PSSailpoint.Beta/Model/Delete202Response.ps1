...
function Initialize-BetaDelete202Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaDelete202Response' | Write-Debug
...
function ConvertFrom-BetaJsonToDelete202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaDelete202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

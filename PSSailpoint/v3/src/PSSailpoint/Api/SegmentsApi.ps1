...
function New-Segment {
    ...
    Process {
        'Calling method: New-Segment' | Write-Debug
...
function Remove-Segment {
    ...
    Process {
        'Calling method: Remove-Segment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-Segment {
    ...
    Process {
        'Calling method: Get-Segment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-Segments {
    ...
    Process {
        'Calling method: Get-Segments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-Segment {
    ...
    Process {
        'Calling method: Update-Segment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

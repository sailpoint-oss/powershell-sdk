...
function Initialize-Uuidgenerator {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => Uuidgenerator' | Write-Debug
...
Uuidgenerator<PSCustomObject>
#>
function ConvertFrom-JsonToUuidgenerator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => Uuidgenerator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Uuidgenerator

...
function Initialize-Accountattribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => Accountattribute' | Write-Debug
...
function ConvertFrom-JsonToAccountattribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => Accountattribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function New-V2024Transform {
    ...
    Process {
        'Calling method: New-V2024Transform' | Write-Debug
...
None
#>
function Remove-V2024Transform {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2024Transform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2024Transform {
    ...
    Process {
        'Calling method: Get-V2024Transform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2024Transforms {
    ...
    Process {
        'Calling method: Get-V2024Transforms' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
TransformRead
#>
function Update-V2024Transform {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2024Transform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

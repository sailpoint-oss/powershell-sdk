...
function Initialize-BetaRoleMiningEntitlementRef {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningEntitlementRef' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningEntitlementRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningEntitlementRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

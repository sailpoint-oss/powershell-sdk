...
function Initialize-ViolationOwnerAssignmentConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => ViolationOwnerAssignmentConfig' | Write-Debug
...
function ConvertFrom-JsonToViolationOwnerAssignmentConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => ViolationOwnerAssignmentConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

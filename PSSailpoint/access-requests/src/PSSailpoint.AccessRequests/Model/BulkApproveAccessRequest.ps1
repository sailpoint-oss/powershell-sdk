...
function Initialize-BulkApproveAccessRequest {
    [CmdletBinding()]
    Param (
...
BulkApproveAccessRequest<PSCustomObject>
#>
function ConvertFrom-JsonToBulkApproveAccessRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in BulkApproveAccessRequest

...
function Initialize-BetaWorkgroupBulkDeleteRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaWorkgroupBulkDeleteRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkgroupBulkDeleteRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaWorkgroupBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

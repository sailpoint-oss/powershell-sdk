...
function Initialize-V2026ResourceObject {
    [CmdletBinding()]
    Param (
    )

    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ResourceObject' | Write-Debug
...
ResourceObject<PSCustomObject>
#>
function ConvertFrom-V2026JsonToResourceObject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ResourceObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ResourceObject

...
function Initialize-BetaManualWorkItemDetails1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaManualWorkItemDetails1' | Write-Debug
...
ManualWorkItemDetails1<PSCustomObject>
#>
function ConvertFrom-BetaJsonToManualWorkItemDetails1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaManualWorkItemDetails1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaManualWorkItemDetails1

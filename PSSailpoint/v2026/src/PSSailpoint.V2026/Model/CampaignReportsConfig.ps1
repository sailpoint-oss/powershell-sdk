...
function Initialize-V2026CampaignReportsConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CampaignReportsConfig' | Write-Debug
...
CampaignReportsConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCampaignReportsConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CampaignReportsConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CampaignReportsConfig

...
function Initialize-V2024PendingApproval {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PendingApproval' | Write-Debug
...
function ConvertFrom-V2024JsonToPendingApproval {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PendingApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NonEmployeeApprovalSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalSummary' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeApprovalSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => NonEmployeeApprovalSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

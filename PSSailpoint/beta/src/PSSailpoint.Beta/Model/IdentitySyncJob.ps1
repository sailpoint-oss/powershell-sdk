...
function Initialize-BetaIdentitySyncJob {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentitySyncJob' | Write-Debug
...
IdentitySyncJob<PSCustomObject>
#>
function ConvertFrom-BetaJsonToIdentitySyncJob {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentitySyncJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaIdentitySyncJob

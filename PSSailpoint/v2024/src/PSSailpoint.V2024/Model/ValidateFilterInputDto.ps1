...
function Initialize-V2024ValidateFilterInputDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ValidateFilterInputDto' | Write-Debug
...
function ConvertFrom-V2024JsonToValidateFilterInputDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ValidateFilterInputDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

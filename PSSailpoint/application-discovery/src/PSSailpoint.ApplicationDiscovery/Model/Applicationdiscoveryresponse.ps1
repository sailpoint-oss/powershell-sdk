...
Applicationdiscoveryresponse<PSCustomObject>
#>

function Initialize-Applicationdiscoveryresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApplicationDiscoveryV1 => Applicationdiscoveryresponse' | Write-Debug
...
Convert from JSON to Applicationdiscoveryresponse<PSCustomObject>
...
Applicationdiscoveryresponse<PSCustomObject>
#>
function ConvertFrom-JsonToApplicationdiscoveryresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApplicationDiscoveryV1 => Applicationdiscoveryresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Applicationdiscoveryresponse

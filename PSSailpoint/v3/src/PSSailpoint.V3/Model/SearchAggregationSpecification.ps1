...
function Initialize-SearchAggregationSpecification {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SearchAggregationSpecification' | Write-Debug
...
function ConvertFrom-JsonToSearchAggregationSpecification {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
```powershell
$CompletedApprovalPreApprovalTriggerResult = Initialize-Tm.V3CompletedApprovalPreApprovalTriggerResult  -Comment This request was autoapproved by our automated ETS subscriber `
 -Decision null `

...
function Initialize-V2026WorkgroupMemberDeleteItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026WorkgroupMemberDeleteItem' | Write-Debug
...
WorkgroupMemberDeleteItem<PSCustomObject>
#>
function ConvertFrom-V2026JsonToWorkgroupMemberDeleteItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026WorkgroupMemberDeleteItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026WorkgroupMemberDeleteItem

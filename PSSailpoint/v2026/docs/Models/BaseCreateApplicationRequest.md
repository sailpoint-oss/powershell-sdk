...
keywords: ['powershell', 'PowerShell', 'sdk', 'BaseCreateApplicationRequest', 'V2026BaseCreateApplicationRequest'] 
slug: /tools/sdk/powershell/v2026/models/base-create-application-request
...
```powershell
$BaseCreateApplicationRequest = Initialize-V2026BaseCreateApplicationRequest  -ApplicationType null `
 -Name HR File Server `

...
function Initialize-BetaExportOptions {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaExportOptions' | Write-Debug
...
function ConvertFrom-BetaJsonToExportOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaExportOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

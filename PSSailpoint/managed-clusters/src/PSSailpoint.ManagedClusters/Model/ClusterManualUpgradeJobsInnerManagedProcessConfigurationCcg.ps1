...
function Initialize-ClusterManualUpgradeJobsInnerManagedProcessConfigurationCcg {
    [CmdletBinding()]
    Param (
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationCcg<PSCustomObject>
#>
function ConvertFrom-JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationCcg {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ClusterManualUpgradeJobsInnerManagedProcessConfigurationCcg

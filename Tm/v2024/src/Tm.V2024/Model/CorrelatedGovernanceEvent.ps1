...
function Initialize-V2024CorrelatedGovernanceEvent {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CorrelatedGovernanceEvent' | Write-Debug
...
function ConvertFrom-V2024JsonToCorrelatedGovernanceEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CorrelatedGovernanceEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

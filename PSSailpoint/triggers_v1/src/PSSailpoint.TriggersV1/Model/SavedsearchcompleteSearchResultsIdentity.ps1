...
function Initialize-SavedsearchcompleteSearchResultsIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => SavedsearchcompleteSearchResultsIdentity' | Write-Debug
...
SavedsearchcompleteSearchResultsIdentity<PSCustomObject>
#>
function ConvertFrom-JsonToSavedsearchcompleteSearchResultsIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => SavedsearchcompleteSearchResultsIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SavedsearchcompleteSearchResultsIdentity

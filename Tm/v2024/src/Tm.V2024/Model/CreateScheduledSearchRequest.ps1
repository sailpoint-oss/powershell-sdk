...
function Initialize-V2024CreateScheduledSearchRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CreateScheduledSearchRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateScheduledSearchRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CreateScheduledSearchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

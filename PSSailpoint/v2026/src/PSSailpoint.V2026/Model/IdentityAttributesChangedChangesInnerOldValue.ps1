...
#>
function ConvertFrom-V2026JsonToIdentityAttributesChangedChangesInnerOldValue {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'Boolean' defined in oneOf (V2026IdentityAttributesChangedChangesInnerOldValue). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'String' defined in oneOf (V2026IdentityAttributesChangedChangesInnerOldValue). Proceeding to the next one if any."
        }
        ...
        try {
            $matchInstance = ConvertFrom-V2026JsonToSystem.Collections.Hashtable $Json
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'System.Collections.Hashtable' defined in oneOf (V2026IdentityAttributesChangedChangesInnerOldValue). Proceeding to the next one if any."
        }

...
function Initialize-V2025ManagedClusterKeyPair {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ManagedClusterKeyPair' | Write-Debug
...
ManagedClusterKeyPair<PSCustomObject>
#>
function ConvertFrom-V2025JsonToManagedClusterKeyPair {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ManagedClusterKeyPair' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ManagedClusterKeyPair

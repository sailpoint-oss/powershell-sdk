...
function Initialize-V2024ErrorMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ErrorMessage' | Write-Debug
...
function ConvertFrom-V2024JsonToErrorMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ErrorMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'EventBridgeConfig', 'V2026EventBridgeConfig'] 
slug: /tools/sdk/powershell/v2026/models/event-bridge-config
...
```powershell
$EventBridgeConfig = Initialize-V2026EventBridgeConfig  -AwsAccount 123456789012 `
 -AwsRegion us-west-1
```

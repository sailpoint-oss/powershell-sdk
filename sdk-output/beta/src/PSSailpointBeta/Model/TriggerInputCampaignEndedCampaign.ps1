...
TriggerInputCampaignEndedCampaign<PSCustomObject>
#>

function Initialize-BetaTriggerInputCampaignEndedCampaign {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputCampaignEndedCampaign' | Write-Debug
...
Convert from JSON to TriggerInputCampaignEndedCampaign<PSCustomObject>
...
TriggerInputCampaignEndedCampaign<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputCampaignEndedCampaign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputCampaignEndedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputCampaignEndedCampaign

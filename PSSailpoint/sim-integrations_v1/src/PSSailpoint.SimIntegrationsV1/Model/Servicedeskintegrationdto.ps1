...
function Initialize-Servicedeskintegrationdto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SimIntegrationsV1 => Servicedeskintegrationdto' | Write-Debug
...
function ConvertFrom-JsonToServicedeskintegrationdto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SimIntegrationsV1 => Servicedeskintegrationdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

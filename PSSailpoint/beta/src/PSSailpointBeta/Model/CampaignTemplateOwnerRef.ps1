...
function Initialize-BetaCampaignTemplateOwnerRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaCampaignTemplateOwnerRef' | Write-Debug
...
function ConvertFrom-BetaJsonToCampaignTemplateOwnerRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaCampaignTemplateOwnerRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

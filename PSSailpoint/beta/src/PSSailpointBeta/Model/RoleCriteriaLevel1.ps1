...
function Initialize-BetaRoleCriteriaLevel1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRoleCriteriaLevel1' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleCriteriaLevel1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRoleCriteriaLevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

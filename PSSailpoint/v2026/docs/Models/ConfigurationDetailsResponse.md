...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConfigurationDetailsResponse', 'V2026ConfigurationDetailsResponse'] 
slug: /tools/sdk/powershell/v2026/models/configuration-details-response
...
```powershell
$ConfigurationDetailsResponse = Initialize-V2026ConfigurationDetailsResponse  -ConfigType null `
 -TargetIdentity null `

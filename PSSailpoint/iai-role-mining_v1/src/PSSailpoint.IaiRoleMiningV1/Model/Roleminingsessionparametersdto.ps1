...
function Initialize-Roleminingsessionparametersdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingsessionparametersdto' | Write-Debug
...
Roleminingsessionparametersdto<PSCustomObject>
#>
function ConvertFrom-JsonToRoleminingsessionparametersdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingsessionparametersdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleminingsessionparametersdto

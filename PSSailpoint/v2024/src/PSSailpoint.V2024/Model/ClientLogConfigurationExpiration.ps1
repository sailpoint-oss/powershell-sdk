...
function Initialize-V2024ClientLogConfigurationExpiration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ClientLogConfigurationExpiration' | Write-Debug
...
ClientLogConfigurationExpiration<PSCustomObject>
#>
function ConvertFrom-V2024JsonToClientLogConfigurationExpiration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ClientLogConfigurationExpiration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ClientLogConfigurationExpiration

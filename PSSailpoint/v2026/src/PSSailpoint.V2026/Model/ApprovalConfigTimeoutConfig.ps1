...
function Initialize-V2026ApprovalConfigTimeoutConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigTimeoutConfig' | Write-Debug
...
ApprovalConfigTimeoutConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApprovalConfigTimeoutConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigTimeoutConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApprovalConfigTimeoutConfig

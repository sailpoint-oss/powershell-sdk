# PSSailpoint.Beta.PSSailpoint.Beta\Api.BetaIdentitiesApi
...
# Send password reset email
try {
    $Result = Send-BetaIdentityVerificationAccountToken -Id $Id -SendAccountVerificationRequest $SendAccountVerificationRequest
} catch {

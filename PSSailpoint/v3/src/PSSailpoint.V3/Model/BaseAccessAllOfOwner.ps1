...
function Initialize-BaseAccessAllOfOwner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => BaseAccessAllOfOwner' | Write-Debug
...
function ConvertFrom-JsonToBaseAccessAllOfOwner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => BaseAccessAllOfOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

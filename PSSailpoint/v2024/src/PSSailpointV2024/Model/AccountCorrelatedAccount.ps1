...
function Initialize-V2024AccountCorrelatedAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountCorrelatedAccount' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountCorrelatedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountCorrelatedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

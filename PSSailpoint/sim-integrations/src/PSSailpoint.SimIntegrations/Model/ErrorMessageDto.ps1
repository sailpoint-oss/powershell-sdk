...
function Initialize-ErrorMessageDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SimIntegrations => ErrorMessageDto' | Write-Debug
...
function ConvertFrom-JsonToErrorMessageDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SimIntegrations => ErrorMessageDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

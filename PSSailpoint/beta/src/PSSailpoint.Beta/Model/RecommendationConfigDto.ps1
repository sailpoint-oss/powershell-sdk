...
function Initialize-BetaRecommendationConfigDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRecommendationConfigDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRecommendationConfigDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRecommendationConfigDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

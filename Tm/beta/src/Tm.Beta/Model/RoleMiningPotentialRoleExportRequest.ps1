...
function Initialize-BetaRoleMiningPotentialRoleExportRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleExportRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleExportRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleExportRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

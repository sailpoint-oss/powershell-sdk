...
function Initialize-V2026ApprovalRequestedTarget {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApprovalRequestedTarget' | Write-Debug
...
ApprovalRequestedTarget<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApprovalRequestedTarget {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApprovalRequestedTarget' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApprovalRequestedTarget

...
function Initialize-BetaWorkgroupConnectionDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaWorkgroupConnectionDto' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkgroupConnectionDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaWorkgroupConnectionDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

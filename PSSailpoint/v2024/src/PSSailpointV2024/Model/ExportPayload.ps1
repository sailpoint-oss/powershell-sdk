...
function Initialize-V2024ExportPayload {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ExportPayload' | Write-Debug
...
function ConvertFrom-V2024JsonToExportPayload {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ExportPayload' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

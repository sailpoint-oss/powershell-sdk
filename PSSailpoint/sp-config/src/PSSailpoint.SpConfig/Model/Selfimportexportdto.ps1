...
function Initialize-Selfimportexportdto {
    [CmdletBinding()]
    Param (
...
Selfimportexportdto<PSCustomObject>
#>
function ConvertFrom-JsonToSelfimportexportdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Selfimportexportdto

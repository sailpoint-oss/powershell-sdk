...
function Initialize-V2025FederationProtocolDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025FederationProtocolDetails' | Write-Debug
...
FederationProtocolDetails<PSCustomObject>
#>
function ConvertFrom-V2025JsonToFederationProtocolDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025FederationProtocolDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025FederationProtocolDetails

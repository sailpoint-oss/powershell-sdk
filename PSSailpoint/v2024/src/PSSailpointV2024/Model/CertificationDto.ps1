...
function Initialize-V2024CertificationDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CertificationDto' | Write-Debug
...
function ConvertFrom-V2024JsonToCertificationDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CertificationDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

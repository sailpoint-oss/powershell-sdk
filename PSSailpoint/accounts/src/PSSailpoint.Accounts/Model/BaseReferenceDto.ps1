...
function Initialize-BaseReferenceDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Accounts => BaseReferenceDto' | Write-Debug
...
function ConvertFrom-JsonToBaseReferenceDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Accounts => BaseReferenceDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

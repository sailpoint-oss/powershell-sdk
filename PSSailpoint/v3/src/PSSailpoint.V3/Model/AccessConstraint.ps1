...
function Initialize-AccessConstraint {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessConstraint' | Write-Debug
...
AccessConstraint<PSCustomObject>
#>
function ConvertFrom-JsonToAccessConstraint {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessConstraint' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccessConstraint

...
function Initialize-V2024RemediationItems {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RemediationItems' | Write-Debug
...
function ConvertFrom-V2024JsonToRemediationItems {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RemediationItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaV3ConnectorDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaV3ConnectorDto' | Write-Debug
...
V3ConnectorDto<PSCustomObject>
#>
function ConvertFrom-BetaJsonToV3ConnectorDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaV3ConnectorDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

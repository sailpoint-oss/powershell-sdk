...
function Initialize-V2024NonEmployeeBulkUploadJob {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeBulkUploadJob' | Write-Debug
...
NonEmployeeBulkUploadJob<PSCustomObject>
#>
function ConvertFrom-V2024JsonToNonEmployeeBulkUploadJob {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeBulkUploadJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024NonEmployeeBulkUploadJob

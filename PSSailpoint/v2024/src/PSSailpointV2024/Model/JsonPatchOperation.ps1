...
function Initialize-V2024JsonPatchOperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024JsonPatchOperation' | Write-Debug
...
function ConvertFrom-V2024JsonToJsonPatchOperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024JsonPatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

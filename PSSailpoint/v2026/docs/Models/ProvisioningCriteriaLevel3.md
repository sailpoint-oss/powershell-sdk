...
keywords: ['powershell', 'PowerShell', 'sdk', 'ProvisioningCriteriaLevel3', 'V2026ProvisioningCriteriaLevel3'] 
slug: /tools/sdk/powershell/v2026/models/provisioning-criteria-level3
...
```powershell
$ProvisioningCriteriaLevel3 = Initialize-V2026ProvisioningCriteriaLevel3  -Operation null `
 -Attribute email `

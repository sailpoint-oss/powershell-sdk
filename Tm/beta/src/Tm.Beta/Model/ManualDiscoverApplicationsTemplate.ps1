...
function Initialize-BetaManualDiscoverApplicationsTemplate {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaManualDiscoverApplicationsTemplate' | Write-Debug
...
function ConvertFrom-BetaJsonToManualDiscoverApplicationsTemplate {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaManualDiscoverApplicationsTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

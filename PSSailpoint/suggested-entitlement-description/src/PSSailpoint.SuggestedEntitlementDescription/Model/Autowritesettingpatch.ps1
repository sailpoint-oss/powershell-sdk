...
function Initialize-Autowritesettingpatch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SuggestedEntitlementDescriptionV1 => Autowritesettingpatch' | Write-Debug
...
Autowritesettingpatch<PSCustomObject>
#>
function ConvertFrom-JsonToAutowritesettingpatch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SuggestedEntitlementDescriptionV1 => Autowritesettingpatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Autowritesettingpatch

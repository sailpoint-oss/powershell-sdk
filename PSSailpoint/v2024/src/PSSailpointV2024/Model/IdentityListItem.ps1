...
function Initialize-V2024IdentityListItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityListItem' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityListItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityListItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaIdentitySummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentitySummary' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentitySummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentitySummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

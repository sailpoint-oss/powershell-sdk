...
function Initialize-BetaTaskStatusMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTaskStatusMessage' | Write-Debug
...
function ConvertFrom-BetaJsonToTaskStatusMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTaskStatusMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

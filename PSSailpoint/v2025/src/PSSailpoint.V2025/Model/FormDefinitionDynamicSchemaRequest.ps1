...
function Initialize-V2025FormDefinitionDynamicSchemaRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025FormDefinitionDynamicSchemaRequest' | Write-Debug
...
FormDefinitionDynamicSchemaRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToFormDefinitionDynamicSchemaRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025FormDefinitionDynamicSchemaRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025FormDefinitionDynamicSchemaRequest

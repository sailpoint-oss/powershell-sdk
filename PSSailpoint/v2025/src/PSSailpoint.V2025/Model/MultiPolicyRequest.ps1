...
function Initialize-V2025MultiPolicyRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025MultiPolicyRequest' | Write-Debug
...
MultiPolicyRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToMultiPolicyRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025MultiPolicyRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025MultiPolicyRequest

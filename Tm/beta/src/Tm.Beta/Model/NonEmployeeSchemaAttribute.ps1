...
function Initialize-BetaNonEmployeeSchemaAttribute {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeSchemaAttribute' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSchemaAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeSchemaAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-FullDiscoveredApplicationsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => FullDiscoveredApplicationsInner' | Write-Debug
...
FullDiscoveredApplicationsInner<PSCustomObject>
#>
function ConvertFrom-JsonToFullDiscoveredApplicationsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => FullDiscoveredApplicationsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FullDiscoveredApplicationsInner

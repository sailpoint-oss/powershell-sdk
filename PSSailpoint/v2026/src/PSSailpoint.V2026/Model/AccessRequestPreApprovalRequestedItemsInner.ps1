...
function Initialize-V2026AccessRequestPreApprovalRequestedItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestPreApprovalRequestedItemsInner' | Write-Debug
...
AccessRequestPreApprovalRequestedItemsInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccessRequestPreApprovalRequestedItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccessRequestPreApprovalRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccessRequestPreApprovalRequestedItemsInner

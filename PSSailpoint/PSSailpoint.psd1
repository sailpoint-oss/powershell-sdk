...
RequiredModules = @(@{ModuleName = 'PSSailpoint.Beta'; RequiredVersion = '1.4.4'; }, 
               @{ModuleName = 'PSSailpoint.V3'; RequiredVersion = '1.4.4'; }, 
               @{ModuleName = 'PSSailpoint.V2024'; RequiredVersion = '1.4.4'; })

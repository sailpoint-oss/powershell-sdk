...
function Initialize-V2024VAClusterStatusChangeEventPreviousHealthCheckResult {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
...
function ConvertFrom-V2024JsonToVAClusterStatusChangeEventPreviousHealthCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024VAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaEntitlementApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaEntitlementApprovalScheme' | Write-Debug
...
EntitlementApprovalScheme<PSCustomObject>
#>
function ConvertFrom-BetaJsonToEntitlementApprovalScheme {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaEntitlementApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaEntitlementApprovalScheme

...
function Initialize-DataaccessCategoriesInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationSummariesV1 => DataaccessCategoriesInner' | Write-Debug
...
DataaccessCategoriesInner<PSCustomObject>
#>
function ConvertFrom-JsonToDataaccessCategoriesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationSummariesV1 => DataaccessCategoriesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DataaccessCategoriesInner

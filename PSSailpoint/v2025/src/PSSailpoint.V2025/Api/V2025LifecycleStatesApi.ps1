...
LifecycleState
#>
function New-V2025LifecycleState {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: New-V2025LifecycleState' | Write-Debug
...
#>
function Remove-V2025LifecycleState {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2025LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LifecycleState
#>
function Get-V2025LifecycleState {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LifecycleState[]
#>
function Get-V2025LifecycleStates {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025LifecycleStates' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Set-V2025LifecycleState {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Set-V2025LifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
LifecycleState
#>
function Update-V2025LifecycleStates {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2025LifecycleStates' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

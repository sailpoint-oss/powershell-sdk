...
function Initialize-ParameterStorageParameter {
    [CmdletBinding()]
    Param (
...
ParameterStorageParameter<PSCustomObject>
#>
function ConvertFrom-JsonToParameterStorageParameter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ParameterStorageParameter

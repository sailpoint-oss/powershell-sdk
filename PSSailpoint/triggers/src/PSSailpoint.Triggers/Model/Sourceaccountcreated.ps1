...
function Initialize-Sourceaccountcreated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => Sourceaccountcreated' | Write-Debug
...
Sourceaccountcreated<PSCustomObject>
#>
function ConvertFrom-JsonToSourceaccountcreated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => Sourceaccountcreated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Sourceaccountcreated

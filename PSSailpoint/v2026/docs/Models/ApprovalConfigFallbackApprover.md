...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalConfigFallbackApprover', 'V2026ApprovalConfigFallbackApprover'] 
slug: /tools/sdk/powershell/v2026/models/approval-config-fallback-approver
...
```powershell
$ApprovalConfigFallbackApprover = Initialize-V2026ApprovalConfigFallbackApprover  -IdentityID fdfda352157d4cc79bb749953131b457 `
 -Type MANAGER_OF
```

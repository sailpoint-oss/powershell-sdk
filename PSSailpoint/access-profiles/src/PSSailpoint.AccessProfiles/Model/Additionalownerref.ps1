...
function Initialize-Additionalownerref {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfiles => Additionalownerref' | Write-Debug
...
function ConvertFrom-JsonToAdditionalownerref {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfiles => Additionalownerref' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

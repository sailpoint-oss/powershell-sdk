...
function Initialize-BetaApprovalStatusDto1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalStatusDto1' | Write-Debug
...
ApprovalStatusDto1<PSCustomObject>
#>
function ConvertFrom-BetaJsonToApprovalStatusDto1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalStatusDto1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaApprovalStatusDto1

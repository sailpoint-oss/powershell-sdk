...
SavedSearchCompleteSearchResultsIdentity<PSCustomObject>
#>

function Initialize-V2025SavedSearchCompleteSearchResultsIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SavedSearchCompleteSearchResultsIdentity' | Write-Debug
...
Convert from JSON to SavedSearchCompleteSearchResultsIdentity<PSCustomObject>
...
SavedSearchCompleteSearchResultsIdentity<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSavedSearchCompleteSearchResultsIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SavedSearchCompleteSearchResultsIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SavedSearchCompleteSearchResultsIdentity

...
function Initialize-BetaJsonPatchOperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaJsonPatchOperation' | Write-Debug
...
function ConvertFrom-BetaJsonToJsonPatchOperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaJsonPatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

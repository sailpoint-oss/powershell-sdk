...
function Initialize-BetaOutlierContributingFeature {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaOutlierContributingFeature' | Write-Debug
...
function ConvertFrom-BetaJsonToOutlierContributingFeature {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaOutlierContributingFeature' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-DimensionCriteriaLevel3 {
    [CmdletBinding()]
    Param (
...
DimensionCriteriaLevel3<PSCustomObject>
#>
function ConvertFrom-JsonToDimensionCriteriaLevel3 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in DimensionCriteriaLevel3

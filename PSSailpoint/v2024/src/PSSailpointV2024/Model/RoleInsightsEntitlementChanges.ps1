...
function Initialize-V2024RoleInsightsEntitlementChanges {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RoleInsightsEntitlementChanges' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleInsightsEntitlementChanges {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RoleInsightsEntitlementChanges' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ScheduleMonths {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ScheduleMonths' | Write-Debug
...
function ConvertFrom-V2024JsonToScheduleMonths {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ScheduleMonths' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026ManagerCorrelationMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ManagerCorrelationMapping' | Write-Debug
...
ManagerCorrelationMapping<PSCustomObject>
#>
function ConvertFrom-V2026JsonToManagerCorrelationMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ManagerCorrelationMapping

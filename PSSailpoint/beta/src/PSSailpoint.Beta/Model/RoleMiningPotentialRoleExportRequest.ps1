...
function Initialize-BetaRoleMiningPotentialRoleExportRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRoleExportRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleExportRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningPotentialRoleExportRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Accountrequestdetailsdto {
    [CmdletBinding()]
    Param (
...
Accountrequestdetailsdto<PSCustomObject>
#>
function ConvertFrom-JsonToAccountrequestdetailsdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Accountrequestdetailsdto

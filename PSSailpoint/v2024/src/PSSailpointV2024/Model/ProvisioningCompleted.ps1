...
function Initialize-V2024ProvisioningCompleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ProvisioningCompleted' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ProvisioningCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026ApprovalConfigEscalationConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigEscalationConfig' | Write-Debug
...
ApprovalConfigEscalationConfig<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApprovalConfigEscalationConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApprovalConfigEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApprovalConfigEscalationConfig

...
function Initialize-Machineclassificationcriterialevel2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineClassificationConfigV1 => Machineclassificationcriterialevel2' | Write-Debug
...
Machineclassificationcriterialevel2<PSCustomObject>
#>
function ConvertFrom-JsonToMachineclassificationcriterialevel2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineClassificationConfigV1 => Machineclassificationcriterialevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Machineclassificationcriterialevel2

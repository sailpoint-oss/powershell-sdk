...
keywords: ['powershell', 'PowerShell', 'sdk', 'DimensionCriteriaLevel1', 'V2026DimensionCriteriaLevel1'] 
slug: /tools/sdk/powershell/v2026/models/dimension-criteria-level1
...
```powershell
$DimensionCriteriaLevel1 = Initialize-V2026DimensionCriteriaLevel1  -Operation null `
 -Key null `

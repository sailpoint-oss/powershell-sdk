...
function Initialize-BetaConnectorRuleValidationResponseDetailsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleValidationResponseDetailsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToConnectorRuleValidationResponseDetailsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConnectorRuleValidationResponseDetailsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

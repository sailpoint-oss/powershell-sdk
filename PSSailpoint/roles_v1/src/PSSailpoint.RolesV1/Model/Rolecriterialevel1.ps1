...
function Initialize-Rolecriterialevel1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RolesV1 => Rolecriterialevel1' | Write-Debug
...
Rolecriterialevel1<PSCustomObject>
#>
function ConvertFrom-JsonToRolecriterialevel1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RolesV1 => Rolecriterialevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Rolecriterialevel1

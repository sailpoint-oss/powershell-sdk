...
function Initialize-Configurationitemresponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.WorkReassignmentV1 => Configurationitemresponse' | Write-Debug
...
Configurationitemresponse<PSCustomObject>
#>
function ConvertFrom-JsonToConfigurationitemresponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.WorkReassignmentV1 => Configurationitemresponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Configurationitemresponse

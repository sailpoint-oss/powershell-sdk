...
function Initialize-BetaListFormInstancesByTenantResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaListFormInstancesByTenantResponse' | Write-Debug
...
ListFormInstancesByTenantResponse<PSCustomObject>
#>
function ConvertFrom-BetaJsonToListFormInstancesByTenantResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaListFormInstancesByTenantResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaListFormInstancesByTenantResponse

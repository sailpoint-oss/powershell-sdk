...
function Initialize-V2026NonEmployeeApprovalItemBase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeApprovalItemBase' | Write-Debug
...
NonEmployeeApprovalItemBase<PSCustomObject>
#>
function ConvertFrom-V2026JsonToNonEmployeeApprovalItemBase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026NonEmployeeApprovalItemBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026NonEmployeeApprovalItemBase

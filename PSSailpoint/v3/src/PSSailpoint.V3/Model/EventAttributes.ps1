...
function Initialize-EventAttributes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => EventAttributes' | Write-Debug
...
EventAttributes<PSCustomObject>
#>
function ConvertFrom-JsonToEventAttributes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => EventAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

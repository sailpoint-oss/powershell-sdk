...
function Initialize-BetaBulkIdentitiesAccountsResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaBulkIdentitiesAccountsResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToBulkIdentitiesAccountsResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaBulkIdentitiesAccountsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
$FunctionPath = "$PSScriptRoot/src/PSSailpoint.Triggers/Api", "$PSScriptRoot/src/PSSailpoint.Triggers/Client","$PSScriptRoot/src/PSSailpoint.Triggers/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\PSSailpoint.Triggers\PSSailpoint.Triggers.psd1"

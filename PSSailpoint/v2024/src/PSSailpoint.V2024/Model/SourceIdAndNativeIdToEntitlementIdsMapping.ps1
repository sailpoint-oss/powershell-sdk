...
function Initialize-V2024SourceIdAndNativeIdToEntitlementIdsMapping {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SourceIdAndNativeIdToEntitlementIdsMapping' | Write-Debug
...
SourceIdAndNativeIdToEntitlementIdsMapping<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSourceIdAndNativeIdToEntitlementIdsMapping {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SourceIdAndNativeIdToEntitlementIdsMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SourceIdAndNativeIdToEntitlementIdsMapping

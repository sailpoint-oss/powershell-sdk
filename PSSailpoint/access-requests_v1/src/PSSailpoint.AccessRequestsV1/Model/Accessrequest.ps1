...
function Initialize-Accessrequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestsV1 => Accessrequest' | Write-Debug
...
function ConvertFrom-JsonToAccessrequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestsV1 => Accessrequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024RoleMiningEntitlementRef {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RoleMiningEntitlementRef' | Write-Debug
...
function ConvertFrom-V2024JsonToRoleMiningEntitlementRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RoleMiningEntitlementRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

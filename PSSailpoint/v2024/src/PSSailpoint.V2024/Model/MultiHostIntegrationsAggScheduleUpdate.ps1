...
function Initialize-V2024MultiHostIntegrationsAggScheduleUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024MultiHostIntegrationsAggScheduleUpdate' | Write-Debug
...
MultiHostIntegrationsAggScheduleUpdate<PSCustomObject>
#>
function ConvertFrom-V2024JsonToMultiHostIntegrationsAggScheduleUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024MultiHostIntegrationsAggScheduleUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024MultiHostIntegrationsAggScheduleUpdate

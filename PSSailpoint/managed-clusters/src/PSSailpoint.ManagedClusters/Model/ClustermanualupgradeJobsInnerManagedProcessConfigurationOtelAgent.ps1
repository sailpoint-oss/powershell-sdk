...
function Initialize-ClustermanualupgradeJobsInnerManagedProcessConfigurationOtelAgent {
    [CmdletBinding()]
    Param (
...
ClustermanualupgradeJobsInnerManagedProcessConfigurationOtelAgent<PSCustomObject>
#>
function ConvertFrom-JsonToClustermanualupgradeJobsInnerManagedProcessConfigurationOtelAgent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ClustermanualupgradeJobsInnerManagedProcessConfigurationOtelAgent

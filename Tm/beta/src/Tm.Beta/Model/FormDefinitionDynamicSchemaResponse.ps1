...
function Initialize-BetaFormDefinitionDynamicSchemaResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaFormDefinitionDynamicSchemaResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToFormDefinitionDynamicSchemaResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaFormDefinitionDynamicSchemaResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

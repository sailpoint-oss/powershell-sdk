...
keywords: ['powershell', 'PowerShell', 'sdk', 'CustomPasswordInstruction', 'V2026CustomPasswordInstruction'] 
slug: /tools/sdk/powershell/v2026/models/custom-password-instruction
...
```powershell
$CustomPasswordInstruction = Initialize-V2026CustomPasswordInstruction  -PageId change-password:enter-password `

...
function Initialize-Machineaccountcreaterequestinput {
    [CmdletBinding()]
    Param (
...
Machineaccountcreaterequestinput<PSCustomObject>
#>
function ConvertFrom-JsonToMachineaccountcreaterequestinput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Machineaccountcreaterequestinput

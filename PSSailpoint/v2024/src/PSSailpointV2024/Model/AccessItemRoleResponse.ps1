...
function Initialize-V2024AccessItemRoleResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessItemRoleResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessItemRoleResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessItemRoleResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

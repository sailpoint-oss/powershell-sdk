...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalSummary', 'V2026ApprovalSummary'] 
slug: /tools/sdk/powershell/v2026/models/approval-summary
...
```powershell
$ApprovalSummary = Initialize-V2026ApprovalSummary  -Pending 0 `
 -Approved 0 `
 -Rejected 0
```

...
function Initialize-Baseentitlement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SearchV1 => Baseentitlement' | Write-Debug
...
Baseentitlement<PSCustomObject>
#>
function ConvertFrom-JsonToBaseentitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SearchV1 => Baseentitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ExpressionChildrenInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ExpressionChildrenInner' | Write-Debug
...
ExpressionChildrenInner<PSCustomObject>
#>
function ConvertFrom-V2024JsonToExpressionChildrenInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ExpressionChildrenInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ExpressionChildrenInner

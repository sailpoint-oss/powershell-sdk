...
function Initialize-V2024SubscriptionPutRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SubscriptionPutRequest' | Write-Debug
...
SubscriptionPutRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSubscriptionPutRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SubscriptionPutRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SubscriptionPutRequest

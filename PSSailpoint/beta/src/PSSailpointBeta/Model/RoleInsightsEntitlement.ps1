...
function Initialize-BetaRoleInsightsEntitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaRoleInsightsEntitlement' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleInsightsEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaRoleInsightsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

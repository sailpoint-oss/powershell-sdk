...
function Initialize-BetaDecomposeDiacriticalMarks {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaDecomposeDiacriticalMarks' | Write-Debug
...
function ConvertFrom-BetaJsonToDecomposeDiacriticalMarks {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaDecomposeDiacriticalMarks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
$FunctionPath = "$PSScriptRoot/src/PSSailpoint.DataAccessSecurity/Api", "$PSScriptRoot/src/PSSailpoint.DataAccessSecurity/Client","$PSScriptRoot/src/PSSailpoint.DataAccessSecurity/Model" | ForEach-Object { $_ }


$Manifest = @{
    Path = "$ScriptDir\src\PSSailpoint.DataAccessSecurity\PSSailpoint.DataAccessSecurity.psd1"

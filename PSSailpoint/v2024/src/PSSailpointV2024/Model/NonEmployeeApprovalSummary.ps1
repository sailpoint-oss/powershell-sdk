...
function Initialize-V2024NonEmployeeApprovalSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeApprovalSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeApprovalSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeApprovalSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

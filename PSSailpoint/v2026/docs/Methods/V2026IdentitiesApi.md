...
keywords: ['powershell', 'PowerShell', 'sdk', 'Identities', 'V2026Identities'] 
slug: /tools/sdk/powershell/v2026/methods/identities
...
------------- | ------------- | -------------
[**Remove-V2026Identity**](#delete-identity) | **DELETE** `/identities/{id}` | Delete identity
[**Get-V2026Identity**](#get-identity) | **GET** `/identities/{id}` | Identity details
[**Get-V2026IdentityOwnershipDetails**](#get-identity-ownership-details) | **GET** `/identities/{identityId}/ownership` | Get ownership details
[**Get-V2026RoleAssignment**](#get-role-assignment) | **GET** `/identities/{identityId}/role-assignments/{assignmentId}` | Role assignment details
[**Get-V2026RoleAssignments**](#get-role-assignments) | **GET** `/identities/{identityId}/role-assignments` | List role assignments
[**Get-V2026EntitlementsByIdentity**](#list-entitlements-by-identity) | **GET** `/entitlements/identities/{id}/entitlements` | List of entitlements by identity.
[**Get-V2026Identities**](#list-identities) | **GET** `/identities` | List identities
[**Reset-V2026Identity**](#reset-identity) | **POST** `/identities/{id}/reset` | Reset an identity
[**Send-V2026IdentityVerificationAccountToken**](#send-identity-verification-account-token) | **POST** `/identities/{id}/verification/account/send` | Send password reset email
[**Start-V2026IdentitiesInvite**](#start-identities-invite) | **POST** `/identities/invite` | Invite identities to register
[**Start-V2026IdentityProcessing**](#start-identity-processing) | **POST** `/identities/process` | Process a list of identityids
[**Sync-V2026hronizeAttributesForIdentity**](#synchronize-attributes-for-identity) | **POST** `/identities/{identityId}/synchronize-attributes` | Attribute synchronization for single identity.
...
try {
    Remove-V2026Identity -Id $Id -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026Identity -Id $Id -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026Identity"
...
try {
    Get-V2026Identity -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026Identity -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Identity"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026IdentityOwnershipDetails -IdentityId $IdentityId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026IdentityOwnershipDetails -IdentityId $IdentityId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026IdentityOwnershipDetails"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026RoleAssignment -IdentityId $IdentityId -AssignmentId $AssignmentId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026RoleAssignment -IdentityId $IdentityId -AssignmentId $AssignmentId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026RoleAssignment"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026RoleAssignments -IdentityId $IdentityId 
    
    # Below is a request that includes all optional parameters
    # Get-V2026RoleAssignments -IdentityId $IdentityId -RoleId $RoleId -RoleName $RoleName  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026RoleAssignments"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026EntitlementsByIdentity -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026EntitlementsByIdentity -Id $Id -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026EntitlementsByIdentity"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Identities -Filters $Filters -Sorters $Sorters -DefaultFilter $DefaultFilter -Count $Count -Limit $Limit -Offset $Offset  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Identities"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Reset-V2026Identity -IdentityId $IdentityId 
    
    # Below is a request that includes all optional parameters
    # Reset-V2026Identity -IdentityId $IdentityId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Reset-V2026Identity"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSendAccountVerificationRequest -Json $SendAccountVerificationRequest
    Send-V2026IdentityVerificationAccountToken -XSailPointExperimental $XSailPointExperimental -Id $Id -SendAccountVerificationRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026IdentityVerificationAccountToken -XSailPointExperimental $XSailPointExperimental -Id $Id -SendAccountVerificationRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026IdentityVerificationAccountToken"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToInviteIdentitiesRequest -Json $InviteIdentitiesRequest
    Start-V2026IdentitiesInvite -XSailPointExperimental $XSailPointExperimental -InviteIdentitiesRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Start-V2026IdentitiesInvite -XSailPointExperimental $XSailPointExperimental -InviteIdentitiesRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Start-V2026IdentitiesInvite"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToProcessIdentitiesRequest -Json $ProcessIdentitiesRequest
    Start-V2026IdentityProcessing -XSailPointExperimental $XSailPointExperimental -ProcessIdentitiesRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Start-V2026IdentityProcessing -XSailPointExperimental $XSailPointExperimental -ProcessIdentitiesRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Start-V2026IdentityProcessing"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Sync-V2026hronizeAttributesForIdentity -IdentityId $IdentityId -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Sync-V2026hronizeAttributesForIdentity -IdentityId $IdentityId -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Sync-V2026hronizeAttributesForIdentity"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

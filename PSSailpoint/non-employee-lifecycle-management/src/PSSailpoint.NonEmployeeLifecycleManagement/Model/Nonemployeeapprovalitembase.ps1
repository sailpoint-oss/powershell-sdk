...
function Initialize-Nonemployeeapprovalitembase {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagementV1 => Nonemployeeapprovalitembase' | Write-Debug
...
Nonemployeeapprovalitembase<PSCustomObject>
#>
function ConvertFrom-JsonToNonemployeeapprovalitembase {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagementV1 => Nonemployeeapprovalitembase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Nonemployeeapprovalitembase

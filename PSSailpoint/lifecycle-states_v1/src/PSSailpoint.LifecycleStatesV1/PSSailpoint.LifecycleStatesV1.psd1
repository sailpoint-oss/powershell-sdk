#
# Module manifest for module 'PSSailpoint.LifecycleStatesV1'
#
...
RootModule = 'PSSailpoint.LifecycleStatesV1.psm1'
...
Description = 'PSSailpoint.LifecycleStatesV1 - the PowerShell module for Identity Security Cloud API - Lifecycle States'

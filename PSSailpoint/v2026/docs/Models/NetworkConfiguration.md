...
keywords: ['powershell', 'PowerShell', 'sdk', 'NetworkConfiguration', 'V2026NetworkConfiguration'] 
slug: /tools/sdk/powershell/v2026/models/network-configuration
...
```powershell
$NetworkConfiguration = Initialize-V2026NetworkConfiguration  -Range [1.3.7.2, 255.255.255.252/30] `

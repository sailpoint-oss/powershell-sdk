...
function Initialize-BetaGenerateRandomString {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaGenerateRandomString' | Write-Debug
...
GenerateRandomString<PSCustomObject>
#>
function ConvertFrom-BetaJsonToGenerateRandomString {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaGenerateRandomString' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaGenerateRandomString

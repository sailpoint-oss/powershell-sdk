...
function Initialize-BetaCreatePersonalAccessTokenRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCreatePersonalAccessTokenRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToCreatePersonalAccessTokenRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCreatePersonalAccessTokenRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Errormessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CustomFormsV1 => Errormessage' | Write-Debug
...
function ConvertFrom-JsonToErrormessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CustomFormsV1 => Errormessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

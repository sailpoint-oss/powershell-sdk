...
function Initialize-TaskDefinitionSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Identities => TaskDefinitionSummary' | Write-Debug
...
function ConvertFrom-JsonToTaskDefinitionSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Identities => TaskDefinitionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
TriggerInputAccessRequestPostApproval<PSCustomObject>
#>

function Initialize-BetaTriggerInputAccessRequestPostApproval {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputAccessRequestPostApproval' | Write-Debug
...
Convert from JSON to TriggerInputAccessRequestPostApproval<PSCustomObject>
...
TriggerInputAccessRequestPostApproval<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputAccessRequestPostApproval {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputAccessRequestPostApproval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputAccessRequestPostApproval

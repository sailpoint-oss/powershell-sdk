...
function Initialize-V2024SodExemptCriteria {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SodExemptCriteria' | Write-Debug
...
SodExemptCriteria<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSodExemptCriteria {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SodExemptCriteria' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SodExemptCriteria

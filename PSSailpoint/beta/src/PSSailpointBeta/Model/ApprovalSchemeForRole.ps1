...
function Initialize-BetaApprovalSchemeForRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaApprovalSchemeForRole' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalSchemeForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaApprovalSchemeForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

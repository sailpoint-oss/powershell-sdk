...
function Initialize-V2024PermissionDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PermissionDto' | Write-Debug
...
function ConvertFrom-V2024JsonToPermissionDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PermissionDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

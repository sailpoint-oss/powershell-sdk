...
keywords: ['powershell', 'PowerShell', 'sdk', 'ManualWorkItemDetails', 'V2026ManualWorkItemDetails'] 
slug: /tools/sdk/powershell/v2026/models/manual-work-item-details
...
```powershell
$ManualWorkItemDetails = Initialize-V2026ManualWorkItemDetails  -Forwarded true `
 -OriginalOwner null `
 -CurrentOwner null `

...
function Get-V2024Approval {
    ...
    Process {
        'Calling method: Get-V2024Approval' | Write-Debug
...
function Get-V2024Approvals {
    ...
    Process {
        'Calling method: Get-V2024Approvals' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-V2024Approval {
    ...
    Process {
        'Calling method: Update-V2024Approval' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling patchApproval."
        }
        $LocalVarHeaderParameters['X-SailPoint-Experimental'] = $XSailPointExperimental

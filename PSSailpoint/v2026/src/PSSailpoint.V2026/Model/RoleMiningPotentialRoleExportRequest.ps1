...
function Initialize-V2026RoleMiningPotentialRoleExportRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleExportRequest' | Write-Debug
...
RoleMiningPotentialRoleExportRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMiningPotentialRoleExportRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleExportRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMiningPotentialRoleExportRequest

...
function Initialize-V2025AccountAttributesChanged {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccountAttributesChanged' | Write-Debug
...
AccountAttributesChanged<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccountAttributesChanged {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccountAttributesChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccountAttributesChanged

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ObjectExportImportNames', 'V2026ObjectExportImportNames'] 
slug: /tools/sdk/powershell/v2026/models/object-export-import-names
...
```powershell
$ObjectExportImportNames = Initialize-V2026ObjectExportImportNames  -IncludedNames null
```

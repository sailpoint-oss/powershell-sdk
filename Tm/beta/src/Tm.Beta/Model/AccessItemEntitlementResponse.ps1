...
function Initialize-BetaAccessItemEntitlementResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessItemEntitlementResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessItemEntitlementResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessItemEntitlementResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

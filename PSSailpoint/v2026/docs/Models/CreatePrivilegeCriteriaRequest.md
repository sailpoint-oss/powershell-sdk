...
keywords: ['powershell', 'PowerShell', 'sdk', 'CreatePrivilegeCriteriaRequest', 'V2026CreatePrivilegeCriteriaRequest'] 
slug: /tools/sdk/powershell/v2026/models/create-privilege-criteria-request
...
```powershell
$CreatePrivilegeCriteriaRequest = Initialize-V2026CreatePrivilegeCriteriaRequest  -SourceId c42c45d8d7c04d2da64d215cd8c32f21 `
 -Type CUSTOM `
 -Operator AND `
 -Groups null `
 -PrivilegeLevel HIGH

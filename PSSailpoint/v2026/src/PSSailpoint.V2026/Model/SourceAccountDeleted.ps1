...
function Initialize-V2026SourceAccountDeleted {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SourceAccountDeleted' | Write-Debug
...
SourceAccountDeleted<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSourceAccountDeleted {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SourceAccountDeleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SourceAccountDeleted

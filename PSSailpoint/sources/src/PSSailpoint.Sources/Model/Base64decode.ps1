...
function Initialize-Base64decode {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => Base64decode' | Write-Debug
...
function ConvertFrom-JsonToBase64decode {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => Base64decode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

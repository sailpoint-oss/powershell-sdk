...
function Initialize-V2024TemplateSlackAutoApprovalData {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024TemplateSlackAutoApprovalData' | Write-Debug
...
function ConvertFrom-V2024JsonToTemplateSlackAutoApprovalData {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024TemplateSlackAutoApprovalData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

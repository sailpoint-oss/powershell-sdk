...
function Initialize-Mailfromattributesdto {
    [CmdletBinding()]
    Param (
...
Mailfromattributesdto<PSCustomObject>
#>
function ConvertFrom-JsonToMailfromattributesdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Mailfromattributesdto

...
function Initialize-VendorConnectorMappingDeletedBy {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => VendorConnectorMappingDeletedBy' | Write-Debug
...
function ConvertFrom-JsonToVendorConnectorMappingDeletedBy {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => VendorConnectorMappingDeletedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

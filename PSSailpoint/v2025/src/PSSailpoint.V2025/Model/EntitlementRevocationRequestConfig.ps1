...
function Initialize-V2025EntitlementRevocationRequestConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025EntitlementRevocationRequestConfig' | Write-Debug
...
EntitlementRevocationRequestConfig<PSCustomObject>
#>
function ConvertFrom-V2025JsonToEntitlementRevocationRequestConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025EntitlementRevocationRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025EntitlementRevocationRequestConfig

...
function Initialize-Nonemployeesourcerequestbody {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagementV1 => Nonemployeesourcerequestbody' | Write-Debug
...
Nonemployeesourcerequestbody<PSCustomObject>
#>
function ConvertFrom-JsonToNonemployeesourcerequestbody {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NonEmployeeLifecycleManagementV1 => Nonemployeesourcerequestbody' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Nonemployeesourcerequestbody

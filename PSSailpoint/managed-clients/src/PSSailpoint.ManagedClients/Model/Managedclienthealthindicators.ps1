...
function Initialize-Managedclienthealthindicators {
    [CmdletBinding()]
    Param (
...
Managedclienthealthindicators<PSCustomObject>
#>
function ConvertFrom-JsonToManagedclienthealthindicators {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Managedclienthealthindicators

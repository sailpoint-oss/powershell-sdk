...
function Initialize-BetaRequestabilityForRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRequestabilityForRole' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestabilityForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRequestabilityForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

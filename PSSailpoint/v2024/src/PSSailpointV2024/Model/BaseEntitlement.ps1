...
function Initialize-V2024BaseEntitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024BaseEntitlement' | Write-Debug
...
function ConvertFrom-V2024JsonToBaseEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024BaseEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

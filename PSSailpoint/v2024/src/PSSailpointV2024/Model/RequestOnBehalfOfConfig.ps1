...
function Initialize-V2024RequestOnBehalfOfConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024RequestOnBehalfOfConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestOnBehalfOfConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024RequestOnBehalfOfConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-TemplatedtoSlackTemplate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NotificationsV1 => TemplatedtoSlackTemplate' | Write-Debug
...
TemplatedtoSlackTemplate<PSCustomObject>
#>
function ConvertFrom-JsonToTemplatedtoSlackTemplate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NotificationsV1 => TemplatedtoSlackTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TemplatedtoSlackTemplate

...
function Initialize-V2024StartInvocationInput {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024StartInvocationInput' | Write-Debug
...
function ConvertFrom-V2024JsonToStartInvocationInput {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024StartInvocationInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

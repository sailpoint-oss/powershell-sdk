...
function Initialize-V2026ContextAttributeDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ContextAttributeDto' | Write-Debug
...
ContextAttributeDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToContextAttributeDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ContextAttributeDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ContextAttributeDto

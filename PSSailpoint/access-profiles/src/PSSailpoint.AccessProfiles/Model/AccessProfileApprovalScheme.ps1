...
function Initialize-AccessProfileApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfiles => AccessProfileApprovalScheme' | Write-Debug
...
function ConvertFrom-JsonToAccessProfileApprovalScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfiles => AccessProfileApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

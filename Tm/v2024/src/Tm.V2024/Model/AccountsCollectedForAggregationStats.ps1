...
function Initialize-V2024AccountsCollectedForAggregationStats {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccountsCollectedForAggregationStats' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountsCollectedForAggregationStats {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccountsCollectedForAggregationStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

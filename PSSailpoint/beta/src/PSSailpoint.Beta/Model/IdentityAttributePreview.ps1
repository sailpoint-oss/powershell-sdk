...
function Initialize-BetaIdentityAttributePreview {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributePreview' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributePreview {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityAttributePreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

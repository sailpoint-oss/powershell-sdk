...
function Initialize-AccountaggregationcompletedStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => AccountaggregationcompletedStats' | Write-Debug
...
AccountaggregationcompletedStats<PSCustomObject>
#>
function ConvertFrom-JsonToAccountaggregationcompletedStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => AccountaggregationcompletedStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AccountaggregationcompletedStats

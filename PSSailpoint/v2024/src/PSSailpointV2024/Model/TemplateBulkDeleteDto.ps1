...
function Initialize-V2024TemplateBulkDeleteDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024TemplateBulkDeleteDto' | Write-Debug
...
function ConvertFrom-V2024JsonToTemplateBulkDeleteDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024TemplateBulkDeleteDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

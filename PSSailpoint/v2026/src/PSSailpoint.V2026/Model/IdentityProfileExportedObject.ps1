...
function Initialize-V2026IdentityProfileExportedObject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026IdentityProfileExportedObject' | Write-Debug
...
IdentityProfileExportedObject<PSCustomObject>
#>
function ConvertFrom-V2026JsonToIdentityProfileExportedObject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026IdentityProfileExportedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026IdentityProfileExportedObject

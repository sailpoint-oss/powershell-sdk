...
keywords: ['powershell', 'PowerShell', 'sdk', 'HealthEvent', 'V2026HealthEvent'] 
slug: /tools/sdk/powershell/v2026/models/health-event
...
```powershell
$HealthEvent = Initialize-V2026HealthEvent  -DetailedMessage CPU utilization is high `
 -Uuid 5 `

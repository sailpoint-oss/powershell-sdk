...
function Initialize-BetaRoleMiningPotentialRoleSourceUsage {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleSourceUsage' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleSourceUsage {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleSourceUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

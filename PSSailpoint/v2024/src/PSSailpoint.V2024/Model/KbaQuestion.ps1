...
function Initialize-V2024KbaQuestion {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024KbaQuestion' | Write-Debug
...
function ConvertFrom-V2024JsonToKbaQuestion {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024KbaQuestion' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

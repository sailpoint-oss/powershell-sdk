...
function Initialize-V2026ApprovalForwardHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApprovalForwardHistory' | Write-Debug
...
ApprovalForwardHistory<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApprovalForwardHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApprovalForwardHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApprovalForwardHistory

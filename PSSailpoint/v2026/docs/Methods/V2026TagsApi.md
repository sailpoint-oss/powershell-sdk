...
keywords: ['powershell', 'PowerShell', 'sdk', 'Tags', 'V2026Tags'] 
slug: /tools/sdk/powershell/v2026/methods/tags
...
------------- | ------------- | -------------
[**New-V2026Tag**](#create-tag) | **POST** `/tags` | Create tag
[**Remove-V2026TagById**](#delete-tag-by-id) | **DELETE** `/tags/{id}` | Delete tag
[**Get-V2026TagById**](#get-tag-by-id) | **GET** `/tags/{id}` | Get tag by id
[**Get-V2026Tags**](#list-tags) | **GET** `/tags` | List tags
...
try {
    $Result = ConvertFrom-V2026JsonToTag -Json $Tag
    New-V2026Tag -Tag $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026Tag -Tag $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026Tag"
...
try {
    Remove-V2026TagById -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026TagById -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026TagById"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026TagById -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026TagById -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026TagById"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2026Tags -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026Tags"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

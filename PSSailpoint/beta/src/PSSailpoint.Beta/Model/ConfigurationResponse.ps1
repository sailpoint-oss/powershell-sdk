...
function Initialize-BetaConfigurationResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaConfigurationResponse' | Write-Debug
...
ConfigurationResponse<PSCustomObject>
#>
function ConvertFrom-BetaJsonToConfigurationResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaConfigurationResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaConfigurationResponse

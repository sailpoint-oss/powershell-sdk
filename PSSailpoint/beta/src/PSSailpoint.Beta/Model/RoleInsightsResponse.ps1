...
function Initialize-BetaRoleInsightsResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleInsightsResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleInsightsResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleInsightsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

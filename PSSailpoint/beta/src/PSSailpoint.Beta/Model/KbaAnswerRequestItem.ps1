...
function Initialize-BetaKbaAnswerRequestItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaKbaAnswerRequestItem' | Write-Debug
...
function ConvertFrom-BetaJsonToKbaAnswerRequestItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaKbaAnswerRequestItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

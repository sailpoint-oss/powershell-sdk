...
function Initialize-BulkAddTaggedObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => BulkAddTaggedObject' | Write-Debug
...
function ConvertFrom-JsonToBulkAddTaggedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => BulkAddTaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

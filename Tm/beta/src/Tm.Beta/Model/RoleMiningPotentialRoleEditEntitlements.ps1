...
function Initialize-BetaRoleMiningPotentialRoleEditEntitlements {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleEditEntitlements' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleEditEntitlements {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleEditEntitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

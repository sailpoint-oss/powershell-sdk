...
function Initialize-AccessReviewReassignment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessReviewReassignment' | Write-Debug
...
function ConvertFrom-JsonToAccessReviewReassignment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessReviewReassignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

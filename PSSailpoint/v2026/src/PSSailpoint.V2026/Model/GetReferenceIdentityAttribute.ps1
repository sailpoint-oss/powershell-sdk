...
function Initialize-V2026GetReferenceIdentityAttribute {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026GetReferenceIdentityAttribute' | Write-Debug
...
GetReferenceIdentityAttribute<PSCustomObject>
#>
function ConvertFrom-V2026JsonToGetReferenceIdentityAttribute {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026GetReferenceIdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026GetReferenceIdentityAttribute

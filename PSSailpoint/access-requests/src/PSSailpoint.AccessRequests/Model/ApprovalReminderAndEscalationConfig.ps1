...
function Initialize-ApprovalReminderAndEscalationConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => ApprovalReminderAndEscalationConfig' | Write-Debug
...
function ConvertFrom-JsonToApprovalReminderAndEscalationConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => ApprovalReminderAndEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

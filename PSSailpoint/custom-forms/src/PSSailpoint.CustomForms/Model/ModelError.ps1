...
function Initialize-ModelError {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CustomForms => ModelError' | Write-Debug
...
function ConvertFrom-JsonToModelError {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CustomForms => ModelError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-SodViolationContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SodViolationContext' | Write-Debug
...
function ConvertFrom-JsonToSodViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SodViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026WorkgroupDeleteItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026WorkgroupDeleteItem' | Write-Debug
...
WorkgroupDeleteItem<PSCustomObject>
#>
function ConvertFrom-V2026JsonToWorkgroupDeleteItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026WorkgroupDeleteItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026WorkgroupDeleteItem

...
function Initialize-BetaProvisioningConfigManagedResourceRefsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaProvisioningConfigManagedResourceRefsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToProvisioningConfigManagedResourceRefsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaProvisioningConfigManagedResourceRefsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

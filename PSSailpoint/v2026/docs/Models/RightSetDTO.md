...
keywords: ['powershell', 'PowerShell', 'sdk', 'RightSetDTO', 'V2026RightSetDTO'] 
slug: /tools/sdk/powershell/v2026/models/right-set-dto
...
```powershell
$RightSetDTO = Initialize-V2026RightSetDTO  -Id idn:ui-right-set-example `
 -Name Right Set Name `

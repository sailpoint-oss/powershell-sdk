...
function Initialize-GetPersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => GetPersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-JsonToGetPersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => GetPersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

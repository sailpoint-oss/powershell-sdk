...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountRequest', 'V2026AccountRequest'] 
slug: /tools/sdk/powershell/v2026/models/account-request
...
```powershell
$AccountRequest = Initialize-V2026AccountRequest  -AccountId John.Doe `

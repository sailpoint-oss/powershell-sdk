...
Describe -tag 'PSSailpoint.MachineIdentitiesLifecycleActions' -name 'LifecycleProvisioning' {
    Context 'LifecycleProvisioning' {
        It 'Initialize-LifecycleProvisioning' {
            # a simple test to create an object
            #$NewObject = Initialize-LifecycleProvisioning -Status "TEST_VALUE" -Started "TEST_VALUE" -Ended "TEST_VALUE"
            #$NewObject | Should -BeOfType LifecycleProvisioning

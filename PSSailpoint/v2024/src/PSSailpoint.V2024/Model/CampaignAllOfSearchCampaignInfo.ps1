...
function Initialize-V2024CampaignAllOfSearchCampaignInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CampaignAllOfSearchCampaignInfo' | Write-Debug
...
CampaignAllOfSearchCampaignInfo<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCampaignAllOfSearchCampaignInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CampaignAllOfSearchCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024CampaignAllOfSearchCampaignInfo

...
function Initialize-V2024AccountsCollectedForAggregationStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccountsCollectedForAggregationStats' | Write-Debug
...
AccountsCollectedForAggregationStats<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAccountsCollectedForAggregationStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccountsCollectedForAggregationStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024AccountsCollectedForAggregationStats

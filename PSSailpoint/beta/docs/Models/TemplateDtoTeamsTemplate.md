...
keywords: ['powershell', 'PowerShell', 'sdk', 'TemplateDtoTeamsTemplate', 'BetaTemplateDtoTeamsTemplate'] 
slug: /tools/sdk/powershell/beta/models/template-dto-teams-template
...
```powershell
$TemplateDtoTeamsTemplate = Initialize-BetaTemplateDtoTeamsTemplate  -Key null `
 -Title null `

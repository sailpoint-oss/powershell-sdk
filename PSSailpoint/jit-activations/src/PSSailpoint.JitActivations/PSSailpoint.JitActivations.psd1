...
FunctionsToExport = 'Get-JitActivationHistoryForCurrentIdentityV1', 
               'Get-JitActivationHistoryV1', 'Start-ActivateWorkflowV1', 
               'Start-DeactivateWorkflowV1', 'Start-ExtendWorkflowV1', 
               ...
               'Initialize-Jitactivationhistorydocument', 
               'ConvertFrom-JsonToJitactivationhistorydocument', 
               'Initialize-JitactivationhistorydocumentFrictionsInner', 
               'ConvertFrom-JsonToJitactivationhistorydocumentFrictionsInner', 
               'Initialize-JitactivationhistorydocumentSummary', 
               'ConvertFrom-JsonToJitactivationhistorydocumentSummary', 
               'Initialize-JitactivationhistorydocumentSummaryJustification', 
               'ConvertFrom-JsonToJitactivationhistorydocumentSummaryJustification', 
               'Initialize-JitactivationhistorydocumentSummaryPolicyMatchesInner', 
               'ConvertFrom-JsonToJitactivationhistorydocumentSummaryPolicyMatchesInner', 
               'Initialize-JitactivationhistorydocumentSummaryReauthentication', 
               'ConvertFrom-JsonToJitactivationhistorydocumentSummaryReauthentication', 
               'Initialize-JitactivationhistorydocumentSummaryServiceNowTicket', 
               'ConvertFrom-JsonToJitactivationhistorydocumentSummaryServiceNowTicket', 

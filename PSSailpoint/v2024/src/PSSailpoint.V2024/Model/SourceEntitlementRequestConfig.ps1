...
function Initialize-V2024SourceEntitlementRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SourceEntitlementRequestConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceEntitlementRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SourceEntitlementRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

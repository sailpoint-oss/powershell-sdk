...
function Initialize-SourcecreatedActor {
    [CmdletBinding()]
    Param (
...
SourcecreatedActor<PSCustomObject>
#>
function ConvertFrom-JsonToSourcecreatedActor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SourcecreatedActor

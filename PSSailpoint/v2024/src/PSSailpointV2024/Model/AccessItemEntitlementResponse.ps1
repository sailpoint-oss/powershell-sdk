...
function Initialize-V2024AccessItemEntitlementResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccessItemEntitlementResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessItemEntitlementResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccessItemEntitlementResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

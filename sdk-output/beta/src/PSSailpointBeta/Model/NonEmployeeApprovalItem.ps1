...
function Initialize-BetaNonEmployeeApprovalItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaNonEmployeeApprovalItem' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeApprovalItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaNonEmployeeApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaSourceCode {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceCode' | Write-Debug
...
SourceCode<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSourceCode {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceCode' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSourceCode

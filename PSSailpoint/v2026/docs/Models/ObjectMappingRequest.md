...
keywords: ['powershell', 'PowerShell', 'sdk', 'ObjectMappingRequest', 'V2026ObjectMappingRequest'] 
slug: /tools/sdk/powershell/v2026/models/object-mapping-request
...
```powershell
$ObjectMappingRequest = Initialize-V2026ObjectMappingRequest  -ObjectType IDENTITY `
 -JsonPath $.name `

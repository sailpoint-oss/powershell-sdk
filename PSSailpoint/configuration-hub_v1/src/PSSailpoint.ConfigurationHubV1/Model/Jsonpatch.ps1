...
function Initialize-Jsonpatch {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ConfigurationHubV1 => Jsonpatch' | Write-Debug
...
function ConvertFrom-JsonToJsonpatch {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ConfigurationHubV1 => Jsonpatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

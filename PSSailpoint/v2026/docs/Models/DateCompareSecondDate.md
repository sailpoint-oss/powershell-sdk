---
id: v2026-date-compare-second-date
title: DateCompareSecondDate
pagination_label: DateCompareSecondDate
sidebar_label: DateCompareSecondDate
sidebar_class_name: powershellsdk
keywords: ['powershell', 'PowerShell', 'sdk', 'DateCompareSecondDate', 'V2026DateCompareSecondDate'] 
slug: /tools/sdk/powershell/v2026/models/date-compare-second-date
tags: ['SDK', 'Software Development Kit', 'DateCompareSecondDate', 'V2026DateCompareSecondDate']
---
...
```powershell
$DateCompareSecondDate = Initialize-V2026DateCompareSecondDate  -SourceName Workday `

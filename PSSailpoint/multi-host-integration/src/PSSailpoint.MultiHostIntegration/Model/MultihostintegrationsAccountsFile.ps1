...
function Initialize-MultihostintegrationsAccountsFile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MultiHostIntegrationV1 => MultihostintegrationsAccountsFile' | Write-Debug
...
MultihostintegrationsAccountsFile<PSCustomObject>
#>
function ConvertFrom-JsonToMultihostintegrationsAccountsFile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MultiHostIntegrationV1 => MultihostintegrationsAccountsFile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MultihostintegrationsAccountsFile

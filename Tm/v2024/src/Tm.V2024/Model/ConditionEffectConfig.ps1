...
function Initialize-V2024ConditionEffectConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ConditionEffectConfig' | Write-Debug
...
function ConvertFrom-V2024JsonToConditionEffectConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ConditionEffectConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

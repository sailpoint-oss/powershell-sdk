...
function Initialize-BetaAccessRequestRecommendationItemDetail {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessRequestRecommendationItemDetail' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestRecommendationItemDetail {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessRequestRecommendationItemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

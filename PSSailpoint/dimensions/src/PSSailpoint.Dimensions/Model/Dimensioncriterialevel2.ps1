...
Dimensioncriterialevel2<PSCustomObject>
#>

function Initialize-Dimensioncriterialevel2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DimensionsV1 => Dimensioncriterialevel2' | Write-Debug
...
Convert from JSON to Dimensioncriterialevel2<PSCustomObject>
...
Dimensioncriterialevel2<PSCustomObject>
#>
function ConvertFrom-JsonToDimensioncriterialevel2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DimensionsV1 => Dimensioncriterialevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Dimensioncriterialevel2

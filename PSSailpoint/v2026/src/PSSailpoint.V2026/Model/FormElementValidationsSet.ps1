...
function Initialize-V2026FormElementValidationsSet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026FormElementValidationsSet' | Write-Debug
...
FormElementValidationsSet<PSCustomObject>
#>
function ConvertFrom-V2026JsonToFormElementValidationsSet {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026FormElementValidationsSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026FormElementValidationsSet

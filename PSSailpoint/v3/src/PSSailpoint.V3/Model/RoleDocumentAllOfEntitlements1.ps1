...
function Initialize-RoleDocumentAllOfEntitlements1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RoleDocumentAllOfEntitlements1' | Write-Debug
...
RoleDocumentAllOfEntitlements1<PSCustomObject>
#>
function ConvertFrom-JsonToRoleDocumentAllOfEntitlements1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RoleDocumentAllOfEntitlements1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RoleDocumentAllOfEntitlements1

...
function Initialize-ScheduledactionpayloadContent {
    [CmdletBinding()]
    Param (
...
ScheduledactionpayloadContent<PSCustomObject>
#>
function ConvertFrom-JsonToScheduledactionpayloadContent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ScheduledactionpayloadContent

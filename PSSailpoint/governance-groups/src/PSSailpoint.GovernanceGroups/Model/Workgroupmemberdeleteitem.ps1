...
function Initialize-Workgroupmemberdeleteitem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.GovernanceGroupsV1 => Workgroupmemberdeleteitem' | Write-Debug
...
Workgroupmemberdeleteitem<PSCustomObject>
#>
function ConvertFrom-JsonToWorkgroupmemberdeleteitem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.GovernanceGroupsV1 => Workgroupmemberdeleteitem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Workgroupmemberdeleteitem

...
function Initialize-V2024NonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

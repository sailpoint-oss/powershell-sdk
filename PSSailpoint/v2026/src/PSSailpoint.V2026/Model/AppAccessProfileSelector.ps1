...
AppAccessProfileSelector<PSCustomObject>
#>

function Initialize-V2026AppAccessProfileSelector {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AppAccessProfileSelector' | Write-Debug
...
Convert from JSON to AppAccessProfileSelector<PSCustomObject>
...
AppAccessProfileSelector<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAppAccessProfileSelector {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AppAccessProfileSelector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AppAccessProfileSelector

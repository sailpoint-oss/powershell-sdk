...
function Initialize-V2024RequestedItemStatusCancelledRequestDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024RequestedItemStatusCancelledRequestDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToRequestedItemStatusCancelledRequestDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024RequestedItemStatusCancelledRequestDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024OriginalRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024OriginalRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToOriginalRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024OriginalRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

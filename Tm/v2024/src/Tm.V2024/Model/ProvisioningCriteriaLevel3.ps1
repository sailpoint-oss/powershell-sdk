...
function Initialize-V2024ProvisioningCriteriaLevel3 {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ProvisioningCriteriaLevel3' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningCriteriaLevel3 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ProvisioningCriteriaLevel3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaCloseAccessRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCloseAccessRequest' | Write-Debug
...
CloseAccessRequest<PSCustomObject>
#>
function ConvertFrom-BetaJsonToCloseAccessRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCloseAccessRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaCloseAccessRequest

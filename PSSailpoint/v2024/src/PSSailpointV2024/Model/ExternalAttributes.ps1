...
function Initialize-V2024ExternalAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ExternalAttributes' | Write-Debug
...
function ConvertFrom-V2024JsonToExternalAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ExternalAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

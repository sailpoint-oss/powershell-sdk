...
function Initialize-V2026RoleMetadataBulkUpdateByIdRequestValuesInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMetadataBulkUpdateByIdRequestValuesInner' | Write-Debug
...
RoleMetadataBulkUpdateByIdRequestValuesInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMetadataBulkUpdateByIdRequestValuesInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMetadataBulkUpdateByIdRequestValuesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMetadataBulkUpdateByIdRequestValuesInner

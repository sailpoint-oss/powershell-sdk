...
function Initialize-V2024ServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ServiceDeskIntegrationTemplateType' | Write-Debug
...
function ConvertFrom-V2024JsonToServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ServiceDeskIntegrationTemplateType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

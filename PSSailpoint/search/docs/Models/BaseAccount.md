...
slug: /tools/sdk/powershell/search/models/base-account
...
**EntitlementAttributes** | **map[string]AnyType** | Map or dictionary of key/value pairs. | [optional] 
...
**AccountAttributes** | **map[string]AnyType** | Map or dictionary of key/value pairs. | [optional] 

...
function Initialize-Basereferencedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineIdentitiesV1 => Basereferencedto' | Write-Debug
...
function ConvertFrom-JsonToBasereferencedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineIdentitiesV1 => Basereferencedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

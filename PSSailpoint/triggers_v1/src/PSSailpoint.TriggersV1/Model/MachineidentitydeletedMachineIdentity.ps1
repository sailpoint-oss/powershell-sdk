...
function Initialize-MachineidentitydeletedMachineIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => MachineidentitydeletedMachineIdentity' | Write-Debug
...
MachineidentitydeletedMachineIdentity<PSCustomObject>
#>
function ConvertFrom-JsonToMachineidentitydeletedMachineIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => MachineidentitydeletedMachineIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MachineidentitydeletedMachineIdentity

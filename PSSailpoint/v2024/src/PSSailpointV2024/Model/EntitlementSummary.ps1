...
function Initialize-V2024EntitlementSummary {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024EntitlementSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlementSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024EntitlementSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024PeerGroupMember {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PeerGroupMember' | Write-Debug
...
function ConvertFrom-V2024JsonToPeerGroupMember {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PeerGroupMember' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

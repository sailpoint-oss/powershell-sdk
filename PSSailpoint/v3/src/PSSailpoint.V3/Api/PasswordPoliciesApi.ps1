...
function New-PasswordPolicy {
    ...
    Process {
        'Calling method: New-PasswordPolicy' | Write-Debug
...
function Remove-PasswordPolicy {
    ...
    Process {
        'Calling method: Remove-PasswordPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
PasswordPolicyV3Dto
#>
function Get-PasswordPolicyById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-PasswordPolicyById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-PasswordPolicies {
    ...
    Process {
        'Calling method: Get-PasswordPolicies' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Set-PasswordPolicy {
    ...
    Process {
        'Calling method: Set-PasswordPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

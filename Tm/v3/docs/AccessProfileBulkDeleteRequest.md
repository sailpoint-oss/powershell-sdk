...
```powershell
$AccessProfileBulkDeleteRequest = Initialize-Tm.V3AccessProfileBulkDeleteRequest  -AccessProfileIds [2c9180847812e0b1017817051919ecca, 2c9180887812e0b201781e129f151816] `
 -BestEffortOnly true
```

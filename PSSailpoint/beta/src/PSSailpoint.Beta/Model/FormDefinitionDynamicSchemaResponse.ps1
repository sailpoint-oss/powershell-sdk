...
function Initialize-BetaFormDefinitionDynamicSchemaResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionDynamicSchemaResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToFormDefinitionDynamicSchemaResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionDynamicSchemaResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

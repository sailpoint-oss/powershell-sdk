...
function Initialize-V2024CreatePersonalAccessTokenResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CreatePersonalAccessTokenResponse' | Write-Debug
...
CreatePersonalAccessTokenResponse<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCreatePersonalAccessTokenResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CreatePersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024Entitlement1ManuallyUpdatedFields {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Entitlement1ManuallyUpdatedFields' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlement1ManuallyUpdatedFields {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Entitlement1ManuallyUpdatedFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

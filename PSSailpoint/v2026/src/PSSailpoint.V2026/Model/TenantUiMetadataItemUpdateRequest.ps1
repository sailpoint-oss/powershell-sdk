...
function Initialize-V2026TenantUiMetadataItemUpdateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TenantUiMetadataItemUpdateRequest' | Write-Debug
...
TenantUiMetadataItemUpdateRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTenantUiMetadataItemUpdateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TenantUiMetadataItemUpdateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TenantUiMetadataItemUpdateRequest

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConfigObject', 'V2026ConfigObject'] 
slug: /tools/sdk/powershell/v2026/models/config-object
...
```powershell
$ConfigObject = Initialize-V2026ConfigObject  -Version 1 `
 -Self null `
 -Object null
```

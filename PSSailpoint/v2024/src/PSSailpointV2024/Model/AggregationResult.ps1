...
function Initialize-V2024AggregationResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AggregationResult' | Write-Debug
...
function ConvertFrom-V2024JsonToAggregationResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AggregationResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

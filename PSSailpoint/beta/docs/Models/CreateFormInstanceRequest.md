...
$CreateFormInstanceRequest = Initialize-PSSailpoint.BetaCreateFormInstanceRequest  -CreatedBy null `
 ...
 -State ASSIGNED `
 -Ttl 1571827560
$CreateFormInstanceRequest = @"{  "CreatedBy": null, "Expire": "2023-08-12T20:14:57.74486Z", "FormDefinitionId": "00000000-0000-0000-0000-000000000000", "FormInput": {"input1": "Sales}", "Recipients": null, "StandAloneForm": false, "State": "ASSIGNED", "Ttl": "1571827560" }}"@
```

- Convert the resource from JSON
```powershell
ConvertFrom-JsonToCreateFormInstanceRequest -Json $CreateFormInstanceRequest
```

...
function Initialize-V2024AuthUser {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AuthUser' | Write-Debug
...
AuthUser<PSCustomObject>
#>
function ConvertFrom-V2024JsonToAuthUser {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AuthUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

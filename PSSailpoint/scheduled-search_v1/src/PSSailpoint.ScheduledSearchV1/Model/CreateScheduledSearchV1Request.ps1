...
CreateScheduledSearchV1Request<PSCustomObject>
#>

function Initialize-CreateScheduledSearchV1Request {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ScheduledSearchV1 => CreateScheduledSearchV1Request' | Write-Debug
...
Convert from JSON to CreateScheduledSearchV1Request<PSCustomObject>
...
CreateScheduledSearchV1Request<PSCustomObject>
#>
function ConvertFrom-JsonToCreateScheduledSearchV1Request {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ScheduledSearchV1 => CreateScheduledSearchV1Request' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateScheduledSearchV1Request

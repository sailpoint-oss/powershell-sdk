...
function Initialize-V2025SetLifecycleState200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SetLifecycleState200Response' | Write-Debug
...
SetLifecycleState200Response<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSetLifecycleState200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SetLifecycleState200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025SetLifecycleState200Response

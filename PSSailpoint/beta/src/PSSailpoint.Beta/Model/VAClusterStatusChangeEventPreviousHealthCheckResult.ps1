...
function Initialize-BetaVAClusterStatusChangeEventPreviousHealthCheckResult {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaVAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
...
function ConvertFrom-BetaJsonToVAClusterStatusChangeEventPreviousHealthCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaVAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

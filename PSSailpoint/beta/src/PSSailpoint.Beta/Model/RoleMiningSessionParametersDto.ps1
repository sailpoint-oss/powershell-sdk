...
function Initialize-BetaRoleMiningSessionParametersDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionParametersDto' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningSessionParametersDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningSessionParametersDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026ApplicationDiscoveryResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApplicationDiscoveryResponse' | Write-Debug
...
ApplicationDiscoveryResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApplicationDiscoveryResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApplicationDiscoveryResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApplicationDiscoveryResponse

...
function Initialize-BetaRequestedItemStatusCancelledRequestDetails {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRequestedItemStatusCancelledRequestDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToRequestedItemStatusCancelledRequestDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRequestedItemStatusCancelledRequestDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

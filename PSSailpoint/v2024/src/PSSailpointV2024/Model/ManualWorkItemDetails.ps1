...
function Initialize-V2024ManualWorkItemDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ManualWorkItemDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToManualWorkItemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ManualWorkItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
keywords: ['powershell', 'PowerShell', 'sdk', 'TransformRead', 'V2026TransformRead'] 
slug: /tools/sdk/powershell/v2026/models/transform-read
...
```powershell
$TransformRead = Initialize-V2026TransformRead  -Name Timestamp To Date `
 -Type dateFormat `
 -Attributes null `

...
#>
function ConvertFrom-V2025JsonToIdentityAccess {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            $matchInstance = ConvertFrom-V2025JsonToAccessProfileEntitlement $Json
            ...
            Write-Debug "Failed to match 'AccessProfileEntitlement' defined in oneOf (V2025IdentityAccess). Proceeding to the next one if any."
        }

        # try to match AccessProfileRole defined in the oneOf schemas
        try {
            $matchInstance = ConvertFrom-V2025JsonToAccessProfileRole $Json
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'AccessProfileRole' defined in oneOf (V2025IdentityAccess). Proceeding to the next one if any."
        }

        # try to match AccessProfileSummary defined in the oneOf schemas
        try {
            $matchInstance = ConvertFrom-V2025JsonToAccessProfileSummary $Json
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'AccessProfileSummary' defined in oneOf (V2025IdentityAccess). Proceeding to the next one if any."
        }

...
function Initialize-BetaSodViolationCheckResult1 {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSodViolationCheckResult1' | Write-Debug
...
function ConvertFrom-BetaJsonToSodViolationCheckResult1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSodViolationCheckResult1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

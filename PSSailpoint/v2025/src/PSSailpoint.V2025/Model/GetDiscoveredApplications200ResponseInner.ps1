...
#>
function ConvertFrom-V2025JsonToGetDiscoveredApplications200ResponseInner {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            $matchInstance = ConvertFrom-V2025JsonToFullDiscoveredApplications $Json
            ...
            Write-Debug "Failed to match 'FullDiscoveredApplications' defined in oneOf (V2025GetDiscoveredApplications200ResponseInner). Proceeding to the next one if any."
        }

        # try to match SlimDiscoveredApplications defined in the oneOf schemas
        try {
            $matchInstance = ConvertFrom-V2025JsonToSlimDiscoveredApplications $Json
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'SlimDiscoveredApplications' defined in oneOf (V2025GetDiscoveredApplications200ResponseInner). Proceeding to the next one if any."
        }

...
function Initialize-BetaNonEmployeeApprovalItemBase {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalItemBase' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeApprovalItemBase {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaNonEmployeeApprovalItemBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

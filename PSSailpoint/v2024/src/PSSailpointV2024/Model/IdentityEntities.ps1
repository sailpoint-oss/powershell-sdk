...
function Initialize-V2024IdentityEntities {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityEntities' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityEntities {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityEntities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

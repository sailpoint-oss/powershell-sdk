...
function Initialize-JsonPatchOperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.GovernanceGroups => JsonPatchOperation' | Write-Debug
...
function ConvertFrom-JsonToJsonPatchOperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.GovernanceGroups => JsonPatchOperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

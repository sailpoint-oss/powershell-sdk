...
function Initialize-BetaServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaServiceDeskIntegrationTemplateType' | Write-Debug
...
function ConvertFrom-BetaJsonToServiceDeskIntegrationTemplateType {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaServiceDeskIntegrationTemplateType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024IdentityLifecycleState {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityLifecycleState' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityLifecycleState {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityLifecycleState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

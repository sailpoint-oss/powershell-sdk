...
function Initialize-KbaAnswerResponseItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => KbaAnswerResponseItem' | Write-Debug
...
KbaAnswerResponseItem<PSCustomObject>
#>
function ConvertFrom-JsonToKbaAnswerResponseItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => KbaAnswerResponseItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KbaAnswerResponseItem

...
function Initialize-BetaVAClusterStatusChangeEventApplication {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaVAClusterStatusChangeEventApplication' | Write-Debug
...
function ConvertFrom-BetaJsonToVAClusterStatusChangeEventApplication {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaVAClusterStatusChangeEventApplication' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

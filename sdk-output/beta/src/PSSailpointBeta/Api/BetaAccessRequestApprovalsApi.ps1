...
ApprovalSummary
#>
function Invoke-BetaApprovalSummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-BetaApprovalSummary' | Write-Debug
...
function Approve-BetaRequest {
    ...
    Process {
        'Calling method: Approve-BetaRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarBodyParameter = $CommentDto | ConvertTo-Json -Depth 100
...
SystemCollectionsHashtable
#>
function Invoke-BetaForwardRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-BetaForwardRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarBodyParameter = $ForwardApprovalDto | ConvertTo-Json -Depth 100
...
function Deny-BetaRequest {
    ...
    Process {
        'Calling method: Deny-BetaRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

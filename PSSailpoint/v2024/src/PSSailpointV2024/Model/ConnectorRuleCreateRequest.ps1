...
function Initialize-V2024ConnectorRuleCreateRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ConnectorRuleCreateRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToConnectorRuleCreateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ConnectorRuleCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

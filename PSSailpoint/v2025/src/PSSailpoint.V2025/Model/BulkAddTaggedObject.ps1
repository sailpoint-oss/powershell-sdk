...
function Initialize-V2025BulkAddTaggedObject {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025BulkAddTaggedObject' | Write-Debug
...
BulkAddTaggedObject<PSCustomObject>
#>
function ConvertFrom-V2025JsonToBulkAddTaggedObject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025BulkAddTaggedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025BulkAddTaggedObject

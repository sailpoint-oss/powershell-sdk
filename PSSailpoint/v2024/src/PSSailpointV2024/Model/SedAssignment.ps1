...
function Initialize-V2024SedAssignment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SedAssignment' | Write-Debug
...
function ConvertFrom-V2024JsonToSedAssignment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SedAssignment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

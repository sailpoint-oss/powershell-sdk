...
function Initialize-V2024NonEmployeeRecord {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeRecord' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeRecord {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeRecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Provisioningconfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ServiceDeskIntegrationV1 => Provisioningconfig' | Write-Debug
...
Provisioningconfig<PSCustomObject>
#>
function ConvertFrom-JsonToProvisioningconfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ServiceDeskIntegrationV1 => Provisioningconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Provisioningconfig

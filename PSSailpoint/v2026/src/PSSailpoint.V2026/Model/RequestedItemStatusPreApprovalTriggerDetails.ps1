...
function Initialize-V2026RequestedItemStatusPreApprovalTriggerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
...
RequestedItemStatusPreApprovalTriggerDetails<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRequestedItemStatusPreApprovalTriggerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RequestedItemStatusPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RequestedItemStatusPreApprovalTriggerDetails

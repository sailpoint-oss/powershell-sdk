...
function Initialize-V2026ApprovalIdentityRecord {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ApprovalIdentityRecord' | Write-Debug
...
ApprovalIdentityRecord<PSCustomObject>
#>
function ConvertFrom-V2026JsonToApprovalIdentityRecord {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ApprovalIdentityRecord' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ApprovalIdentityRecord

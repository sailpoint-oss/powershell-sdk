...
Get the configuration object 'V2026Configuration'.
...
#>
function Get-V2026Configuration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://sailpoint.api.identitynow.com/v2026";
    }
...
System.Collections.Hashtable
#>
function Set-V2026Configuration {
...
None
#>
function Set-V2026ConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-V2026ConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-V2026ConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
String
#>
function Get-V2026UrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-V2026ConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-V2026KeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'V2026ConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-V2026ConfigurationHttpSigning{

...
UpdateMultiHostSourcesV1RequestInnerValue<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateMultiHostSourcesV1RequestInnerValue {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'ArrayInner[]' defined in oneOf (UpdateMultiHostSourcesV1RequestInnerValue). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'Boolean' defined in oneOf (UpdateMultiHostSourcesV1RequestInnerValue). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'Int32' defined in oneOf (UpdateMultiHostSourcesV1RequestInnerValue). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'String' defined in oneOf (UpdateMultiHostSourcesV1RequestInnerValue). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'SystemCollectionsHashtable' defined in oneOf (UpdateMultiHostSourcesV1RequestInnerValue). Proceeding to the next one if any."
        }

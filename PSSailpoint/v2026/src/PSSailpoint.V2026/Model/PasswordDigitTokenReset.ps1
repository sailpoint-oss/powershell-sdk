...
function Initialize-V2026PasswordDigitTokenReset {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026PasswordDigitTokenReset' | Write-Debug
...
PasswordDigitTokenReset<PSCustomObject>
#>
function ConvertFrom-V2026JsonToPasswordDigitTokenReset {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026PasswordDigitTokenReset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026PasswordDigitTokenReset

...
keywords: ['powershell', 'PowerShell', 'sdk', 'CampaignReportsConfig', 'V2026CampaignReportsConfig'] 
slug: /tools/sdk/powershell/v2026/models/campaign-reports-config
...
```powershell
$CampaignReportsConfig = Initialize-V2026CampaignReportsConfig  -IdentityAttributeColumns [firstname, lastname]
```

...
function Initialize-BetaExportPayload {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaExportPayload' | Write-Debug
...
function ConvertFrom-BetaJsonToExportPayload {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaExportPayload' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

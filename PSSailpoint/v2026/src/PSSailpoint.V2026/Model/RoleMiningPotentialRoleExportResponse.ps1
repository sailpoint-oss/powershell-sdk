...
function Initialize-V2026RoleMiningPotentialRoleExportResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleExportResponse' | Write-Debug
...
RoleMiningPotentialRoleExportResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToRoleMiningPotentialRoleExportResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026RoleMiningPotentialRoleExportResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026RoleMiningPotentialRoleExportResponse

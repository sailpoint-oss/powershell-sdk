...
[**Receive-V2025ResourceObjects**](#peek-resource-objects) | **POST** `/sources/{sourceId}/connector/peek-resource-objects` | Peek source connector&#39;s resource objects
...
try {
    Get-V2025SourceConfig -Id $Id -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2025SourceConfig -Id $Id -XSailPointExperimental $XSailPointExperimental -Locale $Locale  
} catch {
...
try {
    ...
    Receive-V2025ResourceObjects -SourceId $SourceId -XSailPointExperimental $XSailPointExperimental -ResourceObjectsRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Receive-V2025ResourceObjects -SourceId $SourceId -XSailPointExperimental $XSailPointExperimental -ResourceObjectsRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Receive-V2025ResourceObjects"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Ping-V2025Cluster -SourceId $SourceId -XSailPointExperimental $XSailPointExperimental 
...
try {
    Test-V2025SourceConfiguration -SourceId $SourceId -XSailPointExperimental $XSailPointExperimental 
...
try {
    Test-V2025SourceConnection -SourceId $SourceId -XSailPointExperimental $XSailPointExperimental 

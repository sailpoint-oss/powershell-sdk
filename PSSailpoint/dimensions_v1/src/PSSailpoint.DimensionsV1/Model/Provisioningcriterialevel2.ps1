...
function Initialize-Provisioningcriterialevel2 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.DimensionsV1 => Provisioningcriterialevel2' | Write-Debug
...
function ConvertFrom-JsonToProvisioningcriterialevel2 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.DimensionsV1 => Provisioningcriterialevel2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

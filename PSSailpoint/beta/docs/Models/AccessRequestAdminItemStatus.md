...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessRequestAdminItemStatus', 'BetaAccessRequestAdminItemStatus'] 
slug: /tools/sdk/powershell/beta/models/access-request-admin-item-status
...
```powershell
$AccessRequestAdminItemStatus = Initialize-BetaAccessRequestAdminItemStatus  -Id 2c9180926cbfbddd016cbfc7c3b10010 `
 -Name AccessProfile1 `
 -Type ACCESS_PROFILE `

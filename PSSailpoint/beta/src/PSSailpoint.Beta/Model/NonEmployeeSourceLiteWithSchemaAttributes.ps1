...
function Initialize-BetaNonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

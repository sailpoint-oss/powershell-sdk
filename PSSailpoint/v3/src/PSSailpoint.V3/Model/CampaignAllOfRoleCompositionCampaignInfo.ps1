...
function Initialize-CampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
...
function ConvertFrom-JsonToCampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

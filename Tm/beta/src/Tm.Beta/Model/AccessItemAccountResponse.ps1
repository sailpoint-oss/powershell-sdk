...
function Initialize-BetaAccessItemAccountResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccessItemAccountResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessItemAccountResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccessItemAccountResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

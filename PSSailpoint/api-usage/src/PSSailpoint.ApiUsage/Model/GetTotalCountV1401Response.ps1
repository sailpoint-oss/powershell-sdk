...
GetTotalCountV1401Response<PSCustomObject>
#>

function Initialize-GetTotalCountV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to GetTotalCountV1401Response<PSCustomObject>
...
GetTotalCountV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetTotalCountV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in GetTotalCountV1401Response
        $AllProperties = ("error")

...
function Initialize-Spconfigexportjob {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigexportjob' | Write-Debug
...
Spconfigexportjob<PSCustomObject>
#>
function ConvertFrom-JsonToSpconfigexportjob {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SpConfigV1 => Spconfigexportjob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Spconfigexportjob

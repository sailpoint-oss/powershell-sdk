...
function Initialize-BetaViolationOwnerAssignmentConfigOwnerRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaViolationOwnerAssignmentConfigOwnerRef' | Write-Debug
...
function ConvertFrom-BetaJsonToViolationOwnerAssignmentConfigOwnerRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaViolationOwnerAssignmentConfigOwnerRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

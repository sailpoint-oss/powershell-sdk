...
function Initialize-AttributeValueDTO {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessModelMetadata => AttributeValueDTO' | Write-Debug
...
function ConvertFrom-JsonToAttributeValueDTO {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessModelMetadata => AttributeValueDTO' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

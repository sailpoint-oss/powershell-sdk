...
function Initialize-V2024ConnectedObject {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ConnectedObject' | Write-Debug
...
function ConvertFrom-V2024JsonToConnectedObject {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ConnectedObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

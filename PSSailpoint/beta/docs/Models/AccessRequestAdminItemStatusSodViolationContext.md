...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessRequestAdminItemStatusSodViolationContext', 'BetaAccessRequestAdminItemStatusSodViolationContext'] 
slug: /tools/sdk/powershell/beta/models/access-request-admin-item-status-sod-violation-context
...
```powershell
$AccessRequestAdminItemStatusSodViolationContext = Initialize-BetaAccessRequestAdminItemStatusSodViolationContext  -State SUCCESS `

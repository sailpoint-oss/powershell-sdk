...
keywords: ['powershell', 'PowerShell', 'sdk', 'ApprovalSchemeForRole', 'V2026ApprovalSchemeForRole'] 
slug: /tools/sdk/powershell/v2026/models/approval-scheme-for-role
...
```powershell
$ApprovalSchemeForRole = Initialize-V2026ApprovalSchemeForRole  -ApproverType GOVERNANCE_GROUP `

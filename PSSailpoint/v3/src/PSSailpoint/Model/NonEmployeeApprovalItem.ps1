...
function Initialize-NonEmployeeApprovalItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => NonEmployeeApprovalItem' | Write-Debug
...
function ConvertFrom-JsonToNonEmployeeApprovalItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => NonEmployeeApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

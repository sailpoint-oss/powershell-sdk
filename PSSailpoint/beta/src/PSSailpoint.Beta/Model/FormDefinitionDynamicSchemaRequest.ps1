...
function Initialize-BetaFormDefinitionDynamicSchemaRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionDynamicSchemaRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToFormDefinitionDynamicSchemaRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaFormDefinitionDynamicSchemaRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

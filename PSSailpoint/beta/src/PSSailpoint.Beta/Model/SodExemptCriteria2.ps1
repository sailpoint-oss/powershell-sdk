...
SodExemptCriteria2<PSCustomObject>
#>

function Initialize-BetaSodExemptCriteria2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSodExemptCriteria2' | Write-Debug
...
Convert from JSON to SodExemptCriteria2<PSCustomObject>
...
SodExemptCriteria2<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSodExemptCriteria2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSodExemptCriteria2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSodExemptCriteria2

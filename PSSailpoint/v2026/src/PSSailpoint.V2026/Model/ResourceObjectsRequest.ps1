...
function Initialize-V2026ResourceObjectsRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ResourceObjectsRequest' | Write-Debug
...
ResourceObjectsRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToResourceObjectsRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ResourceObjectsRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ResourceObjectsRequest

...
#>
function ConvertFrom-V2025JsonToReportDetailsArguments {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToAccountsExportReportArguments $Json
                ...
                Write-Debug "Failed to match 'AccountsExportReportArguments' defined in anyOf (V2025ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToIdentitiesDetailsReportArguments $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'IdentitiesDetailsReportArguments' defined in anyOf (V2025ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToIdentitiesReportArguments $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'IdentitiesReportArguments' defined in anyOf (V2025ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToIdentityProfileIdentityErrorReportArguments $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'IdentityProfileIdentityErrorReportArguments' defined in anyOf (V2025ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToOrphanIdentitiesReportArguments $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'OrphanIdentitiesReportArguments' defined in anyOf (V2025ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToSearchExportReportArguments $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'SearchExportReportArguments' defined in anyOf (V2025ReportDetailsArguments). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2025JsonToUncorrelatedAccountsReportArguments $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'UncorrelatedAccountsReportArguments' defined in anyOf (V2025ReportDetailsArguments). Proceeding to the next one if any."
            }
        }

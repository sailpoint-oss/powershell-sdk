#
# Module manifest for module 'PSSailpoint.WorkItemsV1'
#
...
RootModule = 'PSSailpoint.WorkItemsV1.psm1'
...
GUID = '1535fc5c-f687-48dd-52a9-4253855345f3'
...
Description = 'PSSailpoint.WorkItemsV1 - the PowerShell module for Identity Security Cloud API - Work Items'
...
FunctionsToExport = 'Approve-ApprovalItemV1', 'Approve-ApprovalItemsInBulkV1', 
               'Complete-WorkItemV1', 'Invoke-ForwardWorkItemV1', 
               'Get-CompletedWorkItemsV1', 'Get-CountCompletedWorkItemsV1', 
               'Get-CountWorkItemsV1', 'Get-WorkItemV1', 'Get-WorkItemsSummaryV1', 
               'Get-WorkItemsV1', 'Deny-ApprovalItemV1', 
               'Deny-ApprovalItemsInBulkV1', 'Submit-AccountSelectionV1', 

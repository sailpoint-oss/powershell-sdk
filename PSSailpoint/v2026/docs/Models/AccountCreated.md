...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountCreated', 'V2026AccountCreated'] 
slug: /tools/sdk/powershell/v2026/models/account-created
...
```powershell
$AccountCreated = Initialize-V2026AccountCreated  -VarEvent null `
 -Source null `
 -Account null `
 -Identity null
```

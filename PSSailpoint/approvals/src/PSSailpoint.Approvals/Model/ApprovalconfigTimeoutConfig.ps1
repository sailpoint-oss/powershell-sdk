...
function Initialize-ApprovalconfigTimeoutConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ApprovalsV1 => ApprovalconfigTimeoutConfig' | Write-Debug
...
ApprovalconfigTimeoutConfig<PSCustomObject>
#>
function ConvertFrom-JsonToApprovalconfigTimeoutConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ApprovalsV1 => ApprovalconfigTimeoutConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApprovalconfigTimeoutConfig

...
function Initialize-V2024OwnerReferenceSegments {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024OwnerReferenceSegments' | Write-Debug
...
OwnerReferenceSegments<PSCustomObject>
#>
function ConvertFrom-V2024JsonToOwnerReferenceSegments {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024OwnerReferenceSegments' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024OwnerReferenceSegments

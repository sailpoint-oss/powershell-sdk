...
keywords: ['powershell', 'PowerShell', 'sdk', 'ConnectorRuleManagement', 'V2026ConnectorRuleManagement'] 
slug: /tools/sdk/powershell/v2026/methods/connector-rule-management
...
------------- | ------------- | -------------
[**New-V2026ConnectorRule**](#create-connector-rule) | **POST** `/connector-rules` | Create connector rule
[**Remove-V2026ConnectorRule**](#delete-connector-rule) | **DELETE** `/connector-rules/{id}` | Delete connector rule
[**Get-V2026ConnectorRule**](#get-connector-rule) | **GET** `/connector-rules/{id}` | Get connector rule
[**Get-V2026ConnectorRuleList**](#get-connector-rule-list) | **GET** `/connector-rules` | List connector rules
[**Send-V2026ConnectorRule**](#put-connector-rule) | **PUT** `/connector-rules/{id}` | Update connector rule
[**Test-V2026ConnectorRule**](#test-connector-rule) | **POST** `/connector-rules/validate` | Validate connector rule
...
try {
    $Result = ConvertFrom-V2026JsonToConnectorRuleCreateRequest -Json $ConnectorRuleCreateRequest
    New-V2026ConnectorRule -ConnectorRuleCreateRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026ConnectorRule -ConnectorRuleCreateRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026ConnectorRule"
...
try {
    Remove-V2026ConnectorRule -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026ConnectorRule -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026ConnectorRule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ConnectorRule -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ConnectorRule -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ConnectorRule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026ConnectorRuleList 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ConnectorRuleList -Limit $Limit -Offset $Offset -Count $Count  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ConnectorRuleList"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Send-V2026ConnectorRule -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Send-V2026ConnectorRule -Id $Id -ConnectorRuleUpdateRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026ConnectorRule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSourceCode -Json $SourceCode
    Test-V2026ConnectorRule -SourceCode $Result 
    
    # Below is a request that includes all optional parameters
    # Test-V2026ConnectorRule -SourceCode $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Test-V2026ConnectorRule"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

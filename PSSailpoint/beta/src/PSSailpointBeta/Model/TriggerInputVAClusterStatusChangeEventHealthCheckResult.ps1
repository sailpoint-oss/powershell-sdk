...
TriggerInputVAClusterStatusChangeEventHealthCheckResult<PSCustomObject>
#>

function Initialize-BetaTriggerInputVAClusterStatusChangeEventHealthCheckResult {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputVAClusterStatusChangeEventHealthCheckResult' | Write-Debug
...
Convert from JSON to TriggerInputVAClusterStatusChangeEventHealthCheckResult<PSCustomObject>
...
TriggerInputVAClusterStatusChangeEventHealthCheckResult<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputVAClusterStatusChangeEventHealthCheckResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputVAClusterStatusChangeEventHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputVAClusterStatusChangeEventHealthCheckResult

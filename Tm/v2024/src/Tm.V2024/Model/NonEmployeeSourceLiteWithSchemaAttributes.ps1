...
function Initialize-V2024NonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeSourceLiteWithSchemaAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024NonEmployeeSourceLiteWithSchemaAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

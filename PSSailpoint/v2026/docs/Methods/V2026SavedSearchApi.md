...
keywords: ['powershell', 'PowerShell', 'sdk', 'SavedSearch', 'V2026SavedSearch'] 
slug: /tools/sdk/powershell/v2026/methods/saved-search
...
------------- | ------------- | -------------
[**New-V2026SavedSearch**](#create-saved-search) | **POST** `/saved-searches` | Create a saved search
[**Remove-V2026SavedSearch**](#delete-saved-search) | **DELETE** `/saved-searches/{id}` | Delete document by id
[**Invoke-V2026ExecuteSavedSearch**](#execute-saved-search) | **POST** `/saved-searches/{id}/execute` | Execute a saved search by id
[**Get-V2026SavedSearch**](#get-saved-search) | **GET** `/saved-searches/{id}` | Return saved search by id
[**Get-V2026SavedSearches**](#list-saved-searches) | **GET** `/saved-searches` | A list of saved searches
[**Send-V2026SavedSearch**](#put-saved-search) | **PUT** `/saved-searches/{id}` | Updates an existing saved search 
...
try {
    $Result = ConvertFrom-V2026JsonToCreateSavedSearchRequest -Json $CreateSavedSearchRequest
    New-V2026SavedSearch -CreateSavedSearchRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026SavedSearch -CreateSavedSearchRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026SavedSearch"
...
try {
    Remove-V2026SavedSearch -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026SavedSearch -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026SavedSearch"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSearchArguments -Json $SearchArguments
    Invoke-V2026ExecuteSavedSearch -Id $Id -SearchArguments $Result 
    
    # Below is a request that includes all optional parameters
    # Invoke-V2026ExecuteSavedSearch -Id $Id -SearchArguments $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Invoke-V2026ExecuteSavedSearch"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SavedSearch -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SavedSearch -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SavedSearch"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026SavedSearches 
    
    # Below is a request that includes all optional parameters
    # Get-V2026SavedSearches -Offset $Offset -Limit $Limit -Count $Count -Filters $Filters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026SavedSearches"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToSavedSearch -Json $SavedSearch
    Send-V2026SavedSearch -Id $Id -SavedSearch $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2026SavedSearch -Id $Id -SavedSearch $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2026SavedSearch"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

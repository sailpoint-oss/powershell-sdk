...
function Initialize-Templatedtodefault {
    [CmdletBinding()]
    Param (
...
Templatedtodefault<PSCustomObject>
#>
function ConvertFrom-JsonToTemplatedtodefault {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Templatedtodefault

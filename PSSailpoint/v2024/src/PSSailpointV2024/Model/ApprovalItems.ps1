...
function Initialize-V2024ApprovalItems {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ApprovalItems' | Write-Debug
...
function ConvertFrom-V2024JsonToApprovalItems {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ApprovalItems' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

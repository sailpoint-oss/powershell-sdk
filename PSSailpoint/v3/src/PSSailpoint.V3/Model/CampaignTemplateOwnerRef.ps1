...
function Initialize-CampaignTemplateOwnerRef {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CampaignTemplateOwnerRef' | Write-Debug
...
function ConvertFrom-JsonToCampaignTemplateOwnerRef {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CampaignTemplateOwnerRef' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

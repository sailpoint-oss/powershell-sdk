...
function Initialize-V2024IdentityAttributePreview {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityAttributePreview' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityAttributePreview {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityAttributePreview' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

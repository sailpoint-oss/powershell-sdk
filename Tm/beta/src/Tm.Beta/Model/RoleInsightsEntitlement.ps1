...
function Initialize-BetaRoleInsightsEntitlement {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleInsightsEntitlement' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleInsightsEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleInsightsEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

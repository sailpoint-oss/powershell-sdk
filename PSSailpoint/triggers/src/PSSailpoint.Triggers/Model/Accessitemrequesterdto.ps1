...
function Initialize-Accessitemrequesterdto {
    [CmdletBinding()]
    Param (
...
Accessitemrequesterdto<PSCustomObject>
#>
function ConvertFrom-JsonToAccessitemrequesterdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Accessitemrequesterdto

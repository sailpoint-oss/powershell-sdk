...
function Get-OrgConfigV1 {
    ...
    Process {
        'Calling method: Get-OrgConfigV1' | Write-Debug
...
function Get-ValidTimeZonesV1 {
    ...
    Process {
        'Calling method: Get-ValidTimeZonesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/org-config/v1/valid-time-zones'

        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling getValidTimeZonesV1."
        }
...
function Update-OrgConfigV1 {
    ...
    Process {
        'Calling method: Update-OrgConfigV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$JsonPatchOperation) {
            throw "Error! The required parameter `JsonPatchOperation` missing when calling patchOrgConfigV1."
        }

...
function Initialize-V2024RoleInsightsEntitlementChanges {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleInsightsEntitlementChanges' | Write-Debug
...
RoleInsightsEntitlementChanges<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRoleInsightsEntitlementChanges {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleInsightsEntitlementChanges' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RoleInsightsEntitlementChanges

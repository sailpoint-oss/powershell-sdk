...
function Initialize-V2025RoleMetadataBulkUpdateByIdRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleMetadataBulkUpdateByIdRequest' | Write-Debug
...
RoleMetadataBulkUpdateByIdRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleMetadataBulkUpdateByIdRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleMetadataBulkUpdateByIdRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleMetadataBulkUpdateByIdRequest

...
function Initialize-V2026PutConnectorSourceTemplateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026PutConnectorSourceTemplateRequest' | Write-Debug
...
PutConnectorSourceTemplateRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToPutConnectorSourceTemplateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026PutConnectorSourceTemplateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026PutConnectorSourceTemplateRequest
        $AllProperties = ("file")

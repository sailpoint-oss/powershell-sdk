...
keywords: ['powershell', 'PowerShell', 'sdk', 'SearchCriteriaTextQuery', 'V2026SearchCriteriaTextQuery'] 
slug: /tools/sdk/powershell/v2026/models/search-criteria-text-query
...
```powershell
$SearchCriteriaTextQuery = Initialize-V2026SearchCriteriaTextQuery  -Terms [admin, user] `
 -Fields [role, name] `
 -MatchAny true
```

...
function Initialize-ViolationOwnerAssignmentConfig {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => ViolationOwnerAssignmentConfig' | Write-Debug
...
function ConvertFrom-JsonToViolationOwnerAssignmentConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => ViolationOwnerAssignmentConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

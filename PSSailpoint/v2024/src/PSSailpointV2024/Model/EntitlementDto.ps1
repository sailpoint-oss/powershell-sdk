...
function Initialize-V2024EntitlementDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024EntitlementDto' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlementDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024EntitlementDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

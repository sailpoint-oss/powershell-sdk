...
TriggerInputIdentityCreated<PSCustomObject>
#>

function Initialize-BetaTriggerInputIdentityCreated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputIdentityCreated' | Write-Debug
...
Convert from JSON to TriggerInputIdentityCreated<PSCustomObject>
...
TriggerInputIdentityCreated<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputIdentityCreated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputIdentityCreated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputIdentityCreated

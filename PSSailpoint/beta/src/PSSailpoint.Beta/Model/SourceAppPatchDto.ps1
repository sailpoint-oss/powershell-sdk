...
function Initialize-BetaSourceAppPatchDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceAppPatchDto' | Write-Debug
...
SourceAppPatchDto<PSCustomObject>
#>
function ConvertFrom-BetaJsonToSourceAppPatchDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceAppPatchDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaSourceAppPatchDto

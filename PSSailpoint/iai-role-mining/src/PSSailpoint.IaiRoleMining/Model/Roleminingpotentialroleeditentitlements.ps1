...
function Initialize-Roleminingpotentialroleeditentitlements {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingpotentialroleeditentitlements' | Write-Debug
...
Roleminingpotentialroleeditentitlements<PSCustomObject>
#>
function ConvertFrom-JsonToRoleminingpotentialroleeditentitlements {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiRoleMiningV1 => Roleminingpotentialroleeditentitlements' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Roleminingpotentialroleeditentitlements

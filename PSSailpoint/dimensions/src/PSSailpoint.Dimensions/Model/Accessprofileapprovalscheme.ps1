...
function Initialize-Accessprofileapprovalscheme {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Dimensions => Accessprofileapprovalscheme' | Write-Debug
...
function ConvertFrom-JsonToAccessprofileapprovalscheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Dimensions => Accessprofileapprovalscheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

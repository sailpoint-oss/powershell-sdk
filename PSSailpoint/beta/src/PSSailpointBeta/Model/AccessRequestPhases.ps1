...
function Initialize-BetaAccessRequestPhases {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaAccessRequestPhases' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessRequestPhases {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaAccessRequestPhases' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

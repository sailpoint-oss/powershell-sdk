...
function ConvertFrom-V2024JsonToGetRoleAssignments200ResponseInner {
    ...
    Process {
        ...
        if ($match -eq 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2024JsonToRoleAssignmentDto $Json
                ...
                Write-Debug "Failed to match 'RoleAssignmentDto' defined in anyOf (V2024GetRoleAssignments200ResponseInner). Proceeding to the next one if any."
            }
        }
        ...
        if ($match -eq 0) { # no match yet
            ...
            try {
                $matchInstance = ConvertFrom-V2024JsonToRoleAssignmentRef $Json
                ...
                # fail to match the schema defined in anyOf, proceed to the next one
                Write-Debug "Failed to match 'RoleAssignmentRef' defined in anyOf (V2024GetRoleAssignments200ResponseInner). Proceeding to the next one if any."
            }
        }

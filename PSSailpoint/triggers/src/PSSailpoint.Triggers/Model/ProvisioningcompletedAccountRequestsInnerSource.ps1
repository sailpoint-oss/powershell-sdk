...
function Initialize-ProvisioningcompletedAccountRequestsInnerSource {
    [CmdletBinding()]
    Param (
...
ProvisioningcompletedAccountRequestsInnerSource<PSCustomObject>
#>
function ConvertFrom-JsonToProvisioningcompletedAccountRequestsInnerSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ProvisioningcompletedAccountRequestsInnerSource

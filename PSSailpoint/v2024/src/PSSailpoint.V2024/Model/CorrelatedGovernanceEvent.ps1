...
function Initialize-V2024CorrelatedGovernanceEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024CorrelatedGovernanceEvent' | Write-Debug
...
CorrelatedGovernanceEvent<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCorrelatedGovernanceEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024CorrelatedGovernanceEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024CorrelatedGovernanceEvent

...
function Initialize-BetaSimIntegrationDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaSimIntegrationDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToSimIntegrationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaSimIntegrationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Schedule2Months {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationCampaigns => Schedule2Months' | Write-Debug
...
function ConvertFrom-JsonToSchedule2Months {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationCampaigns => Schedule2Months' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

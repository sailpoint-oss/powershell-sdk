...
function Initialize-Errormessagedto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SimIntegrationsV1 => Errormessagedto' | Write-Debug
...
function ConvertFrom-JsonToErrormessagedto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SimIntegrationsV1 => Errormessagedto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

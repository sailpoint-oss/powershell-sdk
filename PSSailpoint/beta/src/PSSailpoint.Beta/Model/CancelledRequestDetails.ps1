...
function Initialize-BetaCancelledRequestDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCancelledRequestDetails' | Write-Debug
...
CancelledRequestDetails<PSCustomObject>
#>
function ConvertFrom-BetaJsonToCancelledRequestDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCancelledRequestDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaCancelledRequestDetails

...
function Initialize-V2024SetIconRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024SetIconRequest' | Write-Debug
...
SetIconRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToSetIconRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024SetIconRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024SetIconRequest
        $AllProperties = ("image")

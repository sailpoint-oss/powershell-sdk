...
function Initialize-V2024FederationProtocolDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024FederationProtocolDetails' | Write-Debug
...
FederationProtocolDetails<PSCustomObject>
#>
function ConvertFrom-V2024JsonToFederationProtocolDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024FederationProtocolDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024FederationProtocolDetails

...
function Initialize-BetaFormDefinitionDynamicSchemaRequestAttributes {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaFormDefinitionDynamicSchemaRequestAttributes' | Write-Debug
...
function ConvertFrom-BetaJsonToFormDefinitionDynamicSchemaRequestAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaFormDefinitionDynamicSchemaRequestAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

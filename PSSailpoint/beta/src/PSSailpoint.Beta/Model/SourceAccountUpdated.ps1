...
function Initialize-BetaSourceAccountUpdated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSourceAccountUpdated' | Write-Debug
...
function ConvertFrom-BetaJsonToSourceAccountUpdated {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSourceAccountUpdated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

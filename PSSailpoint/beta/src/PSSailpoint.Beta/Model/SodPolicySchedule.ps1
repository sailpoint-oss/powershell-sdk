...
function Initialize-BetaSodPolicySchedule {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSodPolicySchedule' | Write-Debug
...
function ConvertFrom-BetaJsonToSodPolicySchedule {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSodPolicySchedule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

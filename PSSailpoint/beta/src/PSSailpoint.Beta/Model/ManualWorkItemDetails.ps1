...
function Initialize-BetaManualWorkItemDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaManualWorkItemDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToManualWorkItemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaManualWorkItemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

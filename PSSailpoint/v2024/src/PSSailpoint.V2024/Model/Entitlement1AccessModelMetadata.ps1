...
function Initialize-V2024Entitlement1AccessModelMetadata {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Entitlement1AccessModelMetadata' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlement1AccessModelMetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Entitlement1AccessModelMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

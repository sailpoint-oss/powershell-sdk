...
keywords: ['powershell', 'PowerShell', 'sdk', 'IdentityWithNewAccess', 'V2026IdentityWithNewAccess'] 
slug: /tools/sdk/powershell/v2026/models/identity-with-new-access
...
```powershell
$IdentityWithNewAccess = Initialize-V2026IdentityWithNewAccess  -IdentityId 2c91808568c529c60168cca6f90c1313 `

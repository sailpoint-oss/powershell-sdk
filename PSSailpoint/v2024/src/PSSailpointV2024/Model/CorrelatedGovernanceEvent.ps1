...
function Initialize-V2024CorrelatedGovernanceEvent {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CorrelatedGovernanceEvent' | Write-Debug
...
function ConvertFrom-V2024JsonToCorrelatedGovernanceEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CorrelatedGovernanceEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024AccountAggregationCompleted {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccountAggregationCompleted' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAggregationCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccountAggregationCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

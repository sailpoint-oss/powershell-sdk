...
function Initialize-MachineIdentityUserEntitlementResponseEntitlement {
    [CmdletBinding()]
    Param (
...
MachineIdentityUserEntitlementResponseEntitlement<PSCustomObject>
#>
function ConvertFrom-JsonToMachineIdentityUserEntitlementResponseEntitlement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in MachineIdentityUserEntitlementResponseEntitlement

...
keywords: ['powershell', 'PowerShell', 'sdk', 'PendingApproval', 'V2026PendingApproval'] 
slug: /tools/sdk/powershell/v2026/models/pending-approval
...
```powershell
$PendingApproval = Initialize-V2026PendingApproval  -Id id12345 `

...
function Initialize-BetaIdentityAttributesChangedChangesInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaIdentityAttributesChangedChangesInner' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityAttributesChangedChangesInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaIdentityAttributesChangedChangesInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

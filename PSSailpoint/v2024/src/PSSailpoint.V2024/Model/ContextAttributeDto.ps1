...
function Initialize-V2024ContextAttributeDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ContextAttributeDto' | Write-Debug
...
function ConvertFrom-V2024JsonToContextAttributeDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ContextAttributeDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

#
# Module manifest for module 'PSSailpoint.RoleInsightsV1'
#
...
RootModule = 'PSSailpoint.RoleInsightsV1.psm1'
...
GUID = '1ec17571-25a0-8817-d6ed-7f7ebbde8941'
...
Description = 'PSSailpoint.RoleInsightsV1 - the PowerShell module for Identity Security Cloud API - Role Insights'
...
FunctionsToExport = 'New-RoleInsightRequestsV1', 
               'Invoke-DownloadRoleInsightsEntitlementsChangesV1', 
               'Get-EntitlementChangesIdentitiesV1', 'Get-RoleInsightV1', 
               'Get-RoleInsightsCurrentEntitlementsV1', 
               'Get-RoleInsightsEntitlementsChangesV1', 
               'Get-RoleInsightsRequestsV1', 'Get-RoleInsightsSummaryV1', 
               'Get-RoleInsightsV1', 'Get-Configuration', 'Set-Configuration', 
               ...
               'Initialize-CreateRoleInsightRequestsV1401Response', 

...
keywords: ['powershell', 'PowerShell', 'sdk', 'ReportResultReference', 'V2026ReportResultReference'] 
slug: /tools/sdk/powershell/v2026/models/report-result-reference
...
```powershell
$ReportResultReference = Initialize-V2026ReportResultReference  -Type REPORT_RESULT `

...
function Initialize-BetaCompletedApprovalReviewerComment {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaCompletedApprovalReviewerComment' | Write-Debug
...
function ConvertFrom-BetaJsonToCompletedApprovalReviewerComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaCompletedApprovalReviewerComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2025AccessItemRemoved {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccessItemRemoved' | Write-Debug
...
AccessItemRemoved<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccessItemRemoved {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccessItemRemoved' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccessItemRemoved

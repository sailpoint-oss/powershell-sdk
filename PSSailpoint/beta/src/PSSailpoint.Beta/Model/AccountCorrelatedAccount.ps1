...
function Initialize-BetaAccountCorrelatedAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountCorrelatedAccount' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountCorrelatedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountCorrelatedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

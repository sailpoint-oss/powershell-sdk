...
TriggerInputCampaignActivatedCampaign<PSCustomObject>
#>

function Initialize-BetaTriggerInputCampaignActivatedCampaign {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputCampaignActivatedCampaign' | Write-Debug
...
Convert from JSON to TriggerInputCampaignActivatedCampaign<PSCustomObject>
...
TriggerInputCampaignActivatedCampaign<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputCampaignActivatedCampaign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputCampaignActivatedCampaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputCampaignActivatedCampaign

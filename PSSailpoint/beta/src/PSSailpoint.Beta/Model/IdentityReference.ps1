...
function Initialize-BetaIdentityReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityReference' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

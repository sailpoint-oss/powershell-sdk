...
function Initialize-V2026CommonAccessItemResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CommonAccessItemResponse' | Write-Debug
...
CommonAccessItemResponse<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCommonAccessItemResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CommonAccessItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CommonAccessItemResponse

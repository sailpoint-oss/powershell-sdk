...
function Initialize-BetaAccountAttributesChangedAccount {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesChangedAccount' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesChangedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccountAttributesChangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

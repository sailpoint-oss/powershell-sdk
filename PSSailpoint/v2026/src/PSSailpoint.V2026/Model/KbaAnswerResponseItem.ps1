...
function Initialize-V2026KbaAnswerResponseItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026KbaAnswerResponseItem' | Write-Debug
...
KbaAnswerResponseItem<PSCustomObject>
#>
function ConvertFrom-V2026JsonToKbaAnswerResponseItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026KbaAnswerResponseItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026KbaAnswerResponseItem

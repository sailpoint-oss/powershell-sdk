...
keywords: ['powershell', 'PowerShell', 'sdk', 'ServiceDeskIntegrationTemplateType', 'V2026ServiceDeskIntegrationTemplateType'] 
slug: /tools/sdk/powershell/v2026/models/service-desk-integration-template-type
...
```powershell
$ServiceDeskIntegrationTemplateType = Initialize-V2026ServiceDeskIntegrationTemplateType  -Name aName `
 -Type aType `

...
function Initialize-BetaNonEmployeeApprovalItemBase {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaNonEmployeeApprovalItemBase' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeApprovalItemBase {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaNonEmployeeApprovalItemBase' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024PublicIdentity {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PublicIdentity' | Write-Debug
...
function ConvertFrom-V2024JsonToPublicIdentity {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PublicIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-BetaManagerCorrelationMapping {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaManagerCorrelationMapping' | Write-Debug
...
function ConvertFrom-BetaJsonToManagerCorrelationMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024NonEmployeeRequestWithoutApprovalItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeRequestWithoutApprovalItem' | Write-Debug
...
NonEmployeeRequestWithoutApprovalItem<PSCustomObject>
#>
function ConvertFrom-V2024JsonToNonEmployeeRequestWithoutApprovalItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024NonEmployeeRequestWithoutApprovalItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024NonEmployeeRequestWithoutApprovalItem

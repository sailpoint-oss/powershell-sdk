...
function Initialize-BetaSodViolationContextCheckCompleted1 {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaSodViolationContextCheckCompleted1' | Write-Debug
...
function ConvertFrom-BetaJsonToSodViolationContextCheckCompleted1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaSodViolationContextCheckCompleted1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Outlierfeaturesummary {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiOutliersV1 => Outlierfeaturesummary' | Write-Debug
...
Outlierfeaturesummary<PSCustomObject>
#>
function ConvertFrom-JsonToOutlierfeaturesummary {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiOutliersV1 => Outlierfeaturesummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Outlierfeaturesummary

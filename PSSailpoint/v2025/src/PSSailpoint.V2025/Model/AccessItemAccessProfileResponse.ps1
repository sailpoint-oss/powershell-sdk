...
function Initialize-V2025AccessItemAccessProfileResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025AccessItemAccessProfileResponse' | Write-Debug
...
AccessItemAccessProfileResponse<PSCustomObject>
#>
function ConvertFrom-V2025JsonToAccessItemAccessProfileResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025AccessItemAccessProfileResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025AccessItemAccessProfileResponse

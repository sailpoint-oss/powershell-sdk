...
function Initialize-V2024CreateFormInstanceRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CreateFormInstanceRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToCreateFormInstanceRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CreateFormInstanceRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

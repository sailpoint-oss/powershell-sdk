...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessProfileUsage', 'V2026AccessProfileUsage'] 
slug: /tools/sdk/powershell/v2026/models/access-profile-usage
...
```powershell
$AccessProfileUsage = Initialize-V2026AccessProfileUsage  -AccessProfileId 2c91808876438bbb017668c21919ecca `
 -UsedBy null
```

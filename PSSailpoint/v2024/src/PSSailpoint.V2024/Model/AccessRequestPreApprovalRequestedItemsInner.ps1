...
function Initialize-V2024AccessRequestPreApprovalRequestedItemsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestPreApprovalRequestedItemsInner' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestPreApprovalRequestedItemsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestPreApprovalRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

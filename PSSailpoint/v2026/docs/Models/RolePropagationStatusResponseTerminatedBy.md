...
keywords: ['powershell', 'PowerShell', 'sdk', 'RolePropagationStatusResponseTerminatedBy', 'V2026RolePropagationStatusResponseTerminatedBy'] 
slug: /tools/sdk/powershell/v2026/models/role-propagation-status-response-terminated-by
...
```powershell
$RolePropagationStatusResponseTerminatedBy = Initialize-V2026RolePropagationStatusResponseTerminatedBy  -Type IDENTITY `

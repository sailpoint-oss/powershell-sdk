...
function Initialize-V2024UUIDGenerator {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024UUIDGenerator' | Write-Debug
...
function ConvertFrom-V2024JsonToUUIDGenerator {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024UUIDGenerator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

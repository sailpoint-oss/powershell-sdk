...
function Initialize-BetaCampaignActivated {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCampaignActivated' | Write-Debug
...
CampaignActivated<PSCustomObject>
#>
function ConvertFrom-BetaJsonToCampaignActivated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCampaignActivated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaCampaignActivated

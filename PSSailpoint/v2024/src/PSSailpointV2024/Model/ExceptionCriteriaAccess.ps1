...
function Initialize-V2024ExceptionCriteriaAccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ExceptionCriteriaAccess' | Write-Debug
...
function ConvertFrom-V2024JsonToExceptionCriteriaAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ExceptionCriteriaAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

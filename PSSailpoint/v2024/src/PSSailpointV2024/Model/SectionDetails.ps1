...
function Initialize-V2024SectionDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SectionDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToSectionDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SectionDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024CampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignAllOfRoleCompositionCampaignInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CampaignAllOfRoleCompositionCampaignInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

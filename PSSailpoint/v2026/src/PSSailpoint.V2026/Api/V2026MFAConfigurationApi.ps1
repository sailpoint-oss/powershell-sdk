...
MfaDuoConfig
#>
function Get-V2026MFADuoConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2026MFADuoConfig' | Write-Debug
...
KbaQuestion[]
#>
function Get-V2026MFAKbaConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2026MFAKbaConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MfaOktaConfig
#>
function Get-V2026MFAOktaConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2026MFAOktaConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MfaDuoConfig
#>
function Set-V2026MFADuoConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Set-V2026MFADuoConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Set-V2026MFAKBAConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject[]]
    ...
    Process {
        'Calling method: Set-V2026MFAKBAConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
MfaOktaConfig
#>
function Set-V2026MFAOktaConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Set-V2026MFAOktaConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Test-V2026MFAConfig {
    ...
    Process {
        'Calling method: Test-V2026MFAConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

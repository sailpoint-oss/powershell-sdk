...
function Initialize-V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox<PSCustomObject>
#>
function ConvertFrom-V2024JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationToolbox

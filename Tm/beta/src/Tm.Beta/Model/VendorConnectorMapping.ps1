...
function Initialize-BetaVendorConnectorMapping {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaVendorConnectorMapping' | Write-Debug
...
function ConvertFrom-BetaJsonToVendorConnectorMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaVendorConnectorMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

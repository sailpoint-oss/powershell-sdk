...
function Initialize-V2026SlimDiscoveredApplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SlimDiscoveredApplications' | Write-Debug
...
SlimDiscoveredApplications<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSlimDiscoveredApplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SlimDiscoveredApplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SlimDiscoveredApplications

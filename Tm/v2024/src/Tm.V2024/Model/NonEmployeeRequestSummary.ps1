...
function Initialize-V2024NonEmployeeRequestSummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024NonEmployeeRequestSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeRequestSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024NonEmployeeRequestSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ServiceProviderConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ServiceProviderConfiguration' | Write-Debug
...
ServiceProviderConfiguration<PSCustomObject>
#>
function ConvertFrom-V2024JsonToServiceProviderConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ServiceProviderConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ServiceProviderConfiguration

...
function Initialize-Accountactivityitem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccountActivitiesV1 => Accountactivityitem' | Write-Debug
...
Accountactivityitem<PSCustomObject>
#>
function ConvertFrom-JsonToAccountactivityitem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccountActivitiesV1 => Accountactivityitem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Accountactivityitem

...
function Initialize-ConditioneffectConfig {
    [CmdletBinding()]
    Param (
...
ConditioneffectConfig<PSCustomObject>
#>
function ConvertFrom-JsonToConditioneffectConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ConditioneffectConfig

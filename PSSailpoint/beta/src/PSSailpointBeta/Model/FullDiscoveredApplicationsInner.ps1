...
function Initialize-BetaFullDiscoveredApplicationsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaFullDiscoveredApplicationsInner' | Write-Debug
...
FullDiscoveredApplicationsInner<PSCustomObject>
#>
function ConvertFrom-BetaJsonToFullDiscoveredApplicationsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaFullDiscoveredApplicationsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaFullDiscoveredApplicationsInner

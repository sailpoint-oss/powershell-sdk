...
[**Get-V2025NotificationPreferences**](#get-notification-preferences) | **GET** `/notification-preferences/{key}` | List notification preferences for tenant.
...
try {
    ...
    New-V2025DomainDkim -DomainAddress $Result 
...
try {
    ...
    New-V2025NotificationTemplate -TemplateDto $Result 
...
try {
    ...
    New-V2025VerifiedFromAddress -EmailStatusDto $Result 
...
try {
    ...
    Remove-V2025NotificationTemplatesInBulk -TemplateBulkDeleteDto $Result 
...
try {
    Remove-V2025VerifiedFromAddress -Id $Id 
...
try {
    Get-V2025DkimAttributes 
    
    # Below is a request that includes all optional parameters
    # Get-V2025DkimAttributes -Limit $Limit -Offset $Offset  
} catch {
...
try {
    Get-V2025MailFromAttributes -Identity $Identity 
...
try {
    Get-V2025NotificationTemplate -Id $Id 
...
try {
    Get-V2025NotificationsTemplateContext 
...
try {
    Get-V2025FromAddresses 
    
    # Below is a request that includes all optional parameters
    # Get-V2025FromAddresses -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2025NotificationTemplateDefaults -Limit $Limit -Offset $Offset -Filters $Filters  
} catch {
...
try {
    Get-V2025NotificationTemplates 
    
    # Below is a request that includes all optional parameters
    # Get-V2025NotificationTemplates -Limit $Limit -Offset $Offset -Filters $Filters -Sorters $Sorters  
} catch {
...
try {
    ...
    Send-V2025MailFromAttributes -MailFromAttributesDto $Result 
...
try {
    ...
    Send-V2025TestNotification -SendTestNotificationRequestDto $Result 

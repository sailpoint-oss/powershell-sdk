...
function Initialize-V2026ServiceDeskIntegrationTemplateType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ServiceDeskIntegrationTemplateType' | Write-Debug
...
ServiceDeskIntegrationTemplateType<PSCustomObject>
#>
function ConvertFrom-V2026JsonToServiceDeskIntegrationTemplateType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ServiceDeskIntegrationTemplateType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ServiceDeskIntegrationTemplateType

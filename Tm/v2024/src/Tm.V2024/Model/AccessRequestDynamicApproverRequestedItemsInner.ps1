...
function Initialize-V2024AccessRequestDynamicApproverRequestedItemsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestDynamicApproverRequestedItemsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccessRequestDynamicApproverRequestedItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

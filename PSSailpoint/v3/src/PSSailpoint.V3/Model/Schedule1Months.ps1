...
function Initialize-Schedule1Months {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => Schedule1Months' | Write-Debug
...
Schedule1Months<PSCustomObject>
#>
function ConvertFrom-JsonToSchedule1Months {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => Schedule1Months' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Schedule1Months

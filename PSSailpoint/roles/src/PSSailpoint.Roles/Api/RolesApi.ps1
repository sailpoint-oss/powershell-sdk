...
function New-RoleV1 {
    ...
    Process {
        'Calling method: New-RoleV1' | Write-Debug
        ...
        $LocalVarUri = '/roles/v1'

        if (!$Role) {
            throw "Error! The required parameter `Role` missing when calling createRoleV1."
        }
...
function Remove-BulkRolesV1 {
    ...
    Process {
        'Calling method: Remove-BulkRolesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-MetadataFromRoleByKeyAndValueV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-MetadataFromRoleByKeyAndValueV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{id}/access-model-metadata/{attributeKey}/values/{attributeValue}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteMetadataFromRoleByKeyAndValueV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
        if (!$AttributeKey) {
            throw "Error! The required parameter `AttributeKey` missing when calling deleteMetadataFromRoleByKeyAndValueV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{attributeKey}', [System.Web.HTTPUtility]::UrlEncode($AttributeKey))
        if (!$AttributeValue) {
            throw "Error! The required parameter `AttributeValue` missing when calling deleteMetadataFromRoleByKeyAndValueV1."
        }
...
function Remove-RoleV1 {
    ...
    Process {
        'Calling method: Remove-RoleV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteRoleV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-BulkUpdateStatusByIdV1 {
    ...
    Process {
        'Calling method: Get-BulkUpdateStatusByIdV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/access-model-metadata/bulk-update/id'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getBulkUpdateStatusByIdV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-BulkUpdateStatusV1 {
    ...
    Process {
        'Calling method: Get-BulkUpdateStatusV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/access-model-metadata/bulk-update'
...
function Get-RoleAssignedIdentitiesV1 {
    ...
    Process {
        'Calling method: Get-RoleAssignedIdentitiesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{id}/assigned-identities'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getRoleAssignedIdentitiesV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
Entitlement[]
#>
function Get-RoleEntitlementsV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-RoleEntitlementsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{id}/entitlements'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getRoleEntitlementsV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$XSailPointExperimental) {
            throw "Error! The required parameter `XSailPointExperimental` missing when calling getRoleEntitlementsV1."
        }
...
function Get-RoleV1 {
    ...
    Process {
        'Calling method: Get-RoleV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getRoleV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-RolesV1 {
    ...
    Process {
        'Calling method: Get-RolesV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-RoleV1 {
    ...
    Process {
        'Calling method: Update-RoleV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling patchRoleV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
Role[]
#>
function Search-RolesByFilterV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Search-RolesByFilterV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Role
#>
function Update-AttributeKeyAndValueToRoleV1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-AttributeKeyAndValueToRoleV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/roles/v1/{id}/access-model-metadata/{attributeKey}/values/{attributeValue}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling updateAttributeKeyAndValueToRoleV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
        if (!$AttributeKey) {
            throw "Error! The required parameter `AttributeKey` missing when calling updateAttributeKeyAndValueToRoleV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{attributeKey}', [System.Web.HTTPUtility]::UrlEncode($AttributeKey))
        if (!$AttributeValue) {
            throw "Error! The required parameter `AttributeValue` missing when calling updateAttributeKeyAndValueToRoleV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{attributeValue}', [System.Web.HTTPUtility]::UrlEncode($AttributeValue))
...
function Update-RolesMetadataByFilterV1 {
    ...
    Process {
        'Calling method: Update-RolesMetadataByFilterV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-RolesMetadataByIdsV1 {
    ...
    Process {
        'Calling method: Update-RolesMetadataByIdsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-RolesMetadataByQueryV1 {
    ...
    Process {
        'Calling method: Update-RolesMetadataByQueryV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

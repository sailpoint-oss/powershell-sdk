...
function Initialize-BetaNonEmployeeRejectApprovalDecision {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaNonEmployeeRejectApprovalDecision' | Write-Debug
...
function ConvertFrom-BetaJsonToNonEmployeeRejectApprovalDecision {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaNonEmployeeRejectApprovalDecision' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Entitlementrequestconfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestsV1 => Entitlementrequestconfig' | Write-Debug
...
function ConvertFrom-JsonToEntitlementrequestconfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestsV1 => Entitlementrequestconfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

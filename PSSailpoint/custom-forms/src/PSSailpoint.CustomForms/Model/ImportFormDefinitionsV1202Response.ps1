...
ImportFormDefinitionsV1202Response<PSCustomObject>
#>

function Initialize-ImportFormDefinitionsV1202Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CustomFormsV1 => ImportFormDefinitionsV1202Response' | Write-Debug
...
Convert from JSON to ImportFormDefinitionsV1202Response<PSCustomObject>
...
ImportFormDefinitionsV1202Response<PSCustomObject>
#>
function ConvertFrom-JsonToImportFormDefinitionsV1202Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CustomFormsV1 => ImportFormDefinitionsV1202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ImportFormDefinitionsV1202Response

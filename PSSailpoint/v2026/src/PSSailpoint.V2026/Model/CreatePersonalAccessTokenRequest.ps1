...
function Initialize-V2026CreatePersonalAccessTokenRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026CreatePersonalAccessTokenRequest' | Write-Debug
...
CreatePersonalAccessTokenRequest<PSCustomObject>
#>
function ConvertFrom-V2026JsonToCreatePersonalAccessTokenRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026CreatePersonalAccessTokenRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026CreatePersonalAccessTokenRequest

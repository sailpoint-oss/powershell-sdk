...
function Initialize-BaseReferenceDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccountDeletionRequests => BaseReferenceDto' | Write-Debug
...
function ConvertFrom-JsonToBaseReferenceDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccountDeletionRequests => BaseReferenceDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

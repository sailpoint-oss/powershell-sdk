...
GetActiveCampaignsV1401Response<PSCustomObject>
#>

function Initialize-GetActiveCampaignsV1401Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to GetActiveCampaignsV1401Response<PSCustomObject>
...
GetActiveCampaignsV1401Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetActiveCampaignsV1401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in GetActiveCampaignsV1401Response
        $AllProperties = ("error")

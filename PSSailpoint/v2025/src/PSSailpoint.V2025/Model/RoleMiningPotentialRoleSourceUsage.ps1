...
function Initialize-V2025RoleMiningPotentialRoleSourceUsage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningPotentialRoleSourceUsage' | Write-Debug
...
RoleMiningPotentialRoleSourceUsage<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleMiningPotentialRoleSourceUsage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningPotentialRoleSourceUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleMiningPotentialRoleSourceUsage

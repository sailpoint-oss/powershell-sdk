...
function Initialize-CreateScheduledSearchRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => CreateScheduledSearchRequest' | Write-Debug
...
function ConvertFrom-JsonToCreateScheduledSearchRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => CreateScheduledSearchRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

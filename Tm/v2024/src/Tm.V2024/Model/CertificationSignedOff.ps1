...
function Initialize-V2024CertificationSignedOff {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024CertificationSignedOff' | Write-Debug
...
function ConvertFrom-V2024JsonToCertificationSignedOff {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024CertificationSignedOff' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026SpConfigExportJob {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026SpConfigExportJob' | Write-Debug
...
SpConfigExportJob<PSCustomObject>
#>
function ConvertFrom-V2026JsonToSpConfigExportJob {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026SpConfigExportJob' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026SpConfigExportJob

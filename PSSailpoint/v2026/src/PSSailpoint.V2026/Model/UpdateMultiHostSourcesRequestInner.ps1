...
function Initialize-V2026UpdateMultiHostSourcesRequestInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026UpdateMultiHostSourcesRequestInner' | Write-Debug
...
UpdateMultiHostSourcesRequestInner<PSCustomObject>
#>
function ConvertFrom-V2026JsonToUpdateMultiHostSourcesRequestInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026UpdateMultiHostSourcesRequestInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026UpdateMultiHostSourcesRequestInner

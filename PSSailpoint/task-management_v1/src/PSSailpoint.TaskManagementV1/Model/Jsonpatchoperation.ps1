...
function Initialize-Jsonpatchoperation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TaskManagementV1 => Jsonpatchoperation' | Write-Debug
...
function ConvertFrom-JsonToJsonpatchoperation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TaskManagementV1 => Jsonpatchoperation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

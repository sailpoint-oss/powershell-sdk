...
function Initialize-V2024NonEmployeeSourceWithCloudExternalId {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024NonEmployeeSourceWithCloudExternalId' | Write-Debug
...
function ConvertFrom-V2024JsonToNonEmployeeSourceWithCloudExternalId {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024NonEmployeeSourceWithCloudExternalId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Replace {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TransformsV1 => Replace' | Write-Debug
...
Replace<PSCustomObject>
#>
function ConvertFrom-JsonToReplace {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TransformsV1 => Replace' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Replace

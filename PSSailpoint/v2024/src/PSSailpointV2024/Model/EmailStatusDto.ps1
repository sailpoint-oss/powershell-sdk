...
function Initialize-V2024EmailStatusDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024EmailStatusDto' | Write-Debug
...
function ConvertFrom-V2024JsonToEmailStatusDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024EmailStatusDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-RequestabilityForRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => RequestabilityForRole' | Write-Debug
...
function ConvertFrom-JsonToRequestabilityForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => RequestabilityForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

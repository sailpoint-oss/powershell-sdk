...
function Initialize-BetaCertificationTask {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCertificationTask' | Write-Debug
...
function ConvertFrom-BetaJsonToCertificationTask {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCertificationTask' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

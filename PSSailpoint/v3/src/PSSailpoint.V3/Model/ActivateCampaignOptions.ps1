...
function Initialize-ActivateCampaignOptions {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => ActivateCampaignOptions' | Write-Debug
...
function ConvertFrom-JsonToActivateCampaignOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => ActivateCampaignOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

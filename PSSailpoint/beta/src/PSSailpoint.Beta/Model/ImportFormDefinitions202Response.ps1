...
function Initialize-BetaImportFormDefinitions202Response {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaImportFormDefinitions202Response' | Write-Debug
...
function ConvertFrom-BetaJsonToImportFormDefinitions202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaImportFormDefinitions202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

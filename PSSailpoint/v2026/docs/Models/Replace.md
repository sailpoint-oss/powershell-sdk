...
keywords: ['powershell', 'PowerShell', 'sdk', 'Replace', 'V2026Replace'] 
slug: /tools/sdk/powershell/v2026/models/replace
tags: ['SDK', 'Software Development Kit', 'Replace', 'V2026Replace']
---
...
```powershell
$Replace = Initialize-V2026Replace  -Regex [^a-zA-Z] `
 -Replacement   `

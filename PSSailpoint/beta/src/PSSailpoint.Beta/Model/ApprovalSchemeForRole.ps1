...
function Initialize-BetaApprovalSchemeForRole {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalSchemeForRole' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalSchemeForRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalSchemeForRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-TemplateslackCustomFields {
    [CmdletBinding()]
    Param (
...
TemplateslackCustomFields<PSCustomObject>
#>
function ConvertFrom-JsonToTemplateslackCustomFields {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in TemplateslackCustomFields

...
function Initialize-BetaApprovalComment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaApprovalComment' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaApprovalComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-AccountcorrelatedSource {
    [CmdletBinding()]
    Param (
...
AccountcorrelatedSource<PSCustomObject>
#>
function ConvertFrom-JsonToAccountcorrelatedSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in AccountcorrelatedSource

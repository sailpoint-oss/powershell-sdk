...
function Initialize-V2024ScheduleHours {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ScheduleHours' | Write-Debug
...
function ConvertFrom-V2024JsonToScheduleHours {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ScheduleHours' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

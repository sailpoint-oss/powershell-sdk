...
function Initialize-AccountAttributesCreateAttributes {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccountAttributesCreateAttributes' | Write-Debug
...
function ConvertFrom-JsonToAccountAttributesCreateAttributes {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccountAttributesCreateAttributes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

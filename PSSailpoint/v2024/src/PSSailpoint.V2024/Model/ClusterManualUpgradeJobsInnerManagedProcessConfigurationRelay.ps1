...
function Initialize-V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay' | Write-Debug
...
ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay<PSCustomObject>
#>
function ConvertFrom-V2024JsonToClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ClusterManualUpgradeJobsInnerManagedProcessConfigurationRelay

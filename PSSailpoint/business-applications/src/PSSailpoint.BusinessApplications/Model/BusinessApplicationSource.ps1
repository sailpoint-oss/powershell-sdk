...
BusinessApplicationSource<PSCustomObject>
#>

function Initialize-BusinessApplicationSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.BusinessApplications => BusinessApplicationSource' | Write-Debug
...
Convert from JSON to BusinessApplicationSource<PSCustomObject>
...
BusinessApplicationSource<PSCustomObject>
#>
function ConvertFrom-JsonToBusinessApplicationSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.BusinessApplications => BusinessApplicationSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BusinessApplicationSource

...
function Initialize-VerificationPollRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => VerificationPollRequest' | Write-Debug
...
function ConvertFrom-JsonToVerificationPollRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => VerificationPollRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

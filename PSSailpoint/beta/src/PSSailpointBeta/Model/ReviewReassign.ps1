...
function Initialize-BetaReviewReassign {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaReviewReassign' | Write-Debug
...
function ConvertFrom-BetaJsonToReviewReassign {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaReviewReassign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

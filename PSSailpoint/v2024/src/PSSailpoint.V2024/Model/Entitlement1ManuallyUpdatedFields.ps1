...
function Initialize-V2024Entitlement1ManuallyUpdatedFields {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Entitlement1ManuallyUpdatedFields' | Write-Debug
...
function ConvertFrom-V2024JsonToEntitlement1ManuallyUpdatedFields {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Entitlement1ManuallyUpdatedFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

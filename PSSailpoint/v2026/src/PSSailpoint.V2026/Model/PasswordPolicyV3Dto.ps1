...
function Initialize-V2026PasswordPolicyV3Dto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026PasswordPolicyV3Dto' | Write-Debug
...
PasswordPolicyV3Dto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToPasswordPolicyV3Dto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026PasswordPolicyV3Dto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026PasswordPolicyV3Dto

...
function Initialize-BetaAccountAttributesChanged {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaAccountAttributesChanged' | Write-Debug
...
function ConvertFrom-BetaJsonToAccountAttributesChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaAccountAttributesChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

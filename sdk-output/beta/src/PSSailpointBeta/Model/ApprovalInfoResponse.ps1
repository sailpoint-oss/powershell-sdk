...
function Initialize-BetaApprovalInfoResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaApprovalInfoResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToApprovalInfoResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaApprovalInfoResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

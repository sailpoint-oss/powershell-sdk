...
function Initialize-V2024TestWorkflowRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024TestWorkflowRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToTestWorkflowRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024TestWorkflowRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

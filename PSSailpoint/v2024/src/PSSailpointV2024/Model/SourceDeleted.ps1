...
function Initialize-V2024SourceDeleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024SourceDeleted' | Write-Debug
...
function ConvertFrom-V2024JsonToSourceDeleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024SourceDeleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Identityattribute2 {
    [CmdletBinding()]
    Param (
...
Identityattribute2<PSCustomObject>
#>
function ConvertFrom-JsonToIdentityattribute2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Identityattribute2

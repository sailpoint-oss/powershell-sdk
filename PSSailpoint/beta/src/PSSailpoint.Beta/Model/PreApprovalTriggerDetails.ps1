...
function Initialize-BetaPreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaPreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-BetaJsonToPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaPreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

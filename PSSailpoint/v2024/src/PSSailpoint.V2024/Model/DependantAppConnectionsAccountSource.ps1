...
function Initialize-V2024DependantAppConnectionsAccountSource {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024DependantAppConnectionsAccountSource' | Write-Debug
...
DependantAppConnectionsAccountSource<PSCustomObject>
#>
function ConvertFrom-V2024JsonToDependantAppConnectionsAccountSource {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024DependantAppConnectionsAccountSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024DependantAppConnectionsAccountSource

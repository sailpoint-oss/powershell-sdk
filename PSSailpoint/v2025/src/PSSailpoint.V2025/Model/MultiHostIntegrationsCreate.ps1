...
function Initialize-V2025MultiHostIntegrationsCreate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025MultiHostIntegrationsCreate' | Write-Debug
...
MultiHostIntegrationsCreate<PSCustomObject>
#>
function ConvertFrom-V2025JsonToMultiHostIntegrationsCreate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025MultiHostIntegrationsCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025MultiHostIntegrationsCreate

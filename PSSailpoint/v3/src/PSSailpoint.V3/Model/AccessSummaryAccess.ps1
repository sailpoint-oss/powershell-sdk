...
function Initialize-AccessSummaryAccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessSummaryAccess' | Write-Debug
...
function ConvertFrom-JsonToAccessSummaryAccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessSummaryAccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024Concatenation {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Concatenation' | Write-Debug
...
function ConvertFrom-V2024JsonToConcatenation {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Concatenation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

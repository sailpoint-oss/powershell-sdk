...
function Initialize-AccessRequestConfig2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequests => AccessRequestConfig2' | Write-Debug
...
Convert from JSON to AccessRequestConfig2<PSCustomObject>
...
AccessRequestConfig2<PSCustomObject>
#>
function ConvertFrom-JsonToAccessRequestConfig2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequests => AccessRequestConfig2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

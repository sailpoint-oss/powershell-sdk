...
ProfileAttributeRuleId<PSCustomObject>
#>

function Initialize-NERMProfileAttributeRuleId {
    [CmdletBinding()]
    Param (
        ...
        ${Type},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("ProfileSelectAttribute", "ProfileSearchAttribute", "OwnerSelectAttribute", "OwnerSearchAttribute", "ContributorSelectAttribute", "ContributorSearchAttribute")]
        [String]
        ${ConditionObjectType},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String]
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.NERM => NERMProfileAttributeRuleId' | Write-Debug
...
Convert from JSON to ProfileAttributeRuleId<PSCustomObject>
...
ProfileAttributeRuleId<PSCustomObject>
#>
function ConvertFrom-NERMJsonToProfileAttributeRuleId {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.NERM => NERMProfileAttributeRuleId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NERMProfileAttributeRuleId

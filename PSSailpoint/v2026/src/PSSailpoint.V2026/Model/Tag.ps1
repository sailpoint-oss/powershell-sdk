...
function Initialize-V2026Tag {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026Tag' | Write-Debug
...
Tag<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTag {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026Tag' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026Tag

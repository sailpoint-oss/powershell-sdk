...
function Initialize-BetaViolationContext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaViolationContext' | Write-Debug
...
function ConvertFrom-BetaJsonToViolationContext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaViolationContext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

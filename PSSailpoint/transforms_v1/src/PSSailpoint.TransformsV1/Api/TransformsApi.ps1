...
function New-TransformV1 {
    ...
    Process {
        'Calling method: New-TransformV1' | Write-Debug
        ...
        $LocalVarUri = '/transforms/v1'

        if (!$Transform) {
            throw "Error! The required parameter `Transform` missing when calling createTransformV1."
        }
...
function Remove-TransformV1 {
    ...
    Process {
        'Calling method: Remove-TransformV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/transforms/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deleteTransformV1."
        }
...
function Get-TransformV1 {
    ...
    Process {
        'Calling method: Get-TransformV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/transforms/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getTransformV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
function Get-TransformsV1 {
    ...
    Process {
        'Calling method: Get-TransformsV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Update-TransformV1 {
    ...
    Process {
        'Calling method: Update-TransformV1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/transforms/v1/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling updateTransformV1."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

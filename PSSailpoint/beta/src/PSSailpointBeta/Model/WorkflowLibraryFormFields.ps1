...
function Initialize-BetaWorkflowLibraryFormFields {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaWorkflowLibraryFormFields' | Write-Debug
...
function ConvertFrom-BetaJsonToWorkflowLibraryFormFields {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaWorkflowLibraryFormFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

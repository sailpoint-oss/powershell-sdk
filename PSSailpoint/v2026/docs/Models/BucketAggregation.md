...
keywords: ['powershell', 'PowerShell', 'sdk', 'BucketAggregation', 'V2026BucketAggregation'] 
slug: /tools/sdk/powershell/v2026/models/bucket-aggregation
...
```powershell
$BucketAggregation = Initialize-V2026BucketAggregation  -Name Identity Locations `
 -Type null `

...
AccountActivity
#>
function Get-V2025AccountActivity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Get-V2025AccountActivity' | Write-Debug
...
AccountActivity[]
#>
function Get-V2025AccountActivities {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025AccountActivities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

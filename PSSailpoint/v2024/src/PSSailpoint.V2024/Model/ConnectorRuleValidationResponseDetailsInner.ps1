...
function Initialize-V2024ConnectorRuleValidationResponseDetailsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConnectorRuleValidationResponseDetailsInner' | Write-Debug
...
function ConvertFrom-V2024JsonToConnectorRuleValidationResponseDetailsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConnectorRuleValidationResponseDetailsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024ConnectorRuleValidationResponseDetailsInner

...
function Initialize-BetaRoleMiningEntitlement {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningEntitlement' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningEntitlement {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningEntitlement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

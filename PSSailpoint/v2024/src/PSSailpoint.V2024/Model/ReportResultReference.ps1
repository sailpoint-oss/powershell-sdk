...
function Initialize-V2024ReportResultReference {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ReportResultReference' | Write-Debug
...
function ConvertFrom-V2024JsonToReportResultReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ReportResultReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

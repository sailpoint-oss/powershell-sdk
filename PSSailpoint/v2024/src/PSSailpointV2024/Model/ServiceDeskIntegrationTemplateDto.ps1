...
function Initialize-V2024ServiceDeskIntegrationTemplateDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ServiceDeskIntegrationTemplateDto' | Write-Debug
...
function ConvertFrom-V2024JsonToServiceDeskIntegrationTemplateDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ServiceDeskIntegrationTemplateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

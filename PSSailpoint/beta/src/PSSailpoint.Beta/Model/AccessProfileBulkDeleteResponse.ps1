...
function Initialize-BetaAccessProfileBulkDeleteResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessProfileBulkDeleteResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToAccessProfileBulkDeleteResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessProfileBulkDeleteResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

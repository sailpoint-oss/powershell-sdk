...
```powershell
$TriggerInputVAClusterStatusChangeEventApplication = Initialize-PSSailpointBetaTriggerInputVAClusterStatusChangeEventApplication  -Id 2c9180866166b5b0016167c32ef31a66 `
...
```powershell
$TriggerInputVAClusterStatusChangeEventApplication | ConvertTo-JSON
```

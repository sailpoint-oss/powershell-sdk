...
keywords: ['powershell', 'PowerShell', 'sdk', 'SourceUsageStatus', 'V2026SourceUsageStatus'] 
slug: /tools/sdk/powershell/v2026/models/source-usage-status
...
```powershell
$SourceUsageStatus = Initialize-V2026SourceUsageStatus  -Status COMPLETE
```

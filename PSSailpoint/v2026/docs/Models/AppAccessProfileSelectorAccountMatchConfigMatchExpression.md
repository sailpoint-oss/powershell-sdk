...
keywords: ['powershell', 'PowerShell', 'sdk', 'AppAccessProfileSelectorAccountMatchConfigMatchExpression', 'V2026AppAccessProfileSelectorAccountMatchConfigMatchExpression'] 
slug: /tools/sdk/powershell/v2026/models/app-access-profile-selector-account-match-config-match-expression
...
```powershell
$AppAccessProfileSelectorAccountMatchConfigMatchExpression = Initialize-V2026AppAccessProfileSelectorAccountMatchConfigMatchExpression  -MatchTerms [{name=, value=, op=null, container=true, and=false, children=[{name=businessCategory, value=Service, op=eq, container=false, and=false, children=null}]}] `
 -And true
```

...
keywords: ['powershell', 'PowerShell', 'sdk', 'HierarchicalRightSet', 'V2026HierarchicalRightSet'] 
slug: /tools/sdk/powershell/v2026/models/hierarchical-right-set
...
```powershell
$HierarchicalRightSet = Initialize-V2026HierarchicalRightSet  -Id idn:ui-right-set-example `

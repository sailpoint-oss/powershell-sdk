...
function Initialize-IdentityDocumentAllOfManager {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => IdentityDocumentAllOfManager' | Write-Debug
...
function ConvertFrom-JsonToIdentityDocumentAllOfManager {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => IdentityDocumentAllOfManager' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

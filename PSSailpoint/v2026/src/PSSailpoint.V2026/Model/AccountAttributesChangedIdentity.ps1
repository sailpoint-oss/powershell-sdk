...
function Initialize-V2026AccountAttributesChangedIdentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026AccountAttributesChangedIdentity' | Write-Debug
...
AccountAttributesChangedIdentity<PSCustomObject>
#>
function ConvertFrom-V2026JsonToAccountAttributesChangedIdentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026AccountAttributesChangedIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026AccountAttributesChangedIdentity

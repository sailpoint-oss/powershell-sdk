...
function Initialize-V2026TaskResultSimplified {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026TaskResultSimplified' | Write-Debug
...
TaskResultSimplified<PSCustomObject>
#>
function ConvertFrom-V2026JsonToTaskResultSimplified {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026TaskResultSimplified' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026TaskResultSimplified

...
keywords: ['powershell', 'PowerShell', 'sdk', 'AttributeDTO', 'V2026AttributeDTO'] 
slug: /tools/sdk/powershell/v2026/models/attribute-dto
...
```powershell
$AttributeDTO = Initialize-V2026AttributeDTO  -Key iscPrivacy `
 -Name Privacy `
 -Multiselect false `
 -Status active `
 -Type governance `

...
function Initialize-V2024RequestedItemStatus {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatus' | Write-Debug
...
RequestedItemStatus<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRequestedItemStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RequestedItemStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

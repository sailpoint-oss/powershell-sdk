...
function Initialize-V2024TaskDefinitionSummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024TaskDefinitionSummary' | Write-Debug
...
function ConvertFrom-V2024JsonToTaskDefinitionSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024TaskDefinitionSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

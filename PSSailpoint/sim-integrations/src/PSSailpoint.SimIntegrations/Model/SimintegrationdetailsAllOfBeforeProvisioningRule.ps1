...
function Initialize-SimintegrationdetailsAllOfBeforeProvisioningRule {
    [CmdletBinding()]
    Param (
...
SimintegrationdetailsAllOfBeforeProvisioningRule<PSCustomObject>
#>
function ConvertFrom-JsonToSimintegrationdetailsAllOfBeforeProvisioningRule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in SimintegrationdetailsAllOfBeforeProvisioningRule

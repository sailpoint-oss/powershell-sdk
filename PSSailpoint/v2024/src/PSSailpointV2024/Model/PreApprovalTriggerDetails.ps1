...
function Initialize-V2024PreApprovalTriggerDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024PreApprovalTriggerDetails' | Write-Debug
...
function ConvertFrom-V2024JsonToPreApprovalTriggerDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024PreApprovalTriggerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

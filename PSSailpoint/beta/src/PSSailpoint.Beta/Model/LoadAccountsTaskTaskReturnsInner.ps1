...
function Initialize-BetaLoadAccountsTaskTaskReturnsInner {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaLoadAccountsTaskTaskReturnsInner' | Write-Debug
...
function ConvertFrom-BetaJsonToLoadAccountsTaskTaskReturnsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaLoadAccountsTaskTaskReturnsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

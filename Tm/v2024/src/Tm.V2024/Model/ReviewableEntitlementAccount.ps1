...
function Initialize-V2024ReviewableEntitlementAccount {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ReviewableEntitlementAccount' | Write-Debug
...
function ConvertFrom-V2024JsonToReviewableEntitlementAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ReviewableEntitlementAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

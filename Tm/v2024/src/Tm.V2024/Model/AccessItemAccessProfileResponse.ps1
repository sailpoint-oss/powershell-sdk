...
function Initialize-V2024AccessItemAccessProfileResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccessItemAccessProfileResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessItemAccessProfileResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccessItemAccessProfileResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024MultiHostIntegrationsAccountsFile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024MultiHostIntegrationsAccountsFile' | Write-Debug
...
MultiHostIntegrationsAccountsFile<PSCustomObject>
#>
function ConvertFrom-V2024JsonToMultiHostIntegrationsAccountsFile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024MultiHostIntegrationsAccountsFile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024MultiHostIntegrationsAccountsFile

...
function Initialize-V2025RoleMiningSessionParametersDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningSessionParametersDto' | Write-Debug
...
RoleMiningSessionParametersDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleMiningSessionParametersDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleMiningSessionParametersDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleMiningSessionParametersDto

...
function Initialize-V2024OriginalRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024OriginalRequest' | Write-Debug
...
OriginalRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToOriginalRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024OriginalRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ConnectorRuleValidationResponseDetailsInner {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024ConnectorRuleValidationResponseDetailsInner' | Write-Debug
...
function ConvertFrom-V2024JsonToConnectorRuleValidationResponseDetailsInner {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024ConnectorRuleValidationResponseDetailsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

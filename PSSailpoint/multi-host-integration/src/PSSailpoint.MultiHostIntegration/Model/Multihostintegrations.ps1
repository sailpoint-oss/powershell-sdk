...
function Initialize-Multihostintegrations {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MultiHostIntegrationV1 => Multihostintegrations' | Write-Debug
...
Multihostintegrations<PSCustomObject>
#>
function ConvertFrom-JsonToMultihostintegrations {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MultiHostIntegrationV1 => Multihostintegrations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Multihostintegrations
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "accountsFile"))) { #optional property not found
            $AccountsFile = $null
        } else {
            $AccountsFile = $JsonParameters.PSobject.Properties["accountsFile"].value
        }

...
Get the configuration object 'NERMConfiguration'.
...
#>
function Get-NERMConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://acmeco.nonemployee.com/api";
    }
...
System.Collections.Hashtable
#>
function Set-NERMConfiguration {
...
None
#>
function Set-NERMConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-NERMConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-NERMConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
String
#>
function Get-NERMUrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-NERMConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-NERMKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'NERMConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-NERMConfigurationHttpSigning{

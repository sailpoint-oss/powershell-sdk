...
function Initialize-V2024ConfigurationItemRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConfigurationItemRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToConfigurationItemRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConfigurationItemRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

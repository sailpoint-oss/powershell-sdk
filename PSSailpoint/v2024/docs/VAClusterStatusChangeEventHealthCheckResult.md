...
```powershell
$VAClusterStatusChangeEventHealthCheckResult = Initialize-PSSailpointV2024VAClusterStatusChangeEventHealthCheckResult  -Message Test Connection failed with exception. Error message - java.lang Exception `

...
function Initialize-BetaRoleMiningIdentityDistribution {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaRoleMiningIdentityDistribution' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningIdentityDistribution {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaRoleMiningIdentityDistribution' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

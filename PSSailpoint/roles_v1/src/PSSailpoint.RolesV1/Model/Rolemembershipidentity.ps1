...
function Initialize-Rolemembershipidentity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.RolesV1 => Rolemembershipidentity' | Write-Debug
...
Rolemembershipidentity<PSCustomObject>
#>
function ConvertFrom-JsonToRolemembershipidentity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.RolesV1 => Rolemembershipidentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Rolemembershipidentity

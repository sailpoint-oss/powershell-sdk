...
function Initialize-Sodviolationcontext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestApprovals => Sodviolationcontext' | Write-Debug
...
function ConvertFrom-JsonToSodviolationcontext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestApprovals => Sodviolationcontext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

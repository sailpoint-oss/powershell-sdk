...
CreateExternalExecuteWorkflowV1200Response<PSCustomObject>
#>

function Initialize-CreateExternalExecuteWorkflowV1200Response {
    [CmdletBinding()]
    Param (
...
Convert from JSON to CreateExternalExecuteWorkflowV1200Response<PSCustomObject>
...
CreateExternalExecuteWorkflowV1200Response<PSCustomObject>
#>
function ConvertFrom-JsonToCreateExternalExecuteWorkflowV1200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in CreateExternalExecuteWorkflowV1200Response

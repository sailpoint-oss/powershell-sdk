...
keywords: ['powershell', 'PowerShell', 'sdk', 'AssignmentContextDto', 'V2026AssignmentContextDto'] 
slug: /tools/sdk/powershell/v2026/models/assignment-context-dto
...
```powershell
$AssignmentContextDto = Initialize-V2026AssignmentContextDto  -Requested null `
 -Matched null `

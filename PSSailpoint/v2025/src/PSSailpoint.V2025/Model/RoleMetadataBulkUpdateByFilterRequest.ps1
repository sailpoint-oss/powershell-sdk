...
function Initialize-V2025RoleMetadataBulkUpdateByFilterRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025RoleMetadataBulkUpdateByFilterRequest' | Write-Debug
...
RoleMetadataBulkUpdateByFilterRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToRoleMetadataBulkUpdateByFilterRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025RoleMetadataBulkUpdateByFilterRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025RoleMetadataBulkUpdateByFilterRequest

...
function Initialize-AccessRequestConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => AccessRequestConfig' | Write-Debug
...
function ConvertFrom-JsonToAccessRequestConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => AccessRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-CreateprivilegecriteriarequestGroupsInnerCriteriaItemsInner {
    [CmdletBinding()]
    Param (
        ...
        ${TargetType},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("displayName", "description", "value")]
        [String]
        ${Operator},
        [Parameter(ValueFromPipelineByPropertyName = $true)]
        [String[]]
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.PrivilegeCriteriaV1 => CreateprivilegecriteriarequestGroupsInnerCriteriaItemsInner' | Write-Debug
...
CreateprivilegecriteriarequestGroupsInnerCriteriaItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToCreateprivilegecriteriarequestGroupsInnerCriteriaItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.PrivilegeCriteriaV1 => CreateprivilegecriteriarequestGroupsInnerCriteriaItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateprivilegecriteriarequestGroupsInnerCriteriaItemsInner

...
function Initialize-V2025SendTestNotificationRequestDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025SendTestNotificationRequestDto' | Write-Debug
...
SendTestNotificationRequestDto<PSCustomObject>
#>
function ConvertFrom-V2025JsonToSendTestNotificationRequestDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025SendTestNotificationRequestDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

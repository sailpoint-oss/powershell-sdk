...
function Initialize-BetaAccessProfileUsage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaAccessProfileUsage' | Write-Debug
...
AccessProfileUsage<PSCustomObject>
#>
function ConvertFrom-BetaJsonToAccessProfileUsage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaAccessProfileUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaAccessProfileUsage

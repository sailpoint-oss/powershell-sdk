...
keywords: ['powershell', 'PowerShell', 'sdk', 'CommonAccessItemAccess', 'V2026CommonAccessItemAccess'] 
slug: /tools/sdk/powershell/v2026/models/common-access-item-access
...
```powershell
$CommonAccessItemAccess = Initialize-V2026CommonAccessItemAccess  -Id null `
 -Type null `
 -Name null `
 -Description null `
 -OwnerName null `

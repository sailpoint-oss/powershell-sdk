...
function Initialize-Dataaccess {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.CertificationsV1 => Dataaccess' | Write-Debug
...
function ConvertFrom-JsonToDataaccess {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.CertificationsV1 => Dataaccess' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

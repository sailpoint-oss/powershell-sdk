...
function Initialize-V2024DimensionBulkDeleteRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024DimensionBulkDeleteRequest' | Write-Debug
...
DimensionBulkDeleteRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToDimensionBulkDeleteRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024DimensionBulkDeleteRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024DimensionBulkDeleteRequest

...
function Initialize-EntitlementDocumentAllOfSource {
    ...
    Process {
        'Creating PSCustomObject: Tm.V3 => EntitlementDocumentAllOfSource' | Write-Debug
...
function ConvertFrom-JsonToEntitlementDocumentAllOfSource {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V3 => EntitlementDocumentAllOfSource' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Sourceappbulkupdaterequest {
    [CmdletBinding()]
    Param (
...
Sourceappbulkupdaterequest<PSCustomObject>
#>
function ConvertFrom-JsonToSourceappbulkupdaterequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Sourceappbulkupdaterequest

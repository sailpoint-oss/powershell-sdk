...
slug: /tools/sdk/powershell/reportsdataextraction/models/task-result-details
...
**Attributes** | **SystemCollectionsHashtable** | Extra attributes map(dictionary) needed for the report. | [optional] 

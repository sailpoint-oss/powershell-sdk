...
function Initialize-RoleMiningSessionResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IaiRoleMining => RoleMiningSessionResponse' | Write-Debug
...
function ConvertFrom-JsonToRoleMiningSessionResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IaiRoleMining => RoleMiningSessionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

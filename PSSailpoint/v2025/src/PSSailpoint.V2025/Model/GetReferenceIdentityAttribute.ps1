...
function Initialize-V2025GetReferenceIdentityAttribute {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025GetReferenceIdentityAttribute' | Write-Debug
...
GetReferenceIdentityAttribute<PSCustomObject>
#>
function ConvertFrom-V2025JsonToGetReferenceIdentityAttribute {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025GetReferenceIdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025GetReferenceIdentityAttribute

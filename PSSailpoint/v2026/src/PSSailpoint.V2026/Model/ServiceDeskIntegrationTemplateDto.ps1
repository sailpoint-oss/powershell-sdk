...
function Initialize-V2026ServiceDeskIntegrationTemplateDto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ServiceDeskIntegrationTemplateDto' | Write-Debug
...
ServiceDeskIntegrationTemplateDto<PSCustomObject>
#>
function ConvertFrom-V2026JsonToServiceDeskIntegrationTemplateDto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ServiceDeskIntegrationTemplateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ServiceDeskIntegrationTemplateDto

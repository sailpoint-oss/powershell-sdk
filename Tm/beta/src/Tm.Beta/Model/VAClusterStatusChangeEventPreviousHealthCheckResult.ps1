...
function Initialize-BetaVAClusterStatusChangeEventPreviousHealthCheckResult {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaVAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
...
function ConvertFrom-BetaJsonToVAClusterStatusChangeEventPreviousHealthCheckResult {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaVAClusterStatusChangeEventPreviousHealthCheckResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024FormDefinitionInput {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024FormDefinitionInput' | Write-Debug
...
function ConvertFrom-V2024JsonToFormDefinitionInput {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024FormDefinitionInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

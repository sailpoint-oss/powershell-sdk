...
function Initialize-V2024RoleDocumentAllOfDimensions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024RoleDocumentAllOfDimensions' | Write-Debug
...
RoleDocumentAllOfDimensions<PSCustomObject>
#>
function ConvertFrom-V2024JsonToRoleDocumentAllOfDimensions {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024RoleDocumentAllOfDimensions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024RoleDocumentAllOfDimensions

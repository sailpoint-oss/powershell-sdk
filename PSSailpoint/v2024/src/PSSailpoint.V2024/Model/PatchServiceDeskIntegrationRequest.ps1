...
function Initialize-V2024PatchServiceDeskIntegrationRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024PatchServiceDeskIntegrationRequest' | Write-Debug
...
PatchServiceDeskIntegrationRequest<PSCustomObject>
#>
function ConvertFrom-V2024JsonToPatchServiceDeskIntegrationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024PatchServiceDeskIntegrationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2024PatchServiceDeskIntegrationRequest

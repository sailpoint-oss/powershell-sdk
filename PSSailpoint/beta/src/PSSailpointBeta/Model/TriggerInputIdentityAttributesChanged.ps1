...
TriggerInputIdentityAttributesChanged<PSCustomObject>
#>

function Initialize-BetaTriggerInputIdentityAttributesChanged {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaTriggerInputIdentityAttributesChanged' | Write-Debug
...
Convert from JSON to TriggerInputIdentityAttributesChanged<PSCustomObject>
...
TriggerInputIdentityAttributesChanged<PSCustomObject>
#>
function ConvertFrom-BetaJsonToTriggerInputIdentityAttributesChanged {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaTriggerInputIdentityAttributesChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaTriggerInputIdentityAttributesChanged

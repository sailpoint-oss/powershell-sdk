...
function Initialize-V2026ReviewableAccessProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ReviewableAccessProfile' | Write-Debug
...
ReviewableAccessProfile<PSCustomObject>
#>
function ConvertFrom-V2026JsonToReviewableAccessProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ReviewableAccessProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ReviewableAccessProfile

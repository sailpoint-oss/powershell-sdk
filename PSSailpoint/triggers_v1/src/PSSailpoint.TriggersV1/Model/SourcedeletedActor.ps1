...
function Initialize-SourcedeletedActor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.TriggersV1 => SourcedeletedActor' | Write-Debug
...
SourcedeletedActor<PSCustomObject>
#>
function ConvertFrom-JsonToSourcedeletedActor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.TriggersV1 => SourcedeletedActor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SourcedeletedActor

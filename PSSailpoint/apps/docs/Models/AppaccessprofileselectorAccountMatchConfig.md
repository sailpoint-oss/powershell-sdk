...
slug: /tools/sdk/powershell/appsv1/models/appaccessprofileselector-account-match-config
...
------------ | ------------- | ------------- | -------------
**MatchExpression** | [**AppaccessprofileselectorAccountMatchConfigMatchExpression**](appaccessprofileselector-account-match-config-match-expression) |  | [optional] 

...
keywords: ['powershell', 'PowerShell', 'sdk', 'PrivilegeCriteriaDTOGroupsInnerCriteriaItemsInner', 'V2026PrivilegeCriteriaDTOGroupsInnerCriteriaItemsInner'] 
slug: /tools/sdk/powershell/v2026/models/privilege-criteria-dto-groups-inner-criteria-items-inner
...
```powershell
$PrivilegeCriteriaDTOGroupsInnerCriteriaItemsInner = Initialize-V2026PrivilegeCriteriaDTOGroupsInnerCriteriaItemsInner  -TargetType group `
 -Operator IN `
 -Property null `

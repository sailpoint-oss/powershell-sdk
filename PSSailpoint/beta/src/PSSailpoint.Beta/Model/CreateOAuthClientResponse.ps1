...
function Initialize-BetaCreateOAuthClientResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaCreateOAuthClientResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToCreateOAuthClientResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaCreateOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

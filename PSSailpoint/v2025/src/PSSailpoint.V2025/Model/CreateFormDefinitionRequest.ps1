...
function Initialize-V2025CreateFormDefinitionRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025CreateFormDefinitionRequest' | Write-Debug
...
CreateFormDefinitionRequest<PSCustomObject>
#>
function ConvertFrom-V2025JsonToCreateFormDefinitionRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025CreateFormDefinitionRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025CreateFormDefinitionRequest

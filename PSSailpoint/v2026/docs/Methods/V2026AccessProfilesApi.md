...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccessProfiles', 'V2026AccessProfiles'] 
slug: /tools/sdk/powershell/v2026/methods/access-profiles
...
------------- | ------------- | -------------
[**New-V2026AccessProfile**](#create-access-profile) | **POST** `/access-profiles` | Create access profile
[**Remove-V2026AccessProfile**](#delete-access-profile) | **DELETE** `/access-profiles/{id}` | Delete the specified access profile
[**Remove-V2026AccessProfilesInBulk**](#delete-access-profiles-in-bulk) | **POST** `/access-profiles/bulk-delete` | Delete access profile(s)
[**Get-V2026AccessProfile**](#get-access-profile) | **GET** `/access-profiles/{id}` | Get an access profile
[**Get-V2026AccessProfileEntitlements**](#get-access-profile-entitlements) | **GET** `/access-profiles/{id}/entitlements` | List access profile&#39;s entitlements
[**Get-V2026AccessProfiles**](#list-access-profiles) | **GET** `/access-profiles` | List access profiles
[**Update-V2026AccessProfile**](#patch-access-profile) | **PATCH** `/access-profiles/{id}` | Patch a specified access profile
[**Update-V2026AccessProfilesInBulk**](#update-access-profiles-in-bulk) | **POST** `/access-profiles/bulk-update-requestable` | Update access profile(s) requestable field.
...
try {
    $Result = ConvertFrom-V2026JsonToAccessProfile -Json $AccessProfile
    New-V2026AccessProfile -AccessProfile $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2026AccessProfile -AccessProfile $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2026AccessProfile"
...
try {
    Remove-V2026AccessProfile -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026AccessProfile -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026AccessProfile"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAccessProfileBulkDeleteRequest -Json $AccessProfileBulkDeleteRequest
    Remove-V2026AccessProfilesInBulk -AccessProfileBulkDeleteRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Remove-V2026AccessProfilesInBulk -AccessProfileBulkDeleteRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2026AccessProfilesInBulk"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026AccessProfile -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AccessProfile -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccessProfile"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026AccessProfileEntitlements -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AccessProfileEntitlements -Id $Id -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccessProfileEntitlements"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2026AccessProfiles 
    
    # Below is a request that includes all optional parameters
    # Get-V2026AccessProfiles -ForSubadmin $ForSubadmin -Limit $Limit -Offset $Offset -Count $Count -Filters $Filters -Sorters $Sorters -ForSegmentIds $ForSegmentIds -IncludeUnsegmented $IncludeUnsegmented  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026AccessProfiles"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026AccessProfile -Id $Id -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026AccessProfile -Id $Id -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026AccessProfile"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2026JsonToAccessProfileBulkUpdateRequestInner -Json $AccessProfileBulkUpdateRequestInner
    Update-V2026AccessProfilesInBulk -XSailPointExperimental $XSailPointExperimental -AccessProfileBulkUpdateRequestInner $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026AccessProfilesInBulk -XSailPointExperimental $XSailPointExperimental -AccessProfileBulkUpdateRequestInner $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026AccessProfilesInBulk"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

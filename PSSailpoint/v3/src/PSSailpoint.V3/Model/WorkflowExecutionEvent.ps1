...
function Initialize-WorkflowExecutionEvent {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => WorkflowExecutionEvent' | Write-Debug
...
function ConvertFrom-JsonToWorkflowExecutionEvent {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => WorkflowExecutionEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

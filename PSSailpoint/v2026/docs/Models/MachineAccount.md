...
keywords: ['powershell', 'PowerShell', 'sdk', 'MachineAccount', 'V2026MachineAccount'] 
slug: /tools/sdk/powershell/v2026/models/machine-account
...
```powershell
$MachineAccount = Initialize-V2026MachineAccount  -Id id12345 `
 -Name aName `

...
function Initialize-V2024CampaignTemplate {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024CampaignTemplate' | Write-Debug
...
function ConvertFrom-V2024JsonToCampaignTemplate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024CampaignTemplate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

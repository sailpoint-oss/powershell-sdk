...
function Initialize-BetaCreatePersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaCreatePersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToCreatePersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaCreatePersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

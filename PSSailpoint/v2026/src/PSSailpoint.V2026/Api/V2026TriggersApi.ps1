...
None
#>
function Complete-V2026TriggerInvocation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Complete-V2026TriggerInvocation' | Write-Debug
...
Subscription
#>
function New-V2026Subscription {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: New-V2026Subscription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
None
#>
function Remove-V2026Subscription {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Remove-V2026Subscription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Subscription[]
#>
function Get-V2026Subscriptions {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Get-V2026Subscriptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
InvocationStatus[]
#>
function Get-V2026TriggerInvocationStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int32]]
    ...
    Process {
        'Calling method: Get-V2026TriggerInvocationStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
function Get-V2026Triggers {
    ...
    Process {
        'Calling method: Get-V2026Triggers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Subscription
#>
function Update-V2026Subscription {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Update-V2026Subscription' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
Invocation[]
#>
function Start-V2026TestTriggerInvocation {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Start-V2026TestTriggerInvocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Test-V2026SubscriptionFilter {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Test-V2026SubscriptionFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

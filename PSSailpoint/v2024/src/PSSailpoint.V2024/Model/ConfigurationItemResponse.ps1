...
function Initialize-V2024ConfigurationItemResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ConfigurationItemResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToConfigurationItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ConfigurationItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024Schedule1Days {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Schedule1Days' | Write-Debug
...
function ConvertFrom-V2024JsonToSchedule1Days {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Schedule1Days' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

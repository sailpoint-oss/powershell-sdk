...
function Initialize-V2024ObjectImportResult1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ObjectImportResult1' | Write-Debug
...
function ConvertFrom-V2024JsonToObjectImportResult1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ObjectImportResult1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

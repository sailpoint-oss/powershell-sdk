...
function Initialize-V2026ParameterStorageReference {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageReference' | Write-Debug
...
ParameterStorageReference<PSCustomObject>
#>
function ConvertFrom-V2026JsonToParameterStorageReference {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026ParameterStorageReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026ParameterStorageReference

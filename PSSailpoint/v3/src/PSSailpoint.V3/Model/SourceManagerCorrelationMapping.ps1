...
function Initialize-SourceManagerCorrelationMapping {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SourceManagerCorrelationMapping' | Write-Debug
...
function ConvertFrom-JsonToSourceManagerCorrelationMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SourceManagerCorrelationMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

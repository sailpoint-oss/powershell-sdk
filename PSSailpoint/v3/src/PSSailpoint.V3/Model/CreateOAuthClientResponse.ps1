...
function Initialize-CreateOAuthClientResponse {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CreateOAuthClientResponse' | Write-Debug
...
CreateOAuthClientResponse<PSCustomObject>
#>
function ConvertFrom-JsonToCreateOAuthClientResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CreateOAuthClientResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateOAuthClientResponse

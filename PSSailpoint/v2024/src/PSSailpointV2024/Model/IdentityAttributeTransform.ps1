...
function Initialize-V2024IdentityAttributeTransform {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityAttributeTransform' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityAttributeTransform {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityAttributeTransform' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

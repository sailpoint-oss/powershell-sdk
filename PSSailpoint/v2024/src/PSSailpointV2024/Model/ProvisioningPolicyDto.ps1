...
function Initialize-V2024ProvisioningPolicyDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ProvisioningPolicyDto' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningPolicyDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ProvisioningPolicyDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

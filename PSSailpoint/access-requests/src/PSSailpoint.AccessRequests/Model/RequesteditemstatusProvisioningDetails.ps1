...
function Initialize-RequesteditemstatusProvisioningDetails {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestsV1 => RequesteditemstatusProvisioningDetails' | Write-Debug
...
RequesteditemstatusProvisioningDetails<PSCustomObject>
#>
function ConvertFrom-JsonToRequesteditemstatusProvisioningDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestsV1 => RequesteditemstatusProvisioningDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RequesteditemstatusProvisioningDetails

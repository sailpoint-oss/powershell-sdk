...
keywords: ['powershell', 'PowerShell', 'sdk', 'AuthProfile', 'V2026AuthProfile'] 
slug: /tools/sdk/powershell/v2026/methods/auth-profile
...
------------- | ------------- | -------------
[**Get-V2026ProfileConfig**](#get-profile-config) | **GET** `/auth-profiles/{id}` | Get auth profile
[**Get-V2026ProfileConfigList**](#get-profile-config-list) | **GET** `/auth-profiles` | Get list of auth profiles
[**Update-V2026ProfileConfig**](#patch-profile-config) | **PATCH** `/auth-profiles/{id}` | Patch a specified auth profile
...
try {
    Get-V2026ProfileConfig -XSailPointExperimental $XSailPointExperimental -Id $Id 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ProfileConfig -XSailPointExperimental $XSailPointExperimental -Id $Id  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ProfileConfig"
...
try {
    Get-V2026ProfileConfigList -XSailPointExperimental $XSailPointExperimental 
    
    # Below is a request that includes all optional parameters
    # Get-V2026ProfileConfigList -XSailPointExperimental $XSailPointExperimental  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2026ProfileConfigList"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Update-V2026ProfileConfig -Id $Id -XSailPointExperimental $XSailPointExperimental -JsonPatchOperation $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2026ProfileConfig -Id $Id -XSailPointExperimental $XSailPointExperimental -JsonPatchOperation $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2026ProfileConfig"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

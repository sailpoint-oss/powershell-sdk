...
function Initialize-V2024AccountAttributesChanged {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024AccountAttributesChanged' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAttributesChanged {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024AccountAttributesChanged' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

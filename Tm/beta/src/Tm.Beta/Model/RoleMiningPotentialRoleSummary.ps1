...
function Initialize-BetaRoleMiningPotentialRoleSummary {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleSummary' | Write-Debug
...
function ConvertFrom-BetaJsonToRoleMiningPotentialRoleSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaRoleMiningPotentialRoleSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

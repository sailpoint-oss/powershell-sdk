...
function Initialize-ApprovalidentityOwnerOfInner {
    [CmdletBinding()]
    Param (
...
ApprovalidentityOwnerOfInner<PSCustomObject>
#>
function ConvertFrom-JsonToApprovalidentityOwnerOfInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in ApprovalidentityOwnerOfInner

...
function Initialize-BetaFeatureValueDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointBeta => BetaFeatureValueDto' | Write-Debug
...
function ConvertFrom-BetaJsonToFeatureValueDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointBeta => BetaFeatureValueDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

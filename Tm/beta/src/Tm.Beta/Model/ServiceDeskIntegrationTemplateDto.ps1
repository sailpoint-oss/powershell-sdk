...
function Initialize-BetaServiceDeskIntegrationTemplateDto {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaServiceDeskIntegrationTemplateDto' | Write-Debug
...
function ConvertFrom-BetaJsonToServiceDeskIntegrationTemplateDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaServiceDeskIntegrationTemplateDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024ExportOptions {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024ExportOptions' | Write-Debug
...
function ConvertFrom-V2024JsonToExportOptions {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024ExportOptions' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

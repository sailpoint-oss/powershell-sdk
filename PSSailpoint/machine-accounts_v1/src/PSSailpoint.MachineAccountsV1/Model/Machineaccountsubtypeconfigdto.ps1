...
function Initialize-Machineaccountsubtypeconfigdto {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.MachineAccountsV1 => Machineaccountsubtypeconfigdto' | Write-Debug
...
Machineaccountsubtypeconfigdto<PSCustomObject>
#>
function ConvertFrom-JsonToMachineaccountsubtypeconfigdto {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.MachineAccountsV1 => Machineaccountsubtypeconfigdto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Machineaccountsubtypeconfigdto

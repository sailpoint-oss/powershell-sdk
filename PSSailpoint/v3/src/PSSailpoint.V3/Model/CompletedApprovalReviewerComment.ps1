...
function Initialize-CompletedApprovalReviewerComment {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => CompletedApprovalReviewerComment' | Write-Debug
...
function ConvertFrom-JsonToCompletedApprovalReviewerComment {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => CompletedApprovalReviewerComment' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

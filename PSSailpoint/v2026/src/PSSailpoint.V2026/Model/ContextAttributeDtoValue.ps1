...
#>
function ConvertFrom-V2026JsonToContextAttributeDtoValue {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'String' defined in oneOf (V2026ContextAttributeDtoValue). Proceeding to the next one if any."
        }

...
function Initialize-V2024AccessRequestItem {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestItem' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessRequestItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024AccessRequestItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
Aggregation2<PSCustomObject>
#>

function Initialize-Aggregation2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => Aggregation2' | Write-Debug
...
Convert from JSON to Aggregation2<PSCustomObject>
...
Aggregation2<PSCustomObject>
#>
function ConvertFrom-JsonToAggregation2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => Aggregation2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Aggregation2

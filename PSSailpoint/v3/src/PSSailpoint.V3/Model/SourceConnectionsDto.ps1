...
function Initialize-SourceConnectionsDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V3 => SourceConnectionsDto' | Write-Debug
...
function ConvertFrom-JsonToSourceConnectionsDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V3 => SourceConnectionsDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

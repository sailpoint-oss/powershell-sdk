...
function Initialize-V2024LocalizedMessage {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024LocalizedMessage' | Write-Debug
...
function ConvertFrom-V2024JsonToLocalizedMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024LocalizedMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

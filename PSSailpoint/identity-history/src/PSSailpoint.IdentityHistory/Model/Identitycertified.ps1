...
function Initialize-Identitycertified {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.IdentityHistoryV1 => Identitycertified' | Write-Debug
...
Identitycertified<PSCustomObject>
#>
function ConvertFrom-JsonToIdentitycertified {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.IdentityHistoryV1 => Identitycertified' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Identitycertified

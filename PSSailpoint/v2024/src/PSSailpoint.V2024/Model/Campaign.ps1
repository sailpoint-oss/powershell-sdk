...
function Initialize-V2024Campaign {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2024 => V2024Campaign' | Write-Debug
...
Campaign<PSCustomObject>
#>
function ConvertFrom-V2024JsonToCampaign {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2024 => V2024Campaign' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

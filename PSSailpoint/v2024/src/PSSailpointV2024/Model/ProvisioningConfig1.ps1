...
function Initialize-V2024ProvisioningConfig1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ProvisioningConfig1' | Write-Debug
...
function ConvertFrom-V2024JsonToProvisioningConfig1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ProvisioningConfig1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

#
# Module manifest for module 'PSSailpoint.CustomUserLevelsV1'
#
...
RootModule = 'PSSailpoint.CustomUserLevelsV1.psm1'
...
Description = 'PSSailpoint.CustomUserLevelsV1 - the PowerShell module for Identity Security Cloud API - Custom User Levels'

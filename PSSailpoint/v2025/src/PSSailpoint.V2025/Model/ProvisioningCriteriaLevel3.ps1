...
function Initialize-V2025ProvisioningCriteriaLevel3 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2025 => V2025ProvisioningCriteriaLevel3' | Write-Debug
...
ProvisioningCriteriaLevel3<PSCustomObject>
#>
function ConvertFrom-V2025JsonToProvisioningCriteriaLevel3 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2025 => V2025ProvisioningCriteriaLevel3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2025ProvisioningCriteriaLevel3

...
function Initialize-BetaTenantUiMetadataItemResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaTenantUiMetadataItemResponse' | Write-Debug
...
function ConvertFrom-BetaJsonToTenantUiMetadataItemResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaTenantUiMetadataItemResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

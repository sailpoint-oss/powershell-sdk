...
function Initialize-BetaIdentityEntities {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaIdentityEntities' | Write-Debug
...
function ConvertFrom-BetaJsonToIdentityEntities {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaIdentityEntities' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-SearchAggregationSpecification {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => SearchAggregationSpecification' | Write-Debug
...
function ConvertFrom-JsonToSearchAggregationSpecification {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => SearchAggregationSpecification' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-AccountActivityDocument {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint => AccountActivityDocument' | Write-Debug
...
function ConvertFrom-JsonToAccountActivityDocument {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint => AccountActivityDocument' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

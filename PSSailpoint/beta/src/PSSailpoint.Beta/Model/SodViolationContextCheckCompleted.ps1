...
function Initialize-BetaSodViolationContextCheckCompleted {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaSodViolationContextCheckCompleted' | Write-Debug
...
function ConvertFrom-BetaJsonToSodViolationContextCheckCompleted {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaSodViolationContextCheckCompleted' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

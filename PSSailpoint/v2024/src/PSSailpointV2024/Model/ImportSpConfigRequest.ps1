...
function Initialize-V2024ImportSpConfigRequest {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024ImportSpConfigRequest' | Write-Debug
...
function ConvertFrom-V2024JsonToImportSpConfigRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024ImportSpConfigRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ApprovalconfigEscalationConfig {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.SourcesV1 => ApprovalconfigEscalationConfig' | Write-Debug
...
function ConvertFrom-JsonToApprovalconfigEscalationConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.SourcesV1 => ApprovalconfigEscalationConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

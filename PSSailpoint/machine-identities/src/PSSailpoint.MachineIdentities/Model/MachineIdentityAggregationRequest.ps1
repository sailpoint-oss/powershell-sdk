...
function Initialize-MachineIdentityAggregationRequest {
    [CmdletBinding()]
    Param (
...
MachineIdentityAggregationRequest<PSCustomObject>
#>
function ConvertFrom-JsonToMachineIdentityAggregationRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in MachineIdentityAggregationRequest

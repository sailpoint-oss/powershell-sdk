...
function Initialize-BetaTemplateBulkDeleteDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaTemplateBulkDeleteDto' | Write-Debug
...
function ConvertFrom-BetaJsonToTemplateBulkDeleteDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaTemplateBulkDeleteDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-Permissiondto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Entitlements => Permissiondto' | Write-Debug
...
function ConvertFrom-JsonToPermissiondto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Entitlements => Permissiondto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2024DomainStatusDto {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024DomainStatusDto' | Write-Debug
...
function ConvertFrom-V2024JsonToDomainStatusDto {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024DomainStatusDto' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ClustermanualupgradeJobsInnerManagedProcessConfigurationRelay {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.ManagedClustersV1 => ClustermanualupgradeJobsInnerManagedProcessConfigurationRelay' | Write-Debug
...
ClustermanualupgradeJobsInnerManagedProcessConfigurationRelay<PSCustomObject>
#>
function ConvertFrom-JsonToClustermanualupgradeJobsInnerManagedProcessConfigurationRelay {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.ManagedClustersV1 => ClustermanualupgradeJobsInnerManagedProcessConfigurationRelay' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermanualupgradeJobsInnerManagedProcessConfigurationRelay

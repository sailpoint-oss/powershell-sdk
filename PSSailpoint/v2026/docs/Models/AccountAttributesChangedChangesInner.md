...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountAttributesChangedChangesInner', 'V2026AccountAttributesChangedChangesInner'] 
slug: /tools/sdk/powershell/v2026/models/account-attributes-changed-changes-inner
...
```powershell
$AccountAttributesChangedChangesInner = Initialize-V2026AccountAttributesChangedChangesInner  -Attribute sn `
 -OldValue null `
 -NewValue null
```

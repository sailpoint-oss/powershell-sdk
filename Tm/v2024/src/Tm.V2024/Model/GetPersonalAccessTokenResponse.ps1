...
function Initialize-V2024GetPersonalAccessTokenResponse {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024GetPersonalAccessTokenResponse' | Write-Debug
...
function ConvertFrom-V2024JsonToGetPersonalAccessTokenResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024GetPersonalAccessTokenResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

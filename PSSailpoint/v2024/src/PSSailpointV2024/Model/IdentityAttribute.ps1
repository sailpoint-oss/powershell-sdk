...
function Initialize-V2024IdentityAttribute {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024IdentityAttribute' | Write-Debug
...
function ConvertFrom-V2024JsonToIdentityAttribute {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024IdentityAttribute' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

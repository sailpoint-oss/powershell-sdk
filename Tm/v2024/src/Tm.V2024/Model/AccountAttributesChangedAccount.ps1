...
function Initialize-V2024AccountAttributesChangedAccount {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccountAttributesChangedAccount' | Write-Debug
...
function ConvertFrom-V2024JsonToAccountAttributesChangedAccount {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccountAttributesChangedAccount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

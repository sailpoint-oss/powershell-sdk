...
keywords: ['powershell', 'PowerShell', 'sdk', 'SharedSignalsFrameworkSSF', 'V2025SharedSignalsFrameworkSSF'] 
slug: /tools/sdk/powershell/v2025/methods/shared-signals-framework-ssf
...
------------- | ------------- | -------------
[**New-V2025Stream**](#create-stream) | **POST** `/ssf/streams` | Create stream
[**Remove-V2025Stream**](#delete-stream) | **DELETE** `/ssf/streams` | Delete stream
[**Get-V2025JWKSData**](#get-jwks-data) | **GET** `/ssf/jwks` | Get JWKS
[**Get-V2025SSFConfiguration**](#get-ssf-configuration) | **GET** `/.well-known/ssf-configuration` | Get SSF configuration
[**Get-V2025Stream**](#get-stream) | **GET** `/ssf/streams` | Get stream(s)
[**Get-V2025StreamStatus**](#get-stream-status) | **GET** `/ssf/streams/status` | Get stream status
[**Send-V2025StreamVerification**](#send-stream-verification) | **POST** `/ssf/streams/verify` | Verify stream
[**Set-V2025StreamConfiguration**](#set-stream-configuration) | **PUT** `/ssf/streams` | Replace stream configuration
[**Update-V2025StreamConfiguration**](#update-stream-configuration) | **PATCH** `/ssf/streams` | Update stream configuration
[**Update-V2025StreamStatus**](#update-stream-status) | **POST** `/ssf/streams/status` | Update stream status
...
try {
    $Result = ConvertFrom-V2025JsonToCreateStreamRequest -Json $CreateStreamRequest
    New-V2025Stream -CreateStreamRequest $Result 
    
    # Below is a request that includes all optional parameters
    # New-V2025Stream -CreateStreamRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling New-V2025Stream"
...
try {
    Remove-V2025Stream -StreamId $StreamId 
    
    # Below is a request that includes all optional parameters
    # Remove-V2025Stream -StreamId $StreamId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Remove-V2025Stream"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2025JWKSData"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2025SSFConfiguration 
    
    # Below is a request that includes all optional parameters
    # Get-V2025SSFConfiguration  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2025SSFConfiguration"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    ...
    # Below is a request that includes all optional parameters
    # Get-V2025Stream -StreamId $StreamId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2025Stream"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    Get-V2025StreamStatus -StreamId $StreamId 
    
    # Below is a request that includes all optional parameters
    # Get-V2025StreamStatus -StreamId $StreamId  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Get-V2025StreamStatus"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2025JsonToVerificationRequest -Json $VerificationRequest
    Send-V2025StreamVerification -VerificationRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Send-V2025StreamVerification -VerificationRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Send-V2025StreamVerification"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2025JsonToReplaceStreamConfigurationRequest -Json $ReplaceStreamConfigurationRequest
    Set-V2025StreamConfiguration -ReplaceStreamConfigurationRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Set-V2025StreamConfiguration -ReplaceStreamConfigurationRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Set-V2025StreamConfiguration"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2025JsonToUpdateStreamConfigurationRequest -Json $UpdateStreamConfigurationRequest
    Update-V2025StreamConfiguration -UpdateStreamConfigurationRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2025StreamConfiguration -UpdateStreamConfigurationRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2025StreamConfiguration"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 
...
try {
    $Result = ConvertFrom-V2025JsonToUpdateStreamStatusRequest -Json $UpdateStreamStatusRequest
    Update-V2025StreamStatus -UpdateStreamStatusRequest $Result 
    
    # Below is a request that includes all optional parameters
    # Update-V2025StreamStatus -UpdateStreamStatusRequest $Result  
} catch {
    Write-Host $_.Exception.Response.StatusCode.value__ "Exception occurred when calling Update-V2025StreamStatus"
    Write-Host $_.ErrorDetails
}
```
[[Back to top]](#) 

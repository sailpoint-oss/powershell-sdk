...
function Initialize-V2024AccessProfileApprovalScheme {
    ...
    Process {
        'Creating PSCustomObject: Tm.V2024 => V2024AccessProfileApprovalScheme' | Write-Debug
...
function ConvertFrom-V2024JsonToAccessProfileApprovalScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.V2024 => V2024AccessProfileApprovalScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

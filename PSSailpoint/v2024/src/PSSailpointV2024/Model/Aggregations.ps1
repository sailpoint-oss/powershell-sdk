...
function Initialize-V2024Aggregations {
    ...
    Process {
        'Creating PSCustomObject: PSSailpointV2024 => V2024Aggregations' | Write-Debug
...
function ConvertFrom-V2024JsonToAggregations {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpointV2024 => V2024Aggregations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
#>
function Approve-V2025BulkAccessRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Approve-V2025BulkAccessRequest' | Write-Debug
...
SystemCollectionsHashtable
#>
function Suspend-V2025AccessRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Suspend-V2025AccessRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SystemCollectionsHashtable
#>
function Suspend-V2025AccessRequestInBulk {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Suspend-V2025AccessRequestInBulk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
SystemCollectionsHashtable
#>
function Close-V2025AccessRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Close-V2025AccessRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function New-V2025AccessRequest {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: New-V2025AccessRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessRequestConfig
#>
function Get-V2025AccessRequestConfig {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Get-V2025AccessRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025EntitlementDetailsForIdentity {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025EntitlementDetailsForIdentity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
RequestedItemStatus[]
#>
function Get-V2025AccessRequestStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025AccessRequestStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Get-V2025AdministratorsAccessRequestStatus {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-V2025AdministratorsAccessRequestStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
#>
function Invoke-V2025LoadAccountSelections {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-V2025LoadAccountSelections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
...
AccessRequestConfig
#>
function Set-V2025AccessRequestConfig {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Set-V2025AccessRequestConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

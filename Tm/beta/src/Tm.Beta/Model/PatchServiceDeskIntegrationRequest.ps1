...
function Initialize-BetaPatchServiceDeskIntegrationRequest {
    ...
    Process {
        'Creating PSCustomObject: Tm.Beta => BetaPatchServiceDeskIntegrationRequest' | Write-Debug
...
function ConvertFrom-BetaJsonToPatchServiceDeskIntegrationRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: Tm.Beta => BetaPatchServiceDeskIntegrationRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

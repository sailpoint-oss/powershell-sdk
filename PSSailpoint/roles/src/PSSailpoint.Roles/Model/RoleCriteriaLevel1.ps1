...
function Initialize-RoleCriteriaLevel1 {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Roles => RoleCriteriaLevel1' | Write-Debug
...
function ConvertFrom-JsonToRoleCriteriaLevel1 {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Roles => RoleCriteriaLevel1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-V2026WorkflowLibraryTrigger {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.V2026 => V2026WorkflowLibraryTrigger' | Write-Debug
...
WorkflowLibraryTrigger<PSCustomObject>
#>
function ConvertFrom-V2026JsonToWorkflowLibraryTrigger {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.V2026 => V2026WorkflowLibraryTrigger' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V2026WorkflowLibraryTrigger

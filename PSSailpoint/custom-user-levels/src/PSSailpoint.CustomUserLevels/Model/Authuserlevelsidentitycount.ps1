...
function Initialize-Authuserlevelsidentitycount {
    [CmdletBinding()]
    Param (
...
Authuserlevelsidentitycount<PSCustomObject>
#>
function ConvertFrom-JsonToAuthuserlevelsidentitycount {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        ...
        # check if Json contains properties not defined in Authuserlevelsidentitycount

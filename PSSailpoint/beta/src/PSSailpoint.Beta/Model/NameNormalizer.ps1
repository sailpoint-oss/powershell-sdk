...
function Initialize-BetaNameNormalizer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.Beta => BetaNameNormalizer' | Write-Debug
...
NameNormalizer<PSCustomObject>
#>
function ConvertFrom-BetaJsonToNameNormalizer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.Beta => BetaNameNormalizer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BetaNameNormalizer

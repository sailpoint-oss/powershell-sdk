...
function Initialize-Accessprofileapprovalscheme {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessProfilesV1 => Accessprofileapprovalscheme' | Write-Debug
...
function ConvertFrom-JsonToAccessprofileapprovalscheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessProfilesV1 => Accessprofileapprovalscheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

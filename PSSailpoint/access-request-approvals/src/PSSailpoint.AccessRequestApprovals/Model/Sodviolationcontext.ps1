...
function Initialize-Sodviolationcontext {
    ...
    Process {
        'Creating PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => Sodviolationcontext' | Write-Debug
...
function ConvertFrom-JsonToSodviolationcontext {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSSailpoint.AccessRequestApprovalsV1 => Sodviolationcontext' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

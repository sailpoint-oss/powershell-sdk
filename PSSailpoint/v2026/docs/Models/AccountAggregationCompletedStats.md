...
keywords: ['powershell', 'PowerShell', 'sdk', 'AccountAggregationCompletedStats', 'V2026AccountAggregationCompletedStats'] 
slug: /tools/sdk/powershell/v2026/models/account-aggregation-completed-stats
...
```powershell
$AccountAggregationCompletedStats = Initialize-V2026AccountAggregationCompletedStats  -Scanned 200 `
 -Unchanged 190 `
 -Changed 6 `
 -Added 4 `
 -Removed 3
